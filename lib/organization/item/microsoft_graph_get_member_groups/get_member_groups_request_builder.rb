...
module MicrosoftGraph::Organization::Item::MicrosoftGraphGetMemberGroups
    ## 
    ...
    class GetMemberGroupsRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/organization/{organization%2Did}/microsoft.graph.getMemberGroups"
        ...
        def post(body, request_configuration=nil)
            ...
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraph::Organization::Item::MicrosoftGraphGetMemberGroups::GetMemberGroupsResponse.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
        ## Return all the group IDs for the groups that the specified user, group, service principal, organizational contact, device, or directory object is a member of. This function is transitive.
        ## @param body The request body
