    ...
    module Organization
        module Item
            module SetMobileDeviceManagementAuthority
                class SetMobileDeviceManagementAuthorityPostResponse
                    ...
                    ## @return a set_mobile_device_management_authority_post_response
                    ## 
                    def self.create_from_discriminator_value(parse_node)
                        raise StandardError, 'parse_node cannot be null' if parse_node.nil?
                        return SetMobileDeviceManagementAuthorityPostResponse.new
                    end
                    ## 
