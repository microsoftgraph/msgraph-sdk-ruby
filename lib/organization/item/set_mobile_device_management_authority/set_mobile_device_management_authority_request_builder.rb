        ...
        module Item
            module SetMobileDeviceManagementAuthority
                ...
                class SetMobileDeviceManagementAuthorityRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    ## @return a Fiber of set_mobile_device_management_authority_post_response
                    ## 
                    def post(request_configuration=nil)
                        ...
                        return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraph::Organization::Item::SetMobileDeviceManagementAuthority::SetMobileDeviceManagementAuthorityPostResponse.create_from_discriminator_value(pn) }, error_mapping)
                    end
                    ## 
                    ## Set mobile device management authority
                    ## @param request_configuration Configuration for the request such as headers, query parameters, and middleware options.
                    ...
                    ## @return a set_mobile_device_management_authority_request_builder
                    ## 
                    def with_url(raw_url)
                        raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                        return SetMobileDeviceManagementAuthorityRequestBuilder.new(raw_url, @request_adapter)
                    end
                end
            end
        end
