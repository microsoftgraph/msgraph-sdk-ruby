    ...
    module Organization
        module Item
            module CheckMemberObjects
                class CheckMemberObjectspostResponse < MicrosoftGraph::Models::BaseCollectionPaginationCountResponse
                    ...
                    ## @return a check_member_objectspost_response
                    ## 
                    def self.create_from_discriminator_value(parse_node)
                        raise StandardError, 'parse_node cannot be null' if parse_node.nil?
                        return CheckMemberObjectspostResponse.new
                    end
                    ## 
