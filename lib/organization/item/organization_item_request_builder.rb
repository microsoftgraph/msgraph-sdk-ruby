...
require_relative './microsoft_graph_set_mobile_device_management_authority/microsoft_graph_set_mobile_device_management_authority_request_builder'

module MicrosoftGraph::Organization::Item
    ## 
    ...
    class OrganizationItemRequestBuilder
        ...
        def microsoft_graph_check_member_groups()
            return MicrosoftGraph::Organization::Item::MicrosoftGraphCheckMemberGroups::MicrosoftGraphCheckMemberGroupsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the checkMemberObjects method.
        def microsoft_graph_check_member_objects()
            return MicrosoftGraph::Organization::Item::MicrosoftGraphCheckMemberObjects::MicrosoftGraphCheckMemberObjectsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the getMemberGroups method.
        def microsoft_graph_get_member_groups()
            return MicrosoftGraph::Organization::Item::MicrosoftGraphGetMemberGroups::MicrosoftGraphGetMemberGroupsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the getMemberObjects method.
        def microsoft_graph_get_member_objects()
            return MicrosoftGraph::Organization::Item::MicrosoftGraphGetMemberObjects::MicrosoftGraphGetMemberObjectsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the restore method.
        def microsoft_graph_restore()
            return MicrosoftGraph::Organization::Item::MicrosoftGraphRestore::MicrosoftGraphRestoreRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the setMobileDeviceManagementAuthority method.
        def microsoft_graph_set_mobile_device_management_authority()
            return MicrosoftGraph::Organization::Item::MicrosoftGraphSetMobileDeviceManagementAuthority::MicrosoftGraphSetMobileDeviceManagementAuthorityRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
