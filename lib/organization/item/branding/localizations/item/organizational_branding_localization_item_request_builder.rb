...
module MicrosoftGraph::Organization::Item::Branding::Localizations::Item
    ## 
    ...
    class OrganizationalBrandingLocalizationItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, organizational_branding_localization_id=)
            ...
            @url_template = "{+baseurl}/organization/{organization%2Did}/branding/localizations/{organizationalBrandingLocalization%2Did}{?%24select,%24expand}"
