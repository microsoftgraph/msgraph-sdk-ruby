...
require_relative './item/organization_item_request_builder'
...
module MicrosoftGraph
    module Organization
        ...
        class OrganizationRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
            
            ## 
            # Provides operations to count the resources in the collection.
            def count()
                return MicrosoftGraph::Organization::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
            end
            ## 
            # Provides operations to call the delta method.
            def delta()
                return MicrosoftGraph::Organization::Delta::DeltaRequestBuilder.new(@path_parameters, @request_adapter)
            end
            ## 
            ...
            ## 
            def by_organization_id(organization_id)
                raise StandardError, 'organization_id cannot be null' if organization_id.nil?
            ...
            def initialize(path_parameters, request_adapter)
                super(path_parameters, request_adapter, "{+baseurl}/organization{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}")
            end
            ## 
            ## List properties and relationships of the organization objects.
            ## @param request_configuration Configuration for the request such as headers, query parameters, and middleware options.
            ## @return a Fiber of organization_collection_response
            ## 
            def get(request_configuration=nil)
                ...
                return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraph::Models::OrganizationCollectionResponse.create_from_discriminator_value(pn) }, error_mapping)
            end
            ## 
            ...
            def to_post_request_information(body, request_configuration=nil)
                ...
                request_info.url_template = '{+baseurl}/organization'
                request_info.path_parameters = @path_parameters
            ...
            ## @return a organization_request_builder
            ## 
            def with_url(raw_url)
                raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                return OrganizationRequestBuilder.new(raw_url, @request_adapter)
            end
