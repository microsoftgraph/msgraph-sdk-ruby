...
module MicrosoftGraph
    module SchemaExtensions
        module Item
            ...
            class SchemaExtensionItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def initialize(path_parameters, request_adapter)
                    super(path_parameters, request_adapter, "{+baseurl}/schemaExtensions/{schemaExtension%2Did}{?%24expand,%24select}")
                end
                ## 
                ...
                def to_delete_request_information(request_configuration=nil)
                    ...
                    request_info.url_template = '{+baseurl}/schemaExtensions/{schemaExtension%2Did}'
                ...
                def with_url(raw_url)
                    ...
                    return SchemaExtensionItemRequestBuilder.new(raw_url, @request_adapter)
                end
