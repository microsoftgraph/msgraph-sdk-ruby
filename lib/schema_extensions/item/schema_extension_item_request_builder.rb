...
module MicrosoftGraph::SchemaExtensions::Item
    ## 
    ...
    class SchemaExtensionItemRequestBuilder
        ...
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, schema_extension_id=nil)
            raise StandardError, 'path_parameters cannot be null' if path_parameters.nil?
            raise StandardError, 'request_adapter cannot be null' if request_adapter.nil?
            @url_template = "{+baseurl}/schemaExtensions/{schemaExtension%2Did}{?%24select,%24expand}"
