...
module MicrosoftGraph::Users::Item::Activities::Item::HistoryItems::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/activities/{userActivity%2Did}/historyItems/$count{?%24search,%24filter}"
