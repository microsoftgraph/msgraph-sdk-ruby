            ...
            module Activities
                ...
                class ActivitiesRequestBuilder
                    ...
                    def microsoft_graph_recent()
                        return MicrosoftGraph::Users::Item::Activities::MicrosoftGraphRecent::MicrosoftGraphRecentRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ...
                    def initialize(path_parameters, request_adapter)
                        ...
                        @url_template = "{+baseurl}/users/{user%2Did}/activities{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
