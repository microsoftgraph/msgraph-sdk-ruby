...
module MicrosoftGraph::Users::Item::MailFolders
    ## 
    ...
    class MailFoldersRequestBuilder
        ...
        def microsoft_graph_delta()
            return MicrosoftGraph::Users::Item::MailFolders::MicrosoftGraphDelta::MicrosoftGraphDeltaRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
