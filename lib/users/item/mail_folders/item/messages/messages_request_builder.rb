...
module MicrosoftGraph::Users::Item::MailFolders::Item::Messages
    ## 
    ...
    class MessagesRequestBuilder
        ...
        def microsoft_graph_delta()
            return MicrosoftGraph::Users::Item::MailFolders::Item::Messages::MicrosoftGraphDelta::MicrosoftGraphDeltaRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
