...
module MicrosoftGraph::Users::Item::MailFolders::Item::Messages::Item::MicrosoftGraphMove
    ## 
    ...
    class MoveRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/mailFolders/{mailFolder%2Did}/messages/{message%2Did}/microsoft.graph.move"
