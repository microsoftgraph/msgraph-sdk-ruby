...
require_relative '../item'
require_relative './microsoft_graph_move'

module MicrosoftGraph::Users::Item::MailFolders::Item::ChildFolders::Item::Messages::Item::MicrosoftGraphMove
    ## 
    ...
    class MoveRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/mailFolders/{mailFolder%2Did}/childFolders/{mailFolder%2Did1}/messages/{message%2Did}/microsoft.graph.move"
