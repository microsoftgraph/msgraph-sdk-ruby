                            ...
                            module Messages
                                module Item
                                    module CreateReplyAll
                                        ...
                                        class CreateReplyAllRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                            ...
                                            def initialize(path_parameters, request_adapter)
                                                super(path_parameters, request_adapter, "{+baseurl}/users/{user%2Did}/mailFolders/{mailFolder%2Did}/childFolders/{mailFolder%2Did1}/messages/{message%2Did}/createReplyAll")
                                            end
                                            ## 
                                            ...
                                            ## @return a create_reply_all_request_builder
                                            ## 
                                            def with_url(raw_url)
                                                raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                                                return CreateReplyAllRequestBuilder.new(raw_url, @request_adapter)
                                            end
                                        end
                                    end
                                end
