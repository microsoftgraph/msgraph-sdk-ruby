...
module MicrosoftGraph::Users::Item::MailFolders::Item::ChildFolders::Item::Messages::Item
    ## 
    ...
    class MessageItemRequestBuilder
        ...
        def attachments()
            return MicrosoftGraph::Users::Item::MailFolders::Item::ChildFolders::Item::Messages::Item::Attachments::AttachmentsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def microsoft_graph_copy()
            return MicrosoftGraph::Users::Item::MailFolders::Item::ChildFolders::Item::Messages::Item::MicrosoftGraphCopy::MicrosoftGraphCopyRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the createForward method.
        def microsoft_graph_create_forward()
            return MicrosoftGraph::Users::Item::MailFolders::Item::ChildFolders::Item::Messages::Item::MicrosoftGraphCreateForward::MicrosoftGraphCreateForwardRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the createReply method.
        def microsoft_graph_create_reply()
            return MicrosoftGraph::Users::Item::MailFolders::Item::ChildFolders::Item::Messages::Item::MicrosoftGraphCreateReply::MicrosoftGraphCreateReplyRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the createReplyAll method.
        def microsoft_graph_create_reply_all()
            return MicrosoftGraph::Users::Item::MailFolders::Item::ChildFolders::Item::Messages::Item::MicrosoftGraphCreateReplyAll::MicrosoftGraphCreateReplyAllRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the forward method.
        def microsoft_graph_forward()
            return MicrosoftGraph::Users::Item::MailFolders::Item::ChildFolders::Item::Messages::Item::MicrosoftGraphForward::MicrosoftGraphForwardRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the move method.
        def microsoft_graph_move()
            return MicrosoftGraph::Users::Item::MailFolders::Item::ChildFolders::Item::Messages::Item::MicrosoftGraphMove::MicrosoftGraphMoveRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the reply method.
        def microsoft_graph_reply()
            return MicrosoftGraph::Users::Item::MailFolders::Item::ChildFolders::Item::Messages::Item::MicrosoftGraphReply::MicrosoftGraphReplyRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the replyAll method.
        def microsoft_graph_reply_all()
            return MicrosoftGraph::Users::Item::MailFolders::Item::ChildFolders::Item::Messages::Item::MicrosoftGraphReplyAll::MicrosoftGraphReplyAllRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the send method.
        def microsoft_graph_send()
            return MicrosoftGraph::Users::Item::MailFolders::Item::ChildFolders::Item::Messages::Item::MicrosoftGraphSend::MicrosoftGraphSendRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def attachments_by_id(id)
            ...
            return MicrosoftGraph::Users::Item::MailFolders::Item::ChildFolders::Item::Messages::Item::Attachments::Item::AttachmentItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def extensions_by_id(id)
            ...
            return MicrosoftGraph::Users::Item::MailFolders::Item::ChildFolders::Item::Messages::Item::Extensions::Item::ExtensionItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def multi_value_extended_properties_by_id(id)
            ...
            return MicrosoftGraph::Users::Item::MailFolders::Item::ChildFolders::Item::Messages::Item::MultiValueExtendedProperties::Item::MultiValueLegacyExtendedPropertyItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def single_value_extended_properties_by_id(id)
            ...
            return MicrosoftGraph::Users::Item::MailFolders::Item::ChildFolders::Item::Messages::Item::SingleValueExtendedProperties::Item::SingleValueLegacyExtendedPropertyItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Delete navigation property messages for users
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
