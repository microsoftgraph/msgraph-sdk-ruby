...
module MicrosoftGraph::Users::Item::MailFolders::Item::ChildFolders
    ## 
    ...
    class ChildFoldersRequestBuilder
        ...
        def microsoft_graph_delta()
            return MicrosoftGraph::Users::Item::MailFolders::Item::ChildFolders::MicrosoftGraphDelta::MicrosoftGraphDeltaRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
