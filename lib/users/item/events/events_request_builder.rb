...
module MicrosoftGraph::Users::Item::Events
    ## 
    ...
    class EventsRequestBuilder
        ...
        def microsoft_graph_delta()
            return MicrosoftGraph::Users::Item::Events::MicrosoftGraphDelta::MicrosoftGraphDeltaRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/events{?%24top,%24skip,%24filter,%24count,%24orderby,%24select}"
