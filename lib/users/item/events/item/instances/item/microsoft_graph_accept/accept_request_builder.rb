...
module MicrosoftGraph::Users::Item::Events::Item::Instances::Item::MicrosoftGraphAccept
    ## 
    ...
    class AcceptRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/events/{event%2Did}/instances/{event%2Did1}/microsoft.graph.accept"
