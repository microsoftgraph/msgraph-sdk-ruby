...
module MicrosoftGraph::Users::Item::Events::Item::Attachments::MicrosoftGraphCreateUploadSession
    ## 
    ...
    class CreateUploadSessionRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/events/{event%2Did}/attachments/microsoft.graph.createUploadSession"
