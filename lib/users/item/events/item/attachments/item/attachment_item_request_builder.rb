...
module MicrosoftGraph::Users::Item::Events::Item::Attachments::Item
    ## 
    ...
    class AttachmentItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, attachment_id=nil)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/events/{event%2Did}/attachments/{attachment%2Did}{?%24select,%24expand}"
