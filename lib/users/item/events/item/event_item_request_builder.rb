                ...
                module Item
                    ...
                    class EventItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def exception_occurrences()
                            return MicrosoftGraph::Users::Item::Events::Item::ExceptionOccurrences::ExceptionOccurrencesRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ...
                        def permanent_delete()
                            return MicrosoftGraph::Users::Item::Events::Item::PermanentDelete::PermanentDeleteRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/users/{user%2Did}/events/{event%2Did}{?%24expand,%24select}")
                        end
                        ## 
