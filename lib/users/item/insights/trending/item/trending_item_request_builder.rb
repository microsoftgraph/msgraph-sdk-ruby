            ...
            module Insights
                module Trending
                    module Item
                        ...
                        class TrendingItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            
                            ## 
                            # Provides operations to manage the resource property of the microsoft.graph.trending entity.
                            def resource()
                                return MicrosoftGraph::Users::Item::Insights::Trending::Item::Resource::ResourceRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            ...
                            def initialize(path_parameters, request_adapter)
                                super(path_parameters, request_adapter, "{+baseurl}/users/{user%2Did}/insights/trending/{trending%2Did}{?%24expand,%24select}")
                            end
                            ## 
                            ...
                            def to_delete_request_information(request_configuration=nil)
                                ...
                                request_info.url_template = '{+baseurl}/users/{user%2Did}/insights/trending/{trending%2Did}'
                            ...
                            def with_url(raw_url)
                                ...
                                return TrendingItemRequestBuilder.new(raw_url, @request_adapter)
                            end
