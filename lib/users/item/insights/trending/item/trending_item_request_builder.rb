...
module MicrosoftGraph::Users::Item::Insights::Trending::Item
    ## 
    ...
    class TrendingItemRequestBuilder
        ...
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, trending_id=nil)
            raise StandardError, 'path_parameters cannot be null' if path_parameters.nil?
            raise StandardError, 'request_adapter cannot be null' if request_adapter.nil?
            @url_template = "{+baseurl}/users/{user%2Did}/insights/trending/{trending%2Did}{?%24select,%24expand}"
