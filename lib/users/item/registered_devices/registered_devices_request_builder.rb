            ...
            module RegisteredDevices
                ...
                class RegisteredDevicesRequestBuilder
                    ...
                    def microsoft_graph_app_role_assignment()
                        return MicrosoftGraph::Users::Item::RegisteredDevices::MicrosoftGraphAppRoleAssignment::MicrosoftGraphAppRoleAssignmentRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Casts the previous resource to device.
                    def microsoft_graph_device()
                        return MicrosoftGraph::Users::Item::RegisteredDevices::MicrosoftGraphDevice::MicrosoftGraphDeviceRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Casts the previous resource to endpoint.
                    def microsoft_graph_endpoint()
                        return MicrosoftGraph::Users::Item::RegisteredDevices::MicrosoftGraphEndpoint::MicrosoftGraphEndpointRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ...
                    def initialize(path_parameters, request_adapter)
                        ...
                        @url_template = "{+baseurl}/users/{user%2Did}/registeredDevices{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
