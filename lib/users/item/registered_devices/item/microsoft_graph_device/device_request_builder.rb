...
module MicrosoftGraph::Users::Item::RegisteredDevices::Item::MicrosoftGraphDevice
    ## 
    ...
    class DeviceRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/registeredDevices/{directoryObject%2Did}/microsoft.graph.device{?%24select,%24expand}"
