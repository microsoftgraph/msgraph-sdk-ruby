...
require_relative './microsoft_graph_reprocess_license_assignment'

module MicrosoftGraph::Users::Item::MicrosoftGraphReprocessLicenseAssignment
    ## 
    ...
    class ReprocessLicenseAssignmentRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/microsoft.graph.reprocessLicenseAssignment"
