...
module MicrosoftGraph::Users::Item::Photos::Item
    ## 
    ...
    class ProfilePhotoItemRequestBuilder
        ...
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, profile_photo_id=nil)
            raise StandardError, 'path_parameters cannot be null' if path_parameters.nil?
            raise StandardError, 'request_adapter cannot be null' if request_adapter.nil?
            @url_template = "{+baseurl}/users/{user%2Did}/photos/{profilePhoto%2Did}{?%24select}"
