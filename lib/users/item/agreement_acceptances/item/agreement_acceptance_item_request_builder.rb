...
module MicrosoftGraph::Users::Item::AgreementAcceptances::Item
    ## 
    ...
    class AgreementAcceptanceItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, agreement_acceptance_id=)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/agreementAcceptances/{agreementAcceptance%2Did}{?%24select,%24expand}"
