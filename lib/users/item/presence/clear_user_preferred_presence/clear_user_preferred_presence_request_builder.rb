                ...
                module ClearUserPreferredPresence
                    ...
                    class ClearUserPreferredPresenceRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/users/{user%2Did}/presence/clearUserPreferredPresence")
                        end
                        ## 
                        ...
                        ## @return a clear_user_preferred_presence_request_builder
                        ## 
                        def with_url(raw_url)
                            raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                            return ClearUserPreferredPresenceRequestBuilder.new(raw_url, @request_adapter)
                        end
                    end
                end
            end
