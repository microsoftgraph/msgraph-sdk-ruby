    ...
    module Users
        module Item
            module Sponsors
                ...
                class SponsorsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    
                    ## 
                    # Provides operations to count the resources in the collection.
                    def count()
                        return MicrosoftGraph::Users::Item::Sponsors::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ## Provides operations to manage the sponsors property of the microsoft.graph.user entity.
                    ...
                    def by_directory_object_id(directory_object_id)
                        ...
                        return MicrosoftGraph::Users::Item::Sponsors::Item::DirectoryObjectItemRequestBuilder.new(url_tpl_params, @request_adapter)
                    end
                    ## 
                    ...
                    def initialize(path_parameters, request_adapter)
                        super(path_parameters, request_adapter, "{+baseurl}/users/{user%2Did}/sponsors{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}")
                    end
                    ## 
                    ...
                    ## @return a sponsors_request_builder
                    ## 
                    def with_url(raw_url)
                        raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                        return SponsorsRequestBuilder.new(raw_url, @request_adapter)
                    end
