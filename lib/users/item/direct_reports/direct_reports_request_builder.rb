...
module MicrosoftGraph::Users::Item::DirectReports
    ...
    class DirectReportsRequestBuilder
        ...
        def microsoft_graph_org_contact()
            return MicrosoftGraph::Users::Item::DirectReports::MicrosoftGraphOrgContact::OrgContactRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Casts the previous resource to user.
        def microsoft_graph_user()
            return MicrosoftGraph::Users::Item::DirectReports::MicrosoftGraphUser::UserRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
