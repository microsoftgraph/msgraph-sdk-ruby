...
module MicrosoftGraph::Users::Item::DeviceManagementTroubleshootingEvents::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/deviceManagementTroubleshootingEvents/$count{?%24search,%24filter}"
