...
module MicrosoftGraph
    module Users
        module Item
            module DeviceManagementTroubleshootingEvents
                ## 
                # Provides operations to manage the deviceManagementTroubleshootingEvents property of the microsoft.graph.user entity.
                class DeviceManagementTroubleshootingEventsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def initialize(path_parameters, request_adapter)
                        super(path_parameters, request_adapter, "{+baseurl}/users/{user%2Did}/deviceManagementTroubleshootingEvents{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}")
                    end
                    ## 
                    ...
                    def to_post_request_information(body, request_configuration=nil)
                        ...
                        request_info.url_template = '{+baseurl}/users/{user%2Did}/deviceManagementTroubleshootingEvents'
                        request_info.path_parameters = @path_parameters
                    ...
                    ## @return a device_management_troubleshooting_events_request_builder
                    ## 
                    def with_url(raw_url)
                        raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                        return DeviceManagementTroubleshootingEventsRequestBuilder.new(raw_url, @request_adapter)
                    end
