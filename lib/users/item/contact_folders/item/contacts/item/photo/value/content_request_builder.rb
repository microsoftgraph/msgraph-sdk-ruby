...
module MicrosoftGraph::Users::Item::ContactFolders::Item::Contacts::Item::Photo::Value
    ## 
    ...
    class ContentRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/contactFolders/{contactFolder%2Did}/contacts/{contact%2Did}/photo/$value"
