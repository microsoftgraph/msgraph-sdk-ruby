...
module MicrosoftGraph::Users::Item::ContactFolders::Item::Contacts::Item::Extensions::Item
    ## 
    ...
    class ExtensionItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, extension_id=)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/contactFolders/{contactFolder%2Did}/contacts/{contact%2Did}/extensions/{extension%2Did}{?%24select,%24expand}"
