...
module MicrosoftGraph::Users::Item::ContactFolders::Item::SingleValueExtendedProperties::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/contactFolders/{contactFolder%2Did}/singleValueExtendedProperties/$count{?%24search,%24filter}"
