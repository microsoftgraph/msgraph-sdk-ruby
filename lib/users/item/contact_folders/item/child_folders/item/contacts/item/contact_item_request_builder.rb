...
module MicrosoftGraph::Users::Item::ContactFolders::Item::ChildFolders::Item::Contacts::Item
    ## 
    ...
    class ContactItemRequestBuilder
        ...
        def extensions()
            return MicrosoftGraph::Users::Item::ContactFolders::Item::ChildFolders::Item::Contacts::Item::Extensions::ExtensionsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def extensions_by_id(id)
            ...
            return MicrosoftGraph::Users::Item::ContactFolders::Item::ChildFolders::Item::Contacts::Item::Extensions::Item::ExtensionItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
