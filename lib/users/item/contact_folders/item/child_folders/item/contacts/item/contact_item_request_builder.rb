                                ...
                                module Item
                                    ...
                                    class ContactItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                        ...
                                        def permanent_delete()
                                            return MicrosoftGraph::Users::Item::ContactFolders::Item::ChildFolders::Item::Contacts::Item::PermanentDelete::PermanentDeleteRequestBuilder.new(@path_parameters, @request_adapter)
                                        end
                                        ## 
                                        ...
                                        def initialize(path_parameters, request_adapter)
                                            super(path_parameters, request_adapter, "{+baseurl}/users/{user%2Did}/contactFolders/{contactFolder%2Did}/childFolders/{contactFolder%2Did1}/contacts/{contact%2Did}{?%24expand,%24select}")
                                        end
                                        ## 
                                        ...
                                        def with_url(raw_url)
                                            ...
                                            return ContactItemRequestBuilder.new(raw_url, @request_adapter)
                                        end
