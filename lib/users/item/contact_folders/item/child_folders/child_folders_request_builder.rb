...
module MicrosoftGraph::Users::Item::ContactFolders::Item::ChildFolders
    ## 
    ...
    class ChildFoldersRequestBuilder
        ...
        def microsoft_graph_delta()
            return MicrosoftGraph::Users::Item::ContactFolders::Item::ChildFolders::MicrosoftGraphDelta::MicrosoftGraphDeltaRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/contactFolders/{contactFolder%2Did}/childFolders{?%24top,%24skip,%24filter,%24count,%24orderby,%24select,%24expand}"
