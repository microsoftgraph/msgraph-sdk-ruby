            ...
            module ContactFolders
                ...
                class ContactFoldersRequestBuilder
                    ...
                    def microsoft_graph_delta()
                        return MicrosoftGraph::Users::Item::ContactFolders::MicrosoftGraphDelta::MicrosoftGraphDeltaRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ...
                    def initialize(path_parameters, request_adapter)
                        ...
                        @url_template = "{+baseurl}/users/{user%2Did}/contactFolders{?%24top,%24skip,%24filter,%24count,%24orderby,%24select}"
