...
module MicrosoftGraph::Users::Item::ScopedRoleMemberOf::Item
    ## 
    ...
    class ScopedRoleMembershipItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, scoped_role_membership_id=nil)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/scopedRoleMemberOf/{scopedRoleMembership%2Did}{?%24select,%24expand}"
