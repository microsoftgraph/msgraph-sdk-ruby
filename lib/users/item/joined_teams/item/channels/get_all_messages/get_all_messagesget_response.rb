                ...
                module Item
                    module Channels
                        module GetAllMessages
                            class GetAllMessagesgetResponse < MicrosoftGraph::Models::BaseCollectionPaginationCountResponse
                                ...
                                ## @return a get_all_messagesget_response
                                ## 
                                def self.create_from_discriminator_value(parse_node)
                                    raise StandardError, 'parse_node cannot be null' if parse_node.nil?
                                    return GetAllMessagesgetResponse.new
                                end
                                ## 
