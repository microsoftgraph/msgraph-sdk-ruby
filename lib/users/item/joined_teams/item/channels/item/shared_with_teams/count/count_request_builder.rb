...
module MicrosoftGraph::Users::Item::JoinedTeams::Item::Channels::Item::SharedWithTeams::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/channels/{channel%2Did}/sharedWithTeams/$count{?%24search,%24filter}"
