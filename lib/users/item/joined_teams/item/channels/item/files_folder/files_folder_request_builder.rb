                        ...
                        module Item
                            module FilesFolder
                                ...
                                class FilesFolderRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                    ...
                                    def content()
                                        return MicrosoftGraph::Users::Item::JoinedTeams::Item::Channels::Item::FilesFolder::Content::ContentRequestBuilder.new(@path_parameters, @request_adapter)
                                    end
                                    ## 
                                    ...
                                    def initialize(path_parameters, request_adapter)
                                        super(path_parameters, request_adapter, "{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/channels/{channel%2Did}/filesFolder{?%24expand,%24select}")
                                    end
                                    ## 
                                    ...
                                    ## @return a files_folder_request_builder
                                    ## 
                                    def with_url(raw_url)
                                        raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                                        return FilesFolderRequestBuilder.new(raw_url, @request_adapter)
                                    end
