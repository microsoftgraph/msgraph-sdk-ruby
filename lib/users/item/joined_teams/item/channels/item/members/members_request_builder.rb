...
module MicrosoftGraph::Users::Item::JoinedTeams::Item::Channels::Item::Members
    ...
    class MembersRequestBuilder
        ...
        def microsoft_graph_add()
            return MicrosoftGraph::Users::Item::JoinedTeams::Item::Channels::Item::Members::MicrosoftGraphAdd::MicrosoftGraphAddRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
