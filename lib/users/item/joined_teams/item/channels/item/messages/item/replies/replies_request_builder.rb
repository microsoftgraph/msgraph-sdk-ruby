...
module MicrosoftGraph::Users::Item::JoinedTeams::Item::Channels::Item::Messages::Item::Replies
    ## 
    ...
    class RepliesRequestBuilder
        ...
        def microsoft_graph_delta()
            return MicrosoftGraph::Users::Item::JoinedTeams::Item::Channels::Item::Messages::Item::Replies::MicrosoftGraphDelta::MicrosoftGraphDeltaRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
