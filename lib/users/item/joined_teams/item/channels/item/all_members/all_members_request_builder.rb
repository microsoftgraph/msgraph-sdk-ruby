                    ...
                    module Channels
                        module Item
                            module AllMembers
                                ...
                                class AllMembersRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                    
                                    ## 
                                    # Provides operations to call the add method.
                                    def add()
                                        return MicrosoftGraph::Users::Item::JoinedTeams::Item::Channels::Item::AllMembers::Add::AddRequestBuilder.new(@path_parameters, @request_adapter)
                                    end
                                    ## 
                                    # Provides operations to count the resources in the collection.
                                    def count()
                                        return MicrosoftGraph::Users::Item::JoinedTeams::Item::Channels::Item::AllMembers::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                                    end
                                    ## 
                                    # Provides operations to call the remove method.
                                    def remove()
                                        return MicrosoftGraph::Users::Item::JoinedTeams::Item::Channels::Item::AllMembers::Remove::RemoveRequestBuilder.new(@path_parameters, @request_adapter)
                                    end
                                    ## 
                                    ## Provides operations to manage the allMembers property of the microsoft.graph.channel entity.
                                    ...
                                    def by_conversation_member_id(conversation_member_id)
                                        ...
                                        return MicrosoftGraph::Users::Item::JoinedTeams::Item::Channels::Item::AllMembers::Item::ConversationMemberItemRequestBuilder.new(url_tpl_params, @request_adapter)
                                    end
                                    ## 
                                    ...
                                    def initialize(path_parameters, request_adapter)
                                        super(path_parameters, request_adapter, "{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/channels/{channel%2Did}/allMembers{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}")
                                    end
                                    ## 
                                    ...
                                    ## @return a all_members_request_builder
                                    ## 
                                    def with_url(raw_url)
                                        raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                                        return AllMembersRequestBuilder.new(raw_url, @request_adapter)
                                    end
