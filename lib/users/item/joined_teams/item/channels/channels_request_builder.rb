...
module MicrosoftGraph::Users::Item::JoinedTeams::Item::Channels
    ## 
    ...
    class ChannelsRequestBuilder
        ...
        def microsoft_graph_get_all_messages()
            return MicrosoftGraph::Users::Item::JoinedTeams::Item::Channels::MicrosoftGraphGetAllMessages::MicrosoftGraphGetAllMessagesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/channels{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
