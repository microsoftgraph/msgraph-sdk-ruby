            ...
            module JoinedTeams
                module Item
                    module Channels
                        ...
                        class ChannelsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            
                            ## 
                            # Provides operations to count the resources in the collection.
                            def count()
                                return MicrosoftGraph::Users::Item::JoinedTeams::Item::Channels::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            ...
                            def get_all_retained_messages()
                                return MicrosoftGraph::Users::Item::JoinedTeams::Item::Channels::GetAllRetainedMessages::GetAllRetainedMessagesRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            ## Provides operations to manage the channels property of the microsoft.graph.team entity.
                            ...
                            def initialize(path_parameters, request_adapter)
                                super(path_parameters, request_adapter, "{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/channels{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}")
                            end
                            ## 
