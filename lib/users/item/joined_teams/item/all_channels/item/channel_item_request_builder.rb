...
module MicrosoftGraph::Users::Item::JoinedTeams::Item::AllChannels::Item
    ## 
    ...
    class ChannelItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, channel_id=nil)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/allChannels/{channel%2Did}{?%24select,%24expand}"
