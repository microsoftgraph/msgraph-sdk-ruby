...
module MicrosoftGraph::Users::Item::JoinedTeams::Item::AllChannels::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/allChannels/$count{?%24search,%24filter}"
