                            ...
                            module ClockIn
                                ...
                                class ClockInRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                    ...
                                    def initialize(path_parameters, request_adapter)
                                        super(path_parameters, request_adapter, "{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/schedule/timeCards/clockIn")
                                    end
                                    ## 
                                    ...
                                    ## @return a clock_in_request_builder
                                    ## 
                                    def with_url(raw_url)
                                        raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                                        return ClockInRequestBuilder.new(raw_url, @request_adapter)
                                    end
                                end
                            end
                        end
