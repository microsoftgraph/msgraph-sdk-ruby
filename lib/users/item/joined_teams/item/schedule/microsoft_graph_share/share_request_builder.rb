...
require_relative './microsoft_graph_share'

module MicrosoftGraph::Users::Item::JoinedTeams::Item::Schedule::MicrosoftGraphShare
    ## 
    ...
    class ShareRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/schedule/microsoft.graph.share"
