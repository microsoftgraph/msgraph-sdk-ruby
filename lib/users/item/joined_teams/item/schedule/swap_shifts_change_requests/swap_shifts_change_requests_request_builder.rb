...
require_relative '../../../../../../models/swap_shifts_change_request'
require_relative '../../../../../../models/swap_shifts_change_request_collection_response'
    ...
    module Users
        module Item
            module JoinedTeams
                module Item
                    module Schedule
                        module SwapShiftsChangeRequests
                            ## 
                            # Provides operations to manage the swapShiftsChangeRequests property of the microsoft.graph.schedule entity.
                            class SwapShiftsChangeRequestsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                
                                ## 
                                # Provides operations to count the resources in the collection.
                                def count()
                                    return MicrosoftGraph::Users::Item::JoinedTeams::Item::Schedule::SwapShiftsChangeRequests::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                                end
                                ## 
                                ## Provides operations to manage the swapShiftsChangeRequests property of the microsoft.graph.schedule entity.
                                ...
                                def initialize(path_parameters, request_adapter)
                                    super(path_parameters, request_adapter, "{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/schedule/swapShiftsChangeRequests{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}")
                                end
                                ## 
                                ...
                                def to_post_request_information(body, request_configuration=nil)
                                    ...
                                    request_info.url_template = '{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/schedule/swapShiftsChangeRequests'
                                    request_info.path_parameters = @path_parameters
                                ...
                                ## @return a swap_shifts_change_requests_request_builder
                                ## 
                                def with_url(raw_url)
                                    raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                                    return SwapShiftsChangeRequestsRequestBuilder.new(raw_url, @request_adapter)
                                end
