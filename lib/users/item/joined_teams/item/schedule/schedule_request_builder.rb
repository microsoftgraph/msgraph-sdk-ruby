...
module MicrosoftGraph::Users::Item::JoinedTeams::Item::Schedule
    ## 
    ...
    class ScheduleRequestBuilder
        ...
        def microsoft_graph_share()
            return MicrosoftGraph::Users::Item::JoinedTeams::Item::Schedule::MicrosoftGraphShare::ShareRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the offerShiftRequests property of the microsoft.graph.schedule entity.
        def offer_shift_requests()
            return MicrosoftGraph::Users::Item::JoinedTeams::Item::Schedule::OfferShiftRequests::OfferShiftRequestsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the openShiftChangeRequests property of the microsoft.graph.schedule entity.
        def open_shift_change_requests()
            return MicrosoftGraph::Users::Item::JoinedTeams::Item::Schedule::OpenShiftChangeRequests::OpenShiftChangeRequestsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the openShifts property of the microsoft.graph.schedule entity.
        def open_shifts()
            return MicrosoftGraph::Users::Item::JoinedTeams::Item::Schedule::OpenShifts::OpenShiftsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def shifts()
            return MicrosoftGraph::Users::Item::JoinedTeams::Item::Schedule::Shifts::ShiftsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the swapShiftsChangeRequests property of the microsoft.graph.schedule entity.
        def swap_shifts_change_requests()
            return MicrosoftGraph::Users::Item::JoinedTeams::Item::Schedule::SwapShiftsChangeRequests::SwapShiftsChangeRequestsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the timeOffReasons property of the microsoft.graph.schedule entity.
        def time_off_reasons()
            return MicrosoftGraph::Users::Item::JoinedTeams::Item::Schedule::TimeOffReasons::TimeOffReasonsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the timeOffRequests property of the microsoft.graph.schedule entity.
        def time_off_requests()
            return MicrosoftGraph::Users::Item::JoinedTeams::Item::Schedule::TimeOffRequests::TimeOffRequestsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the timesOff property of the microsoft.graph.schedule entity.
        def times_off()
            return MicrosoftGraph::Users::Item::JoinedTeams::Item::Schedule::TimesOff::TimesOffRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/schedule{?%24select,%24expand}"
        ...
        def offer_shift_requests_by_id(id)
            ...
            return MicrosoftGraph::Users::Item::JoinedTeams::Item::Schedule::OfferShiftRequests::Item::OfferShiftRequestItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the openShiftChangeRequests property of the microsoft.graph.schedule entity.
        ## @param id Unique identifier of the item
        ...
        def open_shifts_by_id(id)
            ...
            return MicrosoftGraph::Users::Item::JoinedTeams::Item::Schedule::OpenShifts::Item::OpenShiftItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def shifts_by_id(id)
            ...
            return MicrosoftGraph::Users::Item::JoinedTeams::Item::Schedule::Shifts::Item::ShiftItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the swapShiftsChangeRequests property of the microsoft.graph.schedule entity.
        ## @param id Unique identifier of the item
        ...
        def swap_shifts_change_requests_by_id(id)
            ...
            return MicrosoftGraph::Users::Item::JoinedTeams::Item::Schedule::SwapShiftsChangeRequests::Item::SwapShiftsChangeRequestItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the timeOffReasons property of the microsoft.graph.schedule entity.
        ## @param id Unique identifier of the item
        ...
        def time_off_reasons_by_id(id)
            ...
            return MicrosoftGraph::Users::Item::JoinedTeams::Item::Schedule::TimeOffReasons::Item::TimeOffReasonItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the timeOffRequests property of the microsoft.graph.schedule entity.
        ## @param id Unique identifier of the item
        ...
        def time_off_requests_by_id(id)
            ...
            return MicrosoftGraph::Users::Item::JoinedTeams::Item::Schedule::TimeOffRequests::Item::TimeOffRequestItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the timesOff property of the microsoft.graph.schedule entity.
        ## @param id Unique identifier of the item
