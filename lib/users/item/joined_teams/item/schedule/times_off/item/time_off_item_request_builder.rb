                    ...
                    module Schedule
                        module TimesOff
                            module Item
                                ...
                                class TimeOffItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                    ...
                                    def initialize(path_parameters, request_adapter)
                                        super(path_parameters, request_adapter, "{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/schedule/timesOff/{timeOff%2Did}{?%24select}")
                                    end
                                    ## 
                                    ...
                                    def to_delete_request_information(request_configuration=nil)
                                        ...
                                        request_info.url_template = '{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/schedule/timesOff/{timeOff%2Did}'
                                    ...
                                    def with_url(raw_url)
                                        ...
                                        return TimeOffItemRequestBuilder.new(raw_url, @request_adapter)
                                    end
