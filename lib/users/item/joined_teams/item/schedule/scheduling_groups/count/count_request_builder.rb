...
module MicrosoftGraph::Users::Item::JoinedTeams::Item::Schedule::SchedulingGroups::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/schedule/schedulingGroups/$count{?%24search,%24filter}"
