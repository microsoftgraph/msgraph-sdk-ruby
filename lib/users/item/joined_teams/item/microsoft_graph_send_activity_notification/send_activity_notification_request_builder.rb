...
require_relative '../item'
require_relative './microsoft_graph_send_activity_notification'

module MicrosoftGraph::Users::Item::JoinedTeams::Item::MicrosoftGraphSendActivityNotification
    ## 
    ...
    class SendActivityNotificationRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/microsoft.graph.sendActivityNotification"
