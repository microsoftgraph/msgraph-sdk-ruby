...
module MicrosoftGraph::Users::Item::JoinedTeams::Item::PrimaryChannel
    ## 
    ...
    class PrimaryChannelRequestBuilder
        ...
        def microsoft_graph_complete_migration()
            return MicrosoftGraph::Users::Item::JoinedTeams::Item::PrimaryChannel::MicrosoftGraphCompleteMigration::MicrosoftGraphCompleteMigrationRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def microsoft_graph_does_user_have_accessuser_id_user_id_tenant_id_tenant_id_user_principal_name_user_principal_name()
            return MicrosoftGraph::Users::Item::JoinedTeams::Item::PrimaryChannel::I36f5b8477c6e0b8381f1fe57d51b36baa914f57f3b0c51db1cfca75bc34f6227::MicrosoftGraphDoesUserHaveAccessuserIdUserIdTenantIdTenantIdUserPrincipalNameUserPrincipalNameRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the provisionEmail method.
        def microsoft_graph_provision_email()
            return MicrosoftGraph::Users::Item::JoinedTeams::Item::PrimaryChannel::MicrosoftGraphProvisionEmail::MicrosoftGraphProvisionEmailRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the removeEmail method.
        def microsoft_graph_remove_email()
            return MicrosoftGraph::Users::Item::JoinedTeams::Item::PrimaryChannel::MicrosoftGraphRemoveEmail::MicrosoftGraphRemoveEmailRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
