                ...
                module Item
                    module PrimaryChannel
                        ...
                        class PrimaryChannelRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            def all_members()
                                return MicrosoftGraph::Users::Item::JoinedTeams::Item::PrimaryChannel::AllMembers::AllMembersRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            # Provides operations to call the archive method.
                            def archive()
                                return MicrosoftGraph::Users::Item::JoinedTeams::Item::PrimaryChannel::Archive::ArchiveRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            ...
                            def unarchive()
                                return MicrosoftGraph::Users::Item::JoinedTeams::Item::PrimaryChannel::Unarchive::UnarchiveRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            ...
                            def initialize(path_parameters, request_adapter)
                                super(path_parameters, request_adapter, "{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/primaryChannel{?%24expand,%24select}")
                            end
                            ## 
