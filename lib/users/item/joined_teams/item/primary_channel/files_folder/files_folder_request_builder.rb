                    ...
                    module PrimaryChannel
                        module FilesFolder
                            ...
                            class FilesFolderRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                ...
                                def content()
                                    return MicrosoftGraph::Users::Item::JoinedTeams::Item::PrimaryChannel::FilesFolder::Content::ContentRequestBuilder.new(@path_parameters, @request_adapter)
                                end
                                ## 
                                ...
                                def initialize(path_parameters, request_adapter)
                                    super(path_parameters, request_adapter, "{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/primaryChannel/filesFolder{?%24select,%24expand}")
                                end
                                ## 
