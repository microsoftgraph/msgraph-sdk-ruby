                    ...
                    module PrimaryChannel
                        module Members
                            ...
                            class MembersRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                ...
                                def remove()
                                    return MicrosoftGraph::Users::Item::JoinedTeams::Item::PrimaryChannel::Members::Remove::RemoveRequestBuilder.new(@path_parameters, @request_adapter)
                                end
                                ## 
                                ## Provides operations to manage the members property of the microsoft.graph.channel entity.
                                ...
                                def initialize(path_parameters, request_adapter)
                                    super(path_parameters, request_adapter, "{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/primaryChannel/members{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}")
                                end
                                ## 
