...
module MicrosoftGraph::Users::Item::JoinedTeams::Item::PrimaryChannel::Messages::Item::HostedContents::Item
    ## 
    ...
    class ChatMessageHostedContentItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, chat_message_hosted_content_id=)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/primaryChannel/messages/{chatMessage%2Did}/hostedContents/{chatMessageHostedContent%2Did}{?%24select,%24expand}"
