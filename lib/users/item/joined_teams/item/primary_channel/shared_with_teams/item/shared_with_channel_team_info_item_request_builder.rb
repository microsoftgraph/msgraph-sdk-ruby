                        ...
                        module SharedWithTeams
                            module Item
                                ...
                                class SharedWithChannelTeamInfoItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                    ...
                                    def allowed_members()
                                        return MicrosoftGraph::Users::Item::JoinedTeams::Item::PrimaryChannel::SharedWithTeams::Item::AllowedMembers::AllowedMembersRequestBuilder.new(@path_parameters, @request_adapter)
                                    end
                                    ## 
                                    # Provides operations to manage the team property of the microsoft.graph.teamInfo entity.
                                    def team()
                                        return MicrosoftGraph::Users::Item::JoinedTeams::Item::PrimaryChannel::SharedWithTeams::Item::Team::TeamRequestBuilder.new(@path_parameters, @request_adapter)
                                    end
                                    ## 
                                    ...
                                    def initialize(path_parameters, request_adapter)
                                        super(path_parameters, request_adapter, "{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/primaryChannel/sharedWithTeams/{sharedWithChannelTeamInfo%2Did}{?%24expand,%24select}")
                                    end
                                    ## 
                                    ...
                                    def to_delete_request_information(request_configuration=nil)
                                        ...
                                        request_info.url_template = '{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/primaryChannel/sharedWithTeams/{sharedWithChannelTeamInfo%2Did}'
