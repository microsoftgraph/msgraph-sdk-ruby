            ...
            module JoinedTeams
                module Item
                    module Template
                        ...
                        class TemplateRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            def initialize(path_parameters, request_adapter)
                                super(path_parameters, request_adapter, "{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/template{?%24expand,%24select}")
                            end
                            ## 
                            ...
                            ## @return a template_request_builder
                            ## 
                            def with_url(raw_url)
                                raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                                return TemplateRequestBuilder.new(raw_url, @request_adapter)
                            end
