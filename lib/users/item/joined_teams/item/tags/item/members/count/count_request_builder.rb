...
module MicrosoftGraph::Users::Item::JoinedTeams::Item::Tags::Item::Members::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/tags/{teamworkTag%2Did}/members/$count{?%24search,%24filter}"
