...
module MicrosoftGraph::Users::Item::JoinedTeams::Item::Tags::Item
    ## 
    ...
    class TeamworkTagItemRequestBuilder
        ...
        def members()
            return MicrosoftGraph::Users::Item::JoinedTeams::Item::Tags::Item::Members::MembersRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, teamwork_tag_id=nil)
            raise StandardError, 'path_parameters cannot be null' if path_parameters.nil?
            raise StandardError, 'request_adapter cannot be null' if request_adapter.nil?
            @url_template = "{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/tags/{teamworkTag%2Did}{?%24select,%24expand}"
