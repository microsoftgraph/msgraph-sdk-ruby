                    ...
                    module SendActivityNotification
                        ...
                        class SendActivityNotificationRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            def initialize(path_parameters, request_adapter)
                                super(path_parameters, request_adapter, "{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/sendActivityNotification")
                            end
                            ## 
                            ...
                            ## @return a send_activity_notification_request_builder
                            ## 
                            def with_url(raw_url)
                                raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                                return SendActivityNotificationRequestBuilder.new(raw_url, @request_adapter)
                            end
                        end
                    end
                end
