...
module MicrosoftGraph::Users::Item::JoinedTeams::Item::MicrosoftGraphArchive
    ## 
    ...
    class ArchiveRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/microsoft.graph.archive"
