...
require_relative '../item'
require_relative './microsoft_graph_clone'

module MicrosoftGraph::Users::Item::JoinedTeams::Item::MicrosoftGraphClone
    ## 
    ...
    class CloneRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/microsoft.graph.clone"
