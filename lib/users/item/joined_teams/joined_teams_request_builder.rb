...
module MicrosoftGraph::Users::Item::JoinedTeams
    ...
    class JoinedTeamsRequestBuilder
        ...
        def microsoft_graph_get_all_messages()
            return MicrosoftGraph::Users::Item::JoinedTeams::MicrosoftGraphGetAllMessages::GetAllMessagesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/joinedTeams{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
