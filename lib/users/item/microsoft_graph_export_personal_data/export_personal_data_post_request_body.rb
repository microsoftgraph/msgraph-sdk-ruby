...
require_relative './microsoft_graph_export_personal_data'

module MicrosoftGraph::Users::Item::MicrosoftGraphExportPersonalData
    class ExportPersonalDataPostRequestBody
        ...
        ## @return a export_personal_data_post_request_body
        ## 
        def self.create_from_discriminator_value(parse_node)
            raise StandardError, 'parse_node cannot be null' if parse_node.nil?
            return ExportPersonalDataPostRequestBody.new
        end
        ## 
