...
require_relative '../item'
require_relative './microsoft_graph_disable_lost_mode'

module MicrosoftGraph::Users::Item::ManagedDevices::Item::MicrosoftGraphDisableLostMode
    ## 
    ...
    class DisableLostModeRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/managedDevices/{managedDevice%2Did}/microsoft.graph.disableLostMode"
