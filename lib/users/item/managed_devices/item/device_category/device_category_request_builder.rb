                ...
                module Item
                    module DeviceCategory
                        ...
                        class DeviceCategoryRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            def ref()
                                return MicrosoftGraph::Users::Item::ManagedDevices::Item::DeviceCategory::Ref::RefRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            ...
                            def initialize(path_parameters, request_adapter)
                                super(path_parameters, request_adapter, "{+baseurl}/users/{user%2Did}/managedDevices/{managedDevice%2Did}/deviceCategory{?%24expand,%24select}")
                            end
                            ## 
