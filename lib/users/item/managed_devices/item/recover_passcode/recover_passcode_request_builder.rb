                    ...
                    module RecoverPasscode
                        ...
                        class RecoverPasscodeRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            def initialize(path_parameters, request_adapter)
                                super(path_parameters, request_adapter, "{+baseurl}/users/{user%2Did}/managedDevices/{managedDevice%2Did}/recoverPasscode")
                            end
                            ## 
                            ## Recover passcode
                            ...
                            ## @return a recover_passcode_request_builder
                            ## 
                            def with_url(raw_url)
                                raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                                return RecoverPasscodeRequestBuilder.new(raw_url, @request_adapter)
                            end
                        end
                    end
                end
