                    ...
                    module RebootNow
                        ...
                        class RebootNowRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            def initialize(path_parameters, request_adapter)
                                super(path_parameters, request_adapter, "{+baseurl}/users/{user%2Did}/managedDevices/{managedDevice%2Did}/rebootNow")
                            end
                            ## 
                            ## Reboot device
                            ...
                            ## @return a reboot_now_request_builder
                            ## 
                            def with_url(raw_url)
                                raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                                return RebootNowRequestBuilder.new(raw_url, @request_adapter)
                            end
                        end
                    end
                end
