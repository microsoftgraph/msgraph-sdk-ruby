...
module MicrosoftGraph::Users::Item::ManagedDevices::Item::MicrosoftGraphRetire
    ## 
    ...
    class RetireRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/managedDevices/{managedDevice%2Did}/microsoft.graph.retire"
