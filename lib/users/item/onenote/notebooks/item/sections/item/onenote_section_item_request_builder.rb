...
module MicrosoftGraph::Users::Item::Onenote::Notebooks::Item::Sections::Item
    ## 
    ...
    class OnenoteSectionItemRequestBuilder
        ...
        def microsoft_graph_copy_to_notebook()
            return MicrosoftGraph::Users::Item::Onenote::Notebooks::Item::Sections::Item::MicrosoftGraphCopyToNotebook::CopyToNotebookRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the copyToSectionGroup method.
        def microsoft_graph_copy_to_section_group()
            return MicrosoftGraph::Users::Item::Onenote::Notebooks::Item::Sections::Item::MicrosoftGraphCopyToSectionGroup::CopyToSectionGroupRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the pages property of the microsoft.graph.onenoteSection entity.
        def pages()
            return MicrosoftGraph::Users::Item::Onenote::Notebooks::Item::Sections::Item::Pages::PagesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the parentNotebook property of the microsoft.graph.onenoteSection entity.
        def parent_notebook()
            return MicrosoftGraph::Users::Item::Onenote::Notebooks::Item::Sections::Item::ParentNotebook::ParentNotebookRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def parent_section_group()
            return MicrosoftGraph::Users::Item::Onenote::Notebooks::Item::Sections::Item::ParentSectionGroup::ParentSectionGroupRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter, onenote_section_id=nil)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/onenote/notebooks/{notebook%2Did}/sections/{onenoteSection%2Did}{?%24select,%24expand}"
        ...
        def pages_by_id(id)
            ...
            return MicrosoftGraph::Users::Item::Onenote::Notebooks::Item::Sections::Item::Pages::Item::OnenotePageItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
