        ...
        module Item
            module Onenote
                module Notebooks
                    ...
                    class NotebooksRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        
                        ## 
                        # Provides operations to count the resources in the collection.
                        def count()
                            return MicrosoftGraph::Users::Item::Onenote::Notebooks::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        # Provides operations to call the getNotebookFromWebUrl method.
                        def get_notebook_from_web_url()
                            return MicrosoftGraph::Users::Item::Onenote::Notebooks::GetNotebookFromWebUrl::GetNotebookFromWebUrlRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ## Provides operations to manage the notebooks property of the microsoft.graph.onenote entity.
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/users/{user%2Did}/onenote/notebooks{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}")
                        end
                        ## 
                        ...
                        def to_post_request_information(body, request_configuration=nil)
                            ...
                            request_info.url_template = '{+baseurl}/users/{user%2Did}/onenote/notebooks'
                            request_info.path_parameters = @path_parameters
                        ...
                        ## @return a notebooks_request_builder
                        ## 
                        def with_url(raw_url)
                            raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                            return NotebooksRequestBuilder.new(raw_url, @request_adapter)
                        end
