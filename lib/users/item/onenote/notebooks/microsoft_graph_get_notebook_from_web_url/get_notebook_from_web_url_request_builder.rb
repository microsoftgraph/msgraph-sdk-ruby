...
module MicrosoftGraph::Users::Item::Onenote::Notebooks::MicrosoftGraphGetNotebookFromWebUrl
    ## 
    ...
    class GetNotebookFromWebUrlRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/onenote/notebooks/microsoft.graph.getNotebookFromWebUrl"
