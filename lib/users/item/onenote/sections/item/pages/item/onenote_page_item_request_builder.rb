                        ...
                        module Pages
                            module Item
                                ...
                                class OnenotePageItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                    ...
                                    def copy_to_section()
                                        return MicrosoftGraph::Users::Item::Onenote::Sections::Item::Pages::Item::CopyToSection::CopyToSectionRequestBuilder.new(@path_parameters, @request_adapter)
                                    end
                                    ## 
                                    # Provides operations to call the onenotePatchContent method.
                                    def onenote_patch_content()
                                        return MicrosoftGraph::Users::Item::Onenote::Sections::Item::Pages::Item::OnenotePatchContent::OnenotePatchContentRequestBuilder.new(@path_parameters, @request_adapter)
                                    end
                                    ## 
                                    ...
                                    def preview()
                                        return MicrosoftGraph::Users::Item::Onenote::Sections::Item::Pages::Item::Preview::PreviewRequestBuilder.new(@path_parameters, @request_adapter)
                                    end
                                    ## 
                                    ...
                                    def initialize(path_parameters, request_adapter)
                                        super(path_parameters, request_adapter, "{+baseurl}/users/{user%2Did}/onenote/sections/{onenoteSection%2Did}/pages/{onenotePage%2Did}{?%24expand,%24select}")
                                    end
                                    ## 
                                    ...
                                    def to_delete_request_information(request_configuration=nil)
                                        ...
                                        request_info.url_template = '{+baseurl}/users/{user%2Did}/onenote/sections/{onenoteSection%2Did}/pages/{onenotePage%2Did}'
