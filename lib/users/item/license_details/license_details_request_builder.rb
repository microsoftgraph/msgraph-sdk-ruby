...
require_relative '../../../models/license_details'
require_relative '../../../models/license_details_collection_response'
require_relative '../../../models/o_data_errors_o_data_error'
require_relative '../../users'
require_relative '../item'
require_relative './count/count_request_builder'
require_relative './get_teams_licensing_details/get_teams_licensing_details_request_builder'
...
module MicrosoftGraph
    module Users
        module Item
            module LicenseDetails
                ## 
                # Provides operations to manage the licenseDetails property of the microsoft.graph.user entity.
                class LicenseDetailsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def get_teams_licensing_details()
                        return MicrosoftGraph::Users::Item::LicenseDetails::GetTeamsLicensingDetails::GetTeamsLicensingDetailsRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ## Provides operations to manage the licenseDetails property of the microsoft.graph.user entity.
                    ...
                    def initialize(path_parameters, request_adapter)
                        super(path_parameters, request_adapter, "{+baseurl}/users/{user%2Did}/licenseDetails{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}")
                    end
                    ## 
                    ...
                    def get(request_configuration=nil)
                        ...
                        return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraph::Models::LicenseDetailsCollectionResponse.create_from_discriminator_value(pn) }, error_mapping)
                    end
                    ## 
                    ## Create new navigation property to licenseDetails for users
                    ## @param body The request body
                    ## @param request_configuration Configuration for the request such as headers, query parameters, and middleware options.
                    ## @return a Fiber of license_details
                    ## 
                    ...
                    ## @return a license_details_request_builder
                    ## 
                    def with_url(raw_url)
                        raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                        return LicenseDetailsRequestBuilder.new(raw_url, @request_adapter)
                    end
