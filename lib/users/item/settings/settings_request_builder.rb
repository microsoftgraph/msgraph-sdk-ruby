        ...
        module Item
            module Settings
                ...
                class SettingsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def item_insights()
                        return MicrosoftGraph::Users::Item::Settings::ItemInsights::ItemInsightsRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ...
                    def storage()
                        return MicrosoftGraph::Users::Item::Settings::Storage::StorageRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
