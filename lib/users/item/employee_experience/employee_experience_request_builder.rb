...
require_relative '../../../models/employee_experience_user'
            ...
            module EmployeeExperience
                ...
                class EmployeeExperienceRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def learning_course_activities()
                        return MicrosoftGraph::Users::Item::EmployeeExperience::LearningCourseActivities::LearningCourseActivitiesRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ...
                    def initialize(path_parameters, request_adapter)
                        super(path_parameters, request_adapter, "{+baseurl}/users/{user%2Did}/employeeExperience{?%24expand,%24select}")
                    end
                    ## 
                    ...
                    ## @param request_configuration Configuration for the request such as headers, query parameters, and middleware options.
                    ## @return a Fiber of employee_experience_user
                    ## 
                    def get(request_configuration=nil)
                        ...
                        error_mapping = Hash.new
                        error_mapping["XXX"] = lambda {|pn| MicrosoftGraph::Models::ODataErrorsODataError.create_from_discriminator_value(pn) }
                        return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraph::Models::EmployeeExperienceUser.create_from_discriminator_value(pn) }, error_mapping)
                    end
                    ## 
                    ## Provides operations to manage the learningCourseActivities property of the microsoft.graph.employeeExperienceUser entity.
                    ...
                    def to_delete_request_information(request_configuration=nil)
                        ...
                        request_info.url_template = '{+baseurl}/users/{user%2Did}/employeeExperience'
