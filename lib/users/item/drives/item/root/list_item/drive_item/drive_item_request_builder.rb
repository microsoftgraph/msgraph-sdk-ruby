...
module MicrosoftGraph::Users::Item::Drives::Item::Root::ListItem::DriveItem
    ## 
    ...
    class DriveItemRequestBuilder
        ...
        def content()
            return MicrosoftGraph::Users::Item::Drives::Item::Root::ListItem::DriveItem::Content::ContentRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/drives/{drive%2Did}/root/listItem/driveItem{?%24select,%24expand}"
