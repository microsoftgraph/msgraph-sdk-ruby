...
module MicrosoftGraph::Users::Item::Drives::Item::Root::ListItem::DocumentSetVersions::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/drives/{drive%2Did}/root/listItem/documentSetVersions/$count{?%24search,%24filter}"
