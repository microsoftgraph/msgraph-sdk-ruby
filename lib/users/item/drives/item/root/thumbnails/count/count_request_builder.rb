...
module MicrosoftGraph::Users::Item::Drives::Item::Root::Thumbnails::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/drives/{drive%2Did}/root/thumbnails/$count{?%24search,%24filter}"
