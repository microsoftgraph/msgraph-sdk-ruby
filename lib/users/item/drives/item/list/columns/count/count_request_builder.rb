...
module MicrosoftGraph::Users::Item::Drives::Item::List::Columns::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/drives/{drive%2Did}/list/columns/$count{?%24search,%24filter}"
