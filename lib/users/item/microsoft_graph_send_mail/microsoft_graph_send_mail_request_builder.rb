...
require_relative './microsoft_graph_send_mail'

module MicrosoftGraph::Users::Item::MicrosoftGraphSendMail
    ## 
    ...
    class MicrosoftGraphSendMailRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/microsoft.graph.sendMail"
