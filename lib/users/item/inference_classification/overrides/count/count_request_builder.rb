...
module MicrosoftGraph::Users::Item::InferenceClassification::Overrides::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/inferenceClassification/overrides/$count{?%24filter}"
