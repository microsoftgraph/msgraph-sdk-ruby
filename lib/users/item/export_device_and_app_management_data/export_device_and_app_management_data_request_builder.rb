...
require_relative './export_device_and_app_management_data'

module MicrosoftGraph
    module Users
        module Item
            module ExportDeviceAndAppManagementData
                ## 
                # Provides operations to call the exportDeviceAndAppManagementData method.
                class ExportDeviceAndAppManagementDataRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def initialize(path_parameters, request_adapter)
                        super(path_parameters, request_adapter, "{+baseurl}/users/{user%2Did}/exportDeviceAndAppManagementData()")
                    end
                    ## 
                    ...
                    def with_url(raw_url)
                        ...
                        return ExportDeviceAndAppManagementDataRequestBuilder.new(raw_url, @request_adapter)
                    end
                end
            end
        end
