...
module MicrosoftGraph::Users::Item::Authentication::Methods::Item
    ...
    class AuthenticationMethodItemRequestBuilder
        ...
        def microsoft_graph_reset_password()
            return MicrosoftGraph::Users::Item::Authentication::Methods::Item::MicrosoftGraphResetPassword::MicrosoftGraphResetPasswordRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
