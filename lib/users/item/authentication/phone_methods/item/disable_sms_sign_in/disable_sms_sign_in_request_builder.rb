                        ...
                        module DisableSmsSignIn
                            ...
                            class DisableSmsSignInRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                ...
                                def initialize(path_parameters, request_adapter)
                                    super(path_parameters, request_adapter, "{+baseurl}/users/{user%2Did}/authentication/phoneMethods/{phoneAuthenticationMethod%2Did}/disableSmsSignIn")
                                end
                                ## 
                                ...
                                ## @return a disable_sms_sign_in_request_builder
                                ## 
                                def with_url(raw_url)
                                    raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                                    return DisableSmsSignInRequestBuilder.new(raw_url, @request_adapter)
                                end
                            end
                        end
                    end
