        ...
        module Item
            module Authentication
                module WindowsHelloForBusinessMethods
                    ...
                    class WindowsHelloForBusinessMethodsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/users/{user%2Did}/authentication/windowsHelloForBusinessMethods{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}")
                        end
                        ## 
                        ...
                        ## @return a Fiber of windows_hello_for_business_authentication_method_collection_response
                        ## 
                        ...
                        ## @return a windows_hello_for_business_methods_request_builder
                        ## 
                        def with_url(raw_url)
                            raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                            return WindowsHelloForBusinessMethodsRequestBuilder.new(raw_url, @request_adapter)
                        end
