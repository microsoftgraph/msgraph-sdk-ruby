...
module MicrosoftGraph::Users::Item::Authentication::WindowsHelloForBusinessMethods::Item
    ## 
    ...
    class WindowsHelloForBusinessAuthenticationMethodItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, windows_hello_for_business_authentication_method_id=nil)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/authentication/windowsHelloForBusinessMethods/{windowsHelloForBusinessAuthenticationMethod%2Did}{?%24select,%24expand}"
