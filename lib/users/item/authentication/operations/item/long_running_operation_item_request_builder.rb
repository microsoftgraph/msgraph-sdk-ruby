            ...
            module Authentication
                module Operations
                    module Item
                        ...
                        class LongRunningOperationItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            def initialize(path_parameters, request_adapter)
                                super(path_parameters, request_adapter, "{+baseurl}/users/{user%2Did}/authentication/operations/{longRunningOperation%2Did}{?%24expand,%24select}")
                            end
                            ## 
                            ...
                            ## @param request_configuration Configuration for the request such as headers, query parameters, and middleware options.
                            ## @return a Fiber of long_running_operation
                            ## 
                            ...
                            def to_delete_request_information(request_configuration=nil)
                                ...
                                request_info.url_template = '{+baseurl}/users/{user%2Did}/authentication/operations/{longRunningOperation%2Did}'
                            ...
                            def with_url(raw_url)
                                ...
                                return LongRunningOperationItemRequestBuilder.new(raw_url, @request_adapter)
                            end
