                ...
                module MicrosoftAuthenticatorMethods
                    module Item
                        ...
                        class MicrosoftAuthenticatorAuthenticationMethodItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            def device()
                                return MicrosoftGraph::Users::Item::Authentication::MicrosoftAuthenticatorMethods::Item::Device::DeviceRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            ...
                            def initialize(path_parameters, request_adapter)
                                super(path_parameters, request_adapter, "{+baseurl}/users/{user%2Did}/authentication/microsoftAuthenticatorMethods/{microsoftAuthenticatorAuthenticationMethod%2Did}{?%24expand,%24select}")
                            end
                            ## 
                            ...
                            def to_delete_request_information(request_configuration=nil)
                                ...
                                request_info.url_template = '{+baseurl}/users/{user%2Did}/authentication/microsoftAuthenticatorMethods/{microsoftAuthenticatorAuthenticationMethod%2Did}'
                            ...
                            def with_url(raw_url)
                                ...
                                return MicrosoftAuthenticatorAuthenticationMethodItemRequestBuilder.new(raw_url, @request_adapter)
                            end
