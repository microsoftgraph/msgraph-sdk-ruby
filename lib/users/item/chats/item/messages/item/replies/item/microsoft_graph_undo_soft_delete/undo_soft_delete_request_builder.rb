...
module MicrosoftGraph::Users::Item::Chats::Item::Messages::Item::Replies::Item::MicrosoftGraphUndoSoftDelete
    ## 
    ...
    class UndoSoftDeleteRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/chats/{chat%2Did}/messages/{chatMessage%2Did}/replies/{chatMessage%2Did1}/microsoft.graph.undoSoftDelete"
