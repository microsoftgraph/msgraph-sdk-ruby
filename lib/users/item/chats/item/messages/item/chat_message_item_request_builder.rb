...
module MicrosoftGraph::Users::Item::Chats::Item::Messages::Item
    ...
    class ChatMessageItemRequestBuilder
        ...
        def microsoft_graph_soft_delete()
            return MicrosoftGraph::Users::Item::Chats::Item::Messages::Item::MicrosoftGraphSoftDelete::MicrosoftGraphSoftDeleteRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the undoSoftDelete method.
        def microsoft_graph_undo_soft_delete()
            return MicrosoftGraph::Users::Item::Chats::Item::Messages::Item::MicrosoftGraphUndoSoftDelete::MicrosoftGraphUndoSoftDeleteRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def hosted_contents_by_id(id)
            ...
            return MicrosoftGraph::Users::Item::Chats::Item::Messages::Item::HostedContents::Item::ChatMessageHostedContentItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def replies_by_id(id)
            ...
            return MicrosoftGraph::Users::Item::Chats::Item::Messages::Item::Replies::Item::ChatMessageItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Delete navigation property messages for users
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
