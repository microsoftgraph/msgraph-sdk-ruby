...
module MicrosoftGraph::Users::Item::Chats::Item::Messages::Item::MicrosoftGraphUndoSoftDelete
    ## 
    ...
    class UndoSoftDeleteRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/chats/{chat%2Did}/messages/{chatMessage%2Did}/microsoft.graph.undoSoftDelete"
