                ...
                module Item
                    module Members
                        ...
                        class MembersRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            def remove()
                                return MicrosoftGraph::Users::Item::Chats::Item::Members::Remove::RemoveRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            ## Provides operations to manage the members property of the microsoft.graph.chat entity.
                            ...
                            def initialize(path_parameters, request_adapter)
                                super(path_parameters, request_adapter, "{+baseurl}/users/{user%2Did}/chats/{chat%2Did}/members{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}")
                            end
                            ## 
