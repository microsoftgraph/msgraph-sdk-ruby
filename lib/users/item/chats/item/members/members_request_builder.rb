...
module MicrosoftGraph::Users::Item::Chats::Item::Members
    ## 
    ...
    class MembersRequestBuilder
        ...
        def microsoft_graph_add()
            return MicrosoftGraph::Users::Item::Chats::Item::Members::MicrosoftGraphAdd::MicrosoftGraphAddRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/chats/{chat%2Did}/members{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
