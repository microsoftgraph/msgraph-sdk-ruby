                    ...
                    module PinnedMessages
                        module Item
                            module Message
                                ...
                                class MessageRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                    ...
                                    def initialize(path_parameters, request_adapter)
                                        super(path_parameters, request_adapter, "{+baseurl}/users/{user%2Did}/chats/{chat%2Did}/pinnedMessages/{pinnedChatMessageInfo%2Did}/message{?%24select,%24expand}")
                                    end
                                    ## 
                                    ...
                                    def with_url(raw_url)
                                        ...
                                        return MessageRequestBuilder.new(raw_url, @request_adapter)
                                    end
