...
module MicrosoftGraph::Users::Item::Chats::Item
    ## 
    ...
    class ChatItemRequestBuilder
        ...
        def microsoft_graph_hide_for_user()
            return MicrosoftGraph::Users::Item::Chats::Item::MicrosoftGraphHideForUser::HideForUserRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the markChatReadForUser method.
        def microsoft_graph_mark_chat_read_for_user()
            return MicrosoftGraph::Users::Item::Chats::Item::MicrosoftGraphMarkChatReadForUser::MarkChatReadForUserRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the markChatUnreadForUser method.
        def microsoft_graph_mark_chat_unread_for_user()
            return MicrosoftGraph::Users::Item::Chats::Item::MicrosoftGraphMarkChatUnreadForUser::MarkChatUnreadForUserRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the sendActivityNotification method.
        def microsoft_graph_send_activity_notification()
            return MicrosoftGraph::Users::Item::Chats::Item::MicrosoftGraphSendActivityNotification::SendActivityNotificationRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the unhideForUser method.
        def microsoft_graph_unhide_for_user()
            return MicrosoftGraph::Users::Item::Chats::Item::MicrosoftGraphUnhideForUser::UnhideForUserRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def pinned_messages()
            return MicrosoftGraph::Users::Item::Chats::Item::PinnedMessages::PinnedMessagesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, chat_id=nil)
            raise StandardError, 'path_parameters cannot be null' if path_parameters.nil?
            raise StandardError, 'request_adapter cannot be null' if request_adapter.nil?
            @url_template = "{+baseurl}/users/{user%2Did}/chats/{chat%2Did}{?%24select,%24expand}"
