...
module MicrosoftGraph::Users::Item::TransitiveMemberOf::Item::MicrosoftGraphGroup
    ## 
    ...
    class GroupRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/transitiveMemberOf/{directoryObject%2Did}/microsoft.graph.group{?%24select,%24expand}"
