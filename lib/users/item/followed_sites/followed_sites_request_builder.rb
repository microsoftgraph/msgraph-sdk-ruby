        ...
        module Item
            module FollowedSites
                ...
                class FollowedSitesRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def add()
                        return MicrosoftGraph::Users::Item::FollowedSites::Add::AddRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ...
                    def remove()
                        return MicrosoftGraph::Users::Item::FollowedSites::Remove::RemoveRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ## Provides operations to manage the followedSites property of the microsoft.graph.user entity.
                    ...
                    def initialize(path_parameters, request_adapter)
                        super(path_parameters, request_adapter, "{+baseurl}/users/{user%2Did}/followedSites{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}")
                    end
                    ## 
                    ...
                    ## @return a followed_sites_request_builder
                    ## 
                    def with_url(raw_url)
                        raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                        return FollowedSitesRequestBuilder.new(raw_url, @request_adapter)
                    end
