    ...
    module Users
        module Item
            module GetMemberObjects
                class GetMemberObjectspostResponse < MicrosoftGraph::Models::BaseCollectionPaginationCountResponse
                    ...
                    ## @return a get_member_objectspost_response
                    ## 
                    def self.create_from_discriminator_value(parse_node)
                        raise StandardError, 'parse_node cannot be null' if parse_node.nil?
                        return GetMemberObjectspostResponse.new
                    end
                    ## 
