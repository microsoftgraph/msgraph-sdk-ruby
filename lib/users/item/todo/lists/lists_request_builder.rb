...
module MicrosoftGraph::Users::Item::Todo::Lists
    ## 
    ...
    class ListsRequestBuilder
        ...
        def count()
            return MicrosoftGraph::Users::Item::Todo::Lists::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the delta method.
        def microsoft_graph_delta()
            return MicrosoftGraph::Users::Item::Todo::Lists::MicrosoftGraphDelta::MicrosoftGraphDeltaRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/todo/lists{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
        ...
        def get(request_configuration=nil)
            ...
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraph::Models::TodoTaskListCollectionResponse.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
