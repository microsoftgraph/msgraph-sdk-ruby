    ...
    module Users
        module Item
            module Todo
                ...
                class TodoRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    
                    ## 
                    # Provides operations to manage the lists property of the microsoft.graph.todo entity.
                    def lists()
                        return MicrosoftGraph::Users::Item::Todo::Lists::ListsRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ...
                    def initialize(path_parameters, request_adapter)
                        super(path_parameters, request_adapter, "{+baseurl}/users/{user%2Did}/todo{?%24expand,%24select}")
                    end
                    ## 
                    ...
                    def to_delete_request_information(request_configuration=nil)
                        ...
                        request_info.url_template = '{+baseurl}/users/{user%2Did}/todo'
                    ...
                    ## @return a todo_request_builder
                    ## 
                    def with_url(raw_url)
                        raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                        return TodoRequestBuilder.new(raw_url, @request_adapter)
                    end
