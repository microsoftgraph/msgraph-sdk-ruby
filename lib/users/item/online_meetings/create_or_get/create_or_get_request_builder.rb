        ...
        module Item
            module OnlineMeetings
                module CreateOrGet
                    ...
                    class CreateOrGetRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/users/{user%2Did}/onlineMeetings/createOrGet")
                        end
                        ## 
                        ...
                        ## @return a create_or_get_request_builder
                        ## 
                        def with_url(raw_url)
                            raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                            return CreateOrGetRequestBuilder.new(raw_url, @request_adapter)
                        end
                    end
                end
            end
