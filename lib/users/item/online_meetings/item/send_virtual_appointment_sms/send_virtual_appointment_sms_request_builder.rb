            ...
            module OnlineMeetings
                module Item
                    module SendVirtualAppointmentSms
                        ...
                        class SendVirtualAppointmentSmsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            def initialize(path_parameters, request_adapter)
                                super(path_parameters, request_adapter, "{+baseurl}/users/{user%2Did}/onlineMeetings/{onlineMeeting%2Did}/sendVirtualAppointmentSms")
                            end
                            ## 
                            ...
                            ## @return a send_virtual_appointment_sms_request_builder
                            ## 
                            def with_url(raw_url)
                                raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                                return SendVirtualAppointmentSmsRequestBuilder.new(raw_url, @request_adapter)
                            end
                        end
                    end
                end
