...
module MicrosoftGraph::Users::Item::Calendars::Item::CalendarView
    ...
    class CalendarViewRequestBuilder
        ...
        def microsoft_graph_delta()
            return MicrosoftGraph::Users::Item::Calendars::Item::CalendarView::MicrosoftGraphDelta::MicrosoftGraphDeltaRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
