...
module MicrosoftGraph::Users::Item::Calendars::Item::CalendarView::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/calendars/{calendar%2Did}/calendarView/$count{?%24filter}"
