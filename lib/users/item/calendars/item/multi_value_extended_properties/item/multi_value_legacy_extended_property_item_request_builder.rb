...
module MicrosoftGraph::Users::Item::Calendars::Item::MultiValueExtendedProperties::Item
    ## 
    ...
    class MultiValueLegacyExtendedPropertyItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, multi_value_legacy_extended_property_id=)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/calendars/{calendar%2Did}/multiValueExtendedProperties/{multiValueLegacyExtendedProperty%2Did}{?%24select,%24expand}"
