...
module MicrosoftGraph::Users::Item::Calendars::Item::Events::Item::MicrosoftGraphDecline
    ## 
    ...
    class DeclineRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/calendars/{calendar%2Did}/events/{event%2Did}/microsoft.graph.decline"
