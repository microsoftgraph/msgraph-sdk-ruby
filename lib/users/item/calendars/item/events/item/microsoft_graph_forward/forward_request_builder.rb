...
module MicrosoftGraph::Users::Item::Calendars::Item::Events::Item::MicrosoftGraphForward
    ## 
    ...
    class ForwardRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/calendars/{calendar%2Did}/events/{event%2Did}/microsoft.graph.forward"
