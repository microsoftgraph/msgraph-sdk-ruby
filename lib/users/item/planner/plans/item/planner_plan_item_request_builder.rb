...
module MicrosoftGraph::Users::Item::Planner::Plans::Item
    ## 
    ...
    class PlannerPlanItemRequestBuilder
        ...
        def buckets()
            return MicrosoftGraph::Users::Item::Planner::Plans::Item::Buckets::BucketsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the details property of the microsoft.graph.plannerPlan entity.
        def details()
            return MicrosoftGraph::Users::Item::Planner::Plans::Item::Details::DetailsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter, planner_plan_id=nil)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/planner/plans/{plannerPlan%2Did}{?%24select,%24expand}"
