...
module MicrosoftGraph::Users::Item::Planner::Plans::Item::Buckets::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/planner/plans/{plannerPlan%2Did}/buckets/$count{?%24search,%24filter}"
