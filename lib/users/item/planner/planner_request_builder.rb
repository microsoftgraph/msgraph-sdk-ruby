...
module MicrosoftGraph::Users::Item::Planner
    ## 
    ...
    class PlannerRequestBuilder
        ...
        def plans()
            return MicrosoftGraph::Users::Item::Planner::Plans::PlansRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def tasks()
            return MicrosoftGraph::Users::Item::Planner::Tasks::TasksRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/planner{?%24select,%24expand}"
