...
require_relative './microsoft_graph_export_device_and_app_management_data_with_skip_with_top'
...
module MicrosoftGraph::Users::Item::MicrosoftGraphExportDeviceAndAppManagementDataWithSkipWithTop
    ...
    class ExportDeviceAndAppManagementDataWithSkipWithTopRequestBuilder
        ...
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, skip=, top=)
            raise StandardError, 'path_parameters cannot be null' if path_parameters.nil?
            raise StandardError, 'request_adapter cannot be null' if request_adapter.nil?
            @url_template = "{+baseurl}/users/{user%2Did}/microsoft.graph.exportDeviceAndAppManagementData(skip={skip},top={top})"
