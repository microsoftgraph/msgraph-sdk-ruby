...
require_relative '../../../../models/outlook_category'
require_relative '../../../../models/outlook_category_collection_response'
...
module MicrosoftGraph
    module Users
        module Item
            module Outlook
                module MasterCategories
                    ## 
                    # Provides operations to manage the masterCategories property of the microsoft.graph.outlookUser entity.
                    class MasterCategoriesRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/users/{user%2Did}/outlook/masterCategories{?%24count,%24filter,%24orderby,%24select,%24skip,%24top}")
                        end
                        ## 
                        ...
                        def to_post_request_information(body, request_configuration=nil)
                            ...
                            request_info.url_template = '{+baseurl}/users/{user%2Did}/outlook/masterCategories'
                            request_info.path_parameters = @path_parameters
                        ...
                        ## @return a master_categories_request_builder
                        ## 
                        def with_url(raw_url)
                            raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                            return MasterCategoriesRequestBuilder.new(raw_url, @request_adapter)
                        end
