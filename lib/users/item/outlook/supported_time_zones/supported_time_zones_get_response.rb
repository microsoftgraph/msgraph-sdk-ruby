        ...
        module Item
            module Outlook
                module SupportedTimeZones
                    class SupportedTimeZonesGetResponse < MicrosoftGraph::Models::BaseCollectionPaginationCountResponse
                        ...
                        ## @return a supported_time_zones_get_response
                        ## 
                        def self.create_from_discriminator_value(parse_node)
                            raise StandardError, 'parse_node cannot be null' if parse_node.nil?
                            return SupportedTimeZonesGetResponse.new
                        end
                        ## 
