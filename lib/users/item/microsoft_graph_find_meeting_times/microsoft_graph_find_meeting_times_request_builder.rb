...
require_relative './microsoft_graph_find_meeting_times'

module MicrosoftGraph::Users::Item::MicrosoftGraphFindMeetingTimes
    ## 
    ...
    class MicrosoftGraphFindMeetingTimesRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/microsoft.graph.findMeetingTimes"
