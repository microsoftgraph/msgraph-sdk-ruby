                ...
                module Item
                    ...
                    class ContactItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def permanent_delete()
                            return MicrosoftGraph::Users::Item::Contacts::Item::PermanentDelete::PermanentDeleteRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/users/{user%2Did}/contacts/{contact%2Did}{?%24expand,%24select}")
                        end
                        ## 
