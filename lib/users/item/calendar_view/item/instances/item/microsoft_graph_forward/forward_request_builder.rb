...
module MicrosoftGraph::Users::Item::CalendarView::Item::Instances::Item::MicrosoftGraphForward
    ## 
    ...
    class ForwardRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/calendarView/{event%2Did}/instances/{event%2Did1}/microsoft.graph.forward"
