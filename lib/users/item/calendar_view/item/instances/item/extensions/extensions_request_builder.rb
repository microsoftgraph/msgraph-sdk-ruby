...
module MicrosoftGraph::Users::Item::CalendarView::Item::Instances::Item::Extensions
    ## 
    ...
    class ExtensionsRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/calendarView/{event%2Did}/instances/{event%2Did1}/extensions{?%24top,%24skip,%24filter,%24count,%24orderby,%24select,%24expand}"
