...
module MicrosoftGraph::Users::Item::CalendarView::Item::Instances::Item::SingleValueExtendedProperties::Item
    ## 
    ...
    class SingleValueLegacyExtendedPropertyItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, single_value_legacy_extended_property_id=)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/calendarView/{event%2Did}/instances/{event%2Did1}/singleValueExtendedProperties/{singleValueLegacyExtendedProperty%2Did}{?%24select,%24expand}"
