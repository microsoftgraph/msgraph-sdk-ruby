...
module MicrosoftGraph::Users::Item::CalendarView::Item::Attachments::MicrosoftGraphCreateUploadSession
    ## 
    ...
    class MicrosoftGraphCreateUploadSessionRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/calendarView/{event%2Did}/attachments/microsoft.graph.createUploadSession"
