...
module MicrosoftGraph::Users::Item::CalendarView::Item::MicrosoftGraphAccept
    ## 
    ...
    class AcceptRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/calendarView/{event%2Did}/microsoft.graph.accept"
