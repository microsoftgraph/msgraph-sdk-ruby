...
module MicrosoftGraph::Users::Item::OwnedObjects
    ...
    class OwnedObjectsRequestBuilder
        ...
        def microsoft_graph_application()
            return MicrosoftGraph::Users::Item::OwnedObjects::MicrosoftGraphApplication::ApplicationRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Casts the previous resource to group.
        def microsoft_graph_group()
            return MicrosoftGraph::Users::Item::OwnedObjects::MicrosoftGraphGroup::GroupRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Casts the previous resource to servicePrincipal.
        def microsoft_graph_service_principal()
            return MicrosoftGraph::Users::Item::OwnedObjects::MicrosoftGraphServicePrincipal::ServicePrincipalRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
