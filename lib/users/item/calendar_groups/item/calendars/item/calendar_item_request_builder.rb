...
module MicrosoftGraph::Users::Item::CalendarGroups::Item::Calendars::Item
    ...
    class CalendarItemRequestBuilder
        ...
        def microsoft_graph_get_schedule()
            return MicrosoftGraph::Users::Item::CalendarGroups::Item::Calendars::Item::MicrosoftGraphGetSchedule::GetScheduleRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the multiValueExtendedProperties property of the microsoft.graph.calendar entity.
        def multi_value_extended_properties()
            return MicrosoftGraph::Users::Item::CalendarGroups::Item::Calendars::Item::MultiValueExtendedProperties::MultiValueExtendedPropertiesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def single_value_extended_properties()
            return MicrosoftGraph::Users::Item::CalendarGroups::Item::Calendars::Item::SingleValueExtendedProperties::SingleValueExtendedPropertiesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter, calendar_id=nil)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/calendarGroups/{calendarGroup%2Did}/calendars/{calendar%2Did}{?%24select}"
        ...
        def events_by_id(id)
            ...
            url_tpl_params = @path_parameters.clone
            url_tpl_params["event%2Did"] = id
            return MicrosoftGraph::Users::Item::CalendarGroups::Item::Calendars::Item::Events::Item::EventItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
