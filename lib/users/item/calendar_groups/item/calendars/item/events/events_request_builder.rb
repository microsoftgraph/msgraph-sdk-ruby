...
module MicrosoftGraph::Users::Item::CalendarGroups::Item::Calendars::Item::Events
    ...
    class EventsRequestBuilder
        ...
        def microsoft_graph_delta()
            return MicrosoftGraph::Users::Item::CalendarGroups::Item::Calendars::Item::Events::MicrosoftGraphDelta::DeltaRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
