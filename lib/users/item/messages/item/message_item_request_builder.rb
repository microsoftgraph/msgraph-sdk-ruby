...
module MicrosoftGraph::Users::Item::Messages::Item
    ...
    class MessageItemRequestBuilder
        ...
        def microsoft_graph_copy()
            return MicrosoftGraph::Users::Item::Messages::Item::MicrosoftGraphCopy::CopyRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the createForward method.
        def microsoft_graph_create_forward()
            return MicrosoftGraph::Users::Item::Messages::Item::MicrosoftGraphCreateForward::CreateForwardRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the createReply method.
        def microsoft_graph_create_reply()
            return MicrosoftGraph::Users::Item::Messages::Item::MicrosoftGraphCreateReply::CreateReplyRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the createReplyAll method.
        def microsoft_graph_create_reply_all()
            return MicrosoftGraph::Users::Item::Messages::Item::MicrosoftGraphCreateReplyAll::CreateReplyAllRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the forward method.
        def microsoft_graph_forward()
            return MicrosoftGraph::Users::Item::Messages::Item::MicrosoftGraphForward::ForwardRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the move method.
        def microsoft_graph_move()
            return MicrosoftGraph::Users::Item::Messages::Item::MicrosoftGraphMove::MoveRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the reply method.
        def microsoft_graph_reply()
            return MicrosoftGraph::Users::Item::Messages::Item::MicrosoftGraphReply::ReplyRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the replyAll method.
        def microsoft_graph_reply_all()
            return MicrosoftGraph::Users::Item::Messages::Item::MicrosoftGraphReplyAll::ReplyAllRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the send method.
        def microsoft_graph_send()
            return MicrosoftGraph::Users::Item::Messages::Item::MicrosoftGraphSend::SendRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
