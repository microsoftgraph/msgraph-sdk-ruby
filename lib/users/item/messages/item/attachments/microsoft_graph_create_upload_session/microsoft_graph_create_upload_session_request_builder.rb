...
module MicrosoftGraph::Users::Item::Messages::Item::Attachments::MicrosoftGraphCreateUploadSession
    ## 
    ...
    class MicrosoftGraphCreateUploadSessionRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/messages/{message%2Did}/attachments/microsoft.graph.createUploadSession"
