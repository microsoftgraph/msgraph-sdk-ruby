...
module MicrosoftGraph::Users::Item::Messages::Item::MicrosoftGraphCreateForward
    ## 
    ...
    class CreateForwardRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/messages/{message%2Did}/microsoft.graph.createForward"
