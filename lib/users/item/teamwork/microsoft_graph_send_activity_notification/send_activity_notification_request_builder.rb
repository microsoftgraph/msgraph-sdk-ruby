...
module MicrosoftGraph::Users::Item::Teamwork::MicrosoftGraphSendActivityNotification
    ## 
    ...
    class SendActivityNotificationRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/teamwork/microsoft.graph.sendActivityNotification"
