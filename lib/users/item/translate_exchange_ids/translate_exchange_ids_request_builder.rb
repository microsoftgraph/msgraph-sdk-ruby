        ...
        module Item
            module TranslateExchangeIds
                ...
                class TranslateExchangeIdsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    ## @return a Fiber of translate_exchange_idspost_response
                    ## 
                    def post(body, request_configuration=nil)
                        ...
                        return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraph::Users::Item::TranslateExchangeIds::TranslateExchangeIdspostResponse.create_from_discriminator_value(pn) }, error_mapping)
                    end
                    ## 
                    ## Translate identifiers of Outlook-related resources between formats.
                    ## @param body The request body
