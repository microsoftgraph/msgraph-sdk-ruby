    ...
    module Users
        module Item
            module TranslateExchangeIds
                class TranslateExchangeIdsPostResponse < MicrosoftGraph::Models::BaseCollectionPaginationCountResponse
                    include MicrosoftKiotaAbstractions::Parsable
                    ## 
                    # The value property
                    @value
                    ## 
                    ## Instantiates a new TranslateExchangeIdsPostResponse and sets the default values.
                    ## @return a void
                    ## 
                    def initialize()
                        super
                    ...
                    ## @return a translate_exchange_ids_post_response
                    ## 
                    def self.create_from_discriminator_value(parse_node)
                        raise StandardError, 'parse_node cannot be null' if parse_node.nil?
                        return TranslateExchangeIdsPostResponse.new
                    end
                    ## 
