...
module MicrosoftGraph::Users::Item::Calendar::SingleValueExtendedProperties::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/calendar/singleValueExtendedProperties/$count{?%24search,%24filter}"
