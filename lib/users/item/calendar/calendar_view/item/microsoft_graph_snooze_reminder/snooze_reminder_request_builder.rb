...
module MicrosoftGraph::Users::Item::Calendar::CalendarView::Item::MicrosoftGraphSnoozeReminder
    ## 
    ...
    class SnoozeReminderRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/calendar/calendarView/{event%2Did}/microsoft.graph.snoozeReminder"
