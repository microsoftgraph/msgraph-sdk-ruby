...
module MicrosoftGraph::Users::Item::Calendar::CalendarView::Item::Attachments::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/calendar/calendarView/{event%2Did}/attachments/$count{?%24filter}"
