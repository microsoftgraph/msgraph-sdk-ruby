...
module MicrosoftGraph::Users::Item::Calendar::CalendarPermissions::Item
    ## 
    ...
    class CalendarPermissionItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, calendar_permission_id=)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/calendar/calendarPermissions/{calendarPermission%2Did}{?%24select}"
