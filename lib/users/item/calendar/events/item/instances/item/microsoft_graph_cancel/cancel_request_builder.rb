...
module MicrosoftGraph::Users::Item::Calendar::Events::Item::Instances::Item::MicrosoftGraphCancel
    ## 
    ...
    class CancelRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/calendar/events/{event%2Did}/instances/{event%2Did1}/microsoft.graph.cancel"
