...
module MicrosoftGraph::Users::Item::Calendar::Events::Item::SingleValueExtendedProperties::Item
    ## 
    ...
    class SingleValueLegacyExtendedPropertyItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, single_value_legacy_extended_property_id=)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/calendar/events/{event%2Did}/singleValueExtendedProperties/{singleValueLegacyExtendedProperty%2Did}{?%24select,%24expand}"
