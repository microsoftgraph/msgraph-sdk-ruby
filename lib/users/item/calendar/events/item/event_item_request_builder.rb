                    ...
                    module Item
                        ...
                        class EventItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            def exception_occurrences()
                                return MicrosoftGraph::Users::Item::Calendar::Events::Item::ExceptionOccurrences::ExceptionOccurrencesRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            ...
                            def permanent_delete()
                                return MicrosoftGraph::Users::Item::Calendar::Events::Item::PermanentDelete::PermanentDeleteRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
