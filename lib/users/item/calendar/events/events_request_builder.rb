...
module MicrosoftGraph::Users::Item::Calendar::Events
    ## 
    ...
    class EventsRequestBuilder
        ...
        def count()
            return MicrosoftGraph::Users::Item::Calendar::Events::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the delta method.
        def microsoft_graph_delta()
            return MicrosoftGraph::Users::Item::Calendar::Events::MicrosoftGraphDelta::MicrosoftGraphDeltaRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/calendar/events{?%24top,%24skip,%24filter,%24count,%24orderby,%24select}"
