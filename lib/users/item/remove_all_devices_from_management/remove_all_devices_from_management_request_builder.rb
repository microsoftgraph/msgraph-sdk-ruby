            ...
            module RemoveAllDevicesFromManagement
                ...
                class RemoveAllDevicesFromManagementRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def initialize(path_parameters, request_adapter)
                        super(path_parameters, request_adapter, "{+baseurl}/users/{user%2Did}/removeAllDevicesFromManagement")
                    end
                    ## 
                    ...
                    ## @return a remove_all_devices_from_management_request_builder
                    ## 
                    def with_url(raw_url)
                        raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                        return RemoveAllDevicesFromManagementRequestBuilder.new(raw_url, @request_adapter)
                    end
                end
            end
        end
