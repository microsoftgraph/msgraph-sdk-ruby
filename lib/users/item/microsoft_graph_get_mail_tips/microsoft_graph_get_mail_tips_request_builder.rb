...
require_relative './microsoft_graph_get_mail_tips'

module MicrosoftGraph::Users::Item::MicrosoftGraphGetMailTips
    ## 
    ...
    class MicrosoftGraphGetMailTipsRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/microsoft.graph.getMailTips"
        ...
        def post(body, request_configuration=nil)
            ...
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraph::Users::Item::MicrosoftGraphGetMailTips::GetMailTipsResponse.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
        ## Get the MailTips of one or more recipients as available to the signed-in user. Note that by making a `POST` call to the `getMailTips` action, you can request specific types of MailTips to be returned for more than one recipient at one time. The requested MailTips are returned in a mailTips collection.
        ## @param body The request body
