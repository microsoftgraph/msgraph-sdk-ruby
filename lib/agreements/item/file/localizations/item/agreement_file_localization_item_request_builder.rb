...
module MicrosoftGraph::Agreements::Item::File::Localizations::Item
    ## 
    ...
    class AgreementFileLocalizationItemRequestBuilder
        ...
        def versions()
            return MicrosoftGraph::Agreements::Item::File::Localizations::Item::Versions::VersionsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter, agreement_file_localization_id=nil)
            ...
            @url_template = "{+baseurl}/agreements/{agreement%2Did}/file/localizations/{agreementFileLocalization%2Did}{?%24select,%24expand}"
