        ...
        module Item
            module File
                module Localizations
                    ...
                    class LocalizationsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        
                        ## 
                        # Provides operations to count the resources in the collection.
                        def count()
                            return MicrosoftGraph::Agreements::Item::File::Localizations::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ## Provides operations to manage the localizations property of the microsoft.graph.agreementFile entity.
                        ...
                        def by_agreement_file_localization_id(agreement_file_localization_id)
                            ...
                            return MicrosoftGraph::Agreements::Item::File::Localizations::Item::AgreementFileLocalizationItemRequestBuilder.new(url_tpl_params, @request_adapter)
                        end
                        ## 
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/agreements/{agreement%2Did}/file/localizations{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}")
                        end
                        ## 
                        ...
                        def to_post_request_information(body, request_configuration=nil)
                            ...
                            request_info.url_template = '{+baseurl}/agreements/{agreement%2Did}/file/localizations'
                            request_info.path_parameters = @path_parameters
                        ...
                        ## @return a localizations_request_builder
                        ## 
                        def with_url(raw_url)
                            raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                            return LocalizationsRequestBuilder.new(raw_url, @request_adapter)
                        end
