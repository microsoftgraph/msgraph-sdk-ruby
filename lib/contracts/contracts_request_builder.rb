...
require_relative './item/contract_item_request_builder'
...
module MicrosoftGraph
    module Contracts
        ...
        class ContractsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
            ...
            def by_contract_id(contract_id)
                raise StandardError, 'contract_id cannot be null' if contract_id.nil?
            ...
            def initialize(path_parameters, request_adapter)
                super(path_parameters, request_adapter, "{+baseurl}/contracts{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}")
            end
            ## 
            ...
            def to_post_request_information(body, request_configuration=nil)
                ...
                request_info.url_template = '{+baseurl}/contracts'
                request_info.path_parameters = @path_parameters
            ...
            ## @return a contracts_request_builder
            ## 
            def with_url(raw_url)
                raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                return ContractsRequestBuilder.new(raw_url, @request_adapter)
            end
