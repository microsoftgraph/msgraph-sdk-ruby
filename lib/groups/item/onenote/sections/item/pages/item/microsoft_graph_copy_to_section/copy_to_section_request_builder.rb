...
module MicrosoftGraph::Groups::Item::Onenote::Sections::Item::Pages::Item::MicrosoftGraphCopyToSection
    ## 
    ...
    class CopyToSectionRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/onenote/sections/{onenoteSection%2Did}/pages/{onenotePage%2Did}/microsoft.graph.copyToSection"
