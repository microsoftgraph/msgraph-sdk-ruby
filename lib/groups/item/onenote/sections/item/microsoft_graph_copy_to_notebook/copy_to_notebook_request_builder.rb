...
module MicrosoftGraph::Groups::Item::Onenote::Sections::Item::MicrosoftGraphCopyToNotebook
    ## 
    ...
    class CopyToNotebookRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/onenote/sections/{onenoteSection%2Did}/microsoft.graph.copyToNotebook"
