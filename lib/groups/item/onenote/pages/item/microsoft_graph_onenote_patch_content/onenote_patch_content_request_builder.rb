...
module MicrosoftGraph::Groups::Item::Onenote::Pages::Item::MicrosoftGraphOnenotePatchContent
    ## 
    ...
    class OnenotePatchContentRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/onenote/pages/{onenotePage%2Did}/microsoft.graph.onenotePatchContent"
