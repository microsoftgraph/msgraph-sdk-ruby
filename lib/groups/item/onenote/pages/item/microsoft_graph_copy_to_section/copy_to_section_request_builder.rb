...
module MicrosoftGraph::Groups::Item::Onenote::Pages::Item::MicrosoftGraphCopyToSection
    ## 
    ...
    class CopyToSectionRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/onenote/pages/{onenotePage%2Did}/microsoft.graph.copyToSection"
