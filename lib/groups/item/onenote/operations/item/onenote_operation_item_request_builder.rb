...
module MicrosoftGraph::Groups::Item::Onenote::Operations::Item
    ## 
    ...
    class OnenoteOperationItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, onenote_operation_id=nil)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/onenote/operations/{onenoteOperation%2Did}{?%24select,%24expand}"
