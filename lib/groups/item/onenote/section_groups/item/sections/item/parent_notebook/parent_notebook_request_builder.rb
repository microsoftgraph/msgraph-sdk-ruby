...
module MicrosoftGraph::Groups::Item::Onenote::SectionGroups::Item::Sections::Item::ParentNotebook
    ## 
    ...
    class ParentNotebookRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/onenote/sectionGroups/{sectionGroup%2Did}/sections/{onenoteSection%2Did}/parentNotebook{?%24select,%24expand}"
