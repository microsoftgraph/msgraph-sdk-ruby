                        ...
                        module Sections
                            module Item
                                ...
                                class OnenoteSectionItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                    ...
                                    def pages()
                                        return MicrosoftGraph::Groups::Item::Onenote::SectionGroups::Item::Sections::Item::Pages::PagesRequestBuilder.new(@path_parameters, @request_adapter)
                                    end
                                    ## 
                                    # Provides operations to manage the parentNotebook property of the microsoft.graph.onenoteSection entity.
                                    def parent_notebook()
                                        return MicrosoftGraph::Groups::Item::Onenote::SectionGroups::Item::Sections::Item::ParentNotebook::ParentNotebookRequestBuilder.new(@path_parameters, @request_adapter)
                                    end
                                    ## 
                                    ...
                                    def parent_section_group()
                                        return MicrosoftGraph::Groups::Item::Onenote::SectionGroups::Item::Sections::Item::ParentSectionGroup::ParentSectionGroupRequestBuilder.new(@path_parameters, @request_adapter)
                                    end
                                    ## 
                                    ...
                                    def initialize(path_parameters, request_adapter)
                                        super(path_parameters, request_adapter, "{+baseurl}/groups/{group%2Did}/onenote/sectionGroups/{sectionGroup%2Did}/sections/{onenoteSection%2Did}{?%24select,%24expand}")
                                    end
                                    ## 
