                    ...
                    module GetRecentNotebooksWithIncludePersonalNotebooks
                        ...
                        class GetRecentNotebooksWithIncludePersonalNotebooksRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            def initialize(path_parameters, request_adapter, include_personal_notebooks=nil)
                                super(path_parameters, request_adapter, "{+baseurl}/groups/{group%2Did}/onenote/notebooks/getRecentNotebooks(includePersonalNotebooks={includePersonalNotebooks}){?%24count,%24filter,%24search,%24skip,%24top}")
                            end
                            ## 
                            ...
                            def get(request_configuration=nil)
                                ...
                                return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraph::Groups::Item::Onenote::Notebooks::GetRecentNotebooksWithIncludePersonalNotebooks::GetRecentNotebooksWithIncludePersonalNotebooksGetResponse.create_from_discriminator_value(pn) }, error_mapping)
                            end
                            ## 
                            ## Invoke function getRecentNotebooks
                            ## @param request_configuration Configuration for the request such as headers, query parameters, and middleware options.
