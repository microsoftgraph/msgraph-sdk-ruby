...
module MicrosoftGraph::Groups::Item::Onenote::Notebooks::MicrosoftGraphGetNotebookFromWebUrl
    ## 
    ...
    class GetNotebookFromWebUrlRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/onenote/notebooks/microsoft.graph.getNotebookFromWebUrl"
