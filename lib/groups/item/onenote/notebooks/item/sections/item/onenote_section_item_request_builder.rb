...
module MicrosoftGraph::Groups::Item::Onenote::Notebooks::Item::Sections::Item
    ...
    class OnenoteSectionItemRequestBuilder
        ...
        def microsoft_graph_copy_to_notebook()
            return MicrosoftGraph::Groups::Item::Onenote::Notebooks::Item::Sections::Item::MicrosoftGraphCopyToNotebook::MicrosoftGraphCopyToNotebookRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the copyToSectionGroup method.
        def microsoft_graph_copy_to_section_group()
            return MicrosoftGraph::Groups::Item::Onenote::Notebooks::Item::Sections::Item::MicrosoftGraphCopyToSectionGroup::MicrosoftGraphCopyToSectionGroupRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
