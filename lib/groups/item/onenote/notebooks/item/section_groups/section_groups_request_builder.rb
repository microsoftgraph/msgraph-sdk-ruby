                    ...
                    module Item
                        module SectionGroups
                            ...
                            class SectionGroupsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                ...
                                def count()
                                    return MicrosoftGraph::Groups::Item::Onenote::Notebooks::Item::SectionGroups::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                                end
                                ## 
                                ## Provides operations to manage the sectionGroups property of the microsoft.graph.notebook entity.
                                ...
                                ## 
                                def by_section_group_id(section_group_id)
                                    raise StandardError, 'section_group_id cannot be null' if section_group_id.nil?
                                ...
                                def initialize(path_parameters, request_adapter)
                                    super(path_parameters, request_adapter, "{+baseurl}/groups/{group%2Did}/onenote/notebooks/{notebook%2Did}/sectionGroups{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}")
                                end
                                ## 
                                ...
                                def to_post_request_information(body, request_configuration=nil)
                                    ...
                                    request_info.url_template = '{+baseurl}/groups/{group%2Did}/onenote/notebooks/{notebook%2Did}/sectionGroups'
                                    request_info.path_parameters = @path_parameters
                                ...
                                ## @return a section_groups_request_builder
                                ## 
                                def with_url(raw_url)
                                    raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                                    return SectionGroupsRequestBuilder.new(raw_url, @request_adapter)
                                end
