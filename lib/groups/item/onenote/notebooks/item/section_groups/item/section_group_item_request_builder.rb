...
module MicrosoftGraph::Groups::Item::Onenote::Notebooks::Item::SectionGroups::Item
    ## 
    ...
    class SectionGroupItemRequestBuilder
        ...
        def parent_notebook()
            return MicrosoftGraph::Groups::Item::Onenote::Notebooks::Item::SectionGroups::Item::ParentNotebook::ParentNotebookRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def parent_section_group()
            return MicrosoftGraph::Groups::Item::Onenote::Notebooks::Item::SectionGroups::Item::ParentSectionGroup::ParentSectionGroupRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def section_groups()
            return MicrosoftGraph::Groups::Item::Onenote::Notebooks::Item::SectionGroups::Item::SectionGroups::SectionGroupsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the sections property of the microsoft.graph.sectionGroup entity.
        def sections()
            return MicrosoftGraph::Groups::Item::Onenote::Notebooks::Item::SectionGroups::Item::Sections::SectionsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter, section_group_id=nil)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/onenote/notebooks/{notebook%2Did}/sectionGroups/{sectionGroup%2Did}{?%24select,%24expand}"
        ...
        def sections_by_id(id)
            ...
            return MicrosoftGraph::Groups::Item::Onenote::Notebooks::Item::SectionGroups::Item::Sections::Item::OnenoteSectionItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Delete navigation property sectionGroups for groups
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
