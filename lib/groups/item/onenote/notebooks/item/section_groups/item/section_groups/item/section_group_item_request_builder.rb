...
module MicrosoftGraph::Groups::Item::Onenote::Notebooks::Item::SectionGroups::Item::SectionGroups::Item
    ## 
    ...
    class SectionGroupItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, section_group_id1=nil)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/onenote/notebooks/{notebook%2Did}/sectionGroups/{sectionGroup%2Did}/sectionGroups/{sectionGroup%2Did1}{?%24select,%24expand}"
