...
module MicrosoftGraph::Groups::Item::Events::Item
    ...
    class EventItemRequestBuilder
        ...
        def microsoft_graph_accept()
            return MicrosoftGraph::Groups::Item::Events::Item::MicrosoftGraphAccept::AcceptRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the cancel method.
        def microsoft_graph_cancel()
            return MicrosoftGraph::Groups::Item::Events::Item::MicrosoftGraphCancel::CancelRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the decline method.
        def microsoft_graph_decline()
            return MicrosoftGraph::Groups::Item::Events::Item::MicrosoftGraphDecline::DeclineRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the dismissReminder method.
        def microsoft_graph_dismiss_reminder()
            return MicrosoftGraph::Groups::Item::Events::Item::MicrosoftGraphDismissReminder::DismissReminderRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the forward method.
        def microsoft_graph_forward()
            return MicrosoftGraph::Groups::Item::Events::Item::MicrosoftGraphForward::ForwardRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the snoozeReminder method.
        def microsoft_graph_snooze_reminder()
            return MicrosoftGraph::Groups::Item::Events::Item::MicrosoftGraphSnoozeReminder::SnoozeReminderRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the tentativelyAccept method.
        def microsoft_graph_tentatively_accept()
            return MicrosoftGraph::Groups::Item::Events::Item::MicrosoftGraphTentativelyAccept::TentativelyAcceptRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
