...
module MicrosoftGraph::Groups::Item::Events::Item::MicrosoftGraphSnoozeReminder
    ## 
    ...
    class SnoozeReminderRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/events/{event%2Did}/microsoft.graph.snoozeReminder"
