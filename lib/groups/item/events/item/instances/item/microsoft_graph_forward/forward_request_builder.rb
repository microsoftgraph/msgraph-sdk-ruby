...
module MicrosoftGraph::Groups::Item::Events::Item::Instances::Item::MicrosoftGraphForward
    ## 
    ...
    class ForwardRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/events/{event%2Did}/instances/{event%2Did1}/microsoft.graph.forward"
