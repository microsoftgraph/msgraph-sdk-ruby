...
require_relative './microsoft_graph_unsubscribe_by_mail'

module MicrosoftGraph::Groups::Item::MicrosoftGraphUnsubscribeByMail
    ## 
    ...
    class MicrosoftGraphUnsubscribeByMailRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/microsoft.graph.unsubscribeByMail"
