...
module MicrosoftGraph::Groups::Item::PermissionGrants::MicrosoftGraphValidateProperties
    ## 
    ...
    class ValidatePropertiesRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/permissionGrants/microsoft.graph.validateProperties"
