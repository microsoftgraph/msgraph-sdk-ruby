    ...
    module Groups
        module Item
            module SubscribeByMail
                ...
                class SubscribeByMailRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def initialize(path_parameters, request_adapter)
                        super(path_parameters, request_adapter, "{+baseurl}/groups/{group%2Did}/subscribeByMail")
                    end
                    ## 
                    ...
                    ## @return a subscribe_by_mail_request_builder
                    ## 
                    def with_url(raw_url)
                        raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                        return SubscribeByMailRequestBuilder.new(raw_url, @request_adapter)
                    end
                end
            end
        end
