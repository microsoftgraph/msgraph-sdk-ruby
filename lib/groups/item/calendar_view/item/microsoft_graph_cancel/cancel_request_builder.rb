...
module MicrosoftGraph::Groups::Item::CalendarView::Item::MicrosoftGraphCancel
    ## 
    ...
    class CancelRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/calendarView/{event%2Did}/microsoft.graph.cancel"
