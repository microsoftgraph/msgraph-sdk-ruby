...
module MicrosoftGraph::Groups::Item::CalendarView::Item::Attachments::MicrosoftGraphCreateUploadSession
    ## 
    ...
    class CreateUploadSessionRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/calendarView/{event%2Did}/attachments/microsoft.graph.createUploadSession"
