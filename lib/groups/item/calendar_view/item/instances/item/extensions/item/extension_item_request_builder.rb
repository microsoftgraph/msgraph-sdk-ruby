...
module MicrosoftGraph::Groups::Item::CalendarView::Item::Instances::Item::Extensions::Item
    ## 
    ...
    class ExtensionItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, extension_id=)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/calendarView/{event%2Did}/instances/{event%2Did1}/extensions/{extension%2Did}{?%24select,%24expand}"
