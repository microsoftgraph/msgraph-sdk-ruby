                                ...
                                module Item
                                    module Extensions
                                        ...
                                        class ExtensionsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                            ...
                                            def count()
                                                return MicrosoftGraph::Groups::Item::CalendarView::Item::Instances::Item::ExceptionOccurrences::Item::Extensions::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                                            end
                                            ## 
                                            ## Provides operations to manage the extensions property of the microsoft.graph.event entity.
                                            ...
                                            def by_extension_id(extension_id)
                                                ...
                                                return MicrosoftGraph::Groups::Item::CalendarView::Item::Instances::Item::ExceptionOccurrences::Item::Extensions::Item::ExtensionItemRequestBuilder.new(url_tpl_params, @request_adapter)
                                            end
                                            ## 
                                            ...
                                            def initialize(path_parameters, request_adapter)
                                                super(path_parameters, request_adapter, "{+baseurl}/groups/{group%2Did}/calendarView/{event%2Did}/instances/{event%2Did1}/exceptionOccurrences/{event%2Did2}/extensions{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}")
                                            end
                                            ## 
