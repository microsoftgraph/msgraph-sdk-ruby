...
module MicrosoftGraph::Groups::Item::CalendarView::Item::MicrosoftGraphForward
    ## 
    ...
    class MicrosoftGraphForwardRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/calendarView/{event%2Did}/microsoft.graph.forward"
