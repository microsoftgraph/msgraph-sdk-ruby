...
module MicrosoftGraph::Groups::Item::CalendarView
    ## 
    ...
    class CalendarViewRequestBuilder
        ...
        def microsoft_graph_delta()
            return MicrosoftGraph::Groups::Item::CalendarView::MicrosoftGraphDelta::MicrosoftGraphDeltaRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/calendarView{?startDateTime*,endDateTime*,%24top,%24skip,%24filter,%24count,%24orderby,%24select}"
