...
module MicrosoftGraph::Groups::Item::MembersWithLicenseErrors::Item::MicrosoftGraphUser
    ## 
    ...
    class UserRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/membersWithLicenseErrors/{directoryObject%2Did}/microsoft.graph.user{?%24select,%24expand}"
