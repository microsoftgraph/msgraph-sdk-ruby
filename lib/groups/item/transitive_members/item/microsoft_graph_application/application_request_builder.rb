...
module MicrosoftGraph::Groups::Item::TransitiveMembers::Item::MicrosoftGraphApplication
    ## 
    ...
    class ApplicationRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/transitiveMembers/{directoryObject%2Did}/microsoft.graph.application{?%24select,%24expand}"
