                ...
                module Item
                    ...
                    class ConversationItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/groups/{group%2Did}/conversations/{conversation%2Did}{?%24expand,%24select}")
                        end
                        ## 
                        ## Delete conversation.
                        ...
                        def with_url(raw_url)
                            ...
                            return ConversationItemRequestBuilder.new(raw_url, @request_adapter)
                        end
