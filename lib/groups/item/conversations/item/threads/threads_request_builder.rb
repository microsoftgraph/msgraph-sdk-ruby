...
require_relative '../../../../../models/conversation_thread_collection_response'
            ...
            module Conversations
                module Item
                    module Threads
                        ...
                        class ThreadsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            def initialize(path_parameters, request_adapter)
                                super(path_parameters, request_adapter, "{+baseurl}/groups/{group%2Did}/conversations/{conversation%2Did}/threads{?%24count,%24expand,%24filter,%24orderby,%24select,%24skip,%24top}")
                            end
                            ## 
                            ...
                            def to_post_request_information(body, request_configuration=nil)
                                ...
                                request_info.url_template = '{+baseurl}/groups/{group%2Did}/conversations/{conversation%2Did}/threads'
                                request_info.path_parameters = @path_parameters
                            ...
                            ## @return a threads_request_builder
                            ## 
                            def with_url(raw_url)
                                raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                                return ThreadsRequestBuilder.new(raw_url, @request_adapter)
                            end
