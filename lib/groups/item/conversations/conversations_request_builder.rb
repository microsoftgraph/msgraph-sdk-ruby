...
require_relative '../../../models/conversation_collection_response'
    ...
    module Groups
        module Item
            module Conversations
                ...
                class ConversationsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def initialize(path_parameters, request_adapter)
                        super(path_parameters, request_adapter, "{+baseurl}/groups/{group%2Did}/conversations{?%24count,%24filter,%24orderby,%24search,%24select,%24skip,%24top}")
                    end
                    ## 
                    ...
                    def to_post_request_information(body, request_configuration=nil)
                        ...
                        request_info.url_template = '{+baseurl}/groups/{group%2Did}/conversations'
                        request_info.path_parameters = @path_parameters
                    ...
                    ## @return a conversations_request_builder
                    ## 
                    def with_url(raw_url)
                        raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                        return ConversationsRequestBuilder.new(raw_url, @request_adapter)
                    end
