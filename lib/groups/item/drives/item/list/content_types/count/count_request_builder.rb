...
module MicrosoftGraph::Groups::Item::Drives::Item::List::ContentTypes::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/drives/{drive%2Did}/list/contentTypes/$count{?%24search,%24filter}"
