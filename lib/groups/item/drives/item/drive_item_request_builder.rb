...
module MicrosoftGraph::Groups::Item::Drives::Item
    ## 
    ...
    class DriveItemRequestBuilder
        ...
        def bundles()
            return MicrosoftGraph::Groups::Item::Drives::Item::Bundles::BundlesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the following property of the microsoft.graph.drive entity.
        def following()
            return MicrosoftGraph::Groups::Item::Drives::Item::Following::FollowingRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the items property of the microsoft.graph.drive entity.
        def items()
            return MicrosoftGraph::Groups::Item::Drives::Item::Items::ItemsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the list property of the microsoft.graph.drive entity.
        def list()
            return MicrosoftGraph::Groups::Item::Drives::Item::List::ListRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def root()
            return MicrosoftGraph::Groups::Item::Drives::Item::Root::RootRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the special property of the microsoft.graph.drive entity.
        def special()
            return MicrosoftGraph::Groups::Item::Drives::Item::Special::SpecialRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def bundles_by_id(id)
            ...
            return MicrosoftGraph::Groups::Item::Drives::Item::Bundles::Item::DriveItemItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/drives/{drive%2Did}{?%24select,%24expand}"
        ...
        def following_by_id(id)
            ...
            url_tpl_params = @path_parameters.clone
            url_tpl_params["driveItem%2Did"] = id
            return MicrosoftGraph::Groups::Item::Drives::Item::Following::Item::DriveItemItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def items_by_id(id)
            ...
            url_tpl_params = @path_parameters.clone
            url_tpl_params["driveItem%2Did"] = id
            return MicrosoftGraph::Groups::Item::Drives::Item::Items::Item::DriveItemItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def special_by_id(id)
            ...
            url_tpl_params = @path_parameters.clone
            url_tpl_params["driveItem%2Did"] = id
            return MicrosoftGraph::Groups::Item::Drives::Item::Special::Item::DriveItemItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Delete navigation property drives for groups
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
