...
module MicrosoftGraph::Groups::Item::Drives::Item::Root::Versions::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/drives/{drive%2Did}/root/versions/$count{?%24search,%24filter}"
