...
module MicrosoftGraph::Groups::Item::Drives::Item::Items::Item::Thumbnails::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/drives/{drive%2Did}/items/{driveItem%2Did}/thumbnails/$count{?%24search,%24filter}"
