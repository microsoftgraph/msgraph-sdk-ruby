...
module MicrosoftGraph::Groups::Item::Drives::Item::Items::Item::Unfollow
    ## 
    ...
    class UnfollowRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/drives/{drive%2Did}/items/{driveItem%2Did}/microsoft.graph.unfollow"
