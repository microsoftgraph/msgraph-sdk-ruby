...
module MicrosoftGraph::Groups::Item::Team::Tags::Item::Members::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/team/tags/{teamworkTag%2Did}/members/$count{?%24search,%24filter}"
