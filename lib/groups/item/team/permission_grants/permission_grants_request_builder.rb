                ...
                module PermissionGrants
                    ...
                    class PermissionGrantsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def by_resource_specific_permission_grant_id(resource_specific_permission_grant_id)
                            ...
                            return MicrosoftGraph::Groups::Item::Team::PermissionGrants::Item::ResourceSpecificPermissionGrantItemRequestBuilder.new(url_tpl_params, @request_adapter)
                        end
                        ## 
                        ...
                        def to_post_request_information(body, request_configuration=nil)
                            ...
                            request_info.url_template = '{+baseurl}/groups/{group%2Did}/team/permissionGrants'
                            request_info.path_parameters = @path_parameters
