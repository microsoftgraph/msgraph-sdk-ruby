...
module MicrosoftGraph::Groups::Item::Team::PrimaryChannel::Messages::Item
    ...
    class ChatMessageItemRequestBuilder
        ...
        def microsoft_graph_soft_delete()
            return MicrosoftGraph::Groups::Item::Team::PrimaryChannel::Messages::Item::MicrosoftGraphSoftDelete::SoftDeleteRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the undoSoftDelete method.
        def microsoft_graph_undo_soft_delete()
            return MicrosoftGraph::Groups::Item::Team::PrimaryChannel::Messages::Item::MicrosoftGraphUndoSoftDelete::UndoSoftDeleteRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
