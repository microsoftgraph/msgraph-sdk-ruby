...
module MicrosoftGraph::Groups::Item::Team::PrimaryChannel::Messages::Item::HostedContents::Item
    ## 
    ...
    class ChatMessageHostedContentItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, chat_message_hosted_content_id=)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/team/primaryChannel/messages/{chatMessage%2Did}/hostedContents/{chatMessageHostedContent%2Did}{?%24select,%24expand}"
