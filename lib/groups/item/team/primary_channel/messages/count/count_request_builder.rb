...
module MicrosoftGraph::Groups::Item::Team::PrimaryChannel::Messages::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/team/primaryChannel/messages/$count{?%24search,%24filter}"
