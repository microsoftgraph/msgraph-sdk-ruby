...
module MicrosoftGraph::Groups::Item::Team::PrimaryChannel::MicrosoftGraphProvisionEmail
    ## 
    ...
    class ProvisionEmailRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/team/primaryChannel/microsoft.graph.provisionEmail"
