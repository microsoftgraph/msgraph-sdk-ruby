                ...
                module PrimaryChannel
                    module AllMembers
                        ...
                        class AllMembersRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            def add()
                                return MicrosoftGraph::Groups::Item::Team::PrimaryChannel::AllMembers::Add::AddRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            # Provides operations to count the resources in the collection.
                            def count()
                                return MicrosoftGraph::Groups::Item::Team::PrimaryChannel::AllMembers::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            # Provides operations to call the remove method.
                            def remove()
                                return MicrosoftGraph::Groups::Item::Team::PrimaryChannel::AllMembers::Remove::RemoveRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            ## Provides operations to manage the allMembers property of the microsoft.graph.channel entity.
                            ...
                            def by_conversation_member_id(conversation_member_id)
                                ...
                                return MicrosoftGraph::Groups::Item::Team::PrimaryChannel::AllMembers::Item::ConversationMemberItemRequestBuilder.new(url_tpl_params, @request_adapter)
                            end
                            ## 
                            ...
                            def initialize(path_parameters, request_adapter)
                                super(path_parameters, request_adapter, "{+baseurl}/groups/{group%2Did}/team/primaryChannel/allMembers{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}")
                            end
                            ## 
