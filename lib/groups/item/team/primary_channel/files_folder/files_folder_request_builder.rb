...
module MicrosoftGraph::Groups::Item::Team::PrimaryChannel::FilesFolder
    ## 
    ...
    class FilesFolderRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/team/primaryChannel/filesFolder{?%24select,%24expand}"
