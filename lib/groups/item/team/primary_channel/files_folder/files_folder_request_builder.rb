                ...
                module PrimaryChannel
                    module FilesFolder
                        ...
                        class FilesFolderRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            def content()
                                return MicrosoftGraph::Groups::Item::Team::PrimaryChannel::FilesFolder::Content::ContentRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            ...
                            def initialize(path_parameters, request_adapter)
                                super(path_parameters, request_adapter, "{+baseurl}/groups/{group%2Did}/team/primaryChannel/filesFolder{?%24select,%24expand}")
                            end
                            ## 
