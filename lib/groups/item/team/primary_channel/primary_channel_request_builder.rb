...
module MicrosoftGraph::Groups::Item::Team::PrimaryChannel
    ## 
    ...
    class PrimaryChannelRequestBuilder
        ...
        def files_folder()
            return MicrosoftGraph::Groups::Item::Team::PrimaryChannel::FilesFolder::FilesFolderRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the members property of the microsoft.graph.channel entity.
        def members()
            return MicrosoftGraph::Groups::Item::Team::PrimaryChannel::Members::MembersRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def microsoft_graph_complete_migration()
            return MicrosoftGraph::Groups::Item::Team::PrimaryChannel::MicrosoftGraphCompleteMigration::MicrosoftGraphCompleteMigrationRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def microsoft_graph_provision_email()
            return MicrosoftGraph::Groups::Item::Team::PrimaryChannel::MicrosoftGraphProvisionEmail::MicrosoftGraphProvisionEmailRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the removeEmail method.
        def microsoft_graph_remove_email()
            return MicrosoftGraph::Groups::Item::Team::PrimaryChannel::MicrosoftGraphRemoveEmail::MicrosoftGraphRemoveEmailRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def shared_with_teams()
            return MicrosoftGraph::Groups::Item::Team::PrimaryChannel::SharedWithTeams::SharedWithTeamsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the tabs property of the microsoft.graph.channel entity.
        def tabs()
            return MicrosoftGraph::Groups::Item::Team::PrimaryChannel::Tabs::TabsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/team/primaryChannel{?%24select,%24expand}"
        ...
        def members_by_id(id)
            ...
            return MicrosoftGraph::Groups::Item::Team::PrimaryChannel::Members::Item::ConversationMemberItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the messages property of the microsoft.graph.channel entity.
        ## @param id Unique identifier of the item
        ...
        def messages_by_id(id)
            ...
            return MicrosoftGraph::Groups::Item::Team::PrimaryChannel::Messages::Item::ChatMessageItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def shared_with_teams_by_id(id)
            ...
            return MicrosoftGraph::Groups::Item::Team::PrimaryChannel::SharedWithTeams::Item::SharedWithChannelTeamInfoItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the tabs property of the microsoft.graph.channel entity.
        ## @param id Unique identifier of the item
        ...
        def tabs_by_id(id)
            ...
            return MicrosoftGraph::Groups::Item::Team::PrimaryChannel::Tabs::Item::TeamsTabItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Delete navigation property primaryChannel for groups
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
