...
module MicrosoftGraph::Groups::Item::Team::PrimaryChannel::Tabs::Item
    ## 
    ...
    class TeamsTabItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, teams_tab_id=nil)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/team/primaryChannel/tabs/{teamsTab%2Did}{?%24select,%24expand}"
