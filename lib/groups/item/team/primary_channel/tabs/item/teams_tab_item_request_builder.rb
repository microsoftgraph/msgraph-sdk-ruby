                    ...
                    module Tabs
                        module Item
                            ...
                            class TeamsTabItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                ...
                                def teams_app()
                                    return MicrosoftGraph::Groups::Item::Team::PrimaryChannel::Tabs::Item::TeamsApp::TeamsAppRequestBuilder.new(@path_parameters, @request_adapter)
                                end
                                ## 
                                ...
                                def initialize(path_parameters, request_adapter)
                                    super(path_parameters, request_adapter, "{+baseurl}/groups/{group%2Did}/team/primaryChannel/tabs/{teamsTab%2Did}{?%24expand,%24select}")
                                end
                                ## 
                                ...
                                def to_delete_request_information(request_configuration=nil)
                                    ...
                                    request_info.url_template = '{+baseurl}/groups/{group%2Did}/team/primaryChannel/tabs/{teamsTab%2Did}'
