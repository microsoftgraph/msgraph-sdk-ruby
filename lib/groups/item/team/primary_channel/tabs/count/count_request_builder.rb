...
module MicrosoftGraph::Groups::Item::Team::PrimaryChannel::Tabs::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/team/primaryChannel/tabs/$count{?%24search,%24filter}"
