                ...
                module Channels
                    ...
                    class ChannelsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def get_all_retained_messages()
                            return MicrosoftGraph::Groups::Item::Team::Channels::GetAllRetainedMessages::GetAllRetainedMessagesRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ## Provides operations to manage the channels property of the microsoft.graph.team entity.
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/groups/{group%2Did}/team/channels{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}")
                        end
                        ## 
