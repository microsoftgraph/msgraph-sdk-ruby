...
module MicrosoftGraph::Groups::Item::Team::Channels::Item::Tabs::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/team/channels/{channel%2Did}/tabs/$count{?%24search,%24filter}"
