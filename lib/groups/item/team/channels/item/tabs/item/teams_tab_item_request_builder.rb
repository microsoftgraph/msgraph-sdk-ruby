...
module MicrosoftGraph::Groups::Item::Team::Channels::Item::Tabs::Item
    ## 
    ...
    class TeamsTabItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, teams_tab_id=nil)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/team/channels/{channel%2Did}/tabs/{teamsTab%2Did}{?%24select,%24expand}"
