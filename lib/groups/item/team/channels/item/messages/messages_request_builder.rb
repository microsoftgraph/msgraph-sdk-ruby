...
module MicrosoftGraph::Groups::Item::Team::Channels::Item::Messages
    ...
    class MessagesRequestBuilder
        ...
        def microsoft_graph_delta()
            return MicrosoftGraph::Groups::Item::Team::Channels::Item::Messages::MicrosoftGraphDelta::MicrosoftGraphDeltaRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/team/channels/{channel%2Did}/messages{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
