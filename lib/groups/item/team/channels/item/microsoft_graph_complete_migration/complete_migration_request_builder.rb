...
module MicrosoftGraph::Groups::Item::Team::Channels::Item::MicrosoftGraphCompleteMigration
    ## 
    ...
    class CompleteMigrationRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/team/channels/{channel%2Did}/microsoft.graph.completeMigration"
