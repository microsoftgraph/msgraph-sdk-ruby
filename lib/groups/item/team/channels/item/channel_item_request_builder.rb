                ...
                module Channels
                    module Item
                        ...
                        class ChannelItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            def all_members()
                                return MicrosoftGraph::Groups::Item::Team::Channels::Item::AllMembers::AllMembersRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            # Provides operations to call the archive method.
                            def archive()
                                return MicrosoftGraph::Groups::Item::Team::Channels::Item::Archive::ArchiveRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            ...
                            def unarchive()
                                return MicrosoftGraph::Groups::Item::Team::Channels::Item::Unarchive::UnarchiveRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            ...
                            def initialize(path_parameters, request_adapter)
                                super(path_parameters, request_adapter, "{+baseurl}/groups/{group%2Did}/team/channels/{channel%2Did}{?%24expand,%24select}")
                            end
                            ## 
