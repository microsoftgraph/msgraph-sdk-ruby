...
module MicrosoftGraph::Groups::Item::Team::Channels::Item
    ## 
    ...
    class ChannelItemRequestBuilder
        ...
        def microsoft_graph_complete_migration()
            return MicrosoftGraph::Groups::Item::Team::Channels::Item::MicrosoftGraphCompleteMigration::CompleteMigrationRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def microsoft_graph_does_user_have_accessuser_id_user_id_tenant_id_tenant_id_user_principal_name_user_principal_name()
            return MicrosoftGraph::Groups::Item::Team::Channels::Item::MicrosoftGraphDoesUserHaveAccessuserIdUserIdTenantIdTenantIdUserPrincipalNameUserPrincipalName::DoesUserHaveAccessuserIdUserIdTenantIdTenantIdUserPrincipalNameUserPrincipalNameRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the provisionEmail method.
        def microsoft_graph_provision_email()
            return MicrosoftGraph::Groups::Item::Team::Channels::Item::MicrosoftGraphProvisionEmail::ProvisionEmailRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the removeEmail method.
        def microsoft_graph_remove_email()
            return MicrosoftGraph::Groups::Item::Team::Channels::Item::MicrosoftGraphRemoveEmail::RemoveEmailRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def members_by_id(id)
            ...
            return MicrosoftGraph::Groups::Item::Team::Channels::Item::Members::Item::ConversationMemberItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the messages property of the microsoft.graph.channel entity.
        ## @param id Unique identifier of the item
        ...
        def messages_by_id(id)
            ...
            return MicrosoftGraph::Groups::Item::Team::Channels::Item::Messages::Item::ChatMessageItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def shared_with_teams_by_id(id)
            ...
            return MicrosoftGraph::Groups::Item::Team::Channels::Item::SharedWithTeams::Item::SharedWithChannelTeamInfoItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the tabs property of the microsoft.graph.channel entity.
        ## @param id Unique identifier of the item
        ...
        def tabs_by_id(id)
            ...
            return MicrosoftGraph::Groups::Item::Team::Channels::Item::Tabs::Item::TeamsTabItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Delete navigation property channels for groups
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
