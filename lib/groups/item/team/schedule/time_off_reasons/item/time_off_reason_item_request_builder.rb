...
module MicrosoftGraph::Groups::Item::Team::Schedule::TimeOffReasons::Item
    ## 
    ...
    class TimeOffReasonItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, time_off_reason_id=nil)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/team/schedule/timeOffReasons/{timeOffReason%2Did}{?%24select}"
