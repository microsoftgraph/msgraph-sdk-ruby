...
module MicrosoftGraph::Groups::Item::Team::Schedule::OfferShiftRequests::Item
    ## 
    ...
    class OfferShiftRequestItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, offer_shift_request_id=)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/team/schedule/offerShiftRequests/{offerShiftRequest%2Did}{?%24select,%24expand}"
