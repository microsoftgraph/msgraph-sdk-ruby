...
module MicrosoftGraph::Groups::Item::Team::Schedule
    ## 
    ...
    class ScheduleRequestBuilder
        ...
        def microsoft_graph_share()
            return MicrosoftGraph::Groups::Item::Team::Schedule::MicrosoftGraphShare::MicrosoftGraphShareRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
