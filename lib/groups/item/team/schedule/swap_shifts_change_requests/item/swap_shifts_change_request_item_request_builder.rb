...
module MicrosoftGraph::Groups::Item::Team::Schedule::SwapShiftsChangeRequests::Item
    ## 
    ...
    class SwapShiftsChangeRequestItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, swap_shifts_change_request_id=nil)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/team/schedule/swapShiftsChangeRequests/{swapShiftsChangeRequest%2Did}{?%24select,%24expand}"
