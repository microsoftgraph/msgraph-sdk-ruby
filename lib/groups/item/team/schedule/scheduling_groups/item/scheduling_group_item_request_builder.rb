...
module MicrosoftGraph::Groups::Item::Team::Schedule::SchedulingGroups::Item
    ## 
    ...
    class SchedulingGroupItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, scheduling_group_id=)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/team/schedule/schedulingGroups/{schedulingGroup%2Did}{?%24select}"
