...
require_relative './reset_unseen_count'

module MicrosoftGraph
    module Groups
        module Item
            module ResetUnseenCount
                ## 
                # Provides operations to call the resetUnseenCount method.
                class ResetUnseenCountRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    ## @return a reset_unseen_count_request_builder
                    ## 
                    def with_url(raw_url)
                        raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                        return ResetUnseenCountRequestBuilder.new(raw_url, @request_adapter)
                    end
                end
            end
        end
