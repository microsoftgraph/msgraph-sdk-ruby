...
require_relative './microsoft_graph_assign_license'

module MicrosoftGraph::Groups::Item::MicrosoftGraphAssignLicense
    ## 
    ...
    class AssignLicenseRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/microsoft.graph.assignLicense"
