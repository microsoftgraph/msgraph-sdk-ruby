...
require_relative './microsoft_graph_add_favorite/microsoft_graph_add_favorite_request_builder'
require_relative './microsoft_graph_assign_license/microsoft_graph_assign_license_request_builder'
require_relative './microsoft_graph_check_granted_permissions_for_app/microsoft_graph_check_granted_permissions_for_app_request_builder'
...
require_relative './microsoft_graph_remove_favorite/microsoft_graph_remove_favorite_request_builder'
require_relative './microsoft_graph_renew/microsoft_graph_renew_request_builder'
require_relative './microsoft_graph_reset_unseen_count/microsoft_graph_reset_unseen_count_request_builder'
require_relative './microsoft_graph_restore/microsoft_graph_restore_request_builder'
require_relative './microsoft_graph_subscribe_by_mail/microsoft_graph_subscribe_by_mail_request_builder'
require_relative './microsoft_graph_unsubscribe_by_mail/microsoft_graph_unsubscribe_by_mail_request_builder'
...
module MicrosoftGraph::Groups::Item
    ...
    class GroupItemRequestBuilder
        ...
        def microsoft_graph_add_favorite()
            return MicrosoftGraph::Groups::Item::MicrosoftGraphAddFavorite::MicrosoftGraphAddFavoriteRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the assignLicense method.
        def microsoft_graph_assign_license()
            return MicrosoftGraph::Groups::Item::MicrosoftGraphAssignLicense::MicrosoftGraphAssignLicenseRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the checkGrantedPermissionsForApp method.
        def microsoft_graph_check_granted_permissions_for_app()
            return MicrosoftGraph::Groups::Item::MicrosoftGraphCheckGrantedPermissionsForApp::MicrosoftGraphCheckGrantedPermissionsForAppRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the checkMemberGroups method.
        def microsoft_graph_check_member_groups()
            return MicrosoftGraph::Groups::Item::MicrosoftGraphCheckMemberGroups::MicrosoftGraphCheckMemberGroupsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the checkMemberObjects method.
        def microsoft_graph_check_member_objects()
            return MicrosoftGraph::Groups::Item::MicrosoftGraphCheckMemberObjects::MicrosoftGraphCheckMemberObjectsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the getMemberGroups method.
        def microsoft_graph_get_member_groups()
            return MicrosoftGraph::Groups::Item::MicrosoftGraphGetMemberGroups::MicrosoftGraphGetMemberGroupsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the getMemberObjects method.
        def microsoft_graph_get_member_objects()
            return MicrosoftGraph::Groups::Item::MicrosoftGraphGetMemberObjects::MicrosoftGraphGetMemberObjectsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the removeFavorite method.
        def microsoft_graph_remove_favorite()
            return MicrosoftGraph::Groups::Item::MicrosoftGraphRemoveFavorite::MicrosoftGraphRemoveFavoriteRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the renew method.
        def microsoft_graph_renew()
            return MicrosoftGraph::Groups::Item::MicrosoftGraphRenew::MicrosoftGraphRenewRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the resetUnseenCount method.
        def microsoft_graph_reset_unseen_count()
            return MicrosoftGraph::Groups::Item::MicrosoftGraphResetUnseenCount::MicrosoftGraphResetUnseenCountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the restore method.
        def microsoft_graph_restore()
            return MicrosoftGraph::Groups::Item::MicrosoftGraphRestore::MicrosoftGraphRestoreRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the subscribeByMail method.
        def microsoft_graph_subscribe_by_mail()
            return MicrosoftGraph::Groups::Item::MicrosoftGraphSubscribeByMail::MicrosoftGraphSubscribeByMailRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the unsubscribeByMail method.
        def microsoft_graph_unsubscribe_by_mail()
            return MicrosoftGraph::Groups::Item::MicrosoftGraphUnsubscribeByMail::MicrosoftGraphUnsubscribeByMailRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the validateProperties method.
        def microsoft_graph_validate_properties()
            return MicrosoftGraph::Groups::Item::MicrosoftGraphValidateProperties::MicrosoftGraphValidatePropertiesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
