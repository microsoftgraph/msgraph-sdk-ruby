...
module MicrosoftGraph::Groups::Item::Settings::Item
    ## 
    ...
    class GroupSettingItemRequestBuilder
        ...
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, group_setting_id=)
            raise StandardError, 'path_parameters cannot be null' if path_parameters.nil?
            raise StandardError, 'request_adapter cannot be null' if request_adapter.nil?
            @url_template = "{+baseurl}/groups/{group%2Did}/settings/{groupSetting%2Did}{?%24select,%24expand}"
