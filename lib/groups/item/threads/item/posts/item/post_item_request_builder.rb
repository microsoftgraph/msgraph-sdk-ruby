...
module MicrosoftGraph::Groups::Item::Threads::Item::Posts::Item
    ## 
    ...
    class PostItemRequestBuilder
        ...
        def attachments()
            return MicrosoftGraph::Groups::Item::Threads::Item::Posts::Item::Attachments::AttachmentsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def microsoft_graph_forward()
            return MicrosoftGraph::Groups::Item::Threads::Item::Posts::Item::MicrosoftGraphForward::MicrosoftGraphForwardRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the reply method.
        def microsoft_graph_reply()
            return MicrosoftGraph::Groups::Item::Threads::Item::Posts::Item::MicrosoftGraphReply::MicrosoftGraphReplyRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
