...
module MicrosoftGraph::Groups::Item::Threads::Item::Posts::Item::InReplyTo::MicrosoftGraphForward
    ## 
    ...
    class ForwardRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/threads/{conversationThread%2Did}/posts/{post%2Did}/inReplyTo/microsoft.graph.forward"
