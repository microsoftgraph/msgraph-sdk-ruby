...
module MicrosoftGraph::Groups::Item::Threads::Item::Posts::Item::Attachments::Item
    ## 
    ...
    class AttachmentItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, attachment_id=nil)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/threads/{conversationThread%2Did}/posts/{post%2Did}/attachments/{attachment%2Did}{?%24select,%24expand}"
