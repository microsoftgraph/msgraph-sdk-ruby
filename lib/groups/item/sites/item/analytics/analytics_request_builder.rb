                ...
                module Item
                    module Analytics
                        ...
                        class AnalyticsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            def all_time()
                                return MicrosoftGraph::Groups::Item::Sites::Item::Analytics::AllTime::AllTimeRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            # Provides operations to manage the itemActivityStats property of the microsoft.graph.itemAnalytics entity.
                            def item_activity_stats()
                                return MicrosoftGraph::Groups::Item::Sites::Item::Analytics::ItemActivityStats::ItemActivityStatsRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            # Provides operations to manage the lastSevenDays property of the microsoft.graph.itemAnalytics entity.
                            def last_seven_days()
                                return MicrosoftGraph::Groups::Item::Sites::Item::Analytics::LastSevenDays::LastSevenDaysRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            ...
                            def initialize(path_parameters, request_adapter)
                                super(path_parameters, request_adapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/analytics{?%24expand,%24select}")
                            end
                            ## 
                            ...
                            def to_delete_request_information(request_configuration=nil)
                                ...
                                request_info.url_template = '{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/analytics'
