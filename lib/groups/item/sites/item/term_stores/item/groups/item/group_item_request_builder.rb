                            ...
                            module Groups
                                module Item
                                    ...
                                    class GroupItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                        ...
                                        def sets()
                                            return MicrosoftGraph::Groups::Item::Sites::Item::TermStores::Item::Groups::Item::Sets::SetsRequestBuilder.new(@path_parameters, @request_adapter)
                                        end
                                        ## 
                                        ...
                                        def initialize(path_parameters, request_adapter)
                                            super(path_parameters, request_adapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/termStores/{store%2Did}/groups/{group%2Did1}{?%24expand,%24select}")
                                        end
                                        ## 
                                        ...
                                        def to_delete_request_information(request_configuration=nil)
                                            ...
                                            request_info.url_template = '{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/termStores/{store%2Did}/groups/{group%2Did1}'
