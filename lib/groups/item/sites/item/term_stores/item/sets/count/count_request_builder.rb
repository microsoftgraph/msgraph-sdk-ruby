...
module MicrosoftGraph::Groups::Item::Sites::Item::TermStores::Item::Sets::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/termStores/{store%2Did}/sets/$count{?%24search,%24filter}"
