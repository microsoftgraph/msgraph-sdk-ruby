...
module MicrosoftGraph::Groups::Item::Sites::Item::TermStores::Item::Sets::Item::Terms::Item
    ## 
    ...
    class TermItemRequestBuilder
        ...
        def children()
            return MicrosoftGraph::Groups::Item::Sites::Item::TermStores::Item::Sets::Item::Terms::Item::Children::ChildrenRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def relations()
            return MicrosoftGraph::Groups::Item::Sites::Item::TermStores::Item::Sets::Item::Terms::Item::Relations::RelationsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def set()
            return MicrosoftGraph::Groups::Item::Sites::Item::TermStores::Item::Sets::Item::Terms::Item::Set::SetRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def children_by_id(id)
            ...
            return MicrosoftGraph::Groups::Item::Sites::Item::TermStores::Item::Sets::Item::Terms::Item::Children::Item::TermItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter, term_id=nil)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/termStores/{store%2Did}/sets/{set%2Did}/terms/{term%2Did}{?%24select,%24expand}"
        ...
        def relations_by_id(id)
            ...
            return MicrosoftGraph::Groups::Item::Sites::Item::TermStores::Item::Sets::Item::Terms::Item::Relations::Item::RelationItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Delete navigation property terms for groups
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
