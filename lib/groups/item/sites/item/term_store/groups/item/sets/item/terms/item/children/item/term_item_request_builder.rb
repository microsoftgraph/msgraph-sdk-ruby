...
module MicrosoftGraph::Groups::Item::Sites::Item::TermStore::Groups::Item::Sets::Item::Terms::Item::Children::Item
    ## 
    ...
    class TermItemRequestBuilder
        ...
        def relations()
            return MicrosoftGraph::Groups::Item::Sites::Item::TermStore::Groups::Item::Sets::Item::Terms::Item::Children::Item::Relations::RelationsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def set()
            return MicrosoftGraph::Groups::Item::Sites::Item::TermStore::Groups::Item::Sets::Item::Terms::Item::Children::Item::Set::SetRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter, term_id1=nil)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/termStore/groups/{group%2Did1}/sets/{set%2Did}/terms/{term%2Did}/children/{term%2Did1}{?%24select,%24expand}"
