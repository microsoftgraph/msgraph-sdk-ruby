...
module MicrosoftGraph::Groups::Item::Sites::Item::TermStore::Groups::Item
    ## 
    ...
    class GroupItemRequestBuilder
        ...
        def sets()
            return MicrosoftGraph::Groups::Item::Sites::Item::TermStore::Groups::Item::Sets::SetsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, group_id1=)
            raise StandardError, 'path_parameters cannot be null' if path_parameters.nil?
            raise StandardError, 'request_adapter cannot be null' if request_adapter.nil?
            @url_template = "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/termStore/groups/{group%2Did1}{?%24select,%24expand}"
