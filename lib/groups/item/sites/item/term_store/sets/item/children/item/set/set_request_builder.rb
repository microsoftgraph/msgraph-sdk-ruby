...
module MicrosoftGraph::Groups::Item::Sites::Item::TermStore::Sets::Item::Children::Item::Set
    ## 
    ...
    class SetRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/termStore/sets/{set%2Did}/children/{term%2Did}/set{?%24select,%24expand}"
