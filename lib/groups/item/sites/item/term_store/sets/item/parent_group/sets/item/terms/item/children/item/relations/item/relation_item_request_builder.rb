                                                            ...
                                                            module Relations
                                                                module Item
                                                                    ...
                                                                    class RelationItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                                                        ...
                                                                        def from_term()
                                                                            return MicrosoftGraph::Groups::Item::Sites::Item::TermStore::Sets::Item::ParentGroup::Sets::Item::Terms::Item::Children::Item::Relations::Item::FromTerm::FromTermRequestBuilder.new(@path_parameters, @request_adapter)
                                                                        end
                                                                        ## 
                                                                        # Provides operations to manage the set property of the microsoft.graph.termStore.relation entity.
                                                                        def set()
                                                                            return MicrosoftGraph::Groups::Item::Sites::Item::TermStore::Sets::Item::ParentGroup::Sets::Item::Terms::Item::Children::Item::Relations::Item::Set::SetRequestBuilder.new(@path_parameters, @request_adapter)
                                                                        end
                                                                        ## 
                                                                        # Provides operations to manage the toTerm property of the microsoft.graph.termStore.relation entity.
                                                                        def to_term()
                                                                            return MicrosoftGraph::Groups::Item::Sites::Item::TermStore::Sets::Item::ParentGroup::Sets::Item::Terms::Item::Children::Item::Relations::Item::ToTerm::ToTermRequestBuilder.new(@path_parameters, @request_adapter)
                                                                        end
                                                                        ## 
                                                                        ...
                                                                        def initialize(path_parameters, request_adapter)
                                                                            super(path_parameters, request_adapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/termStore/sets/{set%2Did}/parentGroup/sets/{set%2Did1}/terms/{term%2Did}/children/{term%2Did1}/relations/{relation%2Did}{?%24expand,%24select}")
                                                                        end
                                                                        ## 
                                                                        ...
                                                                        def to_delete_request_information(request_configuration=nil)
                                                                            ...
                                                                            request_info.url_template = '{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/termStore/sets/{set%2Did}/parentGroup/sets/{set%2Did1}/terms/{term%2Did}/children/{term%2Did1}/relations/{relation%2Did}'
