...
module MicrosoftGraph::Groups::Item::Sites::Item::TermStore::Sets::Item::ParentGroup::Sets::Item::Terms::Item::Children::Item::Relations::Item
    ## 
    ...
    class RelationItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, relation_id=nil)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/termStore/sets/{set%2Did}/parentGroup/sets/{set%2Did1}/terms/{term%2Did}/children/{term%2Did1}/relations/{relation%2Did}{?%24select,%24expand}"
