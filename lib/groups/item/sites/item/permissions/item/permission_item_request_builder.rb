...
module MicrosoftGraph::Groups::Item::Sites::Item::Permissions::Item
    ...
    class PermissionItemRequestBuilder
        ...
        def microsoft_graph_grant()
            return MicrosoftGraph::Groups::Item::Sites::Item::Permissions::Item::MicrosoftGraphGrant::MicrosoftGraphGrantRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
