...
module MicrosoftGraph::Groups::Item::Sites::Item::Permissions::Item
    ## 
    ...
    class PermissionItemRequestBuilder
        ...
        def microsoft_graph_grant()
            return MicrosoftGraph::Groups::Item::Sites::Item::Permissions::Item::MicrosoftGraphGrant::GrantRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter, permission_id=nil)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/permissions/{permission%2Did}{?%24select,%24expand}"
