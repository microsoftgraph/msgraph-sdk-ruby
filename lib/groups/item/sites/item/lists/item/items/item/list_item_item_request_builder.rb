                                ...
                                module Item
                                    ...
                                    class ListItemItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                        ...
                                        def document_set_versions_by_id(id)
                                            ...
                                            return MicrosoftGraph::Groups::Item::Sites::Item::Lists::Item::Items::Item::DocumentSetVersions::Item::DocumentSetVersionItemRequestBuilder.new(url_tpl_params, @request_adapter)
                                        end
                                        ## 
                                        ...
                                        def versions_by_id(id)
                                            ...
                                            return MicrosoftGraph::Groups::Item::Sites::Item::Lists::Item::Items::Item::Versions::Item::ListItemVersionItemRequestBuilder.new(url_tpl_params, @request_adapter)
                                        end
