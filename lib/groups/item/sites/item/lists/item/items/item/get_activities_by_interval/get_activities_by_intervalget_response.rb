                            ...
                            module Items
                                module Item
                                    module GetActivitiesByInterval
                                        class GetActivitiesByIntervalgetResponse < MicrosoftGraph::Models::BaseCollectionPaginationCountResponse
                                            ...
                                            ## @return a get_activities_by_intervalget_response
                                            ## 
                                            def self.create_from_discriminator_value(parse_node)
                                                raise StandardError, 'parse_node cannot be null' if parse_node.nil?
                                                return GetActivitiesByIntervalgetResponse.new
                                            end
                                            ## 
