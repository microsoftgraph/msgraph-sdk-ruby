...
require_relative '../item'
require_relative './microsoft_graph_reauthorize'

module MicrosoftGraph::Groups::Item::Sites::Item::Lists::Item::Subscriptions::Item::MicrosoftGraphReauthorize
    ## 
    ...
    class ReauthorizeRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/lists/{list%2Did}/subscriptions/{subscription%2Did}/microsoft.graph.reauthorize"
