...
module MicrosoftGraph::Groups::Item::Sites::Item::Lists::Item
    ## 
    ...
    class ListItemRequestBuilder
        ...
        def columns_by_id(id)
            ...
            return MicrosoftGraph::Groups::Item::Sites::Item::Lists::Item::Columns::Item::ColumnDefinitionItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, list_id=nil)
            raise StandardError, 'path_parameters cannot be null' if path_parameters.nil?
            raise StandardError, 'request_adapter cannot be null' if request_adapter.nil?
            @url_template = "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/lists/{list%2Did}{?%24select,%24expand}"
        ...
        def items_by_id(id)
            ...
            return MicrosoftGraph::Groups::Item::Sites::Item::Lists::Item::Items::Item::ListItemItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the operations property of the microsoft.graph.list entity.
        ## @param id Unique identifier of the item
        ...
        def subscriptions_by_id(id)
            ...
            return MicrosoftGraph::Groups::Item::Sites::Item::Lists::Item::Subscriptions::Item::SubscriptionItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Delete navigation property lists for groups
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
