...
module MicrosoftGraph::Groups::Item::Sites::Item::Lists::Item::ContentTypes::Item::ColumnLinks::Item
    ## 
    ...
    class ColumnLinkItemRequestBuilder
        ...
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, column_link_id=nil)
            raise StandardError, 'path_parameters cannot be null' if path_parameters.nil?
            raise StandardError, 'request_adapter cannot be null' if request_adapter.nil?
            @url_template = "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/lists/{list%2Did}/contentTypes/{contentType%2Did}/columnLinks/{columnLink%2Did}{?%24select,%24expand}"
