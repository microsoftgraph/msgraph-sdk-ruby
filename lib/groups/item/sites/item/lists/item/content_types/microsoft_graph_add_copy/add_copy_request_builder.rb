...
require_relative './microsoft_graph_add_copy'

module MicrosoftGraph::Groups::Item::Sites::Item::Lists::Item::ContentTypes::MicrosoftGraphAddCopy
    ## 
    ...
    class AddCopyRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/lists/{list%2Did}/contentTypes/microsoft.graph.addCopy"
