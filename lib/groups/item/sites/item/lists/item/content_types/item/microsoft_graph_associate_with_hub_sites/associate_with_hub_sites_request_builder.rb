...
require_relative '../item'
require_relative './microsoft_graph_associate_with_hub_sites'

module MicrosoftGraph::Groups::Item::Sites::Item::Lists::Item::ContentTypes::Item::MicrosoftGraphAssociateWithHubSites
    ## 
    ...
    class AssociateWithHubSitesRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/lists/{list%2Did}/contentTypes/{contentType%2Did}/microsoft.graph.associateWithHubSites"
