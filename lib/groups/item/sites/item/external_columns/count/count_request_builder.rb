...
module MicrosoftGraph::Groups::Item::Sites::Item::ExternalColumns::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/externalColumns/$count{?%24search,%24filter}"
