...
module MicrosoftGraph::Groups::Item::Sites::Item::ContentTypes::MicrosoftGraphAddCopy
    ## 
    ...
    class AddCopyRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/contentTypes/microsoft.graph.addCopy"
