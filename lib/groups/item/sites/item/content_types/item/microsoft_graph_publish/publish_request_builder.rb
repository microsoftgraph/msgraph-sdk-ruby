...
module MicrosoftGraph::Groups::Item::Sites::Item::ContentTypes::Item::MicrosoftGraphPublish
    ## 
    ...
    class PublishRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/contentTypes/{contentType%2Did}/microsoft.graph.publish"
