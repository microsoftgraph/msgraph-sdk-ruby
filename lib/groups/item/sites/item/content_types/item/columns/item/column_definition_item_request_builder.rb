...
module MicrosoftGraph::Groups::Item::Sites::Item::ContentTypes::Item::Columns::Item
    ## 
    ...
    class ColumnDefinitionItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, column_definition_id=)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/contentTypes/{contentType%2Did}/columns/{columnDefinition%2Did}{?%24select,%24expand}"
