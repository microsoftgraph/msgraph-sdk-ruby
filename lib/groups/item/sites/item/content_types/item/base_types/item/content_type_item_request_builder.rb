...
module MicrosoftGraph::Groups::Item::Sites::Item::ContentTypes::Item::BaseTypes::Item
    ## 
    ...
    class ContentTypeItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, content_type_id1=nil)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/contentTypes/{contentType%2Did}/baseTypes/{contentType%2Did1}{?%24select,%24expand}"
