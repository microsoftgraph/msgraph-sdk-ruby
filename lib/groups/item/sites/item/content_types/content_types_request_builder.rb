                ...
                module Item
                    module ContentTypes
                        ...
                        class ContentTypesRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            def add_copy()
                                return MicrosoftGraph::Groups::Item::Sites::Item::ContentTypes::AddCopy::AddCopyRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            # Provides operations to call the addCopyFromContentTypeHub method.
                            def add_copy_from_content_type_hub()
                                return MicrosoftGraph::Groups::Item::Sites::Item::ContentTypes::AddCopyFromContentTypeHub::AddCopyFromContentTypeHubRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            ...
                            def get_compatible_hub_content_types()
                                return MicrosoftGraph::Groups::Item::Sites::Item::ContentTypes::GetCompatibleHubContentTypes::GetCompatibleHubContentTypesRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            ## Provides operations to manage the contentTypes property of the microsoft.graph.site entity.
                            ...
                            def initialize(path_parameters, request_adapter)
                                super(path_parameters, request_adapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/contentTypes{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}")
                            end
                            ## 
                            ...
                            def to_post_request_information(body, request_configuration=nil)
                                ...
                                request_info.url_template = '{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/contentTypes'
                                request_info.path_parameters = @path_parameters
