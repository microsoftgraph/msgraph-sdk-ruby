...
require_relative './microsoft_graph_get_notebook_from_web_url'

module MicrosoftGraph::Groups::Item::Sites::Item::Onenote::Notebooks::MicrosoftGraphGetNotebookFromWebUrl
    ## 
    ...
    class MicrosoftGraphGetNotebookFromWebUrlRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/onenote/notebooks/microsoft.graph.getNotebookFromWebUrl"
