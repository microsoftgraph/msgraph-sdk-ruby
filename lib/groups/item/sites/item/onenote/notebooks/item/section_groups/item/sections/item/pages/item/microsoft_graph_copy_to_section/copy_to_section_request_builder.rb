...
require_relative '../item'
require_relative './microsoft_graph_copy_to_section'

module MicrosoftGraph::Groups::Item::Sites::Item::Onenote::Notebooks::Item::SectionGroups::Item::Sections::Item::Pages::Item::MicrosoftGraphCopyToSection
    ## 
    ...
    class CopyToSectionRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/onenote/notebooks/{notebook%2Did}/sectionGroups/{sectionGroup%2Did}/sections/{onenoteSection%2Did}/pages/{onenotePage%2Did}/microsoft.graph.copyToSection"
