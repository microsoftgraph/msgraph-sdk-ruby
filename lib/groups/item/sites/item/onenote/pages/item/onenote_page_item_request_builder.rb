...
module MicrosoftGraph::Groups::Item::Sites::Item::Onenote::Pages::Item
    ## 
    ...
    class OnenotePageItemRequestBuilder
        ...
        def content()
            return MicrosoftGraph::Groups::Item::Sites::Item::Onenote::Pages::Item::Content::ContentRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the copyToSection method.
        def microsoft_graph_copy_to_section()
            return MicrosoftGraph::Groups::Item::Sites::Item::Onenote::Pages::Item::MicrosoftGraphCopyToSection::CopyToSectionRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the onenotePatchContent method.
        def microsoft_graph_onenote_patch_content()
            return MicrosoftGraph::Groups::Item::Sites::Item::Onenote::Pages::Item::MicrosoftGraphOnenotePatchContent::OnenotePatchContentRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the preview method.
        def microsoft_graph_preview()
            return MicrosoftGraph::Groups::Item::Sites::Item::Onenote::Pages::Item::MicrosoftGraphPreview::PreviewRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the parentNotebook property of the microsoft.graph.onenotePage entity.
        def parent_notebook()
            return MicrosoftGraph::Groups::Item::Sites::Item::Onenote::Pages::Item::ParentNotebook::ParentNotebookRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the parentSection property of the microsoft.graph.onenotePage entity.
        def parent_section()
            return MicrosoftGraph::Groups::Item::Sites::Item::Onenote::Pages::Item::ParentSection::ParentSectionRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter, onenote_page_id=nil)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/onenote/pages/{onenotePage%2Did}{?%24select,%24expand}"
