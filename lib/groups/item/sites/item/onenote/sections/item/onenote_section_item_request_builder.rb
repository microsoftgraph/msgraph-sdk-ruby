...
module MicrosoftGraph::Groups::Item::Sites::Item::Onenote::Sections::Item
    ## 
    ...
    class OnenoteSectionItemRequestBuilder
        ...
        def microsoft_graph_copy_to_notebook()
            return MicrosoftGraph::Groups::Item::Sites::Item::Onenote::Sections::Item::MicrosoftGraphCopyToNotebook::CopyToNotebookRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the copyToSectionGroup method.
        def microsoft_graph_copy_to_section_group()
            return MicrosoftGraph::Groups::Item::Sites::Item::Onenote::Sections::Item::MicrosoftGraphCopyToSectionGroup::CopyToSectionGroupRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter, onenote_section_id=nil)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/onenote/sections/{onenoteSection%2Did}{?%24select,%24expand}"
