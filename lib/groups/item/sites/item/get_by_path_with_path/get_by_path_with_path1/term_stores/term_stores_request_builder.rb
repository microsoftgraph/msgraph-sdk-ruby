                    ...
                    module GetByPathWithPath
                        module GetByPathWithPath1
                            module TermStores
                                ...
                                class TermStoresRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                    ...
                                    def initialize(path_parameters, request_adapter)
                                        super(path_parameters, request_adapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/getByPath(path='{path}')/getByPath(path='{path1}')/termStores{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}")
                                    end
                                    ## 
                                    ...
                                    def to_post_request_information(body, request_configuration=nil)
                                        ...
                                        request_info.url_template = '{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/getByPath(path='{path}')/getByPath(path='{path1}')/termStores'
                                        request_info.path_parameters = @path_parameters
                                    ...
                                    ## @return a term_stores_request_builder
                                    ## 
                                    def with_url(raw_url)
                                        raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                                        return TermStoresRequestBuilder.new(raw_url, @request_adapter)
                                    end
