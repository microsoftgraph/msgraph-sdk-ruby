...
module MicrosoftGraph::Groups::Item::Sites::Item::Operations::Item
    ## 
    ...
    class RichLongRunningOperationItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, rich_long_running_operation_id=nil)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/operations/{richLongRunningOperation%2Did}{?%24select,%24expand}"
