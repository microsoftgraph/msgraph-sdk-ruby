            ...
            module Sites
                module Item
                    ...
                    class SiteItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def pages()
                            return MicrosoftGraph::Groups::Item::Sites::Item::Pages::PagesRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ...
                        def to_patch_request_information(body, request_configuration=nil)
                            ...
                            request_info.url_template = '{+baseurl}/groups/{group%2Did}/sites/{site%2Did}'
                            request_info.path_parameters = @path_parameters
