...
module MicrosoftGraph::Groups::Item::Sites::Item
    ...
    class SiteItemRequestBuilder
        ...
        def microsoft_graph_get_activities_by_interval()
            return MicrosoftGraph::Groups::Item::Sites::Item::MicrosoftGraphGetActivitiesByInterval::MicrosoftGraphGetActivitiesByIntervalRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
