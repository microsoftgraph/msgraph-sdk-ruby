        ...
        module Item
            module Photos
                module Item
                    ...
                    class ProfilePhotoItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        
                        ## 
                        # Provides operations to manage the media for the group entity.
                        def content()
                            return MicrosoftGraph::Groups::Item::Photos::Item::Value::ContentRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/groups/{group%2Did}/photos/{profilePhoto%2Did}{?%24expand,%24select}")
                        end
                        ## 
                        ...
                        def with_url(raw_url)
                            ...
                            return ProfilePhotoItemRequestBuilder.new(raw_url, @request_adapter)
                        end
