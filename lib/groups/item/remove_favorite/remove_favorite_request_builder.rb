...
require_relative './remove_favorite'
    ...
    module Groups
        module Item
            module RemoveFavorite
                ...
                class RemoveFavoriteRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def initialize(path_parameters, request_adapter)
                        super(path_parameters, request_adapter, "{+baseurl}/groups/{group%2Did}/removeFavorite")
                    end
                    ## 
                    ...
                    ## @return a remove_favorite_request_builder
                    ## 
                    def with_url(raw_url)
                        raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                        return RemoveFavoriteRequestBuilder.new(raw_url, @request_adapter)
                    end
                end
            end
        end
