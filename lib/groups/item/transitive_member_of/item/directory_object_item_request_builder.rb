                ...
                module Item
                    ...
                    class DirectoryObjectItemRequestBuilder
                        ...
                        def graph_administrative_unit()
                            return MicrosoftGraph::Groups::Item::TransitiveMemberOf::Item::GraphAdministrativeUnit::GraphAdministrativeUnitRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        # Casts the previous resource to group.
                        def graph_group()
                            return MicrosoftGraph::Groups::Item::TransitiveMemberOf::Item::GraphGroup::GraphGroupRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
