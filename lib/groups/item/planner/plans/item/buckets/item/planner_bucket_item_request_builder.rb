                    ...
                    module Item
                        module Buckets
                            module Item
                                ...
                                class PlannerBucketItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                    
                                    ## 
                                    # Provides operations to manage the tasks property of the microsoft.graph.plannerBucket entity.
                                    def tasks()
                                        return MicrosoftGraph::Groups::Item::Planner::Plans::Item::Buckets::Item::Tasks::TasksRequestBuilder.new(@path_parameters, @request_adapter)
                                    end
                                    ## 
                                    ...
                                    def initialize(path_parameters, request_adapter)
                                        super(path_parameters, request_adapter, "{+baseurl}/groups/{group%2Did}/planner/plans/{plannerPlan%2Did}/buckets/{plannerBucket%2Did}{?%24expand,%24select}")
                                    end
                                    ## 
                                    ...
                                    def to_delete_request_information(request_configuration=nil)
                                        ...
                                        request_info.url_template = '{+baseurl}/groups/{group%2Did}/planner/plans/{plannerPlan%2Did}/buckets/{plannerBucket%2Did}'
                                    ...
                                    def with_url(raw_url)
                                        ...
                                        return PlannerBucketItemRequestBuilder.new(raw_url, @request_adapter)
                                    end
