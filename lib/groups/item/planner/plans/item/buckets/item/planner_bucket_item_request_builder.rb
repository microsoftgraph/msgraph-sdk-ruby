...
module MicrosoftGraph::Groups::Item::Planner::Plans::Item::Buckets::Item
    ## 
    ...
    class PlannerBucketItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, planner_bucket_id=)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/planner/plans/{plannerPlan%2Did}/buckets/{plannerBucket%2Did}{?%24select,%24expand}"
