...
module MicrosoftGraph::Groups::Item::Planner::Plans::Item::Tasks::Item
    ## 
    ...
    class PlannerTaskItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, planner_task_id=)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/planner/plans/{plannerPlan%2Did}/tasks/{plannerTask%2Did}{?%24select,%24expand}"
