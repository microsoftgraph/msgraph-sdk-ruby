...
module MicrosoftGraph::Groups::Item::AppRoleAssignments::Item
    ## 
    ...
    class AppRoleAssignmentItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, app_role_assignment_id=nil)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/appRoleAssignments/{appRoleAssignment%2Did}{?%24select,%24expand}"
