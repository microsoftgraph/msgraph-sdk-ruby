...
require_relative './microsoft_graph_remove_favorite'

module MicrosoftGraph::Groups::Item::MicrosoftGraphRemoveFavorite
    ## 
    ...
    class RemoveFavoriteRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/microsoft.graph.removeFavorite"
