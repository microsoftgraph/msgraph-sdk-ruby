...
module MicrosoftGraph::Groups::Item::Calendar
    ## 
    ...
    class CalendarRequestBuilder
        ...
        def microsoft_graph_get_schedule()
            return MicrosoftGraph::Groups::Item::Calendar::MicrosoftGraphGetSchedule::MicrosoftGraphGetScheduleRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
