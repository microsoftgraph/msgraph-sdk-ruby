...
module MicrosoftGraph::Groups::Item::Calendar::Events::Item::MultiValueExtendedProperties::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/calendar/events/{event%2Did}/multiValueExtendedProperties/$count{?%24search,%24filter}"
