...
module MicrosoftGraph::Groups::Item::Calendar::Events::Item::MicrosoftGraphDecline
    ## 
    ...
    class DeclineRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/calendar/events/{event%2Did}/microsoft.graph.decline"
