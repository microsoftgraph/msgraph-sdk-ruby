                            ...
                            module Item
                                module ExceptionOccurrences
                                    ...
                                    class ExceptionOccurrencesRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                        ...
                                        def count()
                                            return MicrosoftGraph::Groups::Item::Calendar::Events::Item::Instances::Item::ExceptionOccurrences::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                                        end
                                        ## 
                                        # Provides operations to call the delta method.
                                        def delta()
                                            return MicrosoftGraph::Groups::Item::Calendar::Events::Item::Instances::Item::ExceptionOccurrences::Delta::DeltaRequestBuilder.new(@path_parameters, @request_adapter)
                                        end
                                        ## 
                                        ## Provides operations to manage the exceptionOccurrences property of the microsoft.graph.event entity.
                                        ...
                                        def by_event_id2(event_id2)
                                            ...
                                            return MicrosoftGraph::Groups::Item::Calendar::Events::Item::Instances::Item::ExceptionOccurrences::Item::EventItemRequestBuilder.new(url_tpl_params, @request_adapter)
                                        end
                                        ## 
                                        ...
                                        def initialize(path_parameters, request_adapter)
                                            super(path_parameters, request_adapter, "{+baseurl}/groups/{group%2Did}/calendar/events/{event%2Did}/instances/{event%2Did1}/exceptionOccurrences{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}")
                                        end
                                        ## 
