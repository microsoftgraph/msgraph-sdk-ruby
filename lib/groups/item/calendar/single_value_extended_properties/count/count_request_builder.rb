...
module MicrosoftGraph::Groups::Item::Calendar::SingleValueExtendedProperties::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/calendar/singleValueExtendedProperties/$count{?%24search,%24filter}"
