...
module MicrosoftGraph::Groups::Item::Calendar::CalendarView::Item::MicrosoftGraphCancel
    ## 
    ...
    class CancelRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/calendar/calendarView/{event%2Did}/microsoft.graph.cancel"
