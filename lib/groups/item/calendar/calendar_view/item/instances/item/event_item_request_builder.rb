                            ...
                            module Item
                                ...
                                class EventItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                    ...
                                    def exception_occurrences()
                                        return MicrosoftGraph::Groups::Item::Calendar::CalendarView::Item::Instances::Item::ExceptionOccurrences::ExceptionOccurrencesRequestBuilder.new(@path_parameters, @request_adapter)
                                    end
                                    ## 
                                    ...
                                    def permanent_delete()
                                        return MicrosoftGraph::Groups::Item::Calendar::CalendarView::Item::Instances::Item::PermanentDelete::PermanentDeleteRequestBuilder.new(@path_parameters, @request_adapter)
                                    end
                                    ## 
                                    ...
                                    def initialize(path_parameters, request_adapter)
                                        super(path_parameters, request_adapter, "{+baseurl}/groups/{group%2Did}/calendar/calendarView/{event%2Did}/instances/{event%2Did1}?endDateTime={endDateTime}&startDateTime={startDateTime}{&%24expand,%24select}")
                                    end
                                    ## 
