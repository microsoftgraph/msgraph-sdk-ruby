...
module MicrosoftGraph::Groups::Item::Calendar::CalendarView::Item::Attachments::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/calendar/calendarView/{event%2Did}/attachments/$count{?%24filter}"
