...
module MicrosoftGraph::Groups::Item::Calendar::MultiValueExtendedProperties::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/calendar/multiValueExtendedProperties/$count{?%24search,%24filter}"
