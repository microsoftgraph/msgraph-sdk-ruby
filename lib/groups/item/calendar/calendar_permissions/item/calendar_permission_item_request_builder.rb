...
module MicrosoftGraph::Groups::Item::Calendar::CalendarPermissions::Item
    ## 
    ...
    class CalendarPermissionItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, calendar_permission_id=)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/calendar/calendarPermissions/{calendarPermission%2Did}{?%24select}"
