                    ...
                    module MicrosoftGraphExternalConnectorsAddActivities
                        class AddActivitiesResponse < MicrosoftGraph::Models::BaseCollectionPaginationCountResponse
                            ...
                            def get_field_deserializers()
                                return super.merge({
                                    "value" => lambda {|n| @value = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraph::Models::ExternalConnectors::ExternalActivityResult.create_from_discriminator_value(pn) }) },
                                })
                            end
                            ## 
