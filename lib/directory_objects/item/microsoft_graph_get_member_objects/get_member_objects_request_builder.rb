...
module MicrosoftGraph::DirectoryObjects::Item::MicrosoftGraphGetMemberObjects
    ## 
    ...
    class GetMemberObjectsRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/directoryObjects/{directoryObject%2Did}/microsoft.graph.getMemberObjects"
        ...
        def post(body, request_configuration=nil)
            ...
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraph::DirectoryObjects::Item::MicrosoftGraphGetMemberObjects::GetMemberObjectsResponse.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
        ## Return all IDs for the groups, administrative units, and directory roles that a user, group, service principal, organizational contact, device, or directory object is a member of. This function is transitive. **Note:** Only users and role-enabled groups can be members of directory roles.
        ## @param body The request body
