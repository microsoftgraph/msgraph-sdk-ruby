    ...
    module DirectoryObjects
        module Item
            module GetMemberGroups
                class GetMemberGroupsPostResponse < MicrosoftGraph::Models::BaseCollectionPaginationCountResponse
                    ...
                    ## @return a get_member_groups_post_response
                    ## 
                    def self.create_from_discriminator_value(parse_node)
                        raise StandardError, 'parse_node cannot be null' if parse_node.nil?
                        return GetMemberGroupsPostResponse.new
                    end
                    ## 
