...
module MicrosoftGraph::DirectoryObjects::MicrosoftGraphGetByIds
    ## 
    ...
    class GetByIdsRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/directoryObjects/microsoft.graph.getByIds"
        ...
        def post(body, request_configuration=)
            ...
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraph::DirectoryObjects::MicrosoftGraphGetByIds::GetByIdsResponse.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
        ## Return the directory objects specified in a list of IDs. Some common uses for this function are to:
        ## @param body 
