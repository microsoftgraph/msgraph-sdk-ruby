...
module MicrosoftGraph
    module DirectoryObjects
        ...
        class DirectoryObjectsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
            ...
            def delta()
                return MicrosoftGraph::DirectoryObjects::Delta::DeltaRequestBuilder.new(@path_parameters, @request_adapter)
            end
            ## 
            ...
            def initialize(path_parameters, request_adapter)
                super(path_parameters, request_adapter, "{+baseurl}/directoryObjects{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}")
            end
            ## 
            ...
            def to_post_request_information(body, request_configuration=nil)
                ...
                request_info.url_template = '{+baseurl}/directoryObjects'
                request_info.path_parameters = @path_parameters
            ...
            ## @return a directory_objects_request_builder
            ## 
            def with_url(raw_url)
                raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                return DirectoryObjectsRequestBuilder.new(raw_url, @request_adapter)
            end
