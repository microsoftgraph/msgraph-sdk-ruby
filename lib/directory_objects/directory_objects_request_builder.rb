...
module MicrosoftGraph
    module DirectoryObjects
        ...
        class DirectoryObjectsRequestBuilder
            ...
            def count()
                return MicrosoftGraph::DirectoryObjects::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
            end
            ## 
            # Provides operations to call the getAvailableExtensionProperties method.
            def microsoft_graph_get_available_extension_properties()
                return MicrosoftGraph::DirectoryObjects::MicrosoftGraphGetAvailableExtensionProperties::MicrosoftGraphGetAvailableExtensionPropertiesRequestBuilder.new(@path_parameters, @request_adapter)
            end
            ## 
            # Provides operations to call the getByIds method.
            def microsoft_graph_get_by_ids()
                return MicrosoftGraph::DirectoryObjects::MicrosoftGraphGetByIds::MicrosoftGraphGetByIdsRequestBuilder.new(@path_parameters, @request_adapter)
            end
            ## 
            # Provides operations to call the validateProperties method.
            def microsoft_graph_validate_properties()
                return MicrosoftGraph::DirectoryObjects::MicrosoftGraphValidateProperties::MicrosoftGraphValidatePropertiesRequestBuilder.new(@path_parameters, @request_adapter)
            end
            ## 
            ...
            def initialize(path_parameters, request_adapter)
                ...
                @url_template = "{+baseurl}/directoryObjects{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
