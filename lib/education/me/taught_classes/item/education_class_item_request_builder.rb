...
module MicrosoftGraph::Education::Me::TaughtClasses::Item
    ## 
    ...
    class EducationClassItemRequestBuilder
        ...
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, education_class_id=nil)
            raise StandardError, 'path_parameters cannot be null' if path_parameters.nil?
            raise StandardError, 'request_adapter cannot be null' if request_adapter.nil?
            @url_template = "{+baseurl}/education/me/taughtClasses/{educationClass%2Did}{?%24select,%24expand}"
