...
module MicrosoftGraph::Education::Me::Assignments
    ...
    class AssignmentsRequestBuilder
        ...
        def microsoft_graph_delta()
            return MicrosoftGraph::Education::Me::Assignments::MicrosoftGraphDelta::MicrosoftGraphDeltaRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/education/me/assignments{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
