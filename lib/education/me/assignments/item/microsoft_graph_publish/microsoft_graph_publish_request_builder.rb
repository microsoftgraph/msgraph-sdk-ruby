...
module MicrosoftGraph::Education::Me::Assignments::Item::MicrosoftGraphPublish
    ## 
    ...
    class MicrosoftGraphPublishRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/education/me/assignments/{educationAssignment%2Did}/microsoft.graph.publish"
