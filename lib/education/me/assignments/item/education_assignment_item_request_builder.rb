            ...
            module Assignments
                module Item
                    ...
                    class EducationAssignmentItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def activate()
                            return MicrosoftGraph::Education::Me::Assignments::Item::Activate::ActivateRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ...
                        def deactivate()
                            return MicrosoftGraph::Education::Me::Assignments::Item::Deactivate::DeactivateRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ...
                        def grading_category()
                            return MicrosoftGraph::Education::Me::Assignments::Item::GradingCategory::GradingCategoryRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/education/me/assignments/{educationAssignment%2Did}{?%24expand,%24select}")
                        end
                        ## 
                        ...
                        def with_url(raw_url)
                            ...
                            return EducationAssignmentItemRequestBuilder.new(raw_url, @request_adapter)
                        end
