...
module MicrosoftGraph::Education::Me::Assignments::Item::Submissions::Item::SubmittedResources::Item
    ## 
    ...
    class EducationSubmissionResourceItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, education_submission_resource_id=nil)
            ...
            @url_template = "{+baseurl}/education/me/assignments/{educationAssignment%2Did}/submissions/{educationSubmission%2Did}/submittedResources/{educationSubmissionResource%2Did}{?%24select,%24expand}"
