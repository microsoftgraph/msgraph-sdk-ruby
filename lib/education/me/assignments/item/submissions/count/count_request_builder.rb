...
module MicrosoftGraph::Education::Me::Assignments::Item::Submissions::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/education/me/assignments/{educationAssignment%2Did}/submissions/$count{?%24search,%24filter}"
