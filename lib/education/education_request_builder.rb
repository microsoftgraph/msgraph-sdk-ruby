...
module MicrosoftGraph
    module Education
        ...
        class EducationRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
            
            ## 
            # Provides operations to manage the classes property of the microsoft.graph.educationRoot entity.
            def classes()
                return MicrosoftGraph::Education::Classes::ClassesRequestBuilder.new(@path_parameters, @request_adapter)
            end
            ## 
            # Provides operations to manage the me property of the microsoft.graph.educationRoot entity.
            def me()
                return MicrosoftGraph::Education::Me::MeRequestBuilder.new(@path_parameters, @request_adapter)
            end
            ## 
            # Provides operations to manage the schools property of the microsoft.graph.educationRoot entity.
            def schools()
                return MicrosoftGraph::Education::Schools::SchoolsRequestBuilder.new(@path_parameters, @request_adapter)
            end
            ## 
            ...
            def initialize(path_parameters, request_adapter)
                super(path_parameters, request_adapter, "{+baseurl}/education{?%24expand,%24select}")
            end
            ## 
            ## Get education
            ## @param request_configuration Configuration for the request such as headers, query parameters, and middleware options.
            ## @return a Fiber of education_root
            ## 
            ...
            def to_patch_request_information(body, request_configuration=nil)
                ...
                request_info.url_template = '{+baseurl}/education'
                request_info.path_parameters = @path_parameters
            ...
            ## @return a education_request_builder
            ## 
            def with_url(raw_url)
                raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                return EducationRequestBuilder.new(raw_url, @request_adapter)
            end
