            ...
            module Item
                module Rubrics
                    module Item
                        ...
                        class EducationRubricItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            def initialize(path_parameters, request_adapter)
                                super(path_parameters, request_adapter, "{+baseurl}/education/users/{educationUser%2Did}/rubrics/{educationRubric%2Did}{?%24expand,%24select}")
                            end
                            ## 
                            ...
                            def to_delete_request_information(request_configuration=nil)
                                ...
                                request_info.url_template = '{+baseurl}/education/users/{educationUser%2Did}/rubrics/{educationRubric%2Did}'
                            ...
                            def with_url(raw_url)
                                ...
                                return EducationRubricItemRequestBuilder.new(raw_url, @request_adapter)
                            end
