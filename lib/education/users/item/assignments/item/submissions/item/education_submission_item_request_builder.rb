...
require_relative './excuse/excuse_request_builder'
require_relative './item'
                        ...
                        module Submissions
                            module Item
                                ...
                                class EducationSubmissionItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                    ...
                                    def excuse()
                                        return MicrosoftGraph::Education::Users::Item::Assignments::Item::Submissions::Item::Excuse::ExcuseRequestBuilder.new(@path_parameters, @request_adapter)
                                    end
                                    ## 
                                    ...
                                    def initialize(path_parameters, request_adapter)
                                        super(path_parameters, request_adapter, "{+baseurl}/education/users/{educationUser%2Did}/assignments/{educationAssignment%2Did}/submissions/{educationSubmission%2Did}{?%24expand,%24select}")
                                    end
                                    ## 
