...
require_relative './item'
require_relative './microsoft_graph_reassign/microsoft_graph_reassign_request_builder'
require_relative './microsoft_graph_return/microsoft_graph_return_request_builder'
require_relative './microsoft_graph_set_up_resources_folder/microsoft_graph_set_up_resources_folder_request_builder'
require_relative './microsoft_graph_submit/microsoft_graph_submit_request_builder'
require_relative './microsoft_graph_unsubmit/microsoft_graph_unsubmit_request_builder'
                            ...
                            module Item
                                ...
                                class EducationSubmissionItemRequestBuilder
                                    ...
                                    def microsoft_graph_reassign()
                                        return MicrosoftGraph::Education::Users::Item::Assignments::Item::Submissions::Item::MicrosoftGraphReassign::MicrosoftGraphReassignRequestBuilder.new(@path_parameters, @request_adapter)
                                    end
                                    ## 
                                    # Provides operations to call the return method.
                                    def microsoft_graph_return()
                                        return MicrosoftGraph::Education::Users::Item::Assignments::Item::Submissions::Item::MicrosoftGraphReturn::MicrosoftGraphReturnRequestBuilder.new(@path_parameters, @request_adapter)
                                    end
                                    ## 
                                    # Provides operations to call the setUpResourcesFolder method.
                                    def microsoft_graph_set_up_resources_folder()
                                        return MicrosoftGraph::Education::Users::Item::Assignments::Item::Submissions::Item::MicrosoftGraphSetUpResourcesFolder::MicrosoftGraphSetUpResourcesFolderRequestBuilder.new(@path_parameters, @request_adapter)
                                    end
                                    ## 
                                    # Provides operations to call the submit method.
                                    def microsoft_graph_submit()
                                        return MicrosoftGraph::Education::Users::Item::Assignments::Item::Submissions::Item::MicrosoftGraphSubmit::MicrosoftGraphSubmitRequestBuilder.new(@path_parameters, @request_adapter)
                                    end
                                    ## 
                                    # Provides operations to call the unsubmit method.
                                    def microsoft_graph_unsubmit()
                                        return MicrosoftGraph::Education::Users::Item::Assignments::Item::Submissions::Item::MicrosoftGraphUnsubmit::MicrosoftGraphUnsubmitRequestBuilder.new(@path_parameters, @request_adapter)
                                    end
                                    ## 
                                    # Provides operations to manage the outcomes property of the microsoft.graph.educationSubmission entity.
                                    def outcomes()
                                        return MicrosoftGraph::Education::Users::Item::Assignments::Item::Submissions::Item::Outcomes::OutcomesRequestBuilder.new(@path_parameters, @request_adapter)
                                    end
                                    ## 
                                    ...
                                    def resources_by_id(id)
                                        ...
                                        return MicrosoftGraph::Education::Users::Item::Assignments::Item::Submissions::Item::Resources::Item::EducationSubmissionResourceItemRequestBuilder.new(url_tpl_params, @request_adapter)
                                    end
                                    ## 
                                    ## Provides operations to manage the submittedResources property of the microsoft.graph.educationSubmission entity.
                                    ## @param id Unique identifier of the item
                                    ...
                                    def submitted_resources_by_id(id)
                                        ...
                                        url_tpl_params = @path_parameters.clone
                                        url_tpl_params["educationSubmissionResource%2Did"] = id
                                        return MicrosoftGraph::Education::Users::Item::Assignments::Item::Submissions::Item::SubmittedResources::Item::EducationSubmissionResourceItemRequestBuilder.new(url_tpl_params, @request_adapter)
                                    end
                                    ## 
                                    ## Delete navigation property submissions for education
                                    ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
