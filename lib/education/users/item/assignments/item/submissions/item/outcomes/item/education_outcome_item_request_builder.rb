...
module MicrosoftGraph::Education::Users::Item::Assignments::Item::Submissions::Item::Outcomes::Item
    ## 
    ...
    class EducationOutcomeItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, education_outcome_id=)
            ...
            @url_template = "{+baseurl}/education/users/{educationUser%2Did}/assignments/{educationAssignment%2Did}/submissions/{educationSubmission%2Did}/outcomes/{educationOutcome%2Did}{?%24select,%24expand}"
