...
module MicrosoftGraph::Education::Users::Item::TaughtClasses::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/education/users/{educationUser%2Did}/taughtClasses/$count{?%24search,%24filter}"
