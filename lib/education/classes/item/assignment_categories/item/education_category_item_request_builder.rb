...
module MicrosoftGraph::Education::Classes::Item::AssignmentCategories::Item
    ## 
    ...
    class EducationCategoryItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, education_category_id=nil)
            ...
            @url_template = "{+baseurl}/education/classes/{educationClass%2Did}/assignmentCategories/{educationCategory%2Did}{?%24select,%24expand}"
