...
require_relative './item'
require_relative './pin/pin_request_builder'
...
require_relative './unpin/unpin_request_builder'
            ...
            module Item
                module Modules
                    module Item
                        ...
                        class EducationModuleItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            
                            ## 
                            # Provides operations to call the pin method.
                            def pin()
                                return MicrosoftGraph::Education::Classes::Item::Modules::Item::Pin::PinRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            # Provides operations to call the publish method.
                            def publish()
                                return MicrosoftGraph::Education::Classes::Item::Modules::Item::Publish::PublishRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            # Provides operations to manage the resources property of the microsoft.graph.educationModule entity.
                            def resources()
                                return MicrosoftGraph::Education::Classes::Item::Modules::Item::Resources::ResourcesRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            # Provides operations to call the setUpResourcesFolder method.
                            def set_up_resources_folder()
                                return MicrosoftGraph::Education::Classes::Item::Modules::Item::SetUpResourcesFolder::SetUpResourcesFolderRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            # Provides operations to call the unpin method.
                            def unpin()
                                return MicrosoftGraph::Education::Classes::Item::Modules::Item::Unpin::UnpinRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            ...
                            def initialize(path_parameters, request_adapter)
                                super(path_parameters, request_adapter, "{+baseurl}/education/classes/{educationClass%2Did}/modules/{educationModule%2Did}{?%24expand,%24select}")
                            end
                            ## 
                            ...
                            def to_delete_request_information(request_configuration=nil)
                                ...
                                request_info.url_template = '{+baseurl}/education/classes/{educationClass%2Did}/modules/{educationModule%2Did}'
