...
module MicrosoftGraph::Education::Classes::Item::Assignments::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/education/classes/{educationClass%2Did}/assignments/$count{?%24search,%24filter}"
