...
module MicrosoftGraph::Education::Classes::Item::Assignments::Item
    ...
    class EducationAssignmentItemRequestBuilder
        ...
        def microsoft_graph_publish()
            return MicrosoftGraph::Education::Classes::Item::Assignments::Item::MicrosoftGraphPublish::PublishRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the setUpFeedbackResourcesFolder method.
        def microsoft_graph_set_up_feedback_resources_folder()
            return MicrosoftGraph::Education::Classes::Item::Assignments::Item::MicrosoftGraphSetUpFeedbackResourcesFolder::SetUpFeedbackResourcesFolderRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the setUpResourcesFolder method.
        def microsoft_graph_set_up_resources_folder()
            return MicrosoftGraph::Education::Classes::Item::Assignments::Item::MicrosoftGraphSetUpResourcesFolder::SetUpResourcesFolderRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
