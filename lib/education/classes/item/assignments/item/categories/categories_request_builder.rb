...
module MicrosoftGraph::Education::Classes::Item::Assignments::Item::Categories
    ## 
    ...
    class CategoriesRequestBuilder
        ...
        def microsoft_graph_delta()
            return MicrosoftGraph::Education::Classes::Item::Assignments::Item::Categories::MicrosoftGraphDelta::MicrosoftGraphDeltaRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/education/classes/{educationClass%2Did}/assignments/{educationAssignment%2Did}/categories{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
