...
require_relative '../item'
require_relative './microsoft_graph_set_up_resources_folder'

module MicrosoftGraph::Education::Classes::Item::Assignments::Item::Submissions::Item::MicrosoftGraphSetUpResourcesFolder
    ## 
    ...
    class SetUpResourcesFolderRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/education/classes/{educationClass%2Did}/assignments/{educationAssignment%2Did}/submissions/{educationSubmission%2Did}/microsoft.graph.setUpResourcesFolder"
