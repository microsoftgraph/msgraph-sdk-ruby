                        ...
                        module SetUpFeedbackResourcesFolder
                            ...
                            class SetUpFeedbackResourcesFolderRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                ...
                                def initialize(path_parameters, request_adapter)
                                    super(path_parameters, request_adapter, "{+baseurl}/education/classes/{educationClass%2Did}/assignments/{educationAssignment%2Did}/setUpFeedbackResourcesFolder")
                                end
                                ## 
                                ...
                                ## @return a set_up_feedback_resources_folder_request_builder
                                ## 
                                def with_url(raw_url)
                                    raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                                    return SetUpFeedbackResourcesFolderRequestBuilder.new(raw_url, @request_adapter)
                                end
                            end
                        end
                    end
