...
require_relative './get_recently_modified_submissions/get_recently_modified_submissions_request_builder'
require_relative './group/group_request_builder'
require_relative './item'
require_relative './members/members_request_builder'
require_relative './modules/modules_request_builder'
        ...
        module Classes
            module Item
                ...
                class EducationClassItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def get_recently_modified_submissions()
                        return MicrosoftGraph::Education::Classes::Item::GetRecentlyModifiedSubmissions::GetRecentlyModifiedSubmissionsRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ...
                    def modules()
                        return MicrosoftGraph::Education::Classes::Item::Modules::ModulesRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ...
                    def initialize(path_parameters, request_adapter)
                        super(path_parameters, request_adapter, "{+baseurl}/education/classes/{educationClass%2Did}{?%24expand,%24select}")
                    end
                    ## 
