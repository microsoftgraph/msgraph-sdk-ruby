...
module MicrosoftGraph
    module Education
        module Schools
            module Item
                module AdministrativeUnit
                    ## 
                    # Provides operations to manage the administrativeUnit property of the microsoft.graph.educationSchool entity.
                    class AdministrativeUnitRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/education/schools/{educationSchool%2Did}/administrativeUnit{?%24expand,%24select}")
                        end
                        ## 
                        ...
                        def to_patch_request_information(body, request_configuration=nil)
                            ...
                            request_info.url_template = '{+baseurl}/education/schools/{educationSchool%2Did}/administrativeUnit'
                            request_info.path_parameters = @path_parameters
                        ...
                        ## @return a administrative_unit_request_builder
                        ## 
                        def with_url(raw_url)
                            raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                            return AdministrativeUnitRequestBuilder.new(raw_url, @request_adapter)
                        end
