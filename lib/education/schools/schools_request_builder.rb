...
module MicrosoftGraph::Education::Schools
    ## 
    ...
    class SchoolsRequestBuilder
        ...
        def microsoft_graph_delta()
            return MicrosoftGraph::Education::Schools::MicrosoftGraphDelta::MicrosoftGraphDeltaRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/education/schools{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
