...
require_relative '../../models/education_school_collection_response'
...
module MicrosoftGraph
    module Education
        module Schools
            ...
            class SchoolsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                
                ## 
                # Provides operations to count the resources in the collection.
                def count()
                    return MicrosoftGraph::Education::Schools::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                # Provides operations to call the delta method.
                def delta()
                    return MicrosoftGraph::Education::Schools::Delta::DeltaRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                ## Provides operations to manage the schools property of the microsoft.graph.educationRoot entity.
                ...
                def initialize(path_parameters, request_adapter)
                    super(path_parameters, request_adapter, "{+baseurl}/education/schools{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}")
                end
                ## 
                ...
                def to_post_request_information(body, request_configuration=nil)
                    ...
                    request_info.url_template = '{+baseurl}/education/schools'
                    request_info.path_parameters = @path_parameters
                ...
                ## @return a schools_request_builder
                ## 
                def with_url(raw_url)
                    raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                    return SchoolsRequestBuilder.new(raw_url, @request_adapter)
                end
