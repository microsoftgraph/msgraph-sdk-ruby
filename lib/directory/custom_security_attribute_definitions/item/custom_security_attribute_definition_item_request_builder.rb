...
require_relative './allowed_values/allowed_values_request_builder'
    ...
    module Directory
        module CustomSecurityAttributeDefinitions
            module Item
                ...
                class CustomSecurityAttributeDefinitionItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    
                    ## 
                    # Provides operations to manage the allowedValues property of the microsoft.graph.customSecurityAttributeDefinition entity.
                    def allowed_values()
                        return MicrosoftGraph::Directory::CustomSecurityAttributeDefinitions::Item::AllowedValues::AllowedValuesRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ...
                    def initialize(path_parameters, request_adapter)
                        super(path_parameters, request_adapter, "{+baseurl}/directory/customSecurityAttributeDefinitions/{customSecurityAttributeDefinition%2Did}{?%24expand,%24select}")
                    end
                    ## 
                    ...
                    def to_delete_request_information(request_configuration=nil)
                        ...
                        request_info.url_template = '{+baseurl}/directory/customSecurityAttributeDefinitions/{customSecurityAttributeDefinition%2Did}'
