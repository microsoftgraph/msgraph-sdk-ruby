...
module MicrosoftGraph::Directory::DeletedItems::MicrosoftGraphValidateProperties
    ## 
    ...
    class MicrosoftGraphValidatePropertiesRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/directory/deletedItems/microsoft.graph.validateProperties"
