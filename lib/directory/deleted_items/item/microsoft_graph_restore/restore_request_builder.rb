...
module MicrosoftGraph::Directory::DeletedItems::Item::MicrosoftGraphRestore
    ## 
    ...
    class RestoreRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/directory/deletedItems/{directoryObject%2Did}/microsoft.graph.restore"
