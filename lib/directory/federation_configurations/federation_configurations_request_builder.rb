...
module MicrosoftGraph
    module Directory
        module FederationConfigurations
            ## 
            # Provides operations to manage the federationConfigurations property of the microsoft.graph.directory entity.
            class FederationConfigurationsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                
                ## 
                # Provides operations to call the availableProviderTypes method.
                def available_provider_types()
                    return MicrosoftGraph::Directory::FederationConfigurations::AvailableProviderTypes::AvailableProviderTypesRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                ...
                def initialize(path_parameters, request_adapter)
                    super(path_parameters, request_adapter, "{+baseurl}/directory/federationConfigurations{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}")
                end
                ## 
                ...
                def to_post_request_information(body, request_configuration=nil)
                    ...
                    request_info.url_template = '{+baseurl}/directory/federationConfigurations'
                    request_info.path_parameters = @path_parameters
                ...
                ## @return a federation_configurations_request_builder
                ## 
                def with_url(raw_url)
                    raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                    return FederationConfigurationsRequestBuilder.new(raw_url, @request_adapter)
                end
