...
module MicrosoftGraph::Directory::AdministrativeUnits::Item
    ## 
    ...
    class AdministrativeUnitItemRequestBuilder
        ...
        def extensions()
            return MicrosoftGraph::Directory::AdministrativeUnits::Item::Extensions::ExtensionsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the members property of the microsoft.graph.administrativeUnit entity.
        def members()
            return MicrosoftGraph::Directory::AdministrativeUnits::Item::Members::MembersRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def scoped_role_members()
            return MicrosoftGraph::Directory::AdministrativeUnits::Item::ScopedRoleMembers::ScopedRoleMembersRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, administrative_unit_id=nil)
            raise StandardError, 'path_parameters cannot be null' if path_parameters.nil?
            raise StandardError, 'request_adapter cannot be null' if request_adapter.nil?
            @url_template = "{+baseurl}/directory/administrativeUnits/{administrativeUnit%2Did}{?%24select,%24expand}"
