...
require_relative './microsoft_graph_service_principal'

module MicrosoftGraph::Directory::AdministrativeUnits::Item::Members::MicrosoftGraphServicePrincipal
    ## 
    ...
    class ServicePrincipalRequestBuilder
        ...
        def count()
            return MicrosoftGraph::Directory::AdministrativeUnits::Item::Members::MicrosoftGraphServicePrincipal::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
