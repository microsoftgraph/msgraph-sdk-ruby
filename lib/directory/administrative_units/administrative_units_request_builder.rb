...
module MicrosoftGraph::Directory::AdministrativeUnits
    ## 
    ...
    class AdministrativeUnitsRequestBuilder
        ...
        def count()
            return MicrosoftGraph::Directory::AdministrativeUnits::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the delta method.
        def microsoft_graph_delta()
            return MicrosoftGraph::Directory::AdministrativeUnits::MicrosoftGraphDelta::DeltaRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/directory/administrativeUnits{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
