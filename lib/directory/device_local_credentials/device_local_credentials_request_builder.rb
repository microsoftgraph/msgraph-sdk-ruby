    ...
    module Directory
        module DeviceLocalCredentials
            ...
            class DeviceLocalCredentialsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def count()
                    return MicrosoftGraph::Directory::DeviceLocalCredentials::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                ## Provides operations to manage the deviceLocalCredentials property of the microsoft.graph.directory entity.
                ...
                def by_device_local_credential_info_id(device_local_credential_info_id)
                    ...
                    return MicrosoftGraph::Directory::DeviceLocalCredentials::Item::DeviceLocalCredentialInfoItemRequestBuilder.new(url_tpl_params, @request_adapter)
                end
                ## 
                ...
                def initialize(path_parameters, request_adapter)
                    super(path_parameters, request_adapter, "{+baseurl}/directory/deviceLocalCredentials{?%24count,%24filter,%24orderby,%24search,%24select,%24top}")
                end
                ## 
                ...
                def get(request_configuration=nil)
                    ...
                    return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraph::Models::DeviceLocalCredentialInfoCollectionResponse.create_from_discriminator_value(pn) }, error_mapping)
                end
                ## 
                ...
                def post(body, request_configuration=nil)
                    ...
                    error_mapping = Hash.new
                    error_mapping["XXX"] = lambda {|pn| MicrosoftGraph::Models::ODataErrorsODataError.create_from_discriminator_value(pn) }
                    return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraph::Models::DeviceLocalCredentialInfo.create_from_discriminator_value(pn) }, error_mapping)
                end
                ## 
                ## Get a list of the deviceLocalCredentialInfo objects and their properties, excluding the credentials property. 
                ## @param request_configuration Configuration for the request such as headers, query parameters, and middleware options.
                ...
                def to_post_request_information(body, request_configuration=nil)
                    ...
                    request_info.url_template = '{+baseurl}/directory/deviceLocalCredentials'
                    request_info.path_parameters = @path_parameters
                ...
                ## @return a device_local_credentials_request_builder
                ## 
                def with_url(raw_url)
                    raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                    return DeviceLocalCredentialsRequestBuilder.new(raw_url, @request_adapter)
                end
