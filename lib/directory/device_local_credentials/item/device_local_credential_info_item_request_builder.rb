    ...
    module Directory
        module DeviceLocalCredentials
            module Item
                ...
                class DeviceLocalCredentialInfoItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def initialize(path_parameters, request_adapter)
                        super(path_parameters, request_adapter, "{+baseurl}/directory/deviceLocalCredentials/{deviceLocalCredentialInfo%2Did}{?%24select}")
                    end
                    ## 
                    ...
                    def to_delete_request_information(request_configuration=nil)
                        ...
                        request_info.url_template = '{+baseurl}/directory/deviceLocalCredentials/{deviceLocalCredentialInfo%2Did}'
                    ...
                    def with_url(raw_url)
                        ...
                        return DeviceLocalCredentialInfoItemRequestBuilder.new(raw_url, @request_adapter)
                    end
