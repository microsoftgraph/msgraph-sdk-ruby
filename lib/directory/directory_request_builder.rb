...
require_relative './public_key_infrastructure/public_key_infrastructure_request_builder'
    ...
    module Directory
        ...
        class DirectoryRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
            ...
            def public_key_infrastructure()
                return MicrosoftGraph::Directory::PublicKeyInfrastructure::PublicKeyInfrastructureRequestBuilder.new(@path_parameters, @request_adapter)
            end
            ## 
