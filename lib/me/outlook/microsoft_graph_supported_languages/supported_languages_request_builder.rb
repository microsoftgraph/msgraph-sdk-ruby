...
module MicrosoftGraph::Me::Outlook::MicrosoftGraphSupportedLanguages
    ## 
    ...
    class SupportedLanguagesRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/outlook/microsoft.graph.supportedLanguages(){?%24top,%24skip,%24search,%24filter,%24count}"
        ...
        def get(request_configuration=nil)
            ...
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraph::Me::Outlook::MicrosoftGraphSupportedLanguages::SupportedLanguagesResponse.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
        ## Get the list of locales and languages that are supported for the user, as configured on the user's mailbox server. When setting up an Outlook client, the user selects the preferred language from this supported list. You can subsequently get the preferred language by getting the user's mailbox settings.
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
