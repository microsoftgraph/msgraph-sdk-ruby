                ...
                module HistoryItems
                    module Item
                        ...
                        class ActivityHistoryItemItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            def activity()
                                return MicrosoftGraph::Me::Activities::Item::HistoryItems::Item::Activity::ActivityRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            ...
                            def initialize(path_parameters, request_adapter)
                                super(path_parameters, request_adapter, "{+baseurl}/me/activities/{userActivity%2Did}/historyItems/{activityHistoryItem%2Did}{?%24select,%24expand}")
                            end
                            ## 
