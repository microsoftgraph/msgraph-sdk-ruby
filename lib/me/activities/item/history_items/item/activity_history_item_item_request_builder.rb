...
module MicrosoftGraph::Me::Activities::Item::HistoryItems::Item
    ## 
    ...
    class ActivityHistoryItemItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, activity_history_item_id=nil)
            ...
            @url_template = "{+baseurl}/me/activities/{userActivity%2Did}/historyItems/{activityHistoryItem%2Did}{?%24select,%24expand}"
