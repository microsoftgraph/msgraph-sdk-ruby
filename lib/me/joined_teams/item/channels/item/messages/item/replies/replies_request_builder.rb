...
module MicrosoftGraph::Me::JoinedTeams::Item::Channels::Item::Messages::Item::Replies
    ...
    class RepliesRequestBuilder
        ...
        def microsoft_graph_delta()
            return MicrosoftGraph::Me::JoinedTeams::Item::Channels::Item::Messages::Item::Replies::MicrosoftGraphDelta::DeltaRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
