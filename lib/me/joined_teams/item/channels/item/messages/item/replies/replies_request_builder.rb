...
module MicrosoftGraph::Me::JoinedTeams::Item::Channels::Item::Messages::Item::Replies
    ...
    class RepliesRequestBuilder
        ...
        def microsoft_graph_delta()
            return MicrosoftGraph::Me::JoinedTeams::Item::Channels::Item::Messages::Item::Replies::MicrosoftGraphDelta::MicrosoftGraphDeltaRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/joinedTeams/{team%2Did}/channels/{channel%2Did}/messages/{chatMessage%2Did}/replies{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
