...
module MicrosoftGraph::Me::JoinedTeams::Item::Channels::Item::Tabs::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/joinedTeams/{team%2Did}/channels/{channel%2Did}/tabs/$count{?%24search,%24filter}"
