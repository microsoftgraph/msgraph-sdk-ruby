...
module MicrosoftGraph::Me::JoinedTeams::Item::Tags::Item
    ## 
    ...
    class TeamworkTagItemRequestBuilder
        ...
        def members()
            return MicrosoftGraph::Me::JoinedTeams::Item::Tags::Item::Members::MembersRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter, teamwork_tag_id=nil)
            ...
            @url_template = "{+baseurl}/me/joinedTeams/{team%2Did}/tags/{teamworkTag%2Did}{?%24select,%24expand}"
