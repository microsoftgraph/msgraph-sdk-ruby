                            ...
                            module Replies
                                module Item
                                    ...
                                    class ChatMessageItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                        ...
                                        def set_reaction()
                                            return MicrosoftGraph::Me::JoinedTeams::Item::PrimaryChannel::Messages::Item::Replies::Item::SetReaction::SetReactionRequestBuilder.new(@path_parameters, @request_adapter)
                                        end
                                        ## 
                                        # Provides operations to call the softDelete method.
                                        def soft_delete()
                                            return MicrosoftGraph::Me::JoinedTeams::Item::PrimaryChannel::Messages::Item::Replies::Item::SoftDelete::SoftDeleteRequestBuilder.new(@path_parameters, @request_adapter)
                                        end
                                        ## 
                                        # Provides operations to call the undoSoftDelete method.
                                        def undo_soft_delete()
                                            return MicrosoftGraph::Me::JoinedTeams::Item::PrimaryChannel::Messages::Item::Replies::Item::UndoSoftDelete::UndoSoftDeleteRequestBuilder.new(@path_parameters, @request_adapter)
                                        end
                                        ## 
                                        # Provides operations to call the unsetReaction method.
                                        def unset_reaction()
                                            return MicrosoftGraph::Me::JoinedTeams::Item::PrimaryChannel::Messages::Item::Replies::Item::UnsetReaction::UnsetReactionRequestBuilder.new(@path_parameters, @request_adapter)
                                        end
                                        ## 
                                        ...
                                        def initialize(path_parameters, request_adapter)
                                            super(path_parameters, request_adapter, "{+baseurl}/me/joinedTeams/{team%2Did}/primaryChannel/messages/{chatMessage%2Did}/replies/{chatMessage%2Did1}{?%24select,%24expand}")
                                        end
                                        ## 
