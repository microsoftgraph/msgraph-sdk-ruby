...
module MicrosoftGraph::Me::JoinedTeams::Item::PrimaryChannel::Messages::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/joinedTeams/{team%2Did}/primaryChannel/messages/$count{?%24search,%24filter}"
