...
module MicrosoftGraph::Me::JoinedTeams::Item::PrimaryChannel::Members
    ...
    class MembersRequestBuilder
        ...
        def microsoft_graph_add()
            return MicrosoftGraph::Me::JoinedTeams::Item::PrimaryChannel::Members::MicrosoftGraphAdd::MicrosoftGraphAddRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
