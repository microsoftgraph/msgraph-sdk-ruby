...
module MicrosoftGraph::Me::JoinedTeams::Item::PrimaryChannel::Tabs::Item
    ## 
    ...
    class TeamsTabItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, teams_tab_id=nil)
            ...
            @url_template = "{+baseurl}/me/joinedTeams/{team%2Did}/primaryChannel/tabs/{teamsTab%2Did}{?%24select,%24expand}"
