...
module MicrosoftGraph::Me::JoinedTeams::Item::Schedule::TimeOffReasons::Item
    ## 
    ...
    class TimeOffReasonItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, time_off_reason_id=nil)
            ...
            @url_template = "{+baseurl}/me/joinedTeams/{team%2Did}/schedule/timeOffReasons/{timeOffReason%2Did}{?%24select}"
