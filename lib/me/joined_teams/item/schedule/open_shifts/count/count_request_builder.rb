...
module MicrosoftGraph::Me::JoinedTeams::Item::Schedule::OpenShifts::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/joinedTeams/{team%2Did}/schedule/openShifts/$count{?%24search,%24filter}"
