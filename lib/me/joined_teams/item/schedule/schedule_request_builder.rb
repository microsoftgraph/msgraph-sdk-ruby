...
module MicrosoftGraph::Me::JoinedTeams::Item::Schedule
    ## 
    ...
    class ScheduleRequestBuilder
        ...
        def microsoft_graph_share()
            return MicrosoftGraph::Me::JoinedTeams::Item::Schedule::MicrosoftGraphShare::MicrosoftGraphShareRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/joinedTeams/{team%2Did}/schedule{?%24select,%24expand}"
        ...
        def open_shift_change_requests_by_id(id)
            ...
            return MicrosoftGraph::Me::JoinedTeams::Item::Schedule::OpenShiftChangeRequests::Item::OpenShiftChangeRequestItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the openShifts property of the microsoft.graph.schedule entity.
        ## @param id Unique identifier of the item
        ...
        def open_shifts_by_id(id)
            ...
            return MicrosoftGraph::Me::JoinedTeams::Item::Schedule::OpenShifts::Item::OpenShiftItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def scheduling_groups_by_id(id)
            ...
            return MicrosoftGraph::Me::JoinedTeams::Item::Schedule::SchedulingGroups::Item::SchedulingGroupItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the shifts property of the microsoft.graph.schedule entity.
        ## @param id Unique identifier of the item
        ...
        def shifts_by_id(id)
            ...
            return MicrosoftGraph::Me::JoinedTeams::Item::Schedule::Shifts::Item::ShiftItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the swapShiftsChangeRequests property of the microsoft.graph.schedule entity.
        ## @param id Unique identifier of the item
        ...
        def swap_shifts_change_requests_by_id(id)
            ...
            return MicrosoftGraph::Me::JoinedTeams::Item::Schedule::SwapShiftsChangeRequests::Item::SwapShiftsChangeRequestItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the timeOffReasons property of the microsoft.graph.schedule entity.
        ## @param id Unique identifier of the item
        ...
        def time_off_reasons_by_id(id)
            ...
            return MicrosoftGraph::Me::JoinedTeams::Item::Schedule::TimeOffReasons::Item::TimeOffReasonItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the timeOffRequests property of the microsoft.graph.schedule entity.
        ## @param id Unique identifier of the item
        ...
        def time_off_requests_by_id(id)
            ...
            return MicrosoftGraph::Me::JoinedTeams::Item::Schedule::TimeOffRequests::Item::TimeOffRequestItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the timesOff property of the microsoft.graph.schedule entity.
        ## @param id Unique identifier of the item
        ...
        def times_off_by_id(id)
            ...
            return MicrosoftGraph::Me::JoinedTeams::Item::Schedule::TimesOff::Item::TimeOffItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Delete navigation property schedule for me
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
