...
module MicrosoftGraph::Me::JoinedTeams::Item::Schedule::OpenShiftChangeRequests::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/joinedTeams/{team%2Did}/schedule/openShiftChangeRequests/$count{?%24search,%24filter}"
