...
module MicrosoftGraph::Me::JoinedTeams::Item::Schedule::SchedulingGroups::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/joinedTeams/{team%2Did}/schedule/schedulingGroups/$count{?%24search,%24filter}"
