...
module MicrosoftGraph::Me::JoinedTeams::Item::Schedule::SchedulingGroups::Item
    ## 
    ...
    class SchedulingGroupItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, scheduling_group_id=)
            ...
            @url_template = "{+baseurl}/me/joinedTeams/{team%2Did}/schedule/schedulingGroups/{schedulingGroup%2Did}{?%24select}"
