                ...
                module InstalledApps
                    module Item
                        ...
                        class TeamsAppInstallationItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            def teams_app()
                                return MicrosoftGraph::Me::JoinedTeams::Item::InstalledApps::Item::TeamsApp::TeamsAppRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            # Provides operations to manage the teamsAppDefinition property of the microsoft.graph.teamsAppInstallation entity.
                            def teams_app_definition()
                                return MicrosoftGraph::Me::JoinedTeams::Item::InstalledApps::Item::TeamsAppDefinition::TeamsAppDefinitionRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            # Provides operations to call the upgrade method.
                            def upgrade()
                                return MicrosoftGraph::Me::JoinedTeams::Item::InstalledApps::Item::Upgrade::UpgradeRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            ...
                            def initialize(path_parameters, request_adapter)
                                super(path_parameters, request_adapter, "{+baseurl}/me/joinedTeams/{team%2Did}/installedApps/{teamsAppInstallation%2Did}{?%24select,%24expand}")
                            end
                            ## 
