...
module MicrosoftGraph::Me::JoinedTeams::Item::InstalledApps::Item
    ...
    class TeamsAppInstallationItemRequestBuilder
        ...
        def microsoft_graph_upgrade()
            return MicrosoftGraph::Me::JoinedTeams::Item::InstalledApps::Item::MicrosoftGraphUpgrade::MicrosoftGraphUpgradeRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
