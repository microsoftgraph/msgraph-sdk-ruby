...
module MicrosoftGraph::Me::JoinedTeams::Item
    ...
    class TeamItemRequestBuilder
        ...
        def microsoft_graph_archive()
            return MicrosoftGraph::Me::JoinedTeams::Item::MicrosoftGraphArchive::ArchiveRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the clone method.
        def microsoft_graph_clone()
            return MicrosoftGraph::Me::JoinedTeams::Item::MicrosoftGraphClone::CloneRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the completeMigration method.
        def microsoft_graph_complete_migration()
            return MicrosoftGraph::Me::JoinedTeams::Item::MicrosoftGraphCompleteMigration::CompleteMigrationRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the sendActivityNotification method.
        def microsoft_graph_send_activity_notification()
            return MicrosoftGraph::Me::JoinedTeams::Item::MicrosoftGraphSendActivityNotification::SendActivityNotificationRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the unarchive method.
        def microsoft_graph_unarchive()
            return MicrosoftGraph::Me::JoinedTeams::Item::MicrosoftGraphUnarchive::UnarchiveRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, team_id=nil)
