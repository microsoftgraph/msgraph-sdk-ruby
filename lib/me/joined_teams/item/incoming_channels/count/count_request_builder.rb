...
module MicrosoftGraph::Me::JoinedTeams::Item::IncomingChannels::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/joinedTeams/{team%2Did}/incomingChannels/$count{?%24search,%24filter}"
