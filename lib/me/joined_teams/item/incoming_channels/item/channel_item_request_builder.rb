...
module MicrosoftGraph::Me::JoinedTeams::Item::IncomingChannels::Item
    ## 
    ...
    class ChannelItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, channel_id=nil)
            ...
            @url_template = "{+baseurl}/me/joinedTeams/{team%2Did}/incomingChannels/{channel%2Did}{?%24select,%24expand}"
