...
module MicrosoftGraph::Me::Teamwork::AssociatedTeams::Item
    ## 
    ...
    class AssociatedTeamInfoItemRequestBuilder
        ...
        ## @param associatedTeamInfoId key: id of associatedTeamInfo
        ## @param pathParameters Path parameters for the request
        ## @param requestAdapter The request adapter to use to execute the requests.
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, associated_team_info_id=nil)
            raise StandardError, 'path_parameters cannot be null' if path_parameters.nil?
            raise StandardError, 'request_adapter cannot be null' if request_adapter.nil?
            @url_template = "{+baseurl}/me/teamwork/associatedTeams/{associatedTeamInfo%2Did}{?%24select,%24expand}"
