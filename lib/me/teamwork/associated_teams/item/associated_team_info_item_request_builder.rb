            ...
            module AssociatedTeams
                module Item
                    ...
                    class AssociatedTeamInfoItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def team()
                            return MicrosoftGraph::Me::Teamwork::AssociatedTeams::Item::Team::TeamRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/me/teamwork/associatedTeams/{associatedTeamInfo%2Did}{?%24select,%24expand}")
                        end
                        ## 
                        ...
                        def with_url(raw_url)
                            ...
                            return AssociatedTeamInfoItemRequestBuilder.new(raw_url, @request_adapter)
                        end
