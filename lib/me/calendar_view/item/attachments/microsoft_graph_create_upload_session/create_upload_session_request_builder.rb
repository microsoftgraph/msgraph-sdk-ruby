...
module MicrosoftGraph::Me::CalendarView::Item::Attachments::MicrosoftGraphCreateUploadSession
    ## 
    ...
    class CreateUploadSessionRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/calendarView/{event%2Did}/attachments/microsoft.graph.createUploadSession"
