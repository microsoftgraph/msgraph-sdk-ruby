...
module MicrosoftGraph::Me::CalendarView::Item::Instances::Item::MicrosoftGraphCancel
    ## 
    ...
    class MicrosoftGraphCancelRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/calendarView/{event%2Did}/instances/{event%2Did1}/microsoft.graph.cancel"
