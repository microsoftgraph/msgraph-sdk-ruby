...
module MicrosoftGraph::Me::CalendarView::Item::MultiValueExtendedProperties::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/calendarView/{event%2Did}/multiValueExtendedProperties/$count{?%24search,%24filter}"
