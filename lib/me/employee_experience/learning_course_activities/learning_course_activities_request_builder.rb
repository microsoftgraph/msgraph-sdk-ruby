        ...
        module EmployeeExperience
            module LearningCourseActivities
                ...
                class LearningCourseActivitiesRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def count()
                        return MicrosoftGraph::Me::EmployeeExperience::LearningCourseActivities::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ## Provides operations to manage the learningCourseActivities property of the microsoft.graph.employeeExperienceUser entity.
                    ...
                    def by_learning_course_activity_id(learning_course_activity_id)
                        ...
                        return MicrosoftGraph::Me::EmployeeExperience::LearningCourseActivities::Item::LearningCourseActivityItemRequestBuilder.new(url_tpl_params, @request_adapter)
                    end
                    ## 
                    ...
                    def initialize(path_parameters, request_adapter)
                        super(path_parameters, request_adapter, "{+baseurl}/me/employeeExperience/learningCourseActivities{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}")
                    end
                    ## 
