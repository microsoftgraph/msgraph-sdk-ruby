        ...
        module EmployeeExperience
            ...
            class EmployeeExperienceRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def learning_course_activities()
                    return MicrosoftGraph::Me::EmployeeExperience::LearningCourseActivities::LearningCourseActivitiesRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                ...
                def initialize(path_parameters, request_adapter)
                    super(path_parameters, request_adapter, "{+baseurl}/me/employeeExperience{?%24select,%24expand}")
                end
                ## 
