...
module MicrosoftGraph::Me::Events::Item::Instances::Item::Extensions::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/events/{event%2Did}/instances/{event%2Did1}/extensions/$count{?%24filter}"
