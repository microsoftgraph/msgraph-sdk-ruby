...
module MicrosoftGraph::Me::Events::Item::Instances::Item::MicrosoftGraphDecline
    ## 
    ...
    class DeclineRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/events/{event%2Did}/instances/{event%2Did1}/microsoft.graph.decline"
