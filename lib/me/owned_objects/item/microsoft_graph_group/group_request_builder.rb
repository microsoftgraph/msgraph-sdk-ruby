...
module MicrosoftGraph::Me::OwnedObjects::Item::MicrosoftGraphGroup
    ## 
    ...
    class GroupRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/ownedObjects/{directoryObject%2Did}/microsoft.graph.group{?%24select,%24expand}"
