...
module MicrosoftGraph::Me::OwnedObjects::Item::MicrosoftGraphApplication
    ## 
    ...
    class ApplicationRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/ownedObjects/{directoryObject%2Did}/microsoft.graph.application{?%24select,%24expand}"
