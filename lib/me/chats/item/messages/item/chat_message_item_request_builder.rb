...
module MicrosoftGraph::Me::Chats::Item::Messages::Item
    ...
    class ChatMessageItemRequestBuilder
        ...
        def microsoft_graph_soft_delete()
            return MicrosoftGraph::Me::Chats::Item::Messages::Item::MicrosoftGraphSoftDelete::MicrosoftGraphSoftDeleteRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the undoSoftDelete method.
        def microsoft_graph_undo_soft_delete()
            return MicrosoftGraph::Me::Chats::Item::Messages::Item::MicrosoftGraphUndoSoftDelete::MicrosoftGraphUndoSoftDeleteRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def replies()
            return MicrosoftGraph::Me::Chats::Item::Messages::Item::Replies::RepliesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/chats/{chat%2Did}/messages/{chatMessage%2Did}{?%24select,%24expand}"
