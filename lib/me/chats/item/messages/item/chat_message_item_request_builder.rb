                ...
                module Messages
                    module Item
                        ...
                        class ChatMessageItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            def set_reaction()
                                return MicrosoftGraph::Me::Chats::Item::Messages::Item::SetReaction::SetReactionRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            ...
                            def unset_reaction()
                                return MicrosoftGraph::Me::Chats::Item::Messages::Item::UnsetReaction::UnsetReactionRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            ...
                            def initialize(path_parameters, request_adapter)
                                super(path_parameters, request_adapter, "{+baseurl}/me/chats/{chat%2Did}/messages/{chatMessage%2Did}{?%24select,%24expand}")
                            end
                            ## 
