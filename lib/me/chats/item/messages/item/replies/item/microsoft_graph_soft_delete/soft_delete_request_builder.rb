...
module MicrosoftGraph::Me::Chats::Item::Messages::Item::Replies::Item::MicrosoftGraphSoftDelete
    ## 
    ...
    class SoftDeleteRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/chats/{chat%2Did}/messages/{chatMessage%2Did}/replies/{chatMessage%2Did1}/microsoft.graph.softDelete"
