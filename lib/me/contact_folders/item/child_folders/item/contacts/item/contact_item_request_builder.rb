...
module MicrosoftGraph::Me::ContactFolders::Item::ChildFolders::Item::Contacts::Item
    ## 
    ...
    class ContactItemRequestBuilder
        ...
        def extensions()
            return MicrosoftGraph::Me::ContactFolders::Item::ChildFolders::Item::Contacts::Item::Extensions::ExtensionsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the multiValueExtendedProperties property of the microsoft.graph.contact entity.
        def multi_value_extended_properties()
            return MicrosoftGraph::Me::ContactFolders::Item::ChildFolders::Item::Contacts::Item::MultiValueExtendedProperties::MultiValueExtendedPropertiesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def photo()
            return MicrosoftGraph::Me::ContactFolders::Item::ChildFolders::Item::Contacts::Item::Photo::PhotoRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def single_value_extended_properties()
            return MicrosoftGraph::Me::ContactFolders::Item::ChildFolders::Item::Contacts::Item::SingleValueExtendedProperties::SingleValueExtendedPropertiesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, contact_id=nil)
            raise StandardError, 'path_parameters cannot be null' if path_parameters.nil?
            raise StandardError, 'request_adapter cannot be null' if request_adapter.nil?
            @url_template = "{+baseurl}/me/contactFolders/{contactFolder%2Did}/childFolders/{contactFolder%2Did1}/contacts/{contact%2Did}{?%24select,%24expand}"
        ...
        def extensions_by_id(id)
            ...
            return MicrosoftGraph::Me::ContactFolders::Item::ChildFolders::Item::Contacts::Item::Extensions::Item::ExtensionItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def multi_value_extended_properties_by_id(id)
            ...
            return MicrosoftGraph::Me::ContactFolders::Item::ChildFolders::Item::Contacts::Item::MultiValueExtendedProperties::Item::MultiValueLegacyExtendedPropertyItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def single_value_extended_properties_by_id(id)
            ...
            return MicrosoftGraph::Me::ContactFolders::Item::ChildFolders::Item::Contacts::Item::SingleValueExtendedProperties::Item::SingleValueLegacyExtendedPropertyItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Delete navigation property contacts for me
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
