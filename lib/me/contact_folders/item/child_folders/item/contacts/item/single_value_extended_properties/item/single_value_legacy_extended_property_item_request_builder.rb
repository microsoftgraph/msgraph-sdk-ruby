...
module MicrosoftGraph::Me::ContactFolders::Item::ChildFolders::Item::Contacts::Item::SingleValueExtendedProperties::Item
    ## 
    ...
    class SingleValueLegacyExtendedPropertyItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, single_value_legacy_extended_property_id=)
            ...
            @url_template = "{+baseurl}/me/contactFolders/{contactFolder%2Did}/childFolders/{contactFolder%2Did1}/contacts/{contact%2Did}/singleValueExtendedProperties/{singleValueLegacyExtendedProperty%2Did}{?%24select,%24expand}"
