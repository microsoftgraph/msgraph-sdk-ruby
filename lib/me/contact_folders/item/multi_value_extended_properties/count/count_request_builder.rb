...
module MicrosoftGraph::Me::ContactFolders::Item::MultiValueExtendedProperties::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/contactFolders/{contactFolder%2Did}/multiValueExtendedProperties/$count{?%24search,%24filter}"
