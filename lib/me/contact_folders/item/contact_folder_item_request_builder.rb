...
module MicrosoftGraph::Me::ContactFolders::Item
    ## 
    ...
    class ContactFolderItemRequestBuilder
        ...
        def child_folders()
            return MicrosoftGraph::Me::ContactFolders::Item::ChildFolders::ChildFoldersRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, contact_folder_id=)
            raise StandardError, 'path_parameters cannot be null' if path_parameters.nil?
            raise StandardError, 'request_adapter cannot be null' if request_adapter.nil?
            @url_template = "{+baseurl}/me/contactFolders/{contactFolder%2Did}{?%24select}"
