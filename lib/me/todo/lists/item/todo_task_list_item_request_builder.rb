...
module MicrosoftGraph::Me::Todo::Lists::Item
    ## 
    ...
    class TodoTaskListItemRequestBuilder
        ...
        def extensions()
            return MicrosoftGraph::Me::Todo::Lists::Item::Extensions::ExtensionsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def tasks()
            return MicrosoftGraph::Me::Todo::Lists::Item::Tasks::TasksRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, todo_task_list_id=nil)
            raise StandardError, 'path_parameters cannot be null' if path_parameters.nil?
            raise StandardError, 'request_adapter cannot be null' if request_adapter.nil?
            @url_template = "{+baseurl}/me/todo/lists/{todoTaskList%2Did}{?%24select,%24expand}"
        ...
        def extensions_by_id(id)
            ...
            return MicrosoftGraph::Me::Todo::Lists::Item::Extensions::Item::ExtensionItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
