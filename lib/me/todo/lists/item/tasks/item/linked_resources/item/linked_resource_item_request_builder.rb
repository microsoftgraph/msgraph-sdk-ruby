...
module MicrosoftGraph::Me::Todo::Lists::Item::Tasks::Item::LinkedResources::Item
    ## 
    ...
    class LinkedResourceItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, linked_resource_id=nil)
            ...
            @url_template = "{+baseurl}/me/todo/lists/{todoTaskList%2Did}/tasks/{todoTask%2Did}/linkedResources/{linkedResource%2Did}{?%24select,%24expand}"
