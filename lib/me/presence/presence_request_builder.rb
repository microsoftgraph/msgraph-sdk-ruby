...
module MicrosoftGraph
    module Me
        module Presence
            ...
            class PresenceRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def set_status_message()
                    return MicrosoftGraph::Me::Presence::SetStatusMessage::SetStatusMessageRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                ...
                def initialize(path_parameters, request_adapter)
                    super(path_parameters, request_adapter, "{+baseurl}/me/presence{?%24select,%24expand}")
                end
                ## 
