...
module MicrosoftGraph::Me::TransitiveMemberOf::MicrosoftGraphGroup::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/transitiveMemberOf/microsoft.graph.group/$count{?%24search,%24filter}"
