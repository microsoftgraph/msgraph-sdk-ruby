...
module MicrosoftGraph::Me::TransitiveMemberOf::Item::MicrosoftGraphServicePrincipal
    ## 
    ...
    class MicrosoftGraphServicePrincipalRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/transitiveMemberOf/{directoryObject%2Did}/microsoft.graph.servicePrincipal{?%24select,%24expand}"
