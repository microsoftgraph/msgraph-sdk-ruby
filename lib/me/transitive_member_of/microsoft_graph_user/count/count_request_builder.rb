...
module MicrosoftGraph::Me::TransitiveMemberOf::MicrosoftGraphUser::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/transitiveMemberOf/microsoft.graph.user/$count{?%24search,%24filter}"
