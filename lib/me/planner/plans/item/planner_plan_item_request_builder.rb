...
module MicrosoftGraph::Me::Planner::Plans::Item
    ## 
    ...
    class PlannerPlanItemRequestBuilder
        ...
        def buckets()
            return MicrosoftGraph::Me::Planner::Plans::Item::Buckets::BucketsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the details property of the microsoft.graph.plannerPlan entity.
        def details()
            return MicrosoftGraph::Me::Planner::Plans::Item::Details::DetailsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def tasks()
            return MicrosoftGraph::Me::Planner::Plans::Item::Tasks::TasksRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, planner_plan_id=nil)
            raise StandardError, 'path_parameters cannot be null' if path_parameters.nil?
            raise StandardError, 'request_adapter cannot be null' if request_adapter.nil?
            @url_template = "{+baseurl}/me/planner/plans/{plannerPlan%2Did}{?%24select,%24expand}"
        ...
        def tasks_by_id(id)
            ...
            return MicrosoftGraph::Me::Planner::Plans::Item::Tasks::Item::PlannerTaskItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Delete navigation property plans for me
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
