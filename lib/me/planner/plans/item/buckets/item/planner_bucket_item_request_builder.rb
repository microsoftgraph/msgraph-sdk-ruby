...
module MicrosoftGraph::Me::Planner::Plans::Item::Buckets::Item
    ## 
    ...
    class PlannerBucketItemRequestBuilder
        ...
        def tasks()
            return MicrosoftGraph::Me::Planner::Plans::Item::Buckets::Item::Tasks::TasksRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter, planner_bucket_id=)
            ...
            @url_template = "{+baseurl}/me/planner/plans/{plannerPlan%2Did}/buckets/{plannerBucket%2Did}{?%24select,%24expand}"
