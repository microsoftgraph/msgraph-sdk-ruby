...
module MicrosoftGraph::Me::CreatedObjects::ServicePrincipal::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/createdObjects/microsoft.graph.servicePrincipal/$count{?%24search,%24filter}"
