...
module MicrosoftGraph::Me::RegisteredDevices::MicrosoftGraphAppRoleAssignment
    ## 
    ...
    class MicrosoftGraphAppRoleAssignmentRequestBuilder
        ...
        def count()
            return MicrosoftGraph::Me::RegisteredDevices::MicrosoftGraphAppRoleAssignment::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
