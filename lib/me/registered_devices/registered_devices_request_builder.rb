...
module MicrosoftGraph::Me::RegisteredDevices
    ...
    class RegisteredDevicesRequestBuilder
        ...
        def microsoft_graph_app_role_assignment()
            return MicrosoftGraph::Me::RegisteredDevices::MicrosoftGraphAppRoleAssignment::AppRoleAssignmentRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Casts the previous resource to device.
        def microsoft_graph_device()
            return MicrosoftGraph::Me::RegisteredDevices::MicrosoftGraphDevice::DeviceRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Casts the previous resource to endpoint.
        def microsoft_graph_endpoint()
            return MicrosoftGraph::Me::RegisteredDevices::MicrosoftGraphEndpoint::EndpointRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
