...
module MicrosoftGraph::Me::CalendarGroups::Item::Calendars::Item::Events::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/calendarGroups/{calendarGroup%2Did}/calendars/{calendar%2Did}/events/$count{?%24filter}"
