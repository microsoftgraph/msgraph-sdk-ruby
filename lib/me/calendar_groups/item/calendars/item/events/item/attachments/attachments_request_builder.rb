...
module MicrosoftGraph::Me::CalendarGroups::Item::Calendars::Item::Events::Item::Attachments
    ## 
    ...
    class AttachmentsRequestBuilder
        ...
        def count()
            return MicrosoftGraph::Me::CalendarGroups::Item::Calendars::Item::Events::Item::Attachments::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the createUploadSession method.
        def microsoft_graph_create_upload_session()
            return MicrosoftGraph::Me::CalendarGroups::Item::Calendars::Item::Events::Item::Attachments::MicrosoftGraphCreateUploadSession::MicrosoftGraphCreateUploadSessionRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/calendarGroups/{calendarGroup%2Did}/calendars/{calendar%2Did}/events/{event%2Did}/attachments{?%24top,%24skip,%24filter,%24count,%24orderby,%24select,%24expand}"
