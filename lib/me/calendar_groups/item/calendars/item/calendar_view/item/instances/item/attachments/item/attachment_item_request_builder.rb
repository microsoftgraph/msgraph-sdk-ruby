...
module MicrosoftGraph::Me::CalendarGroups::Item::Calendars::Item::CalendarView::Item::Instances::Item::Attachments::Item
    ## 
    ...
    class AttachmentItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, attachment_id=nil)
            ...
            @url_template = "{+baseurl}/me/calendarGroups/{calendarGroup%2Did}/calendars/{calendar%2Did}/calendarView/{event%2Did}/instances/{event%2Did1}/attachments/{attachment%2Did}{?%24select,%24expand}"
