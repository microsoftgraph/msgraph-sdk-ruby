...
module MicrosoftGraph::Me::CalendarGroups::Item::Calendars::Item::CalendarView::Item::Instances
    ...
    class InstancesRequestBuilder
        ...
        def microsoft_graph_delta()
            return MicrosoftGraph::Me::CalendarGroups::Item::Calendars::Item::CalendarView::Item::Instances::MicrosoftGraphDelta::DeltaRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
