...
module MicrosoftGraph::Me::CalendarGroups::Item::Calendars::Item::CalendarView::Item::Instances
    ## 
    ...
    class InstancesRequestBuilder
        ...
        def microsoft_graph_delta()
            return MicrosoftGraph::Me::CalendarGroups::Item::Calendars::Item::CalendarView::Item::Instances::MicrosoftGraphDelta::MicrosoftGraphDeltaRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/calendarGroups/{calendarGroup%2Did}/calendars/{calendar%2Did}/calendarView/{event%2Did}/instances{?%24top,%24skip,%24filter,%24count,%24orderby,%24select}"
