...
require_relative '../../models/calendar_group_collection_response'
...
module MicrosoftGraph
    module Me
        module CalendarGroups
            ...
            class CalendarGroupsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                
                ## 
                # Provides operations to count the resources in the collection.
                def count()
                    return MicrosoftGraph::Me::CalendarGroups::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                ## Provides operations to manage the calendarGroups property of the microsoft.graph.user entity.
                ...
                def initialize(path_parameters, request_adapter)
                    super(path_parameters, request_adapter, "{+baseurl}/me/calendarGroups{?%24top,%24skip,%24filter,%24count,%24orderby,%24select}")
                end
                ## 
                ...
                ## @return a calendar_groups_request_builder
                ## 
                def with_url(raw_url)
                    raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                    return CalendarGroupsRequestBuilder.new(raw_url, @request_adapter)
                end
