...
module MicrosoftGraph::Me::ManagedDevices::Item
    ...
    class ManagedDeviceItemRequestBuilder
        ...
        def microsoft_graph_bypass_activation_lock()
            return MicrosoftGraph::Me::ManagedDevices::Item::MicrosoftGraphBypassActivationLock::BypassActivationLockRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the cleanWindowsDevice method.
        def microsoft_graph_clean_windows_device()
            return MicrosoftGraph::Me::ManagedDevices::Item::MicrosoftGraphCleanWindowsDevice::CleanWindowsDeviceRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the deleteUserFromSharedAppleDevice method.
        def microsoft_graph_delete_user_from_shared_apple_device()
            return MicrosoftGraph::Me::ManagedDevices::Item::MicrosoftGraphDeleteUserFromSharedAppleDevice::DeleteUserFromSharedAppleDeviceRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the disableLostMode method.
        def microsoft_graph_disable_lost_mode()
            return MicrosoftGraph::Me::ManagedDevices::Item::MicrosoftGraphDisableLostMode::DisableLostModeRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the locateDevice method.
        def microsoft_graph_locate_device()
            return MicrosoftGraph::Me::ManagedDevices::Item::MicrosoftGraphLocateDevice::LocateDeviceRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the logoutSharedAppleDeviceActiveUser method.
        def microsoft_graph_logout_shared_apple_device_active_user()
            return MicrosoftGraph::Me::ManagedDevices::Item::MicrosoftGraphLogoutSharedAppleDeviceActiveUser::LogoutSharedAppleDeviceActiveUserRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the rebootNow method.
        def microsoft_graph_reboot_now()
            return MicrosoftGraph::Me::ManagedDevices::Item::MicrosoftGraphRebootNow::RebootNowRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the recoverPasscode method.
        def microsoft_graph_recover_passcode()
            return MicrosoftGraph::Me::ManagedDevices::Item::MicrosoftGraphRecoverPasscode::RecoverPasscodeRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the remoteLock method.
        def microsoft_graph_remote_lock()
            return MicrosoftGraph::Me::ManagedDevices::Item::MicrosoftGraphRemoteLock::RemoteLockRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the requestRemoteAssistance method.
        def microsoft_graph_request_remote_assistance()
            return MicrosoftGraph::Me::ManagedDevices::Item::MicrosoftGraphRequestRemoteAssistance::RequestRemoteAssistanceRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the resetPasscode method.
        def microsoft_graph_reset_passcode()
            return MicrosoftGraph::Me::ManagedDevices::Item::MicrosoftGraphResetPasscode::ResetPasscodeRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the retire method.
        def microsoft_graph_retire()
            return MicrosoftGraph::Me::ManagedDevices::Item::MicrosoftGraphRetire::RetireRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the shutDown method.
        def microsoft_graph_shut_down()
            return MicrosoftGraph::Me::ManagedDevices::Item::MicrosoftGraphShutDown::ShutDownRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the syncDevice method.
        def microsoft_graph_sync_device()
            return MicrosoftGraph::Me::ManagedDevices::Item::MicrosoftGraphSyncDevice::SyncDeviceRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the updateWindowsDeviceAccount method.
        def microsoft_graph_update_windows_device_account()
            return MicrosoftGraph::Me::ManagedDevices::Item::MicrosoftGraphUpdateWindowsDeviceAccount::UpdateWindowsDeviceAccountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the windowsDefenderScan method.
        def microsoft_graph_windows_defender_scan()
            return MicrosoftGraph::Me::ManagedDevices::Item::MicrosoftGraphWindowsDefenderScan::WindowsDefenderScanRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the windowsDefenderUpdateSignatures method.
        def microsoft_graph_windows_defender_update_signatures()
            return MicrosoftGraph::Me::ManagedDevices::Item::MicrosoftGraphWindowsDefenderUpdateSignatures::WindowsDefenderUpdateSignaturesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the wipe method.
        def microsoft_graph_wipe()
            return MicrosoftGraph::Me::ManagedDevices::Item::MicrosoftGraphWipe::WipeRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
