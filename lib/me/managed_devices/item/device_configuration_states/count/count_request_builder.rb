...
module MicrosoftGraph::Me::ManagedDevices::Item::DeviceConfigurationStates::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/managedDevices/{managedDevice%2Did}/deviceConfigurationStates/$count{?%24search,%24filter}"
