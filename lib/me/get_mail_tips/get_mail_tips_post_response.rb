...
module MicrosoftGraph
    module Me
        module GetMailTips
            class GetMailTipsPostResponse < MicrosoftGraph::Models::BaseCollectionPaginationCountResponse
                ...
                ## @return a get_mail_tips_post_response
                ## 
                def self.create_from_discriminator_value(parse_node)
                    raise StandardError, 'parse_node cannot be null' if parse_node.nil?
                    return GetMailTipsPostResponse.new
                end
                ## 
