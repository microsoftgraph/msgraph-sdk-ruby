            ...
            module Item
                ...
                class OnlineMeetingItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def attendance_reports()
                        return MicrosoftGraph::Me::OnlineMeetings::Item::AttendanceReports::AttendanceReportsRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to manage the media for the user entity.
                    def attendee_report()
                        return MicrosoftGraph::Me::OnlineMeetings::Item::AttendeeReport::AttendeeReportRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to call the getVirtualAppointmentJoinWebUrl method.
                    def get_virtual_appointment_join_web_url()
                        return MicrosoftGraph::Me::OnlineMeetings::Item::GetVirtualAppointmentJoinWebUrl::GetVirtualAppointmentJoinWebUrlRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to manage the recordings property of the microsoft.graph.onlineMeeting entity.
                    def recordings()
                        return MicrosoftGraph::Me::OnlineMeetings::Item::Recordings::RecordingsRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to manage the transcripts property of the microsoft.graph.onlineMeeting entity.
                    def transcripts()
                        return MicrosoftGraph::Me::OnlineMeetings::Item::Transcripts::TranscriptsRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
