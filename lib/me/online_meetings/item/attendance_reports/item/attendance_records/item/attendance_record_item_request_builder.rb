...
module MicrosoftGraph::Me::OnlineMeetings::Item::AttendanceReports::Item::AttendanceRecords::Item
    ## 
    ...
    class AttendanceRecordItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, attendance_record_id=nil)
            ...
            @url_template = "{+baseurl}/me/onlineMeetings/{onlineMeeting%2Did}/attendanceReports/{meetingAttendanceReport%2Did}/attendanceRecords/{attendanceRecord%2Did}{?%24select,%24expand}"
