                ...
                module Recordings
                    module Item
                        ...
                        class CallRecordingItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            def content()
                                return MicrosoftGraph::Me::OnlineMeetings::Item::Recordings::Item::Content::ContentRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            ...
                            def initialize(path_parameters, request_adapter)
                                super(path_parameters, request_adapter, "{+baseurl}/me/onlineMeetings/{onlineMeeting%2Did}/recordings/{callRecording%2Did}{?%24select,%24expand}")
                            end
                            ## 
