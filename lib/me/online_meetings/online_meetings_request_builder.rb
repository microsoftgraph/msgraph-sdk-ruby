...
module MicrosoftGraph::Me::OnlineMeetings
    ## 
    ...
    class OnlineMeetingsRequestBuilder
        ...
        def count()
            return MicrosoftGraph::Me::OnlineMeetings::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the createOrGet method.
        def microsoft_graph_create_or_get()
            return MicrosoftGraph::Me::OnlineMeetings::MicrosoftGraphCreateOrGet::CreateOrGetRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/onlineMeetings{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
