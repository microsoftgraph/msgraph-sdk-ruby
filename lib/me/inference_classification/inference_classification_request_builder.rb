...
module MicrosoftGraph::Me::InferenceClassification
    ## 
    ...
    class InferenceClassificationRequestBuilder
        ...
        def overrides()
            return MicrosoftGraph::Me::InferenceClassification::Overrides::OverridesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/inferenceClassification{?%24select}"
