...
module MicrosoftGraph::Me::MailFolders::Item::Messages::Item::MicrosoftGraphReply
    ## 
    ...
    class ReplyRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/mailFolders/{mailFolder%2Did}/messages/{message%2Did}/microsoft.graph.reply"
