...
module MicrosoftGraph::Me::MailFolders::Item::SingleValueExtendedProperties::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/mailFolders/{mailFolder%2Did}/singleValueExtendedProperties/$count{?%24search,%24filter}"
