...
module MicrosoftGraph::Me::MailFolders::Item::ChildFolders::Item::Messages::Item::Extensions::Item
    ## 
    ...
    class ExtensionItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, extension_id=)
            ...
            @url_template = "{+baseurl}/me/mailFolders/{mailFolder%2Did}/childFolders/{mailFolder%2Did1}/messages/{message%2Did}/extensions/{extension%2Did}{?%24select,%24expand}"
