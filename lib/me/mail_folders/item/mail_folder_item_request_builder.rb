...
module MicrosoftGraph::Me::MailFolders::Item
    ## 
    ...
    class MailFolderItemRequestBuilder
        ...
        def microsoft_graph_copy()
            return MicrosoftGraph::Me::MailFolders::Item::MicrosoftGraphCopy::MicrosoftGraphCopyRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the move method.
        def microsoft_graph_move()
            return MicrosoftGraph::Me::MailFolders::Item::MicrosoftGraphMove::MicrosoftGraphMoveRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
