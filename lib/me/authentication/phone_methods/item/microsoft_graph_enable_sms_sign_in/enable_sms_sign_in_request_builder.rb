...
require_relative './microsoft_graph_enable_sms_sign_in'

module MicrosoftGraph::Me::Authentication::PhoneMethods::Item::MicrosoftGraphEnableSmsSignIn
    ## 
    ...
    class EnableSmsSignInRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/authentication/phoneMethods/{phoneAuthenticationMethod%2Did}/microsoft.graph.enableSmsSignIn"
