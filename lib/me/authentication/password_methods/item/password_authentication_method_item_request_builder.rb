...
module MicrosoftGraph::Me::Authentication::PasswordMethods::Item
    ## 
    ...
    class PasswordAuthenticationMethodItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, password_authentication_method_id=nil)
            ...
            @url_template = "{+baseurl}/me/authentication/passwordMethods/{passwordAuthenticationMethod%2Did}{?%24select,%24expand}"
