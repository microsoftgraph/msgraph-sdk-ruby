...
module MicrosoftGraph::Me::Authentication::WindowsHelloForBusinessMethods::Item
    ## 
    ...
    class WindowsHelloForBusinessAuthenticationMethodItemRequestBuilder
        ...
        def device()
            return MicrosoftGraph::Me::Authentication::WindowsHelloForBusinessMethods::Item::Device::DeviceRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, windows_hello_for_business_authentication_method_id=nil)
            raise StandardError, 'path_parameters cannot be null' if path_parameters.nil?
            raise StandardError, 'request_adapter cannot be null' if request_adapter.nil?
            @url_template = "{+baseurl}/me/authentication/windowsHelloForBusinessMethods/{windowsHelloForBusinessAuthenticationMethod%2Did}{?%24select,%24expand}"
