...
module MicrosoftGraph::Me::Authentication::TemporaryAccessPassMethods::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/authentication/temporaryAccessPassMethods/$count{?%24search,%24filter}"
