...
module MicrosoftGraph::Me::Authentication::TemporaryAccessPassMethods::Item
    ## 
    ...
    class TemporaryAccessPassAuthenticationMethodItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, temporary_access_pass_authentication_method_id=nil)
            ...
            @url_template = "{+baseurl}/me/authentication/temporaryAccessPassMethods/{temporaryAccessPassAuthenticationMethod%2Did}{?%24select,%24expand}"
