...
module MicrosoftGraph::Me::Authentication::SoftwareOathMethods::Item
    ## 
    ...
    class SoftwareOathAuthenticationMethodItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, software_oath_authentication_method_id=nil)
            ...
            @url_template = "{+baseurl}/me/authentication/softwareOathMethods/{softwareOathAuthenticationMethod%2Did}{?%24select,%24expand}"
