...
module MicrosoftGraph::Me::Authentication::EmailMethods::Item
    ## 
    ...
    class EmailAuthenticationMethodItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, email_authentication_method_id=nil)
            ...
            @url_template = "{+baseurl}/me/authentication/emailMethods/{emailAuthenticationMethod%2Did}{?%24select,%24expand}"
