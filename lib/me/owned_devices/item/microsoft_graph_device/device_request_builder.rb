...
module MicrosoftGraph::Me::OwnedDevices::Item::MicrosoftGraphDevice
    ## 
    ...
    class DeviceRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/ownedDevices/{directoryObject%2Did}/microsoft.graph.device{?%24select,%24expand}"
