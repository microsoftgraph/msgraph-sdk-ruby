...
module MicrosoftGraph::Me::Drives::Item::Items::Item::Children::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/drives/{drive%2Did}/items/{driveItem%2Did}/children/$count{?%24search,%24filter}"
