...
module MicrosoftGraph::Me::Drives::Item::Items::Item::ListItem::DriveItem::Content
    ## 
    ...
    class ContentRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/drives/{drive%2Did}/items/{driveItem%2Did}/listItem/driveItem/content"
