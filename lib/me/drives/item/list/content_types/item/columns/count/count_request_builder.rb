...
module MicrosoftGraph::Me::Drives::Item::List::ContentTypes::Item::Columns::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/drives/{drive%2Did}/list/contentTypes/{contentType%2Did}/columns/$count{?%24search,%24filter}"
