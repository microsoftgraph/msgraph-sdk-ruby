...
module MicrosoftGraph::Me::Drives::Item::List::ContentTypes::Item::BaseTypes::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/drives/{drive%2Did}/list/contentTypes/{contentType%2Did}/baseTypes/$count{?%24search,%24filter}"
