...
module MicrosoftGraph::Me::Drives::Item::List::Items::Item::DocumentSetVersions::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/drives/{drive%2Did}/list/items/{listItem%2Did}/documentSetVersions/$count{?%24search,%24filter}"
