...
module MicrosoftGraph::Me::Drives::Item::Root::ListItem::Versions::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/drives/{drive%2Did}/root/listItem/versions/$count{?%24search,%24filter}"
