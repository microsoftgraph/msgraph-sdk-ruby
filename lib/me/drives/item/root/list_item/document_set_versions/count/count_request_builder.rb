...
module MicrosoftGraph::Me::Drives::Item::Root::ListItem::DocumentSetVersions::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/drives/{drive%2Did}/root/listItem/documentSetVersions/$count{?%24search,%24filter}"
