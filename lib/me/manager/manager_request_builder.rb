...
module MicrosoftGraph::Me::Manager
    ## 
    ...
    class ManagerRequestBuilder
        ...
        def ref()
            return MicrosoftGraph::Me::Manager::Ref::RefRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/manager{?%24select,%24expand}"
