        ...
        module MemberOf
            ...
            class MemberOfRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def graph_directory_role()
                    return MicrosoftGraph::Me::MemberOf::GraphDirectoryRole::GraphDirectoryRoleRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                ...
                def initialize(path_parameters, request_adapter)
                    super(path_parameters, request_adapter, "{+baseurl}/me/memberOf{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}")
                end
                ## 
