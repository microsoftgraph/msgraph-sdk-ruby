...
module MicrosoftGraph::Me::MemberOf::MicrosoftGraphDevice
    ## 
    ...
    class MicrosoftGraphDeviceRequestBuilder
        ...
        def count()
            return MicrosoftGraph::Me::MemberOf::MicrosoftGraphDevice::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/memberOf/microsoft.graph.device{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
