...
module MicrosoftGraph::Me::Onenote::SectionGroups::Item::SectionGroups::Item
    ## 
    ...
    class SectionGroupItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, section_group_id1=nil)
            ...
            @url_template = "{+baseurl}/me/onenote/sectionGroups/{sectionGroup%2Did}/sectionGroups/{sectionGroup%2Did1}{?%24select,%24expand}"
