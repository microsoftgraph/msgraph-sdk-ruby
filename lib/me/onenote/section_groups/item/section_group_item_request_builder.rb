...
module MicrosoftGraph::Me::Onenote::SectionGroups::Item
    ## 
    ...
    class SectionGroupItemRequestBuilder
        ...
        def parent_notebook()
            return MicrosoftGraph::Me::Onenote::SectionGroups::Item::ParentNotebook::ParentNotebookRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def parent_section_group()
            return MicrosoftGraph::Me::Onenote::SectionGroups::Item::ParentSectionGroup::ParentSectionGroupRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def section_groups()
            return MicrosoftGraph::Me::Onenote::SectionGroups::Item::SectionGroups::SectionGroupsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the sections property of the microsoft.graph.sectionGroup entity.
        def sections()
            return MicrosoftGraph::Me::Onenote::SectionGroups::Item::Sections::SectionsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter, section_group_id=nil)
            ...
            @url_template = "{+baseurl}/me/onenote/sectionGroups/{sectionGroup%2Did}{?%24select,%24expand}"
        ...
        def section_groups_by_id(id)
            ...
            return MicrosoftGraph::Me::Onenote::SectionGroups::Item::SectionGroups::Item::SectionGroupItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the sections property of the microsoft.graph.sectionGroup entity.
        ## @param id Unique identifier of the item
        ...
        def sections_by_id(id)
            ...
            return MicrosoftGraph::Me::Onenote::SectionGroups::Item::Sections::Item::OnenoteSectionItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Delete navigation property sectionGroups for me
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
