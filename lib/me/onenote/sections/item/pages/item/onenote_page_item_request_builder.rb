...
module MicrosoftGraph::Me::Onenote::Sections::Item::Pages::Item
    ## 
    ...
    class OnenotePageItemRequestBuilder
        ...
        def content()
            return MicrosoftGraph::Me::Onenote::Sections::Item::Pages::Item::Content::ContentRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the copyToSection method.
        def microsoft_graph_copy_to_section()
            return MicrosoftGraph::Me::Onenote::Sections::Item::Pages::Item::MicrosoftGraphCopyToSection::CopyToSectionRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the onenotePatchContent method.
        def microsoft_graph_onenote_patch_content()
            return MicrosoftGraph::Me::Onenote::Sections::Item::Pages::Item::MicrosoftGraphOnenotePatchContent::OnenotePatchContentRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the preview method.
        def microsoft_graph_preview()
            return MicrosoftGraph::Me::Onenote::Sections::Item::Pages::Item::MicrosoftGraphPreview::PreviewRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the parentNotebook property of the microsoft.graph.onenotePage entity.
        def parent_notebook()
            return MicrosoftGraph::Me::Onenote::Sections::Item::Pages::Item::ParentNotebook::ParentNotebookRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the parentSection property of the microsoft.graph.onenotePage entity.
        def parent_section()
            return MicrosoftGraph::Me::Onenote::Sections::Item::Pages::Item::ParentSection::ParentSectionRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter, onenote_page_id=nil)
            ...
            @url_template = "{+baseurl}/me/onenote/sections/{onenoteSection%2Did}/pages/{onenotePage%2Did}{?%24select,%24expand}"
