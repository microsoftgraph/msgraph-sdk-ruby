                            ...
                            module Pages
                                module Item
                                    ...
                                    class OnenotePageItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                        ...
                                        def preview()
                                            return MicrosoftGraph::Me::Onenote::Notebooks::Item::Sections::Item::Pages::Item::Preview::PreviewRequestBuilder.new(@path_parameters, @request_adapter)
                                        end
                                        ## 
                                        ...
                                        def initialize(path_parameters, request_adapter)
                                            super(path_parameters, request_adapter, "{+baseurl}/me/onenote/notebooks/{notebook%2Did}/sections/{onenoteSection%2Did}/pages/{onenotePage%2Did}{?%24select,%24expand}")
                                        end
                                        ## 
