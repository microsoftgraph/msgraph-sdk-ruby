            ...
            module Resources
                module Item
                    ...
                    class OnenoteResourceItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def content()
                            return MicrosoftGraph::Me::Onenote::Resources::Item::Content::ContentRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/me/onenote/resources/{onenoteResource%2Did}{?%24select,%24expand}")
                        end
                        ## 
