...
module MicrosoftGraph::Me::Calendar
    ## 
    ...
    class CalendarRequestBuilder
        ...
        def calendar_permissions()
            return MicrosoftGraph::Me::Calendar::CalendarPermissions::CalendarPermissionsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the calendarView property of the microsoft.graph.calendar entity.
        def calendar_view()
            return MicrosoftGraph::Me::Calendar::CalendarView::CalendarViewRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the events property of the microsoft.graph.calendar entity.
        def events()
            return MicrosoftGraph::Me::Calendar::Events::EventsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the getSchedule method.
        def microsoft_graph_get_schedule()
            return MicrosoftGraph::Me::Calendar::MicrosoftGraphGetSchedule::MicrosoftGraphGetScheduleRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
