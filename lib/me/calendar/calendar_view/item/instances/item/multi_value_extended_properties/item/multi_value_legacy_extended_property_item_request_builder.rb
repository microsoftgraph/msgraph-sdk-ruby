...
module MicrosoftGraph::Me::Calendar::CalendarView::Item::Instances::Item::MultiValueExtendedProperties::Item
    ## 
    ...
    class MultiValueLegacyExtendedPropertyItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, multi_value_legacy_extended_property_id=)
            ...
            @url_template = "{+baseurl}/me/calendar/calendarView/{event%2Did}/instances/{event%2Did1}/multiValueExtendedProperties/{multiValueLegacyExtendedProperty%2Did}{?%24select,%24expand}"
