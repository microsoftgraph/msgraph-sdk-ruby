...
module MicrosoftGraph::Me::Calendar::CalendarView::Item::Instances::Item::MicrosoftGraphCancel
    ## 
    ...
    class CancelRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/calendar/calendarView/{event%2Did}/instances/{event%2Did1}/microsoft.graph.cancel"
