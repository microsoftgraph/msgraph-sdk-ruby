...
module MicrosoftGraph::Me::Calendar::CalendarView::Item::Extensions::Item
    ## 
    ...
    class ExtensionItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, extension_id=)
            ...
            @url_template = "{+baseurl}/me/calendar/calendarView/{event%2Did}/extensions/{extension%2Did}{?%24select,%24expand}"
