...
module MicrosoftGraph::Me::Calendar::CalendarView::Item
    ...
    class EventItemRequestBuilder
        ...
        def accept()
            return MicrosoftGraph::Me::Calendar::CalendarView::Item::Accept::AcceptRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def cancel()
            return MicrosoftGraph::Me::Calendar::CalendarView::Item::Cancel::CancelRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the decline method.
        def decline()
            return MicrosoftGraph::Me::Calendar::CalendarView::Item::Decline::DeclineRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the dismissReminder method.
        def dismiss_reminder()
            return MicrosoftGraph::Me::Calendar::CalendarView::Item::DismissReminder::DismissReminderRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def forward()
            return MicrosoftGraph::Me::Calendar::CalendarView::Item::Forward::ForwardRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
