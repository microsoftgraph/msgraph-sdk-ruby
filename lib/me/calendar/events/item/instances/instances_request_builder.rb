...
module MicrosoftGraph::Me::Calendar::Events::Item::Instances
    ## 
    ...
    class InstancesRequestBuilder
        ...
        def count()
            return MicrosoftGraph::Me::Calendar::Events::Item::Instances::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the delta method.
        def microsoft_graph_delta()
            return MicrosoftGraph::Me::Calendar::Events::Item::Instances::MicrosoftGraphDelta::MicrosoftGraphDeltaRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/calendar/events/{event%2Did}/instances{?%24top,%24skip,%24filter,%24count,%24orderby,%24select}"
