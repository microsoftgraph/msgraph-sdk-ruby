...
module MicrosoftGraph::Me::Calendar::Events::Item::Instances::Item::Calendar
    ## 
    ...
    class CalendarRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/calendar/events/{event%2Did}/instances/{event%2Did1}/calendar{?%24select}"
