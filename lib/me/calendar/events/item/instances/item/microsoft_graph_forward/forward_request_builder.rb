...
module MicrosoftGraph::Me::Calendar::Events::Item::Instances::Item::MicrosoftGraphForward
    ## 
    ...
    class ForwardRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/calendar/events/{event%2Did}/instances/{event%2Did1}/microsoft.graph.forward"
