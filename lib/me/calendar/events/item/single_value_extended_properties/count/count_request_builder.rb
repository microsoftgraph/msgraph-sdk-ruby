...
module MicrosoftGraph::Me::Calendar::Events::Item::SingleValueExtendedProperties::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/calendar/events/{event%2Did}/singleValueExtendedProperties/$count{?%24search,%24filter}"
