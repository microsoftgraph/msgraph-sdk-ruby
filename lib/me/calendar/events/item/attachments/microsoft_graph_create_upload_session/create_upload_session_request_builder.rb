...
module MicrosoftGraph::Me::Calendar::Events::Item::Attachments::MicrosoftGraphCreateUploadSession
    ## 
    ...
    class CreateUploadSessionRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/calendar/events/{event%2Did}/attachments/microsoft.graph.createUploadSession"
