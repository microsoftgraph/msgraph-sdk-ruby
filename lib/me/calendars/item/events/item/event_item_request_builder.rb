...
module MicrosoftGraph::Me::Calendars::Item::Events::Item
    ## 
    ...
    class EventItemRequestBuilder
        ...
        def attachments()
            return MicrosoftGraph::Me::Calendars::Item::Events::Item::Attachments::AttachmentsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the calendar property of the microsoft.graph.event entity.
        def calendar()
            return MicrosoftGraph::Me::Calendars::Item::Events::Item::Calendar::CalendarRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the extensions property of the microsoft.graph.event entity.
        def extensions()
            return MicrosoftGraph::Me::Calendars::Item::Events::Item::Extensions::ExtensionsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the instances property of the microsoft.graph.event entity.
        def instances()
            return MicrosoftGraph::Me::Calendars::Item::Events::Item::Instances::InstancesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the accept method.
        def microsoft_graph_accept()
            return MicrosoftGraph::Me::Calendars::Item::Events::Item::MicrosoftGraphAccept::MicrosoftGraphAcceptRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the cancel method.
        def microsoft_graph_cancel()
            return MicrosoftGraph::Me::Calendars::Item::Events::Item::MicrosoftGraphCancel::MicrosoftGraphCancelRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the decline method.
        def microsoft_graph_decline()
            return MicrosoftGraph::Me::Calendars::Item::Events::Item::MicrosoftGraphDecline::MicrosoftGraphDeclineRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the dismissReminder method.
        def microsoft_graph_dismiss_reminder()
            return MicrosoftGraph::Me::Calendars::Item::Events::Item::MicrosoftGraphDismissReminder::MicrosoftGraphDismissReminderRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the forward method.
        def microsoft_graph_forward()
            return MicrosoftGraph::Me::Calendars::Item::Events::Item::MicrosoftGraphForward::MicrosoftGraphForwardRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the snoozeReminder method.
        def microsoft_graph_snooze_reminder()
            return MicrosoftGraph::Me::Calendars::Item::Events::Item::MicrosoftGraphSnoozeReminder::MicrosoftGraphSnoozeReminderRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the tentativelyAccept method.
        def microsoft_graph_tentatively_accept()
            return MicrosoftGraph::Me::Calendars::Item::Events::Item::MicrosoftGraphTentativelyAccept::MicrosoftGraphTentativelyAcceptRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def attachments_by_id(id)
            ...
            return MicrosoftGraph::Me::Calendars::Item::Events::Item::Attachments::Item::AttachmentItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def extensions_by_id(id)
            ...
            return MicrosoftGraph::Me::Calendars::Item::Events::Item::Extensions::Item::ExtensionItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def instances_by_id(id)
            ...
            return MicrosoftGraph::Me::Calendars::Item::Events::Item::Instances::Item::EventItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the multiValueExtendedProperties property of the microsoft.graph.event entity.
        ## @param id Unique identifier of the item
        ...
        def multi_value_extended_properties_by_id(id)
            ...
            return MicrosoftGraph::Me::Calendars::Item::Events::Item::MultiValueExtendedProperties::Item::MultiValueLegacyExtendedPropertyItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def single_value_extended_properties_by_id(id)
            ...
            return MicrosoftGraph::Me::Calendars::Item::Events::Item::SingleValueExtendedProperties::Item::SingleValueLegacyExtendedPropertyItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Delete navigation property events for me
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
