...
module MicrosoftGraph::Me::Calendars::Item::Events::Item::Instances::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/calendars/{calendar%2Did}/events/{event%2Did}/instances/$count{?%24filter}"
