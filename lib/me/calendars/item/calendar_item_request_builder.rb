...
module MicrosoftGraph::Me::Calendars::Item
    ## 
    ...
    class CalendarItemRequestBuilder
        ...
        def microsoft_graph_get_schedule()
            return MicrosoftGraph::Me::Calendars::Item::MicrosoftGraphGetSchedule::MicrosoftGraphGetScheduleRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the multiValueExtendedProperties property of the microsoft.graph.calendar entity.
        def multi_value_extended_properties()
            return MicrosoftGraph::Me::Calendars::Item::MultiValueExtendedProperties::MultiValueExtendedPropertiesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def single_value_extended_properties()
            return MicrosoftGraph::Me::Calendars::Item::SingleValueExtendedProperties::SingleValueExtendedPropertiesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def calendar_permissions_by_id(id)
            ...
            return MicrosoftGraph::Me::Calendars::Item::CalendarPermissions::Item::CalendarPermissionItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the calendarView property of the microsoft.graph.calendar entity.
        ## @param id Unique identifier of the item
        ...
        def single_value_extended_properties_by_id(id)
            ...
            return MicrosoftGraph::Me::Calendars::Item::SingleValueExtendedProperties::Item::SingleValueLegacyExtendedPropertyItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Delete navigation property calendars for me
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
