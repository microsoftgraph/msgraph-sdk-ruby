...
module MicrosoftGraph::Me::Calendars::Item::CalendarView::Item::MicrosoftGraphForward
    ## 
    ...
    class MicrosoftGraphForwardRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/calendars/{calendar%2Did}/calendarView/{event%2Did}/microsoft.graph.forward"
