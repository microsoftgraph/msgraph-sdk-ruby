...
module MicrosoftGraph::Me::Calendars::Item::CalendarView
    ## 
    ...
    class CalendarViewRequestBuilder
        ...
        def count()
            return MicrosoftGraph::Me::Calendars::Item::CalendarView::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the delta method.
        def microsoft_graph_delta()
            return MicrosoftGraph::Me::Calendars::Item::CalendarView::MicrosoftGraphDelta::MicrosoftGraphDeltaRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/calendars/{calendar%2Did}/calendarView{?startDateTime*,endDateTime*,%24top,%24skip,%24filter,%24count,%24orderby,%24select}"
