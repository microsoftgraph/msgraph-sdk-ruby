...
module MicrosoftGraph::Me::Calendars::Item::SingleValueExtendedProperties::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/calendars/{calendar%2Did}/singleValueExtendedProperties/$count{?%24search,%24filter}"
