...
module MicrosoftGraph::Me::Contacts::Item::MultiValueExtendedProperties::Item
    ## 
    ...
    class MultiValueLegacyExtendedPropertyItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, multi_value_legacy_extended_property_id=)
            ...
            @url_template = "{+baseurl}/me/contacts/{contact%2Did}/multiValueExtendedProperties/{multiValueLegacyExtendedProperty%2Did}{?%24select,%24expand}"
