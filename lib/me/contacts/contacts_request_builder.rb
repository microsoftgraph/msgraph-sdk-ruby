...
module MicrosoftGraph::Me::Contacts
    ## 
    ...
    class ContactsRequestBuilder
        ...
        def microsoft_graph_delta()
            return MicrosoftGraph::Me::Contacts::MicrosoftGraphDelta::MicrosoftGraphDeltaRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/contacts{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select}"
