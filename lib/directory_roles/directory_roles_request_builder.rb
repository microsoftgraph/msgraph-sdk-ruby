    ...
    module DirectoryRoles
        ...
        class DirectoryRolesRequestBuilder
            ...
            def microsoft_graph_delta()
                return MicrosoftGraph::DirectoryRoles::MicrosoftGraphDelta::MicrosoftGraphDeltaRequestBuilder.new(@path_parameters, @request_adapter)
            end
            ## 
            # Provides operations to call the getAvailableExtensionProperties method.
            def microsoft_graph_get_available_extension_properties()
                return MicrosoftGraph::DirectoryRoles::MicrosoftGraphGetAvailableExtensionProperties::MicrosoftGraphGetAvailableExtensionPropertiesRequestBuilder.new(@path_parameters, @request_adapter)
            end
            ## 
            # Provides operations to call the getByIds method.
            def microsoft_graph_get_by_ids()
                return MicrosoftGraph::DirectoryRoles::MicrosoftGraphGetByIds::MicrosoftGraphGetByIdsRequestBuilder.new(@path_parameters, @request_adapter)
            end
            ## 
            # Provides operations to call the validateProperties method.
            def microsoft_graph_validate_properties()
                return MicrosoftGraph::DirectoryRoles::MicrosoftGraphValidateProperties::MicrosoftGraphValidatePropertiesRequestBuilder.new(@path_parameters, @request_adapter)
            end
            ## 
