...
module MicrosoftGraph
    module DirectoryRoles
        ...
        class DirectoryRolesRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
            ...
            def initialize(path_parameters, request_adapter)
                super(path_parameters, request_adapter, "{+baseurl}/directoryRoles{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip}")
            end
            ## 
            ...
            def to_post_request_information(body, request_configuration=nil)
                ...
                request_info.url_template = '{+baseurl}/directoryRoles'
                request_info.path_parameters = @path_parameters
            ...
            ## @return a directory_roles_request_builder
            ## 
            def with_url(raw_url)
                raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                return DirectoryRolesRequestBuilder.new(raw_url, @request_adapter)
            end
