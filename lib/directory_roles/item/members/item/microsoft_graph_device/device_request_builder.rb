...
module MicrosoftGraph::DirectoryRoles::Item::Members::Item::MicrosoftGraphDevice
    ## 
    ...
    class DeviceRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/directoryRoles/{directoryRole%2Did}/members/{directoryObject%2Did}/microsoft.graph.device{?%24select,%24expand}"
