    ...
    module AuditLogs
        module Provisioning
            module Item
                ...
                class ProvisioningObjectSummaryItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def initialize(path_parameters, request_adapter)
                        super(path_parameters, request_adapter, "{+baseurl}/auditLogs/provisioning/{provisioningObjectSummary%2Did}{?%24expand,%24select}")
                    end
                    ## 
                    ...
                    def to_delete_request_information(request_configuration=nil)
                        ...
                        request_info.url_template = '{+baseurl}/auditLogs/provisioning/{provisioningObjectSummary%2Did}'
                    ...
                    def with_url(raw_url)
                        ...
                        return ProvisioningObjectSummaryItemRequestBuilder.new(raw_url, @request_adapter)
                    end
