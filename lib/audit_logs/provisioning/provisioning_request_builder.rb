...
module MicrosoftGraph
    module AuditLogs
        module Provisioning
            ...
            class ProvisioningRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def initialize(path_parameters, request_adapter)
                    super(path_parameters, request_adapter, "{+baseurl}/auditLogs/provisioning{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}")
                end
                ## 
                ...
                ## @return a Fiber of provisioning_object_summary_collection_response
                ## 
                ...
                ## @param request_configuration Configuration for the request such as headers, query parameters, and middleware options.
                ## @return a Fiber of provisioning_object_summary
                ## 
                ...
                def to_post_request_information(body, request_configuration=nil)
                    ...
                    request_info.url_template = '{+baseurl}/auditLogs/provisioning'
                    request_info.path_parameters = @path_parameters
                ...
                ## @return a provisioning_request_builder
                ## 
                def with_url(raw_url)
                    raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                    return ProvisioningRequestBuilder.new(raw_url, @request_adapter)
                end
