...
module MicrosoftGraph::PermissionGrants::Item::MicrosoftGraphRestore
    ## 
    ...
    class MicrosoftGraphRestoreRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/permissionGrants/{resourceSpecificPermissionGrant%2Did}/microsoft.graph.restore"
