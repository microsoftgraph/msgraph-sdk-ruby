...
require_relative './applications_with_unique_name'

module MicrosoftGraph
    module ApplicationsWithUniqueName
        ## 
        # Provides operations to manage the collection of application entities.
        class ApplicationsWithUniqueNameRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
            ...
            def initialize(path_parameters, request_adapter, unique_name=nil)
                super(path_parameters, request_adapter, "{+baseurl}/applications(uniqueName='{uniqueName}'){?%24expand,%24select}")
            end
            ## 
            ...
            def to_delete_request_information(request_configuration=nil)
                ...
                request_info.url_template = '{+baseurl}/applications(uniqueName='{uniqueName}')'
            ...
            def with_url(raw_url)
                ...
                return ApplicationsWithUniqueNameRequestBuilder.new(raw_url, @request_adapter)
            end
