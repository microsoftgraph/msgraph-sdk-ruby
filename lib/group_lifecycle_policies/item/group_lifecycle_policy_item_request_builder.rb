...
module MicrosoftGraph::GroupLifecyclePolicies::Item
    ...
    class GroupLifecyclePolicyItemRequestBuilder
        ...
        def microsoft_graph_add_group()
            return MicrosoftGraph::GroupLifecyclePolicies::Item::MicrosoftGraphAddGroup::MicrosoftGraphAddGroupRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the removeGroup method.
        def microsoft_graph_remove_group()
            return MicrosoftGraph::GroupLifecyclePolicies::Item::MicrosoftGraphRemoveGroup::MicrosoftGraphRemoveGroupRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
