...
module MicrosoftGraph::IdentityProtection::RiskyUsers::Item::History::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/identityProtection/riskyUsers/{riskyUser%2Did}/history/$count{?%24search,%24filter}"
