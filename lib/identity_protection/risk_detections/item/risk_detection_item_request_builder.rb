    ...
    module IdentityProtection
        module RiskDetections
            module Item
                ...
                class RiskDetectionItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def initialize(path_parameters, request_adapter)
                        super(path_parameters, request_adapter, "{+baseurl}/identityProtection/riskDetections/{riskDetection%2Did}{?%24expand,%24select}")
                    end
                    ## 
                    ...
                    def to_delete_request_information(request_configuration=nil)
                        ...
                        request_info.url_template = '{+baseurl}/identityProtection/riskDetections/{riskDetection%2Did}'
                    ...
                    def with_url(raw_url)
                        ...
                        return RiskDetectionItemRequestBuilder.new(raw_url, @request_adapter)
                    end
