...
module MicrosoftGraph::IdentityProtection::ServicePrincipalRiskDetections::Item
    ## 
    ...
    class ServicePrincipalRiskDetectionItemRequestBuilder
        ...
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, service_principal_risk_detection_id=)
