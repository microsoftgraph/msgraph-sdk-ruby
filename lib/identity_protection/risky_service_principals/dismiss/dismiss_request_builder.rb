            ...
            module Dismiss
                ...
                class DismissRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def initialize(path_parameters, request_adapter)
                        super(path_parameters, request_adapter, "{+baseurl}/identityProtection/riskyServicePrincipals/dismiss")
                    end
                    ## 
                    ...
                    ## @return a dismiss_request_builder
                    ## 
                    def with_url(raw_url)
                        raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                        return DismissRequestBuilder.new(raw_url, @request_adapter)
                    end
                end
            end
        end
