...
module MicrosoftGraph::IdentityProtection::RiskyServicePrincipals::Item::History::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/identityProtection/riskyServicePrincipals/{riskyServicePrincipal%2Did}/history/$count{?%24search,%24filter}"
