...
require_relative './history/item/risky_service_principal_history_item_item_request_builder'
require_relative './item'

module MicrosoftGraph::IdentityProtection::RiskyServicePrincipals::Item
    ## 
    ...
    class RiskyServicePrincipalItemRequestBuilder
        ...
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, risky_service_principal_id=nil)
            raise StandardError, 'path_parameters cannot be null' if path_parameters.nil?
            raise StandardError, 'request_adapter cannot be null' if request_adapter.nil?
            @url_template = "{+baseurl}/identityProtection/riskyServicePrincipals/{riskyServicePrincipal%2Did}{?%24select,%24expand}"
