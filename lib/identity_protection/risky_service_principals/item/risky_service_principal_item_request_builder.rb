    ...
    module IdentityProtection
        module RiskyServicePrincipals
            module Item
                ...
                class RiskyServicePrincipalItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    
                    ## 
                    # Provides operations to manage the history property of the microsoft.graph.riskyServicePrincipal entity.
                    def history()
                        return MicrosoftGraph::IdentityProtection::RiskyServicePrincipals::Item::History::HistoryRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ...
                    def initialize(path_parameters, request_adapter)
                        super(path_parameters, request_adapter, "{+baseurl}/identityProtection/riskyServicePrincipals/{riskyServicePrincipal%2Did}{?%24expand,%24select}")
                    end
                    ## 
                    ...
                    def to_delete_request_information(request_configuration=nil)
                        ...
                        request_info.url_template = '{+baseurl}/identityProtection/riskyServicePrincipals/{riskyServicePrincipal%2Did}'
                    ...
                    def with_url(raw_url)
                        ...
                        return RiskyServicePrincipalItemRequestBuilder.new(raw_url, @request_adapter)
                    end
