...
require_relative './microsoft_graph_dismiss'

module MicrosoftGraph::IdentityProtection::RiskyServicePrincipals::MicrosoftGraphDismiss
    ## 
    ...
    class DismissRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/identityProtection/riskyServicePrincipals/microsoft.graph.dismiss"
