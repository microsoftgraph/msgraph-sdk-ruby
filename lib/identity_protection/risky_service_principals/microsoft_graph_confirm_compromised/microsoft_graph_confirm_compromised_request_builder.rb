...
require_relative './microsoft_graph_confirm_compromised'

module MicrosoftGraph::IdentityProtection::RiskyServicePrincipals::MicrosoftGraphConfirmCompromised
    ## 
    ...
    class MicrosoftGraphConfirmCompromisedRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/identityProtection/riskyServicePrincipals/microsoft.graph.confirmCompromised"
