            ...
            module ConfirmCompromised
                ...
                class ConfirmCompromisedRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def initialize(path_parameters, request_adapter)
                        super(path_parameters, request_adapter, "{+baseurl}/identityProtection/riskyServicePrincipals/confirmCompromised")
                    end
                    ## 
                    ...
                    ## @return a confirm_compromised_request_builder
                    ## 
                    def with_url(raw_url)
                        raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                        return ConfirmCompromisedRequestBuilder.new(raw_url, @request_adapter)
                    end
                end
            end
        end
