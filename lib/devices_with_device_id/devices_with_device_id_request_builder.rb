    ...
    module DevicesWithDeviceId
        ...
        class DevicesWithDeviceIdRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
            ...
            def initialize(path_parameters, request_adapter, device_id=nil)
                super(path_parameters, request_adapter, "{+baseurl}/devices(deviceId='{deviceId}'){?%24expand,%24select}")
            end
            ## 
            ...
            def to_delete_request_information(request_configuration=nil)
                ...
                request_info.url_template = '{+baseurl}/devices(deviceId='{deviceId}')'
            ...
            def with_url(raw_url)
                ...
                return DevicesWithDeviceIdRequestBuilder.new(raw_url, @request_adapter)
            end
