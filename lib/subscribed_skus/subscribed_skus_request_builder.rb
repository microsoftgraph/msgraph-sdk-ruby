    ...
    module SubscribedSkus
        ...
        class SubscribedSkusRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
            ...
            def initialize(path_parameters, request_adapter)
                super(path_parameters, request_adapter, "{+baseurl}/subscribedSkus{?%24orderby,%24search,%24select}")
            end
            ## 
            ...
            def to_post_request_information(body, request_configuration=nil)
                ...
                request_info.url_template = '{+baseurl}/subscribedSkus'
                request_info.path_parameters = @path_parameters
            ...
            ## @return a subscribed_skus_request_builder
            ## 
            def with_url(raw_url)
                raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                return SubscribedSkusRequestBuilder.new(raw_url, @request_adapter)
            end
