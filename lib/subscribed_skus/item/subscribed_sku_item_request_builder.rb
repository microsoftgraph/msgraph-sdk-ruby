...
module MicrosoftGraph
    module SubscribedSkus
        module Item
            ...
            class SubscribedSkuItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def initialize(path_parameters, request_adapter)
                    super(path_parameters, request_adapter, "{+baseurl}/subscribedSkus/{subscribedSku%2Did}{?%24select}")
                end
                ## 
                ...
                def to_delete_request_information(request_configuration=nil)
                    ...
                    request_info.url_template = '{+baseurl}/subscribedSkus/{subscribedSku%2Did}'
                ...
                def with_url(raw_url)
                    ...
                    return SubscribedSkuItemRequestBuilder.new(raw_url, @request_adapter)
                end
