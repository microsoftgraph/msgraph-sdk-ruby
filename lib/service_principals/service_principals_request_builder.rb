...
module MicrosoftGraph::ServicePrincipals
    ...
    class ServicePrincipalsRequestBuilder
        ...
        def microsoft_graph_delta()
            return MicrosoftGraph::ServicePrincipals::MicrosoftGraphDelta::DeltaRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the getAvailableExtensionProperties method.
        def microsoft_graph_get_available_extension_properties()
            return MicrosoftGraph::ServicePrincipals::MicrosoftGraphGetAvailableExtensionProperties::GetAvailableExtensionPropertiesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the getByIds method.
        def microsoft_graph_get_by_ids()
            return MicrosoftGraph::ServicePrincipals::MicrosoftGraphGetByIds::GetByIdsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the validateProperties method.
        def microsoft_graph_validate_properties()
            return MicrosoftGraph::ServicePrincipals::MicrosoftGraphValidateProperties::ValidatePropertiesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
