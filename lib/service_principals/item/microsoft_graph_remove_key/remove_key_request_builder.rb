...
require_relative './microsoft_graph_remove_key'

module MicrosoftGraph::ServicePrincipals::Item::MicrosoftGraphRemoveKey
    ## 
    ...
    class RemoveKeyRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/microsoft.graph.removeKey"
