                    ...
                    module Item
                        module Schema
                            ...
                            class SchemaRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                ...
                                def directories()
                                    return MicrosoftGraph::ServicePrincipals::Item::Synchronization::Templates::Item::Schema::Directories::DirectoriesRequestBuilder.new(@path_parameters, @request_adapter)
                                end
                                ## 
                                # Provides operations to call the filterOperators method.
                                def filter_operators()
                                    return MicrosoftGraph::ServicePrincipals::Item::Synchronization::Templates::Item::Schema::FilterOperators::FilterOperatorsRequestBuilder.new(@path_parameters, @request_adapter)
                                end
                                ## 
                                # Provides operations to call the functions method.
                                def functions()
                                    return MicrosoftGraph::ServicePrincipals::Item::Synchronization::Templates::Item::Schema::Functions::FunctionsRequestBuilder.new(@path_parameters, @request_adapter)
                                end
                                ## 
                                # Provides operations to call the parseExpression method.
                                def parse_expression()
                                    return MicrosoftGraph::ServicePrincipals::Item::Synchronization::Templates::Item::Schema::ParseExpression::ParseExpressionRequestBuilder.new(@path_parameters, @request_adapter)
                                end
                                ## 
                                ...
                                def initialize(path_parameters, request_adapter)
                                    super(path_parameters, request_adapter, "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/synchronization/templates/{synchronizationTemplate%2Did}/schema{?%24expand,%24select}")
                                end
                                ## 
                                ...
                                def to_delete_request_information(request_configuration=nil)
                                    ...
                                    request_info.url_template = '{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/synchronization/templates/{synchronizationTemplate%2Did}/schema'
