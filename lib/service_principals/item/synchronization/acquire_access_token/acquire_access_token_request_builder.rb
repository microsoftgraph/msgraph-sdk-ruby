        ...
        module Item
            module Synchronization
                module AcquireAccessToken
                    ...
                    class AcquireAccessTokenRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/synchronization/acquireAccessToken")
                        end
                        ## 
                        ...
                        ## @return a acquire_access_token_request_builder
                        ## 
                        def with_url(raw_url)
                            raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                            return AcquireAccessTokenRequestBuilder.new(raw_url, @request_adapter)
                        end
                    end
                end
            end
