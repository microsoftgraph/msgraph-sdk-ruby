...
require_relative './microsoft_graph_add_token_signing_certificate'

module MicrosoftGraph::ServicePrincipals::Item::MicrosoftGraphAddTokenSigningCertificate
    ## 
    ...
    class AddTokenSigningCertificateRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/microsoft.graph.addTokenSigningCertificate"
