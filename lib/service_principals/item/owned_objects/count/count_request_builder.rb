...
module MicrosoftGraph::ServicePrincipals::Item::OwnedObjects::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/ownedObjects/$count{?%24search,%24filter}"
