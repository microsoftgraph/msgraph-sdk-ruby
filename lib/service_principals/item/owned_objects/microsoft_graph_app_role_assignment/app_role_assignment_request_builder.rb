...
require_relative './microsoft_graph_app_role_assignment'

module MicrosoftGraph::ServicePrincipals::Item::OwnedObjects::MicrosoftGraphAppRoleAssignment
    ## 
    ...
    class AppRoleAssignmentRequestBuilder
        ...
        def count()
            return MicrosoftGraph::ServicePrincipals::Item::OwnedObjects::MicrosoftGraphAppRoleAssignment::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
