...
module MicrosoftGraph::ServicePrincipals::Item::OwnedObjects::MicrosoftGraphGroup
    ## 
    ...
    class GroupRequestBuilder
        ...
        def count()
            return MicrosoftGraph::ServicePrincipals::Item::OwnedObjects::MicrosoftGraphGroup::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/ownedObjects/microsoft.graph.group{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
