...
require_relative './graph_app_role_assignment'

module MicrosoftGraph
    module ServicePrincipals
        module Item
            module OwnedObjects
                module GraphAppRoleAssignment
                    ## 
                    # Casts the previous resource to appRoleAssignment.
                    class GraphAppRoleAssignmentRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        
                        ## 
                        # Provides operations to count the resources in the collection.
                        def count()
                            return MicrosoftGraph::ServicePrincipals::Item::OwnedObjects::GraphAppRoleAssignment::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/ownedObjects/graph.appRoleAssignment{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}")
                        end
                        ## 
                        ...
                        ## @return a graph_app_role_assignment_request_builder
                        ## 
                        def with_url(raw_url)
                            raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                            return GraphAppRoleAssignmentRequestBuilder.new(raw_url, @request_adapter)
                        end
