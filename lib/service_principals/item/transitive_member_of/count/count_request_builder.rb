...
module MicrosoftGraph::ServicePrincipals::Item::TransitiveMemberOf::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/transitiveMemberOf/$count{?%24search,%24filter}"
