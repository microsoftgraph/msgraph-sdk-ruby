...
require_relative '../../../models/home_realm_discovery_policy_collection_response'
    ...
    module ServicePrincipals
        module Item
            module HomeRealmDiscoveryPolicies
                ...
                class HomeRealmDiscoveryPoliciesRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    
                    ## 
                    # Provides operations to count the resources in the collection.
                    def count()
                        return MicrosoftGraph::ServicePrincipals::Item::HomeRealmDiscoveryPolicies::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ...
                    def initialize(path_parameters, request_adapter)
                        super(path_parameters, request_adapter, "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/homeRealmDiscoveryPolicies{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}")
                    end
                    ## 
                    ...
                    ## @return a home_realm_discovery_policies_request_builder
                    ## 
                    def with_url(raw_url)
                        raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                        return HomeRealmDiscoveryPoliciesRequestBuilder.new(raw_url, @request_adapter)
                    end
