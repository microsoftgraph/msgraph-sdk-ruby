...
require_relative './federated_identity_credentials_with_name'

module MicrosoftGraph
    module ServicePrincipals
        module Item
            module FederatedIdentityCredentialsWithName
                ## 
                # Provides operations to manage the federatedIdentityCredentials property of the microsoft.graph.servicePrincipal entity.
                class FederatedIdentityCredentialsWithNameRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def initialize(path_parameters, request_adapter, name=nil)
                        super(path_parameters, request_adapter, "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/federatedIdentityCredentials(name='{name}'){?%24expand,%24select}")
                    end
                    ## 
                    ...
                    def with_url(raw_url)
                        ...
                        return FederatedIdentityCredentialsWithNameRequestBuilder.new(raw_url, @request_adapter)
                    end
