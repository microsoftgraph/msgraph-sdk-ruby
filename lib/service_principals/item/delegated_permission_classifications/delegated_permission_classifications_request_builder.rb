...
require_relative '../../../models/delegated_permission_classification'
require_relative '../../../models/delegated_permission_classification_collection_response'
...
module MicrosoftGraph
    module ServicePrincipals
        module Item
            module DelegatedPermissionClassifications
                ## 
                # Provides operations to manage the delegatedPermissionClassifications property of the microsoft.graph.servicePrincipal entity.
                class DelegatedPermissionClassificationsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def initialize(path_parameters, request_adapter)
                        super(path_parameters, request_adapter, "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/delegatedPermissionClassifications{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}")
                    end
                    ## 
                    ...
                    def to_post_request_information(body, request_configuration=nil)
                        ...
                        request_info.url_template = '{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/delegatedPermissionClassifications'
                        request_info.path_parameters = @path_parameters
                    ...
                    ## @return a delegated_permission_classifications_request_builder
                    ## 
                    def with_url(raw_url)
                        raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                        return DelegatedPermissionClassificationsRequestBuilder.new(raw_url, @request_adapter)
                    end
