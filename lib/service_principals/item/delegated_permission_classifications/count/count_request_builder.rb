...
module MicrosoftGraph::ServicePrincipals::Item::DelegatedPermissionClassifications::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/delegatedPermissionClassifications/$count{?%24search,%24filter}"
