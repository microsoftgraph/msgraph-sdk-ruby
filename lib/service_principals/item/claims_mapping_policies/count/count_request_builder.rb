...
module MicrosoftGraph::ServicePrincipals::Item::ClaimsMappingPolicies::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/claimsMappingPolicies/$count{?%24search,%24filter}"
