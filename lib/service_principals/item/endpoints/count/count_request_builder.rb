...
module MicrosoftGraph::ServicePrincipals::Item::Endpoints::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/endpoints/$count{?%24search,%24filter}"
