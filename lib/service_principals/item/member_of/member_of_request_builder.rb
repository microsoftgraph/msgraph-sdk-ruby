    ...
    module ServicePrincipals
        module Item
            module MemberOf
                ...
                class MemberOfRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def graph_administrative_unit()
                        return MicrosoftGraph::ServicePrincipals::Item::MemberOf::GraphAdministrativeUnit::GraphAdministrativeUnitRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Casts the previous resource to directoryRole.
                    def graph_directory_role()
                        return MicrosoftGraph::ServicePrincipals::Item::MemberOf::GraphDirectoryRole::GraphDirectoryRoleRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Casts the previous resource to group.
                    def graph_group()
                        return MicrosoftGraph::ServicePrincipals::Item::MemberOf::GraphGroup::GraphGroupRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ## Provides operations to manage the memberOf property of the microsoft.graph.servicePrincipal entity.
                    ...
                    def initialize(path_parameters, request_adapter)
                        super(path_parameters, request_adapter, "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/memberOf{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}")
                    end
                    ## 
                    ...
                    ## @return a member_of_request_builder
                    ## 
                    def with_url(raw_url)
                        raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                        return MemberOfRequestBuilder.new(raw_url, @request_adapter)
                    end
