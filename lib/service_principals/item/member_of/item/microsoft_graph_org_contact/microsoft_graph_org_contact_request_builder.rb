...
module MicrosoftGraph::ServicePrincipals::Item::MemberOf::Item::MicrosoftGraphOrgContact
    ## 
    ...
    class MicrosoftGraphOrgContactRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/memberOf/{directoryObject%2Did}/microsoft.graph.orgContact{?%24select,%24expand}"
