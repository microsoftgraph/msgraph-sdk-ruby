...
module MicrosoftGraph::ServicePrincipals::Item::MemberOf::Item::MicrosoftGraphDevice
    ## 
    ...
    class DeviceRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/memberOf/{directoryObject%2Did}/microsoft.graph.device{?%24select,%24expand}"
