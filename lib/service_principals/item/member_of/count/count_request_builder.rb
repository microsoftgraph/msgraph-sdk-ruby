...
module MicrosoftGraph::ServicePrincipals::Item::MemberOf::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/memberOf/$count{?%24search,%24filter}"
