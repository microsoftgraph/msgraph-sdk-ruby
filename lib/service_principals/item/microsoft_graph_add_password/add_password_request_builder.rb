...
require_relative './microsoft_graph_add_password'

module MicrosoftGraph::ServicePrincipals::Item::MicrosoftGraphAddPassword
    ## 
    ...
    class AddPasswordRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/microsoft.graph.addPassword"
