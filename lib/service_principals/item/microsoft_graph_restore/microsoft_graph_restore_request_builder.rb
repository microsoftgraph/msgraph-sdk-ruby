...
module MicrosoftGraph::ServicePrincipals::Item::MicrosoftGraphRestore
    ## 
    ...
    class MicrosoftGraphRestoreRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/microsoft.graph.restore"
