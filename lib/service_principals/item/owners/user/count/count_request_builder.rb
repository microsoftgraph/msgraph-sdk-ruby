...
module MicrosoftGraph::ServicePrincipals::Item::Owners::User::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/owners/microsoft.graph.user/$count{?%24search,%24filter}"
