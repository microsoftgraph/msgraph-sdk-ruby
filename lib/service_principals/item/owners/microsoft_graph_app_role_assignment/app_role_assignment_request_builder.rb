...
module MicrosoftGraph::ServicePrincipals::Item::Owners::MicrosoftGraphAppRoleAssignment
    ## 
    ...
    class AppRoleAssignmentRequestBuilder
        ...
        def count()
            return MicrosoftGraph::ServicePrincipals::Item::Owners::MicrosoftGraphAppRoleAssignment::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
