                    ...
                    module GraphServicePrincipal
                        ...
                        class GraphServicePrincipalRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            def initialize(path_parameters, request_adapter)
                                super(path_parameters, request_adapter, "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/owners/{directoryObject%2Did}/graph.servicePrincipal{?%24expand,%24select}")
                            end
                            ## 
