...
module MicrosoftGraph::ServicePrincipals::Item::CreatedObjects
    ...
    class CreatedObjectsRequestBuilder
        ...
        def microsoft_graph_service_principal()
            return MicrosoftGraph::ServicePrincipals::Item::CreatedObjects::MicrosoftGraphServicePrincipal::ServicePrincipalRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
