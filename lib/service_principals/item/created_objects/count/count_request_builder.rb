...
module MicrosoftGraph::ServicePrincipals::Item::CreatedObjects::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/createdObjects/$count{?%24search,%24filter}"
