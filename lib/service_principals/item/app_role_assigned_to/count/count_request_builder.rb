...
module MicrosoftGraph::ServicePrincipals::Item::AppRoleAssignedTo::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/appRoleAssignedTo/$count{?%24search,%24filter}"
