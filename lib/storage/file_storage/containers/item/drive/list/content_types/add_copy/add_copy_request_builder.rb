                        ...
                        module List
                            module ContentTypes
                                module AddCopy
                                    ...
                                    class AddCopyRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                        ...
                                        def initialize(path_parameters, request_adapter)
                                            super(path_parameters, request_adapter, "{+baseurl}/storage/fileStorage/containers/{fileStorageContainer%2Did}/drive/list/contentTypes/addCopy")
                                        end
                                        ## 
                                        ...
                                        ## @return a add_copy_request_builder
                                        ## 
                                        def with_url(raw_url)
                                            raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                                            return AddCopyRequestBuilder.new(raw_url, @request_adapter)
                                        end
                                    end
                                end
                            end
