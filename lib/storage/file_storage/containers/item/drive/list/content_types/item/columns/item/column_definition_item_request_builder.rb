                                    ...
                                    module Columns
                                        module Item
                                            ...
                                            class ColumnDefinitionItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                                ...
                                                def source_column()
                                                    return MicrosoftGraph::Storage::FileStorage::Containers::Item::Drive::List::ContentTypes::Item::Columns::Item::SourceColumn::SourceColumnRequestBuilder.new(@path_parameters, @request_adapter)
                                                end
                                                ## 
                                                ...
                                                def initialize(path_parameters, request_adapter)
                                                    super(path_parameters, request_adapter, "{+baseurl}/storage/fileStorage/containers/{fileStorageContainer%2Did}/drive/list/contentTypes/{contentType%2Did}/columns/{columnDefinition%2Did}{?%24expand,%24select}")
                                                end
                                                ## 
