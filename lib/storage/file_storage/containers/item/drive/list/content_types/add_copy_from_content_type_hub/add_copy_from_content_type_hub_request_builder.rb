                                ...
                                module AddCopyFromContentTypeHub
                                    ...
                                    class AddCopyFromContentTypeHubRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                        ...
                                        def initialize(path_parameters, request_adapter)
                                            super(path_parameters, request_adapter, "{+baseurl}/storage/fileStorage/containers/{fileStorageContainer%2Did}/drive/list/contentTypes/addCopyFromContentTypeHub")
                                        end
                                        ## 
                                        ...
                                        ## @return a add_copy_from_content_type_hub_request_builder
                                        ## 
                                        def with_url(raw_url)
                                            raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                                            return AddCopyFromContentTypeHubRequestBuilder.new(raw_url, @request_adapter)
                                        end
                                    end
                                end
                            end
