                        ...
                        module List
                            module Items
                                ...
                                class ItemsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                    ...
                                    def delta()
                                        return MicrosoftGraph::Storage::FileStorage::Containers::Item::Drive::List::Items::Delta::DeltaRequestBuilder.new(@path_parameters, @request_adapter)
                                    end
                                    ## 
                                    ## Provides operations to manage the items property of the microsoft.graph.list entity.
                                    ...
                                    def by_list_item_id(list_item_id)
                                        ...
                                        return MicrosoftGraph::Storage::FileStorage::Containers::Item::Drive::List::Items::Item::ListItemItemRequestBuilder.new(url_tpl_params, @request_adapter)
                                    end
                                    ## 
                                    ...
                                    def initialize(path_parameters, request_adapter)
                                        super(path_parameters, request_adapter, "{+baseurl}/storage/fileStorage/containers/{fileStorageContainer%2Did}/drive/list/items{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}")
                                    end
                                    ## 
                                    ## Provides operations to call the delta method.
