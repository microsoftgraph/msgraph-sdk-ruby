                                    ...
                                    module Versions
                                        module Item
                                            ...
                                            class ListItemVersionItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                                ...
                                                def fields()
                                                    return MicrosoftGraph::Storage::FileStorage::Containers::Item::Drive::List::Items::Item::Versions::Item::Fields::FieldsRequestBuilder.new(@path_parameters, @request_adapter)
                                                end
                                                ## 
                                                # Provides operations to call the restoreVersion method.
                                                def restore_version()
                                                    return MicrosoftGraph::Storage::FileStorage::Containers::Item::Drive::List::Items::Item::Versions::Item::RestoreVersion::RestoreVersionRequestBuilder.new(@path_parameters, @request_adapter)
                                                end
                                                ## 
                                                ...
                                                def initialize(path_parameters, request_adapter)
                                                    super(path_parameters, request_adapter, "{+baseurl}/storage/fileStorage/containers/{fileStorageContainer%2Did}/drive/list/items/{listItem%2Did}/versions/{listItemVersion%2Did}{?%24expand,%24select}")
                                                end
                                                ## 
