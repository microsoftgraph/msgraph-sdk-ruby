                                ...
                                module Item
                                    module Versions
                                        ...
                                        class VersionsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                            ...
                                            def count()
                                                return MicrosoftGraph::Storage::FileStorage::Containers::Item::Drive::List::Items::Item::Versions::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                                            end
                                            ## 
                                            ## Provides operations to manage the versions property of the microsoft.graph.listItem entity.
                                            ...
                                            def by_list_item_version_id(list_item_version_id)
                                                ...
                                                return MicrosoftGraph::Storage::FileStorage::Containers::Item::Drive::List::Items::Item::Versions::Item::ListItemVersionItemRequestBuilder.new(url_tpl_params, @request_adapter)
                                            end
                                            ## 
                                            ...
                                            def initialize(path_parameters, request_adapter)
                                                super(path_parameters, request_adapter, "{+baseurl}/storage/fileStorage/containers/{fileStorageContainer%2Did}/drive/list/items/{listItem%2Did}/versions{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}")
                                            end
                                            ## 
