                        ...
                        module List
                            module Columns
                                ...
                                class ColumnsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                    ...
                                    def count()
                                        return MicrosoftGraph::Storage::FileStorage::Containers::Item::Drive::List::Columns::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                                    end
                                    ## 
                                    ## Provides operations to manage the columns property of the microsoft.graph.list entity.
                                    ...
                                    def by_column_definition_id(column_definition_id)
                                        ...
                                        return MicrosoftGraph::Storage::FileStorage::Containers::Item::Drive::List::Columns::Item::ColumnDefinitionItemRequestBuilder.new(url_tpl_params, @request_adapter)
                                    end
                                    ## 
                                    ...
                                    def initialize(path_parameters, request_adapter)
                                        super(path_parameters, request_adapter, "{+baseurl}/storage/fileStorage/containers/{fileStorageContainer%2Did}/drive/list/columns{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}")
                                    end
                                    ## 
