                                ...
                                module Subscriptions
                                    module Item
                                        ...
                                        class SubscriptionItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                            ...
                                            def reauthorize()
                                                return MicrosoftGraph::Storage::FileStorage::Containers::Item::Drive::Items::Item::Subscriptions::Item::Reauthorize::ReauthorizeRequestBuilder.new(@path_parameters, @request_adapter)
                                            end
                                            ## 
                                            ...
                                            def initialize(path_parameters, request_adapter)
                                                super(path_parameters, request_adapter, "{+baseurl}/storage/fileStorage/containers/{fileStorageContainer%2Did}/drive/items/{driveItem%2Did}/subscriptions/{subscription%2Did}{?%24expand,%24select}")
                                            end
                                            ## 
