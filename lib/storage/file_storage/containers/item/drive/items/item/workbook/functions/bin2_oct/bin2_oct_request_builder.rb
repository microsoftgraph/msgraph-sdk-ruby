                                ...
                                module Workbook
                                    module Functions
                                        module Bin2Oct
                                            ...
                                            class Bin2OctRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                                ...
                                                def initialize(path_parameters, request_adapter)
                                                    super(path_parameters, request_adapter, "{+baseurl}/storage/fileStorage/containers/{fileStorageContainer%2Did}/drive/items/{driveItem%2Did}/workbook/functions/bin2Oct")
                                                end
                                                ## 
                                                ...
                                                ## @return a bin2_oct_request_builder
                                                ## 
                                                def with_url(raw_url)
                                                    raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                                                    return Bin2OctRequestBuilder.new(raw_url, @request_adapter)
                                                end
                                            end
                                        end
                                    end
