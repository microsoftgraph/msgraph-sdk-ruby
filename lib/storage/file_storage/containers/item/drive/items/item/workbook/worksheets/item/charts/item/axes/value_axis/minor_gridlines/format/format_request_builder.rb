                                                            ...
                                                            module MinorGridlines
                                                                module Format
                                                                    ...
                                                                    class FormatRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                                                        ...
                                                                        def line()
                                                                            return MicrosoftGraph::Storage::FileStorage::Containers::Item::Drive::Items::Item::Workbook::Worksheets::Item::Charts::Item::Axes::ValueAxis::MinorGridlines::Format::Line::LineRequestBuilder.new(@path_parameters, @request_adapter)
                                                                        end
                                                                        ## 
                                                                        ...
                                                                        def initialize(path_parameters, request_adapter)
                                                                            super(path_parameters, request_adapter, "{+baseurl}/storage/fileStorage/containers/{fileStorageContainer%2Did}/drive/items/{driveItem%2Did}/workbook/worksheets/{workbookWorksheet%2Did}/charts/{workbookChart%2Did}/axes/valueAxis/minorGridlines/format{?%24expand,%24select}")
                                                                        end
                                                                        ## 
