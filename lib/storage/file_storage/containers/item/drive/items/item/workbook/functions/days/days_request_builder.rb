                                ...
                                module Workbook
                                    module Functions
                                        module Days
                                            ...
                                            class DaysRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                                ...
                                                def initialize(path_parameters, request_adapter)
                                                    super(path_parameters, request_adapter, "{+baseurl}/storage/fileStorage/containers/{fileStorageContainer%2Did}/drive/items/{driveItem%2Did}/workbook/functions/days")
                                                end
                                                ## 
                                                ## Invoke action days
                                                ...
                                                ## @return a days_request_builder
                                                ## 
                                                def with_url(raw_url)
                                                    raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                                                    return DaysRequestBuilder.new(raw_url, @request_adapter)
                                                end
                                            end
                                        end
                                    end
