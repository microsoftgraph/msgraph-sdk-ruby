                                ...
                                module Workbook
                                    module Functions
                                        module Atan2
                                            ...
                                            class Atan2RequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                                ...
                                                def initialize(path_parameters, request_adapter)
                                                    super(path_parameters, request_adapter, "{+baseurl}/storage/fileStorage/containers/{fileStorageContainer%2Did}/drive/items/{driveItem%2Did}/workbook/functions/atan2")
                                                end
                                                ## 
                                                ## Invoke action atan2
                                                ...
                                                ## @return a atan2_request_builder
                                                ## 
                                                def with_url(raw_url)
                                                    raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                                                    return Atan2RequestBuilder.new(raw_url, @request_adapter)
                                                end
                                            end
                                        end
                                    end
