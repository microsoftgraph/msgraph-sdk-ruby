                                ...
                                module Workbook
                                    module Functions
                                        module Match
                                            ...
                                            class MatchRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                                ...
                                                def initialize(path_parameters, request_adapter)
                                                    super(path_parameters, request_adapter, "{+baseurl}/storage/fileStorage/containers/{fileStorageContainer%2Did}/drive/items/{driveItem%2Did}/workbook/functions/match")
                                                end
                                                ## 
                                                ## Invoke action match
                                                ...
                                                ## @return a match_request_builder
                                                ## 
                                                def with_url(raw_url)
                                                    raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                                                    return MatchRequestBuilder.new(raw_url, @request_adapter)
                                                end
                                            end
                                        end
                                    end
