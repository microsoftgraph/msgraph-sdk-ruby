                                ...
                                module Workbook
                                    module Functions
                                        module Oct2Dec
                                            ...
                                            class Oct2DecRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                                ...
                                                def initialize(path_parameters, request_adapter)
                                                    super(path_parameters, request_adapter, "{+baseurl}/storage/fileStorage/containers/{fileStorageContainer%2Did}/drive/items/{driveItem%2Did}/workbook/functions/oct2Dec")
                                                end
                                                ## 
                                                ...
                                                ## @return a oct2_dec_request_builder
                                                ## 
                                                def with_url(raw_url)
                                                    raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                                                    return Oct2DecRequestBuilder.new(raw_url, @request_adapter)
                                                end
                                            end
                                        end
                                    end
