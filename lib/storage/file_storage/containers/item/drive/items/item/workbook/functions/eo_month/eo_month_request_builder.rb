                                ...
                                module Workbook
                                    module Functions
                                        module EoMonth
                                            ...
                                            class EoMonthRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                                ...
                                                def initialize(path_parameters, request_adapter)
                                                    super(path_parameters, request_adapter, "{+baseurl}/storage/fileStorage/containers/{fileStorageContainer%2Did}/drive/items/{driveItem%2Did}/workbook/functions/eoMonth")
                                                end
                                                ## 
                                                ...
                                                ## @return a eo_month_request_builder
                                                ## 
                                                def with_url(raw_url)
                                                    raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                                                    return EoMonthRequestBuilder.new(raw_url, @request_adapter)
                                                end
                                            end
                                        end
                                    end
