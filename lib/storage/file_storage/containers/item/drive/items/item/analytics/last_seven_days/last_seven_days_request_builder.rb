...
require_relative './last_seven_days'
                                    ...
                                    module LastSevenDays
                                        ...
                                        class LastSevenDaysRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                            ...
                                            def initialize(path_parameters, request_adapter)
                                                super(path_parameters, request_adapter, "{+baseurl}/storage/fileStorage/containers/{fileStorageContainer%2Did}/drive/items/{driveItem%2Did}/analytics/lastSevenDays{?%24expand,%24select}")
                                            end
                                            ## 
                                            ...
                                            ## @return a last_seven_days_request_builder
                                            ## 
                                            def with_url(raw_url)
                                                raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                                                return LastSevenDaysRequestBuilder.new(raw_url, @request_adapter)
                                            end
