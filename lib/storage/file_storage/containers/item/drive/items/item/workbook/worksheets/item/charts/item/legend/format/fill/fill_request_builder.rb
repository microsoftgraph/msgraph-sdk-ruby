                                                        ...
                                                        module Format
                                                            module Fill
                                                                ...
                                                                class FillRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                                                    ...
                                                                    def clear()
                                                                        return MicrosoftGraph::Storage::FileStorage::Containers::Item::Drive::Items::Item::Workbook::Worksheets::Item::Charts::Item::Legend::Format::Fill::Clear::ClearRequestBuilder.new(@path_parameters, @request_adapter)
                                                                    end
                                                                    ## 
                                                                    # Provides operations to call the setSolidColor method.
                                                                    def set_solid_color()
                                                                        return MicrosoftGraph::Storage::FileStorage::Containers::Item::Drive::Items::Item::Workbook::Worksheets::Item::Charts::Item::Legend::Format::Fill::SetSolidColor::SetSolidColorRequestBuilder.new(@path_parameters, @request_adapter)
                                                                    end
                                                                    ## 
                                                                    ...
                                                                    def initialize(path_parameters, request_adapter)
                                                                        super(path_parameters, request_adapter, "{+baseurl}/storage/fileStorage/containers/{fileStorageContainer%2Did}/drive/items/{driveItem%2Did}/workbook/worksheets/{workbookWorksheet%2Did}/charts/{workbookChart%2Did}/legend/format/fill{?%24expand,%24select}")
                                                                    end
                                                                    ## 
