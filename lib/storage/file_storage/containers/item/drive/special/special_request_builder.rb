                    ...
                    module Drive
                        module Special
                            ...
                            class SpecialRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                ...
                                def count()
                                    return MicrosoftGraph::Storage::FileStorage::Containers::Item::Drive::Special::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                                end
                                ## 
                                ## Provides operations to manage the special property of the microsoft.graph.drive entity.
                                ...
                                def by_drive_item_id(drive_item_id)
                                    ...
                                    return MicrosoftGraph::Storage::FileStorage::Containers::Item::Drive::Special::Item::DriveItemItemRequestBuilder.new(url_tpl_params, @request_adapter)
                                end
                                ## 
                                ...
                                def initialize(path_parameters, request_adapter)
                                    super(path_parameters, request_adapter, "{+baseurl}/storage/fileStorage/containers/{fileStorageContainer%2Did}/drive/special{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}")
                                end
                                ## 
                                ...
                                ## @return a special_request_builder
                                ## 
                                def with_url(raw_url)
                                    raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                                    return SpecialRequestBuilder.new(raw_url, @request_adapter)
                                end
