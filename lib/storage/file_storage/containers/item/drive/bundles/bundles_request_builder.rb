                ...
                module Item
                    module Drive
                        module Bundles
                            ...
                            class BundlesRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                
                                ## 
                                # Provides operations to count the resources in the collection.
                                def count()
                                    return MicrosoftGraph::Storage::FileStorage::Containers::Item::Drive::Bundles::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                                end
                                ## 
                                ## Provides operations to manage the bundles property of the microsoft.graph.drive entity.
                                ...
                                def by_drive_item_id(drive_item_id)
                                    ...
                                    return MicrosoftGraph::Storage::FileStorage::Containers::Item::Drive::Bundles::Item::DriveItemItemRequestBuilder.new(url_tpl_params, @request_adapter)
                                end
                                ## 
                                ...
                                def initialize(path_parameters, request_adapter)
                                    super(path_parameters, request_adapter, "{+baseurl}/storage/fileStorage/containers/{fileStorageContainer%2Did}/drive/bundles{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}")
                                end
                                ## 
                                ...
                                ## @return a bundles_request_builder
                                ## 
                                def with_url(raw_url)
                                    raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                                    return BundlesRequestBuilder.new(raw_url, @request_adapter)
                                end
