                    ...
                    module Permissions
                        module Item
                            ...
                            class PermissionItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                ...
                                def grant()
                                    return MicrosoftGraph::Storage::FileStorage::Containers::Item::Permissions::Item::Grant::GrantRequestBuilder.new(@path_parameters, @request_adapter)
                                end
                                ## 
                                ...
                                def initialize(path_parameters, request_adapter)
                                    super(path_parameters, request_adapter, "{+baseurl}/storage/fileStorage/containers/{fileStorageContainer%2Did}/permissions/{permission%2Did}{?%24expand,%24select}")
                                end
                                ## 
