...
require_relative './microsoft_graph_disconnect'

module MicrosoftGraph::DeviceManagement::RemoteAssistancePartners::Item::MicrosoftGraphDisconnect
    ## 
    ...
    class DisconnectRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/deviceManagement/remoteAssistancePartners/{remoteAssistancePartner%2Did}/microsoft.graph.disconnect"
