...
require_relative '../../../../models/device_compliance_setting_state'
require_relative '../../../../models/device_compliance_setting_state_collection_response'
...
module MicrosoftGraph
    module DeviceManagement
        module DeviceCompliancePolicySettingStateSummaries
            module Item
                module DeviceComplianceSettingStates
                    ## 
                    ...
                    class DeviceComplianceSettingStatesRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/deviceManagement/deviceCompliancePolicySettingStateSummaries/{deviceCompliancePolicySettingStateSummary%2Did}/deviceComplianceSettingStates{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}")
                        end
                        ## 
                        ## List properties and relationships of the deviceComplianceSettingState objects.
                        ## @param request_configuration Configuration for the request such as headers, query parameters, and middleware options.
                        ## @return a Fiber of device_compliance_setting_state_collection_response
                        ## 
                        def get(request_configuration=nil)
                            ...
                            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraph::Models::DeviceComplianceSettingStateCollectionResponse.create_from_discriminator_value(pn) }, error_mapping)
                        end
                        ## 
                        ...
                        def post(body, request_configuration=nil)
                            ...
                            error_mapping = Hash.new
                            error_mapping["XXX"] = lambda {|pn| MicrosoftGraph::Models::ODataErrorsODataError.create_from_discriminator_value(pn) }
                            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraph::Models::DeviceComplianceSettingState.create_from_discriminator_value(pn) }, error_mapping)
                        end
                        ## 
                        ## List properties and relationships of the deviceComplianceSettingState objects.
                        ## @param request_configuration Configuration for the request such as headers, query parameters, and middleware options.
                        ...
                        def to_post_request_information(body, request_configuration=nil)
                            ...
                            request_info.url_template = '{+baseurl}/deviceManagement/deviceCompliancePolicySettingStateSummaries/{deviceCompliancePolicySettingStateSummary%2Did}/deviceComplianceSettingStates'
                            request_info.path_parameters = @path_parameters
                        ...
                        ## @return a device_compliance_setting_states_request_builder
                        ## 
                        def with_url(raw_url)
                            raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                            return DeviceComplianceSettingStatesRequestBuilder.new(raw_url, @request_adapter)
                        end
