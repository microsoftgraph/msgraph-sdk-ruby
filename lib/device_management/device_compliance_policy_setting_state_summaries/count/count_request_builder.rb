...
module MicrosoftGraph::DeviceManagement::DeviceCompliancePolicySettingStateSummaries::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/deviceManagement/deviceCompliancePolicySettingStateSummaries/$count{?%24search,%24filter}"
