            ...
            module Item
                module ScheduledActionsForRule
                    module Item
                        ...
                        class DeviceComplianceScheduledActionForRuleItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            def scheduled_action_configurations()
                                return MicrosoftGraph::DeviceManagement::DeviceCompliancePolicies::Item::ScheduledActionsForRule::Item::ScheduledActionConfigurations::ScheduledActionConfigurationsRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            ...
                            def initialize(path_parameters, request_adapter)
                                super(path_parameters, request_adapter, "{+baseurl}/deviceManagement/deviceCompliancePolicies/{deviceCompliancePolicy%2Did}/scheduledActionsForRule/{deviceComplianceScheduledActionForRule%2Did}{?%24expand,%24select}")
                            end
                            ## 
                            ...
                            def to_delete_request_information(request_configuration=nil)
                                ...
                                request_info.url_template = '{+baseurl}/deviceManagement/deviceCompliancePolicies/{deviceCompliancePolicy%2Did}/scheduledActionsForRule/{deviceComplianceScheduledActionForRule%2Did}'
                            ...
                            def with_url(raw_url)
                                ...
                                return DeviceComplianceScheduledActionForRuleItemRequestBuilder.new(raw_url, @request_adapter)
                            end
