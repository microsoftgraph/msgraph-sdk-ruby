...
require_relative '../../../../../../models/device_compliance_action_item'
require_relative '../../../../../../models/device_compliance_action_item_collection_response'
...
module MicrosoftGraph
    module DeviceManagement
        module DeviceCompliancePolicies
            module Item
                module ScheduledActionsForRule
                    module Item
                        module ScheduledActionConfigurations
                            ## 
                            ...
                            class ScheduledActionConfigurationsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                ...
                                def initialize(path_parameters, request_adapter)
                                    super(path_parameters, request_adapter, "{+baseurl}/deviceManagement/deviceCompliancePolicies/{deviceCompliancePolicy%2Did}/scheduledActionsForRule/{deviceComplianceScheduledActionForRule%2Did}/scheduledActionConfigurations{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}")
                                end
                                ## 
                                ## List properties and relationships of the deviceComplianceActionItem objects.
                                ## @param request_configuration Configuration for the request such as headers, query parameters, and middleware options.
                                ## @return a Fiber of device_compliance_action_item_collection_response
                                ## 
                                def get(request_configuration=nil)
                                    ...
                                    return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraph::Models::DeviceComplianceActionItemCollectionResponse.create_from_discriminator_value(pn) }, error_mapping)
                                end
                                ## 
                                ...
                                def to_post_request_information(body, request_configuration=nil)
                                    ...
                                    request_info.url_template = '{+baseurl}/deviceManagement/deviceCompliancePolicies/{deviceCompliancePolicy%2Did}/scheduledActionsForRule/{deviceComplianceScheduledActionForRule%2Did}/scheduledActionConfigurations'
                                    request_info.path_parameters = @path_parameters
                                ...
                                ## @return a scheduled_action_configurations_request_builder
                                ## 
                                def with_url(raw_url)
                                    raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                                    return ScheduledActionConfigurationsRequestBuilder.new(raw_url, @request_adapter)
                                end
