...
module MicrosoftGraph::DeviceManagement::DeviceCompliancePolicies::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/deviceManagement/deviceCompliancePolicies/$count{?%24search,%24filter}"
