    ...
    module DeviceManagement
        module DetectedApps
            module Item
                ...
                class DetectedAppItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    
                    ## 
                    # Provides operations to manage the managedDevices property of the microsoft.graph.detectedApp entity.
                    def managed_devices()
                        return MicrosoftGraph::DeviceManagement::DetectedApps::Item::ManagedDevices::ManagedDevicesRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ...
                    def initialize(path_parameters, request_adapter)
                        super(path_parameters, request_adapter, "{+baseurl}/deviceManagement/detectedApps/{detectedApp%2Did}{?%24expand,%24select}")
                    end
                    ## 
                    ...
                    def to_delete_request_information(request_configuration=nil)
                        ...
                        request_info.url_template = '{+baseurl}/deviceManagement/detectedApps/{detectedApp%2Did}'
                    ...
                    def with_url(raw_url)
                        ...
                        return DetectedAppItemRequestBuilder.new(raw_url, @request_adapter)
                    end
