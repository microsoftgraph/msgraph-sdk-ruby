...
require_relative './run_health_checks'
    ...
    module DeviceManagement
        module VirtualEndpoint
            module OnPremisesConnections
                module Item
                    module RunHealthChecks
                        ## 
                        # Provides operations to call the runHealthChecks method.
                        class RunHealthChecksRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            def initialize(path_parameters, request_adapter)
                                super(path_parameters, request_adapter, "{+baseurl}/deviceManagement/virtualEndpoint/onPremisesConnections/{cloudPcOnPremisesConnection%2Did}/runHealthChecks")
                            end
                            ## 
                            ...
                            ## @return a run_health_checks_request_builder
                            ## 
                            def with_url(raw_url)
                                raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                                return RunHealthChecksRequestBuilder.new(raw_url, @request_adapter)
                            end
                        end
                    end
                end
