                ...
                module GetAuditActivityTypes
                    ...
                    class GetAuditActivityTypesRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/deviceManagement/virtualEndpoint/auditEvents/getAuditActivityTypes(){?%24count,%24filter,%24search,%24skip,%24top}")
                        end
                        ## 
                        ## Get audit activity types by tenant ID.
                        ## @param request_configuration Configuration for the request such as headers, query parameters, and middleware options.
                        ## @return a Fiber of get_audit_activity_typesget_response
                        ## 
                        def get(request_configuration=nil)
                            ...
                            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraph::DeviceManagement::VirtualEndpoint::AuditEvents::GetAuditActivityTypes::GetAuditActivityTypesgetResponse.create_from_discriminator_value(pn) }, error_mapping)
                        end
                        ## 
                        ## Get audit activity types by tenant ID.
                        ## @param request_configuration Configuration for the request such as headers, query parameters, and middleware options.
