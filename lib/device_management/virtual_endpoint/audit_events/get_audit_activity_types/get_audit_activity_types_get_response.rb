        ...
        module VirtualEndpoint
            module AuditEvents
                module GetAuditActivityTypes
                    class GetAuditActivityTypesGetResponse < MicrosoftGraph::Models::BaseCollectionPaginationCountResponse
                        include MicrosoftKiotaAbstractions::Parsable
                        ## 
                        # The value property
                        @value
                        ## 
                        ## Instantiates a new GetAuditActivityTypesGetResponse and sets the default values.
                        ## @return a void
                        ## 
                        def initialize()
                            super
                        ...
                        ## @return a get_audit_activity_types_get_response
                        ## 
                        def self.create_from_discriminator_value(parse_node)
                            raise StandardError, 'parse_node cannot be null' if parse_node.nil?
                            return GetAuditActivityTypesGetResponse.new
                        end
                        ## 
