...
require_relative '../item'
require_relative './assigned_users_with_user_principal_name'
        ...
        module VirtualEndpoint
            module ProvisioningPolicies
                module Item
                    module Assignments
                        module Item
                            module AssignedUsersWithUserPrincipalName
                                ## 
                                ...
                                class AssignedUsersWithUserPrincipalNameRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                    ...
                                    ## @return a void
                                    ## 
                                    def initialize(path_parameters, request_adapter, user_principal_name=nil)
                                        super(path_parameters, request_adapter, "{+baseurl}/deviceManagement/virtualEndpoint/provisioningPolicies/{cloudPcProvisioningPolicy%2Did}/assignments/{cloudPcProvisioningPolicyAssignment%2Did}/assignedUsers(userPrincipalName='{userPrincipalName}'){?%24expand,%24select}")
                                    end
                                    ## 
                                    ...
                                    def with_url(raw_url)
                                        ...
                                        return AssignedUsersWithUserPrincipalNameRequestBuilder.new(raw_url, @request_adapter)
                                    end
