...
require_relative './assigned_users/assigned_users_request_builder'
require_relative './assigned_users_with_user_principal_name/assigned_users_with_user_principal_name_request_builder'
require_relative './item'
                ...
                module Item
                    module Assignments
                        module Item
                            ...
                            class CloudPcProvisioningPolicyAssignmentItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                ...
                                def assigned_users()
                                    return MicrosoftGraph::DeviceManagement::VirtualEndpoint::ProvisioningPolicies::Item::Assignments::Item::AssignedUsers::AssignedUsersRequestBuilder.new(@path_parameters, @request_adapter)
                                end
                                ## 
                                ## Provides operations to manage the assignedUsers property of the microsoft.graph.cloudPcProvisioningPolicyAssignment entity.
                                ## @param user_principal_name Alternate key of user
                                ## @return a assigned_users_with_user_principal_name_request_builder
                                ## 
                                def assigned_users_with_user_principal_name(user_principal_name)
                                    raise StandardError, 'user_principal_name cannot be null' if user_principal_name.nil?
                                    return AssignedUsersWithUserPrincipalNameRequestBuilder.new(@path_parameters, @request_adapter, userPrincipalName)
                                end
                                ## 
