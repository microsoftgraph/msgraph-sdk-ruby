    ...
    module DeviceManagement
        module VirtualEndpoint
            ...
            class VirtualEndpointRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def audit_events()
                    return MicrosoftGraph::DeviceManagement::VirtualEndpoint::AuditEvents::AuditEventsRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                # Provides operations to manage the cloudPCs property of the microsoft.graph.virtualEndpoint entity.
                def cloud_p_cs()
                    return MicrosoftGraph::DeviceManagement::VirtualEndpoint::CloudPCs::CloudPCsRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                # Provides operations to manage the deviceImages property of the microsoft.graph.virtualEndpoint entity.
                def device_images()
                    return MicrosoftGraph::DeviceManagement::VirtualEndpoint::DeviceImages::DeviceImagesRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                # Provides operations to manage the galleryImages property of the microsoft.graph.virtualEndpoint entity.
                def gallery_images()
                    return MicrosoftGraph::DeviceManagement::VirtualEndpoint::GalleryImages::GalleryImagesRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                ...
                def on_premises_connections()
                    return MicrosoftGraph::DeviceManagement::VirtualEndpoint::OnPremisesConnections::OnPremisesConnectionsRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                # Provides operations to manage the provisioningPolicies property of the microsoft.graph.virtualEndpoint entity.
                def provisioning_policies()
                    return MicrosoftGraph::DeviceManagement::VirtualEndpoint::ProvisioningPolicies::ProvisioningPoliciesRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                # Provides operations to manage the userSettings property of the microsoft.graph.virtualEndpoint entity.
                def user_settings()
                    return MicrosoftGraph::DeviceManagement::VirtualEndpoint::UserSettings::UserSettingsRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                ...
                def get(request_configuration=nil)
                    ...
                    error_mapping = Hash.new
                    error_mapping["XXX"] = lambda {|pn| MicrosoftGraph::Models::ODataErrorsODataError.create_from_discriminator_value(pn) }
                    return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraph::Models::VirtualEndpoint.create_from_discriminator_value(pn) }, error_mapping)
                end
                ## 
