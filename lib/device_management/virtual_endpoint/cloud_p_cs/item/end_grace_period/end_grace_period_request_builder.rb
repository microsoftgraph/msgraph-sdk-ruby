...
require_relative './end_grace_period'
...
module MicrosoftGraph
    module DeviceManagement
        module VirtualEndpoint
            module CloudPCs
                module Item
                    module EndGracePeriod
                        ## 
                        # Provides operations to call the endGracePeriod method.
                        class EndGracePeriodRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            def initialize(path_parameters, request_adapter)
                                super(path_parameters, request_adapter, "{+baseurl}/deviceManagement/virtualEndpoint/cloudPCs/{cloudPC%2Did}/endGracePeriod")
                            end
                            ## 
                            ...
                            ## @return a end_grace_period_request_builder
                            ## 
                            def with_url(raw_url)
                                raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                                return EndGracePeriodRequestBuilder.new(raw_url, @request_adapter)
                            end
                        end
                    end
                end
