...
require_relative '../../models/imported_windows_autopilot_device_identity_collection_response'
...
module MicrosoftGraph
    module DeviceManagement
        module ImportedWindowsAutopilotDeviceIdentities
            ...
            class ImportedWindowsAutopilotDeviceIdentitiesRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                
                ## 
                # Provides operations to count the resources in the collection.
                def count()
                    return MicrosoftGraph::DeviceManagement::ImportedWindowsAutopilotDeviceIdentities::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                ...
                def initialize(path_parameters, request_adapter)
                    super(path_parameters, request_adapter, "{+baseurl}/deviceManagement/importedWindowsAutopilotDeviceIdentities{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}")
                end
                ## 
                ...
                def get(request_configuration=nil)
                    ...
                    return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraph::Models::ImportedWindowsAutopilotDeviceIdentityCollectionResponse.create_from_discriminator_value(pn) }, error_mapping)
                end
                ## 
                ...
                def post(body, request_configuration=nil)
                    ...
                    error_mapping = Hash.new
                    error_mapping["XXX"] = lambda {|pn| MicrosoftGraph::Models::ODataErrorsODataError.create_from_discriminator_value(pn) }
                    return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraph::Models::ImportedWindowsAutopilotDeviceIdentity.create_from_discriminator_value(pn) }, error_mapping)
                end
                ## 
                ## List properties and relationships of the importedWindowsAutopilotDeviceIdentity objects.
                ## @param request_configuration Configuration for the request such as headers, query parameters, and middleware options.
                ...
                def to_post_request_information(body, request_configuration=nil)
                    ...
                    request_info.url_template = '{+baseurl}/deviceManagement/importedWindowsAutopilotDeviceIdentities'
                    request_info.path_parameters = @path_parameters
                ...
                ## @return a imported_windows_autopilot_device_identities_request_builder
                ## 
                def with_url(raw_url)
                    raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                    return ImportedWindowsAutopilotDeviceIdentitiesRequestBuilder.new(raw_url, @request_adapter)
                end
