...
module MicrosoftGraph::DeviceManagement::DeviceConfigurations::Item::DeviceStatuses::Item
    ## 
    ...
    class DeviceConfigurationDeviceStatusItemRequestBuilder
        ...
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, device_configuration_device_status_id=)
