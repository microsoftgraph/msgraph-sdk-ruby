...
module MicrosoftGraph::DeviceManagement::DeviceConfigurations::Item::DeviceSettingStateSummaries::Item
    ## 
    ...
    class SettingStateDeviceSummaryItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, setting_state_device_summary_id=nil)
            ...
            @url_template = "{+baseurl}/deviceManagement/deviceConfigurations/{deviceConfiguration%2Did}/deviceSettingStateSummaries/{settingStateDeviceSummary%2Did}{?%24select,%24expand}"
