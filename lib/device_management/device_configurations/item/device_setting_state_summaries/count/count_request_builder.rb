...
module MicrosoftGraph::DeviceManagement::DeviceConfigurations::Item::DeviceSettingStateSummaries::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/deviceManagement/deviceConfigurations/{deviceConfiguration%2Did}/deviceSettingStateSummaries/$count{?%24search,%24filter}"
