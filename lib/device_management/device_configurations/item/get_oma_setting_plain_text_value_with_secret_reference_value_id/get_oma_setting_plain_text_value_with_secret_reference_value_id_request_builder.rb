                ...
                module GetOmaSettingPlainTextValueWithSecretReferenceValueId
                    ...
                    class GetOmaSettingPlainTextValueWithSecretReferenceValueIdRequestBuilder
                        ...
                        def initialize(path_parameters, request_adapter, secret_reference_value_id=nil)
                            ...
                            @url_template = "{+baseurl}/deviceManagement/deviceConfigurations/{deviceConfiguration%2Did}/getOmaSettingPlainTextValue(secretReferenceValueId='{secretReferenceValueId}')"
