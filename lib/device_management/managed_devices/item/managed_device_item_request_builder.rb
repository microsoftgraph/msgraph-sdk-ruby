            ...
            module Item
                ...
                class ManagedDeviceItemRequestBuilder
                    ...
                    def microsoft_graph_bypass_activation_lock()
                        return MicrosoftGraph::DeviceManagement::ManagedDevices::Item::MicrosoftGraphBypassActivationLock::MicrosoftGraphBypassActivationLockRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to call the cleanWindowsDevice method.
                    def microsoft_graph_clean_windows_device()
                        return MicrosoftGraph::DeviceManagement::ManagedDevices::Item::MicrosoftGraphCleanWindowsDevice::MicrosoftGraphCleanWindowsDeviceRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to call the deleteUserFromSharedAppleDevice method.
                    def microsoft_graph_delete_user_from_shared_apple_device()
                        return MicrosoftGraph::DeviceManagement::ManagedDevices::Item::MicrosoftGraphDeleteUserFromSharedAppleDevice::MicrosoftGraphDeleteUserFromSharedAppleDeviceRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to call the disableLostMode method.
                    def microsoft_graph_disable_lost_mode()
                        return MicrosoftGraph::DeviceManagement::ManagedDevices::Item::MicrosoftGraphDisableLostMode::MicrosoftGraphDisableLostModeRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to call the locateDevice method.
                    def microsoft_graph_locate_device()
                        return MicrosoftGraph::DeviceManagement::ManagedDevices::Item::MicrosoftGraphLocateDevice::MicrosoftGraphLocateDeviceRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to call the logoutSharedAppleDeviceActiveUser method.
                    def microsoft_graph_logout_shared_apple_device_active_user()
                        return MicrosoftGraph::DeviceManagement::ManagedDevices::Item::MicrosoftGraphLogoutSharedAppleDeviceActiveUser::MicrosoftGraphLogoutSharedAppleDeviceActiveUserRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to call the rebootNow method.
                    def microsoft_graph_reboot_now()
                        return MicrosoftGraph::DeviceManagement::ManagedDevices::Item::MicrosoftGraphRebootNow::MicrosoftGraphRebootNowRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to call the recoverPasscode method.
                    def microsoft_graph_recover_passcode()
                        return MicrosoftGraph::DeviceManagement::ManagedDevices::Item::MicrosoftGraphRecoverPasscode::MicrosoftGraphRecoverPasscodeRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to call the remoteLock method.
                    def microsoft_graph_remote_lock()
                        return MicrosoftGraph::DeviceManagement::ManagedDevices::Item::MicrosoftGraphRemoteLock::MicrosoftGraphRemoteLockRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to call the requestRemoteAssistance method.
                    def microsoft_graph_request_remote_assistance()
                        return MicrosoftGraph::DeviceManagement::ManagedDevices::Item::MicrosoftGraphRequestRemoteAssistance::MicrosoftGraphRequestRemoteAssistanceRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to call the resetPasscode method.
                    def microsoft_graph_reset_passcode()
                        return MicrosoftGraph::DeviceManagement::ManagedDevices::Item::MicrosoftGraphResetPasscode::MicrosoftGraphResetPasscodeRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to call the retire method.
                    def microsoft_graph_retire()
                        return MicrosoftGraph::DeviceManagement::ManagedDevices::Item::MicrosoftGraphRetire::MicrosoftGraphRetireRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to call the shutDown method.
                    def microsoft_graph_shut_down()
                        return MicrosoftGraph::DeviceManagement::ManagedDevices::Item::MicrosoftGraphShutDown::MicrosoftGraphShutDownRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to call the syncDevice method.
                    def microsoft_graph_sync_device()
                        return MicrosoftGraph::DeviceManagement::ManagedDevices::Item::MicrosoftGraphSyncDevice::MicrosoftGraphSyncDeviceRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to call the updateWindowsDeviceAccount method.
                    def microsoft_graph_update_windows_device_account()
                        return MicrosoftGraph::DeviceManagement::ManagedDevices::Item::MicrosoftGraphUpdateWindowsDeviceAccount::MicrosoftGraphUpdateWindowsDeviceAccountRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to call the windowsDefenderScan method.
                    def microsoft_graph_windows_defender_scan()
                        return MicrosoftGraph::DeviceManagement::ManagedDevices::Item::MicrosoftGraphWindowsDefenderScan::MicrosoftGraphWindowsDefenderScanRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to call the windowsDefenderUpdateSignatures method.
                    def microsoft_graph_windows_defender_update_signatures()
                        return MicrosoftGraph::DeviceManagement::ManagedDevices::Item::MicrosoftGraphWindowsDefenderUpdateSignatures::MicrosoftGraphWindowsDefenderUpdateSignaturesRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to call the wipe method.
                    def microsoft_graph_wipe()
                        return MicrosoftGraph::DeviceManagement::ManagedDevices::Item::MicrosoftGraphWipe::MicrosoftGraphWipeRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
