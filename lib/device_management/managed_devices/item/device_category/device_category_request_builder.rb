        ...
        module ManagedDevices
            module Item
                module DeviceCategory
                    ...
                    class DeviceCategoryRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        
                        ## 
                        # Provides operations to manage the collection of deviceManagement entities.
                        def ref()
                            return MicrosoftGraph::DeviceManagement::ManagedDevices::Item::DeviceCategory::Ref::RefRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/deviceManagement/managedDevices/{managedDevice%2Did}/deviceCategory{?%24expand,%24select}")
                        end
                        ## 
                        ...
                        ## @return a device_category_request_builder
                        ## 
                        def with_url(raw_url)
                            raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                            return DeviceCategoryRequestBuilder.new(raw_url, @request_adapter)
                        end
