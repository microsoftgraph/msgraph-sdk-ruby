    ...
    module DeviceManagement
        module UserExperienceAnalyticsModelScores
            ...
            class UserExperienceAnalyticsModelScoresRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def count()
                    return MicrosoftGraph::DeviceManagement::UserExperienceAnalyticsModelScores::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                ## Provides operations to manage the userExperienceAnalyticsModelScores property of the microsoft.graph.deviceManagement entity.
                ...
                def by_user_experience_analytics_model_scores_id(user_experience_analytics_model_scores_id)
                    ...
                    return MicrosoftGraph::DeviceManagement::UserExperienceAnalyticsModelScores::Item::UserExperienceAnalyticsModelScoresItemRequestBuilder.new(url_tpl_params, @request_adapter)
                end
                ## 
                ...
                def initialize(path_parameters, request_adapter)
                    super(path_parameters, request_adapter, "{+baseurl}/deviceManagement/userExperienceAnalyticsModelScores{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}")
                end
                ## 
                ...
                def get(request_configuration=nil)
                    ...
                    return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraph::Models::UserExperienceAnalyticsModelScoresCollectionResponse.create_from_discriminator_value(pn) }, error_mapping)
                end
                ## 
                ...
                def post(body, request_configuration=nil)
                    ...
                    error_mapping = Hash.new
                    error_mapping["XXX"] = lambda {|pn| MicrosoftGraph::Models::ODataErrorsODataError.create_from_discriminator_value(pn) }
                    return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraph::Models::UserExperienceAnalyticsModelScores.create_from_discriminator_value(pn) }, error_mapping)
                end
                ## 
                ## User experience analytics model scores
                ## @param request_configuration Configuration for the request such as headers, query parameters, and middleware options.
                ...
                def to_post_request_information(body, request_configuration=nil)
                    ...
                    request_info.url_template = '{+baseurl}/deviceManagement/userExperienceAnalyticsModelScores'
                    request_info.path_parameters = @path_parameters
