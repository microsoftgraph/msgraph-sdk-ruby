    ...
    module DeviceManagement
        module UserExperienceAnalyticsModelScores
            module Item
                ...
                class UserExperienceAnalyticsModelScoresItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def initialize(path_parameters, request_adapter)
                        super(path_parameters, request_adapter, "{+baseurl}/deviceManagement/userExperienceAnalyticsModelScores/{userExperienceAnalyticsModelScores%2Did}{?%24expand,%24select}")
                    end
                    ## 
                    ...
                    def to_delete_request_information(request_configuration=nil)
                        ...
                        request_info.url_template = '{+baseurl}/deviceManagement/userExperienceAnalyticsModelScores/{userExperienceAnalyticsModelScores%2Did}'
                    ...
                    def with_url(raw_url)
                        ...
                        return UserExperienceAnalyticsModelScoresItemRequestBuilder.new(raw_url, @request_adapter)
                    end
