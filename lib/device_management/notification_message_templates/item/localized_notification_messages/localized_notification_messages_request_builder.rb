...
require_relative '../../../../models/localized_notification_message'
require_relative '../../../../models/localized_notification_message_collection_response'
...
module MicrosoftGraph
    module DeviceManagement
        module NotificationMessageTemplates
            module Item
                module LocalizedNotificationMessages
                    ## 
                    ...
                    class LocalizedNotificationMessagesRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/deviceManagement/notificationMessageTemplates/{notificationMessageTemplate%2Did}/localizedNotificationMessages{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}")
                        end
                        ## 
                        ...
                        def to_post_request_information(body, request_configuration=nil)
                            ...
                            request_info.url_template = '{+baseurl}/deviceManagement/notificationMessageTemplates/{notificationMessageTemplate%2Did}/localizedNotificationMessages'
                            request_info.path_parameters = @path_parameters
                        ...
                        ## @return a localized_notification_messages_request_builder
                        ## 
                        def with_url(raw_url)
                            raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                            return LocalizedNotificationMessagesRequestBuilder.new(raw_url, @request_adapter)
                        end
