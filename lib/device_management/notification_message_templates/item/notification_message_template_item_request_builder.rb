...
require_relative './microsoft_graph_send_test_message/microsoft_graph_send_test_message_request_builder'
...
module MicrosoftGraph::DeviceManagement::NotificationMessageTemplates::Item
    ...
    class NotificationMessageTemplateItemRequestBuilder
        ...
        def microsoft_graph_send_test_message()
            return MicrosoftGraph::DeviceManagement::NotificationMessageTemplates::Item::MicrosoftGraphSendTestMessage::MicrosoftGraphSendTestMessageRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
