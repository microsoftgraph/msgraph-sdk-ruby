    ...
    module DeviceManagement
        module VerifyWindowsEnrollmentAutoDiscoveryWithDomainName
            class VerifyWindowsEnrollmentAutoDiscoveryWithDomainNameGetResponse
                ...
                ## @return a verify_windows_enrollment_auto_discovery_with_domain_name_get_response
                ## 
                def self.create_from_discriminator_value(parse_node)
                    raise StandardError, 'parse_node cannot be null' if parse_node.nil?
                    return VerifyWindowsEnrollmentAutoDiscoveryWithDomainNameGetResponse.new
                end
                ## 
