...
module MicrosoftGraph
    module DeviceManagement
        module SoftwareUpdateStatusSummary
            ## 
            # Provides operations to manage the softwareUpdateStatusSummary property of the microsoft.graph.deviceManagement entity.
            class SoftwareUpdateStatusSummaryRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def initialize(path_parameters, request_adapter)
                    super(path_parameters, request_adapter, "{+baseurl}/deviceManagement/softwareUpdateStatusSummary{?%24expand,%24select}")
                end
                ## 
                ...
                ## @return a software_update_status_summary_request_builder
                ## 
                def with_url(raw_url)
                    raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                    return SoftwareUpdateStatusSummaryRequestBuilder.new(raw_url, @request_adapter)
                end
