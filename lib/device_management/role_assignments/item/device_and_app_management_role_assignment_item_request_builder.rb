...
module MicrosoftGraph::DeviceManagement::RoleAssignments::Item
    ## 
    ...
    class DeviceAndAppManagementRoleAssignmentItemRequestBuilder
        ...
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, device_and_app_management_role_assignment_id=)
