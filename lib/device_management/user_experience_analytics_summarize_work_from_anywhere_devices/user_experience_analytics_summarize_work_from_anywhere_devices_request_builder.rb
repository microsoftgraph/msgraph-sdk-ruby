        ...
        module UserExperienceAnalyticsSummarizeWorkFromAnywhereDevices
            ...
            class UserExperienceAnalyticsSummarizeWorkFromAnywhereDevicesRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def get(request_configuration=nil)
                    ...
                    return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraph::Models::UserExperienceAnalyticsWorkFromAnywhereDevicesSummary.create_from_discriminator_value(pn) }, error_mapping)
                end
                ## 
                ## Invoke function userExperienceAnalyticsSummarizeWorkFromAnywhereDevices
                ## @param request_configuration Configuration for the request such as headers, query parameters, and middleware options.
                ...
                def with_url(raw_url)
                    ...
                    return UserExperienceAnalyticsSummarizeWorkFromAnywhereDevicesRequestBuilder.new(raw_url, @request_adapter)
                end
            end
        end
    end
