...
require_relative '../../models/device_compliance_policy_device_state_summary'
...
module MicrosoftGraph
    module DeviceManagement
        module DeviceCompliancePolicyDeviceStateSummary
            ## 
            ...
            class DeviceCompliancePolicyDeviceStateSummaryRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def initialize(path_parameters, request_adapter)
                    super(path_parameters, request_adapter, "{+baseurl}/deviceManagement/deviceCompliancePolicyDeviceStateSummary{?%24expand,%24select}")
                end
                ## 
                ...
                def to_delete_request_information(request_configuration=nil)
                    ...
                    request_info.url_template = '{+baseurl}/deviceManagement/deviceCompliancePolicyDeviceStateSummary'
                ...
                ## @return a device_compliance_policy_device_state_summary_request_builder
                ## 
                def with_url(raw_url)
                    raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                    return DeviceCompliancePolicyDeviceStateSummaryRequestBuilder.new(raw_url, @request_adapter)
                end
