            ...
            module Item
                ...
                class UserExperienceAnalyticsBaselineItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def app_health_metrics()
                        return MicrosoftGraph::DeviceManagement::UserExperienceAnalyticsBaselines::Item::AppHealthMetrics::AppHealthMetricsRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ...
                    def battery_health_metrics()
                        return MicrosoftGraph::DeviceManagement::UserExperienceAnalyticsBaselines::Item::BatteryHealthMetrics::BatteryHealthMetricsRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ...
                    def best_practices_metrics()
                        return MicrosoftGraph::DeviceManagement::UserExperienceAnalyticsBaselines::Item::BestPracticesMetrics::BestPracticesMetricsRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ...
                    def device_boot_performance_metrics()
                        return MicrosoftGraph::DeviceManagement::UserExperienceAnalyticsBaselines::Item::DeviceBootPerformanceMetrics::DeviceBootPerformanceMetricsRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ...
                    def reboot_analytics_metrics()
                        return MicrosoftGraph::DeviceManagement::UserExperienceAnalyticsBaselines::Item::RebootAnalyticsMetrics::RebootAnalyticsMetricsRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ...
                    def resource_performance_metrics()
                        return MicrosoftGraph::DeviceManagement::UserExperienceAnalyticsBaselines::Item::ResourcePerformanceMetrics::ResourcePerformanceMetricsRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ...
                    def work_from_anywhere_metrics()
                        return MicrosoftGraph::DeviceManagement::UserExperienceAnalyticsBaselines::Item::WorkFromAnywhereMetrics::WorkFromAnywhereMetricsRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ...
                    def initialize(path_parameters, request_adapter)
                        super(path_parameters, request_adapter, "{+baseurl}/deviceManagement/userExperienceAnalyticsBaselines/{userExperienceAnalyticsBaseline%2Did}{?%24expand,%24select}")
                    end
                    ## 
                    ...
                    def get(request_configuration=nil)
                        ...
                        error_mapping = Hash.new
                        error_mapping["XXX"] = lambda {|pn| MicrosoftGraph::Models::ODataErrorsODataError.create_from_discriminator_value(pn) }
                        return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraph::Models::UserExperienceAnalyticsBaseline.create_from_discriminator_value(pn) }, error_mapping)
                    end
                    ## 
                    ...
                    def to_delete_request_information(request_configuration=nil)
                        ...
                        request_info.url_template = '{+baseurl}/deviceManagement/userExperienceAnalyticsBaselines/{userExperienceAnalyticsBaseline%2Did}'
                    ...
                    def with_url(raw_url)
                        ...
                        return UserExperienceAnalyticsBaselineItemRequestBuilder.new(raw_url, @request_adapter)
                    end
