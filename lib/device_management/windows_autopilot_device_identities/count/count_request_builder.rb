...
module MicrosoftGraph::DeviceManagement::WindowsAutopilotDeviceIdentities::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/deviceManagement/windowsAutopilotDeviceIdentities/$count{?%24search,%24filter}"
