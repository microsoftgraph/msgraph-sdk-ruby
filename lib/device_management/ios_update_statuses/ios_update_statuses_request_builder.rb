...
require_relative '../../models/ios_update_device_status'
require_relative '../../models/ios_update_device_status_collection_response'
...
module MicrosoftGraph
    module DeviceManagement
        module IosUpdateStatuses
            ## 
            # Provides operations to manage the iosUpdateStatuses property of the microsoft.graph.deviceManagement entity.
            class IosUpdateStatusesRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def initialize(path_parameters, request_adapter)
                    super(path_parameters, request_adapter, "{+baseurl}/deviceManagement/iosUpdateStatuses{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}")
                end
                ## 
                ## List properties and relationships of the iosUpdateDeviceStatus objects.
                ## @param request_configuration Configuration for the request such as headers, query parameters, and middleware options.
                ## @return a Fiber of ios_update_device_status_collection_response
                ## 
                def get(request_configuration=nil)
                    ...
                    return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraph::Models::IosUpdateDeviceStatusCollectionResponse.create_from_discriminator_value(pn) }, error_mapping)
                end
                ## 
                ...
                def to_post_request_information(body, request_configuration=nil)
                    ...
                    request_info.url_template = '{+baseurl}/deviceManagement/iosUpdateStatuses'
                    request_info.path_parameters = @path_parameters
                ...
                ## @return a ios_update_statuses_request_builder
                ## 
                def with_url(raw_url)
                    raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                    return IosUpdateStatusesRequestBuilder.new(raw_url, @request_adapter)
                end
