        ...
        module ApplePushNotificationCertificate
            module DownloadApplePushNotificationCertificateSigningRequest
                class DownloadApplePushNotificationCertificateSigningRequestgetResponse
                    ...
                    ## @return a download_apple_push_notification_certificate_signing_requestget_response
                    ## 
                    def self.create_from_discriminator_value(parse_node)
                        raise StandardError, 'parse_node cannot be null' if parse_node.nil?
                        return DownloadApplePushNotificationCertificateSigningRequestgetResponse.new
                    end
                    ## 
