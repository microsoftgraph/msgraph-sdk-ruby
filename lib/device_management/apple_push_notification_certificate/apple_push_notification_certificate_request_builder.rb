...
module MicrosoftGraph
    module DeviceManagement
        module ApplePushNotificationCertificate
            ...
            class ApplePushNotificationCertificateRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def initialize(path_parameters, request_adapter)
                    super(path_parameters, request_adapter, "{+baseurl}/deviceManagement/applePushNotificationCertificate{?%24expand,%24select}")
                end
                ## 
                ...
                def to_delete_request_information(request_configuration=nil)
                    ...
                    request_info.url_template = '{+baseurl}/deviceManagement/applePushNotificationCertificate'
                ...
                ## @return a apple_push_notification_certificate_request_builder
                ## 
                def with_url(raw_url)
                    raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                    return ApplePushNotificationCertificateRequestBuilder.new(raw_url, @request_adapter)
                end
