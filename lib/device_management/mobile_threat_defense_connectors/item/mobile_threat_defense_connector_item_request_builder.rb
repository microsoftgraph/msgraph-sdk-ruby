...
module MicrosoftGraph::DeviceManagement::MobileThreatDefenseConnectors::Item
    ## 
    ...
    class MobileThreatDefenseConnectorItemRequestBuilder
        ...
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, mobile_threat_defense_connector_id=)
