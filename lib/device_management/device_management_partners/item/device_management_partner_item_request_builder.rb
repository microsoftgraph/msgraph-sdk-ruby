...
require_relative './microsoft_graph_terminate/microsoft_graph_terminate_request_builder'
            ...
            module Item
                ...
                class DeviceManagementPartnerItemRequestBuilder
                    ...
                    def microsoft_graph_terminate()
                        return MicrosoftGraph::DeviceManagement::DeviceManagementPartners::Item::MicrosoftGraphTerminate::MicrosoftGraphTerminateRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
