...
require_relative '../../models/device_enrollment_configuration_collection_response'
require_relative '../../models/o_data_errors_o_data_error'
require_relative '../device_management'
require_relative './count/count_request_builder'
require_relative './device_enrollment_configurations'
require_relative './item/device_enrollment_configuration_item_request_builder'
...
module MicrosoftGraph
    module DeviceManagement
        module DeviceEnrollmentConfigurations
            ...
            class DeviceEnrollmentConfigurationsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                
                ## 
                # Provides operations to count the resources in the collection.
                def count()
                    return MicrosoftGraph::DeviceManagement::DeviceEnrollmentConfigurations::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                ## Provides operations to manage the deviceEnrollmentConfigurations property of the microsoft.graph.deviceManagement entity.
                ...
                ## 
                def by_device_enrollment_configuration_id(device_enrollment_configuration_id)
                    raise StandardError, 'device_enrollment_configuration_id cannot be null' if device_enrollment_configuration_id.nil?
                ...
                def initialize(path_parameters, request_adapter)
                    super(path_parameters, request_adapter, "{+baseurl}/deviceManagement/deviceEnrollmentConfigurations{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}")
                end
                ## 
                ...
                def to_post_request_information(body, request_configuration=nil)
                    ...
                    request_info.url_template = '{+baseurl}/deviceManagement/deviceEnrollmentConfigurations'
                    request_info.path_parameters = @path_parameters
                ...
                ## @return a device_enrollment_configurations_request_builder
                ## 
                def with_url(raw_url)
                    raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                    return DeviceEnrollmentConfigurationsRequestBuilder.new(raw_url, @request_adapter)
                end
