...
module MicrosoftGraph::DeviceManagement::TermsAndConditions::Item::AcceptanceStatuses::Item
    ## 
    ...
    class TermsAndConditionsAcceptanceStatusItemRequestBuilder
        ...
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, terms_and_conditions_acceptance_status_id=)
