...
module MicrosoftGraph::DeviceManagement::Reports::MicrosoftGraphGetCompliancePolicyNonComplianceReport
    class GetCompliancePolicyNonComplianceReportPostRequestBody
        ...
        ## @return a get_compliance_policy_non_compliance_report_post_request_body
        ## 
        def self.create_from_discriminator_value(parse_node)
            raise StandardError, 'parse_node cannot be null' if parse_node.nil?
            return GetCompliancePolicyNonComplianceReportPostRequestBody.new
        end
        ## 
