...
require_relative './microsoft_graph_get_device_management_intent_per_setting_contributing_profiles'

module MicrosoftGraph::DeviceManagement::Reports::MicrosoftGraphGetDeviceManagementIntentPerSettingContributingProfiles
    class GetDeviceManagementIntentPerSettingContributingProfilesPostRequestBody
        ...
        ## @return a get_device_management_intent_per_setting_contributing_profiles_post_request_body
        ## 
        def self.create_from_discriminator_value(parse_node)
            raise StandardError, 'parse_node cannot be null' if parse_node.nil?
            return GetDeviceManagementIntentPerSettingContributingProfilesPostRequestBody.new
        end
        ## 
