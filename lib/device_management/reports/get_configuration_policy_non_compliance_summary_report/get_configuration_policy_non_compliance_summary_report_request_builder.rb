        ...
        module Reports
            module GetConfigurationPolicyNonComplianceSummaryReport
                ...
                class GetConfigurationPolicyNonComplianceSummaryReportRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    ## @return a get_configuration_policy_non_compliance_summary_report_request_builder
                    ## 
                    def with_url(raw_url)
                        raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                        return GetConfigurationPolicyNonComplianceSummaryReportRequestBuilder.new(raw_url, @request_adapter)
                    end
                end
            end
        end
