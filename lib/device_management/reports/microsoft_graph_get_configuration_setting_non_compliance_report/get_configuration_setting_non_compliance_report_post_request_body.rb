...
require_relative './microsoft_graph_get_configuration_setting_non_compliance_report'

module MicrosoftGraph::DeviceManagement::Reports::MicrosoftGraphGetConfigurationSettingNonComplianceReport
    class GetConfigurationSettingNonComplianceReportPostRequestBody
        ...
        ## @return a get_configuration_setting_non_compliance_report_post_request_body
        ## 
        def self.create_from_discriminator_value(parse_node)
            raise StandardError, 'parse_node cannot be null' if parse_node.nil?
            return GetConfigurationSettingNonComplianceReportPostRequestBody.new
        end
        ## 
