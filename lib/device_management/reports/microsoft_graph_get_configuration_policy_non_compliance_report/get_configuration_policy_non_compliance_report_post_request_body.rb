...
module MicrosoftGraph::DeviceManagement::Reports::MicrosoftGraphGetConfigurationPolicyNonComplianceReport
    class GetConfigurationPolicyNonComplianceReportPostRequestBody
        ...
        ## @return a get_configuration_policy_non_compliance_report_post_request_body
        ## 
        def self.create_from_discriminator_value(parse_node)
            raise StandardError, 'parse_node cannot be null' if parse_node.nil?
            return GetConfigurationPolicyNonComplianceReportPostRequestBody.new
        end
        ## 
