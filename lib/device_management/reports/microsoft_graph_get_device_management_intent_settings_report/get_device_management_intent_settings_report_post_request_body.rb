...
require_relative './microsoft_graph_get_device_management_intent_settings_report'

module MicrosoftGraph::DeviceManagement::Reports::MicrosoftGraphGetDeviceManagementIntentSettingsReport
    class GetDeviceManagementIntentSettingsReportPostRequestBody
        ...
        ## @return a get_device_management_intent_settings_report_post_request_body
        ## 
        def self.create_from_discriminator_value(parse_node)
            raise StandardError, 'parse_node cannot be null' if parse_node.nil?
            return GetDeviceManagementIntentSettingsReportPostRequestBody.new
        end
        ## 
