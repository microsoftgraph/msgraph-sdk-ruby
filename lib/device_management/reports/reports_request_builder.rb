...
require_relative './retrieve_device_app_installation_status_report/retrieve_device_app_installation_status_report_request_builder'
    ...
    module DeviceManagement
        module Reports
            ...
            class ReportsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def retrieve_device_app_installation_status_report()
                    return MicrosoftGraph::DeviceManagement::Reports::RetrieveDeviceAppInstallationStatusReport::RetrieveDeviceAppInstallationStatusReportRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
