...
require_relative '../../../../models/device_management_export_job'
        ...
        module Reports
            module ExportJobs
                module Item
                    ...
                    class DeviceManagementExportJobItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/deviceManagement/reports/exportJobs/{deviceManagementExportJob%2Did}{?%24expand,%24select}")
                        end
                        ## 
                        ...
                        def to_delete_request_information(request_configuration=nil)
                            ...
                            request_info.url_template = '{+baseurl}/deviceManagement/reports/exportJobs/{deviceManagementExportJob%2Did}'
                        ...
                        def with_url(raw_url)
                            ...
                            return DeviceManagementExportJobItemRequestBuilder.new(raw_url, @request_adapter)
                        end
