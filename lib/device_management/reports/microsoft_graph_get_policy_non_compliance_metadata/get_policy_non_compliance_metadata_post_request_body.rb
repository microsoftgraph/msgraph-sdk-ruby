...
require_relative './microsoft_graph_get_policy_non_compliance_metadata'

module MicrosoftGraph::DeviceManagement::Reports::MicrosoftGraphGetPolicyNonComplianceMetadata
    class GetPolicyNonComplianceMetadataPostRequestBody
        ...
        ## @return a get_policy_non_compliance_metadata_post_request_body
        ## 
        def self.create_from_discriminator_value(parse_node)
            raise StandardError, 'parse_node cannot be null' if parse_node.nil?
            return GetPolicyNonComplianceMetadataPostRequestBody.new
        end
        ## 
