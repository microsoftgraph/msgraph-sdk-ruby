...
require_relative './microsoft_graph_get_compliance_setting_non_compliance_report'
...
module MicrosoftGraph::DeviceManagement::Reports::MicrosoftGraphGetComplianceSettingNonComplianceReport
    class GetComplianceSettingNonComplianceReportPostRequestBody
        ...
        ## @return a get_compliance_setting_non_compliance_report_post_request_body
        ## 
        def self.create_from_discriminator_value(parse_node)
            raise StandardError, 'parse_node cannot be null' if parse_node.nil?
            return GetComplianceSettingNonComplianceReportPostRequestBody.new
        end
        ## 
