...
module MicrosoftGraph::DeviceManagement::Reports::MicrosoftGraphGetPolicyNonComplianceSummaryReport
    class GetPolicyNonComplianceSummaryReportPostRequestBody
        ...
        ## @return a get_policy_non_compliance_summary_report_post_request_body
        ## 
        def self.create_from_discriminator_value(parse_node)
            raise StandardError, 'parse_node cannot be null' if parse_node.nil?
            return GetPolicyNonComplianceSummaryReportPostRequestBody.new
        end
        ## 
