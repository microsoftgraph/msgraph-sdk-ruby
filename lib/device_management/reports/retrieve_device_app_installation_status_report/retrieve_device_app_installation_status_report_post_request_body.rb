    ...
    module DeviceManagement
        module Reports
            module RetrieveDeviceAppInstallationStatusReport
                class RetrieveDeviceAppInstallationStatusReportPostRequestBody
                    ...
                    ## 
                    ## Instantiates a new RetrieveDeviceAppInstallationStatusReportPostRequestBody and sets the default values.
                    ## @return a void
                    ## 
                    def initialize()
                    ...
                    ## @return a retrieve_device_app_installation_status_report_post_request_body
                    ## 
                    def self.create_from_discriminator_value(parse_node)
                        raise StandardError, 'parse_node cannot be null' if parse_node.nil?
                        return RetrieveDeviceAppInstallationStatusReportPostRequestBody.new
                    end
                    ## 
