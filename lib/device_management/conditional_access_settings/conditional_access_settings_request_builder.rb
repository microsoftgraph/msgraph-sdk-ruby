...
require_relative '../../models/on_premises_conditional_access_settings'
...
module MicrosoftGraph
    module DeviceManagement
        module ConditionalAccessSettings
            ## 
            # Provides operations to manage the conditionalAccessSettings property of the microsoft.graph.deviceManagement entity.
            class ConditionalAccessSettingsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def initialize(path_parameters, request_adapter)
                    super(path_parameters, request_adapter, "{+baseurl}/deviceManagement/conditionalAccessSettings{?%24expand,%24select}")
                end
                ## 
                ...
                def to_delete_request_information(request_configuration=nil)
                    ...
                    request_info.url_template = '{+baseurl}/deviceManagement/conditionalAccessSettings'
                ...
                ## @return a conditional_access_settings_request_builder
                ## 
                def with_url(raw_url)
                    raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                    return ConditionalAccessSettingsRequestBuilder.new(raw_url, @request_adapter)
                end
