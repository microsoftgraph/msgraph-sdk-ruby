...
require_relative './microsoft_graph_get_effective_permissions_with_scope/microsoft_graph_get_effective_permissions_with_scope_request_builder'
require_relative './microsoft_graph_verify_windows_enrollment_auto_discovery_with_domain_name/microsoft_graph_verify_windows_enrollment_auto_discovery_with_domain_name_request_builder'
...
module MicrosoftGraph::DeviceManagement
    ## 
    ...
    class DeviceManagementRequestBuilder
        ...
        ## @return a microsoft_graph_get_effective_permissions_with_scope_request_builder
        ## 
        def microsoft_graph_get_effective_permissions_with_scope(scope)
            raise StandardError, 'scope cannot be null' if scope.nil?
            return MicrosoftGraphGetEffectivePermissionsWithScopeRequestBuilder.new(@path_parameters, @request_adapter, scope)
        end
        ## 
        ## Provides operations to call the verifyWindowsEnrollmentAutoDiscovery method.
        ## @param domainName Usage: domainName='{domainName}'
        ## @return a microsoft_graph_verify_windows_enrollment_auto_discovery_with_domain_name_request_builder
        ## 
        def microsoft_graph_verify_windows_enrollment_auto_discovery_with_domain_name(domain_name)
            ...
            return MicrosoftGraphVerifyWindowsEnrollmentAutoDiscoveryWithDomainNameRequestBuilder.new(@path_parameters, @request_adapter, domainName)
        end
        ## 
        ## Provides operations to manage the mobileThreatDefenseConnectors property of the microsoft.graph.deviceManagement entity.
        ## @param id Unique identifier of the item
