...
module MicrosoftGraph::DeviceManagement::ComplianceManagementPartners::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/deviceManagement/complianceManagementPartners/$count{?%24search,%24filter}"
