...
module MicrosoftGraph::DeviceManagement::ComplianceManagementPartners::Item
    ## 
    ...
    class ComplianceManagementPartnerItemRequestBuilder
        ...
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, compliance_management_partner_id=)
