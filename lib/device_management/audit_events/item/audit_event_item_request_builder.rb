...
module MicrosoftGraph::DeviceManagement::AuditEvents::Item
    ## 
    ...
    class AuditEventItemRequestBuilder
        ...
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, audit_event_id=nil)
            raise StandardError, 'path_parameters cannot be null' if path_parameters.nil?
            raise StandardError, 'request_adapter cannot be null' if request_adapter.nil?
            @url_template = "{+baseurl}/deviceManagement/auditEvents/{auditEvent%2Did}{?%24select,%24expand}"
