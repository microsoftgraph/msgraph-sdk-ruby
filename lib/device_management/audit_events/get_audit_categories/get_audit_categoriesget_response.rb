    ...
    module DeviceManagement
        module AuditEvents
            module GetAuditCategories
                class GetAuditCategoriesgetResponse < MicrosoftGraph::Models::BaseCollectionPaginationCountResponse
                    ...
                    ## @return a get_audit_categoriesget_response
                    ## 
                    def self.create_from_discriminator_value(parse_node)
                        raise StandardError, 'parse_node cannot be null' if parse_node.nil?
                        return GetAuditCategoriesgetResponse.new
                    end
                    ## 
