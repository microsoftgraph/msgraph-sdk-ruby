...
require_relative '../../models/windows_information_protection_network_learning_summary'
...
module MicrosoftGraph
    module DeviceManagement
        module WindowsInformationProtectionNetworkLearningSummaries
            ## 
            # Provides operations to manage the windowsInformationProtectionNetworkLearningSummaries property of the microsoft.graph.deviceManagement entity.
            class WindowsInformationProtectionNetworkLearningSummariesRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def initialize(path_parameters, request_adapter)
                    super(path_parameters, request_adapter, "{+baseurl}/deviceManagement/windowsInformationProtectionNetworkLearningSummaries{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}")
                end
                ## 
                ...
                ## @return a Fiber of windows_information_protection_network_learning_summary_collection_response
                ## 
                def get(request_configuration=nil)
                    ...
                    return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraph::Models::WindowsInformationProtectionNetworkLearningSummaryCollectionResponse.create_from_discriminator_value(pn) }, error_mapping)
                end
                ## 
                ...
                def to_post_request_information(body, request_configuration=nil)
                    ...
                    request_info.url_template = '{+baseurl}/deviceManagement/windowsInformationProtectionNetworkLearningSummaries'
                    request_info.path_parameters = @path_parameters
                ...
                ## @return a windows_information_protection_network_learning_summaries_request_builder
                ## 
                def with_url(raw_url)
                    raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                    return WindowsInformationProtectionNetworkLearningSummariesRequestBuilder.new(raw_url, @request_adapter)
                end
