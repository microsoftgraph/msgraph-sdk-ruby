...
module MicrosoftGraph::DeviceManagement::WindowsInformationProtectionNetworkLearningSummaries::Item
    ...
    class WindowsInformationProtectionNetworkLearningSummaryItemRequestBuilder
        ...
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, windows_information_protection_network_learning_summary_id=nil)
            raise StandardError, 'path_parameters cannot be null' if path_parameters.nil?
            raise StandardError, 'request_adapter cannot be null' if request_adapter.nil?
            @url_template = "{+baseurl}/deviceManagement/windowsInformationProtectionNetworkLearningSummaries/{windowsInformationProtectionNetworkLearningSummary%2Did}{?%24select,%24expand}"
