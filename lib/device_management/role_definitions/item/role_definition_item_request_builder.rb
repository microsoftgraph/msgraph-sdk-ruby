...
require_relative './role_assignments/item/role_assignment_item_request_builder'
require_relative './role_assignments/role_assignments_request_builder'

module MicrosoftGraph::DeviceManagement::RoleDefinitions::Item
    ## 
    ...
    class RoleDefinitionItemRequestBuilder
        ...
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, role_definition_id=nil)
            raise StandardError, 'path_parameters cannot be null' if path_parameters.nil?
            raise StandardError, 'request_adapter cannot be null' if request_adapter.nil?
            @url_template = "{+baseurl}/deviceManagement/roleDefinitions/{roleDefinition%2Did}{?%24select,%24expand}"
