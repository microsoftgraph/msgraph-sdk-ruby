...
module MicrosoftGraph
    module DeviceManagement
        module ManagedDeviceOverview
            ## 
            # Provides operations to manage the managedDeviceOverview property of the microsoft.graph.deviceManagement entity.
            class ManagedDeviceOverviewRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def initialize(path_parameters, request_adapter)
                    super(path_parameters, request_adapter, "{+baseurl}/deviceManagement/managedDeviceOverview{?%24expand,%24select}")
                end
                ## 
                ## Device overview
                ...
                ## @return a managed_device_overview_request_builder
                ## 
                def with_url(raw_url)
                    raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                    return ManagedDeviceOverviewRequestBuilder.new(raw_url, @request_adapter)
                end
