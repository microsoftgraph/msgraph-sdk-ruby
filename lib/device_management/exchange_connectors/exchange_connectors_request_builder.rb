...
require_relative '../../models/device_management_exchange_connector'
require_relative '../../models/device_management_exchange_connector_collection_response'
...
module MicrosoftGraph
    module DeviceManagement
        module ExchangeConnectors
            ...
            class ExchangeConnectorsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def initialize(path_parameters, request_adapter)
                    super(path_parameters, request_adapter, "{+baseurl}/deviceManagement/exchangeConnectors{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}")
                end
                ## 
                ...
                def to_post_request_information(body, request_configuration=nil)
                    ...
                    request_info.url_template = '{+baseurl}/deviceManagement/exchangeConnectors'
                    request_info.path_parameters = @path_parameters
                ...
                ## @return a exchange_connectors_request_builder
                ## 
                def with_url(raw_url)
                    raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                    return ExchangeConnectorsRequestBuilder.new(raw_url, @request_adapter)
                end
