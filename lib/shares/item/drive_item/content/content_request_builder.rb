                ...
                module Content
                    ...
                    class ContentRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/shares/{sharedDriveItem%2Did}/driveItem/content{?%24format*}")
                        end
                        ## 
                        ...
                        def to_put_request_information(body, request_configuration=nil)
                            ...
                            request_info.url_template = '{+baseurl}/shares/{sharedDriveItem%2Did}/driveItem/content'
                            request_info.path_parameters = @path_parameters
