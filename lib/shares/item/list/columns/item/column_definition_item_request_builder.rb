...
module MicrosoftGraph::Shares::Item::List::Columns::Item
    ## 
    ...
    class ColumnDefinitionItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, column_definition_id=)
            ...
            @url_template = "{+baseurl}/shares/{sharedDriveItem%2Did}/list/columns/{columnDefinition%2Did}{?%24select,%24expand}"
