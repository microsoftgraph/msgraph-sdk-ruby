            ...
            module List
                module Items
                    ...
                    class ItemsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def delta()
                            return MicrosoftGraph::Shares::Item::List::Items::Delta::DeltaRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ## Provides operations to manage the items property of the microsoft.graph.list entity.
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/shares/{sharedDriveItem%2Did}/list/items{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}")
                        end
                        ## 
                        ## Provides operations to call the delta method.
