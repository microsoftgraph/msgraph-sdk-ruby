...
module MicrosoftGraph::Shares::Item::List::Items::Item
    ...
    class ListItemItemRequestBuilder
        ...
        def microsoft_graph_get_activities_by_interval()
            return MicrosoftGraph::Shares::Item::List::Items::Item::MicrosoftGraphGetActivitiesByInterval::MicrosoftGraphGetActivitiesByIntervalRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
