...
module MicrosoftGraph::Shares::Item::List::ContentTypes::Item::ColumnLinks::Item
    ## 
    ...
    class ColumnLinkItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, column_link_id=nil)
            ...
            @url_template = "{+baseurl}/shares/{sharedDriveItem%2Did}/list/contentTypes/{contentType%2Did}/columnLinks/{columnLink%2Did}{?%24select,%24expand}"
