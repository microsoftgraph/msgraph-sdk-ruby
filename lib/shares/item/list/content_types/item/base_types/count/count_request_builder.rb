...
module MicrosoftGraph::Shares::Item::List::ContentTypes::Item::BaseTypes::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/shares/{sharedDriveItem%2Did}/list/contentTypes/{contentType%2Did}/baseTypes/$count{?%24search,%24filter}"
