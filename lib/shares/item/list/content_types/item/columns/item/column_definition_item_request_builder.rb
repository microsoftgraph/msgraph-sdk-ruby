...
module MicrosoftGraph::Shares::Item::List::ContentTypes::Item::Columns::Item
    ## 
    ...
    class ColumnDefinitionItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, column_definition_id=)
            ...
            @url_template = "{+baseurl}/shares/{sharedDriveItem%2Did}/list/contentTypes/{contentType%2Did}/columns/{columnDefinition%2Did}{?%24select,%24expand}"
