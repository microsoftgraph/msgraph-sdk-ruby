        ...
        module Item
            module List
                ...
                class ListRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def columns()
                        return MicrosoftGraph::Shares::Item::List::Columns::ColumnsRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ...
                    def operations()
                        return MicrosoftGraph::Shares::Item::List::Operations::OperationsRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ...
                    def initialize(path_parameters, request_adapter)
                        super(path_parameters, request_adapter, "{+baseurl}/shares/{sharedDriveItem%2Did}/list{?%24expand,%24select}")
                    end
                    ## 
                    ...
                    def to_delete_request_information(request_configuration=nil)
                        ...
                        request_info.url_template = '{+baseurl}/shares/{sharedDriveItem%2Did}/list'
