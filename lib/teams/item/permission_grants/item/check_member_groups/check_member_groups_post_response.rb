            ...
            module PermissionGrants
                module Item
                    module CheckMemberGroups
                        class CheckMemberGroupsPostResponse < MicrosoftGraph::Models::BaseCollectionPaginationCountResponse
                            include MicrosoftKiotaAbstractions::Parsable
                            ## 
                            # The value property
                            @value
                            ## 
                            ## Instantiates a new checkMemberGroupsPostResponse and sets the default values.
                            ## @return a void
                            ## 
                            def initialize()
                                super
                            ...
                            ## @return a check_member_groups_post_response
                            ## 
                            def self.create_from_discriminator_value(parse_node)
                                raise StandardError, 'parse_node cannot be null' if parse_node.nil?
                                return CheckMemberGroupsPostResponse.new
                            end
                            ## 
