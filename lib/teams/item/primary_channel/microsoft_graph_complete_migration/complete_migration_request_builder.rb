...
module MicrosoftGraph::Teams::Item::PrimaryChannel::MicrosoftGraphCompleteMigration
    ## 
    ...
    class CompleteMigrationRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/teams/{team%2Did}/primaryChannel/microsoft.graph.completeMigration"
