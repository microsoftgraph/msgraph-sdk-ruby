...
module MicrosoftGraph::Teams::Item::PrimaryChannel::SharedWithTeams::Item
    ## 
    ...
    class SharedWithChannelTeamInfoItemRequestBuilder
        ...
        def allowed_members()
            return MicrosoftGraph::Teams::Item::PrimaryChannel::SharedWithTeams::Item::AllowedMembers::AllowedMembersRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter, shared_with_channel_team_info_id=)
            ...
            @url_template = "{+baseurl}/teams/{team%2Did}/primaryChannel/sharedWithTeams/{sharedWithChannelTeamInfo%2Did}{?%24select,%24expand}"
