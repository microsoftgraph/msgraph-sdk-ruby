        ...
        module Item
            module PrimaryChannel
                ...
                class PrimaryChannelRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def all_members()
                        return MicrosoftGraph::Teams::Item::PrimaryChannel::AllMembers::AllMembersRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to call the archive method.
                    def archive()
                        return MicrosoftGraph::Teams::Item::PrimaryChannel::Archive::ArchiveRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to call the completeMigration method.
                    def complete_migration()
                        return MicrosoftGraph::Teams::Item::PrimaryChannel::CompleteMigration::CompleteMigrationRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to call the doesUserHaveAccess method.
                    def does_user_have_accessuser_id_user_id_tenant_id_tenant_id_user_principal_name_user_principal_name()
                        return MicrosoftGraph::Teams::Item::PrimaryChannel::DoesUserHaveAccessuserIdUserIdTenantIdTenantIdUserPrincipalNameUserPrincipalName::DoesUserHaveAccessuserIdUserIdTenantIdTenantIdUserPrincipalNameUserPrincipalNameRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ...
                    def provision_email()
                        return MicrosoftGraph::Teams::Item::PrimaryChannel::ProvisionEmail::ProvisionEmailRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to call the removeEmail method.
                    def remove_email()
                        return MicrosoftGraph::Teams::Item::PrimaryChannel::RemoveEmail::RemoveEmailRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ...
                    def unarchive()
                        return MicrosoftGraph::Teams::Item::PrimaryChannel::Unarchive::UnarchiveRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ...
                    def initialize(path_parameters, request_adapter)
                        super(path_parameters, request_adapter, "{+baseurl}/teams/{team%2Did}/primaryChannel{?%24expand,%24select}")
                    end
                    ## 
