...
module MicrosoftGraph::Teams::Item::PrimaryChannel::Messages::Item::Replies
    ## 
    ...
    class RepliesRequestBuilder
        ...
        def microsoft_graph_delta()
            return MicrosoftGraph::Teams::Item::PrimaryChannel::Messages::Item::Replies::MicrosoftGraphDelta::MicrosoftGraphDeltaRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/teams/{team%2Did}/primaryChannel/messages/{chatMessage%2Did}/replies{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
