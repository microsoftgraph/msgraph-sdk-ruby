...
module MicrosoftGraph::Teams::Item::PrimaryChannel::Messages::Item::HostedContents::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/teams/{team%2Did}/primaryChannel/messages/{chatMessage%2Did}/hostedContents/$count{?%24search,%24filter}"
