...
module MicrosoftGraph::Teams::Item::Channels::Item::Tabs::Item
    ## 
    ...
    class TeamsTabItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, teams_tab_id=nil)
            ...
            @url_template = "{+baseurl}/teams/{team%2Did}/channels/{channel%2Did}/tabs/{teamsTab%2Did}{?%24select,%24expand}"
