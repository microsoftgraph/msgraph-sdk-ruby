...
module MicrosoftGraph::Teams::Item::Channels::Item::Members::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/teams/{team%2Did}/channels/{channel%2Did}/members/$count{?%24search,%24filter}"
