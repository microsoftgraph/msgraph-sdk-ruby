...
module MicrosoftGraph::Teams::Item::Channels::Item::SharedWithTeams::Item
    ## 
    ...
    class SharedWithChannelTeamInfoItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, shared_with_channel_team_info_id=)
            ...
            @url_template = "{+baseurl}/teams/{team%2Did}/channels/{channel%2Did}/sharedWithTeams/{sharedWithChannelTeamInfo%2Did}{?%24select,%24expand}"
