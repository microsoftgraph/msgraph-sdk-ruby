...
module MicrosoftGraph::Teams::Item::InstalledApps::Item
    ## 
    ...
    class TeamsAppInstallationItemRequestBuilder
        ...
        def microsoft_graph_upgrade()
            return MicrosoftGraph::Teams::Item::InstalledApps::Item::MicrosoftGraphUpgrade::UpgradeRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter, teams_app_installation_id=)
            ...
            @url_template = "{+baseurl}/teams/{team%2Did}/installedApps/{teamsAppInstallation%2Did}{?%24select,%24expand}"
