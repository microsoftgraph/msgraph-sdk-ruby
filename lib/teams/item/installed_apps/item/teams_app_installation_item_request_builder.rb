            ...
            module InstalledApps
                module Item
                    ...
                    class TeamsAppInstallationItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def teams_app()
                            return MicrosoftGraph::Teams::Item::InstalledApps::Item::TeamsApp::TeamsAppRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/teams/{team%2Did}/installedApps/{teamsAppInstallation%2Did}{?%24expand,%24select}")
                        end
                        ## 
                        ...
                        def to_delete_request_information(request_configuration=nil)
                            ...
                            request_info.url_template = '{+baseurl}/teams/{team%2Did}/installedApps/{teamsAppInstallation%2Did}'
