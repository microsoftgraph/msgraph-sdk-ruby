...
module MicrosoftGraph::Teams::Item::Schedule::OpenShiftChangeRequests::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/teams/{team%2Did}/schedule/openShiftChangeRequests/$count{?%24search,%24filter}"
