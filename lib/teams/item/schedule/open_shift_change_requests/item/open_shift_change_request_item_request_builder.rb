...
module MicrosoftGraph::Teams::Item::Schedule::OpenShiftChangeRequests::Item
    ## 
    ...
    class OpenShiftChangeRequestItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, open_shift_change_request_id=)
            ...
            @url_template = "{+baseurl}/teams/{team%2Did}/schedule/openShiftChangeRequests/{openShiftChangeRequest%2Did}{?%24select,%24expand}"
