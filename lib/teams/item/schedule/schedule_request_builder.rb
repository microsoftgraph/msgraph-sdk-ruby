        ...
        module Item
            module Schedule
                ...
                class ScheduleRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def day_notes()
                        return MicrosoftGraph::Teams::Item::Schedule::DayNotes::DayNotesRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ...
                    def time_cards()
                        return MicrosoftGraph::Teams::Item::Schedule::TimeCards::TimeCardsRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ...
                    def initialize(path_parameters, request_adapter)
                        super(path_parameters, request_adapter, "{+baseurl}/teams/{team%2Did}/schedule{?%24expand,%24select}")
                    end
                    ## 
