...
module MicrosoftGraph::Teams::Item::Schedule::SwapShiftsChangeRequests::Item
    ## 
    ...
    class SwapShiftsChangeRequestItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, swap_shifts_change_request_id=nil)
            ...
            @url_template = "{+baseurl}/teams/{team%2Did}/schedule/swapShiftsChangeRequests/{swapShiftsChangeRequest%2Did}{?%24select,%24expand}"
