            ...
            module Schedule
                module SwapShiftsChangeRequests
                    ...
                    class SwapShiftsChangeRequestsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def count()
                            return MicrosoftGraph::Teams::Item::Schedule::SwapShiftsChangeRequests::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ## Provides operations to manage the swapShiftsChangeRequests property of the microsoft.graph.schedule entity.
                        ...
                        def by_swap_shifts_change_request_id(swap_shifts_change_request_id)
                            ...
                            return MicrosoftGraph::Teams::Item::Schedule::SwapShiftsChangeRequests::Item::SwapShiftsChangeRequestItemRequestBuilder.new(url_tpl_params, @request_adapter)
                        end
                        ## 
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/teams/{team%2Did}/schedule/swapShiftsChangeRequests{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}")
                        end
                        ## 
                        ...
                        def to_post_request_information(body, request_configuration=nil)
                            ...
                            request_info.url_template = '{+baseurl}/teams/{team%2Did}/schedule/swapShiftsChangeRequests'
                            request_info.path_parameters = @path_parameters
