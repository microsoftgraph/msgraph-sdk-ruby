...
module MicrosoftGraph::Teams::Item::Schedule::SwapShiftsChangeRequests::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/teams/{team%2Did}/schedule/swapShiftsChangeRequests/$count{?%24search,%24filter}"
