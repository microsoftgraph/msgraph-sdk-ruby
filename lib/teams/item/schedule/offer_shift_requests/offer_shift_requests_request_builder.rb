            ...
            module Schedule
                module OfferShiftRequests
                    ...
                    class OfferShiftRequestsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def count()
                            return MicrosoftGraph::Teams::Item::Schedule::OfferShiftRequests::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ## Provides operations to manage the offerShiftRequests property of the microsoft.graph.schedule entity.
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/teams/{team%2Did}/schedule/offerShiftRequests{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}")
                        end
                        ## 
                        ...
                        def to_post_request_information(body, request_configuration=nil)
                            ...
                            request_info.url_template = '{+baseurl}/teams/{team%2Did}/schedule/offerShiftRequests'
                            request_info.path_parameters = @path_parameters
