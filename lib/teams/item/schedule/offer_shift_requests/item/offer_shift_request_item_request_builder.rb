...
module MicrosoftGraph::Teams::Item::Schedule::OfferShiftRequests::Item
    ## 
    ...
    class OfferShiftRequestItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, offer_shift_request_id=)
            ...
            @url_template = "{+baseurl}/teams/{team%2Did}/schedule/offerShiftRequests/{offerShiftRequest%2Did}{?%24select,%24expand}"
