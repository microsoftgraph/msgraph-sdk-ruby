...
module MicrosoftGraph::Contacts::Item::DirectReports::User
    ## 
    ...
    class UserRequestBuilder
        ...
        def count()
            return MicrosoftGraph::Contacts::Item::DirectReports::User::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
