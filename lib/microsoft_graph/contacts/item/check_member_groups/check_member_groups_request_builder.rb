...
module MicrosoftGraph::Contacts::Item::CheckMemberGroups
    ...
    class CheckMemberGroupsRequestBuilder
        ...
        def post(body, request_configuration=nil)
            ...
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraph::Contacts::Item::CheckMemberGroups::CheckMemberGroupsResponse.create_from_discriminator_value(pn) }, error_mapping)
        end
