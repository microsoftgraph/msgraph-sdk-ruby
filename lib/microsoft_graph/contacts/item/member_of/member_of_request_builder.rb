...
module MicrosoftGraph::Contacts::Item::MemberOf
    ...
    class MemberOfRequestBuilder
        ...
        def application()
            return MicrosoftGraph::Contacts::Item::MemberOf::Application::ApplicationRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def device()
            return MicrosoftGraph::Contacts::Item::MemberOf::Device::DeviceRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Casts the previous resource to group.
        def group()
            return MicrosoftGraph::Contacts::Item::MemberOf::Group::GroupRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Casts the previous resource to orgContact.
        def org_contact()
            return MicrosoftGraph::Contacts::Item::MemberOf::OrgContact::OrgContactRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def service_principal()
            return MicrosoftGraph::Contacts::Item::MemberOf::ServicePrincipal::ServicePrincipalRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def user()
            return MicrosoftGraph::Contacts::Item::MemberOf::User::UserRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
