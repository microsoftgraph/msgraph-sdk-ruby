...
module MicrosoftGraph::Contacts::Item::MemberOf::Item::OrgContact
    ## 
    ...
    class OrgContactRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/contacts/{orgContact%2Did}/memberOf/{directoryObject%2Did}/microsoft.graph.orgContact{?%24select,%24expand}"
