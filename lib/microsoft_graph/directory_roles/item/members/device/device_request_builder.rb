...
module MicrosoftGraph::DirectoryRoles::Item::Members::Device
    ## 
    ...
    class DeviceRequestBuilder
        ...
        def count()
            return MicrosoftGraph::DirectoryRoles::Item::Members::Device::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
