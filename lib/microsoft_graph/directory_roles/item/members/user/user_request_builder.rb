...
module MicrosoftGraph::DirectoryRoles::Item::Members::User
    ## 
    ...
    class UserRequestBuilder
        ...
        def count()
            return MicrosoftGraph::DirectoryRoles::Item::Members::User::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
