...
module MicrosoftGraph::DirectoryRoles::Item::Members::Item::OrgContact
    ## 
    ...
    class OrgContactRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/directoryRoles/{directoryRole%2Did}/members/{directoryObject%2Did}/microsoft.graph.orgContact{?%24select,%24expand}"
