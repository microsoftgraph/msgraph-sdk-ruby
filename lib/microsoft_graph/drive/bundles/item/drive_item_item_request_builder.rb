...
module MicrosoftGraph::Drive::Bundles::Item
    ## 
    ...
    class DriveItemItemRequestBuilder
        ...
        def content()
            return MicrosoftGraph::Drive::Bundles::Item::Content::ContentRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/drive/bundles/{driveItem%2Did}{?%24select,%24expand}"
