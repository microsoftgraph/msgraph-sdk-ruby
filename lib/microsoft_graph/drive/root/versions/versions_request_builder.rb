...
module MicrosoftGraph::Drive::Root::Versions
    ## 
    ...
    class VersionsRequestBuilder
        ...
        def count()
            return MicrosoftGraph::Drive::Root::Versions::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/drive/root/versions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
