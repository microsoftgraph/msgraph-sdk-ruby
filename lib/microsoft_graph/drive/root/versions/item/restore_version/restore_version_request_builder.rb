...
module MicrosoftGraph::Drive::Root::Versions::Item::RestoreVersion
    ## 
    ...
    class RestoreVersionRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/drive/root/versions/{driveItemVersion%2Did}/microsoft.graph.restoreVersion"
