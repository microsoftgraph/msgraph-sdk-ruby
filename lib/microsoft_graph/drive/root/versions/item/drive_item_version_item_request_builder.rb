...
module MicrosoftGraph::Drive::Root::Versions::Item
    ## 
    ...
    class DriveItemVersionItemRequestBuilder
        ...
        def content()
            return MicrosoftGraph::Drive::Root::Versions::Item::Content::ContentRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def restore_version()
            return MicrosoftGraph::Drive::Root::Versions::Item::RestoreVersion::RestoreVersionRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/drive/root/versions/{driveItemVersion%2Did}{?%24select,%24expand}"
