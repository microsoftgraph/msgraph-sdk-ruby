...
module MicrosoftGraph::Drive::Root::ListItem::DocumentSetVersions::Item::Restore
    ## 
    ...
    class RestoreRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/drive/root/listItem/documentSetVersions/{documentSetVersion%2Did}/microsoft.graph.restore"
