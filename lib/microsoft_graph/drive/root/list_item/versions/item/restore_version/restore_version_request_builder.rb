...
module MicrosoftGraph::Drive::Root::ListItem::Versions::Item::RestoreVersion
    ## 
    ...
    class RestoreVersionRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/drive/root/listItem/versions/{listItemVersion%2Did}/microsoft.graph.restoreVersion"
