...
module MicrosoftGraph::Drive::Root::Permissions
    ## 
    ...
    class PermissionsRequestBuilder
        ...
        def count()
            return MicrosoftGraph::Drive::Root::Permissions::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/drive/root/permissions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
