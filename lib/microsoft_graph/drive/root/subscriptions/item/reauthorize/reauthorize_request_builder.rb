...
module MicrosoftGraph::Drive::Root::Subscriptions::Item::Reauthorize
    ## 
    ...
    class ReauthorizeRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/drive/root/subscriptions/{subscription%2Did}/microsoft.graph.reauthorize"
