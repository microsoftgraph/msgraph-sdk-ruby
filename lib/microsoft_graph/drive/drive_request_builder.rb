...
module MicrosoftGraph::Drive
    ...
    class DriveRequestBuilder
        ...
        def bundles()
            return MicrosoftGraph::Drive::Bundles::BundlesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the following property of the microsoft.graph.drive entity.
        def following()
            return MicrosoftGraph::Drive::Following::FollowingRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the items property of the microsoft.graph.drive entity.
        def items()
            return MicrosoftGraph::Drive::Items::ItemsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the list property of the microsoft.graph.drive entity.
        def list()
            return MicrosoftGraph::Drive::List::ListRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def root()
            return MicrosoftGraph::Drive::Root::RootRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the special property of the microsoft.graph.drive entity.
        def special()
            return MicrosoftGraph::Drive::Special::SpecialRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def bundles_by_id(id)
            ...
            return MicrosoftGraph::Drive::Bundles::Item::DriveItemItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/drive{?%24select,%24expand}"
        ...
        def following_by_id(id)
            ...
            url_tpl_params = @path_parameters.clone
            url_tpl_params["driveItem%2Did"] = id
            return MicrosoftGraph::Drive::Following::Item::DriveItemItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Get drive
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ...
        def items_by_id(id)
            ...
            url_tpl_params = @path_parameters.clone
            url_tpl_params["driveItem%2Did"] = id
            return MicrosoftGraph::Drive::Items::Item::DriveItemItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Update drive
        ## @param body The request body
        ...
        def special_by_id(id)
            ...
            url_tpl_params = @path_parameters.clone
            url_tpl_params["driveItem%2Did"] = id
            return MicrosoftGraph::Drive::Special::Item::DriveItemItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
