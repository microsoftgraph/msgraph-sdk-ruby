...
module MicrosoftGraph::Drive::Special
    ## 
    ...
    class SpecialRequestBuilder
        ...
        def count()
            return MicrosoftGraph::Drive::Special::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/drive/special{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
