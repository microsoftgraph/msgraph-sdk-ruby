...
module MicrosoftGraph::Drive::Items::Item::ListItem::Versions
    ## 
    ...
    class VersionsRequestBuilder
        ...
        def count()
            return MicrosoftGraph::Drive::Items::Item::ListItem::Versions::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/drive/items/{driveItem%2Did}/listItem/versions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
