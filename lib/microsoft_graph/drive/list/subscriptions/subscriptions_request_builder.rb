...
module MicrosoftGraph::Drive::List::Subscriptions
    ## 
    ...
    class SubscriptionsRequestBuilder
        ...
        def count()
            return MicrosoftGraph::Drive::List::Subscriptions::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/drive/list/subscriptions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
