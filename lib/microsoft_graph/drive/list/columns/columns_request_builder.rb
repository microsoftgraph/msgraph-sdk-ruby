...
module MicrosoftGraph::Drive::List::Columns
    ## 
    ...
    class ColumnsRequestBuilder
        ...
        def count()
            return MicrosoftGraph::Drive::List::Columns::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/drive/list/columns{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
