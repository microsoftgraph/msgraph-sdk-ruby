...
module MicrosoftGraph::Drive::List::Columns::Item
    ## 
    ...
    class ColumnDefinitionItemRequestBuilder
        ...
        def source_column()
            return MicrosoftGraph::Drive::List::Columns::Item::SourceColumn::SourceColumnRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/drive/list/columns/{columnDefinition%2Did}{?%24select,%24expand}"
