...
module MicrosoftGraph::Drive::List::ContentTypes::Item::Columns
    ## 
    ...
    class ColumnsRequestBuilder
        ...
        def count()
            return MicrosoftGraph::Drive::List::ContentTypes::Item::Columns::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/drive/list/contentTypes/{contentType%2Did}/columns{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
