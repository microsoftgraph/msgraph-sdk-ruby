...
module MicrosoftGraph::Drive::List::ContentTypes::Item::ColumnPositions::Item
    ## 
    ...
    class ColumnDefinitionItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/drive/list/contentTypes/{contentType%2Did}/columnPositions/{columnDefinition%2Did}{?%24select,%24expand}"
