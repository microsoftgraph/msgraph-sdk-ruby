...
module MicrosoftGraph::Drive::List::ContentTypes::Item::ColumnLinks::Item
    ## 
    ...
    class ColumnLinkItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/drive/list/contentTypes/{contentType%2Did}/columnLinks/{columnLink%2Did}{?%24select,%24expand}"
