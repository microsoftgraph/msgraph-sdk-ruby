...
module MicrosoftGraph::Drive::List::ContentTypes::Item::BaseTypes::Item
    ## 
    ...
    class ContentTypeItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/drive/list/contentTypes/{contentType%2Did}/baseTypes/{contentType%2Did1}{?%24select,%24expand}"
