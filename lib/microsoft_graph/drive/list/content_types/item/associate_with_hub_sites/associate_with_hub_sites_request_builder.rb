...
module MicrosoftGraph::Drive::List::ContentTypes::Item::AssociateWithHubSites
    ## 
    ...
    class AssociateWithHubSitesRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/drive/list/contentTypes/{contentType%2Did}/microsoft.graph.associateWithHubSites"
