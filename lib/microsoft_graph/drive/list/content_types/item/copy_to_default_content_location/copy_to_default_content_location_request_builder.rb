...
module MicrosoftGraph::Drive::List::ContentTypes::Item::CopyToDefaultContentLocation
    ## 
    ...
    class CopyToDefaultContentLocationRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/drive/list/contentTypes/{contentType%2Did}/microsoft.graph.copyToDefaultContentLocation"
