...
module MicrosoftGraph::Drive::List::Items::Item::DocumentSetVersions::Item
    ## 
    ...
    class DocumentSetVersionItemRequestBuilder
        ...
        def restore()
            return MicrosoftGraph::Drive::List::Items::Item::DocumentSetVersions::Item::Restore::RestoreRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/drive/list/items/{listItem%2Did}/documentSetVersions/{documentSetVersion%2Did}{?%24select,%24expand}"
