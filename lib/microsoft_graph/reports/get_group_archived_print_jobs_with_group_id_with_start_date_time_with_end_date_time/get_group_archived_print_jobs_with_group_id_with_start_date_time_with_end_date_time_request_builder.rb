...
module MicrosoftGraph::Reports::GetGroupArchivedPrintJobsWithGroupIdWithStartDateTimeWithEndDateTime
    ...
    class GetGroupArchivedPrintJobsWithGroupIdWithStartDateTimeWithEndDateTimeRequestBuilder
        ...
        ## Invoke function getGroupArchivedPrintJobs
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of get_group_archived_print_jobs_with_group_id_with_start_date_time_with_end_date_time_response
        ## 
        def get(request_configuration=nil)
            ...
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraph::Reports::GetGroupArchivedPrintJobsWithGroupIdWithStartDateTimeWithEndDateTime::GetGroupArchivedPrintJobsWithGroupIdWithStartDateTimeWithEndDateTimeResponse.create_from_discriminator_value(pn) }, error_mapping)
        end
