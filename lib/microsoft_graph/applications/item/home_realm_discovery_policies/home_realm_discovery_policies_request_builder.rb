...
module MicrosoftGraph::Applications::Item::HomeRealmDiscoveryPolicies
    ## 
    ...
    class HomeRealmDiscoveryPoliciesRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/applications/{application%2Did}/homeRealmDiscoveryPolicies{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
