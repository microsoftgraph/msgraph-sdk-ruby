...
module MicrosoftGraph::Applications::Item::Owners::Item
    ...
    class DirectoryObjectItemRequestBuilder
        ...
        def app_role_assignment()
            return MicrosoftGraph::Applications::Item::Owners::Item::AppRoleAssignment::AppRoleAssignmentRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Casts the previous resource to endpoint.
        def endpoint()
            return MicrosoftGraph::Applications::Item::Owners::Item::Endpoint::EndpointRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def service_principal()
            return MicrosoftGraph::Applications::Item::Owners::Item::ServicePrincipal::ServicePrincipalRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def user()
            return MicrosoftGraph::Applications::Item::Owners::Item::User::UserRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
