...
module MicrosoftGraph::Applications::Item::Owners::Item::User
    ## 
    ...
    class UserRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/applications/{application%2Did}/owners/{directoryObject%2Did}/microsoft.graph.user{?%24select,%24expand}"
