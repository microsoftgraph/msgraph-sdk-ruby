...
module MicrosoftGraph::Applications::Item::Owners::User
    ## 
    ...
    class UserRequestBuilder
        ...
        def count()
            return MicrosoftGraph::Applications::Item::Owners::User::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
