...
module MicrosoftGraph::Applications::Item::GetMemberObjects
    ## 
    ...
    class GetMemberObjectsRequestBuilder
        ...
        def post(body, request_configuration=nil)
            ...
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraph::Applications::Item::GetMemberObjects::GetMemberObjectsResponse.create_from_discriminator_value(pn) }, error_mapping)
        end
