...
module MicrosoftGraph::DeviceManagement::ApplePushNotificationCertificate
    ...
    class ApplePushNotificationCertificateRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/deviceManagement/applePushNotificationCertificate{?%24select,%24expand}"
        ...
        ## Apple push notification certificate.
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of apple_push_notification_certificate
        ## 
