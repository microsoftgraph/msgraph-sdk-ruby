...
module MicrosoftGraph::DeviceManagement::WindowsInformationProtectionNetworkLearningSummaries
    ...
    class WindowsInformationProtectionNetworkLearningSummariesRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/deviceManagement/windowsInformationProtectionNetworkLearningSummaries{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
        ...
        ## The windows information protection network learning summaries.
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of windows_information_protection_network_learning_summary_collection_response
        ## 
        ...
        ## @param body The request body
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of windows_information_protection_network_learning_summary
        ## 
