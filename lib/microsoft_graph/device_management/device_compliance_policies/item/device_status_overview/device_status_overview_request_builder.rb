...
module MicrosoftGraph::DeviceManagement::DeviceCompliancePolicies::Item::DeviceStatusOverview
    ## 
    ...
    class DeviceStatusOverviewRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/deviceManagement/deviceCompliancePolicies/{deviceCompliancePolicy%2Did}/deviceStatusOverview{?%24select,%24expand}"
        ...
        ## Device compliance devices status overview
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of device_compliance_device_overview
        ## 
