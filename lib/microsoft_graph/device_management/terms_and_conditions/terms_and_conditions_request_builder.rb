...
module MicrosoftGraph::DeviceManagement::TermsAndConditions
    ## 
    ...
    class TermsAndConditionsRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/deviceManagement/termsAndConditions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
        ...
        ## The terms and conditions associated with device management of the company.
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of terms_and_conditions_collection_response
        ## 
