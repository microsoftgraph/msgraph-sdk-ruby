...
module MicrosoftGraph::DeviceManagement::DeviceCompliancePolicyDeviceStateSummary
    ...
    class DeviceCompliancePolicyDeviceStateSummaryRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/deviceManagement/deviceCompliancePolicyDeviceStateSummary{?%24select,%24expand}"
        ...
        ## The device compliance state summary for this account.
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of device_compliance_policy_device_state_summary
        ## 
