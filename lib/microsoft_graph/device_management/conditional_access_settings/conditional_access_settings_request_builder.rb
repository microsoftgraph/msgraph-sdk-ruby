...
module MicrosoftGraph::DeviceManagement::ConditionalAccessSettings
    ...
    class ConditionalAccessSettingsRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/deviceManagement/conditionalAccessSettings{?%24select,%24expand}"
        ...
        ## The Exchange on premises conditional access settings. On premises conditional access will require devices to be both enrolled and compliant for mail access
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of on_premises_conditional_access_settings
        ## 
