...
module MicrosoftGraph::DeviceManagement::TroubleshootingEvents::Item
    ## 
    ...
    class DeviceManagementTroubleshootingEventItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/deviceManagement/troubleshootingEvents/{deviceManagementTroubleshootingEvent%2Did}{?%24select,%24expand}"
