...
module MicrosoftGraph::DeviceManagement::DeviceCompliancePolicySettingStateSummaries
    ...
    class DeviceCompliancePolicySettingStateSummariesRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/deviceManagement/deviceCompliancePolicySettingStateSummaries{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
        ...
        ## The summary states of compliance policy settings for this account.
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of device_compliance_policy_setting_state_summary_collection_response
        ## 
        ...
        ## @param body The request body
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of device_compliance_policy_setting_state_summary
        ## 
