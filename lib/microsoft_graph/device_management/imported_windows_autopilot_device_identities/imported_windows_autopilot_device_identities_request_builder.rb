...
module MicrosoftGraph::DeviceManagement::ImportedWindowsAutopilotDeviceIdentities
    ...
    class ImportedWindowsAutopilotDeviceIdentitiesRequestBuilder
        ...
        ## Collection of imported Windows autopilot devices.
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of imported_windows_autopilot_device_identity_collection_response
        ## 
        ...
        ## @param body The request body
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of imported_windows_autopilot_device_identity
        ## 
