...
module MicrosoftGraph::DeviceManagement::ManagedDevices
    ## 
    ...
    class ManagedDevicesRequestBuilder
        ...
        def count()
            return MicrosoftGraph::DeviceManagement::ManagedDevices::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
