...
module MicrosoftGraph::DeviceManagement::ManagedDevices::Item::Users
    ## 
    ...
    class UsersRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/deviceManagement/managedDevices/{managedDevice%2Did}/users{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
