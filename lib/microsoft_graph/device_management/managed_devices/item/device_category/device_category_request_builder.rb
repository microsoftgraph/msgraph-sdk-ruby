...
module MicrosoftGraph::DeviceManagement::ManagedDevices::Item::DeviceCategory
    ## 
    ...
    class DeviceCategoryRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/deviceManagement/managedDevices/{managedDevice%2Did}/deviceCategory{?%24select,%24expand}"
