...
module MicrosoftGraph::DeviceManagement::ManagedDeviceOverview
    ## 
    ...
    class ManagedDeviceOverviewRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/deviceManagement/managedDeviceOverview{?%24select,%24expand}"
        ...
        ## Device overview
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of managed_device_overview
        ## 
