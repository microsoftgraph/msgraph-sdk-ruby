...
module MicrosoftGraph::DeviceManagement::RoleDefinitions::Item::RoleAssignments
    ## 
    ...
    class RoleAssignmentsRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/deviceManagement/roleDefinitions/{roleDefinition%2Did}/roleAssignments{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
        ...
        ## List of Role assignments for this role definition.
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of role_assignment_collection_response
        ## 
