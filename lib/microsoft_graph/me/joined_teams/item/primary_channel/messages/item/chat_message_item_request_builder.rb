...
module MicrosoftGraph::Me::JoinedTeams::Item::PrimaryChannel::Messages::Item
    ...
    class ChatMessageItemRequestBuilder
        ...
        def soft_delete()
            return MicrosoftGraph::Me::JoinedTeams::Item::PrimaryChannel::Messages::Item::SoftDelete::SoftDeleteRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the undoSoftDelete method.
        def undo_soft_delete()
            return MicrosoftGraph::Me::JoinedTeams::Item::PrimaryChannel::Messages::Item::UndoSoftDelete::UndoSoftDeleteRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
