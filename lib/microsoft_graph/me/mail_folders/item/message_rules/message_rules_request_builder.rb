...
module MicrosoftGraph::Me::MailFolders::Item::MessageRules
    ## 
    ...
    class MessageRulesRequestBuilder
        ...
        def count()
            return MicrosoftGraph::Me::MailFolders::Item::MessageRules::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/mailFolders/{mailFolder%2Did}/messageRules{?%24top,%24skip,%24filter,%24count,%24orderby,%24select}"
