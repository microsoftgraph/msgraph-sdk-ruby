...
module MicrosoftGraph::Me::MailFolders::Item::Messages::Item
    ...
    class MessageItemRequestBuilder
        ...
        def copy()
            return MicrosoftGraph::Me::MailFolders::Item::Messages::Item::Copy::CopyRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the createForward method.
        def create_forward()
            return MicrosoftGraph::Me::MailFolders::Item::Messages::Item::CreateForward::CreateForwardRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the createReply method.
        def create_reply()
            return MicrosoftGraph::Me::MailFolders::Item::Messages::Item::CreateReply::CreateReplyRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the createReplyAll method.
        def create_reply_all()
            return MicrosoftGraph::Me::MailFolders::Item::Messages::Item::CreateReplyAll::CreateReplyAllRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def forward()
            return MicrosoftGraph::Me::MailFolders::Item::Messages::Item::Forward::ForwardRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the move method.
        def move()
            return MicrosoftGraph::Me::MailFolders::Item::Messages::Item::Move::MoveRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def reply()
            return MicrosoftGraph::Me::MailFolders::Item::Messages::Item::Reply::ReplyRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the replyAll method.
        def reply_all()
            return MicrosoftGraph::Me::MailFolders::Item::Messages::Item::ReplyAll::ReplyAllRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def send()
            return MicrosoftGraph::Me::MailFolders::Item::Messages::Item::Send::SendRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
