...
module MicrosoftGraph::Me::MailFolders::Item::ChildFolders::Item::Messages::Item::Value
    ## 
    ...
    class ContentRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/mailFolders/{mailFolder%2Did}/childFolders/{mailFolder%2Did1}/messages/{message%2Did}/$value"
