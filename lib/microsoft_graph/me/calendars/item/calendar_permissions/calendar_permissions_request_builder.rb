...
module MicrosoftGraph::Me::Calendars::Item::CalendarPermissions
    ## 
    ...
    class CalendarPermissionsRequestBuilder
        ...
        def count()
            return MicrosoftGraph::Me::Calendars::Item::CalendarPermissions::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/calendars/{calendar%2Did}/calendarPermissions{?%24top,%24skip,%24filter,%24count,%24orderby,%24select}"
