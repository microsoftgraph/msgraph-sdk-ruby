...
module MicrosoftGraph::Me::Calendars::Item::Events::Item
    ...
    class EventItemRequestBuilder
        ...
        def accept()
            return MicrosoftGraph::Me::Calendars::Item::Events::Item::Accept::AcceptRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def cancel()
            return MicrosoftGraph::Me::Calendars::Item::Events::Item::Cancel::CancelRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the decline method.
        def decline()
            return MicrosoftGraph::Me::Calendars::Item::Events::Item::Decline::DeclineRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the dismissReminder method.
        def dismiss_reminder()
            return MicrosoftGraph::Me::Calendars::Item::Events::Item::DismissReminder::DismissReminderRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def forward()
            return MicrosoftGraph::Me::Calendars::Item::Events::Item::Forward::ForwardRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def snooze_reminder()
            return MicrosoftGraph::Me::Calendars::Item::Events::Item::SnoozeReminder::SnoozeReminderRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
