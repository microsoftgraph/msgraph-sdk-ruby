...
module MicrosoftGraph::Me::Calendars
    ## 
    ...
    class CalendarsRequestBuilder
        ...
        def count()
            return MicrosoftGraph::Me::Calendars::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/calendars{?%24top,%24skip,%24filter,%24count,%24orderby,%24select}"
        ...
        ## Get all the user's calendars (`/calendars` navigation property), get the calendars from the default calendar group or from a specific calendar group. 
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of calendar_collection_response
        ## 
