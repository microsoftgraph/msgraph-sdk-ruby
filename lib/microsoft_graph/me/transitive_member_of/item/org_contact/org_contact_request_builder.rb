...
module MicrosoftGraph::Me::TransitiveMemberOf::Item::OrgContact
    ## 
    ...
    class OrgContactRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/transitiveMemberOf/{directoryObject%2Did}/microsoft.graph.orgContact{?%24select,%24expand}"
