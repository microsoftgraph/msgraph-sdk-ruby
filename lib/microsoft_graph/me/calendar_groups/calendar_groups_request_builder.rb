...
module MicrosoftGraph::Me::CalendarGroups
    ## 
    ...
    class CalendarGroupsRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/calendarGroups{?%24top,%24skip,%24filter,%24count,%24orderby,%24select}"
        ...
        ## Get the user's calendar groups.
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of calendar_group_collection_response
        ## 
        ...
        ## @param body The request body
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of calendar_group
        ## 
