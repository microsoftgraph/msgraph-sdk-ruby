...
module MicrosoftGraph::Me::ContactFolders::Delta
    ## 
    ...
    class DeltaRequestBuilder
        ...
        def get(request_configuration=nil)
            ...
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraph::Me::ContactFolders::Delta::DeltaResponse.create_from_discriminator_value(pn) }, error_mapping)
        end
