...
module MicrosoftGraph::Me::Drives::Item::Root::Invite
    ## 
    ...
    class InviteRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/drives/{drive%2Did}/root/microsoft.graph.invite"
        ...
        def post(body, request_configuration=nil)
            ...
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraph::Me::Drives::Item::Root::Invite::InviteResponse.create_from_discriminator_value(pn) }, error_mapping)
        end
