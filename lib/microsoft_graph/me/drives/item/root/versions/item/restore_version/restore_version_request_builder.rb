...
module MicrosoftGraph::Me::Drives::Item::Root::Versions::Item::RestoreVersion
    ## 
    ...
    class RestoreVersionRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/drives/{drive%2Did}/root/versions/{driveItemVersion%2Did}/microsoft.graph.restoreVersion"
