...
module MicrosoftGraph::Me::Drives::Item::Root::Versions::Item
    ## 
    ...
    class DriveItemVersionItemRequestBuilder
        ...
        def content()
            return MicrosoftGraph::Me::Drives::Item::Root::Versions::Item::Content::ContentRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def restore_version()
            return MicrosoftGraph::Me::Drives::Item::Root::Versions::Item::RestoreVersion::RestoreVersionRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/drives/{drive%2Did}/root/versions/{driveItemVersion%2Did}{?%24select,%24expand}"
