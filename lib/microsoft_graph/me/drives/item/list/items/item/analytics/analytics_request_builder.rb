...
module MicrosoftGraph::Me::Drives::Item::List::Items::Item::Analytics
    ## 
    ...
    class AnalyticsRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/drives/{drive%2Did}/list/items/{listItem%2Did}/analytics{?%24select,%24expand}"
