...
module MicrosoftGraph::Me::Drives::Item::List::Items::Item::Versions::Item
    ## 
    ...
    class ListItemVersionItemRequestBuilder
        ...
        def fields()
            return MicrosoftGraph::Me::Drives::Item::List::Items::Item::Versions::Item::Fields::FieldsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def restore_version()
            return MicrosoftGraph::Me::Drives::Item::List::Items::Item::Versions::Item::RestoreVersion::RestoreVersionRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/drives/{drive%2Did}/list/items/{listItem%2Did}/versions/{listItemVersion%2Did}{?%24select,%24expand}"
