...
module MicrosoftGraph::Me::Drives::Item::List::ContentTypes::Item::AssociateWithHubSites
    ## 
    ...
    class AssociateWithHubSitesRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/drives/{drive%2Did}/list/contentTypes/{contentType%2Did}/microsoft.graph.associateWithHubSites"
