...
module MicrosoftGraph::Me::Drives::Item::List::ContentTypes::Item::Columns::Item::SourceColumn
    ## 
    ...
    class SourceColumnRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/drives/{drive%2Did}/list/contentTypes/{contentType%2Did}/columns/{columnDefinition%2Did}/sourceColumn{?%24select,%24expand}"
