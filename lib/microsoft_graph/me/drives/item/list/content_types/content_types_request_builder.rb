...
module MicrosoftGraph::Me::Drives::Item::List::ContentTypes
    ## 
    ...
    class ContentTypesRequestBuilder
        ...
        def add_copy()
            return MicrosoftGraph::Me::Drives::Item::List::ContentTypes::AddCopy::AddCopyRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the addCopyFromContentTypeHub method.
        def add_copy_from_content_type_hub()
            return MicrosoftGraph::Me::Drives::Item::List::ContentTypes::AddCopyFromContentTypeHub::AddCopyFromContentTypeHubRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to count the resources in the collection.
        def count()
            return MicrosoftGraph::Me::Drives::Item::List::ContentTypes::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/drives/{drive%2Did}/list/contentTypes{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
