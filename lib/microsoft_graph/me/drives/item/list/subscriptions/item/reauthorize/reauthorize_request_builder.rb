...
module MicrosoftGraph::Me::Drives::Item::List::Subscriptions::Item::Reauthorize
    ## 
    ...
    class ReauthorizeRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/drives/{drive%2Did}/list/subscriptions/{subscription%2Did}/microsoft.graph.reauthorize"
