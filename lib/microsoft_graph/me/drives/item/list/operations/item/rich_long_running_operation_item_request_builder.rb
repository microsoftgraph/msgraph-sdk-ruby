...
module MicrosoftGraph::Me::Drives::Item::List::Operations::Item
    ## 
    ...
    class RichLongRunningOperationItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/drives/{drive%2Did}/list/operations/{richLongRunningOperation%2Did}{?%24select,%24expand}"
