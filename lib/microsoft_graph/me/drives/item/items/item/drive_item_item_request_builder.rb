...
module MicrosoftGraph::Me::Drives::Item::Items::Item
    ## 
    ...
    class DriveItemItemRequestBuilder
        ...
        def analytics()
            return MicrosoftGraph::Me::Drives::Item::Items::Item::Analytics::AnalyticsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the checkin method.
        def checkin()
            return MicrosoftGraph::Me::Drives::Item::Items::Item::Checkin::CheckinRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the checkout method.
        def checkout()
            return MicrosoftGraph::Me::Drives::Item::Items::Item::Checkout::CheckoutRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the children property of the microsoft.graph.driveItem entity.
        def children()
            return MicrosoftGraph::Me::Drives::Item::Items::Item::Children::ChildrenRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the media for the user entity.
        def content()
            return MicrosoftGraph::Me::Drives::Item::Items::Item::Content::ContentRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the copy method.
        def copy()
            return MicrosoftGraph::Me::Drives::Item::Items::Item::Copy::CopyRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the createLink method.
        def create_link()
            return MicrosoftGraph::Me::Drives::Item::Items::Item::CreateLink::CreateLinkRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the createUploadSession method.
        def create_upload_session()
            return MicrosoftGraph::Me::Drives::Item::Items::Item::CreateUploadSession::CreateUploadSessionRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the follow method.
        def follow()
            return MicrosoftGraph::Me::Drives::Item::Items::Item::Follow::FollowRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the invite method.
        def invite()
            return MicrosoftGraph::Me::Drives::Item::Items::Item::Invite::InviteRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the listItem property of the microsoft.graph.driveItem entity.
        def list_item()
            return MicrosoftGraph::Me::Drives::Item::Items::Item::ListItem::ListItemRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def permissions()
            return MicrosoftGraph::Me::Drives::Item::Items::Item::Permissions::PermissionsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the preview method.
        def preview()
            return MicrosoftGraph::Me::Drives::Item::Items::Item::Preview::PreviewRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def restore()
            return MicrosoftGraph::Me::Drives::Item::Items::Item::Restore::RestoreRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the subscriptions property of the microsoft.graph.driveItem entity.
        def subscriptions()
            return MicrosoftGraph::Me::Drives::Item::Items::Item::Subscriptions::SubscriptionsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the thumbnails property of the microsoft.graph.driveItem entity.
        def thumbnails()
            return MicrosoftGraph::Me::Drives::Item::Items::Item::Thumbnails::ThumbnailsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the unfollow method.
        def unfollow()
            return MicrosoftGraph::Me::Drives::Item::Items::Item::Unfollow::UnfollowRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def validate_permission()
            return MicrosoftGraph::Me::Drives::Item::Items::Item::ValidatePermission::ValidatePermissionRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the versions property of the microsoft.graph.driveItem entity.
        def versions()
            return MicrosoftGraph::Me::Drives::Item::Items::Item::Versions::VersionsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ## Provides operations to manage the children property of the microsoft.graph.driveItem entity.
        ...
        def children_by_id(id)
            ...
            return MicrosoftGraph::Me::Drives::Item::Items::Item::Children::Item::DriveItemItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/drives/{drive%2Did}/items/{driveItem%2Did}{?%24select,%24expand}"
        ...
        def permissions_by_id(id)
            ...
            return MicrosoftGraph::Me::Drives::Item::Items::Item::Permissions::Item::PermissionItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def subscriptions_by_id(id)
            ...
            return MicrosoftGraph::Me::Drives::Item::Items::Item::Subscriptions::Item::SubscriptionItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the thumbnails property of the microsoft.graph.driveItem entity.
        ## @param id Unique identifier of the item
        ...
        def thumbnails_by_id(id)
            ...
            return MicrosoftGraph::Me::Drives::Item::Items::Item::Thumbnails::Item::ThumbnailSetItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the versions property of the microsoft.graph.driveItem entity.
        ## @param id Unique identifier of the item
        ...
        def versions_by_id(id)
            ...
            return MicrosoftGraph::Me::Drives::Item::Items::Item::Versions::Item::DriveItemVersionItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
