...
module MicrosoftGraph::Me::Drives::Item::Items::Item::DeltaWithToken
    ...
    class DeltaWithTokenRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, token=nil)
            ...
            @url_template = "{+baseurl}/me/drives/{drive%2Did}/items/{driveItem%2Did}/microsoft.graph.delta(token='{token}'){?%24top,%24skip,%24search,%24filter,%24count,%24select,%24orderby}"
        ...
        def get(request_configuration=nil)
            ...
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraph::Me::Drives::Item::Items::Item::DeltaWithToken::DeltaWithTokenResponse.create_from_discriminator_value(pn) }, error_mapping)
        end
