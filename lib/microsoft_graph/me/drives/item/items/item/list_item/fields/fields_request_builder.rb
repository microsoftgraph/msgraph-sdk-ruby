...
module MicrosoftGraph::Me::Drives::Item::Items::Item::ListItem::Fields
    ## 
    ...
    class FieldsRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/drives/{drive%2Did}/items/{driveItem%2Did}/listItem/fields{?%24select,%24expand}"
