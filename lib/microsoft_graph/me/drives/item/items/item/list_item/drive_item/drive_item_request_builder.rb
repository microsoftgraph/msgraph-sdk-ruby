...
module MicrosoftGraph::Me::Drives::Item::Items::Item::ListItem::DriveItem
    ## 
    ...
    class DriveItemRequestBuilder
        ...
        def content()
            return MicrosoftGraph::Me::Drives::Item::Items::Item::ListItem::DriveItem::Content::ContentRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/drives/{drive%2Did}/items/{driveItem%2Did}/listItem/driveItem{?%24select,%24expand}"
