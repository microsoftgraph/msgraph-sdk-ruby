...
require_relative '../../models/planner_user'
require_relative '../me'
...
module MicrosoftGraph::Me::Planner
    ## 
    ...
    class PlannerRequestBuilder
        ...
        def plans()
            return MicrosoftGraph::Me::Planner::Plans::PlansRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def tasks()
            return MicrosoftGraph::Me::Planner::Tasks::TasksRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/planner{?%24select,%24expand}"
        ...
        ## Entry-point to the Planner resource that might exist for a user. Read-only.
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of planner_user
        ## 
        def get(request_configuration=nil)
            ...
            error_mapping["4XX"] = lambda {|pn| MicrosoftGraph::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            error_mapping["5XX"] = lambda {|pn| MicrosoftGraph::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraph::Models::PlannerUser.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
        ## Update the navigation property planner in me
        ## @param body The request body
        ...
        def plans_by_id(id)
            ...
            return MicrosoftGraph::Me::Planner::Plans::Item::PlannerPlanItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the tasks property of the microsoft.graph.plannerUser entity.
        ## @param id Unique identifier of the item
        ...
        def tasks_by_id(id)
            ...
            return MicrosoftGraph::Me::Planner::Tasks::Item::PlannerTaskItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
