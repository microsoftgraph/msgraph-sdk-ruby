...
module MicrosoftGraph::Me::Planner::Tasks::Item::BucketTaskBoardFormat
    ## 
    ...
    class BucketTaskBoardFormatRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/planner/tasks/{plannerTask%2Did}/bucketTaskBoardFormat{?%24select,%24expand}"
