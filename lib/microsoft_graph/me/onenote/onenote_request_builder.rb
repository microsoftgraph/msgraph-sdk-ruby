...
module MicrosoftGraph::Me::Onenote
    ## 
    ...
    class OnenoteRequestBuilder
        ...
        def notebooks()
            return MicrosoftGraph::Me::Onenote::Notebooks::NotebooksRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the operations property of the microsoft.graph.onenote entity.
        def operations()
            return MicrosoftGraph::Me::Onenote::Operations::OperationsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def section_groups()
            return MicrosoftGraph::Me::Onenote::SectionGroups::SectionGroupsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def notebooks_by_id(id)
            ...
            return MicrosoftGraph::Me::Onenote::Notebooks::Item::NotebookItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the operations property of the microsoft.graph.onenote entity.
        ## @param id Unique identifier of the item
        ...
        def resources_by_id(id)
            ...
            return MicrosoftGraph::Me::Onenote::Resources::Item::OnenoteResourceItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the sectionGroups property of the microsoft.graph.onenote entity.
        ## @param id Unique identifier of the item
        ...
        def section_groups_by_id(id)
            ...
            return MicrosoftGraph::Me::Onenote::SectionGroups::Item::SectionGroupItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the sections property of the microsoft.graph.onenote entity.
        ## @param id Unique identifier of the item
        ...
        def sections_by_id(id)
            ...
            return MicrosoftGraph::Me::Onenote::Sections::Item::OnenoteSectionItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Delete navigation property onenote for me
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
