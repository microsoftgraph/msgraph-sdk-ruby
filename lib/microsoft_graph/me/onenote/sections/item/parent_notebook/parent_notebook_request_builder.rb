...
module MicrosoftGraph::Me::Onenote::Sections::Item::ParentNotebook
    ## 
    ...
    class ParentNotebookRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/onenote/sections/{onenoteSection%2Did}/parentNotebook{?%24select,%24expand}"
