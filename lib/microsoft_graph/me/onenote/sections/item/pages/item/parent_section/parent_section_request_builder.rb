...
module MicrosoftGraph::Me::Onenote::Sections::Item::Pages::Item::ParentSection
    ## 
    ...
    class ParentSectionRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/onenote/sections/{onenoteSection%2Did}/pages/{onenotePage%2Did}/parentSection{?%24select,%24expand}"
