...
module MicrosoftGraph::Me::Onenote::Sections::Item::ParentSectionGroup
    ## 
    ...
    class ParentSectionGroupRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/onenote/sections/{onenoteSection%2Did}/parentSectionGroup{?%24select,%24expand}"
