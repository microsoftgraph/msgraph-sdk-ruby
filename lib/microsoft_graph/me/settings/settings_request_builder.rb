...
module MicrosoftGraph::Me::Settings
    ## 
    ...
    class SettingsRequestBuilder
        ...
        def shift_preferences()
            return MicrosoftGraph::Me::Settings::ShiftPreferences::ShiftPreferencesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/settings{?%24select,%24expand}"
        ...
        ## Get settings from me
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of user_settings
        ## 
