...
module MicrosoftGraph::Me::ManagedDevices
    ## 
    ...
    class ManagedDevicesRequestBuilder
        ...
        def count()
            return MicrosoftGraph::Me::ManagedDevices::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/managedDevices{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
        ...
        ## The managed devices associated with the user.
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of managed_device_collection_response
        ## 
