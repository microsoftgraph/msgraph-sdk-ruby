...
module MicrosoftGraph::Me::RegisteredDevices::Device
    ## 
    ...
    class DeviceRequestBuilder
        ...
        def count()
            return MicrosoftGraph::Me::RegisteredDevices::Device::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
