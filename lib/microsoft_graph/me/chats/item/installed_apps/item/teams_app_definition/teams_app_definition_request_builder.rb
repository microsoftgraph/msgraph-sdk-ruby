...
module MicrosoftGraph::Me::Chats::Item::InstalledApps::Item::TeamsAppDefinition
    ## 
    ...
    class TeamsAppDefinitionRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/chats/{chat%2Did}/installedApps/{teamsAppInstallation%2Did}/teamsAppDefinition{?%24select,%24expand}"
