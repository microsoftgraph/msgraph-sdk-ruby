...
module MicrosoftGraph::Me::Chats::Item::PinnedMessages::Item::Message
    ## 
    ...
    class MessageRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/chats/{chat%2Did}/pinnedMessages/{pinnedChatMessageInfo%2Did}/message{?%24select,%24expand}"
