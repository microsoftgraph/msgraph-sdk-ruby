...
module MicrosoftGraph::Me::Authentication::Fido2Methods
    ## 
    ...
    class Fido2MethodsRequestBuilder
        ...
        def count()
            return MicrosoftGraph::Me::Authentication::Fido2Methods::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/authentication/fido2Methods{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
        ...
        ## Represents the FIDO2 security keys registered to a user for authentication.
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of fido2_authentication_method_collection_response
        ## 
