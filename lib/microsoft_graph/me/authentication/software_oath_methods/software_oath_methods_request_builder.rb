...
module MicrosoftGraph::Me::Authentication::SoftwareOathMethods
    ## 
    ...
    class SoftwareOathMethodsRequestBuilder
        ...
        def count()
            return MicrosoftGraph::Me::Authentication::SoftwareOathMethods::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/me/authentication/softwareOathMethods{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
