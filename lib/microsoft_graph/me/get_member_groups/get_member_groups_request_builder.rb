...
module MicrosoftGraph::Me::GetMemberGroups
    ...
    class GetMemberGroupsRequestBuilder
        ...
        def post(body, request_configuration=nil)
            ...
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraph::Me::GetMemberGroups::GetMemberGroupsResponse.create_from_discriminator_value(pn) }, error_mapping)
        end
