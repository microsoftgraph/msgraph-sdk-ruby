...
module MicrosoftGraph::Me::OwnedDevices::Device
    ## 
    ...
    class DeviceRequestBuilder
        ...
        def count()
            return MicrosoftGraph::Me::OwnedDevices::Device::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
