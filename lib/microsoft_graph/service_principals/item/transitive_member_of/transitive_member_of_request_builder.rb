...
module MicrosoftGraph::ServicePrincipals::Item::TransitiveMemberOf
    ...
    class TransitiveMemberOfRequestBuilder
        ...
        def application()
            return MicrosoftGraph::ServicePrincipals::Item::TransitiveMemberOf::Application::ApplicationRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def device()
            return MicrosoftGraph::ServicePrincipals::Item::TransitiveMemberOf::Device::DeviceRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Casts the previous resource to group.
        def group()
            return MicrosoftGraph::ServicePrincipals::Item::TransitiveMemberOf::Group::GroupRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Casts the previous resource to orgContact.
        def org_contact()
            return MicrosoftGraph::ServicePrincipals::Item::TransitiveMemberOf::OrgContact::OrgContactRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def service_principal()
            return MicrosoftGraph::ServicePrincipals::Item::TransitiveMemberOf::ServicePrincipal::ServicePrincipalRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def user()
            return MicrosoftGraph::ServicePrincipals::Item::TransitiveMemberOf::User::UserRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
