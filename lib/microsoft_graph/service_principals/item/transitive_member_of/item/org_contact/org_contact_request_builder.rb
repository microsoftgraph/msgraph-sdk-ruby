...
module MicrosoftGraph::ServicePrincipals::Item::TransitiveMemberOf::Item::OrgContact
    ## 
    ...
    class OrgContactRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/transitiveMemberOf/{directoryObject%2Did}/microsoft.graph.orgContact{?%24select,%24expand}"
