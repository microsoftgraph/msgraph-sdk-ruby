...
module MicrosoftGraph::ServicePrincipals::Item::CreatedObjects
    ## 
    ...
    class CreatedObjectsRequestBuilder
        ...
        def service_principal()
            return MicrosoftGraph::ServicePrincipals::Item::CreatedObjects::ServicePrincipal::ServicePrincipalRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/createdObjects{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
