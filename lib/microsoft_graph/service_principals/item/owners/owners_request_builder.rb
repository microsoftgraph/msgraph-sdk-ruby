...
module MicrosoftGraph::ServicePrincipals::Item::Owners
    ...
    class OwnersRequestBuilder
        ...
        def app_role_assignment()
            return MicrosoftGraph::ServicePrincipals::Item::Owners::AppRoleAssignment::AppRoleAssignmentRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def endpoint()
            return MicrosoftGraph::ServicePrincipals::Item::Owners::Endpoint::EndpointRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def service_principal()
            return MicrosoftGraph::ServicePrincipals::Item::Owners::ServicePrincipal::ServicePrincipalRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def user()
            return MicrosoftGraph::ServicePrincipals::Item::Owners::User::UserRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
