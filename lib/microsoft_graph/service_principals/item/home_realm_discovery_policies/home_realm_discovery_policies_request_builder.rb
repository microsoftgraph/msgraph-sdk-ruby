...
module MicrosoftGraph::ServicePrincipals::Item::HomeRealmDiscoveryPolicies
    ## 
    ...
    class HomeRealmDiscoveryPoliciesRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/homeRealmDiscoveryPolicies{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
        ...
        ## List the homeRealmDiscoveryPolicy objects that are assigned to a servicePrincipal.
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of home_realm_discovery_policy_collection_response
        ## 
