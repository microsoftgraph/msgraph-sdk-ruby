...
module MicrosoftGraph::RoleManagement::EntitlementManagement::RoleAssignments::Item::RoleDefinition
    ## 
    ...
    class RoleDefinitionRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/roleManagement/entitlementManagement/roleAssignments/{unifiedRoleAssignment%2Did}/roleDefinition{?%24select,%24expand}"
