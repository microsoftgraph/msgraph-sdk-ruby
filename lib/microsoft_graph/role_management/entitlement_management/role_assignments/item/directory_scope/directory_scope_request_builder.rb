...
module MicrosoftGraph::RoleManagement::EntitlementManagement::RoleAssignments::Item::DirectoryScope
    ## 
    ...
    class DirectoryScopeRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/roleManagement/entitlementManagement/roleAssignments/{unifiedRoleAssignment%2Did}/directoryScope{?%24select,%24expand}"
