...
module MicrosoftGraph::RoleManagement::EntitlementManagement::RoleAssignments::Item::AppScope
    ## 
    ...
    class AppScopeRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/roleManagement/entitlementManagement/roleAssignments/{unifiedRoleAssignment%2Did}/appScope{?%24select,%24expand}"
