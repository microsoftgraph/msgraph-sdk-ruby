...
module MicrosoftGraph::RoleManagement::Directory::RoleAssignmentScheduleRequests::Item::TargetSchedule
    ## 
    ...
    class TargetScheduleRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/roleManagement/directory/roleAssignmentScheduleRequests/{unifiedRoleAssignmentScheduleRequest%2Did}/targetSchedule{?%24select,%24expand}"
