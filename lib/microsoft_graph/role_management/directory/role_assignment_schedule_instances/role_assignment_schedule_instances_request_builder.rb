...
module MicrosoftGraph::RoleManagement::Directory::RoleAssignmentScheduleInstances
    ...
    class RoleAssignmentScheduleInstancesRequestBuilder
        ...
        def count()
            return MicrosoftGraph::RoleManagement::Directory::RoleAssignmentScheduleInstances::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/roleManagement/directory/roleAssignmentScheduleInstances{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
        ...
        ## Get the instances of active role assignments in your tenant. The active assignments include those made through assignments and activation requests, and directly through the role assignments API.
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of unified_role_assignment_schedule_instance_collection_response
        ## 
