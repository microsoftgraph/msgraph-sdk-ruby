...
module MicrosoftGraph::RoleManagement::Directory::RoleAssignmentScheduleInstances::Item::ActivatedUsing
    ...
    class ActivatedUsingRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/roleManagement/directory/roleAssignmentScheduleInstances/{unifiedRoleAssignmentScheduleInstance%2Did}/activatedUsing{?%24select,%24expand}"
