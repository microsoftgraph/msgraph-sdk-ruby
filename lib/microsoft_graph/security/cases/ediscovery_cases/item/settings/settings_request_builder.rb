...
module MicrosoftGraph::Security::Cases::EdiscoveryCases::Item::Settings
    ...
    class SettingsRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/security/cases/ediscoveryCases/{ediscoveryCase%2Did}/settings{?%24select,%24expand}"
        ...
        ## Read the properties and relationships of an ediscoveryCaseSettings object.
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of ediscovery_case_settings
        ## 
