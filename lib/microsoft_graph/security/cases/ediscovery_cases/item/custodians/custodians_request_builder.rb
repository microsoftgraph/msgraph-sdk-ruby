...
require_relative '../../../../../models/security/ediscovery_custodian_collection_response'
...
module MicrosoftGraph::Security::Cases::EdiscoveryCases::Item::Custodians
    ## 
    ...
    class CustodiansRequestBuilder
        ...
        def apply_hold()
            return MicrosoftGraph::Security::Cases::EdiscoveryCases::Item::Custodians::ApplyHold::ApplyHoldRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def remove_hold()
            return MicrosoftGraph::Security::Cases::EdiscoveryCases::Item::Custodians::RemoveHold::RemoveHoldRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/security/cases/ediscoveryCases/{ediscoveryCase%2Did}/custodians{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
        ...
        ## Get a list of the custodian objects and their properties.
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of ediscovery_custodian_collection_response
        ## 
        ...
        ## @param body The request body
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of ediscovery_custodian
        ## 
