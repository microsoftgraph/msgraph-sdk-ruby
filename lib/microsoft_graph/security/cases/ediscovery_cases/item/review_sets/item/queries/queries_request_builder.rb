...
require_relative '../../../../../../../models/security/ediscovery_review_set_query_collection_response'
...
module MicrosoftGraph::Security::Cases::EdiscoveryCases::Item::ReviewSets::Item::Queries
    ## 
    ...
    class QueriesRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/security/cases/ediscoveryCases/{ediscoveryCase%2Did}/reviewSets/{ediscoveryReviewSet%2Did}/queries{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
        ...
        ## Get the list of queries associated with an eDiscovery review set.
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of ediscovery_review_set_query_collection_response
        ## 
        def get(request_configuration=nil)
            ...
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraph::Models::Security::EdiscoveryReviewSetQueryCollectionResponse.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
        ## Create a new ediscoveryReviewSetQuery object.
        ## @param body The request body
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of ediscovery_review_set_query
        ## 
