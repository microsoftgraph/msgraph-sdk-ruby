...
require_relative './as_hierarchy/as_hierarchy_request_builder'
require_relative './count/count_request_builder'
require_relative './tags'

module MicrosoftGraph::Security::Cases::EdiscoveryCases::Item::Tags
    ## 
    ...
    class TagsRequestBuilder
        ...
        ## @return a as_hierarchy_request_builder
        ## 
        def as_hierarchy()
            return AsHierarchyRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/security/cases/ediscoveryCases/{ediscoveryCase%2Did}/tags{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
        ...
        ## Get a list of eDiscoveryReviewTag objects and their properties.
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of ediscovery_review_tag_collection_response
        ## 
        ...
        ## @param body The request body
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of ediscovery_review_tag
        ## 
