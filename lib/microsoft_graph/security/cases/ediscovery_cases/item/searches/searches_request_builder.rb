...
require_relative '../../../../../models/security/ediscovery_search_collection_response'
...
module MicrosoftGraph::Security::Cases::EdiscoveryCases::Item::Searches
    ## 
    ...
    class SearchesRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/security/cases/ediscoveryCases/{ediscoveryCase%2Did}/searches{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
        ...
        ## Get the list of ediscoverySearch resources from an eDiscoveryCase object.
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of ediscovery_search_collection_response
        ## 
        ...
        ## @param body The request body
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of ediscovery_search
        ## 
