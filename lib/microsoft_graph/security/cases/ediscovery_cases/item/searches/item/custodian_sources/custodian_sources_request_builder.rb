...
module MicrosoftGraph::Security::Cases::EdiscoveryCases::Item::Searches::Item::CustodianSources
    ## 
    ...
    class CustodianSourcesRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/security/cases/ediscoveryCases/{ediscoveryCase%2Did}/searches/{ediscoverySearch%2Did}/custodianSources{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
