...
module MicrosoftGraph::Security::Cases::EdiscoveryCases::Item::NoncustodialDataSources::Item::LastIndexOperation
    ## 
    ...
    class LastIndexOperationRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/security/cases/ediscoveryCases/{ediscoveryCase%2Did}/noncustodialDataSources/{ediscoveryNoncustodialDataSource%2Did}/lastIndexOperation{?%24select,%24expand}"
        ...
        ## Operation entity that represents the latest indexing for the non-custodial data source.
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of ediscovery_index_operation
        ## 
