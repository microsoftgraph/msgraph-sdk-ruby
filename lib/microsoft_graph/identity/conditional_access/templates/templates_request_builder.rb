...
require_relative '../../../models/conditional_access_template_collection_response'
...
module MicrosoftGraph::Identity::ConditionalAccess::Templates
    ## 
    ...
    class TemplatesRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/identity/conditionalAccess/templates{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
        ...
        ## Get a list of the conditionalAccessTemplate objects and their properties.
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of conditional_access_template_collection_response
        ## 
