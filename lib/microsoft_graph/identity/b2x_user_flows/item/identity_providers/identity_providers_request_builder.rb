...
module MicrosoftGraph::Identity::B2xUserFlows::Item::IdentityProviders
    ...
    class IdentityProvidersRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/identity/b2xUserFlows/{b2xIdentityUserFlow%2Did}/identityProviders{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
        ...
        ## Get the identity providers in a b2xIdentityUserFlow object.
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of identity_provider_collection_response
        ## 
