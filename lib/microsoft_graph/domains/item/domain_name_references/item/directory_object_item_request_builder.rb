...
module MicrosoftGraph::Domains::Item::DomainNameReferences::Item
    ## 
    ...
    class DirectoryObjectItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/domains/{domain%2Did}/domainNameReferences/{directoryObject%2Did}{?%24select,%24expand}"
