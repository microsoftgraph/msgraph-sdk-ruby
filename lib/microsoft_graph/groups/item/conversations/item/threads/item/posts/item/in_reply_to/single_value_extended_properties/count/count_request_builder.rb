...
module MicrosoftGraph::Groups::Item::Conversations::Item::Threads::Item::Posts::Item::InReplyTo::SingleValueExtendedProperties::Count
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/conversations/{conversation%2Did}/threads/{conversationThread%2Did}/posts/{post%2Did}/inReplyTo/singleValueExtendedProperties/$count"
