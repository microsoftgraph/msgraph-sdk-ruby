...
module MicrosoftGraph::Groups::Item::Conversations::Item::Threads
    ## 
    ...
    class ThreadsRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/conversations/{conversation%2Did}/threads{?%24top,%24skip,%24filter,%24count,%24orderby,%24select,%24expand}"
        ...
        ## Get all the threads in a group conversation. Note: You can also get all the threads of a group.
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of conversation_thread_collection_response
        ## 
