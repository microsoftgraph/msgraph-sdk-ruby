...
module MicrosoftGraph::Groups::Item::Conversations
    ## 
    ...
    class ConversationsRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/conversations{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select}"
        ...
        ## Retrieve the list of conversations in this group.
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of conversation_collection_response
        ## 
