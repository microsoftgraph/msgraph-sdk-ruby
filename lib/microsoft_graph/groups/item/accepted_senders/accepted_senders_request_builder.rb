...
module MicrosoftGraph::Groups::Item::AcceptedSenders
    ## 
    ...
    class AcceptedSendersRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/acceptedSenders{?%24top,%24skip,%24filter,%24count,%24orderby,%24select}"
