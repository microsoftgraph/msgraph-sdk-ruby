...
module MicrosoftGraph::Groups::Item::AcceptedSenders::Ref
    ## 
    ...
    class RefRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/acceptedSenders/$ref{?%24top,%24skip,%24filter,%24count,%24orderby}"
