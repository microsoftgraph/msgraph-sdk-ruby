...
module MicrosoftGraph::Groups::Item::Team::InstalledApps::Item::TeamsAppDefinition
    ## 
    ...
    class TeamsAppDefinitionRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/team/installedApps/{teamsAppInstallation%2Did}/teamsAppDefinition{?%24select,%24expand}"
