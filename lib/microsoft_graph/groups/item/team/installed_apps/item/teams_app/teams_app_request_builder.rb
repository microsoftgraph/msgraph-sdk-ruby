...
module MicrosoftGraph::Groups::Item::Team::InstalledApps::Item::TeamsApp
    ## 
    ...
    class TeamsAppRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/team/installedApps/{teamsAppInstallation%2Did}/teamsApp{?%24select,%24expand}"
