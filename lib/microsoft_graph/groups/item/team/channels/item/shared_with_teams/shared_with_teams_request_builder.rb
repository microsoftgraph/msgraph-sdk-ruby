...
module MicrosoftGraph::Groups::Item::Team::Channels::Item::SharedWithTeams
    ## 
    ...
    class SharedWithTeamsRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/team/channels/{channel%2Did}/sharedWithTeams{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
