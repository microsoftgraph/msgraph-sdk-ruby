...
module MicrosoftGraph::Groups::Item::Team::Channels::Item::Messages::Item::Replies::Item::HostedContents
    ## 
    ...
    class HostedContentsRequestBuilder
        ...
        def count()
            return MicrosoftGraph::Groups::Item::Team::Channels::Item::Messages::Item::Replies::Item::HostedContents::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/team/channels/{channel%2Did}/messages/{chatMessage%2Did}/replies/{chatMessage%2Did1}/hostedContents{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
