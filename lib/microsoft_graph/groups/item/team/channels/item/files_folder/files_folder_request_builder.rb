...
module MicrosoftGraph::Groups::Item::Team::Channels::Item::FilesFolder
    ## 
    ...
    class FilesFolderRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/team/channels/{channel%2Did}/filesFolder{?%24select,%24expand}"
