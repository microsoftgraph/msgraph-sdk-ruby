...
module MicrosoftGraph::Groups::Item::Team::Channels::Item::Members::Item
    ## 
    ...
    class ConversationMemberItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/team/channels/{channel%2Did}/members/{conversationMember%2Did}{?%24select,%24expand}"
