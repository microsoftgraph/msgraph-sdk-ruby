...
module MicrosoftGraph::Groups::Item::Team::PrimaryChannel::Tabs::Item::TeamsApp
    ## 
    ...
    class TeamsAppRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/team/primaryChannel/tabs/{teamsTab%2Did}/teamsApp{?%24select,%24expand}"
