...
module MicrosoftGraph::Groups::Item::Team::PrimaryChannel::SharedWithTeams::Item::AllowedMembers
    ## 
    ...
    class AllowedMembersRequestBuilder
        ...
        def count()
            return MicrosoftGraph::Groups::Item::Team::PrimaryChannel::SharedWithTeams::Item::AllowedMembers::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/team/primaryChannel/sharedWithTeams/{sharedWithChannelTeamInfo%2Did}/allowedMembers{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
