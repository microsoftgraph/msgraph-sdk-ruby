...
module MicrosoftGraph::Groups::Item::Team::Schedule::TimesOff
    ## 
    ...
    class TimesOffRequestBuilder
        ...
        def count()
            return MicrosoftGraph::Groups::Item::Team::Schedule::TimesOff::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/team/schedule/timesOff{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select}"
