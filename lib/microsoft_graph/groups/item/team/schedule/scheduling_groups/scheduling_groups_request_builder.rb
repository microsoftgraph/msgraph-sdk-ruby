...
module MicrosoftGraph::Groups::Item::Team::Schedule::SchedulingGroups
    ## 
    ...
    class SchedulingGroupsRequestBuilder
        ...
        def count()
            return MicrosoftGraph::Groups::Item::Team::Schedule::SchedulingGroups::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/team/schedule/schedulingGroups{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select}"
        ...
        ## Get the list of schedulingGroups in this schedule.
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of scheduling_group_collection_response
        ## 
        ...
        ## @param body The request body
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of scheduling_group
        ## 
