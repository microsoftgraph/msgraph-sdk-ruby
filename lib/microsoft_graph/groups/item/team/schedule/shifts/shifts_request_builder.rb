...
module MicrosoftGraph::Groups::Item::Team::Schedule::Shifts
    ## 
    ...
    class ShiftsRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/team/schedule/shifts{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select}"
