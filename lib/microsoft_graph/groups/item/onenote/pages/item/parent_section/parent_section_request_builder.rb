...
module MicrosoftGraph::Groups::Item::Onenote::Pages::Item::ParentSection
    ## 
    ...
    class ParentSectionRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/onenote/pages/{onenotePage%2Did}/parentSection{?%24select,%24expand}"
