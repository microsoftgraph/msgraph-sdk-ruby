...
module MicrosoftGraph::Groups::Item::Onenote::SectionGroups::Item::SectionGroups
    ## 
    ...
    class SectionGroupsRequestBuilder
        ...
        def count()
            return MicrosoftGraph::Groups::Item::Onenote::SectionGroups::Item::SectionGroups::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/onenote/sectionGroups/{sectionGroup%2Did}/sectionGroups{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
