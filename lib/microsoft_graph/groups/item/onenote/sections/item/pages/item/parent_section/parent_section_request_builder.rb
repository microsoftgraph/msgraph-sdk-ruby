...
module MicrosoftGraph::Groups::Item::Onenote::Sections::Item::Pages::Item::ParentSection
    ## 
    ...
    class ParentSectionRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/onenote/sections/{onenoteSection%2Did}/pages/{onenotePage%2Did}/parentSection{?%24select,%24expand}"
