...
module MicrosoftGraph::Groups::Item::Onenote::Sections::Item::Pages::Item::Preview
    ## 
    ...
    class PreviewRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/onenote/sections/{onenoteSection%2Did}/pages/{onenotePage%2Did}/microsoft.graph.preview()"
