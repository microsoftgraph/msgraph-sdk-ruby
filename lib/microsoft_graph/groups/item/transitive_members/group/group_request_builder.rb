...
module MicrosoftGraph::Groups::Item::TransitiveMembers::Group
    ## 
    ...
    class GroupRequestBuilder
        ...
        def count()
            return MicrosoftGraph::Groups::Item::TransitiveMembers::Group::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
