...
module MicrosoftGraph::Groups::Item::Planner::Plans::Item::Buckets::Item::Tasks::Item::BucketTaskBoardFormat
    ## 
    ...
    class BucketTaskBoardFormatRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/planner/plans/{plannerPlan%2Did}/buckets/{plannerBucket%2Did}/tasks/{plannerTask%2Did}/bucketTaskBoardFormat{?%24select,%24expand}"
        ...
        ## Retrieve the properties and relationships of **plannerBucketTaskBoardTaskFormat** object.
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of planner_bucket_task_board_task_format
        ## 
