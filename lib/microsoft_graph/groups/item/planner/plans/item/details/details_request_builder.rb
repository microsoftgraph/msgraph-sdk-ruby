...
module MicrosoftGraph::Groups::Item::Planner::Plans::Item::Details
    ## 
    ...
    class DetailsRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/planner/plans/{plannerPlan%2Did}/details{?%24select,%24expand}"
        ...
        ## Retrieve the properties and relationships of a **plannerPlanDetails** object.
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of planner_plan_details
        ## 
