...
require_relative '../../../models/planner_group'
...
module MicrosoftGraph::Groups::Item::Planner
    ## 
    ...
    class PlannerRequestBuilder
        ...
        def plans()
            return MicrosoftGraph::Groups::Item::Planner::Plans::PlansRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/planner{?%24select,%24expand}"
        ...
        ## Entry-point to Planner resource that might exist for a Unified Group.
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of planner_group
        ## 
        def get(request_configuration=nil)
            ...
            error_mapping["4XX"] = lambda {|pn| MicrosoftGraph::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            error_mapping["5XX"] = lambda {|pn| MicrosoftGraph::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraph::Models::PlannerGroup.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
        ## Update the navigation property planner in groups
        ## @param body The request body
