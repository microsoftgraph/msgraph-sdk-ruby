...
module MicrosoftGraph::Groups::Item::MembersWithLicenseErrors::Group
    ## 
    ...
    class GroupRequestBuilder
        ...
        def count()
            return MicrosoftGraph::Groups::Item::MembersWithLicenseErrors::Group::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
