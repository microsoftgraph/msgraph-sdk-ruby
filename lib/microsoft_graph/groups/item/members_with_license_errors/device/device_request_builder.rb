...
module MicrosoftGraph::Groups::Item::MembersWithLicenseErrors::Device
    ## 
    ...
    class DeviceRequestBuilder
        ...
        def count()
            return MicrosoftGraph::Groups::Item::MembersWithLicenseErrors::Device::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
