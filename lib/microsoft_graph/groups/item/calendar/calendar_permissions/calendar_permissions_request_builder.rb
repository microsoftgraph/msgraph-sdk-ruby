...
module MicrosoftGraph::Groups::Item::Calendar::CalendarPermissions
    ## 
    ...
    class CalendarPermissionsRequestBuilder
        ...
        def count()
            return MicrosoftGraph::Groups::Item::Calendar::CalendarPermissions::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/calendar/calendarPermissions{?%24top,%24skip,%24filter,%24count,%24orderby,%24select}"
