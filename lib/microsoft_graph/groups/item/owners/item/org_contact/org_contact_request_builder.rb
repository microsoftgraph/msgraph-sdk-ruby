...
module MicrosoftGraph::Groups::Item::Owners::Item::OrgContact
    ## 
    ...
    class OrgContactRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/owners/{directoryObject%2Did}/microsoft.graph.orgContact{?%24select,%24expand}"
