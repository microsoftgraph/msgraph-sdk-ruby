...
module MicrosoftGraph::Groups::Item::Owners::Device
    ## 
    ...
    class DeviceRequestBuilder
        ...
        def count()
            return MicrosoftGraph::Groups::Item::Owners::Device::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
