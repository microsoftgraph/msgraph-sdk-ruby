...
module MicrosoftGraph::Groups::Item::Owners::User
    ## 
    ...
    class UserRequestBuilder
        ...
        def count()
            return MicrosoftGraph::Groups::Item::Owners::User::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
