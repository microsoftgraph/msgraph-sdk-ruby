...
module MicrosoftGraph::Groups::Item::MemberOf::Device
    ## 
    ...
    class DeviceRequestBuilder
        ...
        def count()
            return MicrosoftGraph::Groups::Item::MemberOf::Device::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
