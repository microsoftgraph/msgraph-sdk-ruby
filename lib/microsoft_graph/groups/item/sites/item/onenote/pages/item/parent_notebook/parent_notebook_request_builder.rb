...
module MicrosoftGraph::Groups::Item::Sites::Item::Onenote::Pages::Item::ParentNotebook
    ## 
    ...
    class ParentNotebookRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/onenote/pages/{onenotePage%2Did}/parentNotebook{?%24select,%24expand}"
