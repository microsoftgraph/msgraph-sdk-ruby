...
module MicrosoftGraph::Groups::Item::Sites::Item::Items
    ## 
    ...
    class ItemsRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/items{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
        ...
        ## Used to address any item contained in this site. This collection can't be enumerated.
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of base_item_collection_response
        ## 
