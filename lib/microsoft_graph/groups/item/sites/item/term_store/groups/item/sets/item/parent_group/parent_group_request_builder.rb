...
module MicrosoftGraph::Groups::Item::Sites::Item::TermStore::Groups::Item::Sets::Item::ParentGroup
    ## 
    ...
    class ParentGroupRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/termStore/groups/{group%2Did1}/sets/{set%2Did}/parentGroup{?%24select,%24expand}"
