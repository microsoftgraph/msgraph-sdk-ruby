...
module MicrosoftGraph::Groups::Item::Sites::Item::TermStore::Groups::Item::Sets::Item::Terms::Item::Children::Item::Relations
    ## 
    ...
    class RelationsRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/termStore/groups/{group%2Did1}/sets/{set%2Did}/terms/{term%2Did}/children/{term%2Did1}/relations{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
