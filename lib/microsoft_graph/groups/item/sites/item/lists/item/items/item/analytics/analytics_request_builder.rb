...
module MicrosoftGraph::Groups::Item::Sites::Item::Lists::Item::Items::Item::Analytics
    ## 
    ...
    class AnalyticsRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/lists/{list%2Did}/items/{listItem%2Did}/analytics{?%24select,%24expand}"
        ...
        ## Analytics about the view activities that took place on this item.
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of item_analytics
        ## 
