...
module MicrosoftGraph::Groups::Item::Sites::Item::Lists::Item::Drive
    ## 
    ...
    class DriveRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/lists/{list%2Did}/drive{?%24select,%24expand}"
