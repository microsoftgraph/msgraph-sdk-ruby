...
module MicrosoftGraph::Groups::Item::Members
    ...
    class MembersRequestBuilder
        ...
        def application()
            return MicrosoftGraph::Groups::Item::Members::Application::ApplicationRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def device()
            return MicrosoftGraph::Groups::Item::Members::Device::DeviceRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Casts the previous resource to group.
        def group()
            return MicrosoftGraph::Groups::Item::Members::Group::GroupRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Casts the previous resource to orgContact.
        def org_contact()
            return MicrosoftGraph::Groups::Item::Members::OrgContact::OrgContactRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def service_principal()
            return MicrosoftGraph::Groups::Item::Members::ServicePrincipal::ServicePrincipalRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def user()
            return MicrosoftGraph::Groups::Item::Members::User::UserRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
