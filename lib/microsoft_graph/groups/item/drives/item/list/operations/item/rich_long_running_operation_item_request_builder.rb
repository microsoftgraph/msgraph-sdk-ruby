...
module MicrosoftGraph::Groups::Item::Drives::Item::List::Operations::Item
    ## 
    ...
    class RichLongRunningOperationItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/drives/{drive%2Did}/list/operations/{richLongRunningOperation%2Did}{?%24select,%24expand}"
