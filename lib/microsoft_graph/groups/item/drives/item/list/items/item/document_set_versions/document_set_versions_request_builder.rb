...
module MicrosoftGraph::Groups::Item::Drives::Item::List::Items::Item::DocumentSetVersions
    ## 
    ...
    class DocumentSetVersionsRequestBuilder
        ...
        def count()
            return MicrosoftGraph::Groups::Item::Drives::Item::List::Items::Item::DocumentSetVersions::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/drives/{drive%2Did}/list/items/{listItem%2Did}/documentSetVersions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
