...
module MicrosoftGraph::Groups::Item::Drives::Item::List
    ## 
    ...
    class ListRequestBuilder
        ...
        def columns()
            return MicrosoftGraph::Groups::Item::Drives::Item::List::Columns::ColumnsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the contentTypes property of the microsoft.graph.list entity.
        def content_types()
            return MicrosoftGraph::Groups::Item::Drives::Item::List::ContentTypes::ContentTypesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the drive property of the microsoft.graph.list entity.
        def drive()
            return MicrosoftGraph::Groups::Item::Drives::Item::List::Drive::DriveRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the items property of the microsoft.graph.list entity.
        def items()
            return MicrosoftGraph::Groups::Item::Drives::Item::List::Items::ItemsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the operations property of the microsoft.graph.list entity.
        def operations()
            return MicrosoftGraph::Groups::Item::Drives::Item::List::Operations::OperationsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def subscriptions()
            return MicrosoftGraph::Groups::Item::Drives::Item::List::Subscriptions::SubscriptionsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def columns_by_id(id)
            ...
            return MicrosoftGraph::Groups::Item::Drives::Item::List::Columns::Item::ColumnDefinitionItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/drives/{drive%2Did}/list{?%24select,%24expand}"
        ...
        def content_types_by_id(id)
            ...
            return MicrosoftGraph::Groups::Item::Drives::Item::List::ContentTypes::Item::ContentTypeItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def items_by_id(id)
            ...
            return MicrosoftGraph::Groups::Item::Drives::Item::List::Items::Item::ListItemItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the operations property of the microsoft.graph.list entity.
        ## @param id Unique identifier of the item
        ...
        def operations_by_id(id)
            ...
            return MicrosoftGraph::Groups::Item::Drives::Item::List::Operations::Item::RichLongRunningOperationItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Update the navigation property list in groups
        ## @param body The request body
        ...
        def subscriptions_by_id(id)
            ...
            return MicrosoftGraph::Groups::Item::Drives::Item::List::Subscriptions::Item::SubscriptionItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
