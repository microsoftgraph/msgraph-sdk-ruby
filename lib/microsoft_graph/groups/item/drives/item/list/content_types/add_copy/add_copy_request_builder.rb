...
module MicrosoftGraph::Groups::Item::Drives::Item::List::ContentTypes::AddCopy
    ## 
    ...
    class AddCopyRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/drives/{drive%2Did}/list/contentTypes/microsoft.graph.addCopy"
