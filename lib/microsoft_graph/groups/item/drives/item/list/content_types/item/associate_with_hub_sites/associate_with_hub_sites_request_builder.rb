...
module MicrosoftGraph::Groups::Item::Drives::Item::List::ContentTypes::Item::AssociateWithHubSites
    ## 
    ...
    class AssociateWithHubSitesRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/drives/{drive%2Did}/list/contentTypes/{contentType%2Did}/microsoft.graph.associateWithHubSites"
