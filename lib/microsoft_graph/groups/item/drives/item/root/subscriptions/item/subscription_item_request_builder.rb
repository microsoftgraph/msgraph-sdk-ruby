...
module MicrosoftGraph::Groups::Item::Drives::Item::Root::Subscriptions::Item
    ## 
    ...
    class SubscriptionItemRequestBuilder
        ...
        def reauthorize()
            return MicrosoftGraph::Groups::Item::Drives::Item::Root::Subscriptions::Item::Reauthorize::ReauthorizeRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/drives/{drive%2Did}/root/subscriptions/{subscription%2Did}{?%24select,%24expand}"
