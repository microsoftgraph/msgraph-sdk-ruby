...
module MicrosoftGraph::Groups::Item::Drives::Item::Root::ListItem::Analytics
    ## 
    ...
    class AnalyticsRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/drives/{drive%2Did}/root/listItem/analytics{?%24select,%24expand}"
