...
module MicrosoftGraph::Groups::Item::Drives::Item::Root
    ## 
    ...
    class RootRequestBuilder
        ...
        def analytics()
            return MicrosoftGraph::Groups::Item::Drives::Item::Root::Analytics::AnalyticsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the checkin method.
        def checkin()
            return MicrosoftGraph::Groups::Item::Drives::Item::Root::Checkin::CheckinRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the checkout method.
        def checkout()
            return MicrosoftGraph::Groups::Item::Drives::Item::Root::Checkout::CheckoutRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the children property of the microsoft.graph.driveItem entity.
        def children()
            return MicrosoftGraph::Groups::Item::Drives::Item::Root::Children::ChildrenRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the media for the group entity.
        def content()
            return MicrosoftGraph::Groups::Item::Drives::Item::Root::Content::ContentRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the copy method.
        def copy()
            return MicrosoftGraph::Groups::Item::Drives::Item::Root::Copy::CopyRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the createLink method.
        def create_link()
            return MicrosoftGraph::Groups::Item::Drives::Item::Root::CreateLink::CreateLinkRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the createUploadSession method.
        def create_upload_session()
            return MicrosoftGraph::Groups::Item::Drives::Item::Root::CreateUploadSession::CreateUploadSessionRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the follow method.
        def follow()
            return MicrosoftGraph::Groups::Item::Drives::Item::Root::Follow::FollowRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the invite method.
        def invite()
            return MicrosoftGraph::Groups::Item::Drives::Item::Root::Invite::InviteRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the listItem property of the microsoft.graph.driveItem entity.
        def list_item()
            return MicrosoftGraph::Groups::Item::Drives::Item::Root::ListItem::ListItemRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def permissions()
            return MicrosoftGraph::Groups::Item::Drives::Item::Root::Permissions::PermissionsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the preview method.
        def preview()
            return MicrosoftGraph::Groups::Item::Drives::Item::Root::Preview::PreviewRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def restore()
            return MicrosoftGraph::Groups::Item::Drives::Item::Root::Restore::RestoreRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the subscriptions property of the microsoft.graph.driveItem entity.
        def subscriptions()
            return MicrosoftGraph::Groups::Item::Drives::Item::Root::Subscriptions::SubscriptionsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the thumbnails property of the microsoft.graph.driveItem entity.
        def thumbnails()
            return MicrosoftGraph::Groups::Item::Drives::Item::Root::Thumbnails::ThumbnailsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the unfollow method.
        def unfollow()
            return MicrosoftGraph::Groups::Item::Drives::Item::Root::Unfollow::UnfollowRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def validate_permission()
            return MicrosoftGraph::Groups::Item::Drives::Item::Root::ValidatePermission::ValidatePermissionRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the versions property of the microsoft.graph.driveItem entity.
        def versions()
            return MicrosoftGraph::Groups::Item::Drives::Item::Root::Versions::VersionsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ## Provides operations to manage the children property of the microsoft.graph.driveItem entity.
        ...
        def children_by_id(id)
            ...
            return MicrosoftGraph::Groups::Item::Drives::Item::Root::Children::Item::DriveItemItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/drives/{drive%2Did}/root{?%24select,%24expand}"
        ...
        def permissions_by_id(id)
            ...
            return MicrosoftGraph::Groups::Item::Drives::Item::Root::Permissions::Item::PermissionItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def subscriptions_by_id(id)
            ...
            return MicrosoftGraph::Groups::Item::Drives::Item::Root::Subscriptions::Item::SubscriptionItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the thumbnails property of the microsoft.graph.driveItem entity.
        ## @param id Unique identifier of the item
        ...
        def thumbnails_by_id(id)
            ...
            return MicrosoftGraph::Groups::Item::Drives::Item::Root::Thumbnails::Item::ThumbnailSetItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the versions property of the microsoft.graph.driveItem entity.
        ## @param id Unique identifier of the item
        ...
        def versions_by_id(id)
            ...
            return MicrosoftGraph::Groups::Item::Drives::Item::Root::Versions::Item::DriveItemVersionItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
