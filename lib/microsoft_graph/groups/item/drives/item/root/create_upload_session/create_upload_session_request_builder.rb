...
module MicrosoftGraph::Groups::Item::Drives::Item::Root::CreateUploadSession
    ## 
    ...
    class CreateUploadSessionRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/drives/{drive%2Did}/root/microsoft.graph.createUploadSession"
