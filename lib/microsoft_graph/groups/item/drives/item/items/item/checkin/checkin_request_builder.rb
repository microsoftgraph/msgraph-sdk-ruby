...
module MicrosoftGraph::Groups::Item::Drives::Item::Items::Item::Checkin
    ## 
    ...
    class CheckinRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/drives/{drive%2Did}/items/{driveItem%2Did}/microsoft.graph.checkin"
