...
module MicrosoftGraph::Groups::Item::Drives::Item::Items::Item::Thumbnails::Item
    ## 
    ...
    class ThumbnailSetItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/drives/{drive%2Did}/items/{driveItem%2Did}/thumbnails/{thumbnailSet%2Did}{?%24select,%24expand}"
