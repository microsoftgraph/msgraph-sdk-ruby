...
module MicrosoftGraph::Groups::Item::Drives::Item::Items::Item::Permissions
    ## 
    ...
    class PermissionsRequestBuilder
        ...
        def count()
            return MicrosoftGraph::Groups::Item::Drives::Item::Items::Item::Permissions::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/drives/{drive%2Did}/items/{driveItem%2Did}/permissions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
        ...
        ## List the effective sharing permissions on a driveItem.
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of permission_collection_response
        ## 
