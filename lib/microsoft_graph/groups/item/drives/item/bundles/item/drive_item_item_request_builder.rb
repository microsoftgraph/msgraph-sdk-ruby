...
module MicrosoftGraph::Groups::Item::Drives::Item::Bundles::Item
    ## 
    ...
    class DriveItemItemRequestBuilder
        ...
        def content()
            return MicrosoftGraph::Groups::Item::Drives::Item::Bundles::Item::Content::ContentRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/drives/{drive%2Did}/bundles/{driveItem%2Did}{?%24select,%24expand}"
