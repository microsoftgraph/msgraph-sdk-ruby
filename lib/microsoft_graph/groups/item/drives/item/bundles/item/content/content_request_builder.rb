...
module MicrosoftGraph::Groups::Item::Drives::Item::Bundles::Item::Content
    ## 
    ...
    class ContentRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/groups/{group%2Did}/drives/{drive%2Did}/bundles/{driveItem%2Did}/content"
