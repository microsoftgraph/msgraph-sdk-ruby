...
module MicrosoftGraph::Groups::Item::CheckGrantedPermissionsForApp
    ...
    class CheckGrantedPermissionsForAppRequestBuilder
        ...
        ## Invoke action checkGrantedPermissionsForApp
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of check_granted_permissions_for_app_response
        ## 
        def post(request_configuration=nil)
            ...
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraph::Groups::Item::CheckGrantedPermissionsForApp::CheckGrantedPermissionsForAppResponse.create_from_discriminator_value(pn) }, error_mapping)
        end
