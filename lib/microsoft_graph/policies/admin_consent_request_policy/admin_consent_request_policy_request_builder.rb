...
module MicrosoftGraph::Policies::AdminConsentRequestPolicy
    ## 
    ...
    class AdminConsentRequestPolicyRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/policies/adminConsentRequestPolicy{?%24select,%24expand}"
        ...
        ## Read the properties and relationships of an adminConsentRequestPolicy object.
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of admin_consent_request_policy
        ## 
