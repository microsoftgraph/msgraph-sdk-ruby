...
module MicrosoftGraph::Policies::IdentitySecurityDefaultsEnforcementPolicy
    ...
    class IdentitySecurityDefaultsEnforcementPolicyRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/policies/identitySecurityDefaultsEnforcementPolicy{?%24select,%24expand}"
        ...
        ## Retrieve the properties of an identitySecurityDefaultsEnforcementPolicy object.
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of identity_security_defaults_enforcement_policy
        ## 
