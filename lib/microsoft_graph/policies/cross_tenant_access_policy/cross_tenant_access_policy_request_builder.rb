...
module MicrosoftGraph::Policies::CrossTenantAccessPolicy
    ## 
    ...
    class CrossTenantAccessPolicyRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/policies/crossTenantAccessPolicy{?%24select,%24expand}"
        ...
        ## Read the properties and relationships of a crossTenantAccessPolicy object.
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of cross_tenant_access_policy
        ## 
