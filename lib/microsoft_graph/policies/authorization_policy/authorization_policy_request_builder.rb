...
module MicrosoftGraph::Policies::AuthorizationPolicy
    ## 
    ...
    class AuthorizationPolicyRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/policies/authorizationPolicy{?%24select,%24expand}"
        ...
        ## The policy that controls Azure AD authorization settings.
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of authorization_policy
        ## 
        ...
        class AuthorizationPolicyRequestBuilderDeleteRequestConfiguration
