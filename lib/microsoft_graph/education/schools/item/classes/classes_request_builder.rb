...
module MicrosoftGraph::Education::Schools::Item::Classes
    ## 
    ...
    class ClassesRequestBuilder
        ...
        def count()
            return MicrosoftGraph::Education::Schools::Item::Classes::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/education/schools/{educationSchool%2Did}/classes{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
