...
module MicrosoftGraph::Education::Schools::Item::AdministrativeUnit
    ## 
    ...
    class AdministrativeUnitRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/education/schools/{educationSchool%2Did}/administrativeUnit{?%24select,%24expand}"
