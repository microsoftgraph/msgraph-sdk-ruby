...
module MicrosoftGraph::Education::Users::Item::Assignments::Item::Rubric::Ref
    ## 
    ...
    class RefRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/education/users/{educationUser%2Did}/assignments/{educationAssignment%2Did}/rubric/$ref"
