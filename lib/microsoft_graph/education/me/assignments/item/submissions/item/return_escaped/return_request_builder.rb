...
module MicrosoftGraph::Education::Me::Assignments::Item::Submissions::Item::Return_escaped
    ## 
    ...
    class ReturnRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/education/me/assignments/{educationAssignment%2Did}/submissions/{educationSubmission%2Did}/microsoft.graph.return"
