...
module MicrosoftGraph::Education::Me::Assignments::Item::Rubric
    ## 
    ...
    class RubricRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/education/me/assignments/{educationAssignment%2Did}/rubric{?%24select,%24expand}"
