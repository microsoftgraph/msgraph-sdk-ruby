...
module MicrosoftGraph::Education::Classes::Item::Schools
    ## 
    ...
    class SchoolsRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/education/classes/{educationClass%2Did}/schools{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
        ...
        ## Retrieve a list of schools in which the class is taught.
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of education_school_collection_response
        ## 
