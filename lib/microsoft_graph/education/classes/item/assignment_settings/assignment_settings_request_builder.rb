...
require_relative '../../../../models/education_assignment_settings'
...
module MicrosoftGraph::Education::Classes::Item::AssignmentSettings
    ## 
    ...
    class AssignmentSettingsRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/education/classes/{educationClass%2Did}/assignmentSettings{?%24select,%24expand}"
        ...
        ## Specifies class-level assignments settings.
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of education_assignment_settings
        ## 
