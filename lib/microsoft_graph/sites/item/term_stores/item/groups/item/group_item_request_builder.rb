...
module MicrosoftGraph::Sites::Item::TermStores::Item::Groups::Item
    ## 
    ...
    class GroupItemRequestBuilder
        ...
        def sets()
            return MicrosoftGraph::Sites::Item::TermStores::Item::Groups::Item::Sets::SetsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/sites/{site%2Did}/termStores/{store%2Did}/groups/{group%2Did}{?%24select,%24expand}"
