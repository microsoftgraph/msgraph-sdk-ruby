...
module MicrosoftGraph::Sites::Item::TermStores::Item::Sets::Item::ParentGroup::Sets
    ## 
    ...
    class SetsRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/sites/{site%2Did}/termStores/{store%2Did}/sets/{set%2Did}/parentGroup/sets{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
