...
module MicrosoftGraph::Sites::Item::TermStores::Item::Sets::Item::Terms::Item::Set
    ## 
    ...
    class SetRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/sites/{site%2Did}/termStores/{store%2Did}/sets/{set%2Did}/terms/{term%2Did}/set{?%24select,%24expand}"
