...
module MicrosoftGraph::Sites::Item::TermStores
    ## 
    ...
    class TermStoresRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/sites/{site%2Did}/termStores{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
        ...
        ## The collection of termStores under this site.
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of store_collection_response
        ## 
        ...
        ## 
        # Configuration for the request such as headers, query parameters, and middleware options.
        class TermStoresRequestBuilderPostRequestConfiguration
