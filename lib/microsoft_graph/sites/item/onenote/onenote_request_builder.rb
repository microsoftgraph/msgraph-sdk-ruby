...
module MicrosoftGraph::Sites::Item::Onenote
    ## 
    ...
    class OnenoteRequestBuilder
        ...
        def notebooks()
            return MicrosoftGraph::Sites::Item::Onenote::Notebooks::NotebooksRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the operations property of the microsoft.graph.onenote entity.
        def operations()
            return MicrosoftGraph::Sites::Item::Onenote::Operations::OperationsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the pages property of the microsoft.graph.onenote entity.
        def pages()
            return MicrosoftGraph::Sites::Item::Onenote::Pages::PagesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def resources()
            return MicrosoftGraph::Sites::Item::Onenote::Resources::ResourcesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the sectionGroups property of the microsoft.graph.onenote entity.
        def section_groups()
            return MicrosoftGraph::Sites::Item::Onenote::SectionGroups::SectionGroupsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the sections property of the microsoft.graph.onenote entity.
        def sections()
            return MicrosoftGraph::Sites::Item::Onenote::Sections::SectionsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/sites/{site%2Did}/onenote{?%24select,%24expand}"
        ...
        def notebooks_by_id(id)
            ...
            return MicrosoftGraph::Sites::Item::Onenote::Notebooks::Item::NotebookItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the operations property of the microsoft.graph.onenote entity.
        ## @param id Unique identifier of the item
        ...
        def operations_by_id(id)
            ...
            return MicrosoftGraph::Sites::Item::Onenote::Operations::Item::OnenoteOperationItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the pages property of the microsoft.graph.onenote entity.
        ## @param id Unique identifier of the item
        ...
        def pages_by_id(id)
            ...
            return MicrosoftGraph::Sites::Item::Onenote::Pages::Item::OnenotePageItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def section_groups_by_id(id)
            ...
            return MicrosoftGraph::Sites::Item::Onenote::SectionGroups::Item::SectionGroupItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the sections property of the microsoft.graph.onenote entity.
        ## @param id Unique identifier of the item
