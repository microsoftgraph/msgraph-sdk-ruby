...
module MicrosoftGraph::Sites::Item::Onenote::SectionGroups::Item::ParentSectionGroup
    ## 
    ...
    class ParentSectionGroupRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/sites/{site%2Did}/onenote/sectionGroups/{sectionGroup%2Did}/parentSectionGroup{?%24select,%24expand}"
