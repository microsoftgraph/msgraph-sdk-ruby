...
module MicrosoftGraph::Sites::Item::Onenote::Pages::Item::ParentNotebook
    ## 
    ...
    class ParentNotebookRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/sites/{site%2Did}/onenote/pages/{onenotePage%2Did}/parentNotebook{?%24select,%24expand}"
