...
module MicrosoftGraph::Sites::Item::Onenote::Pages::Item::Preview
    ## 
    ...
    class PreviewRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/sites/{site%2Did}/onenote/pages/{onenotePage%2Did}/microsoft.graph.preview()"
