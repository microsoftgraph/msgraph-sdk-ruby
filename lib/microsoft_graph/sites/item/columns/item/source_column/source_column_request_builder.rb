...
module MicrosoftGraph::Sites::Item::Columns::Item::SourceColumn
    ## 
    ...
    class SourceColumnRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/sites/{site%2Did}/columns/{columnDefinition%2Did}/sourceColumn{?%24select,%24expand}"
