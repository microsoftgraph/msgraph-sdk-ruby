...
module MicrosoftGraph::Sites::Item::TermStore::Groups::Item::Sets::Item::Relations::Item::ToTerm
    ## 
    ...
    class ToTermRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/sites/{site%2Did}/termStore/groups/{group%2Did}/sets/{set%2Did}/relations/{relation%2Did}/toTerm{?%24select,%24expand}"
