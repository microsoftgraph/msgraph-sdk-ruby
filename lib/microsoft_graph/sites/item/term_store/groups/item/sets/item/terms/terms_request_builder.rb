...
module MicrosoftGraph::Sites::Item::TermStore::Groups::Item::Sets::Item::Terms
    ## 
    ...
    class TermsRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/sites/{site%2Did}/termStore/groups/{group%2Did}/sets/{set%2Did}/terms{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
