...
module MicrosoftGraph::Sites::Item::TermStore::Sets::Item::Children::Item::Relations::Item::FromTerm
    ## 
    ...
    class FromTermRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/sites/{site%2Did}/termStore/sets/{set%2Did}/children/{term%2Did}/relations/{relation%2Did}/fromTerm{?%24select,%24expand}"
