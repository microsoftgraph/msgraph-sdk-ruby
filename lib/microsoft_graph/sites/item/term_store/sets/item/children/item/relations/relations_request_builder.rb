...
module MicrosoftGraph::Sites::Item::TermStore::Sets::Item::Children::Item::Relations
    ## 
    ...
    class RelationsRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/sites/{site%2Did}/termStore/sets/{set%2Did}/children/{term%2Did}/relations{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
