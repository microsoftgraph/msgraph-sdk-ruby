...
module MicrosoftGraph::Sites::Item::TermStore::Sets::Item::Relations::Item::Set
    ## 
    ...
    class SetRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/sites/{site%2Did}/termStore/sets/{set%2Did}/relations/{relation%2Did}/set{?%24select,%24expand}"
