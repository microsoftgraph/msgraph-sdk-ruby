...
module MicrosoftGraph::Sites::Item::Lists::Item::ContentTypes::Item::Base
    ## 
    ...
    class BaseRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/sites/{site%2Did}/lists/{list%2Did}/contentTypes/{contentType%2Did}/base{?%24select,%24expand}"
