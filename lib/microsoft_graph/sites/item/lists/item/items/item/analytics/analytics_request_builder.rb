...
module MicrosoftGraph::Sites::Item::Lists::Item::Items::Item::Analytics
    ## 
    ...
    class AnalyticsRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/sites/{site%2Did}/lists/{list%2Did}/items/{listItem%2Did}/analytics{?%24select,%24expand}"
