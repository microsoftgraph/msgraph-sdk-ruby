...
module MicrosoftGraph::Sites::Item::Lists::Item::Items::Item::DocumentSetVersions
    ## 
    ...
    class DocumentSetVersionsRequestBuilder
        ...
        def count()
            return MicrosoftGraph::Sites::Item::Lists::Item::Items::Item::DocumentSetVersions::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/sites/{site%2Did}/lists/{list%2Did}/items/{listItem%2Did}/documentSetVersions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
