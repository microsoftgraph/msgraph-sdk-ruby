...
module MicrosoftGraph::Chats::Item::Messages::Item::HostedContents
    ## 
    ...
    class HostedContentsRequestBuilder
        ...
        def count()
            return MicrosoftGraph::Chats::Item::Messages::Item::HostedContents::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/chats/{chat%2Did}/messages/{chatMessage%2Did}/hostedContents{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
