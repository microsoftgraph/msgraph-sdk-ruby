...
module MicrosoftGraph::Chats::Item::InstalledApps::Item::TeamsApp
    ## 
    ...
    class TeamsAppRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/chats/{chat%2Did}/installedApps/{teamsAppInstallation%2Did}/teamsApp{?%24select,%24expand}"
