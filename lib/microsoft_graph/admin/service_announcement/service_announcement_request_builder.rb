...
module MicrosoftGraph::Admin::ServiceAnnouncement
    ## 
    ...
    class ServiceAnnouncementRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/admin/serviceAnnouncement{?%24select,%24expand}"
        ...
        ## A container for service communications resources. Read-only.
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of service_announcement
        ## 
