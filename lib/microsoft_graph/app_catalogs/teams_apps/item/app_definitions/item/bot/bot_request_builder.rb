...
module MicrosoftGraph::AppCatalogs::TeamsApps::Item::AppDefinitions::Item::Bot
    ## 
    ...
    class BotRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/appCatalogs/teamsApps/{teamsApp%2Did}/appDefinitions/{teamsAppDefinition%2Did}/bot{?%24select,%24expand}"
        ...
        ## Get the bot associated with a specific definition of the  TeamsApp.
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of teamwork_bot
        ## 
