...
module MicrosoftGraph::Workbooks::Item::Permissions::Item
    ## 
    ...
    class PermissionItemRequestBuilder
        ...
        def grant()
            return MicrosoftGraph::Workbooks::Item::Permissions::Item::Grant::GrantRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/workbooks/{driveItem%2Did}/permissions/{permission%2Did}{?%24select,%24expand}"
