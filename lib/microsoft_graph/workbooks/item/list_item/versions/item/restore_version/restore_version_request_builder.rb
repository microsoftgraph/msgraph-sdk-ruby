...
module MicrosoftGraph::Workbooks::Item::ListItem::Versions::Item::RestoreVersion
    ## 
    ...
    class RestoreVersionRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/workbooks/{driveItem%2Did}/listItem/versions/{listItemVersion%2Did}/microsoft.graph.restoreVersion"
