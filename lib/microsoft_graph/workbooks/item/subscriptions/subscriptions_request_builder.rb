...
module MicrosoftGraph::Workbooks::Item::Subscriptions
    ## 
    ...
    class SubscriptionsRequestBuilder
        ...
        def count()
            return MicrosoftGraph::Workbooks::Item::Subscriptions::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/workbooks/{driveItem%2Did}/subscriptions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
