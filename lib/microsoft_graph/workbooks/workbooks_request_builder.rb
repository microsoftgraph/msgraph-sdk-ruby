...
module MicrosoftGraph::Workbooks
    ## 
    ...
    class WorkbooksRequestBuilder
        ...
        def count()
            return MicrosoftGraph::Workbooks::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/workbooks{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
