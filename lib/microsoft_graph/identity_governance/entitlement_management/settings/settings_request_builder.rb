...
require_relative '../../../models/entitlement_management_settings'
require_relative '../../../models/o_data_errors/o_data_error'
require_relative '../../identity_governance'
require_relative '../entitlement_management'
require_relative './settings'

module MicrosoftGraph::IdentityGovernance::EntitlementManagement::Settings
    ## 
    ...
    class SettingsRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/identityGovernance/entitlementManagement/settings{?%24select,%24expand}"
        ...
        ## Retrieve the properties of an entitlementManagementSettings object.
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of entitlement_management_settings
        ## 
