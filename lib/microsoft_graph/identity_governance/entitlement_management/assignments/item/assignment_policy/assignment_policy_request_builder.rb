...
module MicrosoftGraph::IdentityGovernance::EntitlementManagement::Assignments::Item::AssignmentPolicy
    ## 
    ...
    class AssignmentPolicyRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/identityGovernance/entitlementManagement/assignments/{accessPackageAssignment%2Did}/assignmentPolicy{?%24select,%24expand}"
