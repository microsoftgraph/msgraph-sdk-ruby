...
module MicrosoftGraph::IdentityGovernance::TermsOfUse::Agreements::Item::File
    ## 
    ...
    class FileRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/identityGovernance/termsOfUse/agreements/{agreement%2Did}/file{?%24select,%24expand}"
