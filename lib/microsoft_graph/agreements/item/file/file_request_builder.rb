...
module MicrosoftGraph::Agreements::Item::File
    ## 
    ...
    class FileRequestBuilder
        ...
        def localizations()
            return MicrosoftGraph::Agreements::Item::File::Localizations::LocalizationsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/agreements/{agreement%2Did}/file{?%24select,%24expand}"
        ...
        ## Retrieve the details of the default file for an agreement, including the language and version information. The file information is specified through the agreementFile object.
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of agreement_file
        ## 
