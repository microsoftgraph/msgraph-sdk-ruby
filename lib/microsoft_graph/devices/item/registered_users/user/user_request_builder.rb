...
module MicrosoftGraph::Devices::Item::RegisteredUsers::User
    ## 
    ...
    class UserRequestBuilder
        ...
        def count()
            return MicrosoftGraph::Devices::Item::RegisteredUsers::User::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
