...
module MicrosoftGraph::Devices::Item::TransitiveMemberOf::Device
    ## 
    ...
    class DeviceRequestBuilder
        ...
        def count()
            return MicrosoftGraph::Devices::Item::TransitiveMemberOf::Device::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
