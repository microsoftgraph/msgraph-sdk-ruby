...
module MicrosoftGraph::Devices::Item::MemberOf::Device
    ## 
    ...
    class DeviceRequestBuilder
        ...
        def count()
            return MicrosoftGraph::Devices::Item::MemberOf::Device::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
