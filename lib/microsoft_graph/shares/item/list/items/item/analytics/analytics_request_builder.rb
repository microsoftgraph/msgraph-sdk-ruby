...
module MicrosoftGraph::Shares::Item::List::Items::Item::Analytics
    ## 
    ...
    class AnalyticsRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/shares/{sharedDriveItem%2Did}/list/items/{listItem%2Did}/analytics{?%24select,%24expand}"
