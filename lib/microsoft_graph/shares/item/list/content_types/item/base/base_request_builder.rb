...
module MicrosoftGraph::Shares::Item::List::ContentTypes::Item::Base
    ## 
    ...
    class BaseRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/shares/{sharedDriveItem%2Did}/list/contentTypes/{contentType%2Did}/base{?%24select,%24expand}"
