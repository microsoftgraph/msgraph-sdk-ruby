...
module MicrosoftGraph::Shares::Item::ListItem::DocumentSetVersions::Item
    ## 
    ...
    class DocumentSetVersionItemRequestBuilder
        ...
        def restore()
            return MicrosoftGraph::Shares::Item::ListItem::DocumentSetVersions::Item::Restore::RestoreRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/shares/{sharedDriveItem%2Did}/listItem/documentSetVersions/{documentSetVersion%2Did}{?%24select,%24expand}"
