...
module MicrosoftGraph::Users::Item::Planner::Plans::Item::Tasks::Item::Details
    ## 
    ...
    class DetailsRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/planner/plans/{plannerPlan%2Did}/tasks/{plannerTask%2Did}/details{?%24select,%24expand}"
