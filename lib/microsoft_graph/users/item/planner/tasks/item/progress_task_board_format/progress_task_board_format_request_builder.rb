...
module MicrosoftGraph::Users::Item::Planner::Tasks::Item::ProgressTaskBoardFormat
    ## 
    ...
    class ProgressTaskBoardFormatRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/planner/tasks/{plannerTask%2Did}/progressTaskBoardFormat{?%24select,%24expand}"
