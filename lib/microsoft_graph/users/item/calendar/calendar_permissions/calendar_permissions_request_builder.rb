...
module MicrosoftGraph::Users::Item::Calendar::CalendarPermissions
    ## 
    ...
    class CalendarPermissionsRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/calendar/calendarPermissions{?%24top,%24skip,%24filter,%24count,%24orderby,%24select}"
