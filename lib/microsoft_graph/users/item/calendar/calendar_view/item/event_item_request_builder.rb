...
module MicrosoftGraph::Users::Item::Calendar::CalendarView::Item
    ...
    class EventItemRequestBuilder
        ...
        def accept()
            return MicrosoftGraph::Users::Item::Calendar::CalendarView::Item::Accept::AcceptRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def cancel()
            return MicrosoftGraph::Users::Item::Calendar::CalendarView::Item::Cancel::CancelRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the decline method.
        def decline()
            return MicrosoftGraph::Users::Item::Calendar::CalendarView::Item::Decline::DeclineRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the dismissReminder method.
        def dismiss_reminder()
            return MicrosoftGraph::Users::Item::Calendar::CalendarView::Item::DismissReminder::DismissReminderRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def forward()
            return MicrosoftGraph::Users::Item::Calendar::CalendarView::Item::Forward::ForwardRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def tentatively_accept()
            return MicrosoftGraph::Users::Item::Calendar::CalendarView::Item::TentativelyAccept::TentativelyAcceptRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
