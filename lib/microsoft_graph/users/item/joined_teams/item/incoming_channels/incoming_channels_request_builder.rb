...
module MicrosoftGraph::Users::Item::JoinedTeams::Item::IncomingChannels
    ## 
    ...
    class IncomingChannelsRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/incomingChannels{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
        ...
        ## Get the list of incoming channels (channels shared with a team).
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of channel_collection_response
        ## 
