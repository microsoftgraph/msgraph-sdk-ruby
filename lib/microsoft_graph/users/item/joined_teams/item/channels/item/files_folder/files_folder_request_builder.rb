...
module MicrosoftGraph::Users::Item::JoinedTeams::Item::Channels::Item::FilesFolder
    ## 
    ...
    class FilesFolderRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/channels/{channel%2Did}/filesFolder{?%24select,%24expand}"
