...
module MicrosoftGraph::Users::Item::JoinedTeams::Item::Channels::Item::Members
    ## 
    ...
    class MembersRequestBuilder
        ...
        def add()
            return MicrosoftGraph::Users::Item::JoinedTeams::Item::Channels::Item::Members::Add::AddRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/channels/{channel%2Did}/members{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
