...
module MicrosoftGraph::Users::Item::JoinedTeams::Item::Schedule::SchedulingGroups
    ## 
    ...
    class SchedulingGroupsRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/schedule/schedulingGroups{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select}"
