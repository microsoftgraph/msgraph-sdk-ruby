...
module MicrosoftGraph::Users::Item::JoinedTeams::Item::Schedule::Shifts
    ## 
    ...
    class ShiftsRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/schedule/shifts{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select}"
        ...
        ## Get the list of shift instances in a schedule.
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of shift_collection_response
        ## 
