...
module MicrosoftGraph::Users::Item::JoinedTeams::Item::PrimaryChannel::FilesFolder
    ## 
    ...
    class FilesFolderRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/primaryChannel/filesFolder{?%24select,%24expand}"
