...
module MicrosoftGraph::Users::Item::Photos
    ## 
    ...
    class PhotosRequestBuilder
        ...
        def count()
            return MicrosoftGraph::Users::Item::Photos::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/photos{?%24top,%24skip,%24filter,%24count,%24orderby,%24select}"
        ...
        ## Get photos from users
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of profile_photo_collection_response
        ## 
