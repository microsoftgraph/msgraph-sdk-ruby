...
module MicrosoftGraph::Users::Item::ManagedDevices::Item::DeviceCategory
    ## 
    ...
    class DeviceCategoryRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/managedDevices/{managedDevice%2Did}/deviceCategory{?%24select,%24expand}"
