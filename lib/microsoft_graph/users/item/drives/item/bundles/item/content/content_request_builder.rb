...
module MicrosoftGraph::Users::Item::Drives::Item::Bundles::Item::Content
    ## 
    ...
    class ContentRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/drives/{drive%2Did}/bundles/{driveItem%2Did}/content"
