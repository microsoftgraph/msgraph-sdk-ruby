...
module MicrosoftGraph::Users::Item::Drives::Item::Root::Children::Item
    ...
    class DriveItemItemRequestBuilder
        ...
        def content()
            return MicrosoftGraph::Users::Item::Drives::Item::Root::Children::Item::Content::ContentRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/drives/{drive%2Did}/root/children/{driveItem%2Did}{?%24select,%24expand}"
