...
module MicrosoftGraph::Users::Item::Drives::Item::Root::Thumbnails::Item
    ## 
    ...
    class ThumbnailSetItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/drives/{drive%2Did}/root/thumbnails/{thumbnailSet%2Did}{?%24select,%24expand}"
