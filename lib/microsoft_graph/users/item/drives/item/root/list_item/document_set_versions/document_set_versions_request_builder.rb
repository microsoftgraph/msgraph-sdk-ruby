...
module MicrosoftGraph::Users::Item::Drives::Item::Root::ListItem::DocumentSetVersions
    ## 
    ...
    class DocumentSetVersionsRequestBuilder
        ...
        def count()
            return MicrosoftGraph::Users::Item::Drives::Item::Root::ListItem::DocumentSetVersions::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/drives/{drive%2Did}/root/listItem/documentSetVersions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
