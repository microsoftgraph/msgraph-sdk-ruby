...
module MicrosoftGraph::Users::Item::Drives::Item::Root::ListItem::DocumentSetVersions::Item
    ## 
    ...
    class DocumentSetVersionItemRequestBuilder
        ...
        def restore()
            return MicrosoftGraph::Users::Item::Drives::Item::Root::ListItem::DocumentSetVersions::Item::Restore::RestoreRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/drives/{drive%2Did}/root/listItem/documentSetVersions/{documentSetVersion%2Did}{?%24select,%24expand}"
