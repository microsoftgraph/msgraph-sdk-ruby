...
module MicrosoftGraph::Users::Item::Drives::Item::Root::ListItem::Versions::Item::Fields
    ## 
    ...
    class FieldsRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/drives/{drive%2Did}/root/listItem/versions/{listItemVersion%2Did}/fields{?%24select,%24expand}"
