...
module MicrosoftGraph::Users::Item::Drives::Item::List::Columns::Item::SourceColumn
    ## 
    ...
    class SourceColumnRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/drives/{drive%2Did}/list/columns/{columnDefinition%2Did}/sourceColumn{?%24select,%24expand}"
