...
module MicrosoftGraph::Users::Item::Drives::Item::List::ContentTypes::Item::ColumnLinks
    ## 
    ...
    class ColumnLinksRequestBuilder
        ...
        def count()
            return MicrosoftGraph::Users::Item::Drives::Item::List::ContentTypes::Item::ColumnLinks::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/drives/{drive%2Did}/list/contentTypes/{contentType%2Did}/columnLinks{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
