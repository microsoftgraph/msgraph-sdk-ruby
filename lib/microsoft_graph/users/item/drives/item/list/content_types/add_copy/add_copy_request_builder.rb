...
module MicrosoftGraph::Users::Item::Drives::Item::List::ContentTypes::AddCopy
    ## 
    ...
    class AddCopyRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/drives/{drive%2Did}/list/contentTypes/microsoft.graph.addCopy"
