...
module MicrosoftGraph::Users::Item::Drives::Item::List::Subscriptions::Item
    ## 
    ...
    class SubscriptionItemRequestBuilder
        ...
        def reauthorize()
            return MicrosoftGraph::Users::Item::Drives::Item::List::Subscriptions::Item::Reauthorize::ReauthorizeRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/drives/{drive%2Did}/list/subscriptions/{subscription%2Did}{?%24select,%24expand}"
