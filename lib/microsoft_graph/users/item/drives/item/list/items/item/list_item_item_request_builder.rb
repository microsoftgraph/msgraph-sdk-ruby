...
module MicrosoftGraph::Users::Item::Drives::Item::List::Items::Item
    ## 
    ...
    class ListItemItemRequestBuilder
        ...
        def analytics()
            return MicrosoftGraph::Users::Item::Drives::Item::List::Items::Item::Analytics::AnalyticsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the documentSetVersions property of the microsoft.graph.listItem entity.
        def document_set_versions()
            return MicrosoftGraph::Users::Item::Drives::Item::List::Items::Item::DocumentSetVersions::DocumentSetVersionsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the driveItem property of the microsoft.graph.listItem entity.
        def drive_item()
            return MicrosoftGraph::Users::Item::Drives::Item::List::Items::Item::DriveItem::DriveItemRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the fields property of the microsoft.graph.listItem entity.
        def fields()
            return MicrosoftGraph::Users::Item::Drives::Item::List::Items::Item::Fields::FieldsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def versions()
            return MicrosoftGraph::Users::Item::Drives::Item::List::Items::Item::Versions::VersionsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/drives/{drive%2Did}/list/items/{listItem%2Did}{?%24select,%24expand}"
        ...
        def document_set_versions_by_id(id)
            ...
            return MicrosoftGraph::Users::Item::Drives::Item::List::Items::Item::DocumentSetVersions::Item::DocumentSetVersionItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## All items contained in the list.
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ...
        def versions_by_id(id)
            ...
            return MicrosoftGraph::Users::Item::Drives::Item::List::Items::Item::Versions::Item::ListItemVersionItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
