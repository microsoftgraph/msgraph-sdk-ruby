...
module MicrosoftGraph::Users::Item::Drives::Item::List::Items::Item::Fields
    ## 
    ...
    class FieldsRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/drives/{drive%2Did}/list/items/{listItem%2Did}/fields{?%24select,%24expand}"
