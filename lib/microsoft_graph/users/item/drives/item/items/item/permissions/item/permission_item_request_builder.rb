...
module MicrosoftGraph::Users::Item::Drives::Item::Items::Item::Permissions::Item
    ## 
    ...
    class PermissionItemRequestBuilder
        ...
        def grant()
            return MicrosoftGraph::Users::Item::Drives::Item::Items::Item::Permissions::Item::Grant::GrantRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/drives/{drive%2Did}/items/{driveItem%2Did}/permissions/{permission%2Did}{?%24select,%24expand}"
