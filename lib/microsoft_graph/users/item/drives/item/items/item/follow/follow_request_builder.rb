...
module MicrosoftGraph::Users::Item::Drives::Item::Items::Item::Follow
    ## 
    ...
    class FollowRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/drives/{drive%2Did}/items/{driveItem%2Did}/microsoft.graph.follow"
