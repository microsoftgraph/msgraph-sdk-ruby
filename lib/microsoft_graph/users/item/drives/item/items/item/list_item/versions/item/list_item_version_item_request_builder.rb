...
module MicrosoftGraph::Users::Item::Drives::Item::Items::Item::ListItem::Versions::Item
    ...
    class ListItemVersionItemRequestBuilder
        ...
        def fields()
            return MicrosoftGraph::Users::Item::Drives::Item::Items::Item::ListItem::Versions::Item::Fields::FieldsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def restore_version()
            return MicrosoftGraph::Users::Item::Drives::Item::Items::Item::ListItem::Versions::Item::RestoreVersion::RestoreVersionRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/drives/{drive%2Did}/items/{driveItem%2Did}/listItem/versions/{listItemVersion%2Did}{?%24select,%24expand}"
