...
module MicrosoftGraph::Users::Item::Drives::Item::Items::Item::Checkin
    ## 
    ...
    class CheckinRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/drives/{drive%2Did}/items/{driveItem%2Did}/microsoft.graph.checkin"
