...
module MicrosoftGraph::Users::Item::Drives::Item::Items::Item::ListItem::Versions::Item::Fields
    ## 
    ...
    class FieldsRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/drives/{drive%2Did}/items/{driveItem%2Did}/listItem/versions/{listItemVersion%2Did}/fields{?%24select,%24expand}"
