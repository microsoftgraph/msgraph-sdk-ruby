...
module MicrosoftGraph::Users::Item::DirectReports
    ## 
    ...
    class DirectReportsRequestBuilder
        ...
        def count()
            return MicrosoftGraph::Users::Item::DirectReports::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Casts the previous resource to orgContact.
        def org_contact()
            return MicrosoftGraph::Users::Item::DirectReports::OrgContact::OrgContactRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def user()
            return MicrosoftGraph::Users::Item::DirectReports::User::UserRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/directReports{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
