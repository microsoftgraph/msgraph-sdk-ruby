...
module MicrosoftGraph::Users::Item::Onenote::Notebooks::Item::Sections::Item::Pages::Item::Preview
    ## 
    ...
    class PreviewRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/onenote/notebooks/{notebook%2Did}/sections/{onenoteSection%2Did}/pages/{onenotePage%2Did}/microsoft.graph.preview()"
