...
module MicrosoftGraph::Users::Item::Onenote::Sections::Item::Pages::Item::ParentNotebook
    ## 
    ...
    class ParentNotebookRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/onenote/sections/{onenoteSection%2Did}/pages/{onenotePage%2Did}/parentNotebook{?%24select,%24expand}"
