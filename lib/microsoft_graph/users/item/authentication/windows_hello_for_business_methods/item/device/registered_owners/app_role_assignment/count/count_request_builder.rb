...
module MicrosoftGraph::Users::Item::Authentication::WindowsHelloForBusinessMethods::Item::Device::RegisteredOwners::AppRoleAssignment::Count
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/authentication/windowsHelloForBusinessMethods/{windowsHelloForBusinessAuthenticationMethod%2Did}/device/registeredOwners/microsoft.graph.appRoleAssignment/$count"
