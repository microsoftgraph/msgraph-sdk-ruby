...
module MicrosoftGraph::Users::Item::Authentication::SoftwareOathMethods
    ## 
    ...
    class SoftwareOathMethodsRequestBuilder
        ...
        def count()
            return MicrosoftGraph::Users::Item::Authentication::SoftwareOathMethods::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/authentication/softwareOathMethods{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
        ...
        ## Retrieve a list of a user's software OATH token authentication method objects and their properties.
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of software_oath_authentication_method_collection_response
        ## 
