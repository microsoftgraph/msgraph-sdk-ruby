...
module MicrosoftGraph::Users::Item::Chats::Item::Members::Item
    ## 
    ...
    class ConversationMemberItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/chats/{chat%2Did}/members/{conversationMember%2Did}{?%24select,%24expand}"
