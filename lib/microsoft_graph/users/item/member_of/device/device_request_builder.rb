...
module MicrosoftGraph::Users::Item::MemberOf::Device
    ## 
    ...
    class DeviceRequestBuilder
        ...
        def count()
            return MicrosoftGraph::Users::Item::MemberOf::Device::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
