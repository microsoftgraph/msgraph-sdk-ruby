...
module MicrosoftGraph::Users::Item::OnlineMeetings::Item::AttendeeReport
    ## 
    ...
    class AttendeeReportRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/onlineMeetings/{onlineMeeting%2Did}/attendeeReport"
