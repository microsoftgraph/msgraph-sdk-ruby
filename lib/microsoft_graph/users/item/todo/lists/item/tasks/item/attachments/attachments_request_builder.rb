...
require_relative '../../../../../../../../models/attachment_base_collection_response'
...
module MicrosoftGraph::Users::Item::Todo::Lists::Item::Tasks::Item::Attachments
    ## 
    ...
    class AttachmentsRequestBuilder
        ...
        def count()
            return MicrosoftGraph::Users::Item::Todo::Lists::Item::Tasks::Item::Attachments::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the createUploadSession method.
        def create_upload_session()
            return MicrosoftGraph::Users::Item::Todo::Lists::Item::Tasks::Item::Attachments::CreateUploadSession::CreateUploadSessionRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/todo/lists/{todoTaskList%2Did}/tasks/{todoTask%2Did}/attachments{?%24top,%24skip,%24filter,%24count,%24orderby,%24select}"
        ...
        ## Get attachments from users
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of attachment_base_collection_response
        ## 
        ...
        ## @param body The request body
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of attachment_base
        ## 
