...
module MicrosoftGraph::Users::Item::ManagedAppRegistrations
    ## 
    ...
    class ManagedAppRegistrationsRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/users/{user%2Did}/managedAppRegistrations{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
        ...
        ## Zero or more managed app registrations that belong to the user.
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of managed_app_registration_collection_response
        ## 
