...
module MicrosoftGraph::Users::Item::OwnedDevices::Device
    ## 
    ...
    class DeviceRequestBuilder
        ...
        def count()
            return MicrosoftGraph::Users::Item::OwnedDevices::Device::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
