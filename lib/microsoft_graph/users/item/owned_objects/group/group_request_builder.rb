...
module MicrosoftGraph::Users::Item::OwnedObjects::Group
    ## 
    ...
    class GroupRequestBuilder
        ...
        def count()
            return MicrosoftGraph::Users::Item::OwnedObjects::Group::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
