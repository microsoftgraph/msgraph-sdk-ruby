...
module MicrosoftGraph::Users::Item::TransitiveMemberOf::Device
    ## 
    ...
    class DeviceRequestBuilder
        ...
        def count()
            return MicrosoftGraph::Users::Item::TransitiveMemberOf::Device::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
