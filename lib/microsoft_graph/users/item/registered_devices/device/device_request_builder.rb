...
module MicrosoftGraph::Users::Item::RegisteredDevices::Device
    ## 
    ...
    class DeviceRequestBuilder
        ...
        def count()
            return MicrosoftGraph::Users::Item::RegisteredDevices::Device::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
