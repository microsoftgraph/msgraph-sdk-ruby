...
module MicrosoftGraph::Drives::Item::Root::Permissions::Item
    ...
    class PermissionItemRequestBuilder
        ...
        def grant()
            return MicrosoftGraph::Drives::Item::Root::Permissions::Item::Grant::GrantRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/drives/{drive%2Did}/root/permissions/{permission%2Did}{?%24select,%24expand}"
