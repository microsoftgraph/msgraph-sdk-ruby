...
module MicrosoftGraph::Drives::Item::Root::ListItem::DocumentSetVersions::Item::Restore
    ## 
    ...
    class RestoreRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/drives/{drive%2Did}/root/listItem/documentSetVersions/{documentSetVersion%2Did}/microsoft.graph.restore"
