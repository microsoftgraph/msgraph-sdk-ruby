...
module MicrosoftGraph::Drives::Item::Root::Versions
    ## 
    ...
    class VersionsRequestBuilder
        ...
        def count()
            return MicrosoftGraph::Drives::Item::Root::Versions::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/drives/{drive%2Did}/root/versions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
