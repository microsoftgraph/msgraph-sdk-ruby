...
module MicrosoftGraph::Directory::DeletedItems::User
    ## 
    ...
    class UserRequestBuilder
        ...
        def count()
            return MicrosoftGraph::Directory::DeletedItems::User::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
