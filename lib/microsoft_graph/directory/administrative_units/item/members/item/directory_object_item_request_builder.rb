...
module MicrosoftGraph::Directory::AdministrativeUnits::Item::Members::Item
    ...
    class DirectoryObjectItemRequestBuilder
        ...
        def application()
            return MicrosoftGraph::Directory::AdministrativeUnits::Item::Members::Item::Application::ApplicationRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Casts the previous resource to device.
        def device()
            return MicrosoftGraph::Directory::AdministrativeUnits::Item::Members::Item::Device::DeviceRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Casts the previous resource to group.
        def group()
            return MicrosoftGraph::Directory::AdministrativeUnits::Item::Members::Item::Group::GroupRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Casts the previous resource to orgContact.
        def org_contact()
            return MicrosoftGraph::Directory::AdministrativeUnits::Item::Members::Item::OrgContact::OrgContactRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def service_principal()
            return MicrosoftGraph::Directory::AdministrativeUnits::Item::Members::Item::ServicePrincipal::ServicePrincipalRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def user()
            return MicrosoftGraph::Directory::AdministrativeUnits::Item::Members::Item::User::UserRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
