...
module MicrosoftGraph::Directory::AdministrativeUnits::Item::Members::Device
    ## 
    ...
    class DeviceRequestBuilder
        ...
        def count()
            return MicrosoftGraph::Directory::AdministrativeUnits::Item::Members::Device::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
