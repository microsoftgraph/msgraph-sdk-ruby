...
module MicrosoftGraph::Branding::Localizations::Item::BackgroundImage
    ## 
    ...
    class BackgroundImageRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/branding/localizations/{organizationalBrandingLocalization%2Did}/backgroundImage"
