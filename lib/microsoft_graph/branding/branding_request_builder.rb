...
module MicrosoftGraph::Branding
    ## 
    ...
    class BrandingRequestBuilder
        ...
        def background_image()
            return MicrosoftGraph::Branding::BackgroundImage::BackgroundImageRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the media for the organizationalBranding entity.
        def banner_logo()
            return MicrosoftGraph::Branding::BannerLogo::BannerLogoRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the localizations property of the microsoft.graph.organizationalBranding entity.
        def localizations()
            return MicrosoftGraph::Branding::Localizations::LocalizationsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        # Provides operations to manage the media for the organizationalBranding entity.
        def square_logo()
            return MicrosoftGraph::Branding::SquareLogo::SquareLogoRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/branding{?%24select,%24expand}"
        ...
        ## Get branding
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of organizational_branding
        ## 
