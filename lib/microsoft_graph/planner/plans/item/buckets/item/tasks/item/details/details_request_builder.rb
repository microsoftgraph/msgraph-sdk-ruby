...
module MicrosoftGraph::Planner::Plans::Item::Buckets::Item::Tasks::Item::Details
    ## 
    ...
    class DetailsRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/planner/plans/{plannerPlan%2Did}/buckets/{plannerBucket%2Did}/tasks/{plannerTask%2Did}/details{?%24select,%24expand}"
