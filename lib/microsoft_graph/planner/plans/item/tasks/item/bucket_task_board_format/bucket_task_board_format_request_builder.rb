...
module MicrosoftGraph::Planner::Plans::Item::Tasks::Item::BucketTaskBoardFormat
    ## 
    ...
    class BucketTaskBoardFormatRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/planner/plans/{plannerPlan%2Did}/tasks/{plannerTask%2Did}/bucketTaskBoardFormat{?%24select,%24expand}"
