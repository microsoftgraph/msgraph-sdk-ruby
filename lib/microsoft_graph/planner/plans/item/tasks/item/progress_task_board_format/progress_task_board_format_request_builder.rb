...
module MicrosoftGraph::Planner::Plans::Item::Tasks::Item::ProgressTaskBoardFormat
    ## 
    ...
    class ProgressTaskBoardFormatRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/planner/plans/{plannerPlan%2Did}/tasks/{plannerTask%2Did}/progressTaskBoardFormat{?%24select,%24expand}"
