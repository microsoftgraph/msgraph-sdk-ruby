...
module MicrosoftGraph::Planner::Tasks::Item::AssignedToTaskBoardFormat
    ## 
    ...
    class AssignedToTaskBoardFormatRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/planner/tasks/{plannerTask%2Did}/assignedToTaskBoardFormat{?%24select,%24expand}"
