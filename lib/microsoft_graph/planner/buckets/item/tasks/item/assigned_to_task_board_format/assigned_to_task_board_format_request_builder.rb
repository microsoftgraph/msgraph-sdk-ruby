...
module MicrosoftGraph::Planner::Buckets::Item::Tasks::Item::AssignedToTaskBoardFormat
    ## 
    ...
    class AssignedToTaskBoardFormatRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/planner/buckets/{plannerBucket%2Did}/tasks/{plannerTask%2Did}/assignedToTaskBoardFormat{?%24select,%24expand}"
