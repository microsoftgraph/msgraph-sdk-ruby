...
module MicrosoftGraph::Teams::Item::Schedule::TimesOff
    ## 
    ...
    class TimesOffRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/teams/{team%2Did}/schedule/timesOff{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select}"
