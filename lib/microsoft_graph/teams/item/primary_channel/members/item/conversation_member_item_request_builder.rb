...
module MicrosoftGraph::Teams::Item::PrimaryChannel::Members::Item
    ## 
    ...
    class ConversationMemberItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/teams/{team%2Did}/primaryChannel/members/{conversationMember%2Did}{?%24select,%24expand}"
