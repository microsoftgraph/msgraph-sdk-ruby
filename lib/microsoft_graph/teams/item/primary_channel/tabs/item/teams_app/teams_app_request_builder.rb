...
module MicrosoftGraph::Teams::Item::PrimaryChannel::Tabs::Item::TeamsApp
    ## 
    ...
    class TeamsAppRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/teams/{team%2Did}/primaryChannel/tabs/{teamsTab%2Did}/teamsApp{?%24select,%24expand}"
