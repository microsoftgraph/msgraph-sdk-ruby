...
module MicrosoftGraph::Teams::Item::Channels::Item::Members::Item
    ## 
    ...
    class ConversationMemberItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/teams/{team%2Did}/channels/{channel%2Did}/members/{conversationMember%2Did}{?%24select,%24expand}"
