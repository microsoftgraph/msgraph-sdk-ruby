...
module MicrosoftGraph::Teams::Item::Channels::Item::SharedWithTeams
    ## 
    ...
    class SharedWithTeamsRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/teams/{team%2Did}/channels/{channel%2Did}/sharedWithTeams{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
