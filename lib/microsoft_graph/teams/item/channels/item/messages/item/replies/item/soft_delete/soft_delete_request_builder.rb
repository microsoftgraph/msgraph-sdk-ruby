...
module MicrosoftGraph::Teams::Item::Channels::Item::Messages::Item::Replies::Item::SoftDelete
    ## 
    ...
    class SoftDeleteRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/teams/{team%2Did}/channels/{channel%2Did}/messages/{chatMessage%2Did}/replies/{chatMessage%2Did1}/microsoft.graph.softDelete"
