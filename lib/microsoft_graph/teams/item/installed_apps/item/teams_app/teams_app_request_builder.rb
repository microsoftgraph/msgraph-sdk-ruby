...
module MicrosoftGraph::Teams::Item::InstalledApps::Item::TeamsApp
    ## 
    ...
    class TeamsAppRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/teams/{team%2Did}/installedApps/{teamsAppInstallation%2Did}/teamsApp{?%24select,%24expand}"
