...
module MicrosoftGraph::Print::Shares::Item::AllowedUsers
    ## 
    ...
    class AllowedUsersRequestBuilder
        ...
        def count()
            return MicrosoftGraph::Print::Shares::Item::AllowedUsers::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/print/shares/{printerShare%2Did}/allowedUsers{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
