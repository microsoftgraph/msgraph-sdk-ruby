...
module MicrosoftGraph::Print::Printers::Item::TaskTriggers::Item::Definition
    ## 
    ...
    class DefinitionRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/print/printers/{printer%2Did}/taskTriggers/{printTaskTrigger%2Did}/definition{?%24select,%24expand}"
