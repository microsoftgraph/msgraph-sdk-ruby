...
module MicrosoftGraph::Communications::CallRecords::GetPstnCallsWithFromDateTimeWithToDateTime
    ...
    class GetPstnCallsWithFromDateTimeWithToDateTimeRequestBuilder
        ...
        ## Invoke function getPstnCalls
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of get_pstn_calls_with_from_date_time_with_to_date_time_response
        ## 
        def get(request_configuration=nil)
            ...
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraph::Communications::CallRecords::GetPstnCallsWithFromDateTimeWithToDateTime::GetPstnCallsWithFromDateTimeWithToDateTimeResponse.create_from_discriminator_value(pn) }, error_mapping)
        end
