...
module MicrosoftGraph::Communications::OnlineMeetings::Item::AttendeeReport
    ## 
    ...
    class AttendeeReportRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/communications/onlineMeetings/{onlineMeeting%2Did}/attendeeReport"
