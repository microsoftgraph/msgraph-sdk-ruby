...
module MicrosoftGraph::DeviceAppManagement::MdmWindowsInformationProtectionPolicies
    ...
    class MdmWindowsInformationProtectionPoliciesRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/deviceAppManagement/mdmWindowsInformationProtectionPolicies{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
        ...
        ## Windows information protection for apps running on devices which are MDM enrolled.
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of mdm_windows_information_protection_policy_collection_response
        ## 
        ...
        ## @param body The request body
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of mdm_windows_information_protection_policy
        ## 
