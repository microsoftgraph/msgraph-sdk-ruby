...
module MicrosoftGraph::DeviceAppManagement::MobileAppConfigurations::Item::DeviceStatuses
    ## 
    ...
    class DeviceStatusesRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/deviceAppManagement/mobileAppConfigurations/{managedDeviceMobileAppConfiguration%2Did}/deviceStatuses{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
        ...
        ## List of ManagedDeviceMobileAppConfigurationDeviceStatus.
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of managed_device_mobile_app_configuration_device_status_collection_response
        ## 
        ...
        ## @param body The request body
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of managed_device_mobile_app_configuration_device_status
        ## 
