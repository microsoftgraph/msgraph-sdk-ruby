...
module MicrosoftGraph::DeviceAppManagement::MobileAppConfigurations::Item::UserStatusSummary
    ## 
    ...
    class UserStatusSummaryRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/deviceAppManagement/mobileAppConfigurations/{managedDeviceMobileAppConfiguration%2Did}/userStatusSummary{?%24select,%24expand}"
        ...
        ## App configuration user status summary.
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of managed_device_mobile_app_configuration_user_summary
        ## 
