...
module MicrosoftGraph::DeviceAppManagement::DefaultManagedAppProtections::Item::DeploymentSummary
    ## 
    ...
    class DeploymentSummaryRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/deviceAppManagement/defaultManagedAppProtections/{defaultManagedAppProtection%2Did}/deploymentSummary{?%24select,%24expand}"
        ...
        ## Navigation property to deployment summary of the configuration.
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of managed_app_policy_deployment_summary
        ## 
