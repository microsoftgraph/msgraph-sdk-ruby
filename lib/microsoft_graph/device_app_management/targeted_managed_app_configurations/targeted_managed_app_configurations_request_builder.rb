...
module MicrosoftGraph::DeviceAppManagement::TargetedManagedAppConfigurations
    ...
    class TargetedManagedAppConfigurationsRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/deviceAppManagement/targetedManagedAppConfigurations{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
        ...
        ## Targeted managed app configurations.
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
        ## @return a CompletableFuture of targeted_managed_app_configuration_collection_response
        ## 
