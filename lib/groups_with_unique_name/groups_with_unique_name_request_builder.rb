    ...
    module GroupsWithUniqueName
        ...
        class GroupsWithUniqueNameRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
            ...
            def initialize(path_parameters, request_adapter, unique_name=nil)
                super(path_parameters, request_adapter, "{+baseurl}/groups(uniqueName='{uniqueName}'){?%24expand,%24select}")
            end
            ## 
            ...
            def to_delete_request_information(request_configuration=nil)
                ...
                request_info.url_template = '{+baseurl}/groups(uniqueName='{uniqueName}')'
            ...
            def with_url(raw_url)
                ...
                return GroupsWithUniqueNameRequestBuilder.new(raw_url, @request_adapter)
            end
