    ...
    module InformationProtection
        module ThreatAssessmentRequests
            module Item
                ...
                class ThreatAssessmentRequestItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    
                    ## 
                    # Provides operations to manage the results property of the microsoft.graph.threatAssessmentRequest entity.
                    def results()
                        return MicrosoftGraph::InformationProtection::ThreatAssessmentRequests::Item::Results::ResultsRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ...
                    def initialize(path_parameters, request_adapter)
                        super(path_parameters, request_adapter, "{+baseurl}/informationProtection/threatAssessmentRequests/{threatAssessmentRequest%2Did}{?%24expand,%24select}")
                    end
                    ## 
                    ...
                    def to_delete_request_information(request_configuration=nil)
                        ...
                        request_info.url_template = '{+baseurl}/informationProtection/threatAssessmentRequests/{threatAssessmentRequest%2Did}'
                    ...
                    def with_url(raw_url)
                        ...
                        return ThreatAssessmentRequestItemRequestBuilder.new(raw_url, @request_adapter)
                    end
