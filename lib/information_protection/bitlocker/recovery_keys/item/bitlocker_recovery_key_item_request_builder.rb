...
module MicrosoftGraph::InformationProtection::Bitlocker::RecoveryKeys::Item
    ## 
    ...
    class BitlockerRecoveryKeyItemRequestBuilder
        ...
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, bitlocker_recovery_key_id=nil)
            raise StandardError, 'path_parameters cannot be null' if path_parameters.nil?
            raise StandardError, 'request_adapter cannot be null' if request_adapter.nil?
            @url_template = "{+baseurl}/informationProtection/bitlocker/recoveryKeys/{bitlockerRecoveryKey%2Did}{?%24select,%24expand}"
        ...
        def get(request_configuration=nil)
            ...
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraph::Models::BitlockerRecoveryKey.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
        ## The recovery keys associated with the bitlocker entity.
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
