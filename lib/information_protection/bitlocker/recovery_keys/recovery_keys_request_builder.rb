...
require_relative '../../../models/bitlocker_recovery_key_collection_response'
    ...
    module InformationProtection
        module Bitlocker
            module RecoveryKeys
                ...
                class RecoveryKeysRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def initialize(path_parameters, request_adapter)
                        super(path_parameters, request_adapter, "{+baseurl}/informationProtection/bitlocker/recoveryKeys{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}")
                    end
                    ## 
                    ...
                    ## @return a recovery_keys_request_builder
                    ## 
                    def with_url(raw_url)
                        raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                        return RecoveryKeysRequestBuilder.new(raw_url, @request_adapter)
                    end
