        ...
        module Bitlocker
            ...
            class BitlockerRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def initialize(path_parameters, request_adapter)
                    super(path_parameters, request_adapter, "{+baseurl}/informationProtection/bitlocker{?%24expand,%24select}")
                end
                ## 
                ...
                ## @return a bitlocker_request_builder
                ## 
                def with_url(raw_url)
                    raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                    return BitlockerRequestBuilder.new(raw_url, @request_adapter)
                end
