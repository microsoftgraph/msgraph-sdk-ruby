...
require_relative './deleted_chats/deleted_chats_request_builder'
...
require_relative './teams_app_settings/teams_app_settings_request_builder'
...
module MicrosoftGraph
    module Teamwork
        ...
        class TeamworkRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
            ...
            def deleted_chats()
                return MicrosoftGraph::Teamwork::DeletedChats::DeletedChatsRequestBuilder.new(@path_parameters, @request_adapter)
            end
            ## 
            ...
            def teams_app_settings()
                return MicrosoftGraph::Teamwork::TeamsAppSettings::TeamsAppSettingsRequestBuilder.new(@path_parameters, @request_adapter)
            end
            ## 
            ...
            def initialize(path_parameters, request_adapter)
                super(path_parameters, request_adapter, "{+baseurl}/teamwork{?%24expand,%24select}")
            end
            ## 
            ## Get teamwork
            ...
            def to_patch_request_information(body, request_configuration=nil)
                ...
                request_info.url_template = '{+baseurl}/teamwork'
                request_info.path_parameters = @path_parameters
