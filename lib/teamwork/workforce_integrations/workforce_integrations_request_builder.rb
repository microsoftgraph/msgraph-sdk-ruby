...
require_relative '../../models/workforce_integration'
...
module MicrosoftGraph
    module Teamwork
        module WorkforceIntegrations
            ## 
            # Provides operations to manage the workforceIntegrations property of the microsoft.graph.teamwork entity.
            class WorkforceIntegrationsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def initialize(path_parameters, request_adapter)
                    super(path_parameters, request_adapter, "{+baseurl}/teamwork/workforceIntegrations{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}")
                end
                ## 
                ...
                def to_post_request_information(body, request_configuration=nil)
                    ...
                    request_info.url_template = '{+baseurl}/teamwork/workforceIntegrations'
                    request_info.path_parameters = @path_parameters
                ...
                ## @return a workforce_integrations_request_builder
                ## 
                def with_url(raw_url)
                    raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                    return WorkforceIntegrationsRequestBuilder.new(raw_url, @request_adapter)
                end
