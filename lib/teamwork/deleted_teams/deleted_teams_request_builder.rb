...
module MicrosoftGraph
    module Teamwork
        module DeletedTeams
            ...
            class DeletedTeamsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                
                ## 
                # Provides operations to count the resources in the collection.
                def count()
                    return MicrosoftGraph::Teamwork::DeletedTeams::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                ...
                def initialize(path_parameters, request_adapter)
                    super(path_parameters, request_adapter, "{+baseurl}/teamwork/deletedTeams{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}")
                end
                ## 
                ...
                def to_post_request_information(body, request_configuration=nil)
                    ...
                    request_info.url_template = '{+baseurl}/teamwork/deletedTeams'
                    request_info.path_parameters = @path_parameters
                ...
                ## @return a deleted_teams_request_builder
                ## 
                def with_url(raw_url)
                    raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                    return DeletedTeamsRequestBuilder.new(raw_url, @request_adapter)
                end
