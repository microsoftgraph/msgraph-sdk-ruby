                            ...
                            module Item
                                ...
                                class ChatMessageItemRequestBuilder
                                    ...
                                    def microsoft_graph_soft_delete()
                                        return MicrosoftGraph::Teamwork::DeletedTeams::Item::Channels::Item::Messages::Item::MicrosoftGraphSoftDelete::MicrosoftGraphSoftDeleteRequestBuilder.new(@path_parameters, @request_adapter)
                                    end
                                    ## 
                                    # Provides operations to call the undoSoftDelete method.
                                    def microsoft_graph_undo_soft_delete()
                                        return MicrosoftGraph::Teamwork::DeletedTeams::Item::Channels::Item::Messages::Item::MicrosoftGraphUndoSoftDelete::MicrosoftGraphUndoSoftDeleteRequestBuilder.new(@path_parameters, @request_adapter)
                                    end
                                    ## 
                                    ...
                                    def initialize(path_parameters, request_adapter)
                                        ...
                                        @url_template = "{+baseurl}/teamwork/deletedTeams/{deletedTeam%2Did}/channels/{channel%2Did}/messages/{chatMessage%2Did}{?%24select,%24expand}"
