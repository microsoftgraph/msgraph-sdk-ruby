                        ...
                        module Tabs
                            module Item
                                module TeamsApp
                                    ...
                                    class TeamsAppRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                        ...
                                        def initialize(path_parameters, request_adapter)
                                            super(path_parameters, request_adapter, "{+baseurl}/teamwork/deletedTeams/{deletedTeam%2Did}/channels/{channel%2Did}/tabs/{teamsTab%2Did}/teamsApp{?%24select,%24expand}")
                                        end
                                        ## 
                                        ...
                                        ## @return a teams_app_request_builder
                                        ## 
                                        def with_url(raw_url)
                                            raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                                            return TeamsAppRequestBuilder.new(raw_url, @request_adapter)
                                        end
