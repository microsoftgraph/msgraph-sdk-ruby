            ...
            module Item
                module Channels
                    ...
                    class ChannelsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def count()
                            return MicrosoftGraph::Teamwork::DeletedTeams::Item::Channels::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ...
                        def get_all_retained_messages()
                            return MicrosoftGraph::Teamwork::DeletedTeams::Item::Channels::GetAllRetainedMessages::GetAllRetainedMessagesRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ## Provides operations to manage the channels property of the microsoft.graph.deletedTeam entity.
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/teamwork/deletedTeams/{deletedTeam%2Did}/channels{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}")
                        end
                        ## 
