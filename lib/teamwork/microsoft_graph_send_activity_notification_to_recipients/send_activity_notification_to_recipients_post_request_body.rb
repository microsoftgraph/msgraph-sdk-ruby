...
require_relative './microsoft_graph_send_activity_notification_to_recipients'

module MicrosoftGraph
    module Teamwork
        module MicrosoftGraphSendActivityNotificationToRecipients
            class SendActivityNotificationToRecipientsPostRequestBody
                ...
                ## @return a send_activity_notification_to_recipients_post_request_body
                ## 
                def self.create_from_discriminator_value(parse_node)
                    raise StandardError, 'parse_node cannot be null' if parse_node.nil?
                    return SendActivityNotificationToRecipientsPostRequestBody.new
                end
                ## 
