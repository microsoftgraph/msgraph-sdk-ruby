...
module MicrosoftGraph::Chats::Item::Messages::Item
    ...
    class ChatMessageItemRequestBuilder
        ...
        def microsoft_graph_soft_delete()
            return MicrosoftGraph::Chats::Item::Messages::Item::MicrosoftGraphSoftDelete::SoftDeleteRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the undoSoftDelete method.
        def microsoft_graph_undo_soft_delete()
            return MicrosoftGraph::Chats::Item::Messages::Item::MicrosoftGraphUndoSoftDelete::UndoSoftDeleteRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
