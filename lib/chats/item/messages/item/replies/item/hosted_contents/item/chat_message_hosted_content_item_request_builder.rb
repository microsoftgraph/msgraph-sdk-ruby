...
module MicrosoftGraph::Chats::Item::Messages::Item::Replies::Item::HostedContents::Item
    ## 
    ...
    class ChatMessageHostedContentItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, chat_message_hosted_content_id=)
            ...
            @url_template = "{+baseurl}/chats/{chat%2Did}/messages/{chatMessage%2Did}/replies/{chatMessage%2Did1}/hostedContents/{chatMessageHostedContent%2Did}{?%24select,%24expand}"
