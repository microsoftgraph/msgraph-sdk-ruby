...
module MicrosoftGraph::Chats::Item::Messages::Item::Replies::Item::MicrosoftGraphUndoSoftDelete
    ## 
    ...
    class UndoSoftDeleteRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/chats/{chat%2Did}/messages/{chatMessage%2Did}/replies/{chatMessage%2Did1}/microsoft.graph.undoSoftDelete"
