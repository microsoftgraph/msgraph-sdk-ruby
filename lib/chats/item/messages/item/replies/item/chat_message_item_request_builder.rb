...
module MicrosoftGraph::Chats::Item::Messages::Item::Replies::Item
    ## 
    ...
    class ChatMessageItemRequestBuilder
        ...
        def microsoft_graph_soft_delete()
            return MicrosoftGraph::Chats::Item::Messages::Item::Replies::Item::MicrosoftGraphSoftDelete::MicrosoftGraphSoftDeleteRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the undoSoftDelete method.
        def microsoft_graph_undo_soft_delete()
            return MicrosoftGraph::Chats::Item::Messages::Item::Replies::Item::MicrosoftGraphUndoSoftDelete::MicrosoftGraphUndoSoftDeleteRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/chats/{chat%2Did}/messages/{chatMessage%2Did}/replies/{chatMessage%2Did1}{?%24select,%24expand}"
