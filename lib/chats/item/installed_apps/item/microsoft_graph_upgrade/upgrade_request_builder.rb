...
module MicrosoftGraph::Chats::Item::InstalledApps::Item::MicrosoftGraphUpgrade
    ## 
    ...
    class UpgradeRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/chats/{chat%2Did}/installedApps/{teamsAppInstallation%2Did}/microsoft.graph.upgrade"
