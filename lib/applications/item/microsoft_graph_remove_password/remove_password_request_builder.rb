...
require_relative './microsoft_graph_remove_password'

module MicrosoftGraph::Applications::Item::MicrosoftGraphRemovePassword
    ## 
    ...
    class RemovePasswordRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/applications/{application%2Did}/microsoft.graph.removePassword"
