...
require_relative './unset_verified_publisher'

module MicrosoftGraph
    module Applications
        module Item
            module UnsetVerifiedPublisher
                ## 
                # Provides operations to call the unsetVerifiedPublisher method.
                class UnsetVerifiedPublisherRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    ## @return a unset_verified_publisher_request_builder
                    ## 
                    def with_url(raw_url)
                        raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                        return UnsetVerifiedPublisherRequestBuilder.new(raw_url, @request_adapter)
                    end
                end
            end
        end
