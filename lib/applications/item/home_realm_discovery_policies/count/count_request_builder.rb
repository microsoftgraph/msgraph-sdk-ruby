...
module MicrosoftGraph::Applications::Item::HomeRealmDiscoveryPolicies::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/applications/{application%2Did}/homeRealmDiscoveryPolicies/$count{?%24search,%24filter}"
