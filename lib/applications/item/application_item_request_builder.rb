...
require_relative './microsoft_graph_add_key/microsoft_graph_add_key_request_builder'
require_relative './microsoft_graph_add_password/microsoft_graph_add_password_request_builder'
...
require_relative './microsoft_graph_remove_key/microsoft_graph_remove_key_request_builder'
require_relative './microsoft_graph_remove_password/microsoft_graph_remove_password_request_builder'
require_relative './microsoft_graph_restore/microsoft_graph_restore_request_builder'
require_relative './microsoft_graph_set_verified_publisher/microsoft_graph_set_verified_publisher_request_builder'
require_relative './microsoft_graph_unset_verified_publisher/microsoft_graph_unset_verified_publisher_request_builder'
...
module MicrosoftGraph::Applications::Item
    ...
    class ApplicationItemRequestBuilder
        ...
        def microsoft_graph_add_key()
            return MicrosoftGraph::Applications::Item::MicrosoftGraphAddKey::MicrosoftGraphAddKeyRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the addPassword method.
        def microsoft_graph_add_password()
            return MicrosoftGraph::Applications::Item::MicrosoftGraphAddPassword::MicrosoftGraphAddPasswordRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the checkMemberGroups method.
        def microsoft_graph_check_member_groups()
            return MicrosoftGraph::Applications::Item::MicrosoftGraphCheckMemberGroups::MicrosoftGraphCheckMemberGroupsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the checkMemberObjects method.
        def microsoft_graph_check_member_objects()
            return MicrosoftGraph::Applications::Item::MicrosoftGraphCheckMemberObjects::MicrosoftGraphCheckMemberObjectsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the getMemberGroups method.
        def microsoft_graph_get_member_groups()
            return MicrosoftGraph::Applications::Item::MicrosoftGraphGetMemberGroups::MicrosoftGraphGetMemberGroupsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the getMemberObjects method.
        def microsoft_graph_get_member_objects()
            return MicrosoftGraph::Applications::Item::MicrosoftGraphGetMemberObjects::MicrosoftGraphGetMemberObjectsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the removeKey method.
        def microsoft_graph_remove_key()
            return MicrosoftGraph::Applications::Item::MicrosoftGraphRemoveKey::MicrosoftGraphRemoveKeyRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the removePassword method.
        def microsoft_graph_remove_password()
            return MicrosoftGraph::Applications::Item::MicrosoftGraphRemovePassword::MicrosoftGraphRemovePasswordRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the restore method.
        def microsoft_graph_restore()
            return MicrosoftGraph::Applications::Item::MicrosoftGraphRestore::MicrosoftGraphRestoreRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the setVerifiedPublisher method.
        def microsoft_graph_set_verified_publisher()
            return MicrosoftGraph::Applications::Item::MicrosoftGraphSetVerifiedPublisher::MicrosoftGraphSetVerifiedPublisherRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the unsetVerifiedPublisher method.
        def microsoft_graph_unset_verified_publisher()
            return MicrosoftGraph::Applications::Item::MicrosoftGraphUnsetVerifiedPublisher::MicrosoftGraphUnsetVerifiedPublisherRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
