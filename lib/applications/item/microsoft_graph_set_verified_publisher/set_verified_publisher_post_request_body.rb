...
require_relative './microsoft_graph_set_verified_publisher'

module MicrosoftGraph
    module Applications
        module Item
            module MicrosoftGraphSetVerifiedPublisher
                class SetVerifiedPublisherPostRequestBody
                    ...
                    ## @return a set_verified_publisher_post_request_body
                    ## 
                    def self.create_from_discriminator_value(parse_node)
                        raise StandardError, 'parse_node cannot be null' if parse_node.nil?
                        return SetVerifiedPublisherPostRequestBody.new
                    end
                    ## 
