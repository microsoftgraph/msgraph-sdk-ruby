...
module MicrosoftGraph::Applications::Item::ExtensionProperties::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/applications/{application%2Did}/extensionProperties/$count{?%24search,%24filter}"
