...
require_relative './created_on_behalf_of'

module MicrosoftGraph
    module Applications
        module Item
            module CreatedOnBehalfOf
                ## 
                # Provides operations to manage the createdOnBehalfOf property of the microsoft.graph.application entity.
                class CreatedOnBehalfOfRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def initialize(path_parameters, request_adapter)
                        super(path_parameters, request_adapter, "{+baseurl}/applications/{application%2Did}/createdOnBehalfOf{?%24expand,%24select}")
                    end
                    ## 
