            ...
            module Synchronization
                ...
                class SynchronizationRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def acquire_access_token()
                        return MicrosoftGraph::Applications::Item::Synchronization::AcquireAccessToken::AcquireAccessTokenRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to manage the jobs property of the microsoft.graph.synchronization entity.
                    def jobs()
                        return MicrosoftGraph::Applications::Item::Synchronization::Jobs::JobsRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # The secrets property
                    def secrets()
                        return MicrosoftGraph::Applications::Item::Synchronization::Secrets::SecretsRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to manage the templates property of the microsoft.graph.synchronization entity.
                    def templates()
                        return MicrosoftGraph::Applications::Item::Synchronization::Templates::TemplatesRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ...
                    def initialize(path_parameters, request_adapter)
                        super(path_parameters, request_adapter, "{+baseurl}/applications/{application%2Did}/synchronization{?%24expand,%24select}")
                    end
                    ## 
                    ...
                    def to_delete_request_information(request_configuration=nil)
                        ...
                        request_info.url_template = '{+baseurl}/applications/{application%2Did}/synchronization'
