...
require_relative './bulk_upload/bulk_upload_request_builder'
require_relative './item'
                ...
                module Jobs
                    module Item
                        ...
                        class SynchronizationJobItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            def bulk_upload()
                                return MicrosoftGraph::Applications::Item::Synchronization::Jobs::Item::BulkUpload::BulkUploadRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            # Provides operations to call the pause method.
                            def pause()
                                return MicrosoftGraph::Applications::Item::Synchronization::Jobs::Item::Pause::PauseRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            # Provides operations to call the provisionOnDemand method.
                            def provision_on_demand()
                                return MicrosoftGraph::Applications::Item::Synchronization::Jobs::Item::ProvisionOnDemand::ProvisionOnDemandRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            # Provides operations to call the restart method.
                            def restart()
                                return MicrosoftGraph::Applications::Item::Synchronization::Jobs::Item::Restart::RestartRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            # Provides operations to manage the schema property of the microsoft.graph.synchronizationJob entity.
                            def schema()
                                return MicrosoftGraph::Applications::Item::Synchronization::Jobs::Item::Schema::SchemaRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            # Provides operations to call the start method.
                            def start()
                                return MicrosoftGraph::Applications::Item::Synchronization::Jobs::Item::Start::StartRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            # Provides operations to call the validateCredentials method.
                            def validate_credentials()
                                return MicrosoftGraph::Applications::Item::Synchronization::Jobs::Item::ValidateCredentials::ValidateCredentialsRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            ...
                            def initialize(path_parameters, request_adapter)
                                super(path_parameters, request_adapter, "{+baseurl}/applications/{application%2Did}/synchronization/jobs/{synchronizationJob%2Did}{?%24expand,%24select}")
                            end
                            ## 
                            ...
                            def to_delete_request_information(request_configuration=nil)
                                ...
                                request_info.url_template = '{+baseurl}/applications/{application%2Did}/synchronization/jobs/{synchronizationJob%2Did}'
