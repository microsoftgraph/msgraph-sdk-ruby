...
module MicrosoftGraph
    module Applications
        module Item
            module SetVerifiedPublisher
                ## 
                # Provides operations to call the setVerifiedPublisher method.
                class SetVerifiedPublisherRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    ## @return a set_verified_publisher_request_builder
                    ## 
                    def with_url(raw_url)
                        raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                        return SetVerifiedPublisherRequestBuilder.new(raw_url, @request_adapter)
                    end
                end
            end
        end
