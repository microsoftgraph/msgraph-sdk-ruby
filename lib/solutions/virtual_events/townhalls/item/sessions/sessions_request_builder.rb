                ...
                module Item
                    module Sessions
                        ...
                        class SessionsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            def count()
                                return MicrosoftGraph::Solutions::VirtualEvents::Townhalls::Item::Sessions::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            ## Provides operations to manage the sessions property of the microsoft.graph.virtualEvent entity.
                            ...
                            def by_virtual_event_session_id(virtual_event_session_id)
                                ...
                                return MicrosoftGraph::Solutions::VirtualEvents::Townhalls::Item::Sessions::Item::VirtualEventSessionItemRequestBuilder.new(url_tpl_params, @request_adapter)
                            end
                            ## 
                            ...
                            def initialize(path_parameters, request_adapter)
                                super(path_parameters, request_adapter, "{+baseurl}/solutions/virtualEvents/townhalls/{virtualEventTownhall%2Did}/sessions{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}")
                            end
                            ## 
