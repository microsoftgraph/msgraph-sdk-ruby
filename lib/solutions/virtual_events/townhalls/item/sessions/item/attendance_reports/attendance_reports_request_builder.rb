                        ...
                        module Item
                            module AttendanceReports
                                ...
                                class AttendanceReportsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                    ...
                                    def count()
                                        return MicrosoftGraph::Solutions::VirtualEvents::Townhalls::Item::Sessions::Item::AttendanceReports::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                                    end
                                    ## 
                                    ## Provides operations to manage the attendanceReports property of the microsoft.graph.onlineMeetingBase entity.
                                    ...
                                    def by_meeting_attendance_report_id(meeting_attendance_report_id)
                                        ...
                                        return MicrosoftGraph::Solutions::VirtualEvents::Townhalls::Item::Sessions::Item::AttendanceReports::Item::MeetingAttendanceReportItemRequestBuilder.new(url_tpl_params, @request_adapter)
                                    end
                                    ## 
                                    ...
                                    def initialize(path_parameters, request_adapter)
                                        super(path_parameters, request_adapter, "{+baseurl}/solutions/virtualEvents/townhalls/{virtualEventTownhall%2Did}/sessions/{virtualEventSession%2Did}/attendanceReports{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}")
                                    end
                                    ## 
