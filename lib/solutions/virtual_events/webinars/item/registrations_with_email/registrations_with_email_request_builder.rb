...
require_relative './registrations_with_email'
...
module MicrosoftGraph
    module Solutions
        module VirtualEvents
            module Webinars
                module Item
                    module RegistrationsWithEmail
                        ## 
                        # Provides operations to manage the registrations property of the microsoft.graph.virtualEventWebinar entity.
                        class RegistrationsWithEmailRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            
                            ## 
                            # Provides operations to call the cancel method.
                            def cancel()
                                return MicrosoftGraph::Solutions::VirtualEvents::Webinars::Item::RegistrationsWithEmail::Cancel::CancelRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            ...
                            ## @return a void
                            ## 
                            def initialize(path_parameters, request_adapter, email=nil)
                                super(path_parameters, request_adapter, "{+baseurl}/solutions/virtualEvents/webinars/{virtualEventWebinar%2Did}/registrations(email='{email}'){?%24expand,%24select}")
                            end
                            ## 
                            ...
                            def with_url(raw_url)
                                ...
                                return RegistrationsWithEmailRequestBuilder.new(raw_url, @request_adapter)
                            end
