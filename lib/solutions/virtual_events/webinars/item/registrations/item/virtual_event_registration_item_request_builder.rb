                    ...
                    module Registrations
                        module Item
                            ...
                            class VirtualEventRegistrationItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                ...
                                def cancel()
                                    return MicrosoftGraph::Solutions::VirtualEvents::Webinars::Item::Registrations::Item::Cancel::CancelRequestBuilder.new(@path_parameters, @request_adapter)
                                end
                                ## 
                                # Provides operations to manage the sessions property of the microsoft.graph.virtualEventRegistration entity.
                                def sessions()
                                    return MicrosoftGraph::Solutions::VirtualEvents::Webinars::Item::Registrations::Item::Sessions::SessionsRequestBuilder.new(@path_parameters, @request_adapter)
                                end
                                ## 
                                ...
                                def initialize(path_parameters, request_adapter)
                                    super(path_parameters, request_adapter, "{+baseurl}/solutions/virtualEvents/webinars/{virtualEventWebinar%2Did}/registrations/{virtualEventRegistration%2Did}{?%24expand,%24select}")
                                end
                                ## 
