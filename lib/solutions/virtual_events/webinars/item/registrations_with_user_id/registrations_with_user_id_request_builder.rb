...
require_relative './registrations_with_user_id'
...
module MicrosoftGraph
    module Solutions
        module VirtualEvents
            module Webinars
                module Item
                    module RegistrationsWithUserId
                        ## 
                        # Provides operations to manage the registrations property of the microsoft.graph.virtualEventWebinar entity.
                        class RegistrationsWithUserIdRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            
                            ## 
                            # Provides operations to call the cancel method.
                            def cancel()
                                return MicrosoftGraph::Solutions::VirtualEvents::Webinars::Item::RegistrationsWithUserId::Cancel::CancelRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            ...
                            def initialize(path_parameters, request_adapter, user_id=nil)
                                super(path_parameters, request_adapter, "{+baseurl}/solutions/virtualEvents/webinars/{virtualEventWebinar%2Did}/registrations(userId='{userId}'){?%24expand,%24select}")
                            end
                            ## 
                            ...
                            def with_url(raw_url)
                                ...
                                return RegistrationsWithUserIdRequestBuilder.new(raw_url, @request_adapter)
                            end
