                ...
                module Item
                    module SiteInclusionRules
                        module Item
                            ...
                            class SiteProtectionRuleItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                ...
                                def initialize(path_parameters, request_adapter)
                                    super(path_parameters, request_adapter, "{+baseurl}/solutions/backupRestore/sharePointProtectionPolicies/{sharePointProtectionPolicy%2Did}/siteInclusionRules/{siteProtectionRule%2Did}{?%24expand,%24select}")
                                end
                                ## 
                                ...
                                def with_url(raw_url)
                                    ...
                                    return SiteProtectionRuleItemRequestBuilder.new(raw_url, @request_adapter)
                                end
