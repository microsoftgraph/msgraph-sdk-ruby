                ...
                module Item
                    module SiteInclusionRules
                        ...
                        class SiteInclusionRulesRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            def count()
                                return MicrosoftGraph::Solutions::BackupRestore::SharePointProtectionPolicies::Item::SiteInclusionRules::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            ## Provides operations to manage the siteInclusionRules property of the microsoft.graph.sharePointProtectionPolicy entity.
                            ...
                            def by_site_protection_rule_id(site_protection_rule_id)
                                ...
                                return MicrosoftGraph::Solutions::BackupRestore::SharePointProtectionPolicies::Item::SiteInclusionRules::Item::SiteProtectionRuleItemRequestBuilder.new(url_tpl_params, @request_adapter)
                            end
                            ## 
                            ...
                            def initialize(path_parameters, request_adapter)
                                super(path_parameters, request_adapter, "{+baseurl}/solutions/backupRestore/sharePointProtectionPolicies/{sharePointProtectionPolicy%2Did}/siteInclusionRules{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}")
                            end
                            ## 
