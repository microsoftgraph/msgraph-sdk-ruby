                ...
                module Item
                    ...
                    class OneDriveForBusinessProtectionPolicyItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def drive_protection_units_bulk_addition_jobs()
                            return MicrosoftGraph::Solutions::BackupRestore::OneDriveForBusinessProtectionPolicies::Item::DriveProtectionUnitsBulkAdditionJobs::DriveProtectionUnitsBulkAdditionJobsRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
