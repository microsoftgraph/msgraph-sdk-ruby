        ...
        module BackupRestore
            module ProtectionPolicies
                module Item
                    ...
                    class ProtectionPolicyBaseItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        
                        ## 
                        # Provides operations to call the activate method.
                        def activate()
                            return MicrosoftGraph::Solutions::BackupRestore::ProtectionPolicies::Item::Activate::ActivateRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        # Provides operations to call the deactivate method.
                        def deactivate()
                            return MicrosoftGraph::Solutions::BackupRestore::ProtectionPolicies::Item::Deactivate::DeactivateRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/solutions/backupRestore/protectionPolicies/{protectionPolicyBase%2Did}{?%24expand,%24select}")
                        end
                        ## 
                        ...
                        def with_url(raw_url)
                            ...
                            return ProtectionPolicyBaseItemRequestBuilder.new(raw_url, @request_adapter)
                        end
