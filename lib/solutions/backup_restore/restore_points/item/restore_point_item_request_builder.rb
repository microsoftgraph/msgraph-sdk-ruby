...
require_relative './protection_unit/protection_unit_request_builder'
        ...
        module BackupRestore
            module RestorePoints
                module Item
                    ...
                    class RestorePointItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        
                        ## 
                        # Provides operations to manage the protectionUnit property of the microsoft.graph.restorePoint entity.
                        def protection_unit()
                            return MicrosoftGraph::Solutions::BackupRestore::RestorePoints::Item::ProtectionUnit::ProtectionUnitRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/solutions/backupRestore/restorePoints/{restorePoint%2Did}{?%24expand,%24select}")
                        end
                        ## 
                        ...
                        def with_url(raw_url)
                            ...
                            return RestorePointItemRequestBuilder.new(raw_url, @request_adapter)
                        end

                        ## 
                        # List of restore points in the tenant.
                        class RestorePointItemRequestBuilderGetQueryParameters
