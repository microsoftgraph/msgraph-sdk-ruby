...
require_relative './mailbox_restore_artifacts_bulk_addition_requests/mailbox_restore_artifacts_bulk_addition_requests_request_builder'
                ...
                module Item
                    ...
                    class ExchangeRestoreSessionItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def mailbox_restore_artifacts_bulk_addition_requests()
                            return MicrosoftGraph::Solutions::BackupRestore::ExchangeRestoreSessions::Item::MailboxRestoreArtifactsBulkAdditionRequests::MailboxRestoreArtifactsBulkAdditionRequestsRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
