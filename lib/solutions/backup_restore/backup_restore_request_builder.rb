...
require_relative './drive_protection_units_bulk_addition_jobs/drive_protection_units_bulk_addition_jobs_request_builder'
    ...
    module Solutions
        module BackupRestore
            ...
            class BackupRestoreRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def drive_protection_units_bulk_addition_jobs()
                    return MicrosoftGraph::Solutions::BackupRestore::DriveProtectionUnitsBulkAdditionJobs::DriveProtectionUnitsBulkAdditionJobsRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                ...
                def mailbox_protection_units_bulk_addition_jobs()
                    return MicrosoftGraph::Solutions::BackupRestore::MailboxProtectionUnitsBulkAdditionJobs::MailboxProtectionUnitsBulkAdditionJobsRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                ...
                def site_protection_units_bulk_addition_jobs()
                    return MicrosoftGraph::Solutions::BackupRestore::SiteProtectionUnitsBulkAdditionJobs::SiteProtectionUnitsBulkAdditionJobsRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
