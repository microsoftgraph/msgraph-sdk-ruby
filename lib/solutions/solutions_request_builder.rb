...
require_relative './backup_restore/backup_restore_request_builder'
...
module MicrosoftGraph
    module Solutions
        ...
        class SolutionsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
            ...
            def backup_restore()
                return MicrosoftGraph::Solutions::BackupRestore::BackupRestoreRequestBuilder.new(@path_parameters, @request_adapter)
            end
            ## 
            ...
            def virtual_events()
                return MicrosoftGraph::Solutions::VirtualEvents::VirtualEventsRequestBuilder.new(@path_parameters, @request_adapter)
            end
            ## 
            ...
            def initialize(path_parameters, request_adapter)
                super(path_parameters, request_adapter, "{+baseurl}/solutions{?%24expand,%24select}")
            end
            ## 
            ## Get solutions
            ## @param request_configuration Configuration for the request such as headers, query parameters, and middleware options.
            ## @return a Fiber of solutions_root
            ## 
