        ...
        module BookingBusinesses
            module Item
                module GetStaffAvailability
                    ...
                    class GetStaffAvailabilityRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        ## @return a Fiber of get_staff_availability_post_response
                        ## 
                        def post(body, request_configuration=nil)
                            ...
                            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraph::Solutions::BookingBusinesses::Item::GetStaffAvailability::GetStaffAvailabilityPostResponse.create_from_discriminator_value(pn) }, error_mapping)
                        end
                        ## 
                        ## Get the availability information of staff members of a Microsoft Bookings calendar. This API is available in the following national cloud deployments.
                        ## @param body The request body
                        ...
                        ## @return a get_staff_availability_request_builder
                        ## 
                        def with_url(raw_url)
                            raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                            return GetStaffAvailabilityRequestBuilder.new(raw_url, @request_adapter)
                        end
                    end
                end
            end
