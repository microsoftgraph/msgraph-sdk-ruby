...
module MicrosoftGraph::Solutions::BookingBusinesses::Item::MicrosoftGraphUnpublish
    ## 
    ...
    class UnpublishRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/solutions/bookingBusinesses/{bookingBusiness%2Did}/microsoft.graph.unpublish"
