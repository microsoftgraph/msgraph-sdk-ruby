...
module MicrosoftGraph::Solutions::BookingBusinesses::Item::StaffMembers::Item
    ## 
    ...
    class BookingStaffMemberBaseItemRequestBuilder
        ...
        ## @param bookingStaffMemberBaseId key: id of bookingStaffMemberBase
        ## @param pathParameters Path parameters for the request
        ## @param requestAdapter The request adapter to use to execute the requests.
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, booking_staff_member_base_id=nil)
            raise StandardError, 'path_parameters cannot be null' if path_parameters.nil?
            raise StandardError, 'request_adapter cannot be null' if request_adapter.nil?
            @url_template = "{+baseurl}/solutions/bookingBusinesses/{bookingBusiness%2Did}/staffMembers/{bookingStaffMemberBase%2Did}{?%24select,%24expand}"
