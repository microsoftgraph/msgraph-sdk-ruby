                    ...
                    module Item
                        ...
                        class BookingAppointmentItemRequestBuilder
                            ...
                            def microsoft_graph_cancel()
                                return MicrosoftGraph::Solutions::BookingBusinesses::Item::CalendarView::Item::MicrosoftGraphCancel::MicrosoftGraphCancelRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
