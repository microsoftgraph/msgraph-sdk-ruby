...
require_relative './microsoft_graph_get_staff_availability/microsoft_graph_get_staff_availability_request_builder'
...
module MicrosoftGraph::Solutions::BookingBusinesses::Item
    ...
    class BookingBusinessItemRequestBuilder
        ...
        def microsoft_graph_get_staff_availability()
            return MicrosoftGraph::Solutions::BookingBusinesses::Item::MicrosoftGraphGetStaffAvailability::MicrosoftGraphGetStaffAvailabilityRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the publish method.
        def microsoft_graph_publish()
            return MicrosoftGraph::Solutions::BookingBusinesses::Item::MicrosoftGraphPublish::MicrosoftGraphPublishRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the unpublish method.
        def microsoft_graph_unpublish()
            return MicrosoftGraph::Solutions::BookingBusinesses::Item::MicrosoftGraphUnpublish::MicrosoftGraphUnpublishRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
