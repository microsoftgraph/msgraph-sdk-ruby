    ...
    module AuthenticationMethodsPolicy
        ...
        class AuthenticationMethodsPolicyRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
            ...
            def authentication_method_configurations()
                return MicrosoftGraph::AuthenticationMethodsPolicy::AuthenticationMethodConfigurations::AuthenticationMethodConfigurationsRequestBuilder.new(@path_parameters, @request_adapter)
            end
            ## 
            ...
            def initialize(path_parameters, request_adapter)
                super(path_parameters, request_adapter, "{+baseurl}/authenticationMethodsPolicy{?%24expand,%24select}")
            end
            ## 
            ...
            def to_patch_request_information(body, request_configuration=nil)
                ...
                request_info.url_template = '{+baseurl}/authenticationMethodsPolicy'
                request_info.path_parameters = @path_parameters
