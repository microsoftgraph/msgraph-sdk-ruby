...
module MicrosoftGraph
    module Models
        class AzureADJoinPolicy
            ...
            ## @return a void
            ## 
            def allowed_to_join=(value)
                @allowed_to_join = value
            end
            ## 
            ...
            def get_field_deserializers()
                return {
                    "allowedToJoin" => lambda {|n| @allowed_to_join = n.get_object_value(lambda {|pn| MicrosoftGraph::Models::DeviceRegistrationMembership.create_from_discriminator_value(pn) }) },
            ...
            def serialize(writer)
                ...
                writer.write_object_value("allowedToJoin", @allowed_to_join)
