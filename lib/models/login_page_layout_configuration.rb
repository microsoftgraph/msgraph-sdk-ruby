    ...
    module Models
        class LoginPageLayoutConfiguration
            ...
            def serialize(writer)
                ...
                writer.write_boolean_value("isFooterShown", @is_footer_shown) unless @is_footer_shown.nil?
                writer.write_boolean_value("isHeaderShown", @is_header_shown) unless @is_header_shown.nil?
                writer.write_enum_value("layoutTemplateType", @layout_template_type) unless @layout_template_type.nil?
