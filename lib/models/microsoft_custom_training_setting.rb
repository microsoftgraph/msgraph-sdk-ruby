        ...
        class MicrosoftCustomTrainingSetting < MicrosoftGraph::Models::TrainingSetting
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "trainingCompletionDuration" => lambda {|n| @training_completion_duration = n.get_enum_value(MicrosoftGraph::Models::MicrosoftCustomTrainingSettingTrainingCompletionDuration) },
                })
            end
            ## 
