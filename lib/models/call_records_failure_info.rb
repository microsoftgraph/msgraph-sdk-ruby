    ...
    module Models
        class CallRecordsFailureInfo
            ...
            def self.create_from_discriminator_value(parse_node)
                ...
                return CallRecordsFailureInfo.new
            end
            ## 
            ...
            def get_field_deserializers()
                return {
                    ...
                    "stage" => lambda {|n| @stage = n.get_enum_value(MicrosoftGraph::Models::CallRecordsFailureStage) },
                }
            end
            ## 
            ...
            ## @return a call_records_failure_stage
            ## 
            def stage
                return @stage
            end
