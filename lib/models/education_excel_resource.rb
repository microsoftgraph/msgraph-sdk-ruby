...
module MicrosoftGraph
    module Models
        class EducationExcelResource < MicrosoftGraph::Models::EducationResource
            ...
            ## @return a education_excel_resource
            ## 
            ...
            def serialize(writer)
                ...
                super
                writer.write_string_value("fileUrl", @file_url) unless @file_url.nil?
            end
        end
    end
end
