...
module MicrosoftGraph
    module Models
        class OnInteractiveAuthFlowStartHandler
            ...
            def self.create_from_discriminator_value(parse_node)
                ...
                unless mapping_value_node.nil? then
                    ...
                    case mapping_value
                        when "#microsoft.graph.onInteractiveAuthFlowStartExternalUsersSelfServiceSignUp"
                            return OnInteractiveAuthFlowStartExternalUsersSelfServiceSignUp.new
                    end
                end
                return OnInteractiveAuthFlowStartHandler.new
            end
            ## 
