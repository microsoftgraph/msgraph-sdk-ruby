    ...
    module Models
        class MediaContentRatingNewZealand
            ...
            def self.create_from_discriminator_value(parse_node)
                ...
                return MediaContentRatingNewZealand.new
            end
            ## 
            ...
            def get_field_deserializers()
                return {
                    "movieRating" => lambda {|n| @movie_rating = n.get_enum_value(MicrosoftGraph::Models::RatingNewZealandMoviesType) },
                    "@odata.type" => lambda {|n| @odata_type = n.get_string_value() },
                    "tvRating" => lambda {|n| @tv_rating = n.get_enum_value(MicrosoftGraph::Models::RatingNewZealandTelevisionType) },
                }
            end
            ## 
            ## Gets the movieRating property value. Movies rating labels in New Zealand
            ## @return a rating_new_zealand_movies_type
            ## 
            def movie_rating
                return @movie_rating
            end
            ...
            def serialize(writer)
                ...
                writer.write_enum_value("movieRating", @movie_rating) unless @movie_rating.nil?
                writer.write_string_value("@odata.type", @odata_type) unless @odata_type.nil?
                writer.write_enum_value("tvRating", @tv_rating) unless @tv_rating.nil?
                writer.write_additional_data(@additional_data) unless @additional_data.nil?
            end
            ## 
            ## Gets the tvRating property value. TV content rating labels in New Zealand
            ## @return a rating_new_zealand_television_type
            ## 
            def tv_rating
                return @tv_rating
            end
