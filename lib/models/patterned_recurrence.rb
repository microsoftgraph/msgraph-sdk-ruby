    ...
    module Models
        class PatternedRecurrence
            ...
            def self.create_from_discriminator_value(parse_node)
                ...
                return PatternedRecurrence.new
            end
            ## 
            ...
            def get_field_deserializers()
                return {
                    ...
                    "pattern" => lambda {|n| @pattern = n.get_object_value(lambda {|pn| MicrosoftGraph::Models::RecurrencePattern.create_from_discriminator_value(pn) }) },
                    "range" => lambda {|n| @range = n.get_object_value(lambda {|pn| MicrosoftGraph::Models::RecurrenceRange.create_from_discriminator_value(pn) }) },
                }
            end
            ## 
            ...
            def serialize(writer)
                ...
                writer.write_object_value("pattern", @pattern) unless @pattern.nil?
                writer.write_object_value("range", @range) unless @range.nil?
