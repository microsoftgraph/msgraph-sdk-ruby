...
module MicrosoftGraph
    module Models
        class SecurityRetentionEventStatus
            ...
            ## 
            ## Instantiates a new securityRetentionEventStatus and sets the default values.
            ## @return a void
            ## 
            def initialize()
            ...
            def get_field_deserializers()
                return {
                    ...
                    "status" => lambda {|n| @status = n.get_enum_value(MicrosoftGraph::Models::SecurityRetentionEventStatusStatus) },
                }
            end
            ## 
            ...
            ## @return a security_retention_event_status_status
            ## 
            def status
                return @status
            end
