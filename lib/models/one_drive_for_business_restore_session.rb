...
module MicrosoftGraph
    module Models
        class OneDriveForBusinessRestoreSession < MicrosoftGraph::Models::RestoreSessionBase
            ...
            @drive_restore_artifacts_bulk_addition_requests
            ## 
            ...
            def drive_restore_artifacts_bulk_addition_requests
                return @drive_restore_artifacts_bulk_addition_requests
            end
            ## 
            ...
            ## @return a void
            ## 
            def drive_restore_artifacts_bulk_addition_requests=(value)
                @drive_restore_artifacts_bulk_addition_requests = value
            end
            ## 
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "driveRestoreArtifactsBulkAdditionRequests" => lambda {|n| @drive_restore_artifacts_bulk_addition_requests = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraph::Models::DriveRestoreArtifactsBulkAdditionRequest.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
            ...
            def serialize(writer)
                ...
                writer.write_collection_of_object_values("driveRestoreArtifactsBulkAdditionRequests", @drive_restore_artifacts_bulk_addition_requests)
            end
        end
    end
end
