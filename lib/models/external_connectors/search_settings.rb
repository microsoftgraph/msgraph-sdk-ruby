            ...
            class SearchSettings
                ...
                def get_field_deserializers()
                    return {
                        ...
                        "searchResultTemplates" => lambda {|n| @search_result_templates = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraph::Models::ExternalConnectors::DisplayTemplate.create_from_discriminator_value(pn) }) },
                    }
                end
                ## 
                ...
                ## @param value Value to set for the search_result_templates property.
                ## @return a void
                ## 
