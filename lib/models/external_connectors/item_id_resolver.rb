...
module MicrosoftGraph
    module Models
        module ExternalConnectors
            class ItemIdResolver < MicrosoftGraph::Models::ExternalConnectors::UrlToItemResolverBase
                ...
                def get_field_deserializers()
                    return super.merge({
                        ...
                        "urlMatchInfo" => lambda {|n| @url_match_info = n.get_object_value(lambda {|pn| MicrosoftGraph::Models::ExternalConnectors::UrlMatchInfo.create_from_discriminator_value(pn) }) },
                    })
                end
                ## 
                ...
                ## @param value Value to set for the url_match_info property.
                ## @return a void
                ## 
