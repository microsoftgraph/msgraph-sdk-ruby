        ...
        module ExternalConnectors
            class External
                ...
                def get_field_deserializers()
                    return {
                        "connections" => lambda {|n| @connections = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraph::Models::ExternalConnectors::ExternalConnection.create_from_discriminator_value(pn) }) },
