            ...
            class ActivitySettings
                ...
                def get_field_deserializers()
                    return {
                        ...
                        "urlToItemResolvers" => lambda {|n| @url_to_item_resolvers = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraph::Models::ExternalConnectors::UrlToItemResolverBase.create_from_discriminator_value(pn) }) },
                    }
                end
                ## 
                ...
                ## @param value Value to set for the url_to_item_resolvers property.
                ## @return a void
                ## 
