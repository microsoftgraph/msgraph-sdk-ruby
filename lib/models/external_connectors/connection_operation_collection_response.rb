    ...
    module Models
        module ExternalConnectors
            class ConnectionOperationCollectionResponse < MicrosoftGraph::Models::BaseCollectionPaginationCountResponse
                ...
                ## @return a connection_operation_collection_response
                ## 
                def self.create_from_discriminator_value(parse_node)
                    raise StandardError, 'parse_node cannot be null' if parse_node.nil?
                    return ConnectionOperationCollectionResponse.new
                end
                ## 
                ...
                def get_field_deserializers()
                    return super.merge({
                        "value" => lambda {|n| @value = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraph::Models::ExternalConnectors::ConnectionOperation.create_from_discriminator_value(pn) }) },
                    })
                end
                ## 
