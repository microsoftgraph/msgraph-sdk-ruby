...
module MicrosoftGraph
    module Models
        module ExternalConnectors
            class ExternalActivity < MicrosoftGraph::Models::Entity
                ...
                def get_field_deserializers()
                    return super.merge({
                        "performedBy" => lambda {|n| @performed_by = n.get_object_value(lambda {|pn| MicrosoftGraph::Models::ExternalConnectors::Identity.create_from_discriminator_value(pn) }) },
                        "startDateTime" => lambda {|n| @start_date_time = n.get_date_time_value() },
                        "type" => lambda {|n| @type = n.get_enum_value(MicrosoftGraph::Models::ExternalConnectors::ExternalActivityType) },
                    })
                end
                ## 
