    ...
    module Models
        class EducationAssignmentPointsGrade < MicrosoftGraph::Models::EducationAssignmentGrade
            ...
            def get_field_deserializers()
                return super.merge({
                    "points" => lambda {|n| @points = n.get_object_value(lambda {|pn| EducationAssignmentPointsGrade::EducationAssignmentPointsGradePoints.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
            ## Gets the points property value. Number of points a teacher is giving this submission object.
            ## @return a education_assignment_points_grade_points
            ## 
            def points
                return @points
            end
            ...
            class EducationAssignmentPointsGradePoints
                include MicrosoftKiotaAbstractions::Parsable
                ## 
                ...
                def self.create_from_discriminator_value(parse_node)
                    ...
                    return EducationAssignmentPointsGradePoints.new
                end
                ## 
