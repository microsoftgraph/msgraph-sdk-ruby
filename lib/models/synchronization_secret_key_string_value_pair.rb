    ...
    module Models
        class SynchronizationSecretKeyStringValuePair
            ...
            def self.create_from_discriminator_value(parse_node)
                ...
                return SynchronizationSecretKeyStringValuePair.new
            end
            ## 
            ...
            def get_field_deserializers()
                return {
                    "key" => lambda {|n| @key = n.get_enum_value(MicrosoftGraph::Models::SynchronizationSecret) },
            ...
            ## @return a synchronization_secret
            ## 
            def key
                return @key
            end
