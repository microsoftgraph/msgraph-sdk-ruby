    ...
    module Models
        class SearchAlteration
            ...
            def serialize(writer)
                ...
                writer.write_string_value("alteredHighlightedQueryString", @altered_highlighted_query_string) unless @altered_highlighted_query_string.nil?
                writer.write_string_value("alteredQueryString", @altered_query_string) unless @altered_query_string.nil?
                writer.write_collection_of_object_values("alteredQueryTokens", @altered_query_tokens) unless @altered_query_tokens.nil?
