...
module MicrosoftGraph
    module Models
        class OnAttributeCollectionSubmitCustomExtensionHandler < MicrosoftGraph::Models::OnAttributeCollectionSubmitHandler
            ...
            ## @return a on_attribute_collection_submit_custom_extension_handler
            ## 
            def self.create_from_discriminator_value(parse_node)
                raise StandardError, 'parse_node cannot be null' if parse_node.nil?
                return OnAttributeCollectionSubmitCustomExtensionHandler.new
            end
            ## 
            ## Gets the customExtension property value. The customExtension property
            ## @return a on_attribute_collection_submit_custom_extension
            ## 
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "customExtension" => lambda {|n| @custom_extension = n.get_object_value(lambda {|pn| MicrosoftGraph::Models::OnAttributeCollectionSubmitCustomExtension.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
