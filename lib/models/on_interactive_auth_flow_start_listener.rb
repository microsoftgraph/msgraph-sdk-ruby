...
module MicrosoftGraph
    module Models
        class OnInteractiveAuthFlowStartListener < MicrosoftGraph::Models::AuthenticationEventListener
            ...
            ## @return a on_interactive_auth_flow_start_listener
            ## 
            ...
            def get_field_deserializers()
                return super.merge({
                    "handler" => lambda {|n| @handler = n.get_object_value(lambda {|pn| MicrosoftGraph::Models::OnInteractiveAuthFlowStartHandler.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
