...
module MicrosoftGraph
    module Models
        class EducationItemBody
            ...
            ## @return a education_item_body_content_type
            ## 
            def content_type
                return @content_type
            end
            ...
            def get_field_deserializers()
                return {
                    ...
                    "contentType" => lambda {|n| @content_type = n.get_enum_value(MicrosoftGraph::Models::EducationItemBodyContentType) },
