...
module MicrosoftGraph
    module Models
        class PrivilegedAccessGroupEligibilityScheduleInstance < MicrosoftGraph::Models::PrivilegedAccessScheduleInstance
            ...
            ## @return a privileged_access_group_eligibility_schedule_instance_access_id
            ## 
            def access_id
                return @access_id
            end
            ...
            def get_field_deserializers()
                return super.merge({
                    "accessId" => lambda {|n| @access_id = n.get_enum_value(MicrosoftGraph::Models::PrivilegedAccessGroupEligibilityScheduleInstanceAccessId) },
                    ...
                    "memberType" => lambda {|n| @member_type = n.get_enum_value(MicrosoftGraph::Models::PrivilegedAccessGroupEligibilityScheduleInstanceMemberType) },
            ...
            ## @return a privileged_access_group_eligibility_schedule_instance_member_type
            ## 
            def member_type
                return @member_type
            end
