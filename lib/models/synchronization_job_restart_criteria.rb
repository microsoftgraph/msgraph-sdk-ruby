    ...
    module Models
        class SynchronizationJobRestartCriteria
            ...
            def self.create_from_discriminator_value(parse_node)
                ...
                return SynchronizationJobRestartCriteria.new
            end
            ## 
            ...
            def get_field_deserializers()
                return {
                    ...
                    "resetScope" => lambda {|n| @reset_scope = n.get_enum_value(MicrosoftGraph::Models::SynchronizationJobRestartCriteriaResetScope) },
                }
            end
            ## 
            ...
            ## @return a synchronization_job_restart_criteria_reset_scope
            ## 
            def reset_scope
                return @reset_scope
            end
            ...
            def serialize(writer)
                ...
                writer.write_enum_value("resetScope", @reset_scope)
