    ...
    module Models
        class AssignedTrainingInfo
            ...
            def serialize(writer)
                ...
                writer.write_number_value("assignedUserCount", @assigned_user_count) unless @assigned_user_count.nil?
                writer.write_number_value("completedUserCount", @completed_user_count) unless @completed_user_count.nil?
