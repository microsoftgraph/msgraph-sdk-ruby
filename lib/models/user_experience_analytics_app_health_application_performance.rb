...
module MicrosoftGraph
    module Models
        ...
        class UserExperienceAnalyticsAppHealthApplicationPerformance < MicrosoftGraph::Models::Entity
            ...
            ## @return a user_experience_analytics_app_health_application_performance_app_health_score
            ## 
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "appHealthScore" => lambda {|n| @app_health_score = n.get_object_value(lambda {|pn| UserExperienceAnalyticsAppHealthApplicationPerformance::UserExperienceAnalyticsAppHealthApplicationPerformanceAppHealthScore.create_from_discriminator_value(pn) }) },
            ...
            class UserExperienceAnalyticsAppHealthApplicationPerformanceAppHealthScore
                include MicrosoftKiotaAbstractions::Parsable
                ## 
                ...
                def self.create_from_discriminator_value(parse_node)
                    ...
                    return UserExperienceAnalyticsAppHealthApplicationPerformanceAppHealthScore.new
                end
                ## 
