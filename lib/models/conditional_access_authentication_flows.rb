...
module MicrosoftGraph
    module Models
        class ConditionalAccessAuthenticationFlows
            ...
            ## 
            ## Instantiates a new ConditionalAccessAuthenticationFlows and sets the default values.
            ## @return a void
            ## 
            def initialize()
            ...
            def self.create_from_discriminator_value(parse_node)
                ...
                return ConditionalAccessAuthenticationFlows.new
            end
            ## 
            ...
            def get_field_deserializers()
                return {
                    ...
                    "transferMethods" => lambda {|n| @transfer_methods = n.get_enum_values(MicrosoftGraph::Models::ConditionalAccessTransferMethods) },
                }
            end
            ## 
            ...
            def serialize(writer)
                ...
                writer.write_enum_value("transferMethods", @transfer_methods)
                writer.write_additional_data(@additional_data)
            end
            ## 
            ## Gets the transferMethods property value. The transferMethods property
            ## @return a conditional_access_transfer_methods
            ## 
