...
module MicrosoftGraph
    module Models
        class TermStoreStore < MicrosoftGraph::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "groups" => lambda {|n| @groups = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraph::Models::TermStoreGroup.create_from_discriminator_value(pn) }) },
