...
module MicrosoftGraph
    module Models
        class PrivilegedAccessGroupAssignmentScheduleRequest < MicrosoftGraph::Models::PrivilegedAccessScheduleRequest
            ...
            ## @return a privileged_access_group_assignment_schedule_request_access_id
            ## 
            def access_id
                return @access_id
            end
            ...
            def get_field_deserializers()
                return super.merge({
                    "accessId" => lambda {|n| @access_id = n.get_enum_value(MicrosoftGraph::Models::PrivilegedAccessGroupAssignmentScheduleRequestAccessId) },
