        ...
        class ExternalConnectorsProperty
            ...
            def get_field_deserializers()
                return {
                    ...
                    "labels" => lambda {|n| @labels = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraph::Models::ExternalConnectorsPropertyLabels.create_from_discriminator_value(pn) }) },
            ...
            ## @return a external_connectors_property_labels
            ## 
            def labels
                return @labels
            end
