    ...
    module Models
        class SolutionsRoot
            ...
            def serialize(writer)
                ...
                writer.write_collection_of_object_values("bookingBusinesses", @booking_businesses) unless @booking_businesses.nil?
                writer.write_collection_of_object_values("bookingCurrencies", @booking_currencies) unless @booking_currencies.nil?
