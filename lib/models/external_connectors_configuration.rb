    ...
    module Models
        class ExternalConnectorsConfiguration
            ...
            def self.create_from_discriminator_value(parse_node)
                ...
                return ExternalConnectorsConfiguration.new
            end
            ## 
            ...
            def serialize(writer)
                ...
                writer.write_collection_of_primitive_values("authorizedAppIds", @authorized_app_ids) unless @authorized_app_ids.nil?
