...
module MicrosoftGraph
    module Models
        class InferenceClassification < MicrosoftGraph::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    "overrides" => lambda {|n| @overrides = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraph::Models::InferenceClassificationOverride.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
            ...
            def serialize(writer)
                ...
                super
                writer.write_collection_of_object_values("overrides", @overrides) unless @overrides.nil?
            end
        end
    end
end
