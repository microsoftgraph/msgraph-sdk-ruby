        ...
        class SecurityIncident < MicrosoftGraph::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "classification" => lambda {|n| @classification = n.get_enum_value(MicrosoftGraph::Models::SecurityIncidentClassification) },
                    ...
                    "determination" => lambda {|n| @determination = n.get_enum_value(MicrosoftGraph::Models::SecurityIncidentDetermination) },
