...
module MicrosoftGraph
    module Models
        class SecurityEdiscoveryExportOperation < MicrosoftGraph::Models::SecurityCaseOperation
            ...
            ## @return a security_ediscovery_export_operation_export_options
            ## 
            def export_options
            ...
            ## @return a security_ediscovery_export_operation_export_structure
            ## 
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "exportOptions" => lambda {|n| @export_options = n.get_enum_value(MicrosoftGraph::Models::SecurityEdiscoveryExportOperationExportOptions) },
                    "exportStructure" => lambda {|n| @export_structure = n.get_enum_value(MicrosoftGraph::Models::SecurityEdiscoveryExportOperationExportStructure) },
