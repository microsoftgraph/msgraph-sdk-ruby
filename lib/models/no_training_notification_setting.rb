...
module MicrosoftGraph
    module Models
        class NoTrainingNotificationSetting < MicrosoftGraph::Models::EndUserNotificationSetting
            ...
            def get_field_deserializers()
                return super.merge({
                    "simulationNotification" => lambda {|n| @simulation_notification = n.get_object_value(lambda {|pn| MicrosoftGraph::Models::SimulationNotification.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
