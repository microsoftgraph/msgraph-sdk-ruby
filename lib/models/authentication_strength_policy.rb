...
module MicrosoftGraph
    module Models
        class AuthenticationStrengthPolicy < MicrosoftGraph::Models::Entity
            ...
            ## @param value Value to set for the allowed_combinations property.
            ## @return a void
            ## 
            ...
            ## @param value Value to set for the combination_configurations property.
            ## @return a void
            ## 
            ...
            ## @param value Value to set for the requirements_satisfied property.
            ## @return a void
            ## 
