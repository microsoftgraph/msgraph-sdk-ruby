...
module MicrosoftGraph
    module Models
        class SecurityRetentionEvent < MicrosoftGraph::Models::Entity
            ...
            ## @return a security_retention_event
            ## 
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "eventPropagationResults" => lambda {|n| @event_propagation_results = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraph::Models::SecurityEventPropagationResult.create_from_discriminator_value(pn) }) },
                    "eventQueries" => lambda {|n| @event_queries = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraph::Models::SecurityEventQuery.create_from_discriminator_value(pn) }) },
                    "eventStatus" => lambda {|n| @event_status = n.get_object_value(lambda {|pn| MicrosoftGraph::Models::SecurityRetentionEventStatus.create_from_discriminator_value(pn) }) },
            ...
            def serialize(writer)
                ...
                writer.write_collection_of_object_values("eventPropagationResults", @event_propagation_results) unless @event_propagation_results.nil?
                writer.write_collection_of_object_values("eventQueries", @event_queries) unless @event_queries.nil?
                writer.write_object_value("eventStatus", @event_status) unless @event_status.nil?
                writer.write_date_time_value("eventTriggerDateTime", @event_trigger_date_time) unless @event_trigger_date_time.nil?
                ...
                writer.write_date_time_value("lastStatusUpdateDateTime", @last_status_update_date_time) unless @last_status_update_date_time.nil?
                writer.write_object_value("retentionEventType", @retention_event_type) unless @retention_event_type.nil?
            end
        end
    end
end
