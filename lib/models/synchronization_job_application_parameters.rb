        ...
        class SynchronizationJobApplicationParameters
            ...
            def get_field_deserializers()
                return {
                    ...
                    "subjects" => lambda {|n| @subjects = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraph::Models::SynchronizationJobSubject.create_from_discriminator_value(pn) }) },
                }
            end
            ## 
