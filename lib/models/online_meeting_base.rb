...
module MicrosoftGraph
    module Models
        class OnlineMeetingBase < MicrosoftGraph::Models::Entity
            ...
            ## @return a boolean
            ## 
            def allow_breakout_rooms
                return @allow_breakout_rooms
            end
            ## 
            ...
            ## @return a void
            ## 
            def allow_breakout_rooms=(value)
                @allow_breakout_rooms = value
            end
            ## 
            ...
            ## @return a meeting_live_share_options
            ## 
            def allow_live_share
                return @allow_live_share
            end
            ## 
            ...
            ## @return a void
            ## 
            def allow_live_share=(value)
                @allow_live_share = value
            end
            ## 
            ...
            ## @return a boolean
            ## 
            def allow_power_point_sharing
                return @allow_power_point_sharing
            end
            ## 
            ...
            ## @return a void
            ## 
            def allow_power_point_sharing=(value)
                @allow_power_point_sharing = value
            end
            ## 
            ...
            ## @return a boolean
            ## 
            def allow_whiteboard
                return @allow_whiteboard
            end
            ## 
            ...
            ## @return a void
            ## 
            def allow_whiteboard=(value)
                @allow_whiteboard = value
            end
            ## 
            ...
            ## @return a allowed_lobby_admitter_roles
            ## 
            def allowed_lobby_admitters
                return @allowed_lobby_admitters
            end
            ## 
            ...
            ## @return a void
            ## 
            def allowed_lobby_admitters=(value)
                @allowed_lobby_admitters = value
            end
            ## 
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "allowBreakoutRooms" => lambda {|n| @allow_breakout_rooms = n.get_boolean_value() },
                    "allowLiveShare" => lambda {|n| @allow_live_share = n.get_enum_value(MicrosoftGraph::Models::MeetingLiveShareOptions) },
                    ...
                    "allowPowerPointSharing" => lambda {|n| @allow_power_point_sharing = n.get_boolean_value() },
                    ...
                    "allowWhiteboard" => lambda {|n| @allow_whiteboard = n.get_boolean_value() },
                    "allowedLobbyAdmitters" => lambda {|n| @allowed_lobby_admitters = n.get_enum_value(MicrosoftGraph::Models::AllowedLobbyAdmitterRoles) },
                    ...
                    "chatRestrictions" => lambda {|n| @chat_restrictions = n.get_object_value(lambda {|pn| MicrosoftGraph::Models::ChatRestrictions.create_from_discriminator_value(pn) }) },
            ...
            def serialize(writer)
                ...
                writer.write_boolean_value("allowBreakoutRooms", @allow_breakout_rooms)
                writer.write_enum_value("allowLiveShare", @allow_live_share)
                ...
                writer.write_boolean_value("allowPowerPointSharing", @allow_power_point_sharing)
                ...
                writer.write_boolean_value("allowWhiteboard", @allow_whiteboard)
                writer.write_enum_value("allowedLobbyAdmitters", @allowed_lobby_admitters)
