    ...
    module Models
        class UserRegistrationMethodCount
            ...
            def serialize(writer)
                ...
                writer.write_string_value("authenticationMethod", @authentication_method) unless @authentication_method.nil?
                writer.write_string_value("@odata.type", @odata_type) unless @odata_type.nil?
                writer.write_object_value("userCount", @user_count) unless @user_count.nil?
