...
module MicrosoftGraph
    module Models
        class SecurityEdiscoveryReviewSet < MicrosoftGraph::Models::SecurityDataSet
            ...
            def get_field_deserializers()
                return super.merge({
                    "queries" => lambda {|n| @queries = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraph::Models::SecurityEdiscoveryReviewSetQuery.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
            ...
            def serialize(writer)
                ...
                super
                writer.write_collection_of_object_values("queries", @queries) unless @queries.nil?
            end
        end
    end
end
