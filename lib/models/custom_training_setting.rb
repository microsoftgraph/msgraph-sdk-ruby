...
module MicrosoftGraph
    module Models
        class CustomTrainingSetting < MicrosoftGraph::Models::TrainingSetting
            ...
            ## @return a custom_training_setting_assigned_to
            ## 
            def assigned_to
                return @assigned_to
            end
            ...
            def get_field_deserializers()
                return super.merge({
                    "assignedTo" => lambda {|n| @assigned_to = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraph::Models::CustomTrainingSettingAssignedTo.create_from_discriminator_value(pn) }) },
