        ...
        class UserExperienceAnalyticsAppHealthDeviceModelPerformance < MicrosoftGraph::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "modelAppHealthScore" => lambda {|n| @model_app_health_score = n.get_object_value(lambda {|pn| UserExperienceAnalyticsAppHealthDeviceModelPerformance::UserExperienceAnalyticsAppHealthDeviceModelPerformanceModelAppHealthScore.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
            ...
            ## @return a user_experience_analytics_app_health_device_model_performance_model_app_health_score
            ## 
            ...
            class UserExperienceAnalyticsAppHealthDeviceModelPerformanceModelAppHealthScore
                include MicrosoftKiotaAbstractions::Parsable
                ## 
                ...
                def self.create_from_discriminator_value(parse_node)
                    ...
                    return UserExperienceAnalyticsAppHealthDeviceModelPerformanceModelAppHealthScore.new
                end
                ## 
