...
module MicrosoftGraph
    module Models
        class ExternalConnectorsConnectionOperation < MicrosoftGraph::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "status" => lambda {|n| @status = n.get_enum_value(MicrosoftGraph::Models::ExternalConnectorsConnectionOperationStatus) },
                })
            end
            ## 
            ...
            ## @return a external_connectors_connection_operation_status
            ## 
            def status
                return @status
            end
