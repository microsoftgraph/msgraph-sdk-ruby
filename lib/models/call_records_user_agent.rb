...
module MicrosoftGraph
    module Models
        class CallRecordsUserAgent
            ...
            ## 
            ## Instantiates a new callRecordsUserAgent and sets the default values.
            ## @return a void
            ## 
            def initialize()
            ...
            def self.create_from_discriminator_value(parse_node)
                ...
                return CallRecordsUserAgent.new
            end
            ## 
            ...
            def serialize(writer)
                ...
                writer.write_string_value("headerValue", @header_value) unless @header_value.nil?
