        ...
        class UserRegistrationFeatureSummary
            ...
            def get_field_deserializers()
                return {
                    ...
                    "userRoles" => lambda {|n| @user_roles = n.get_enum_value(MicrosoftGraph::Models::UserRegistrationFeatureSummaryUserRoles) },
                    "userTypes" => lambda {|n| @user_types = n.get_enum_value(MicrosoftGraph::Models::UserRegistrationFeatureSummaryUserTypes) },
                }
            end
            ## 
            ...
            ## @return a user_registration_feature_summary_user_roles
            ## 
            def user_roles
                return @user_roles
            end
            ...
            ## @return a user_registration_feature_summary_user_types
            ## 
            def user_types
                return @user_types
            end
