        ...
        class TeamworkNotificationRecipient
            ...
            def self.create_from_discriminator_value(parse_node)
                ...
                unless mapping_value_node.nil? then
                    ...
                    case mapping_value
                        when "#microsoft.graph.aadUserNotificationRecipient"
                            return AadUserNotificationRecipient.new
                        when "#microsoft.graph.channelMembersNotificationRecipient"
                            return ChannelMembersNotificationRecipient.new
                        when "#microsoft.graph.chatMembersNotificationRecipient"
                            return ChatMembersNotificationRecipient.new
                        when "#microsoft.graph.teamMembersNotificationRecipient"
                            return TeamMembersNotificationRecipient.new
                    end
                end
                return TeamworkNotificationRecipient.new
            end
            ## 
