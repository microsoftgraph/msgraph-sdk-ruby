...
module MicrosoftGraph
    module Models
        class OnAuthenticationMethodLoadStartHandler
            ...
            def self.create_from_discriminator_value(parse_node)
                ...
                unless mapping_value_node.nil? then
                    ...
                    case mapping_value
                        when "#microsoft.graph.onAuthenticationMethodLoadStartExternalUsersSelfServiceSignUp"
                            return OnAuthenticationMethodLoadStartExternalUsersSelfServiceSignUp.new
                    end
                end
                return OnAuthenticationMethodLoadStartHandler.new
            end
            ## 
