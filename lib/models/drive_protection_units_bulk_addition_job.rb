...
module MicrosoftGraph
    module Models
        class DriveProtectionUnitsBulkAdditionJob < MicrosoftGraph::Models::ProtectionUnitsBulkJobBase
            ...
            @drives
            ## 
            ## Instantiates a new DriveProtectionUnitsBulkAdditionJob and sets the default values.
            ## @return a void
            ## 
            def initialize()
                super
                @odata_type = "#microsoft.graph.driveProtectionUnitsBulkAdditionJob"
            end
            ## 
