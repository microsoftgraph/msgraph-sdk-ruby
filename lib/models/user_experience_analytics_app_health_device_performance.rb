...
module MicrosoftGraph
    module Models
        ...
        class UserExperienceAnalyticsAppHealthDevicePerformance < MicrosoftGraph::Models::Entity
            ...
            ## @return a user_experience_analytics_app_health_device_performance_device_app_health_score
            ## 
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "deviceAppHealthScore" => lambda {|n| @device_app_health_score = n.get_object_value(lambda {|pn| UserExperienceAnalyticsAppHealthDevicePerformance::UserExperienceAnalyticsAppHealthDevicePerformanceDeviceAppHealthScore.create_from_discriminator_value(pn) }) },
            ...
            class UserExperienceAnalyticsAppHealthDevicePerformanceDeviceAppHealthScore
                include MicrosoftKiotaAbstractions::Parsable
                ## 
                ...
                def self.create_from_discriminator_value(parse_node)
                    ...
                    return UserExperienceAnalyticsAppHealthDevicePerformanceDeviceAppHealthScore.new
                end
                ## 
