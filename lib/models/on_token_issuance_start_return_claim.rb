...
module MicrosoftGraph
    module Models
        class OnTokenIssuanceStartReturnClaim
            ...
            ## @return a string
            ## 
            def claim_id_in_api_response
                return @claim_id_in_api_response
            end
            ## 
            ...
            ## @return a void
            ## 
            def claim_id_in_api_response=(value)
                @claim_id_in_api_response = value
            end
            ## 
            ...
            def self.create_from_discriminator_value(parse_node)
                ...
                return OnTokenIssuanceStartReturnClaim.new
            end
            ## 
            ...
            def get_field_deserializers()
                return {
                    "claimIdInApiResponse" => lambda {|n| @claim_id_in_api_response = n.get_string_value() },
            ...
            def serialize(writer)
                ...
                writer.write_string_value("claimIdInApiResponse", @claim_id_in_api_response)
