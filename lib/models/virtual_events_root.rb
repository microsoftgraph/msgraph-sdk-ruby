        ...
        class VirtualEventsRoot < MicrosoftGraph::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "townhalls" => lambda {|n| @townhalls = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraph::Models::VirtualEventTownhall.create_from_discriminator_value(pn) }) },
