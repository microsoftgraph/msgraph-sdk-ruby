        ...
        class KeyCredentialConfiguration
            ...
            def get_field_deserializers()
                return {
                    ...
                    "restrictionType" => lambda {|n| @restriction_type = n.get_enum_value(MicrosoftGraph::Models::KeyCredentialConfigurationRestrictionType) },
                }
            end
            ## 
            ...
            ## @return a key_credential_configuration_restriction_type
            ## 
