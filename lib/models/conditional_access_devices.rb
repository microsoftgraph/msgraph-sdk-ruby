    ...
    module Models
        class ConditionalAccessDevices
            ...
            def get_field_deserializers()
                return {
                    "deviceFilter" => lambda {|n| @device_filter = n.get_object_value(lambda {|pn| MicrosoftGraph::Models::ConditionalAccessFilter.create_from_discriminator_value(pn) }) },
            ...
            def serialize(writer)
                ...
                writer.write_object_value("deviceFilter", @device_filter) unless @device_filter.nil?
