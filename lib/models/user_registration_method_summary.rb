...
module MicrosoftGraph
    module Models
        class UserRegistrationMethodSummary
            ...
            @user_registration_method_counts
            ## 
            ...
            ## @return a user_registration_method_summary
            ## 
            ...
            def serialize(writer)
                ...
                writer.write_collection_of_object_values("userRegistrationMethodCounts", @user_registration_method_counts) unless @user_registration_method_counts.nil?
