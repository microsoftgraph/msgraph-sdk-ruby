...
module MicrosoftGraph
    module Models
        class ExternalConnectorsExternalItem < MicrosoftGraph::Models::Entity
            ...
            ## @return a external_connectors_acl
            ## 
            def acl
                return @acl
            end
            ...
            ## @return a external_connectors_properties
            ## 
            def properties
                return @properties
            end
            ...
            def serialize(writer)
                ...
                super
                writer.write_collection_of_object_values("acl", @acl) unless @acl.nil?
                ...
                writer.write_object_value("properties", @properties) unless @properties.nil?
            end
        end
    end
end
