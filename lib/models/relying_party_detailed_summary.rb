        ...
        class RelyingPartyDetailedSummary < MicrosoftGraph::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "signInSuccessRate" => lambda {|n| @sign_in_success_rate = n.get_object_value(lambda {|pn| RelyingPartyDetailedSummary::RelyingPartyDetailedSummarySignInSuccessRate.create_from_discriminator_value(pn) }) },
            ...
            ## @return a relying_party_detailed_summary_sign_in_success_rate
            ## 
            ...
            class RelyingPartyDetailedSummarySignInSuccessRate
                include MicrosoftKiotaAbstractions::Parsable
                ## 
                ...
                def self.create_from_discriminator_value(parse_node)
                    ...
                    return RelyingPartyDetailedSummarySignInSuccessRate.new
                end
                ## 
