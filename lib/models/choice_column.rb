    ...
    module Models
        class ChoiceColumn
            ...
            def serialize(writer)
                ...
                writer.write_boolean_value("allowTextEntry", @allow_text_entry) unless @allow_text_entry.nil?
                writer.write_collection_of_primitive_values("choices", @choices) unless @choices.nil?
