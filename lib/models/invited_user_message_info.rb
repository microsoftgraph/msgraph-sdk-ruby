    ...
    module Models
        class InvitedUserMessageInfo
            ...
            def serialize(writer)
                ...
                writer.write_string_value("customizedMessageBody", @customized_message_body) unless @customized_message_body.nil?
                writer.write_string_value("messageLanguage", @message_language) unless @message_language.nil?
