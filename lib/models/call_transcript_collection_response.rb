...
module MicrosoftGraph
    module Models
        class CallTranscriptCollectionResponse < MicrosoftGraph::Models::BaseCollectionPaginationCountResponse
            ...
            ## @return a call_transcript_collection_response
            ## 
            def self.create_from_discriminator_value(parse_node)
                raise StandardError, 'parse_node cannot be null' if parse_node.nil?
                return CallTranscriptCollectionResponse.new
            end
            ## 
