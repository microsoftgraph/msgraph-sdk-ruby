...
module MicrosoftGraph
    module Models
        class EmployeeOrgData
            ...
            ## @param value Value to set for the cost_center property.
            ## @return a void
            ## 
            def cost_center=(value)
                @cost_center = value
            end
            ## 
            ...
            def serialize(writer)
                ...
                writer.write_string_value("costCenter", @cost_center)
                writer.write_string_value("division", @division)
