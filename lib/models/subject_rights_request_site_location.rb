...
module MicrosoftGraph
    module Models
        class SubjectRightsRequestSiteLocation
            ...
            def self.create_from_discriminator_value(parse_node)
                ...
                unless mapping_value_node.nil? then
                    ...
                    case mapping_value
                        when "#microsoft.graph.subjectRightsRequestAllSiteLocation"
                            return SubjectRightsRequestAllSiteLocation.new
                        when "#microsoft.graph.subjectRightsRequestEnumeratedSiteLocation"
                            return SubjectRightsRequestEnumeratedSiteLocation.new
                    end
                end
                return SubjectRightsRequestSiteLocation.new
            end
            ## 
