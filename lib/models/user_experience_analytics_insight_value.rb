...
module MicrosoftGraph
    module Models
        ...
        class UserExperienceAnalyticsInsightValue
            ...
            def self.create_from_discriminator_value(parse_node)
                ...
                unless mapping_value_node.nil? then
                    ...
                    case mapping_value
                        when "#microsoft.graph.insightValueDouble"
                            return InsightValueDouble.new
                        when "#microsoft.graph.insightValueInt"
                            return InsightValueInt.new
                    end
                end
                return UserExperienceAnalyticsInsightValue.new
            end
            ## 
