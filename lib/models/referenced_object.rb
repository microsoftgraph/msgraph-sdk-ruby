...
module MicrosoftGraph
    module Models
        class ReferencedObject
            ...
            ## @param value Value to set for the referenced_object_name property.
            ## @return a void
            ## 
            ...
            ## @param value Value to set for the referenced_property property.
            ## @return a void
            ## 
            ...
            def serialize(writer)
                ...
                writer.write_string_value("referencedObjectName", @referenced_object_name)
                writer.write_string_value("referencedProperty", @referenced_property)
