...
module MicrosoftGraph
    module Models
        class ProtectionUnitsBulkJobBase < MicrosoftGraph::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "status" => lambda {|n| @status = n.get_enum_value(MicrosoftGraph::Models::ProtectionUnitsBulkJobStatus) },
                })
            end
            ## 
