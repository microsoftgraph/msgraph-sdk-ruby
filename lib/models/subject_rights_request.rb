        ...
        class SubjectRightsRequest < MicrosoftGraph::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "dataSubjectType" => lambda {|n| @data_subject_type = n.get_enum_value(MicrosoftGraph::Models::SubjectRightsRequestDataSubjectType) },
                    ...
                    "mailboxLocations" => lambda {|n| @mailbox_locations = n.get_object_value(lambda {|pn| MicrosoftGraph::Models::SubjectRightsRequestMailboxLocation.create_from_discriminator_value(pn) }) },
                    ...
                    "siteLocations" => lambda {|n| @site_locations = n.get_object_value(lambda {|pn| MicrosoftGraph::Models::SubjectRightsRequestSiteLocation.create_from_discriminator_value(pn) }) },
