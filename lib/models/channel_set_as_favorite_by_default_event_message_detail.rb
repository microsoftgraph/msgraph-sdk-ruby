...
module MicrosoftGraph
    module Models
        class ChannelSetAsFavoriteByDefaultEventMessageDetail < MicrosoftGraph::Models::EventMessageDetail
            ...
            def initialize()
                super
                @odata_type = "#microsoft.graph.channelSetAsFavoriteByDefaultEventMessageDetail"
            end
            ## 
            ## Creates a new instance of the appropriate class based on discriminator value
            ## @param parseNode The parse node to use to read the discriminator value and create the object
            ## @return a channel_set_as_favorite_by_default_event_message_detail
            ## 
