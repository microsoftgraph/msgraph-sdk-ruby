...
module MicrosoftGraph
    module Models
        class ChannelRenamedEventMessageDetail < MicrosoftGraph::Models::EventMessageDetail
            ...
            def initialize()
                super
                @odata_type = "#microsoft.graph.channelRenamedEventMessageDetail"
            end
            ## 
            ## Creates a new instance of the appropriate class based on discriminator value
            ## @param parse_node The parse node to use to read the discriminator value and create the object
            ## @return a channel_renamed_event_message_detail
            ## 
            ...
            def serialize(writer)
                ...
                super
                writer.write_string_value("channelDisplayName", @channel_display_name) unless @channel_display_name.nil?
