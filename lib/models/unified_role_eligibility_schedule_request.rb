...
module MicrosoftGraph
    module Models
        class UnifiedRoleEligibilityScheduleRequest < MicrosoftGraph::Models::Request
            ...
            ## @return a unified_role_eligibility_schedule_request_action
            ## 
            def action
                return @action
            end
            ...
            def get_field_deserializers()
                return super.merge({
                    "action" => lambda {|n| @action = n.get_enum_value(MicrosoftGraph::Models::UnifiedRoleEligibilityScheduleRequestAction) },
