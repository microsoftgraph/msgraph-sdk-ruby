    ...
    module Models
        class ItemPreviewInfo
            ...
            def serialize(writer)
                ...
                writer.write_string_value("getUrl", @get_url) unless @get_url.nil?
                writer.write_string_value("@odata.type", @odata_type) unless @odata_type.nil?
                writer.write_string_value("postParameters", @post_parameters) unless @post_parameters.nil?
                writer.write_string_value("postUrl", @post_url) unless @post_url.nil?
