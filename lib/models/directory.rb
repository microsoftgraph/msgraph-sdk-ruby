        ...
        class Directory < MicrosoftGraph::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "publicKeyInfrastructure" => lambda {|n| @public_key_infrastructure = n.get_object_value(lambda {|pn| MicrosoftGraph::Models::PublicKeyInfrastructureRoot.create_from_discriminator_value(pn) }) },
            ...
            ## 
            def public_key_infrastructure
                return @public_key_infrastructure
            end
            ## 
            ...
            ## @return a void
            ## 
            def public_key_infrastructure=(value)
                @public_key_infrastructure = value
            end
            ## 
            ...
            def serialize(writer)
                ...
                writer.write_object_value("publicKeyInfrastructure", @public_key_infrastructure)
