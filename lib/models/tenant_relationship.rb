    ...
    module Models
        class TenantRelationship
            ...
            def serialize(writer)
                ...
                writer.write_collection_of_object_values("delegatedAdminCustomers", @delegated_admin_customers) unless @delegated_admin_customers.nil?
                writer.write_collection_of_object_values("delegatedAdminRelationships", @delegated_admin_relationships) unless @delegated_admin_relationships.nil?
