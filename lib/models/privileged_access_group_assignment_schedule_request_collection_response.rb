...
module MicrosoftGraph
    module Models
        class PrivilegedAccessGroupAssignmentScheduleRequestCollectionResponse < MicrosoftGraph::Models::BaseCollectionPaginationCountResponse
            ...
            ## @return a privileged_access_group_assignment_schedule_request_collection_response
            ## 
            def self.create_from_discriminator_value(parse_node)
                raise StandardError, 'parse_node cannot be null' if parse_node.nil?
                return PrivilegedAccessGroupAssignmentScheduleRequestCollectionResponse.new
            end
            ## 
