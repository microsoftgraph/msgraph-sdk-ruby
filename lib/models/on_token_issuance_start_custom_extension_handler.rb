...
module MicrosoftGraph
    module Models
        class OnTokenIssuanceStartCustomExtensionHandler < MicrosoftGraph::Models::OnTokenIssuanceStartHandler
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "customExtension" => lambda {|n| @custom_extension = n.get_object_value(lambda {|pn| MicrosoftGraph::Models::OnTokenIssuanceStartCustomExtension.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
