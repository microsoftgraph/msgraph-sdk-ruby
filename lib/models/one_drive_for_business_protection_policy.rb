...
module MicrosoftGraph
    module Models
        class OneDriveForBusinessProtectionPolicy < MicrosoftGraph::Models::ProtectionPolicyBase
            ...
            @drive_protection_units_bulk_addition_jobs
            ## 
            ...
            ## @return a drive_protection_units_bulk_addition_job
            ## 
            def drive_protection_units_bulk_addition_jobs
                return @drive_protection_units_bulk_addition_jobs
            end
            ## 
            ...
            ## @return a void
            ## 
            def drive_protection_units_bulk_addition_jobs=(value)
                @drive_protection_units_bulk_addition_jobs = value
            end
            ## 
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "driveProtectionUnitsBulkAdditionJobs" => lambda {|n| @drive_protection_units_bulk_addition_jobs = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraph::Models::DriveProtectionUnitsBulkAdditionJob.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
            ...
            def serialize(writer)
                ...
                writer.write_collection_of_object_values("driveProtectionUnitsBulkAdditionJobs", @drive_protection_units_bulk_addition_jobs)
            end
        end
    end
end
