        ...
        class IdentitySource
            ...
            def self.create_from_discriminator_value(parse_node)
                ...
                unless mapping_value_node.nil? then
                    ...
                    case mapping_value
                        when "#microsoft.graph.azureActiveDirectoryTenant"
                            return AzureActiveDirectoryTenant.new
                        when "#microsoft.graph.crossCloudAzureActiveDirectoryTenant"
                            return CrossCloudAzureActiveDirectoryTenant.new
                        when "#microsoft.graph.domainIdentitySource"
                            return DomainIdentitySource.new
                        when "#microsoft.graph.externalDomainFederation"
                            return ExternalDomainFederation.new
                        when "#microsoft.graph.socialIdentitySource"
                            return SocialIdentitySource.new
                    end
                end
                return IdentitySource.new
            end
            ## 
