        ...
        module Security
            class RetentionEventStatus
                ...
                def self.create_from_discriminator_value(parse_node)
                    ...
                    return RetentionEventStatus.new
                end
                ## 
                ...
                def get_field_deserializers()
                    return {
                        ...
                        "status" => lambda {|n| @status = n.get_enum_value(MicrosoftGraph::Models::Security::EventStatusType) },
                    }
                end
                ## 
