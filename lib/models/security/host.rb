...
module MicrosoftGraph
    module Models
        module Security
            class Host < MicrosoftGraph::Models::Security::Artifact
                ...
                def get_field_deserializers()
                    return super.merge({
                        "components" => lambda {|n| @components = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraph::Models::Security::HostComponent.create_from_discriminator_value(pn) }) },
                        "cookies" => lambda {|n| @cookies = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraph::Models::Security::HostCookie.create_from_discriminator_value(pn) }) },
                        "firstSeenDateTime" => lambda {|n| @first_seen_date_time = n.get_date_time_value() },
                        "lastSeenDateTime" => lambda {|n| @last_seen_date_time = n.get_date_time_value() },
                        "passiveDns" => lambda {|n| @passive_dns = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraph::Models::Security::PassiveDnsRecord.create_from_discriminator_value(pn) }) },
                        "passiveDnsReverse" => lambda {|n| @passive_dns_reverse = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraph::Models::Security::PassiveDnsRecord.create_from_discriminator_value(pn) }) },
                        "reputation" => lambda {|n| @reputation = n.get_object_value(lambda {|pn| MicrosoftGraph::Models::Security::HostReputation.create_from_discriminator_value(pn) }) },
                        "trackers" => lambda {|n| @trackers = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraph::Models::Security::HostTracker.create_from_discriminator_value(pn) }) },
                    })
                end
                ## 
                ...
                ## @param value Value to set for the passive_dns property.
                ## @return a void
                ## 
                ...
                ## @param value Value to set for the passive_dns_reverse property.
                ## @return a void
                ## 
