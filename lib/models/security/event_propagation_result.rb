        ...
        module Security
            class EventPropagationResult
                ...
                def self.create_from_discriminator_value(parse_node)
                    ...
                    return EventPropagationResult.new
                end
                ## 
                ...
                def get_field_deserializers()
                    return {
                        ...
                        "status" => lambda {|n| @status = n.get_enum_value(MicrosoftGraph::Models::Security::EventPropagationStatus) },
                ...
                ## @return a event_propagation_status
                ## 
                def status
                    return @status
                end
