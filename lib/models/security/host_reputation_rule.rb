            ...
            class HostReputationRule
                ...
                def get_field_deserializers()
                    return {
                        ...
                        "severity" => lambda {|n| @severity = n.get_enum_value(MicrosoftGraph::Models::Security::HostReputationRuleSeverity) },
                    }
                end
                ## 
                ...
                ## @param value Value to set for the related_details_url property.
                ## @return a void
                ## 
                ...
                ## @return a host_reputation_rule_severity
                ## 
                def severity
                    return @severity
                end
