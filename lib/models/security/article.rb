...
module MicrosoftGraph
    module Models
        module Security
            class Article < MicrosoftGraph::Models::Entity
                ...
                def get_field_deserializers()
                    return super.merge({
                        "body" => lambda {|n| @body = n.get_object_value(lambda {|pn| MicrosoftGraph::Models::Security::FormattedContent.create_from_discriminator_value(pn) }) },
                        "createdDateTime" => lambda {|n| @created_date_time = n.get_date_time_value() },
                        "imageUrl" => lambda {|n| @image_url = n.get_string_value() },
                        "indicators" => lambda {|n| @indicators = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraph::Models::Security::ArticleIndicator.create_from_discriminator_value(pn) }) },
