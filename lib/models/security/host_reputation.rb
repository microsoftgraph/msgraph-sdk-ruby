...
module MicrosoftGraph
    module Models
        module Security
            class HostReputation < MicrosoftGraph::Models::Entity
                ...
                ## @return a host_reputation_classification
                ## 
                def classification
                ...
                def get_field_deserializers()
                    return super.merge({
                        "classification" => lambda {|n| @classification = n.get_enum_value(MicrosoftGraph::Models::Security::HostReputationClassification) },
                        "rules" => lambda {|n| @rules = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraph::Models::Security::HostReputationRule.create_from_discriminator_value(pn) }) },
