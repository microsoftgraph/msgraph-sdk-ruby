...
module MicrosoftGraph
    module Models
        module Security
            class IntelligenceProfile < MicrosoftGraph::Models::Entity
                ...
                ## @return a intelligence_profile_country_or_region_of_origin
                ## 
                ...
                ## @param value Value to set for the countries_or_regions_of_origin property.
                ## @return a void
                ## 
                ...
                def get_field_deserializers()
                    return super.merge({
                        ...
                        "countriesOrRegionsOfOrigin" => lambda {|n| @countries_or_regions_of_origin = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraph::Models::Security::IntelligenceProfileCountryOrRegionOfOrigin.create_from_discriminator_value(pn) }) },
                        "description" => lambda {|n| @description = n.get_object_value(lambda {|pn| MicrosoftGraph::Models::Security::FormattedContent.create_from_discriminator_value(pn) }) },
                        "firstActiveDateTime" => lambda {|n| @first_active_date_time = n.get_date_time_value() },
                        "indicators" => lambda {|n| @indicators = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraph::Models::Security::IntelligenceProfileIndicator.create_from_discriminator_value(pn) }) },
                        "kind" => lambda {|n| @kind = n.get_enum_value(MicrosoftGraph::Models::Security::IntelligenceProfileKind) },
                        "summary" => lambda {|n| @summary = n.get_object_value(lambda {|pn| MicrosoftGraph::Models::Security::FormattedContent.create_from_discriminator_value(pn) }) },
                        "targets" => lambda {|n| @targets = n.get_collection_of_primitive_values(String) },
                        "title" => lambda {|n| @title = n.get_string_value() },
                        "tradecraft" => lambda {|n| @tradecraft = n.get_object_value(lambda {|pn| MicrosoftGraph::Models::Security::FormattedContent.create_from_discriminator_value(pn) }) },
                    })
                end
                ## 
