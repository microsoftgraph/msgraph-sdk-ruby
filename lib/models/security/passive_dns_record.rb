...
module MicrosoftGraph
    module Models
        module Security
            class PassiveDnsRecord < MicrosoftGraph::Models::Security::Artifact
                ...
                ## @param value Value to set for the collected_date_time property.
                ## @return a void
                ## 
                ...
                def get_field_deserializers()
                    return super.merge({
                        "artifact" => lambda {|n| @artifact = n.get_object_value(lambda {|pn| MicrosoftGraph::Models::Security::Artifact.create_from_discriminator_value(pn) }) },
                        "collectedDateTime" => lambda {|n| @collected_date_time = n.get_date_time_value() },
                        "firstSeenDateTime" => lambda {|n| @first_seen_date_time = n.get_date_time_value() },
                        "lastSeenDateTime" => lambda {|n| @last_seen_date_time = n.get_date_time_value() },
                        "parentHost" => lambda {|n| @parent_host = n.get_object_value(lambda {|pn| MicrosoftGraph::Models::Security::Host.create_from_discriminator_value(pn) }) },
