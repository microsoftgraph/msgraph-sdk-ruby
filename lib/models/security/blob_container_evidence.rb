...
module MicrosoftGraph
    module Models
        module Security
            class BlobContainerEvidence < MicrosoftGraph::Models::Security::AlertEvidence
                ...
                def get_field_deserializers()
                    return super.merge({
                        ...
                        "storageResource" => lambda {|n| @storage_resource = n.get_object_value(lambda {|pn| MicrosoftGraph::Models::Security::AzureResourceEvidence.create_from_discriminator_value(pn) }) },
