...
module MicrosoftGraph
    module Models
        module Security
            class Indicator < MicrosoftGraph::Models::Entity
                ...
                def get_field_deserializers()
                    return super.merge({
                        ...
                        "source" => lambda {|n| @source = n.get_enum_value(MicrosoftGraph::Models::Security::IndicatorSource) },
                    })
                end
                ## 
