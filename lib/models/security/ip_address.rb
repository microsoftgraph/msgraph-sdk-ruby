...
module MicrosoftGraph
    module Models
        module Security
            class IpAddress < MicrosoftGraph::Models::Security::Host
                ...
                ## @param value Value to set for the autonomous_system property.
                ## @return a void
                ## 
                ...
                def get_field_deserializers()
                    return super.merge({
                        "autonomousSystem" => lambda {|n| @autonomous_system = n.get_object_value(lambda {|pn| MicrosoftGraph::Models::Security::AutonomousSystem.create_from_discriminator_value(pn) }) },
                ...
                ## @param value Value to set for the hosting_provider property.
                ## @return a void
                ## 
