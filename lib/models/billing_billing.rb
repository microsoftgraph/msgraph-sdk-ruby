        ...
        class .models.partners.billingBilling < MicrosoftGraph::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "reconciliation" => lambda {|n| @reconciliation = n.get_object_value(lambda {|pn| MicrosoftGraph::Models::.models.partners.billingBillingReconciliation.create_from_discriminator_value(pn) }) },
            ...
            def serialize(writer)
                ...
                writer.write_object_value("reconciliation", @reconciliation)
