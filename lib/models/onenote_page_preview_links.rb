    ...
    module Models
        class OnenotePagePreviewLinks
            ...
            def self.create_from_discriminator_value(parse_node)
                ...
                return OnenotePagePreviewLinks.new
            end
            ## 
            ...
            def get_field_deserializers()
                return {
                    ...
                    "previewImageUrl" => lambda {|n| @preview_image_url = n.get_object_value(lambda {|pn| MicrosoftGraph::Models::ExternalLink.create_from_discriminator_value(pn) }) },
                }
            end
            ## 
            ...
            def serialize(writer)
                ...
                writer.write_object_value("previewImageUrl", @preview_image_url) unless @preview_image_url.nil?
