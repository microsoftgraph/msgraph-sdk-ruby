...
module MicrosoftGraph
    module Models
        ...
        class DeviceGeoLocation
            ...
            ## @return a device_geo_location_altitude
            ## 
            def altitude
                return @altitude
            end
            ...
            def get_field_deserializers()
                return {
                    "altitude" => lambda {|n| @altitude = n.get_object_value(lambda {|pn| DeviceGeoLocation::DeviceGeoLocationAltitude.create_from_discriminator_value(pn) }) },
                    "heading" => lambda {|n| @heading = n.get_object_value(lambda {|pn| DeviceGeoLocation::DeviceGeoLocationHeading.create_from_discriminator_value(pn) }) },
                    "horizontalAccuracy" => lambda {|n| @horizontal_accuracy = n.get_object_value(lambda {|pn| DeviceGeoLocation::DeviceGeoLocationHorizontalAccuracy.create_from_discriminator_value(pn) }) },
                    "lastCollectedDateTime" => lambda {|n| @last_collected_date_time = n.get_date_time_value() },
                    "latitude" => lambda {|n| @latitude = n.get_object_value(lambda {|pn| DeviceGeoLocation::DeviceGeoLocationLatitude.create_from_discriminator_value(pn) }) },
                    "longitude" => lambda {|n| @longitude = n.get_object_value(lambda {|pn| DeviceGeoLocation::DeviceGeoLocationLongitude.create_from_discriminator_value(pn) }) },
                    "@odata.type" => lambda {|n| @odata_type = n.get_string_value() },
                    "speed" => lambda {|n| @speed = n.get_object_value(lambda {|pn| DeviceGeoLocation::DeviceGeoLocationSpeed.create_from_discriminator_value(pn) }) },
                    "verticalAccuracy" => lambda {|n| @vertical_accuracy = n.get_object_value(lambda {|pn| DeviceGeoLocation::DeviceGeoLocationVerticalAccuracy.create_from_discriminator_value(pn) }) },
                }
            end
            ## 
            ## Gets the heading property value. Heading in degrees from true north
            ## @return a device_geo_location_heading
            ## 
            def heading
                return @heading
            end
            ...
            ## @return a device_geo_location_horizontal_accuracy
            ## 
            ...
            ## @return a device_geo_location_latitude
            ## 
            def latitude
                return @latitude
            end
            ...
            ## @return a device_geo_location_longitude
            ## 
            def longitude
                return @longitude
            end
            ...
            ## @return a device_geo_location_speed
            ## 
            def speed
                return @speed
            end
            ...
            ## @return a device_geo_location_vertical_accuracy
            ## 
            ...
            class DeviceGeoLocationAltitude
                ...
                def self.create_from_discriminator_value(parse_node)
                    ...
                    return DeviceGeoLocationAltitude.new
                end
                ## 
            ...
            ## 
            # Composed type wrapper for classes Double, ReferenceNumeric, string
            class DeviceGeoLocationHeading
                include MicrosoftKiotaAbstractions::Parsable
                ## 
                # Composed type representation for type Double
                @double
                ...
                def self.create_from_discriminator_value(parse_node)
                    ...
                    return DeviceGeoLocationHeading.new
                end
                ## 
                ## Gets the double property value. Composed type representation for type Double
                ## @return a double
            ...
            ## 
            # Composed type wrapper for classes Double, ReferenceNumeric, string
            class DeviceGeoLocationHorizontalAccuracy
                include MicrosoftKiotaAbstractions::Parsable
                ## 
                # Composed type representation for type Double
                @double
                ...
                def self.create_from_discriminator_value(parse_node)
                    ...
                    return DeviceGeoLocationHorizontalAccuracy.new
                end
                ## 
                ## Gets the double property value. Composed type representation for type Double
                ## @return a double
            ...
            ## 
            # Composed type wrapper for classes Double, ReferenceNumeric, string
            class DeviceGeoLocationLatitude
                include MicrosoftKiotaAbstractions::Parsable
                ## 
                # Composed type representation for type Double
                @double
                ...
                def self.create_from_discriminator_value(parse_node)
                    ...
                    return DeviceGeoLocationLatitude.new
                end
                ## 
                ## Gets the double property value. Composed type representation for type Double
                ## @return a double
            ...
            ## 
            # Composed type wrapper for classes Double, ReferenceNumeric, string
            class DeviceGeoLocationLongitude
                include MicrosoftKiotaAbstractions::Parsable
                ## 
                # Composed type representation for type Double
                @double
                ...
                def self.create_from_discriminator_value(parse_node)
                    ...
                    return DeviceGeoLocationLongitude.new
                end
                ## 
                ## Gets the double property value. Composed type representation for type Double
                ## @return a double
            ...
            class DeviceGeoLocationSpeed
                ...
                def self.create_from_discriminator_value(parse_node)
                    ...
                    return DeviceGeoLocationSpeed.new
                end
                ## 
                ## Gets the double property value. Composed type representation for type Double
                ## @return a double
            ...
            ## 
            # Composed type wrapper for classes Double, ReferenceNumeric, string
            class DeviceGeoLocationVerticalAccuracy
                include MicrosoftKiotaAbstractions::Parsable
                ## 
                # Composed type representation for type Double
                @double
                ...
                def self.create_from_discriminator_value(parse_node)
                    ...
                    return DeviceGeoLocationVerticalAccuracy.new
                end
                ## 
                ## Gets the double property value. Composed type representation for type Double
                ## @return a double
