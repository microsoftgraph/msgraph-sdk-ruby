...
module MicrosoftGraph
    module Models
        class SecurityVmMetadata
            ...
            ## @return a security_vm_cloud_provider
            ## 
            def cloud_provider
            ...
            def get_field_deserializers()
                return {
                    "cloudProvider" => lambda {|n| @cloud_provider = n.get_enum_value(MicrosoftGraph::Models::SecurityVmCloudProvider) },
            ...
            def serialize(writer)
                ...
                writer.write_enum_value("cloudProvider", @cloud_provider) unless @cloud_provider.nil?
                ...
                writer.write_string_value("vmId", @vm_id) unless @vm_id.nil?
