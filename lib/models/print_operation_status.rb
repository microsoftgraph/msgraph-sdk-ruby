    ...
    module Models
        class PrintOperationStatus
            ...
            def self.create_from_discriminator_value(parse_node)
                ...
                return PrintOperationStatus.new
            end
            ## 
            ...
            def get_field_deserializers()
                return {
                    ...
                    "state" => lambda {|n| @state = n.get_enum_value(MicrosoftGraph::Models::PrintOperationProcessingState) },
                }
            end
            ## 
            ...
            ## @return a print_operation_processing_state
            ## 
            def state
                return @state
            end
