        ...
        class Payload < MicrosoftGraph::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "platform" => lambda {|n| @platform = n.get_enum_value(MicrosoftGraph::Models::PayloadPlatform) },
                    ...
                    "simulationAttackType" => lambda {|n| @simulation_attack_type = n.get_enum_value(MicrosoftGraph::Models::PayloadSimulationAttackType) },
                    "source" => lambda {|n| @source = n.get_enum_value(MicrosoftGraph::Models::SimulationContentSource) },
                    "status" => lambda {|n| @status = n.get_enum_value(MicrosoftGraph::Models::PayloadStatus) },
                    "technique" => lambda {|n| @technique = n.get_enum_value(MicrosoftGraph::Models::PayloadTechnique) },
            ...
            ## @return a payload_simulation_attack_type
            ## 
