...
module MicrosoftGraph
    module Models
        class ProtectionUnitBase < MicrosoftGraph::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "status" => lambda {|n| @status = n.get_enum_value(MicrosoftGraph::Models::ProtectionUnitStatus) },
                })
            end
            ## 
            ...
            ## @return a protection_unit_status
            ## 
            def status
                return @status
            end
