    ...
    module Models
        class MediaContentRatingFrance
            ...
            def self.create_from_discriminator_value(parse_node)
                ...
                return MediaContentRatingFrance.new
            end
            ## 
            ...
            def get_field_deserializers()
                return {
                    "movieRating" => lambda {|n| @movie_rating = n.get_enum_value(MicrosoftGraph::Models::RatingFranceMoviesType) },
                    "@odata.type" => lambda {|n| @odata_type = n.get_string_value() },
                    "tvRating" => lambda {|n| @tv_rating = n.get_enum_value(MicrosoftGraph::Models::RatingFranceTelevisionType) },
                }
            end
            ## 
            ## Gets the movieRating property value. Movies rating labels in France
            ## @return a rating_france_movies_type
            ## 
            def movie_rating
                return @movie_rating
            end
            ...
            ## @return a rating_france_television_type
            ## 
            def tv_rating
                return @tv_rating
            end
