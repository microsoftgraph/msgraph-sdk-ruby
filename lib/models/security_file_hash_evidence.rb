...
module MicrosoftGraph
    module Models
        class SecurityFileHashEvidence < MicrosoftGraph::Models::SecurityAlertEvidence
            ...
            ## 
            ## Instantiates a new SecurityFileHashEvidence and sets the default values.
            ## @return a void
            ## 
            def initialize()
                super
                @odata_type = "#microsoft.graph.security.fileHashEvidence"
            end
            ## 
            ## Creates a new instance of the appropriate class based on discriminator value
            ## @param parse_node The parse node to use to read the discriminator value and create the object
            ## @return a security_file_hash_evidence
            ## 
