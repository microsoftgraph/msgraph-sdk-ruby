...
module MicrosoftGraph
    module Models
        class CallRecordsNetworkInfo
            ...
            ## @return a network_info_bandwidth_low_event_ratio
            ## 
            ...
            ## @return a call_records_network_connection_type
            ## 
            def connection_type
            ...
            ## @return a network_info_delay_event_ratio
            ## 
            ...
            def get_field_deserializers()
                return {
                    "bandwidthLowEventRatio" => lambda {|n| @bandwidth_low_event_ratio = n.get_object_value(lambda {|pn| CallRecordsNetworkInfo::NetworkInfoBandwidthLowEventRatio.create_from_discriminator_value(pn) }) },
                    ...
                    "delayEventRatio" => lambda {|n| @delay_event_ratio = n.get_object_value(lambda {|pn| CallRecordsNetworkInfo::NetworkInfoDelayEventRatio.create_from_discriminator_value(pn) }) },
                    ...
                    "receivedQualityEventRatio" => lambda {|n| @received_quality_event_ratio = n.get_object_value(lambda {|pn| CallRecordsNetworkInfo::NetworkInfoReceivedQualityEventRatio.create_from_discriminator_value(pn) }) },
                    ...
                    "sentQualityEventRatio" => lambda {|n| @sent_quality_event_ratio = n.get_object_value(lambda {|pn| CallRecordsNetworkInfo::NetworkInfoSentQualityEventRatio.create_from_discriminator_value(pn) }) },
            ...
            ## @return a call_records_network_transport_protocol
            ## 
            ...
            ## @return a network_info_received_quality_event_ratio
            ## 
            ...
            ## @return a network_info_sent_quality_event_ratio
            ## 
            ...
            def serialize(writer)
                ...
                writer.write_object_value("bandwidthLowEventRatio", @bandwidth_low_event_ratio)
                ...
                writer.write_object_value("delayEventRatio", @delay_event_ratio)
                ...
                writer.write_object_value("receivedQualityEventRatio", @received_quality_event_ratio)
                ...
                writer.write_object_value("sentQualityEventRatio", @sent_quality_event_ratio)
            ...
            ## @return a call_records_trace_route_hop
            ## 
            ...
            ## @return a call_records_wifi_band
            ## 
            def wifi_band
                return @wifi_band
            end
            ...
            ## @return a call_records_wifi_radio_type
            ## 
            def wifi_radio_type
            ...
            class NetworkInfoBandwidthLowEventRatio
                ...
                def self.create_from_discriminator_value(parse_node)
                    ...
                    return NetworkInfoBandwidthLowEventRatio.new
                end
                ## 
            ...
            ## 
            # Composed type wrapper for classes float, ReferenceNumeric, string
            class NetworkInfoDelayEventRatio
                include MicrosoftKiotaAbstractions::Parsable
                ## 
                # Composed type representation for type float
                @float
                ...
                def self.create_from_discriminator_value(parse_node)
                    ...
                    return NetworkInfoDelayEventRatio.new
                end
                ## 
                ## Gets the float property value. Composed type representation for type float
                ## @return a float
            ...
            ## 
            # Composed type wrapper for classes float, ReferenceNumeric, string
            class NetworkInfoReceivedQualityEventRatio
                include MicrosoftKiotaAbstractions::Parsable
                ## 
                # Composed type representation for type float
                @float
                ...
                def self.create_from_discriminator_value(parse_node)
                    ...
                    return NetworkInfoReceivedQualityEventRatio.new
                end
                ## 
                ## Gets the float property value. Composed type representation for type float
                ## @return a float
            ...
            ## 
            # Composed type wrapper for classes float, ReferenceNumeric, string
            class NetworkInfoSentQualityEventRatio
                include MicrosoftKiotaAbstractions::Parsable
                ## 
                # Composed type representation for type float
                @float
                ...
                def self.create_from_discriminator_value(parse_node)
                    ...
                    return NetworkInfoSentQualityEventRatio.new
                end
                ## 
                ## Gets the float property value. Composed type representation for type float
                ## @return a float
