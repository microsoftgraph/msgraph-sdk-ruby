    ...
    module Models
        class SearchAlterationOptions
            ...
            def serialize(writer)
                ...
                writer.write_boolean_value("enableModification", @enable_modification) unless @enable_modification.nil?
                writer.write_boolean_value("enableSuggestion", @enable_suggestion) unless @enable_suggestion.nil?
