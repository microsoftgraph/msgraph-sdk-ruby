...
module MicrosoftGraph
    module Models
        class OnAttributeCollectionStartHandler
            ...
            def self.create_from_discriminator_value(parse_node)
                ...
                unless mapping_value_node.nil? then
                    ...
                    case mapping_value
                        when "#microsoft.graph.onAttributeCollectionStartCustomExtensionHandler"
                            return OnAttributeCollectionStartCustomExtensionHandler.new
                    end
                end
                return OnAttributeCollectionStartHandler.new
            end
            ## 
