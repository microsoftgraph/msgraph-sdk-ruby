...
module MicrosoftGraph
    module Models
        class CallStartedEventMessageDetail < MicrosoftGraph::Models::EventMessageDetail
            ...
            ## @return a call_started_event_message_detail_call_event_type
            ## 
            def call_event_type
            ...
            def get_field_deserializers()
                return super.merge({
                    "callEventType" => lambda {|n| @call_event_type = n.get_enum_value(MicrosoftGraph::Models::CallStartedEventMessageDetailCallEventType) },
