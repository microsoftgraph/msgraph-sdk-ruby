        ...
        class Application < MicrosoftGraph::Models::DirectoryObject
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "authenticationBehaviors" => lambda {|n| @authentication_behaviors = n.get_object_value(lambda {|pn| MicrosoftGraph::Models::AuthenticationBehaviors.create_from_discriminator_value(pn) }) },
                    ...
                    "nativeAuthenticationApisEnabled" => lambda {|n| @native_authentication_apis_enabled = n.get_enum_values(MicrosoftGraph::Models::NativeAuthenticationApisEnabled) },
            ...
            ## @return a native_authentication_apis_enabled
            ## 
            def native_authentication_apis_enabled
                return @native_authentication_apis_enabled
            end
            ## 
            ...
            ## @return a void
            ## 
            def native_authentication_apis_enabled=(value)
                @native_authentication_apis_enabled = value
            end
            ## 
            ...
            def serialize(writer)
                ...
                writer.write_enum_value("nativeAuthenticationApisEnabled", @native_authentication_apis_enabled)
