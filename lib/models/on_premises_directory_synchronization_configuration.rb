    ...
    module Models
        class OnPremisesDirectorySynchronizationConfiguration
            ...
            def get_field_deserializers()
                return {
                    "accidentalDeletionPrevention" => lambda {|n| @accidental_deletion_prevention = n.get_object_value(lambda {|pn| MicrosoftGraph::Models::OnPremisesAccidentalDeletionPrevention.create_from_discriminator_value(pn) }) },
            ...
            def serialize(writer)
                ...
                writer.write_object_value("accidentalDeletionPrevention", @accidental_deletion_prevention) unless @accidental_deletion_prevention.nil?
