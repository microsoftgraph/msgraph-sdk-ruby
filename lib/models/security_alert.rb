...
module MicrosoftGraph
    module Models
        class SecurityAlert < MicrosoftGraph::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "customDetails" => lambda {|n| @custom_details = n.get_object_value(lambda {|pn| MicrosoftGraph::Models::SecurityDictionary.create_from_discriminator_value(pn) }) },
            ...
            def serialize(writer)
                ...
                writer.write_object_value("customDetails", @custom_details)
            ...
            ## @return a security_service_source
            ## 
            def service_source
            ...
            ## @return a security_alert_status
            ## 
            def status
                return @status
            end
