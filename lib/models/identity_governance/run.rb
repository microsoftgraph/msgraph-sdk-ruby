...
module MicrosoftGraph
    module Models
        module IdentityGovernance
            class Run < MicrosoftGraph::Models::Entity
                ...
                ## @param value Value to set for the failed_tasks_count property.
                ## @return a void
                ## 
                ...
                ## @param value Value to set for the failed_users_count property.
                ## @return a void
                ## 
                ...
                def get_field_deserializers()
                    return super.merge({
                        ...
                        "workflowExecutionType" => lambda {|n| @workflow_execution_type = n.get_enum_value(MicrosoftGraph::Models::IdentityGovernance::WorkflowExecutionType) },
                    })
                end
                ## 
                ...
                ## @param value Value to set for the scheduled_date_time property.
                ## @return a void
                ## 
                ...
                ## @param value Value to set for the successful_users_count property.
                ## @return a void
                ## 
                ...
                ## @param value Value to set for the total_tasks_count property.
                ## @return a void
                ## 
                ...
                ## @param value Value to set for the total_unprocessed_tasks_count property.
                ## @return a void
                ## 
                ...
                ## @param value Value to set for the total_users_count property.
                ## @return a void
                ## 
                ...
                ## @return a workflow_execution_type
                ## 
                ...
                ## @param value Value to set for the workflow_execution_type property.
                ## @return a void
                ## 
