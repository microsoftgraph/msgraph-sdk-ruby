...
module MicrosoftGraph
    module Models
        module IdentityGovernance
            class CustomTaskExtensionCallbackConfiguration < MicrosoftGraph::Models::CustomExtensionCallbackConfiguration
                ...
                ## @param value Value to set for the authorized_apps property.
                ## @return a void
                ## 
                ...
                ## @return a custom_task_extension_callback_configuration
                ## 
                def self.create_from_discriminator_value(parse_node)
                    raise StandardError, 'parse_node cannot be null' if parse_node.nil?
                    return CustomTaskExtensionCallbackConfiguration.new
                end
                ## 
                ...
                def serialize(writer)
                    ...
                    super
                    writer.write_collection_of_object_values("authorizedApps", @authorized_apps)
                end
            end
        end
    end
