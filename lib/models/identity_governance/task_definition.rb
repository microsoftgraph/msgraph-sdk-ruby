...
module MicrosoftGraph
    module Models
        module IdentityGovernance
            class TaskDefinition < MicrosoftGraph::Models::Entity
                ...
                def get_field_deserializers()
                    return super.merge({
                        ...
                        "parameters" => lambda {|n| @parameters = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraph::Models::IdentityGovernance::Parameter.create_from_discriminator_value(pn) }) },
