...
module MicrosoftGraph
    module Models
        module IdentityGovernance
            class TriggerAndScopeBasedConditions < MicrosoftGraph::Models::IdentityGovernance::WorkflowExecutionConditions
                ...
                def get_field_deserializers()
                    return super.merge({
                        ...
                        "trigger" => lambda {|n| @trigger = n.get_object_value(lambda {|pn| MicrosoftGraph::Models::IdentityGovernance::WorkflowExecutionTrigger.create_from_discriminator_value(pn) }) },
                    })
                end
                ## 
