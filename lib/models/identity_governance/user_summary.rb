    ...
    module Models
        module IdentityGovernance
            class UserSummary
                ...
                ## @return a user_summary
                ## 
                def self.create_from_discriminator_value(parse_node)
                    raise StandardError, 'parse_node cannot be null' if parse_node.nil?
                    return UserSummary.new
                end
                ## 
                ...
                ## @param value Value to set for the failed_users property.
                ## @return a void
                ## 
                ...
                ## @param value Value to set for the successful_users property.
                ## @return a void
                ## 
