    ...
    module Models
        module IdentityGovernance
            class TaskReportSummary
                ...
                ## @return a task_report_summary
                ## 
                def self.create_from_discriminator_value(parse_node)
                    raise StandardError, 'parse_node cannot be null' if parse_node.nil?
                    return TaskReportSummary.new
                end
                ## 
                ...
                ## @param value Value to set for the successful_tasks property.
                ## @return a void
                ## 
                ...
                ## @param value Value to set for the unprocessed_tasks property.
                ## @return a void
                ## 
