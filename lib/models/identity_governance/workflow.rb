...
module MicrosoftGraph
    module Models
        module IdentityGovernance
            class Workflow < MicrosoftGraph::Models::IdentityGovernance::WorkflowBase
                ...
                ## @return a user_processing_result
                ## 
                def execution_scope
                ...
                ## @param value Value to set for the execution_scope property.
                ## @return a void
                ## 
                ...
                def get_field_deserializers()
                    return super.merge({
                        ...
                        "executionScope" => lambda {|n| @execution_scope = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraph::Models::IdentityGovernance::UserProcessingResult.create_from_discriminator_value(pn) }) },
                        "id" => lambda {|n| @id = n.get_string_value() },
                        "nextScheduleRunDateTime" => lambda {|n| @next_schedule_run_date_time = n.get_date_time_value() },
                        "runs" => lambda {|n| @runs = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraph::Models::IdentityGovernance::Run.create_from_discriminator_value(pn) }) },
                        "taskReports" => lambda {|n| @task_reports = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraph::Models::IdentityGovernance::TaskReport.create_from_discriminator_value(pn) }) },
                        "userProcessingResults" => lambda {|n| @user_processing_results = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraph::Models::IdentityGovernance::UserProcessingResult.create_from_discriminator_value(pn) }) },
                        "version" => lambda {|n| @version = n.get_number_value() },
                        "versions" => lambda {|n| @versions = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraph::Models::IdentityGovernance::WorkflowVersion.create_from_discriminator_value(pn) }) },
                    })
                end
                ## 
                ...
                ## @param value Value to set for the next_schedule_run_date_time property.
                ## @return a void
                ## 
                ...
                ## @param value Value to set for the task_reports property.
                ## @return a void
                ## 
                ...
                ## @param value Value to set for the user_processing_results property.
                ## @return a void
                ## 
