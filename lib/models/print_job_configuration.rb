    ...
    module Models
        class PrintJobConfiguration
            ...
            def serialize(writer)
                ...
                writer.write_boolean_value("collate", @collate) unless @collate.nil?
                writer.write_enum_value("colorMode", @color_mode) unless @color_mode.nil?
                writer.write_number_value("copies", @copies) unless @copies.nil?
                writer.write_number_value("dpi", @dpi) unless @dpi.nil?
                writer.write_enum_value("duplexMode", @duplex_mode) unless @duplex_mode.nil?
                writer.write_enum_value("feedOrientation", @feed_orientation) unless @feed_orientation.nil?
                ...
                writer.write_object_value("margin", @margin) unless @margin.nil?
                ...
                writer.write_collection_of_object_values("pageRanges", @page_ranges) unless @page_ranges.nil?
