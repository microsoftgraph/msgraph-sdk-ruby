        ...
        class PrinterLocation
            ...
            def get_field_deserializers()
                return {
                    ...
                    "latitude" => lambda {|n| @latitude = n.get_object_value(lambda {|pn| PrinterLocation::PrinterLocationLatitude.create_from_discriminator_value(pn) }) },
                    "longitude" => lambda {|n| @longitude = n.get_object_value(lambda {|pn| PrinterLocation::PrinterLocationLongitude.create_from_discriminator_value(pn) }) },
            ...
            ## @return a printer_location_latitude
            ## 
            def latitude
                return @latitude
            end
            ...
            ## @return a printer_location_longitude
            ## 
            def longitude
                return @longitude
            end
            ...
            class PrinterLocationLatitude
                ...
                def self.create_from_discriminator_value(parse_node)
                    ...
                    return PrinterLocationLatitude.new
                end
                ## 
            ...
            ## 
            # Composed type wrapper for classes Double, ReferenceNumeric, string
            class PrinterLocationLongitude
                include MicrosoftKiotaAbstractions::Parsable
                ## 
                # Composed type representation for type Double
                @double
                ...
                def self.create_from_discriminator_value(parse_node)
                    ...
                    return PrinterLocationLongitude.new
                end
                ## 
                ## Gets the double property value. Composed type representation for type Double
                ## @return a double
