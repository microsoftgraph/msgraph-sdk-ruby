...
module MicrosoftGraph
    module Models
        class FileStorageContainerViewpoint
            ...
            ## 
            ## Instantiates a new FileStorageContainerViewpoint and sets the default values.
            ## @return a void
            ## 
            def initialize()
            ...
            def self.create_from_discriminator_value(parse_node)
                ...
                return FileStorageContainerViewpoint.new
            end
            ## 
            ...
            def get_field_deserializers()
                return {
                    "effectiveRole" => lambda {|n| @effective_role = n.get_string_value() },
            ...
            def serialize(writer)
                ...
                writer.write_string_value("effectiveRole", @effective_role)
