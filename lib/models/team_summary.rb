    ...
    module Models
        class TeamSummary
            ...
            def serialize(writer)
                ...
                writer.write_number_value("guestsCount", @guests_count) unless @guests_count.nil?
                writer.write_number_value("membersCount", @members_count) unless @members_count.nil?
                writer.write_string_value("@odata.type", @odata_type) unless @odata_type.nil?
                writer.write_number_value("ownersCount", @owners_count) unless @owners_count.nil?
