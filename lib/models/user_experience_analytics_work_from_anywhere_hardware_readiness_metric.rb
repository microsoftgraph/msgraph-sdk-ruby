    ...
    module Models
        ...
        class UserExperienceAnalyticsWorkFromAnywhereHardwareReadinessMetric < MicrosoftGraph::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    "osCheckFailedPercentage" => lambda {|n| @os_check_failed_percentage = n.get_object_value(lambda {|pn| UserExperienceAnalyticsWorkFromAnywhereHardwareReadinessMetric::UserExperienceAnalyticsWorkFromAnywhereHardwareReadinessMetricOsCheckFailedPercentage.create_from_discriminator_value(pn) }) },
                    "processorCoreCountCheckFailedPercentage" => lambda {|n| @processor_core_count_check_failed_percentage = n.get_object_value(lambda {|pn| UserExperienceAnalyticsWorkFromAnywhereHardwareReadinessMetric::UserExperienceAnalyticsWorkFromAnywhereHardwareReadinessMetricProcessorCoreCountCheckFailedPercentage.create_from_discriminator_value(pn) }) },
                    "processorFamilyCheckFailedPercentage" => lambda {|n| @processor_family_check_failed_percentage = n.get_object_value(lambda {|pn| UserExperienceAnalyticsWorkFromAnywhereHardwareReadinessMetric::UserExperienceAnalyticsWorkFromAnywhereHardwareReadinessMetricProcessorFamilyCheckFailedPercentage.create_from_discriminator_value(pn) }) },
                    "processorSpeedCheckFailedPercentage" => lambda {|n| @processor_speed_check_failed_percentage = n.get_object_value(lambda {|pn| UserExperienceAnalyticsWorkFromAnywhereHardwareReadinessMetric::UserExperienceAnalyticsWorkFromAnywhereHardwareReadinessMetricProcessorSpeedCheckFailedPercentage.create_from_discriminator_value(pn) }) },
                    "processor64BitCheckFailedPercentage" => lambda {|n| @processor64_bit_check_failed_percentage = n.get_object_value(lambda {|pn| UserExperienceAnalyticsWorkFromAnywhereHardwareReadinessMetric::UserExperienceAnalyticsWorkFromAnywhereHardwareReadinessMetricProcessor64BitCheckFailedPercentage.create_from_discriminator_value(pn) }) },
                    "ramCheckFailedPercentage" => lambda {|n| @ram_check_failed_percentage = n.get_object_value(lambda {|pn| UserExperienceAnalyticsWorkFromAnywhereHardwareReadinessMetric::UserExperienceAnalyticsWorkFromAnywhereHardwareReadinessMetricRamCheckFailedPercentage.create_from_discriminator_value(pn) }) },
                    "secureBootCheckFailedPercentage" => lambda {|n| @secure_boot_check_failed_percentage = n.get_object_value(lambda {|pn| UserExperienceAnalyticsWorkFromAnywhereHardwareReadinessMetric::UserExperienceAnalyticsWorkFromAnywhereHardwareReadinessMetricSecureBootCheckFailedPercentage.create_from_discriminator_value(pn) }) },
                    "storageCheckFailedPercentage" => lambda {|n| @storage_check_failed_percentage = n.get_object_value(lambda {|pn| UserExperienceAnalyticsWorkFromAnywhereHardwareReadinessMetric::UserExperienceAnalyticsWorkFromAnywhereHardwareReadinessMetricStorageCheckFailedPercentage.create_from_discriminator_value(pn) }) },
                    "totalDeviceCount" => lambda {|n| @total_device_count = n.get_number_value() },
                    "tpmCheckFailedPercentage" => lambda {|n| @tpm_check_failed_percentage = n.get_object_value(lambda {|pn| UserExperienceAnalyticsWorkFromAnywhereHardwareReadinessMetric::UserExperienceAnalyticsWorkFromAnywhereHardwareReadinessMetricTpmCheckFailedPercentage.create_from_discriminator_value(pn) }) },
            ...
            ## @return a user_experience_analytics_work_from_anywhere_hardware_readiness_metric_os_check_failed_percentage
            ## 
            ...
            ## @return a user_experience_analytics_work_from_anywhere_hardware_readiness_metric_processor_core_count_check_failed_percentage
            ## 
            ...
            ## @return a user_experience_analytics_work_from_anywhere_hardware_readiness_metric_processor_family_check_failed_percentage
            ## 
            ...
            ## @return a user_experience_analytics_work_from_anywhere_hardware_readiness_metric_processor_speed_check_failed_percentage
            ## 
            ...
            ## @return a user_experience_analytics_work_from_anywhere_hardware_readiness_metric_processor64_bit_check_failed_percentage
            ## 
            ...
            ## @return a user_experience_analytics_work_from_anywhere_hardware_readiness_metric_ram_check_failed_percentage
            ## 
            ...
            ## @return a user_experience_analytics_work_from_anywhere_hardware_readiness_metric_secure_boot_check_failed_percentage
            ## 
            ...
            ## @return a user_experience_analytics_work_from_anywhere_hardware_readiness_metric_storage_check_failed_percentage
            ## 
            ...
            ## @return a user_experience_analytics_work_from_anywhere_hardware_readiness_metric_tpm_check_failed_percentage
            ## 
            ...
            class UserExperienceAnalyticsWorkFromAnywhereHardwareReadinessMetricOsCheckFailedPercentage
                include MicrosoftKiotaAbstractions::Parsable
                ## 
                ...
                def self.create_from_discriminator_value(parse_node)
                    ...
                    return UserExperienceAnalyticsWorkFromAnywhereHardwareReadinessMetricOsCheckFailedPercentage.new
                end
                ## 
            ...
            ## 
            # Composed type wrapper for classes Double, ReferenceNumeric, string
            class UserExperienceAnalyticsWorkFromAnywhereHardwareReadinessMetricProcessor64BitCheckFailedPercentage
                include MicrosoftKiotaAbstractions::Parsable
                ## 
                # Composed type representation for type Double
                @double
                ...
                def self.create_from_discriminator_value(parse_node)
                    ...
                    return UserExperienceAnalyticsWorkFromAnywhereHardwareReadinessMetricProcessor64BitCheckFailedPercentage.new
                end
                ## 
                ## Gets the double property value. Composed type representation for type Double
                ## @return a double
            ...
            ## 
            # Composed type wrapper for classes Double, ReferenceNumeric, string
            class UserExperienceAnalyticsWorkFromAnywhereHardwareReadinessMetricProcessorCoreCountCheckFailedPercentage
                include MicrosoftKiotaAbstractions::Parsable
                ## 
                # Composed type representation for type Double
                @double
                ...
                def self.create_from_discriminator_value(parse_node)
                    ...
                    return UserExperienceAnalyticsWorkFromAnywhereHardwareReadinessMetricProcessorCoreCountCheckFailedPercentage.new
                end
                ## 
                ## Gets the double property value. Composed type representation for type Double
                ## @return a double
            ...
            ## 
            # Composed type wrapper for classes Double, ReferenceNumeric, string
            class UserExperienceAnalyticsWorkFromAnywhereHardwareReadinessMetricProcessorFamilyCheckFailedPercentage
                include MicrosoftKiotaAbstractions::Parsable
                ## 
                # Composed type representation for type Double
                @double
                ...
                def self.create_from_discriminator_value(parse_node)
                    ...
                    return UserExperienceAnalyticsWorkFromAnywhereHardwareReadinessMetricProcessorFamilyCheckFailedPercentage.new
                end
                ## 
                ## Gets the double property value. Composed type representation for type Double
                ## @return a double
            ...
            ## 
            # Composed type wrapper for classes Double, ReferenceNumeric, string
            class UserExperienceAnalyticsWorkFromAnywhereHardwareReadinessMetricProcessorSpeedCheckFailedPercentage
                include MicrosoftKiotaAbstractions::Parsable
                ## 
                # Composed type representation for type Double
                @double
                ...
                def self.create_from_discriminator_value(parse_node)
                    ...
                    return UserExperienceAnalyticsWorkFromAnywhereHardwareReadinessMetricProcessorSpeedCheckFailedPercentage.new
                end
                ## 
                ## Gets the double property value. Composed type representation for type Double
                ## @return a double
            ...
            ## 
            # Composed type wrapper for classes Double, ReferenceNumeric, string
            class UserExperienceAnalyticsWorkFromAnywhereHardwareReadinessMetricRamCheckFailedPercentage
                include MicrosoftKiotaAbstractions::Parsable
                ## 
                # Composed type representation for type Double
                @double
                ...
                def self.create_from_discriminator_value(parse_node)
                    ...
                    return UserExperienceAnalyticsWorkFromAnywhereHardwareReadinessMetricRamCheckFailedPercentage.new
                end
                ## 
                ## Gets the double property value. Composed type representation for type Double
                ## @return a double
            ...
            ## 
            # Composed type wrapper for classes Double, ReferenceNumeric, string
            class UserExperienceAnalyticsWorkFromAnywhereHardwareReadinessMetricSecureBootCheckFailedPercentage
                include MicrosoftKiotaAbstractions::Parsable
                ## 
                # Composed type representation for type Double
                @double
                ...
                def self.create_from_discriminator_value(parse_node)
                    ...
                    return UserExperienceAnalyticsWorkFromAnywhereHardwareReadinessMetricSecureBootCheckFailedPercentage.new
                end
                ## 
                ## Gets the double property value. Composed type representation for type Double
                ## @return a double
            ...
            ## 
            # Composed type wrapper for classes Double, ReferenceNumeric, string
            class UserExperienceAnalyticsWorkFromAnywhereHardwareReadinessMetricStorageCheckFailedPercentage
                include MicrosoftKiotaAbstractions::Parsable
                ## 
                # Composed type representation for type Double
                @double
                ...
                def self.create_from_discriminator_value(parse_node)
                    ...
                    return UserExperienceAnalyticsWorkFromAnywhereHardwareReadinessMetricStorageCheckFailedPercentage.new
                end
                ## 
                ## Gets the double property value. Composed type representation for type Double
                ## @return a double
            ...
            ## 
            # Composed type wrapper for classes Double, ReferenceNumeric, string
            class UserExperienceAnalyticsWorkFromAnywhereHardwareReadinessMetricTpmCheckFailedPercentage
                include MicrosoftKiotaAbstractions::Parsable
                ## 
                # Composed type representation for type Double
                @double
                ...
                def self.create_from_discriminator_value(parse_node)
                    ...
                    return UserExperienceAnalyticsWorkFromAnywhereHardwareReadinessMetricTpmCheckFailedPercentage.new
                end
                ## 
                ## Gets the double property value. Composed type representation for type Double
                ## @return a double
