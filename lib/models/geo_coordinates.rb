...
module MicrosoftGraph
    module Models
        class GeoCoordinates
            ...
            ## @return a geo_coordinates_altitude
            ## 
            def altitude
                return @altitude
            end
            ...
            def get_field_deserializers()
                return {
                    "altitude" => lambda {|n| @altitude = n.get_object_value(lambda {|pn| GeoCoordinates::GeoCoordinatesAltitude.create_from_discriminator_value(pn) }) },
                    "latitude" => lambda {|n| @latitude = n.get_object_value(lambda {|pn| GeoCoordinates::GeoCoordinatesLatitude.create_from_discriminator_value(pn) }) },
                    "longitude" => lambda {|n| @longitude = n.get_object_value(lambda {|pn| GeoCoordinates::GeoCoordinatesLongitude.create_from_discriminator_value(pn) }) },
                    "@odata.type" => lambda {|n| @odata_type = n.get_string_value() },
                }
            end
            ## 
            ## Gets the latitude property value. Optional. The latitude, in decimal, for the item. Read-only.
            ## @return a geo_coordinates_latitude
            ## 
            def latitude
                return @latitude
            end
            ...
            ## @return a geo_coordinates_longitude
            ## 
            def longitude
                return @longitude
            end
            ...
            class GeoCoordinatesAltitude
                ...
                def self.create_from_discriminator_value(parse_node)
                    ...
                    return GeoCoordinatesAltitude.new
                end
                ## 
            ...
            class GeoCoordinatesLatitude
                ...
                def self.create_from_discriminator_value(parse_node)
                    ...
                    return GeoCoordinatesLatitude.new
                end
                ## 
                ## Gets the double property value. Composed type representation for type Double
                ## @return a double
            ...
            class GeoCoordinatesLongitude
                ...
                def self.create_from_discriminator_value(parse_node)
                    ...
                    return GeoCoordinatesLongitude.new
                end
                ## 
                ## Gets the double property value. Composed type representation for type Double
                ## @return a double
