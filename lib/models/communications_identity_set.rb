...
module MicrosoftGraph
    module Models
        class CommunicationsIdentitySet < MicrosoftGraph::Models::IdentitySet
            ...
            ## @return a communications_identity_set_endpoint_type
            ## 
            def endpoint_type
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "endpointType" => lambda {|n| @endpoint_type = n.get_enum_value(MicrosoftGraph::Models::CommunicationsIdentitySetEndpointType) },
