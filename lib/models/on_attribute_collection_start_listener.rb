...
module MicrosoftGraph
    module Models
        class OnAttributeCollectionStartListener < MicrosoftGraph::Models::AuthenticationEventListener
            ...
            ## @return a on_attribute_collection_start_listener
            ## 
            ...
            def get_field_deserializers()
                return super.merge({
                    "handler" => lambda {|n| @handler = n.get_object_value(lambda {|pn| MicrosoftGraph::Models::OnAttributeCollectionStartHandler.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
