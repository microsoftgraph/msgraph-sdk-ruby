...
module MicrosoftGraph
    module Models
        class SecurityCasesRoot < MicrosoftGraph::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    "ediscoveryCases" => lambda {|n| @ediscovery_cases = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraph::Models::SecurityEdiscoveryCase.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
            ...
            def serialize(writer)
                ...
                super
                writer.write_collection_of_object_values("ediscoveryCases", @ediscovery_cases) unless @ediscovery_cases.nil?
            end
        end
    end
end
