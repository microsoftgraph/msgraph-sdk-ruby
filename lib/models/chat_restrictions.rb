...
module MicrosoftGraph
    module Models
        class ChatRestrictions
            ...
            ## @return a void
            ## 
            def allow_text_only=(value)
                @allow_text_only = value
            end
            ## 
            ## Instantiates a new ChatRestrictions and sets the default values.
            ## @return a void
            ## 
            def initialize()
            ...
            def get_field_deserializers()
                return {
                    "allowTextOnly" => lambda {|n| @allow_text_only = n.get_boolean_value() },
            ...
            def serialize(writer)
                ...
                writer.write_boolean_value("allowTextOnly", @allow_text_only)
