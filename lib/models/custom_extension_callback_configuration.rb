        ...
        class CustomExtensionCallbackConfiguration
            ...
            def self.create_from_discriminator_value(parse_node)
                ...
                unless mapping_value_node.nil? then
                    ...
                    case mapping_value
                        when "#microsoft.graph.identityGovernance.customTaskExtensionCallbackConfiguration"
            ...
            def serialize(writer)
                ...
                writer.write_duration_value("timeoutDuration", @timeout_duration) unless @timeout_duration.nil?
