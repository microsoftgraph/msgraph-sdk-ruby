...
module MicrosoftGraph
    module Models
        class SecurityCitationTemplate < MicrosoftGraph::Models::SecurityFilePlanDescriptorTemplate
            ...
            ## 
            ## Instantiates a new SecurityCitationTemplate and sets the default values.
            ## @return a void
            ## 
            def initialize()
                super
