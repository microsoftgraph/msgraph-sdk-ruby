        ...
        class AccountTargetContent
            ...
            def self.create_from_discriminator_value(parse_node)
                ...
                unless mapping_value_node.nil? then
                    ...
                    case mapping_value
                        when "#microsoft.graph.addressBookAccountTargetContent"
                            return AddressBookAccountTargetContent.new
                        when "#microsoft.graph.includeAllAccountTargetContent"
                            return IncludeAllAccountTargetContent.new
                    end
                end
                return AccountTargetContent.new
            end
            ## 
            ...
            def get_field_deserializers()
                return {
                    ...
                    "type" => lambda {|n| @type = n.get_enum_value(MicrosoftGraph::Models::AccountTargetContentType) },
                }
            end
            ## 
            ...
            ## @return a account_target_content_type
            ## 
            def type
                return @type
            end
