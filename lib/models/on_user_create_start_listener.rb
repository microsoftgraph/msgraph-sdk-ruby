...
module MicrosoftGraph
    module Models
        class OnUserCreateStartListener < MicrosoftGraph::Models::AuthenticationEventListener
            ...
            ## @return a on_user_create_start_listener
            ## 
            ...
            def get_field_deserializers()
                return super.merge({
                    "handler" => lambda {|n| @handler = n.get_object_value(lambda {|pn| MicrosoftGraph::Models::OnUserCreateStartHandler.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
