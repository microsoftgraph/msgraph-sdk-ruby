    ...
    module Models
        class MediaContentRatingJapan
            ...
            def self.create_from_discriminator_value(parse_node)
                ...
                return MediaContentRatingJapan.new
            end
            ## 
            ...
            def get_field_deserializers()
                return {
                    "movieRating" => lambda {|n| @movie_rating = n.get_enum_value(MicrosoftGraph::Models::RatingJapanMoviesType) },
                    "@odata.type" => lambda {|n| @odata_type = n.get_string_value() },
                    "tvRating" => lambda {|n| @tv_rating = n.get_enum_value(MicrosoftGraph::Models::RatingJapanTelevisionType) },
                }
            end
            ## 
            ## Gets the movieRating property value. Movies rating labels in Japan
            ## @return a rating_japan_movies_type
            ## 
            def movie_rating
                return @movie_rating
            end
            ...
            ## @return a rating_japan_television_type
            ## 
            def tv_rating
                return @tv_rating
            end
