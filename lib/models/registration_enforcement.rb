...
module MicrosoftGraph
    module Models
        class RegistrationEnforcement
            ...
            ## @param value Value to set for the authentication_methods_registration_campaign property.
            ## @return a void
            ## 
            def authentication_methods_registration_campaign=(value)
            ...
            def self.create_from_discriminator_value(parse_node)
                ...
                return RegistrationEnforcement.new
            end
            ## 
            ...
            def get_field_deserializers()
                return {
                    "authenticationMethodsRegistrationCampaign" => lambda {|n| @authentication_methods_registration_campaign = n.get_object_value(lambda {|pn| MicrosoftGraph::Models::AuthenticationMethodsRegistrationCampaign.create_from_discriminator_value(pn) }) },
            ...
            def serialize(writer)
                ...
                writer.write_object_value("authenticationMethodsRegistrationCampaign", @authentication_methods_registration_campaign)
