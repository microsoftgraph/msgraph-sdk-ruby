        ...
        class VirtualEventWebinar < MicrosoftGraph::Models::VirtualEvent
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "registrationConfiguration" => lambda {|n| @registration_configuration = n.get_object_value(lambda {|pn| MicrosoftGraph::Models::VirtualEventWebinarRegistrationConfiguration.create_from_discriminator_value(pn) }) },
