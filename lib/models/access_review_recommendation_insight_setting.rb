        ...
        class AccessReviewRecommendationInsightSetting
            ...
            def self.create_from_discriminator_value(parse_node)
                ...
                unless mapping_value_node.nil? then
                    ...
                    case mapping_value
                        when "#microsoft.graph.groupPeerOutlierRecommendationInsightSettings"
                            return GroupPeerOutlierRecommendationInsightSettings.new
                        when "#microsoft.graph.userLastSignInRecommendationInsightSetting"
                            return UserLastSignInRecommendationInsightSetting.new
                    end
                end
                return AccessReviewRecommendationInsightSetting.new
            end
            ## 
