        ...
        class ScoredEmailAddress
            ...
            def get_field_deserializers()
                return {
                    ...
                    "relevanceScore" => lambda {|n| @relevance_score = n.get_object_value(lambda {|pn| ScoredEmailAddress::ScoredEmailAddressRelevanceScore.create_from_discriminator_value(pn) }) },
            ...
            ## @return a scored_email_address_relevance_score
            ## 
            def relevance_score
            ...
            class ScoredEmailAddressRelevanceScore
                ...
                def self.create_from_discriminator_value(parse_node)
                    ...
                    return ScoredEmailAddressRelevanceScore.new
                end
                ## 
