        ...
        class NumberColumn
            ...
            def get_field_deserializers()
                return {
                    ...
                    "maximum" => lambda {|n| @maximum = n.get_object_value(lambda {|pn| NumberColumn::NumberColumnMaximum.create_from_discriminator_value(pn) }) },
                    "minimum" => lambda {|n| @minimum = n.get_object_value(lambda {|pn| NumberColumn::NumberColumnMinimum.create_from_discriminator_value(pn) }) },
                    "@odata.type" => lambda {|n| @odata_type = n.get_string_value() },
                }
            end
            ## 
            ## Gets the maximum property value. The maximum permitted value.
            ## @return a number_column_maximum
            ## 
            def maximum
                return @maximum
            end
            ...
            ## @return a number_column_minimum
            ## 
            def minimum
                return @minimum
            end
            ...
            class NumberColumnMaximum
                ...
                def self.create_from_discriminator_value(parse_node)
                    ...
                    return NumberColumnMaximum.new
                end
                ## 
            ...
            class NumberColumnMinimum
                ...
                def self.create_from_discriminator_value(parse_node)
                    ...
                    return NumberColumnMinimum.new
                end
                ## 
                ## Gets the double property value. Composed type representation for type Double
                ## @return a double
