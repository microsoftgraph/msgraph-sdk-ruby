...
module MicrosoftGraph
    module Models
        class SimulationEventsContent
            ...
            ## @return a simulation_events_content_compromised_rate
            ## 
            ...
            def get_field_deserializers()
                return {
                    "compromisedRate" => lambda {|n| @compromised_rate = n.get_object_value(lambda {|pn| SimulationEventsContent::SimulationEventsContentCompromisedRate.create_from_discriminator_value(pn) }) },
            ...
            class SimulationEventsContentCompromisedRate
                ...
                def self.create_from_discriminator_value(parse_node)
                    ...
                    return SimulationEventsContentCompromisedRate.new
                end
                ## 
