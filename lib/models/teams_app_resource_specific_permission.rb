    ...
    module Models
        class TeamsAppResourceSpecificPermission
            ...
            def self.create_from_discriminator_value(parse_node)
                ...
                return TeamsAppResourceSpecificPermission.new
            end
            ## 
            ...
            ## @param value Value to set for the permission_value property.
            ## @return a void
            ## 
            ...
            def serialize(writer)
                ...
                writer.write_string_value("permissionValue", @permission_value)
