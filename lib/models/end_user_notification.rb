        ...
        class EndUserNotification < MicrosoftGraph::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "notificationType" => lambda {|n| @notification_type = n.get_enum_value(MicrosoftGraph::Models::EndUserNotificationNotificationType) },
                    "source" => lambda {|n| @source = n.get_enum_value(MicrosoftGraph::Models::EndUserNotificationSource) },
                    "status" => lambda {|n| @status = n.get_enum_value(MicrosoftGraph::Models::EndUserNotificationStatus) },
            ...
            ## @return a end_user_notification_notification_type
            ## 
            ...
            ## @return a end_user_notification_source
            ## 
            def source
                return @source
            end
            ...
            ## @return a end_user_notification_status
            ## 
            def status
                return @status
            end
