        ...
        class Simulation < MicrosoftGraph::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "payloadDeliveryPlatform" => lambda {|n| @payload_delivery_platform = n.get_enum_value(MicrosoftGraph::Models::SimulationPayloadDeliveryPlatform) },
            ...
            ## @return a simulation_payload_delivery_platform
            ## 
