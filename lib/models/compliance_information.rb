    ...
    module Models
        class ComplianceInformation
            ...
            def self.create_from_discriminator_value(parse_node)
                ...
                return ComplianceInformation.new
            end
            ## 
            ...
            def get_field_deserializers()
                return {
                    "certificationControls" => lambda {|n| @certification_controls = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraph::Models::CertificationControl.create_from_discriminator_value(pn) }) },
                    "certificationName" => lambda {|n| @certification_name = n.get_string_value() },
            ...
            def serialize(writer)
                ...
                writer.write_collection_of_object_values("certificationControls", @certification_controls) unless @certification_controls.nil?
                writer.write_string_value("certificationName", @certification_name) unless @certification_name.nil?
