    ...
    module Models
        class ConditionalAccessPlatforms
            ...
            def serialize(writer)
                ...
                writer.write_collection_of_object_values("excludePlatforms", @exclude_platforms) unless @exclude_platforms.nil?
                writer.write_collection_of_object_values("includePlatforms", @include_platforms) unless @include_platforms.nil?
