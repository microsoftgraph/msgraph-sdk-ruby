    ...
    module Models
        class ConditionalAccessLocations
            ...
            def serialize(writer)
                ...
                writer.write_collection_of_primitive_values("excludeLocations", @exclude_locations) unless @exclude_locations.nil?
                writer.write_collection_of_primitive_values("includeLocations", @include_locations) unless @include_locations.nil?
