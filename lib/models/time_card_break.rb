        ...
        class TimeCardBreak
            ...
            def get_field_deserializers()
                return {
                    ...
                    "end" => lambda {|n| @end_escaped = n.get_object_value(lambda {|pn| MicrosoftGraph::Models::TimeCardEvent.create_from_discriminator_value(pn) }) },
                    ...
                    "start" => lambda {|n| @start = n.get_object_value(lambda {|pn| MicrosoftGraph::Models::TimeCardEvent.create_from_discriminator_value(pn) }) },
                }
            end
            ## 
