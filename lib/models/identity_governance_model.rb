...
require_relative './identity_governance/lifecycle_workflows_container'
...
module MicrosoftGraph
    module Models
        class IdentityGovernanceModel
            ...
            ## 
            ## Instantiates a new IdentityGovernanceModel and sets the default values.
            ## @return a void
            ## 
            def initialize()
            ...
            ## @return a identity_governance_model
            ## 
            def self.create_from_discriminator_value(parse_node)
                raise StandardError, 'parse_node cannot be null' if parse_node.nil?
                return IdentityGovernanceModel.new
            end
            ## 
            ...
            def get_field_deserializers()
                return {
                    ...
                    "lifecycleWorkflows" => lambda {|n| @lifecycle_workflows = n.get_object_value(lambda {|pn| MicrosoftGraph::Models::IdentityGovernance::LifecycleWorkflowsContainer.create_from_discriminator_value(pn) }) },
            ...
            ## @param value Value to set for the lifecycle_workflows property.
            ## @return a void
            ## 
