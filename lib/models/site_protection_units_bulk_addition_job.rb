...
module MicrosoftGraph
    module Models
        class SiteProtectionUnitsBulkAdditionJob < MicrosoftGraph::Models::ProtectionUnitsBulkJobBase
            ...
            def initialize()
                super
                @odata_type = "#microsoft.graph.siteProtectionUnitsBulkAdditionJob"
            end
            ## 
