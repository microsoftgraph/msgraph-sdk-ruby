    ...
    module Models
        class StringKeyAttributeMappingSourceValuePair
            ...
            def self.create_from_discriminator_value(parse_node)
                ...
                return StringKeyAttributeMappingSourceValuePair.new
            end
            ## 
            ...
            def get_field_deserializers()
                return {
                    ...
                    "value" => lambda {|n| @value = n.get_object_value(lambda {|pn| MicrosoftGraph::Models::AttributeMappingSource.create_from_discriminator_value(pn) }) },
                }
            end
            ## 
