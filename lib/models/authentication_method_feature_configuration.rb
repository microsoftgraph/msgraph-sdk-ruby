        ...
        class AuthenticationMethodFeatureConfiguration
            ...
            def get_field_deserializers()
                return {
                    ...
                    "state" => lambda {|n| @state = n.get_enum_value(MicrosoftGraph::Models::AuthenticationMethodFeatureConfigurationState) },
                }
            end
            ## 
            ...
            ## @return a authentication_method_feature_configuration_state
            ## 
            def state
                return @state
            end
