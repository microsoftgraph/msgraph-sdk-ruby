...
module MicrosoftGraph
    module Models
        class CallRecordsEndpoint
            ...
            ## 
            ## Instantiates a new callRecordsEndpoint and sets the default values.
            ## @return a void
            ## 
            def initialize()
            ...
            def self.create_from_discriminator_value(parse_node)
                ...
                return CallRecordsEndpoint.new
            end
            ## 
            ...
            def get_field_deserializers()
                return {
                    ...
                    "userAgent" => lambda {|n| @user_agent = n.get_object_value(lambda {|pn| MicrosoftGraph::Models::CallRecordsUserAgent.create_from_discriminator_value(pn) }) },
                }
            end
            ## 
            ...
            def serialize(writer)
                ...
                writer.write_object_value("userAgent", @user_agent) unless @user_agent.nil?
                writer.write_additional_data(@additional_data) unless @additional_data.nil?
            end
            ## 
            ## Gets the userAgent property value. User-agent reported by this endpoint.
            ## @return a call_records_user_agent
            ## 
            def user_agent
                return @user_agent
            end
