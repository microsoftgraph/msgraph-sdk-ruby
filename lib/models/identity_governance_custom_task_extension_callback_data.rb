...
module MicrosoftGraph
    module Models
        class IdentityGovernanceCustomTaskExtensionCallbackData < MicrosoftGraph::Models::CustomExtensionData
            ...
            def serialize(writer)
                ...
                super
                writer.write_enum_value("operationStatus", @operation_status) unless @operation_status.nil?
            end
        end
    end
end
