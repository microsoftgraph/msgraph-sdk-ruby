    ...
    module Models
        ...
        class ProxiedDomain
            ...
            def serialize(writer)
                ...
                writer.write_string_value("ipAddressOrFQDN", @ip_address_or_f_q_d_n) unless @ip_address_or_f_q_d_n.nil?
                writer.write_string_value("@odata.type", @odata_type) unless @odata_type.nil?
                writer.write_string_value("proxy", @proxy) unless @proxy.nil?
