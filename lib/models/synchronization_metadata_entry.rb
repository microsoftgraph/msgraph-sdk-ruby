    ...
    module Models
        class SynchronizationMetadataEntry
            ...
            def self.create_from_discriminator_value(parse_node)
                ...
                return SynchronizationMetadataEntry.new
            end
            ## 
            ...
            def get_field_deserializers()
                return {
                    "key" => lambda {|n| @key = n.get_enum_value(MicrosoftGraph::Models::SynchronizationMetadataEntryKey) },
            ...
            ## @return a synchronization_metadata_entry_key
            ## 
            def key
                return @key
            end
