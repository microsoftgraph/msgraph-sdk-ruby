    ...
    module Models
        class AverageComparativeScore
            ...
            def get_field_deserializers()
                return {
                    "averageScore" => lambda {|n| @average_score = n.get_object_value(lambda {|pn| Double.create_from_discriminator_value(pn) }) },
            ...
            def serialize(writer)
                ...
                writer.write_object_value("averageScore", @average_score) unless @average_score.nil?
                writer.write_string_value("basis", @basis) unless @basis.nil?
