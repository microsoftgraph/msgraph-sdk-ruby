...
module MicrosoftGraph
    module Models
        class ChannelDescriptionUpdatedEventMessageDetail < MicrosoftGraph::Models::EventMessageDetail
            ...
            ## @param value Value to set for the channel_description property.
            ## @return a void
            ## 
            def channel_description=(value)
            ...
            ## @return a channel_description_updated_event_message_detail
            ## 
            ...
            def get_field_deserializers()
                return super.merge({
                    "channelDescription" => lambda {|n| @channel_description = n.get_string_value() },
            ...
            def serialize(writer)
                ...
                super
                writer.write_string_value("channelDescription", @channel_description)
