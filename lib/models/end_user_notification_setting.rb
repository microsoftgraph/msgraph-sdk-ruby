    ...
    module Models
        class EndUserNotificationSetting
            ...
            def get_field_deserializers()
                return {
                    "notificationPreference" => lambda {|n| @notification_preference = n.get_enum_value(MicrosoftGraph::Models::EndUserNotificationSettingNotificationPreference) },
                    ...
                    "settingType" => lambda {|n| @setting_type = n.get_enum_value(MicrosoftGraph::Models::EndUserNotificationSettingSettingType) },
                }
            end
            ## 
