    ...
    module Models
        class AccessReviewNotificationRecipientItem
            ...
            def serialize(writer)
                ...
                writer.write_object_value("notificationRecipientScope", @notification_recipient_scope) unless @notification_recipient_scope.nil?
                writer.write_string_value("notificationTemplateType", @notification_template_type) unless @notification_template_type.nil?
