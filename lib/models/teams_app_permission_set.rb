        ...
        class TeamsAppPermissionSet
            ...
            def get_field_deserializers()
                return {
                    ...
                    "resourceSpecificPermissions" => lambda {|n| @resource_specific_permissions = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraph::Models::TeamsAppResourceSpecificPermission.create_from_discriminator_value(pn) }) },
                }
            end
            ## 
            ...
            def serialize(writer)
                ...
                writer.write_collection_of_object_values("resourceSpecificPermissions", @resource_specific_permissions) unless @resource_specific_permissions.nil?
