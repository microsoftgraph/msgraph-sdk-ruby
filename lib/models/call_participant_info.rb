    ...
    module Models
        class CallParticipantInfo
            ...
            def self.create_from_discriminator_value(parse_node)
                ...
                return CallParticipantInfo.new
            end
            ## 
            ...
            def get_field_deserializers()
                return {
                    ...
                    "participant" => lambda {|n| @participant = n.get_object_value(lambda {|pn| MicrosoftGraph::Models::IdentitySet.create_from_discriminator_value(pn) }) },
                }
            end
            ## 
            ...
            def serialize(writer)
                ...
                writer.write_object_value("participant", @participant) unless @participant.nil?
