        ...
        class PolicyRoot < MicrosoftGraph::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    ...
                    "deviceRegistrationPolicy" => lambda {|n| @device_registration_policy = n.get_object_value(lambda {|pn| MicrosoftGraph::Models::DeviceRegistrationPolicy.create_from_discriminator_value(pn) }) },
