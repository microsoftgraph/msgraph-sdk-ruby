...
module MicrosoftGraph
    module Models
        class TimeClockSettings
            ...
            ## @return a void
            ## 
            def approved_location=(value)
                @approved_location = value
            end
            ## 
            ...
            def get_field_deserializers()
                return {
                    "approvedLocation" => lambda {|n| @approved_location = n.get_object_value(lambda {|pn| MicrosoftGraph::Models::GeoCoordinates.create_from_discriminator_value(pn) }) },
            ...
            def serialize(writer)
                ...
                writer.write_object_value("approvedLocation", @approved_location)
