    ...
    module Models
        ...
        class WindowsUniversalAppX < MicrosoftGraph::Models::MobileLobApp
            ...
            def serialize(writer)
                ...
                writer.write_enum_value("applicableDeviceTypes", @applicable_device_types) unless @applicable_device_types.nil?
                writer.write_collection_of_object_values("committedContainedApps", @committed_contained_apps) unless @committed_contained_apps.nil?
