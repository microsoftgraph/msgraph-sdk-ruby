    ...
    module Models
        class PeopleAdminSettings < MicrosoftGraph::Models::Entity
            ...
            def get_field_deserializers()
                return super.merge({
                    "itemInsights" => lambda {|n| @item_insights = n.get_object_value(lambda {|pn| MicrosoftGraph::Models::InsightsSettings.create_from_discriminator_value(pn) }) },
                    ...
                    "pronouns" => lambda {|n| @pronouns = n.get_object_value(lambda {|pn| MicrosoftGraph::Models::PronounsSettings.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
