...
module MicrosoftGraph
    module Models
        class PrivilegedAccessGroupAssignmentScheduleInstance < MicrosoftGraph::Models::PrivilegedAccessScheduleInstance
            ...
            ## @return a privileged_access_group_assignment_schedule_instance_access_id
            ## 
            def access_id
                return @access_id
            end
            ...
            ## @return a privileged_access_group_assignment_schedule_instance_assignment_type
            ## 
            def assignment_type
            ...
            def get_field_deserializers()
                return super.merge({
                    "accessId" => lambda {|n| @access_id = n.get_enum_value(MicrosoftGraph::Models::PrivilegedAccessGroupAssignmentScheduleInstanceAccessId) },
                    ...
                    "assignmentType" => lambda {|n| @assignment_type = n.get_enum_value(MicrosoftGraph::Models::PrivilegedAccessGroupAssignmentScheduleInstanceAssignmentType) },
                    ...
                    "memberType" => lambda {|n| @member_type = n.get_enum_value(MicrosoftGraph::Models::PrivilegedAccessGroupAssignmentScheduleInstanceMemberType) },
            ...
            ## @return a privileged_access_group_assignment_schedule_instance_member_type
            ## 
            def member_type
                return @member_type
            end
