        ...
        class ApiAuthenticationConfigurationBase
            ...
            def self.create_from_discriminator_value(parse_node)
                ...
                unless mapping_value_node.nil? then
                    ...
                    case mapping_value
                        when "#microsoft.graph.basicAuthentication"
                            return BasicAuthentication.new
                        when "#microsoft.graph.clientCertificateAuthentication"
                            return ClientCertificateAuthentication.new
                        when "#microsoft.graph.pkcs12Certificate"
                            return Pkcs12Certificate.new
                    end
                end
                return ApiAuthenticationConfigurationBase.new
            end
            ## 
