...
module MicrosoftGraph
    module Models
        class OnAttributeCollectionSubmitListener < MicrosoftGraph::Models::AuthenticationEventListener
            ...
            ## @return a on_attribute_collection_submit_listener
            ## 
            ...
            def get_field_deserializers()
                return super.merge({
                    "handler" => lambda {|n| @handler = n.get_object_value(lambda {|pn| MicrosoftGraph::Models::OnAttributeCollectionSubmitHandler.create_from_discriminator_value(pn) }) },
                })
            end
            ## 
