        ...
        class AuthenticationAttributeCollectionPage
            ...
            def get_field_deserializers()
                return {
                    ...
                    "views" => lambda {|n| @views = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraph::Models::AuthenticationAttributeCollectionPageViewConfiguration.create_from_discriminator_value(pn) }) },
                }
            end
            ## 
