    ...
    module Models
        class DirectoryRole < MicrosoftGraph::Models::DirectoryObject
            ...
            def serialize(writer)
                ...
                writer.write_string_value("roleTemplateId", @role_template_id) unless @role_template_id.nil?
                writer.write_collection_of_object_values("scopedMembers", @scoped_members) unless @scoped_members.nil?
            end
        end
    end
end
