...
module MicrosoftGraph
    module Models
        class PrivilegedAccessGroupAssignmentSchedule < MicrosoftGraph::Models::PrivilegedAccessSchedule
            ...
            ## @return a privileged_access_group_assignment_schedule_access_id
            ## 
            def access_id
                return @access_id
            end
            ...
            ## @return a privileged_access_group_assignment_schedule_assignment_type
            ## 
            def assignment_type
            ...
            def get_field_deserializers()
                return super.merge({
                    "accessId" => lambda {|n| @access_id = n.get_enum_value(MicrosoftGraph::Models::PrivilegedAccessGroupAssignmentScheduleAccessId) },
                    ...
                    "assignmentType" => lambda {|n| @assignment_type = n.get_enum_value(MicrosoftGraph::Models::PrivilegedAccessGroupAssignmentScheduleAssignmentType) },
                    ...
                    "memberType" => lambda {|n| @member_type = n.get_enum_value(MicrosoftGraph::Models::PrivilegedAccessGroupAssignmentScheduleMemberType) },
            ...
            ## @return a privileged_access_group_assignment_schedule_member_type
            ## 
            def member_type
                return @member_type
            end
