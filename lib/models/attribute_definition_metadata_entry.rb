    ...
    module Models
        class AttributeDefinitionMetadataEntry
            ...
            def self.create_from_discriminator_value(parse_node)
                ...
                return AttributeDefinitionMetadataEntry.new
            end
            ## 
            ...
            def get_field_deserializers()
                return {
                    "key" => lambda {|n| @key = n.get_enum_value(MicrosoftGraph::Models::AttributeDefinitionMetadataEntryKey) },
            ...
            ## @return a attribute_definition_metadata_entry_key
            ## 
            def key
                return @key
            end
