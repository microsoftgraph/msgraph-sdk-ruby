        ...
        class AccessReviewApplyAction
            ...
            def self.create_from_discriminator_value(parse_node)
                ...
                unless mapping_value_node.nil? then
                    ...
                    case mapping_value
                        when "#microsoft.graph.disableAndDeleteUserApplyAction"
                            return DisableAndDeleteUserApplyAction.new
                        when "#microsoft.graph.removeAccessApplyAction"
                            return RemoveAccessApplyAction.new
                    end
                end
                return AccessReviewApplyAction.new
            end
            ## 
