...
module MicrosoftGraph
    module Models
        class ExternalConnectorsSearchSettings
            ...
            ## 
            ## Instantiates a new externalConnectorsSearchSettings and sets the default values.
            ## @return a void
            ## 
            def initialize()
            ...
            def self.create_from_discriminator_value(parse_node)
                ...
                return ExternalConnectorsSearchSettings.new
            end
            ## 
            ...
            def get_field_deserializers()
                return {
                    ...
                    "searchResultTemplates" => lambda {|n| @search_result_templates = n.get_collection_of_object_values(lambda {|pn| MicrosoftGraph::Models::ExternalConnectorsDisplayTemplate.create_from_discriminator_value(pn) }) },
                }
            end
            ## 
            ...
            ## 
            def search_result_templates
                return @search_result_templates
            end
            ## 
            ...
            ## @return a void
            ## 
            def search_result_templates=(value)
                @search_result_templates = value
            end
            ## 
            ...
            def serialize(writer)
                ...
                writer.write_collection_of_object_values("searchResultTemplates", @search_result_templates) unless @search_result_templates.nil?
