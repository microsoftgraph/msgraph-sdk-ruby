    ...
    module Models
        class CrossTenantAccessPolicyConfigurationPartner
            ...
            def serialize(writer)
                ...
                writer.write_object_value("identitySynchronization", @identity_synchronization) unless @identity_synchronization.nil?
                writer.write_object_value("inboundTrust", @inbound_trust) unless @inbound_trust.nil?
                writer.write_boolean_value("isServiceProvider", @is_service_provider) unless @is_service_provider.nil?
