...
module MicrosoftGraph
    module Models
        class MeetingTimeSuggestion
            ...
            ## @return a meeting_time_suggestion_confidence
            ## 
            def confidence
                return @confidence
            end
            ...
            def get_field_deserializers()
                return {
                    ...
                    "confidence" => lambda {|n| @confidence = n.get_object_value(lambda {|pn| MeetingTimeSuggestion::MeetingTimeSuggestionConfidence.create_from_discriminator_value(pn) }) },
            ...
            class MeetingTimeSuggestionConfidence
                ...
                def self.create_from_discriminator_value(parse_node)
                    ...
                    return MeetingTimeSuggestionConfidence.new
                end
                ## 
