...
module MicrosoftGraph
    module Models
        class RetentionLabelSettings
            ...
            ## @return a retention_label_settings_behavior_during_retention_period
            ## 
            ...
            def get_field_deserializers()
                return {
                    "behaviorDuringRetentionPeriod" => lambda {|n| @behavior_during_retention_period = n.get_enum_value(MicrosoftGraph::Models::RetentionLabelSettingsBehaviorDuringRetentionPeriod) },
