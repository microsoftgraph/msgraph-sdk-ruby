    ...
    module Models
        class EmailSettings
            ...
            def serialize(writer)
                ...
                writer.write_string_value("senderDomain", @sender_domain) unless @sender_domain.nil?
                writer.write_boolean_value("useCompanyBranding", @use_company_branding) unless @use_company_branding.nil?
