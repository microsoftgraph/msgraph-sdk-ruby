        ...
        module MultiTenantOrganization
            module Tenants
                module Item
                    ...
                    class MultiTenantOrganizationMemberItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/tenantRelationships/multiTenantOrganization/tenants/{multiTenantOrganizationMember%2Did}{?%24expand,%24select}")
                        end
                        ## 
                        ...
                        def with_url(raw_url)
                            ...
                            return MultiTenantOrganizationMemberItemRequestBuilder.new(raw_url, @request_adapter)
                        end
