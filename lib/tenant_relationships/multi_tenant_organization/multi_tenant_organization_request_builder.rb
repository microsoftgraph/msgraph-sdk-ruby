...
require_relative '../../models/multi_tenant_organization'
require_relative '../../models/o_data_errors_o_data_error'
require_relative '../tenant_relationships'
require_relative './join_request/join_request_request_builder'
...
module MicrosoftGraph
    module TenantRelationships
        module MultiTenantOrganization
            ...
            class MultiTenantOrganizationRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                
                ## 
                # Provides operations to manage the joinRequest property of the microsoft.graph.multiTenantOrganization entity.
                def join_request()
                    return MicrosoftGraph::TenantRelationships::MultiTenantOrganization::JoinRequest::JoinRequestRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                # Provides operations to manage the tenants property of the microsoft.graph.multiTenantOrganization entity.
                def tenants()
                    return MicrosoftGraph::TenantRelationships::MultiTenantOrganization::Tenants::TenantsRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                ...
                def initialize(path_parameters, request_adapter)
                    super(path_parameters, request_adapter, "{+baseurl}/tenantRelationships/multiTenantOrganization{?%24expand,%24select}")
                end
                ## 
                ...
                def get(request_configuration=nil)
                    ...
                    return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraph::Models::MultiTenantOrganization.create_from_discriminator_value(pn) }, error_mapping)
                end
                ## 
