...
require_relative '../../models/delegated_admin_relationship_collection_response'
...
module MicrosoftGraph
    module TenantRelationships
        module DelegatedAdminRelationships
            ...
            class DelegatedAdminRelationshipsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def initialize(path_parameters, request_adapter)
                    super(path_parameters, request_adapter, "{+baseurl}/tenantRelationships/delegatedAdminRelationships{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}")
                end
                ## 
                ## Get a list of the delegatedAdminRelationship objects and their properties.
                ## @param request_configuration Configuration for the request such as headers, query parameters, and middleware options.
                ## @return a Fiber of delegated_admin_relationship_collection_response
                ## 
                def get(request_configuration=nil)
                    ...
                    return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraph::Models::DelegatedAdminRelationshipCollectionResponse.create_from_discriminator_value(pn) }, error_mapping)
                end
                ## 
                ...
                def to_post_request_information(body, request_configuration=nil)
                    ...
                    request_info.url_template = '{+baseurl}/tenantRelationships/delegatedAdminRelationships'
                    request_info.path_parameters = @path_parameters
                ...
                ## @return a delegated_admin_relationships_request_builder
                ## 
                def with_url(raw_url)
                    raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                    return DelegatedAdminRelationshipsRequestBuilder.new(raw_url, @request_adapter)
                end
