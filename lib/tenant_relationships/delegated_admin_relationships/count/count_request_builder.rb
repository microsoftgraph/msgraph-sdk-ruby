...
module MicrosoftGraph::TenantRelationships::DelegatedAdminRelationships::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/tenantRelationships/delegatedAdminRelationships/$count{?%24search,%24filter}"
