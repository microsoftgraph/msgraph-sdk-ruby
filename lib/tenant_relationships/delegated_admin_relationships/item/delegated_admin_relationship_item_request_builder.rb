...
module MicrosoftGraph::TenantRelationships::DelegatedAdminRelationships::Item
    ## 
    ...
    class DelegatedAdminRelationshipItemRequestBuilder
        ...
        ## @param delegatedAdminRelationshipId key: id of delegatedAdminRelationship
        ## @param pathParameters Path parameters for the request
        ## @param requestAdapter The request adapter to use to execute the requests.
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, delegated_admin_relationship_id=nil)
