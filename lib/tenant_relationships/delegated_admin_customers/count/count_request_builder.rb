...
module MicrosoftGraph::TenantRelationships::DelegatedAdminCustomers::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/tenantRelationships/delegatedAdminCustomers/$count{?%24search,%24filter}"
