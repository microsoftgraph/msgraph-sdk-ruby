...
module MicrosoftGraph
    module TenantRelationships
        module DelegatedAdminCustomers
            ...
            class DelegatedAdminCustomersRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def initialize(path_parameters, request_adapter)
                    super(path_parameters, request_adapter, "{+baseurl}/tenantRelationships/delegatedAdminCustomers{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}")
                end
                ## 
                ## Get a list of the delegatedAdminCustomer objects and their properties.
                ## @param request_configuration Configuration for the request such as headers, query parameters, and middleware options.
                ## @return a Fiber of delegated_admin_customer_collection_response
                ## 
                ...
                def to_post_request_information(body, request_configuration=nil)
                    ...
                    request_info.url_template = '{+baseurl}/tenantRelationships/delegatedAdminCustomers'
                    request_info.path_parameters = @path_parameters
                ...
                ## @return a delegated_admin_customers_request_builder
                ## 
                def with_url(raw_url)
                    raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                    return DelegatedAdminCustomersRequestBuilder.new(raw_url, @request_adapter)
                end
