...
module MicrosoftGraph::Security::AttackSimulation::Simulations::Item
    ## 
    ...
    class SimulationItemRequestBuilder
        ...
        ## @param simulationId key: id of simulation
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, simulation_id=nil)
            raise StandardError, 'path_parameters cannot be null' if path_parameters.nil?
            raise StandardError, 'request_adapter cannot be null' if request_adapter.nil?
            @url_template = "{+baseurl}/security/attackSimulation/simulations/{simulation%2Did}{?%24select,%24expand}"
