        ...
        module AttackSimulation
            module LandingPages
                module Item
                    ...
                    class LandingPageItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        
                        ## 
                        # Provides operations to manage the details property of the microsoft.graph.landingPage entity.
                        def details()
                            return MicrosoftGraph::Security::AttackSimulation::LandingPages::Item::Details::DetailsRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/security/attackSimulation/landingPages/{landingPage%2Did}{?%24expand,%24select}")
                        end
                        ## 
                        ...
                        def to_delete_request_information(request_configuration=nil)
                            ...
                            request_info.url_template = '{+baseurl}/security/attackSimulation/landingPages/{landingPage%2Did}'
                        ...
                        def with_url(raw_url)
                            ...
                            return LandingPageItemRequestBuilder.new(raw_url, @request_adapter)
                        end
