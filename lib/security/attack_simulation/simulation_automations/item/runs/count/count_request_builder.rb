...
module MicrosoftGraph::Security::AttackSimulation::SimulationAutomations::Item::Runs::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/security/attackSimulation/simulationAutomations/{simulationAutomation%2Did}/runs/$count{?%24search,%24filter}"
