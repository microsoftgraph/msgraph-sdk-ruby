                ...
                module Item
                    module Runs
                        module Item
                            ...
                            class SimulationAutomationRunItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                ...
                                def initialize(path_parameters, request_adapter)
                                    super(path_parameters, request_adapter, "{+baseurl}/security/attackSimulation/simulationAutomations/{simulationAutomation%2Did}/runs/{simulationAutomationRun%2Did}{?%24expand,%24select}")
                                end
                                ## 
                                ...
                                def to_delete_request_information(request_configuration=nil)
                                    ...
                                    request_info.url_template = '{+baseurl}/security/attackSimulation/simulationAutomations/{simulationAutomation%2Did}/runs/{simulationAutomationRun%2Did}'
                                ...
                                def with_url(raw_url)
                                    ...
                                    return SimulationAutomationRunItemRequestBuilder.new(raw_url, @request_adapter)
                                end
