    ...
    module Security
        module AttackSimulation
            module SimulationAutomations
                ...
                class SimulationAutomationsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def initialize(path_parameters, request_adapter)
                        super(path_parameters, request_adapter, "{+baseurl}/security/attackSimulation/simulationAutomations{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}")
                    end
                    ## 
                    ## Get a list of attack simulation automations for a tenant.
                    ## @param request_configuration Configuration for the request such as headers, query parameters, and middleware options.
                    ## @return a Fiber of simulation_automation_collection_response
                    ## 
                    ...
                    def to_post_request_information(body, request_configuration=nil)
                        ...
                        request_info.url_template = '{+baseurl}/security/attackSimulation/simulationAutomations'
                        request_info.path_parameters = @path_parameters
                    ...
                    ## @return a simulation_automations_request_builder
                    ## 
                    def with_url(raw_url)
                        raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                        return SimulationAutomationsRequestBuilder.new(raw_url, @request_adapter)
                    end
