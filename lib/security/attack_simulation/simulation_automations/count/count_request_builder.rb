...
module MicrosoftGraph::Security::AttackSimulation::SimulationAutomations::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/security/attackSimulation/simulationAutomations/$count{?%24search,%24filter}"
