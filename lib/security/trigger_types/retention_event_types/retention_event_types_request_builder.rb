...
require_relative '../../../models/security_retention_event_type'
require_relative '../../../models/security_retention_event_type_collection_response'
    ...
    module Security
        module TriggerTypes
            module RetentionEventTypes
                ...
                class RetentionEventTypesRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def initialize(path_parameters, request_adapter)
                        super(path_parameters, request_adapter, "{+baseurl}/security/triggerTypes/retentionEventTypes{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}")
                    end
                    ## 
                    ## Get a list of the retentionEventType objects and their properties.
                    ## @param request_configuration Configuration for the request such as headers, query parameters, and middleware options.
                    ## @return a Fiber of security_retention_event_type_collection_response
                    ## 
                    def get(request_configuration=nil)
                        ...
                        return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraph::Models::SecurityRetentionEventTypeCollectionResponse.create_from_discriminator_value(pn) }, error_mapping)
                    end
                    ## 
                    ## Create a new retentionEventType object.
                    ## @param body The request body
                    ## @param request_configuration Configuration for the request such as headers, query parameters, and middleware options.
                    ## @return a Fiber of security_retention_event_type
                    ## 
                    def post(body, request_configuration=nil)
                        ...
                        error_mapping = Hash.new
                        error_mapping["XXX"] = lambda {|pn| MicrosoftGraph::Models::ODataErrorsODataError.create_from_discriminator_value(pn) }
                        return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraph::Models::SecurityRetentionEventType.create_from_discriminator_value(pn) }, error_mapping)
                    end
                    ## 
                    ## Get a list of the retentionEventType objects and their properties.
                    ## @param request_configuration Configuration for the request such as headers, query parameters, and middleware options.
                    ...
                    def to_post_request_information(body, request_configuration=nil)
                        ...
                        request_info.url_template = '{+baseurl}/security/triggerTypes/retentionEventTypes'
                        request_info.path_parameters = @path_parameters
                    ...
                    ## @return a retention_event_types_request_builder
                    ## 
                    def with_url(raw_url)
                        raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                        return RetentionEventTypesRequestBuilder.new(raw_url, @request_adapter)
                    end
