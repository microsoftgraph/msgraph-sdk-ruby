...
require_relative './identities/identities_request_builder'
...
module MicrosoftGraph
    module Security
        ...
        class SecurityRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
            ...
            def identities()
                return MicrosoftGraph::Security::Identities::IdentitiesRequestBuilder.new(@path_parameters, @request_adapter)
            end
            ## 
