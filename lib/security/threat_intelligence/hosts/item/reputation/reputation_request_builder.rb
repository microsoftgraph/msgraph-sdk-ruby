...
require_relative '../../../../../models/security/host_reputation'
                ...
                module Item
                    module Reputation
                        ...
                        class ReputationRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            ## @param request_configuration Configuration for the request such as headers, query parameters, and middleware options.
                            ## @return a Fiber of host_reputation
                            ## 
                            def get(request_configuration=nil)
                                ...
                                error_mapping["4XX"] = lambda {|pn| MicrosoftGraph::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
                                error_mapping["5XX"] = lambda {|pn| MicrosoftGraph::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
                                return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraph::Models::Security::HostReputation.create_from_discriminator_value(pn) }, error_mapping)
                            end
                            ## 
