            ...
            module HostPairs
                module Item
                    module ChildHost
                        ...
                        class ChildHostRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            def initialize(path_parameters, request_adapter)
                                super(path_parameters, request_adapter, "{+baseurl}/security/threatIntelligence/hostPairs/{hostPair%2Did}/childHost{?%24select,%24expand}")
                            end
                            ## 
                            ...
                            ## @return a child_host_request_builder
                            ## 
                            def with_url(raw_url)
                                raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                                return ChildHostRequestBuilder.new(raw_url, @request_adapter)
                            end
