                        ...
                        module Item
                            module ChildTags
                                ...
                                class ChildTagsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                    ...
                                    ## 
                                    ## Provides operations to manage the childTags property of the microsoft.graph.security.ediscoveryReviewTag entity.
                                    ## @param ediscovery_review_tag_id1 Unique identifier of the item
                                    ...
                                    def initialize(path_parameters, request_adapter)
                                        super(path_parameters, request_adapter, "{+baseurl}/security/cases/ediscoveryCases/{ediscoveryCase%2Did}/tags/{ediscoveryReviewTag%2Did}/childTags{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}")
                                    end
                                    ## 
