...
module MicrosoftGraph::Security::Cases::EdiscoveryCases::Item::Tags::Item::ChildTags::Item
    ## 
    ...
    class EdiscoveryReviewTagItemRequestBuilder
        ...
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, ediscovery_review_tag_id1=nil)
