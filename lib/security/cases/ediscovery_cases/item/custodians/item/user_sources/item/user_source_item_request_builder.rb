...
module MicrosoftGraph::Security::Cases::EdiscoveryCases::Item::Custodians::Item::UserSources::Item
    ## 
    ...
    class UserSourceItemRequestBuilder
        ...
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, user_source_id=)
