...
module MicrosoftGraph::Security::Cases::EdiscoveryCases::Item::Custodians::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/security/cases/ediscoveryCases/{ediscoveryCase%2Did}/custodians/$count{?%24search,%24filter}"
