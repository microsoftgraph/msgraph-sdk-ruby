...
module MicrosoftGraph::Security::Cases::EdiscoveryCases::Item::NoncustodialDataSources::Item
    ...
    class EdiscoveryNoncustodialDataSourceItemRequestBuilder
        ...
        def microsoft_graph_security_apply_hold()
            return MicrosoftGraph::Security::Cases::EdiscoveryCases::Item::NoncustodialDataSources::Item::MicrosoftGraphSecurityApplyHold::ApplyHoldRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the release method.
        def microsoft_graph_security_release()
            return MicrosoftGraph::Security::Cases::EdiscoveryCases::Item::NoncustodialDataSources::Item::MicrosoftGraphSecurityRelease::ReleaseRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the removeHold method.
        def microsoft_graph_security_remove_hold()
            return MicrosoftGraph::Security::Cases::EdiscoveryCases::Item::NoncustodialDataSources::Item::MicrosoftGraphSecurityRemoveHold::RemoveHoldRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the updateIndex method.
        def microsoft_graph_security_update_index()
            return MicrosoftGraph::Security::Cases::EdiscoveryCases::Item::NoncustodialDataSources::Item::MicrosoftGraphSecurityUpdateIndex::UpdateIndexRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, ediscovery_noncustodial_data_source_id=)
