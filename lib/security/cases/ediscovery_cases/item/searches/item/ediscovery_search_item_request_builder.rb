                        ...
                        module Item
                            ...
                            class EdiscoverySearchItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                ...
                                def microsoft_graph_security_export_report()
                                    return MicrosoftGraph::Security::Cases::EdiscoveryCases::Item::Searches::Item::MicrosoftGraphSecurityExportReport::MicrosoftGraphSecurityExportReportRequestBuilder.new(@path_parameters, @request_adapter)
                                end
                                ## 
                                # Provides operations to call the exportResult method.
                                def microsoft_graph_security_export_result()
                                    return MicrosoftGraph::Security::Cases::EdiscoveryCases::Item::Searches::Item::MicrosoftGraphSecurityExportResult::MicrosoftGraphSecurityExportResultRequestBuilder.new(@path_parameters, @request_adapter)
                                end
                                ## 
