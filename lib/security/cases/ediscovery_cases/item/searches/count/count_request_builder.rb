...
module MicrosoftGraph::Security::Cases::EdiscoveryCases::Item::Searches::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/security/cases/ediscoveryCases/{ediscoveryCase%2Did}/searches/$count{?%24search,%24filter}"
