...
require_relative './microsoft_graph_security_get_deployment_access_key'

module MicrosoftGraph
    module Security
        module Identities
            module Sensors
                module MicrosoftGraphSecurityGetDeploymentAccessKey
                    ## 
                    # Provides operations to call the getDeploymentAccessKey method.
                    class MicrosoftGraphSecurityGetDeploymentAccessKeyRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/security/identities/sensors/microsoft.graph.security.getDeploymentAccessKey()")
                        end
                        ## 
                        ...
                        ## @return a microsoft_graph_security_get_deployment_access_key_request_builder
                        ## 
                        def with_url(raw_url)
                            raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                            return MicrosoftGraphSecurityGetDeploymentAccessKeyRequestBuilder.new(raw_url, @request_adapter)
                        end
                    end
                end
            end
