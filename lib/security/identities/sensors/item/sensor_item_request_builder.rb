        ...
        module Identities
            module Sensors
                module Item
                    ...
                    class SensorItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        
                        ## 
                        # Provides operations to manage the healthIssues property of the microsoft.graph.security.sensor entity.
                        def health_issues()
                            return MicrosoftGraph::Security::Identities::Sensors::Item::HealthIssues::HealthIssuesRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/security/identities/sensors/{sensor%2Did}{?%24expand,%24select}")
                        end
                        ## 
                        ...
                        def with_url(raw_url)
                            ...
                            return SensorItemRequestBuilder.new(raw_url, @request_adapter)
                        end
