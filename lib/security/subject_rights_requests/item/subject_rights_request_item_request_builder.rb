        ...
        module SubjectRightsRequests
            module Item
                ...
                class SubjectRightsRequestItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def approvers()
                        return MicrosoftGraph::Security::SubjectRightsRequests::Item::Approvers::ApproversRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to manage the collaborators property of the microsoft.graph.subjectRightsRequest entity.
                    def collaborators()
                        return MicrosoftGraph::Security::SubjectRightsRequests::Item::Collaborators::CollaboratorsRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to call the getFinalAttachment method.
                    def get_final_attachment()
                        return MicrosoftGraph::Security::SubjectRightsRequests::Item::GetFinalAttachment::GetFinalAttachmentRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to call the getFinalReport method.
                    def get_final_report()
                        return MicrosoftGraph::Security::SubjectRightsRequests::Item::GetFinalReport::GetFinalReportRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to manage the notes property of the microsoft.graph.subjectRightsRequest entity.
                    def notes()
                        return MicrosoftGraph::Security::SubjectRightsRequests::Item::Notes::NotesRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to manage the team property of the microsoft.graph.subjectRightsRequest entity.
                    def team()
                        return MicrosoftGraph::Security::SubjectRightsRequests::Item::Team::TeamRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ...
                    def initialize(path_parameters, request_adapter)
                        super(path_parameters, request_adapter, "{+baseurl}/security/subjectRightsRequests/{subjectRightsRequest%2Did}{?%24expand,%24select}")
                    end
                    ## 
                    ...
                    def to_delete_request_information(request_configuration=nil)
                        ...
                        request_info.url_template = '{+baseurl}/security/subjectRightsRequests/{subjectRightsRequest%2Did}'
