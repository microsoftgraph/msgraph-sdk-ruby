...
require_relative './collaborators_with_user_principal_name'

module MicrosoftGraph
    module Security
        module SubjectRightsRequests
            module Item
                module CollaboratorsWithUserPrincipalName
                    ## 
                    # Provides operations to manage the collaborators property of the microsoft.graph.subjectRightsRequest entity.
                    class CollaboratorsWithUserPrincipalNameRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def initialize(path_parameters, request_adapter, user_principal_name=nil)
                            super(path_parameters, request_adapter, "{+baseurl}/security/subjectRightsRequests/{subjectRightsRequest%2Did}/collaborators(userPrincipalName='{userPrincipalName}'){?%24expand,%24select}")
                        end
                        ## 
                        ...
                        def with_url(raw_url)
                            ...
                            return CollaboratorsWithUserPrincipalNameRequestBuilder.new(raw_url, @request_adapter)
                        end
