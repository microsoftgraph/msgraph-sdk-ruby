        ...
        module Triggers
            module RetentionEvents
                module Item
                    ...
                    class RetentionEventItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def retention_event_type()
                            return MicrosoftGraph::Security::Triggers::RetentionEvents::Item::RetentionEventType::RetentionEventTypeRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/security/triggers/retentionEvents/{retentionEvent%2Did}{?%24expand,%24select}")
                        end
                        ## 
                        ...
                        def to_delete_request_information(request_configuration=nil)
                            ...
                            request_info.url_template = '{+baseurl}/security/triggers/retentionEvents/{retentionEvent%2Did}'
                        ...
                        def with_url(raw_url)
                            ...
                            return RetentionEventItemRequestBuilder.new(raw_url, @request_adapter)
                        end
