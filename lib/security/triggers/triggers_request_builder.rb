...
module MicrosoftGraph
    module Security
        module Triggers
            ...
            class TriggersRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def retention_events()
                    return MicrosoftGraph::Security::Triggers::RetentionEvents::RetentionEventsRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                ...
                def initialize(path_parameters, request_adapter)
                    super(path_parameters, request_adapter, "{+baseurl}/security/triggers{?%24expand,%24select}")
                end
                ## 
                ...
                def to_delete_request_information(request_configuration=nil)
                    ...
                    request_info.url_template = '{+baseurl}/security/triggers'
                ...
                ## @return a triggers_request_builder
                ## 
                def with_url(raw_url)
                    raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                    return TriggersRequestBuilder.new(raw_url, @request_adapter)
                end
