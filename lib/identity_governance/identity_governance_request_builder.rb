...
require_relative '../models/identity_governance_model'
...
module MicrosoftGraph
    module IdentityGovernance
        ...
        class IdentityGovernanceRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
            ...
            def initialize(path_parameters, request_adapter)
                super(path_parameters, request_adapter, "{+baseurl}/identityGovernance{?%24select,%24expand}")
            end
            ## 
            ## Get identityGovernance
            ## @param request_configuration Configuration for the request such as headers, query parameters, and middleware options.
            ## @return a Fiber of identity_governance_model
            ## 
            def get(request_configuration=nil)
                ...
                return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraph::Models::IdentityGovernanceModel.create_from_discriminator_value(pn) }, error_mapping)
            end
            ## 
