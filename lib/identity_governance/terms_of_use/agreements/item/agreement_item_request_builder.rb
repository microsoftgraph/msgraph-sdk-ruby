...
module MicrosoftGraph::IdentityGovernance::TermsOfUse::Agreements::Item
    ## 
    ...
    class AgreementItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, agreement_id=)
            ...
            @url_template = "{+baseurl}/identityGovernance/termsOfUse/agreements/{agreement%2Did}{?%24select,%24expand}"
