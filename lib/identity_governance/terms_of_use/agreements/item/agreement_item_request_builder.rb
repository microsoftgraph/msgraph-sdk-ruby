            ...
            module Agreements
                module Item
                    ...
                    class AgreementItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def acceptances()
                            return MicrosoftGraph::IdentityGovernance::TermsOfUse::Agreements::Item::Acceptances::AcceptancesRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        # Provides operations to manage the file property of the microsoft.graph.agreement entity.
                        def file()
                            return MicrosoftGraph::IdentityGovernance::TermsOfUse::Agreements::Item::File::FileRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/identityGovernance/termsOfUse/agreements/{agreement%2Did}{?%24expand,%24select}")
                        end
                        ## 
                        ...
                        def to_delete_request_information(request_configuration=nil)
                            ...
                            request_info.url_template = '{+baseurl}/identityGovernance/termsOfUse/agreements/{agreement%2Did}'
                        ...
                        def with_url(raw_url)
                            ...
                            return AgreementItemRequestBuilder.new(raw_url, @request_adapter)
                        end
