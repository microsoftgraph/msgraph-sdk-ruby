...
module MicrosoftGraph::IdentityGovernance::TermsOfUse::Agreements::Item::File::Localizations::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/identityGovernance/termsOfUse/agreements/{agreement%2Did}/file/localizations/$count{?%24search,%24filter}"
