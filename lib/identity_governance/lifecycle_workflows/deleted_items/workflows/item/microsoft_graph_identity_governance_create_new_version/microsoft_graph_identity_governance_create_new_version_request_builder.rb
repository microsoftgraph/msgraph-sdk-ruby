                ...
                module Workflows
                    module Item
                        module MicrosoftGraphIdentityGovernanceCreateNewVersion
                            ...
                            class MicrosoftGraphIdentityGovernanceCreateNewVersionRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                ...
                                def initialize(path_parameters, request_adapter)
                                    super(path_parameters, request_adapter, "{+baseurl}/identityGovernance/lifecycleWorkflows/deletedItems/workflows/{workflow%2Did}/microsoft.graph.identityGovernance.createNewVersion")
                                end
                                ## 
                                ...
                                ## @return a microsoft_graph_identity_governance_create_new_version_request_builder
                                ## 
                                def with_url(raw_url)
                                    raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                                    return MicrosoftGraphIdentityGovernanceCreateNewVersionRequestBuilder.new(raw_url, @request_adapter)
                                end
                            end
                        end
                    end
