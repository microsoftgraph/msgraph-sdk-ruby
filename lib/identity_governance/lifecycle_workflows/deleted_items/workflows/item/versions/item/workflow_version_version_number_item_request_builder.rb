...
require_relative '../../../../../../../models/identity_governance/workflow_version'
                        ...
                        module Versions
                            module Item
                                ...
                                class WorkflowVersionVersionNumberItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                    ...
                                    def created_by()
                                        return MicrosoftGraph::IdentityGovernance::LifecycleWorkflows::DeletedItems::Workflows::Item::Versions::Item::CreatedBy::CreatedByRequestBuilder.new(@path_parameters, @request_adapter)
                                    end
                                    ## 
                                    ...
                                    def last_modified_by()
                                        return MicrosoftGraph::IdentityGovernance::LifecycleWorkflows::DeletedItems::Workflows::Item::Versions::Item::LastModifiedBy::LastModifiedByRequestBuilder.new(@path_parameters, @request_adapter)
                                    end
                                    ## 
                                    # Provides operations to manage the tasks property of the microsoft.graph.identityGovernance.workflowBase entity.
                                    def tasks()
                                        return MicrosoftGraph::IdentityGovernance::LifecycleWorkflows::DeletedItems::Workflows::Item::Versions::Item::Tasks::TasksRequestBuilder.new(@path_parameters, @request_adapter)
                                    end
                                    ## 
                                    ...
                                    ## @return a Fiber of workflow_version
                                    ## 
                                    def get(request_configuration=nil)
                                        ...
                                        return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraph::Models::IdentityGovernance::WorkflowVersion.create_from_discriminator_value(pn) }, error_mapping)
                                    end
                                    ## 
                                    ## Read the properties and relationships of a workflowVersion object.
                                    ## @param request_configuration Configuration for the request such as headers, query parameters, and middleware options.
