...
require_relative '../../../../../../../../models/identity_governance/user_processing_result_collection_response'
                            ...
                            module Item
                                module UserProcessingResults
                                    ...
                                    class UserProcessingResultsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                        ...
                                        def count()
                                            return MicrosoftGraph::IdentityGovernance::LifecycleWorkflows::DeletedItems::Workflows::Item::Runs::Item::UserProcessingResults::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                                        end
                                        ## 
                                        ## Provides operations to manage the userProcessingResults property of the microsoft.graph.identityGovernance.run entity.
                                        ## @param user_processing_result_id Unique identifier of the item
                                        ...
                                        def by_user_processing_result_id(user_processing_result_id)
                                            ...
                                            return MicrosoftGraph::IdentityGovernance::LifecycleWorkflows::DeletedItems::Workflows::Item::Runs::Item::UserProcessingResults::Item::UserProcessingResultItemRequestBuilder.new(url_tpl_params, @request_adapter)
                                        end
                                        ## 
                                        ...
                                        def initialize(path_parameters, request_adapter)
                                            super(path_parameters, request_adapter, "{+baseurl}/identityGovernance/lifecycleWorkflows/deletedItems/workflows/{workflow%2Did}/runs/{run%2Did}/userProcessingResults{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}")
                                        end
                                        ## 
                                        ## Get user processing results of a workflow run object.
                                        ## @param request_configuration Configuration for the request such as headers, query parameters, and middleware options.
                                        ## @return a Fiber of user_processing_result_collection_response
                                        ## 
                                        def get(request_configuration=nil)
                                            ...
                                            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraph::Models::IdentityGovernance::UserProcessingResultCollectionResponse.create_from_discriminator_value(pn) }, error_mapping)
                                        end
                                        ## 
