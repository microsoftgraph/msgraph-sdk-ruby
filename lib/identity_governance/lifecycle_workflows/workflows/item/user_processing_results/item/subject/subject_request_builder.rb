                            ...
                            module Subject
                                ...
                                class SubjectRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                    ...
                                    def mailbox_settings()
                                        return MicrosoftGraph::IdentityGovernance::LifecycleWorkflows::Workflows::Item::UserProcessingResults::Item::Subject::MailboxSettings::MailboxSettingsRequestBuilder.new(@path_parameters, @request_adapter)
                                    end
                                    ## 
                                    # The serviceProvisioningErrors property
                                    def service_provisioning_errors()
                                        return MicrosoftGraph::IdentityGovernance::LifecycleWorkflows::Workflows::Item::UserProcessingResults::Item::Subject::ServiceProvisioningErrors::ServiceProvisioningErrorsRequestBuilder.new(@path_parameters, @request_adapter)
                                    end
                                    ## 
                                    ...
                                    def initialize(path_parameters, request_adapter)
                                        super(path_parameters, request_adapter, "{+baseurl}/identityGovernance/lifecycleWorkflows/workflows/{workflow%2Did}/userProcessingResults/{userProcessingResult%2Did}/subject{?%24expand,%24select}")
                                    end
                                    ## 
