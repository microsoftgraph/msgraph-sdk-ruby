                    ...
                    module Versions
                        module Item
                            module LastModifiedBy
                                ...
                                class LastModifiedByRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                    
                                    ## 
                                    # The mailboxSettings property
                                    def mailbox_settings()
                                        return MicrosoftGraph::IdentityGovernance::LifecycleWorkflows::Workflows::Item::Versions::Item::LastModifiedBy::MailboxSettings::MailboxSettingsRequestBuilder.new(@path_parameters, @request_adapter)
                                    end
                                    ## 
                                    # The serviceProvisioningErrors property
                                    def service_provisioning_errors()
                                        return MicrosoftGraph::IdentityGovernance::LifecycleWorkflows::Workflows::Item::Versions::Item::LastModifiedBy::ServiceProvisioningErrors::ServiceProvisioningErrorsRequestBuilder.new(@path_parameters, @request_adapter)
                                    end
                                    ## 
                                    ...
                                    def initialize(path_parameters, request_adapter)
                                        super(path_parameters, request_adapter, "{+baseurl}/identityGovernance/lifecycleWorkflows/workflows/{workflow%2Did}/versions/{workflowVersion%2DversionNumber}/lastModifiedBy{?%24select,%24expand}")
                                    end
                                    ## 
