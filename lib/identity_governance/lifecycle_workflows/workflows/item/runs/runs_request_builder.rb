...
require_relative '../../../../../models/identity_governance/run_collection_response'
                ...
                module Item
                    module Runs
                        ...
                        class RunsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            def count()
                                return MicrosoftGraph::IdentityGovernance::LifecycleWorkflows::Workflows::Item::Runs::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            ## Provides operations to manage the runs property of the microsoft.graph.identityGovernance.workflow entity.
                            ...
                            def by_run_id(run_id)
                                ...
                                return MicrosoftGraph::IdentityGovernance::LifecycleWorkflows::Workflows::Item::Runs::Item::RunItemRequestBuilder.new(url_tpl_params, @request_adapter)
                            end
                            ## 
                            ...
                            def initialize(path_parameters, request_adapter)
                                super(path_parameters, request_adapter, "{+baseurl}/identityGovernance/lifecycleWorkflows/workflows/{workflow%2Did}/runs{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}")
                            end
                            ## 
                            ## Get a list of the run objects and their properties for a lifecycle workflow.
                            ## @param request_configuration Configuration for the request such as headers, query parameters, and middleware options.
                            ## @return a Fiber of run_collection_response
                            ## 
                            def get(request_configuration=nil)
                                ...
                                return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraph::Models::IdentityGovernance::RunCollectionResponse.create_from_discriminator_value(pn) }, error_mapping)
                            end
                            ## 
