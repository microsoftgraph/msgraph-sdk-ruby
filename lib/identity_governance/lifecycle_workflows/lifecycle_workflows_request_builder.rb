        ...
        module LifecycleWorkflows
            ...
            class LifecycleWorkflowsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def custom_task_extensions()
                    return MicrosoftGraph::IdentityGovernance::LifecycleWorkflows::CustomTaskExtensions::CustomTaskExtensionsRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                ...
                def deleted_items()
                    return MicrosoftGraph::IdentityGovernance::LifecycleWorkflows::DeletedItems::DeletedItemsRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                ...
                def insights()
                    return MicrosoftGraph::IdentityGovernance::LifecycleWorkflows::Insights::InsightsRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                ...
                def settings()
                    return MicrosoftGraph::IdentityGovernance::LifecycleWorkflows::Settings::SettingsRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                ...
                def task_definitions()
                    return MicrosoftGraph::IdentityGovernance::LifecycleWorkflows::TaskDefinitions::TaskDefinitionsRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                # Provides operations to manage the workflows property of the microsoft.graph.identityGovernance.lifecycleWorkflowsContainer entity.
                def workflows()
                    return MicrosoftGraph::IdentityGovernance::LifecycleWorkflows::Workflows::WorkflowsRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                ...
                def workflow_templates()
                    return MicrosoftGraph::IdentityGovernance::LifecycleWorkflows::WorkflowTemplates::WorkflowTemplatesRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                ...
                def initialize(path_parameters, request_adapter)
                    super(path_parameters, request_adapter, "{+baseurl}/identityGovernance/lifecycleWorkflows{?%24expand,%24select}")
                end
                ## 
                ...
                def get(request_configuration=nil)
                    ...
                    error_mapping = Hash.new
                    error_mapping["XXX"] = lambda {|pn| MicrosoftGraph::Models::ODataErrorsODataError.create_from_discriminator_value(pn) }
                    return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraph::Models::IdentityGovernanceLifecycleWorkflowsContainer.create_from_discriminator_value(pn) }, error_mapping)
                end
                ## 
                ...
                ## @return a lifecycle_workflows_request_builder
                ## 
                def with_url(raw_url)
                    raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                    return LifecycleWorkflowsRequestBuilder.new(raw_url, @request_adapter)
                end
