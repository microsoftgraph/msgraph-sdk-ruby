...
require_relative '../../../models/identity_governance/task_definition_collection_response'
        ...
        module LifecycleWorkflows
            module TaskDefinitions
                ...
                class TaskDefinitionsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def count()
                        return MicrosoftGraph::IdentityGovernance::LifecycleWorkflows::TaskDefinitions::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ## Provides operations to manage the taskDefinitions property of the microsoft.graph.identityGovernance.lifecycleWorkflowsContainer entity.
                    ## @param task_definition_id Unique identifier of the item
                    ...
                    def by_task_definition_id(task_definition_id)
                        ...
                        return MicrosoftGraph::IdentityGovernance::LifecycleWorkflows::TaskDefinitions::Item::TaskDefinitionItemRequestBuilder.new(url_tpl_params, @request_adapter)
                    end
                    ## 
                    ...
                    ## @return a Fiber of task_definition_collection_response
                    ## 
                    def get(request_configuration=nil)
                        ...
                        return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraph::Models::IdentityGovernance::TaskDefinitionCollectionResponse.create_from_discriminator_value(pn) }, error_mapping)
                    end
                    ## 
                    ## Get a list of the taskDefinition objects and their properties.
                    ## @param request_configuration Configuration for the request such as headers, query parameters, and middleware options.
