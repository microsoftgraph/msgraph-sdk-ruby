                                    ...
                                    module Subject
                                        ...
                                        class SubjectRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                            ...
                                            def service_provisioning_errors()
                                                return MicrosoftGraph::IdentityGovernance::LifecycleWorkflows::WorkflowTemplates::Item::Tasks::Item::TaskProcessingResults::Item::Subject::ServiceProvisioningErrors::ServiceProvisioningErrorsRequestBuilder.new(@path_parameters, @request_adapter)
                                            end
                                            ## 
                                            ...
                                            def initialize(path_parameters, request_adapter)
                                                super(path_parameters, request_adapter, "{+baseurl}/identityGovernance/lifecycleWorkflows/workflowTemplates/{workflowTemplate%2Did}/tasks/{task%2Did}/taskProcessingResults/{taskProcessingResult%2Did}/subject{?%24expand,%24select}")
                                            end
                                            ## 
