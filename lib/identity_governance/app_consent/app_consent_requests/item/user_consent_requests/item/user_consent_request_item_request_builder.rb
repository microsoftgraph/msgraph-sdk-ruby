...
require_relative './approval/approval_request_builder'
require_relative './item'
                ...
                module Item
                    module UserConsentRequests
                        module Item
                            ...
                            class UserConsentRequestItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                
                                ## 
                                # Provides operations to manage the approval property of the microsoft.graph.userConsentRequest entity.
                                def approval()
                                    return MicrosoftGraph::IdentityGovernance::AppConsent::AppConsentRequests::Item::UserConsentRequests::Item::Approval::ApprovalRequestBuilder.new(@path_parameters, @request_adapter)
                                end
                                ## 
                                ...
                                def initialize(path_parameters, request_adapter)
                                    super(path_parameters, request_adapter, "{+baseurl}/identityGovernance/appConsent/appConsentRequests/{appConsentRequest%2Did}/userConsentRequests/{userConsentRequest%2Did}{?%24expand,%24select}")
                                end
                                ## 
                                ...
                                ## @param request_configuration Configuration for the request such as headers, query parameters, and middleware options.
                                ## @return a Fiber of user_consent_request
                                ## 
                                ...
                                def to_delete_request_information(request_configuration=nil)
                                    ...
                                    request_info.url_template = '{+baseurl}/identityGovernance/appConsent/appConsentRequests/{appConsentRequest%2Did}/userConsentRequests/{userConsentRequest%2Did}'
                                ...
                                def with_url(raw_url)
                                    ...
                                    return UserConsentRequestItemRequestBuilder.new(raw_url, @request_adapter)
                                end
