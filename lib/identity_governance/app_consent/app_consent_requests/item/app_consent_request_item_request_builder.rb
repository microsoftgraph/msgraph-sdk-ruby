        ...
        module AppConsent
            module AppConsentRequests
                module Item
                    ...
                    class AppConsentRequestItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        
                        ## 
                        # Provides operations to manage the userConsentRequests property of the microsoft.graph.appConsentRequest entity.
                        def user_consent_requests()
                            return MicrosoftGraph::IdentityGovernance::AppConsent::AppConsentRequests::Item::UserConsentRequests::UserConsentRequestsRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/identityGovernance/appConsent/appConsentRequests/{appConsentRequest%2Did}{?%24expand,%24select}")
                        end
                        ## 
                        ...
                        def to_delete_request_information(request_configuration=nil)
                            ...
                            request_info.url_template = '{+baseurl}/identityGovernance/appConsent/appConsentRequests/{appConsentRequest%2Did}'
                        ...
                        def with_url(raw_url)
                            ...
                            return AppConsentRequestItemRequestBuilder.new(raw_url, @request_adapter)
                        end
