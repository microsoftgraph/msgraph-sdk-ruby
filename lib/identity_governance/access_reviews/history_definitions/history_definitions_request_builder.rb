    ...
    module IdentityGovernance
        module AccessReviews
            module HistoryDefinitions
                ...
                class HistoryDefinitionsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def initialize(path_parameters, request_adapter)
                        super(path_parameters, request_adapter, "{+baseurl}/identityGovernance/accessReviews/historyDefinitions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}")
                    end
                    ## 
                    ## Retrieve the accessReviewHistoryDefinition objects created in the last 30 days, including all nested properties. This API is supported in the following national cloud deployments.
                    ## @param request_configuration Configuration for the request such as headers, query parameters, and middleware options.
                    ## @return a Fiber of access_review_history_definition_collection_response
                    ## 
                    ...
                    ## 
                    ## Create a new accessReviewHistoryDefinition object. This API is supported in the following national cloud deployments.
                    ...
                    ## @return a history_definitions_request_builder
                    ## 
                    def with_url(raw_url)
                        raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                        return HistoryDefinitionsRequestBuilder.new(raw_url, @request_adapter)
                    end
