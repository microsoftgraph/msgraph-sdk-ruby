...
module MicrosoftGraph::IdentityGovernance::AccessReviews::HistoryDefinitions::Item
    ## 
    ...
    class AccessReviewHistoryDefinitionItemRequestBuilder
        ...
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, access_review_history_definition_id=nil)
