...
module MicrosoftGraph::IdentityGovernance::AccessReviews::HistoryDefinitions::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/identityGovernance/accessReviews/historyDefinitions/$count{?%24search,%24filter}"
