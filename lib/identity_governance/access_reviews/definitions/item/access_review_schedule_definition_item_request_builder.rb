...
module MicrosoftGraph::IdentityGovernance::AccessReviews::Definitions::Item
    ...
    class AccessReviewScheduleDefinitionItemRequestBuilder
        ...
        def microsoft_graph_stop()
            return MicrosoftGraph::IdentityGovernance::AccessReviews::Definitions::Item::MicrosoftGraphStop::MicrosoftGraphStopRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/identityGovernance/accessReviews/definitions/{accessReviewScheduleDefinition%2Did}{?%24select,%24expand}"
