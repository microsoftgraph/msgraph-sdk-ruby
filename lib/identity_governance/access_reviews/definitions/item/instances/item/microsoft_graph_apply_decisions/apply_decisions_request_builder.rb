...
require_relative '../item'
require_relative './microsoft_graph_apply_decisions'

module MicrosoftGraph::IdentityGovernance::AccessReviews::Definitions::Item::Instances::Item::MicrosoftGraphApplyDecisions
    ## 
    ...
    class ApplyDecisionsRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/identityGovernance/accessReviews/definitions/{accessReviewScheduleDefinition%2Did}/instances/{accessReviewInstance%2Did}/microsoft.graph.applyDecisions"
