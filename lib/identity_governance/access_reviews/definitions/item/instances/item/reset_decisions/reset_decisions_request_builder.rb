                    ...
                    module Instances
                        module Item
                            module ResetDecisions
                                ...
                                class ResetDecisionsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                    ...
                                    ## @return a reset_decisions_request_builder
                                    ## 
                                    def with_url(raw_url)
                                        raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                                        return ResetDecisionsRequestBuilder.new(raw_url, @request_adapter)
                                    end
                                end
                            end
                        end
