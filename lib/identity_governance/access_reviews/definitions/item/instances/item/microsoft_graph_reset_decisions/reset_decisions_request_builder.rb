...
require_relative '../item'
require_relative './microsoft_graph_reset_decisions'

module MicrosoftGraph::IdentityGovernance::AccessReviews::Definitions::Item::Instances::Item::MicrosoftGraphResetDecisions
    ## 
    ...
    class ResetDecisionsRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/identityGovernance/accessReviews/definitions/{accessReviewScheduleDefinition%2Did}/instances/{accessReviewInstance%2Did}/microsoft.graph.resetDecisions"
