                    ...
                    module Instances
                        module Item
                            module BatchRecordDecisions
                                ...
                                class BatchRecordDecisionsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                    ...
                                    def initialize(path_parameters, request_adapter)
                                        super(path_parameters, request_adapter, "{+baseurl}/identityGovernance/accessReviews/definitions/{accessReviewScheduleDefinition%2Did}/instances/{accessReviewInstance%2Did}/batchRecordDecisions")
                                    end
                                    ## 
                                    ...
                                    ## @return a batch_record_decisions_request_builder
                                    ## 
                                    def with_url(raw_url)
                                        raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                                        return BatchRecordDecisionsRequestBuilder.new(raw_url, @request_adapter)
                                    end
                                end
                            end
                        end
