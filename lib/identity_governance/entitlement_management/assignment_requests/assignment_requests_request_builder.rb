...
require_relative '../../../models/access_package_assignment_request_collection_response'
...
require_relative './item/access_package_assignment_request_item_request_builder'
    ...
    module IdentityGovernance
        module EntitlementManagement
            module AssignmentRequests
                ...
                class AssignmentRequestsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    
                    ## 
                    # Provides operations to count the resources in the collection.
                    def count()
                        return MicrosoftGraph::IdentityGovernance::EntitlementManagement::AssignmentRequests::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ## Provides operations to manage the assignmentRequests property of the microsoft.graph.entitlementManagement entity.
                    ...
                    ## 
                    def by_access_package_assignment_request_id(access_package_assignment_request_id)
                        raise StandardError, 'access_package_assignment_request_id cannot be null' if access_package_assignment_request_id.nil?
                    ...
                    def initialize(path_parameters, request_adapter)
                        super(path_parameters, request_adapter, "{+baseurl}/identityGovernance/entitlementManagement/assignmentRequests{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}")
                    end
                    ## 
                    ...
                    ## @return a Fiber of access_package_assignment_request_collection_response
                    ## 
                    def get(request_configuration=nil)
                        ...
                        return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraph::Models::AccessPackageAssignmentRequestCollectionResponse.create_from_discriminator_value(pn) }, error_mapping)
                    end
                    ## 
                    ...
                    def to_post_request_information(body, request_configuration=nil)
                        ...
                        request_info.url_template = '{+baseurl}/identityGovernance/entitlementManagement/assignmentRequests'
                        request_info.path_parameters = @path_parameters
                    ...
                    ## @return a assignment_requests_request_builder
                    ## 
                    def with_url(raw_url)
                        raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                        return AssignmentRequestsRequestBuilder.new(raw_url, @request_adapter)
                    end
