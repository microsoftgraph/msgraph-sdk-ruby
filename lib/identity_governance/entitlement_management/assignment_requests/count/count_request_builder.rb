...
module MicrosoftGraph::IdentityGovernance::EntitlementManagement::AssignmentRequests::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/identityGovernance/entitlementManagement/assignmentRequests/$count{?%24search,%24filter}"
