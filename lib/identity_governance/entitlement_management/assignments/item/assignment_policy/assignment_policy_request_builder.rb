...
require_relative './assignment_policy'
                    ...
                    module AssignmentPolicy
                        ...
                        class AssignmentPolicyRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            def initialize(path_parameters, request_adapter)
                                super(path_parameters, request_adapter, "{+baseurl}/identityGovernance/entitlementManagement/assignments/{accessPackageAssignment%2Did}/assignmentPolicy{?%24select,%24expand}")
                            end
                            ## 
                            ...
                            ## @return a assignment_policy_request_builder
                            ## 
                            def with_url(raw_url)
                                raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                                return AssignmentPolicyRequestBuilder.new(raw_url, @request_adapter)
                            end
