...
module MicrosoftGraph
    module IdentityGovernance
        module EntitlementManagement
            module Assignments
                module AdditionalAccessWithAccessPackageIdWithIncompatibleAccessPackageId
                    ## 
                    # Provides operations to call the additionalAccess method.
                    class AdditionalAccessWithAccessPackageIdWithIncompatibleAccessPackageIdRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def initialize(path_parameters, request_adapter, access_package_id=nil, incompatible_access_package_id=nil)
                            super(path_parameters, request_adapter, "{+baseurl}/identityGovernance/entitlementManagement/assignments/additionalAccess(accessPackageId='{accessPackageId}',incompatibleAccessPackageId='{incompatibleAccessPackageId}'){?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}")
                        end
                        ## 
                        ## Invoke function additionalAccess
                        ## @param request_configuration Configuration for the request such as headers, query parameters, and middleware options.
                        ## @return a Fiber of additional_access_with_access_package_id_with_incompatible_access_package_idget_response
                        ## 
                        ...
                        def with_url(raw_url)
                            ...
                            return AdditionalAccessWithAccessPackageIdWithIncompatibleAccessPackageIdRequestBuilder.new(raw_url, @request_adapter)
                        end
