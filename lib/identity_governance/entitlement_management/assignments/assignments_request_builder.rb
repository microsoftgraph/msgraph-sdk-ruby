...
require_relative './microsoft_graph_additional_access/microsoft_graph_additional_access_request_builder'
require_relative './microsoft_graph_additional_access_with_access_package_id_with_incompatible_access_package_id/f6f69600f789db359948698551f5ea2b748b0fbe77bd506d8535bd0cd55aaaf6'
            ...
            module Assignments
                ...
                class AssignmentsRequestBuilder
                    ...
                    def microsoft_graph_additional_access()
                        return MicrosoftGraph::IdentityGovernance::EntitlementManagement::Assignments::MicrosoftGraphAdditionalAccess::MicrosoftGraphAdditionalAccessRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ...
                    def initialize(path_parameters, request_adapter)
                        ...
                        @url_template = "{+baseurl}/identityGovernance/entitlementManagement/assignments{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
                    ...
                    ## @return a microsoft_graph_additional_access_with_access_package_id_with_incompatible_access_package_id_request_builder
                    ## 
                    def microsoft_graph_additional_access_with_access_package_id_with_incompatible_access_package_id(access_package_id, incompatible_access_package_id)
                        ...
                        return MicrosoftGraphAdditionalAccessWithAccessPackageIdWithIncompatibleAccessPackageIdRequestBuilder.new(@path_parameters, @request_adapter, accessPackageId, incompatibleAccessPackageId)
                    end
                    ## 
