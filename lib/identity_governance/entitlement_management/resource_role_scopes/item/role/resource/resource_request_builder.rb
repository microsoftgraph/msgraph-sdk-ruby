                    ...
                    module Role
                        module Resource
                            ...
                            class ResourceRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                ...
                                def environment()
                                    return MicrosoftGraph::IdentityGovernance::EntitlementManagement::ResourceRoleScopes::Item::Role::Resource::Environment::EnvironmentRequestBuilder.new(@path_parameters, @request_adapter)
                                end
                                ## 
                                # Provides operations to call the refresh method.
                                def refresh()
                                    return MicrosoftGraph::IdentityGovernance::EntitlementManagement::ResourceRoleScopes::Item::Role::Resource::Refresh::RefreshRequestBuilder.new(@path_parameters, @request_adapter)
                                end
                                ## 
                                # Provides operations to manage the roles property of the microsoft.graph.accessPackageResource entity.
                                def roles()
                                    return MicrosoftGraph::IdentityGovernance::EntitlementManagement::ResourceRoleScopes::Item::Role::Resource::Roles::RolesRequestBuilder.new(@path_parameters, @request_adapter)
                                end
                                ## 
                                # Provides operations to manage the scopes property of the microsoft.graph.accessPackageResource entity.
                                def scopes()
                                    return MicrosoftGraph::IdentityGovernance::EntitlementManagement::ResourceRoleScopes::Item::Role::Resource::Scopes::ScopesRequestBuilder.new(@path_parameters, @request_adapter)
                                end
                                ## 
                                ...
                                def initialize(path_parameters, request_adapter)
                                    super(path_parameters, request_adapter, "{+baseurl}/identityGovernance/entitlementManagement/resourceRoleScopes/{accessPackageResourceRoleScope%2Did}/role/resource{?%24expand,%24select}")
                                end
                                ## 
