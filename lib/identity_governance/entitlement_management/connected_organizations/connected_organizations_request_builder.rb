    ...
    module IdentityGovernance
        module EntitlementManagement
            module ConnectedOrganizations
                ...
                class ConnectedOrganizationsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def initialize(path_parameters, request_adapter)
                        super(path_parameters, request_adapter, "{+baseurl}/identityGovernance/entitlementManagement/connectedOrganizations{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}")
                    end
                    ## 
                    ## Retrieve a list of connectedOrganization objects. This API is supported in the following national cloud deployments.
                    ## @param request_configuration Configuration for the request such as headers, query parameters, and middleware options.
                    ## @return a Fiber of connected_organization_collection_response
                    ## 
                    ...
                    ## 
                    ## Create a new connectedOrganization object. This API is supported in the following national cloud deployments.
                    ...
                    ## @return a connected_organizations_request_builder
                    ## 
                    def with_url(raw_url)
                        raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                        return ConnectedOrganizationsRequestBuilder.new(raw_url, @request_adapter)
                    end
