        ...
        module EntitlementManagement
            module ResourceEnvironments
                module Item
                    ...
                    class AccessPackageResourceEnvironmentItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        
                        ## 
                        # Provides operations to manage the resources property of the microsoft.graph.accessPackageResourceEnvironment entity.
                        def resources()
                            return MicrosoftGraph::IdentityGovernance::EntitlementManagement::ResourceEnvironments::Item::Resources::ResourcesRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/identityGovernance/entitlementManagement/resourceEnvironments/{accessPackageResourceEnvironment%2Did}{?%24expand,%24select}")
                        end
                        ## 
                        ...
                        def to_delete_request_information(request_configuration=nil)
                            ...
                            request_info.url_template = '{+baseurl}/identityGovernance/entitlementManagement/resourceEnvironments/{accessPackageResourceEnvironment%2Did}'
                        ...
                        def with_url(raw_url)
                            ...
                            return AccessPackageResourceEnvironmentItemRequestBuilder.new(raw_url, @request_adapter)
                        end
