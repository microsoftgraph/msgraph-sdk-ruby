                                            ...
                                            module Resource
                                                module Scopes
                                                    ...
                                                    class ScopesRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                                        ...
                                                        def count()
                                                            return MicrosoftGraph::IdentityGovernance::EntitlementManagement::ResourceRequests::Item::Catalog::ResourceScopes::Item::Resource::Roles::Item::Resource::Scopes::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                                                        end
                                                        ## 
                                                        ## Provides operations to manage the scopes property of the microsoft.graph.accessPackageResource entity.
                                                        ...
                                                        def by_access_package_resource_scope_id1(access_package_resource_scope_id1)
                                                            ...
                                                            return MicrosoftGraph::IdentityGovernance::EntitlementManagement::ResourceRequests::Item::Catalog::ResourceScopes::Item::Resource::Roles::Item::Resource::Scopes::Item::AccessPackageResourceScopeItemRequestBuilder.new(url_tpl_params, @request_adapter)
                                                        end
                                                        ## 
                                                        ...
                                                        def to_post_request_information(body, request_configuration=nil)
                                                            ...
                                                            request_info.url_template = '{+baseurl}/identityGovernance/entitlementManagement/resourceRequests/{accessPackageResourceRequest%2Did}/catalog/resourceScopes/{accessPackageResourceScope%2Did}/resource/roles/{accessPackageResourceRole%2Did}/resource/scopes'
                                                            request_info.path_parameters = @path_parameters
