...
module MicrosoftGraph::IdentityGovernance::EntitlementManagement::AssignmentPolicies::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/identityGovernance/entitlementManagement/assignmentPolicies/$count{?%24search,%24filter}"
