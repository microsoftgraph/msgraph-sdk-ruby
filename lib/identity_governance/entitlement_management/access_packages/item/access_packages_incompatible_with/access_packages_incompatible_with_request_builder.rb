    ...
    module IdentityGovernance
        module EntitlementManagement
            module AccessPackages
                module Item
                    module AccessPackagesIncompatibleWith
                        ## 
                        # Provides operations to manage the accessPackagesIncompatibleWith property of the microsoft.graph.accessPackage entity.
                        class AccessPackagesIncompatibleWithRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            def initialize(path_parameters, request_adapter)
                                super(path_parameters, request_adapter, "{+baseurl}/identityGovernance/entitlementManagement/accessPackages/{accessPackage%2Did}/accessPackagesIncompatibleWith{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}")
                            end
                            ## 
                            ...
                            ## @return a access_packages_incompatible_with_request_builder
                            ## 
                            def with_url(raw_url)
                                raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                                return AccessPackagesIncompatibleWithRequestBuilder.new(raw_url, @request_adapter)
                            end
