...
module MicrosoftGraph::IdentityGovernance::EntitlementManagement::AccessPackages::Item::IncompatibleAccessPackages::Item
    ## 
    ...
    class AccessPackageItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, access_package_id1=nil)
            ...
            @url_template = "{+baseurl}/identityGovernance/entitlementManagement/accessPackages/{accessPackage%2Did}/incompatibleAccessPackages/{accessPackage%2Did1}"
