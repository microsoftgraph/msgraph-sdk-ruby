...
require_relative './scope/scope_request_builder'
                    ...
                    module ResourceRoleScopes
                        module Item
                            ...
                            class AccessPackageResourceRoleScopeItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                ...
                                def role()
                                    return MicrosoftGraph::IdentityGovernance::EntitlementManagement::AccessPackages::Item::ResourceRoleScopes::Item::Role::RoleRequestBuilder.new(@path_parameters, @request_adapter)
                                end
                                ## 
                                # Provides operations to manage the scope property of the microsoft.graph.accessPackageResourceRoleScope entity.
                                def scope()
                                    return MicrosoftGraph::IdentityGovernance::EntitlementManagement::AccessPackages::Item::ResourceRoleScopes::Item::Scope::ScopeRequestBuilder.new(@path_parameters, @request_adapter)
                                end
                                ## 
                                ...
                                def initialize(path_parameters, request_adapter)
                                    super(path_parameters, request_adapter, "{+baseurl}/identityGovernance/entitlementManagement/accessPackages/{accessPackage%2Did}/resourceRoleScopes/{accessPackageResourceRoleScope%2Did}{?%24expand,%24select}")
                                end
                                ## 
                                ...
                                def to_delete_request_information(request_configuration=nil)
                                    ...
                                    request_info.url_template = '{+baseurl}/identityGovernance/entitlementManagement/accessPackages/{accessPackage%2Did}/resourceRoleScopes/{accessPackageResourceRoleScope%2Did}'
                                ...
                                def with_url(raw_url)
                                    ...
                                    return AccessPackageResourceRoleScopeItemRequestBuilder.new(raw_url, @request_adapter)
                                end
