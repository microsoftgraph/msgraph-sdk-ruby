...
module MicrosoftGraph::IdentityGovernance::EntitlementManagement::AccessPackages::Item
    ...
    class AccessPackageItemRequestBuilder
        ...
        def microsoft_graph_get_applicable_policy_requirements()
            return MicrosoftGraph::IdentityGovernance::EntitlementManagement::AccessPackages::Item::MicrosoftGraphGetApplicablePolicyRequirements::MicrosoftGraphGetApplicablePolicyRequirementsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
