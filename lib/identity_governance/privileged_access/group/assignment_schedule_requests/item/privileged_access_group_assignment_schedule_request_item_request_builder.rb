            ...
            module Group
                module AssignmentScheduleRequests
                    module Item
                        ...
                        class PrivilegedAccessGroupAssignmentScheduleRequestItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            def activated_using()
                                return MicrosoftGraph::IdentityGovernance::PrivilegedAccess::Group::AssignmentScheduleRequests::Item::ActivatedUsing::ActivatedUsingRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            # Provides operations to call the cancel method.
                            def cancel()
                                return MicrosoftGraph::IdentityGovernance::PrivilegedAccess::Group::AssignmentScheduleRequests::Item::Cancel::CancelRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            ...
                            def group()
                                return MicrosoftGraph::IdentityGovernance::PrivilegedAccess::Group::AssignmentScheduleRequests::Item::Group::GroupRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            ...
                            def principal()
                                return MicrosoftGraph::IdentityGovernance::PrivilegedAccess::Group::AssignmentScheduleRequests::Item::Principal::PrincipalRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            ...
                            def target_schedule()
                                return MicrosoftGraph::IdentityGovernance::PrivilegedAccess::Group::AssignmentScheduleRequests::Item::TargetSchedule::TargetScheduleRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            ...
                            def initialize(path_parameters, request_adapter)
                                super(path_parameters, request_adapter, "{+baseurl}/identityGovernance/privilegedAccess/group/assignmentScheduleRequests/{privilegedAccessGroupAssignmentScheduleRequest%2Did}{?%24expand,%24select}")
                            end
                            ## 
                            ...
                            def get(request_configuration=nil)
                                ...
                                error_mapping = Hash.new
                                error_mapping["XXX"] = lambda {|pn| MicrosoftGraph::Models::ODataErrorsODataError.create_from_discriminator_value(pn) }
                                return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraph::Models::PrivilegedAccessGroupAssignmentScheduleRequest.create_from_discriminator_value(pn) }, error_mapping)
                            end
                            ## 
                            ...
                            def to_delete_request_information(request_configuration=nil)
                                ...
                                request_info.url_template = '{+baseurl}/identityGovernance/privilegedAccess/group/assignmentScheduleRequests/{privilegedAccessGroupAssignmentScheduleRequest%2Did}'
                            ...
                            ## @return a privileged_access_group_assignment_schedule_request_item_request_builder
                            ## 
                            def with_url(raw_url)
                                raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                                return PrivilegedAccessGroupAssignmentScheduleRequestItemRequestBuilder.new(raw_url, @request_adapter)
                            end
