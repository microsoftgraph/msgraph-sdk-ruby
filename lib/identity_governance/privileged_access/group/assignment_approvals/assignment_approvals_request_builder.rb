        ...
        module PrivilegedAccess
            module Group
                module AssignmentApprovals
                    ...
                    class AssignmentApprovalsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        
                        ## 
                        # Provides operations to count the resources in the collection.
                        def count()
                            return MicrosoftGraph::IdentityGovernance::PrivilegedAccess::Group::AssignmentApprovals::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ## Provides operations to manage the assignmentApprovals property of the microsoft.graph.privilegedAccessGroup entity.
                        ...
                        def by_approval_id(approval_id)
                            ...
                            return MicrosoftGraph::IdentityGovernance::PrivilegedAccess::Group::AssignmentApprovals::Item::ApprovalItemRequestBuilder.new(url_tpl_params, @request_adapter)
                        end
                        ## 
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/identityGovernance/privilegedAccess/group/assignmentApprovals{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}")
                        end
                        ## 
                        ...
                        def to_post_request_information(body, request_configuration=nil)
                            ...
                            request_info.url_template = '{+baseurl}/identityGovernance/privilegedAccess/group/assignmentApprovals'
                            request_info.path_parameters = @path_parameters
                        ...
                        ## @return a assignment_approvals_request_builder
                        ## 
                        def with_url(raw_url)
                            raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                            return AssignmentApprovalsRequestBuilder.new(raw_url, @request_adapter)
                        end
