                ...
                module AssignmentApprovals
                    module Item
                        ...
                        class ApprovalItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            def stages()
                                return MicrosoftGraph::IdentityGovernance::PrivilegedAccess::Group::AssignmentApprovals::Item::Stages::StagesRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            ...
                            def initialize(path_parameters, request_adapter)
                                super(path_parameters, request_adapter, "{+baseurl}/identityGovernance/privilegedAccess/group/assignmentApprovals/{approval%2Did}{?%24expand,%24select}")
                            end
                            ## 
                            ...
                            def to_delete_request_information(request_configuration=nil)
                                ...
                                request_info.url_template = '{+baseurl}/identityGovernance/privilegedAccess/group/assignmentApprovals/{approval%2Did}'
                            ...
                            def with_url(raw_url)
                                ...
                                return ApprovalItemRequestBuilder.new(raw_url, @request_adapter)
                            end
