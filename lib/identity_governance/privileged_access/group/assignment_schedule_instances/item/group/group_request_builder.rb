                        ...
                        module Group
                            ...
                            class GroupRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                ...
                                def service_provisioning_errors()
                                    return MicrosoftGraph::IdentityGovernance::PrivilegedAccess::Group::AssignmentScheduleInstances::Item::Group::ServiceProvisioningErrors::ServiceProvisioningErrorsRequestBuilder.new(@path_parameters, @request_adapter)
                                end
                                ## 
                                ...
                                def initialize(path_parameters, request_adapter)
                                    super(path_parameters, request_adapter, "{+baseurl}/identityGovernance/privilegedAccess/group/assignmentScheduleInstances/{privilegedAccessGroupAssignmentScheduleInstance%2Did}/group{?%24expand,%24select}")
                                end
                                ## 
