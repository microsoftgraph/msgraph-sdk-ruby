...
require_relative './item/directory_role_template_item_request_builder'
...
module MicrosoftGraph
    module DirectoryRoleTemplates
        ...
        class DirectoryRoleTemplatesRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
            ...
            def delta()
                return MicrosoftGraph::DirectoryRoleTemplates::Delta::DeltaRequestBuilder.new(@path_parameters, @request_adapter)
            end
            ## 
            ...
            ## 
            def by_directory_role_template_id(directory_role_template_id)
                raise StandardError, 'directory_role_template_id cannot be null' if directory_role_template_id.nil?
            ...
            def initialize(path_parameters, request_adapter)
                super(path_parameters, request_adapter, "{+baseurl}/directoryRoleTemplates{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip}")
            end
            ## 
            ...
            def to_post_request_information(body, request_configuration=nil)
                ...
                request_info.url_template = '{+baseurl}/directoryRoleTemplates'
                request_info.path_parameters = @path_parameters
