...
require_relative '../../../models/pronouns_settings'
    ...
    module Admin
        module People
            module Pronouns
                ...
                class PronounsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def initialize(path_parameters, request_adapter)
                        super(path_parameters, request_adapter, "{+baseurl}/admin/people/pronouns{?%24expand,%24select}")
                    end
                    ## 
                    ...
                    ## @return a Fiber of pronouns_settings
                    ## 
                    def get(request_configuration=nil)
                        ...
                        return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraph::Models::PronounsSettings.create_from_discriminator_value(pn) }, error_mapping)
                    end
                    ## 
                    ...
                    def to_patch_request_information(body, request_configuration=nil)
                        ...
                        request_info.url_template = '{+baseurl}/admin/people/pronouns'
                        request_info.path_parameters = @path_parameters
                    ...
                    ## @return a pronouns_request_builder
                    ## 
                    def with_url(raw_url)
                        raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                        return PronounsRequestBuilder.new(raw_url, @request_adapter)
                    end
