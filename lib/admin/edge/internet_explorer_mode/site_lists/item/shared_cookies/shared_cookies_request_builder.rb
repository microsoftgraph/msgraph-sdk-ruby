...
require_relative '../../../../../../models/browser_shared_cookie_collection_response'
...
require_relative './item/browser_shared_cookie_item_request_builder'
require_relative './shared_cookies'
    ...
    module Admin
        module Edge
            module InternetExplorerMode
                module SiteLists
                    module Item
                        module SharedCookies
                            ## 
                            # Provides operations to manage the sharedCookies property of the microsoft.graph.browserSiteList entity.
                            class SharedCookiesRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                
                                ## 
                                # Provides operations to count the resources in the collection.
                                def count()
                                    return MicrosoftGraph::Admin::Edge::InternetExplorerMode::SiteLists::Item::SharedCookies::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                                end
                                ## 
                                ## Provides operations to manage the sharedCookies property of the microsoft.graph.browserSiteList entity.
                                ...
                                ## 
                                def by_browser_shared_cookie_id(browser_shared_cookie_id)
                                    raise StandardError, 'browser_shared_cookie_id cannot be null' if browser_shared_cookie_id.nil?
                                ...
                                def initialize(path_parameters, request_adapter)
                                    super(path_parameters, request_adapter, "{+baseurl}/admin/edge/internetExplorerMode/siteLists/{browserSiteList%2Did}/sharedCookies{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}")
                                end
                                ## 
                                ...
                                def to_post_request_information(body, request_configuration=nil)
                                    ...
                                    request_info.url_template = '{+baseurl}/admin/edge/internetExplorerMode/siteLists/{browserSiteList%2Did}/sharedCookies'
                                    request_info.path_parameters = @path_parameters
                                ...
                                ## @return a shared_cookies_request_builder
                                ## 
                                def with_url(raw_url)
                                    raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                                    return SharedCookiesRequestBuilder.new(raw_url, @request_adapter)
                                end
