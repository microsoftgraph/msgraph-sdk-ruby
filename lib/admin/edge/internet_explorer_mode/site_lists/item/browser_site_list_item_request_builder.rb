            ...
            module InternetExplorerMode
                module SiteLists
                    module Item
                        ...
                        class BrowserSiteListItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            
                            ## 
                            # Provides operations to call the publish method.
                            def publish()
                                return MicrosoftGraph::Admin::Edge::InternetExplorerMode::SiteLists::Item::Publish::PublishRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            # Provides operations to manage the sharedCookies property of the microsoft.graph.browserSiteList entity.
                            def shared_cookies()
                                return MicrosoftGraph::Admin::Edge::InternetExplorerMode::SiteLists::Item::SharedCookies::SharedCookiesRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            # Provides operations to manage the sites property of the microsoft.graph.browserSiteList entity.
                            def sites()
                                return MicrosoftGraph::Admin::Edge::InternetExplorerMode::SiteLists::Item::Sites::SitesRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            ...
                            def initialize(path_parameters, request_adapter)
                                super(path_parameters, request_adapter, "{+baseurl}/admin/edge/internetExplorerMode/siteLists/{browserSiteList%2Did}{?%24expand,%24select}")
                            end
                            ## 
                            ...
                            def to_delete_request_information(request_configuration=nil)
                                ...
                                request_info.url_template = '{+baseurl}/admin/edge/internetExplorerMode/siteLists/{browserSiteList%2Did}'
