...
require_relative '../../../../../../models/browser_site_collection_response'
...
require_relative './item/browser_site_item_request_builder'
                ...
                module SiteLists
                    module Item
                        module Sites
                            ...
                            class SitesRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                
                                ## 
                                # Provides operations to count the resources in the collection.
                                def count()
                                    return MicrosoftGraph::Admin::Edge::InternetExplorerMode::SiteLists::Item::Sites::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                                end
                                ## 
                                ## Provides operations to manage the sites property of the microsoft.graph.browserSiteList entity.
                                ...
                                ## 
                                def by_browser_site_id(browser_site_id)
                                    raise StandardError, 'browser_site_id cannot be null' if browser_site_id.nil?
                                ...
                                def initialize(path_parameters, request_adapter)
                                    super(path_parameters, request_adapter, "{+baseurl}/admin/edge/internetExplorerMode/siteLists/{browserSiteList%2Did}/sites{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}")
                                end
                                ## 
                                ...
                                def to_post_request_information(body, request_configuration=nil)
                                    ...
                                    request_info.url_template = '{+baseurl}/admin/edge/internetExplorerMode/siteLists/{browserSiteList%2Did}/sites'
                                    request_info.path_parameters = @path_parameters
