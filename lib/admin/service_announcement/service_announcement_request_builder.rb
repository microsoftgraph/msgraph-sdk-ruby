        ...
        module ServiceAnnouncement
            ...
            class ServiceAnnouncementRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def initialize(path_parameters, request_adapter)
                    super(path_parameters, request_adapter, "{+baseurl}/admin/serviceAnnouncement{?%24expand,%24select}")
                end
                ## 
                ...
                def to_delete_request_information(request_configuration=nil)
                    ...
                    request_info.url_template = '{+baseurl}/admin/serviceAnnouncement'
                ...
                ## @return a service_announcement_request_builder
                ## 
                def with_url(raw_url)
                    raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                    return ServiceAnnouncementRequestBuilder.new(raw_url, @request_adapter)
                end
