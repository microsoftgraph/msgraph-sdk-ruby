        ...
        module ServiceAnnouncement
            module Messages
                module Item
                    ...
                    class ServiceUpdateMessageItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/admin/serviceAnnouncement/messages/{serviceUpdateMessage%2Did}{?%24expand,%24select}")
                        end
                        ## 
                        ...
                        def to_delete_request_information(request_configuration=nil)
                            ...
                            request_info.url_template = '{+baseurl}/admin/serviceAnnouncement/messages/{serviceUpdateMessage%2Did}'
                        ...
                        def with_url(raw_url)
                            ...
                            return ServiceUpdateMessageItemRequestBuilder.new(raw_url, @request_adapter)
                        end
