                ...
                module Item
                    module Attachments
                        module Item
                            ...
                            class ServiceAnnouncementAttachmentItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                
                                ## 
                                # Provides operations to manage the media for the admin entity.
                                def content()
                                    return MicrosoftGraph::Admin::ServiceAnnouncement::Messages::Item::Attachments::Item::Content::ContentRequestBuilder.new(@path_parameters, @request_adapter)
                                end
                                ## 
                                ...
                                def initialize(path_parameters, request_adapter)
                                    super(path_parameters, request_adapter, "{+baseurl}/admin/serviceAnnouncement/messages/{serviceUpdateMessage%2Did}/attachments/{serviceAnnouncementAttachment%2Did}{?%24expand,%24select}")
                                end
                                ## 
                                ...
                                def to_delete_request_information(request_configuration=nil)
                                    ...
                                    request_info.url_template = '{+baseurl}/admin/serviceAnnouncement/messages/{serviceUpdateMessage%2Did}/attachments/{serviceAnnouncementAttachment%2Did}'
                                ...
                                def with_url(raw_url)
                                    ...
                                    return ServiceAnnouncementAttachmentItemRequestBuilder.new(raw_url, @request_adapter)
                                end
