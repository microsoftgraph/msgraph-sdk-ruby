...
module MicrosoftGraph::Admin::ServiceAnnouncement::Messages::Item::Attachments::Item
    ## 
    ...
    class ServiceAnnouncementAttachmentItemRequestBuilder
        ...
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, service_announcement_attachment_id=)
