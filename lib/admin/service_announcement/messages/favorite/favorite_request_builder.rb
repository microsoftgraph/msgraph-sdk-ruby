        ...
        module ServiceAnnouncement
            module Messages
                module Favorite
                    ...
                    class FavoriteRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        ## @return a Fiber of favorite_post_response
                        ## 
                        def post(body, request_configuration=nil)
                            ...
                            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraph::Admin::ServiceAnnouncement::Messages::Favorite::FavoritePostResponse.create_from_discriminator_value(pn) }, error_mapping)
                        end
                        ## 
                        ## Change the status of a list of serviceUpdateMessages to favorite for the signed in user. This API is available in the following national cloud deployments.
                        ## @param body The request body
                        ...
                        ## @return a favorite_request_builder
                        ## 
                        def with_url(raw_url)
                            raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                            return FavoriteRequestBuilder.new(raw_url, @request_adapter)
                        end
                    end
                end
            end
