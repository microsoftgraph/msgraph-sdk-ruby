        ...
        module ServiceAnnouncement
            module Issues
                module Item
                    ...
                    class ServiceHealthIssueItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        
                        ## 
                        # Provides operations to call the incidentReport method.
                        def incident_report()
                            return MicrosoftGraph::Admin::ServiceAnnouncement::Issues::Item::IncidentReport::IncidentReportRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/admin/serviceAnnouncement/issues/{serviceHealthIssue%2Did}{?%24expand,%24select}")
                        end
                        ## 
                        ...
                        def to_delete_request_information(request_configuration=nil)
                            ...
                            request_info.url_template = '{+baseurl}/admin/serviceAnnouncement/issues/{serviceHealthIssue%2Did}'
                        ...
                        def with_url(raw_url)
                            ...
                            return ServiceHealthIssueItemRequestBuilder.new(raw_url, @request_adapter)
                        end
