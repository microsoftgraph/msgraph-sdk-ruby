...
module MicrosoftGraph::Admin::ServiceAnnouncement::Issues::Item
    ...
    class ServiceHealthIssueItemRequestBuilder
        ...
        def microsoft_graph_incident_report()
            return MicrosoftGraph::Admin::ServiceAnnouncement::Issues::Item::MicrosoftGraphIncidentReport::MicrosoftGraphIncidentReportRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
