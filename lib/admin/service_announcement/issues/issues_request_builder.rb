...
require_relative './item/service_health_issue_item_request_builder'
    ...
    module Admin
        module ServiceAnnouncement
            module Issues
                ...
                class IssuesRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    
                    ## 
                    # Provides operations to count the resources in the collection.
                    def count()
                        return MicrosoftGraph::Admin::ServiceAnnouncement::Issues::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ## Provides operations to manage the issues property of the microsoft.graph.serviceAnnouncement entity.
                    ...
                    ## 
                    def by_service_health_issue_id(service_health_issue_id)
                        raise StandardError, 'service_health_issue_id cannot be null' if service_health_issue_id.nil?
                    ...
                    def initialize(path_parameters, request_adapter)
                        super(path_parameters, request_adapter, "{+baseurl}/admin/serviceAnnouncement/issues{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}")
                    end
                    ## 
                    ...
                    def to_post_request_information(body, request_configuration=nil)
                        ...
                        request_info.url_template = '{+baseurl}/admin/serviceAnnouncement/issues'
                        request_info.path_parameters = @path_parameters
                    ...
                    ## @return a issues_request_builder
                    ## 
                    def with_url(raw_url)
                        raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                        return IssuesRequestBuilder.new(raw_url, @request_adapter)
                    end
