...
require_relative '../../models/admin_report_settings'
require_relative '../../models/o_data_errors_o_data_error'
require_relative '../admin'
require_relative './report_settings'
...
module MicrosoftGraph
    module Admin
        module ReportSettings
            ...
            class ReportSettingsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def initialize(path_parameters, request_adapter)
                    super(path_parameters, request_adapter, "{+baseurl}/admin/reportSettings{?%24expand,%24select}")
                end
                ## 
                ...
                def get(request_configuration=nil)
                    ...
                    error_mapping = Hash.new
                    error_mapping["XXX"] = lambda {|pn| MicrosoftGraph::Models::ODataErrorsODataError.create_from_discriminator_value(pn) }
                    return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraph::Models::AdminReportSettings.create_from_discriminator_value(pn) }, error_mapping)
                end
                ## 
