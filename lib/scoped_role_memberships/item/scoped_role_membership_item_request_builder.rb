        ...
        module Item
            ...
            class ScopedRoleMembershipItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def initialize(path_parameters, request_adapter)
                    super(path_parameters, request_adapter, "{+baseurl}/scopedRoleMemberships/{scopedRoleMembership%2Did}{?%24expand,%24select}")
                end
                ## 
                ...
                def to_delete_request_information(request_configuration=nil)
                    ...
                    request_info.url_template = '{+baseurl}/scopedRoleMemberships/{scopedRoleMembership%2Did}'
