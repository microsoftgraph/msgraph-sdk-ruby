...
module MicrosoftGraph::RoleManagement::EntitlementManagement::RoleAssignments::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/roleManagement/entitlementManagement/roleAssignments/$count{?%24search,%24filter}"
