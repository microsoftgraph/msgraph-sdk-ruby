...
module MicrosoftGraph::RoleManagement::EntitlementManagement::RoleAssignmentScheduleInstances::Item
    ## 
    ...
    class UnifiedRoleAssignmentScheduleInstanceItemRequestBuilder
        ...
        ## @param unifiedRoleAssignmentScheduleInstanceId key: id of unifiedRoleAssignmentScheduleInstance
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, unified_role_assignment_schedule_instance_id=nil)
            raise StandardError, 'path_parameters cannot be null' if path_parameters.nil?
            raise StandardError, 'request_adapter cannot be null' if request_adapter.nil?
            @url_template = "{+baseurl}/roleManagement/entitlementManagement/roleAssignmentScheduleInstances/{unifiedRoleAssignmentScheduleInstance%2Did}{?%24select,%24expand}"
