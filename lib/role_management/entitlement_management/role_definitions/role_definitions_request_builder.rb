    ...
    module RoleManagement
        module EntitlementManagement
            module RoleDefinitions
                ...
                class RoleDefinitionsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    
                    ## 
                    # Provides operations to count the resources in the collection.
                    def count()
                        return MicrosoftGraph::RoleManagement::EntitlementManagement::RoleDefinitions::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ## Provides operations to manage the roleDefinitions property of the microsoft.graph.rbacApplication entity.
                    ...
                    ## 
                    def by_unified_role_definition_id(unified_role_definition_id)
                        raise StandardError, 'unified_role_definition_id cannot be null' if unified_role_definition_id.nil?
                    ...
                    def initialize(path_parameters, request_adapter)
                        super(path_parameters, request_adapter, "{+baseurl}/roleManagement/entitlementManagement/roleDefinitions{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}")
                    end
                    ## 
                    ...
                    def to_post_request_information(body, request_configuration=nil)
                        ...
                        request_info.url_template = '{+baseurl}/roleManagement/entitlementManagement/roleDefinitions'
                        request_info.path_parameters = @path_parameters
                    ...
                    ## @return a role_definitions_request_builder
                    ## 
                    def with_url(raw_url)
                        raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                        return RoleDefinitionsRequestBuilder.new(raw_url, @request_adapter)
                    end
