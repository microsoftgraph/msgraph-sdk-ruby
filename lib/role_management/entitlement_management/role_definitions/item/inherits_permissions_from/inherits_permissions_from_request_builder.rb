...
require_relative '../../../../../models/unified_role_definition_collection_response'
            ...
            module RoleDefinitions
                module Item
                    module InheritsPermissionsFrom
                        ...
                        class InheritsPermissionsFromRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            
                            ## 
                            # Provides operations to count the resources in the collection.
                            def count()
                                return MicrosoftGraph::RoleManagement::EntitlementManagement::RoleDefinitions::Item::InheritsPermissionsFrom::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            ## Provides operations to manage the inheritsPermissionsFrom property of the microsoft.graph.unifiedRoleDefinition entity.
                            ...
                            def by_unified_role_definition_id1(unified_role_definition_id1)
                                ...
                                return MicrosoftGraph::RoleManagement::EntitlementManagement::RoleDefinitions::Item::InheritsPermissionsFrom::Item::UnifiedRoleDefinitionItemRequestBuilder.new(url_tpl_params, @request_adapter)
                            end
                            ## 
                            ...
                            def initialize(path_parameters, request_adapter)
                                super(path_parameters, request_adapter, "{+baseurl}/roleManagement/entitlementManagement/roleDefinitions/{unifiedRoleDefinition%2Did}/inheritsPermissionsFrom{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}")
                            end
                            ## 
                            ...
                            ## @return a Fiber of unified_role_definition_collection_response
                            ## 
                            def get(request_configuration=nil)
                                ...
                                return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraph::Models::UnifiedRoleDefinitionCollectionResponse.create_from_discriminator_value(pn) }, error_mapping)
                            end
                            ## 
                            ...
                            def to_post_request_information(body, request_configuration=nil)
                                ...
                                request_info.url_template = '{+baseurl}/roleManagement/entitlementManagement/roleDefinitions/{unifiedRoleDefinition%2Did}/inheritsPermissionsFrom'
                                request_info.path_parameters = @path_parameters
                            ...
                            ## @return a inherits_permissions_from_request_builder
                            ## 
                            def with_url(raw_url)
                                raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                                return InheritsPermissionsFromRequestBuilder.new(raw_url, @request_adapter)
                            end
