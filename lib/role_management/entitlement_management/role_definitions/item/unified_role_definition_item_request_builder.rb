...
module MicrosoftGraph::RoleManagement::EntitlementManagement::RoleDefinitions::Item
    ## 
    ...
    class UnifiedRoleDefinitionItemRequestBuilder
        ...
        def inherits_permissions_from()
            return MicrosoftGraph::RoleManagement::EntitlementManagement::RoleDefinitions::Item::InheritsPermissionsFrom::InheritsPermissionsFromRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, unified_role_definition_id=)
            raise StandardError, 'path_parameters cannot be null' if path_parameters.nil?
            raise StandardError, 'request_adapter cannot be null' if request_adapter.nil?
            @url_template = "{+baseurl}/roleManagement/entitlementManagement/roleDefinitions/{unifiedRoleDefinition%2Did}{?%24select,%24expand}"
