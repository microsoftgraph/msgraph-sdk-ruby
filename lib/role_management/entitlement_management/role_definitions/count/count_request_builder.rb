...
module MicrosoftGraph::RoleManagement::EntitlementManagement::RoleDefinitions::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/roleManagement/entitlementManagement/roleDefinitions/$count{?%24search,%24filter}"
