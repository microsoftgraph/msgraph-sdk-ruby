...
module MicrosoftGraph::RoleManagement::EntitlementManagement::RoleAssignmentSchedules::Item
    ## 
    ...
    class UnifiedRoleAssignmentScheduleItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, unified_role_assignment_schedule_id=nil)
            ...
            @url_template = "{+baseurl}/roleManagement/entitlementManagement/roleAssignmentSchedules/{unifiedRoleAssignmentSchedule%2Did}{?%24select,%24expand}"
