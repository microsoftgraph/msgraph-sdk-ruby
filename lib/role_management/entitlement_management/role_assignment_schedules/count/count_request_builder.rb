...
module MicrosoftGraph::RoleManagement::EntitlementManagement::RoleAssignmentSchedules::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/roleManagement/entitlementManagement/roleAssignmentSchedules/$count{?%24search,%24filter}"
