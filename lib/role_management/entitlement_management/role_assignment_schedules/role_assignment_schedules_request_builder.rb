...
require_relative '../../../models/unified_role_assignment_schedule_collection_response'
...
require_relative './item/unified_role_assignment_schedule_item_request_builder'
    ...
    module RoleManagement
        module EntitlementManagement
            module RoleAssignmentSchedules
                ...
                class RoleAssignmentSchedulesRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    
                    ## 
                    # Provides operations to count the resources in the collection.
                    def count()
                        return MicrosoftGraph::RoleManagement::EntitlementManagement::RoleAssignmentSchedules::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ## Provides operations to manage the roleAssignmentSchedules property of the microsoft.graph.rbacApplication entity.
                    ...
                    ## 
                    def by_unified_role_assignment_schedule_id(unified_role_assignment_schedule_id)
                        raise StandardError, 'unified_role_assignment_schedule_id cannot be null' if unified_role_assignment_schedule_id.nil?
                    ...
                    def initialize(path_parameters, request_adapter)
                        super(path_parameters, request_adapter, "{+baseurl}/roleManagement/entitlementManagement/roleAssignmentSchedules{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}")
                    end
                    ## 
                    ...
                    def to_post_request_information(body, request_configuration=nil)
                        ...
                        request_info.url_template = '{+baseurl}/roleManagement/entitlementManagement/roleAssignmentSchedules'
                        request_info.path_parameters = @path_parameters
                    ...
                    ## @return a role_assignment_schedules_request_builder
                    ## 
                    def with_url(raw_url)
                        raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                        return RoleAssignmentSchedulesRequestBuilder.new(raw_url, @request_adapter)
                    end
