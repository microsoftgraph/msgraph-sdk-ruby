        ...
        module EntitlementManagement
            module RoleEligibilityScheduleRequests
                module Item
                    ...
                    class UnifiedRoleEligibilityScheduleRequestItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def principal()
                            return MicrosoftGraph::RoleManagement::EntitlementManagement::RoleEligibilityScheduleRequests::Item::Principal::PrincipalRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ...
                        def role_definition()
                            return MicrosoftGraph::RoleManagement::EntitlementManagement::RoleEligibilityScheduleRequests::Item::RoleDefinition::RoleDefinitionRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ...
                        def target_schedule()
                            return MicrosoftGraph::RoleManagement::EntitlementManagement::RoleEligibilityScheduleRequests::Item::TargetSchedule::TargetScheduleRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/roleManagement/entitlementManagement/roleEligibilityScheduleRequests/{unifiedRoleEligibilityScheduleRequest%2Did}{?%24expand,%24select}")
                        end
                        ## 
                        ...
                        def to_delete_request_information(request_configuration=nil)
                            ...
                            request_info.url_template = '{+baseurl}/roleManagement/entitlementManagement/roleEligibilityScheduleRequests/{unifiedRoleEligibilityScheduleRequest%2Did}'
                        ...
                        def with_url(raw_url)
                            ...
                            return UnifiedRoleEligibilityScheduleRequestItemRequestBuilder.new(raw_url, @request_adapter)
                        end
