...
module MicrosoftGraph::RoleManagement::EntitlementManagement::RoleEligibilityScheduleRequests::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/roleManagement/entitlementManagement/roleEligibilityScheduleRequests/$count{?%24search,%24filter}"
