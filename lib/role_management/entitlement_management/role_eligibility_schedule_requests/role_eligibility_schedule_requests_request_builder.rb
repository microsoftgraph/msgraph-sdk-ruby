...
require_relative '../../../models/unified_role_eligibility_schedule_request_collection_response'
    ...
    module RoleManagement
        module EntitlementManagement
            module RoleEligibilityScheduleRequests
                ...
                class RoleEligibilityScheduleRequestsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    
                    ## 
                    # Provides operations to count the resources in the collection.
                    def count()
                        return MicrosoftGraph::RoleManagement::EntitlementManagement::RoleEligibilityScheduleRequests::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ## Provides operations to manage the roleEligibilityScheduleRequests property of the microsoft.graph.rbacApplication entity.
                    ...
                    def initialize(path_parameters, request_adapter)
                        super(path_parameters, request_adapter, "{+baseurl}/roleManagement/entitlementManagement/roleEligibilityScheduleRequests{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}")
                    end
                    ## 
                    ...
                    def to_post_request_information(body, request_configuration=nil)
                        ...
                        request_info.url_template = '{+baseurl}/roleManagement/entitlementManagement/roleEligibilityScheduleRequests'
                        request_info.path_parameters = @path_parameters
                    ...
                    ## @return a role_eligibility_schedule_requests_request_builder
                    ## 
                    def with_url(raw_url)
                        raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                        return RoleEligibilityScheduleRequestsRequestBuilder.new(raw_url, @request_adapter)
                    end
