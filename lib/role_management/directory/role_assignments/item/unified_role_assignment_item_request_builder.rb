            ...
            module RoleAssignments
                module Item
                    ...
                    class UnifiedRoleAssignmentItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def app_scope()
                            return MicrosoftGraph::RoleManagement::Directory::RoleAssignments::Item::AppScope::AppScopeRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        # Provides operations to manage the directoryScope property of the microsoft.graph.unifiedRoleAssignment entity.
                        def directory_scope()
                            return MicrosoftGraph::RoleManagement::Directory::RoleAssignments::Item::DirectoryScope::DirectoryScopeRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        # Provides operations to manage the principal property of the microsoft.graph.unifiedRoleAssignment entity.
                        def principal()
                            return MicrosoftGraph::RoleManagement::Directory::RoleAssignments::Item::Principal::PrincipalRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        # Provides operations to manage the roleDefinition property of the microsoft.graph.unifiedRoleAssignment entity.
                        def role_definition()
                            return MicrosoftGraph::RoleManagement::Directory::RoleAssignments::Item::RoleDefinition::RoleDefinitionRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/roleManagement/directory/roleAssignments/{unifiedRoleAssignment%2Did}{?%24expand,%24select}")
                        end
                        ## 
                        ...
                        def to_delete_request_information(request_configuration=nil)
                            ...
                            request_info.url_template = '{+baseurl}/roleManagement/directory/roleAssignments/{unifiedRoleAssignment%2Did}'
