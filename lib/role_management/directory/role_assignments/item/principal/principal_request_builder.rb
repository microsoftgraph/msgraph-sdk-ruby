...
module MicrosoftGraph::RoleManagement::Directory::RoleAssignments::Item::Principal
    ## 
    ...
    class PrincipalRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/roleManagement/directory/roleAssignments/{unifiedRoleAssignment%2Did}/principal{?%24select,%24expand}"
