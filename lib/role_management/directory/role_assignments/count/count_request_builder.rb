...
module MicrosoftGraph::RoleManagement::Directory::RoleAssignments::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/roleManagement/directory/roleAssignments/$count{?%24search,%24filter}"
