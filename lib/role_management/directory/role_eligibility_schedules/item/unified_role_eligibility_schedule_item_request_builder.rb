...
require_relative '../../../../models/unified_role_eligibility_schedule'
...
module MicrosoftGraph
    module RoleManagement
        module Directory
            module RoleEligibilitySchedules
                module Item
                    ## 
                    ...
                    class UnifiedRoleEligibilityScheduleItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def app_scope()
                            return MicrosoftGraph::RoleManagement::Directory::RoleEligibilitySchedules::Item::AppScope::AppScopeRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        # Provides operations to manage the directoryScope property of the microsoft.graph.unifiedRoleScheduleBase entity.
                        def directory_scope()
                            return MicrosoftGraph::RoleManagement::Directory::RoleEligibilitySchedules::Item::DirectoryScope::DirectoryScopeRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        # Provides operations to manage the principal property of the microsoft.graph.unifiedRoleScheduleBase entity.
                        def principal()
                            return MicrosoftGraph::RoleManagement::Directory::RoleEligibilitySchedules::Item::Principal::PrincipalRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        # Provides operations to manage the roleDefinition property of the microsoft.graph.unifiedRoleScheduleBase entity.
                        def role_definition()
                            return MicrosoftGraph::RoleManagement::Directory::RoleEligibilitySchedules::Item::RoleDefinition::RoleDefinitionRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/roleManagement/directory/roleEligibilitySchedules/{unifiedRoleEligibilitySchedule%2Did}{?%24expand,%24select}")
                        end
                        ## 
                        ...
                        def get(request_configuration=nil)
                            ...
                            error_mapping = Hash.new
                            error_mapping["XXX"] = lambda {|pn| MicrosoftGraph::Models::ODataErrorsODataError.create_from_discriminator_value(pn) }
                            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraph::Models::UnifiedRoleEligibilitySchedule.create_from_discriminator_value(pn) }, error_mapping)
                        end
                        ## 
                        ...
                        def to_delete_request_information(request_configuration=nil)
                            ...
                            request_info.url_template = '{+baseurl}/roleManagement/directory/roleEligibilitySchedules/{unifiedRoleEligibilitySchedule%2Did}'
                        ...
                        def with_url(raw_url)
                            ...
                            return UnifiedRoleEligibilityScheduleItemRequestBuilder.new(raw_url, @request_adapter)
                        end
