                ...
                module Item
                    ...
                    class UnifiedRbacResourceNamespaceItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def resource_actions()
                            return MicrosoftGraph::RoleManagement::Directory::ResourceNamespaces::Item::ResourceActions::ResourceActionsRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/roleManagement/directory/resourceNamespaces/{unifiedRbacResourceNamespace%2Did}{?%24expand,%24select}")
                        end
                        ## 
                        ...
                        def to_delete_request_information(request_configuration=nil)
                            ...
                            request_info.url_template = '{+baseurl}/roleManagement/directory/resourceNamespaces/{unifiedRbacResourceNamespace%2Did}'
                        ...
                        def with_url(raw_url)
                            ...
                            return UnifiedRbacResourceNamespaceItemRequestBuilder.new(raw_url, @request_adapter)
                        end
