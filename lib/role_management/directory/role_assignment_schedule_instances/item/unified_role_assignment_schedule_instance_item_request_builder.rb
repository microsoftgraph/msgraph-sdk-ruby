...
module MicrosoftGraph::RoleManagement::Directory::RoleAssignmentScheduleInstances::Item
    ## 
    ...
    class UnifiedRoleAssignmentScheduleInstanceItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, unified_role_assignment_schedule_instance_id=nil)
            ...
            @url_template = "{+baseurl}/roleManagement/directory/roleAssignmentScheduleInstances/{unifiedRoleAssignmentScheduleInstance%2Did}{?%24select,%24expand}"
