                ...
                module Item
                    ...
                    class UnifiedRoleEligibilityScheduleRequestItemRequestBuilder
                        ...
                        def microsoft_graph_cancel()
                            return MicrosoftGraph::RoleManagement::Directory::RoleEligibilityScheduleRequests::Item::MicrosoftGraphCancel::MicrosoftGraphCancelRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
