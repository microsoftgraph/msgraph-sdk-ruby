...
module MicrosoftGraph::RoleManagement::Directory::RoleEligibilityScheduleRequests::Item::MicrosoftGraphCancel
    ## 
    ...
    class MicrosoftGraphCancelRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/roleManagement/directory/roleEligibilityScheduleRequests/{unifiedRoleEligibilityScheduleRequest%2Did}/microsoft.graph.cancel"
