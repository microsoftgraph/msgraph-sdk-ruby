...
module MicrosoftGraph::RoleManagement::Directory::RoleEligibilityScheduleRequests::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/roleManagement/directory/roleEligibilityScheduleRequests/$count{?%24search,%24filter}"
