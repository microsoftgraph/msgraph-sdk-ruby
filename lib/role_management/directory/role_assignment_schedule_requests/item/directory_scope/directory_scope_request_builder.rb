...
module MicrosoftGraph::RoleManagement::Directory::RoleAssignmentScheduleRequests::Item::DirectoryScope
    ## 
    ...
    class DirectoryScopeRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/roleManagement/directory/roleAssignmentScheduleRequests/{unifiedRoleAssignmentScheduleRequest%2Did}/directoryScope{?%24select,%24expand}"
