...
module MicrosoftGraph::RoleManagement::Directory::RoleAssignmentScheduleRequests::Item
    ## 
    ...
    class UnifiedRoleAssignmentScheduleRequestItemRequestBuilder
        ...
        def microsoft_graph_cancel()
            return MicrosoftGraph::RoleManagement::Directory::RoleAssignmentScheduleRequests::Item::MicrosoftGraphCancel::MicrosoftGraphCancelRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
