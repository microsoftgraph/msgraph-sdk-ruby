...
module MicrosoftGraph::RoleManagement::Directory::RoleAssignmentScheduleRequests::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/roleManagement/directory/roleAssignmentScheduleRequests/$count{?%24search,%24filter}"
