...
module MicrosoftGraph::RoleManagement::Directory::RoleDefinitions::Item::InheritsPermissionsFrom::Item
    ## 
    ...
    class UnifiedRoleDefinitionItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, unified_role_definition_id1=nil)
            ...
            @url_template = "{+baseurl}/roleManagement/directory/roleDefinitions/{unifiedRoleDefinition%2Did}/inheritsPermissionsFrom/{unifiedRoleDefinition%2Did1}{?%24select,%24expand}"
