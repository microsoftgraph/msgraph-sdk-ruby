                ...
                module Item
                    ...
                    class UnifiedRoleDefinitionItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def inherits_permissions_from()
                            return MicrosoftGraph::RoleManagement::Directory::RoleDefinitions::Item::InheritsPermissionsFrom::InheritsPermissionsFromRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/roleManagement/directory/roleDefinitions/{unifiedRoleDefinition%2Did}{?%24expand,%24select}")
                        end
                        ## 
                        ...
                        def to_delete_request_information(request_configuration=nil)
                            ...
                            request_info.url_template = '{+baseurl}/roleManagement/directory/roleDefinitions/{unifiedRoleDefinition%2Did}'
