...
require_relative './directory_roles_with_role_template_id'

module MicrosoftGraph
    module DirectoryRolesWithRoleTemplateId
        ## 
        # Provides operations to manage the collection of directoryRole entities.
        class DirectoryRolesWithRoleTemplateIdRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
            ...
            def to_delete_request_information(request_configuration=nil)
                ...
                request_info.url_template = '{+baseurl}/directoryRoles(roleTemplateId='{roleTemplateId}')'
