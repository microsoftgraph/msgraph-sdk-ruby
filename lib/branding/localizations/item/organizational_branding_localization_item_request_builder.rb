...
module MicrosoftGraph::Branding::Localizations::Item
    ## 
    ...
    class OrganizationalBrandingLocalizationItemRequestBuilder
        ...
        def background_image()
            return MicrosoftGraph::Branding::Localizations::Item::BackgroundImage::BackgroundImageRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the media for the organizationalBranding entity.
        def banner_logo()
