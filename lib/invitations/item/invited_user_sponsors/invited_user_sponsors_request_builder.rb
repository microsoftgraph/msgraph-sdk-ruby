...
require_relative './invited_user_sponsors'
require_relative './item/directory_object_item_request_builder'

module MicrosoftGraph
    module Invitations
        module Item
            module InvitedUserSponsors
                ## 
                # Provides operations to manage the invitedUserSponsors property of the microsoft.graph.invitation entity.
                class InvitedUserSponsorsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    
                    ## 
                    # Provides operations to count the resources in the collection.
                    def count()
                        return MicrosoftGraph::Invitations::Item::InvitedUserSponsors::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ## Provides operations to manage the invitedUserSponsors property of the microsoft.graph.invitation entity.
                    ...
                    def by_directory_object_id(directory_object_id)
                        ...
                        return MicrosoftGraph::Invitations::Item::InvitedUserSponsors::Item::DirectoryObjectItemRequestBuilder.new(url_tpl_params, @request_adapter)
                    end
                    ## 
                    ...
                    def initialize(path_parameters, request_adapter)
                        super(path_parameters, request_adapter, "{+baseurl}/invitations/{invitation%2Did}/invitedUserSponsors{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}")
                    end
                    ## 
                    ...
                    ## @return a invited_user_sponsors_request_builder
                    ## 
                    def with_url(raw_url)
                        raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                        return InvitedUserSponsorsRequestBuilder.new(raw_url, @request_adapter)
                    end
