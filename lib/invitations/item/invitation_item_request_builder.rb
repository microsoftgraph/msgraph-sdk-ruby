...
module MicrosoftGraph
    module Invitations
        module Item
            ...
            class InvitationItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                
                ## 
                # Provides operations to manage the invitedUser property of the microsoft.graph.invitation entity.
                def invited_user()
                    return MicrosoftGraph::Invitations::Item::InvitedUser::InvitedUserRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                ...
                def invited_user_sponsors()
                    return MicrosoftGraph::Invitations::Item::InvitedUserSponsors::InvitedUserSponsorsRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                ...
                def initialize(path_parameters, request_adapter)
                    super(path_parameters, request_adapter, "{+baseurl}/invitations/{invitation%2Did}{?%24expand,%24select}")
                end
                ## 
                ...
                def to_delete_request_information(request_configuration=nil)
                    ...
                    request_info.url_template = '{+baseurl}/invitations/{invitation%2Did}'
                ...
                def with_url(raw_url)
                    ...
                    return InvitationItemRequestBuilder.new(raw_url, @request_adapter)
                end
