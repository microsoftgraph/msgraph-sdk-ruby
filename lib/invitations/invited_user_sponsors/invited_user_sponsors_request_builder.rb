    ...
    module Invitations
        module InvitedUserSponsors
            ...
            class InvitedUserSponsorsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def count()
                    return MicrosoftGraph::Invitations::InvitedUserSponsors::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                ## Provides operations to manage the invitedUserSponsors property of the microsoft.graph.invitation entity.
                ...
                def by_directory_object_id(directory_object_id)
                    ...
                    return MicrosoftGraph::Invitations::InvitedUserSponsors::Item::DirectoryObjectItemRequestBuilder.new(url_tpl_params, @request_adapter)
                end
                ## 
                ...
                def initialize(path_parameters, request_adapter)
                    super(path_parameters, request_adapter, "{+baseurl}/invitations/invitedUserSponsors{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}")
                end
                ## 
