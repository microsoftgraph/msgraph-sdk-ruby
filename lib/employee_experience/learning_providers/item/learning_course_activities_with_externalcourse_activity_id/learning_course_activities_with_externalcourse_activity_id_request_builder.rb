...
require_relative './learning_course_activities_with_externalcourse_activity_id'

module MicrosoftGraph
    module EmployeeExperience
        module LearningProviders
            module Item
                module LearningCourseActivitiesWithExternalcourseActivityId
                    ## 
                    # Provides operations to manage the learningCourseActivities property of the microsoft.graph.learningProvider entity.
                    class LearningCourseActivitiesWithExternalcourseActivityIdRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        ## @return a void
                        ## 
                        def initialize(path_parameters, request_adapter, externalcourse_activity_id=nil)
                            super(path_parameters, request_adapter, "{+baseurl}/employeeExperience/learningProviders/{learningProvider%2Did}/learningCourseActivities(externalcourseActivityId='{externalcourseActivityId}'){?%24expand,%24select}")
                        end
                        ## 
                        ...
                        def to_delete_request_information(request_configuration=nil)
                            ...
                            request_info.url_template = '{+baseurl}/employeeExperience/learningProviders/{learningProvider%2Did}/learningCourseActivities(externalcourseActivityId='{externalcourseActivityId}')'
                        ...
                        def with_url(raw_url)
                            ...
                            return LearningCourseActivitiesWithExternalcourseActivityIdRequestBuilder.new(raw_url, @request_adapter)
                        end
