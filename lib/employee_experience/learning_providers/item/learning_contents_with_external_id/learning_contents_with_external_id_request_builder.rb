...
require_relative './learning_contents_with_external_id'

module MicrosoftGraph
    module EmployeeExperience
        module LearningProviders
            module Item
                module LearningContentsWithExternalId
                    ## 
                    # Provides operations to manage the learningContents property of the microsoft.graph.learningProvider entity.
                    class LearningContentsWithExternalIdRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        ## @return a void
                        ## 
                        def initialize(path_parameters, request_adapter, external_id=nil)
                            super(path_parameters, request_adapter, "{+baseurl}/employeeExperience/learningProviders/{learningProvider%2Did}/learningContents(externalId='{externalId}'){?%24expand,%24select}")
                        end
                        ## 
                        ...
                        def to_delete_request_information(request_configuration=nil)
                            ...
                            request_info.url_template = '{+baseurl}/employeeExperience/learningProviders/{learningProvider%2Did}/learningContents(externalId='{externalId}')'
                        ...
                        def with_url(raw_url)
                            ...
                            return LearningContentsWithExternalIdRequestBuilder.new(raw_url, @request_adapter)
                        end
