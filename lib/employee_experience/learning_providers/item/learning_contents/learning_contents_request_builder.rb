...
require_relative '../../../../models/learning_content'
require_relative '../../../../models/learning_content_collection_response'
...
module MicrosoftGraph
    module EmployeeExperience
        module LearningProviders
            module Item
                module LearningContents
                    ## 
                    # Provides operations to manage the learningContents property of the microsoft.graph.learningProvider entity.
                    class LearningContentsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/employeeExperience/learningProviders/{learningProvider%2Did}/learningContents{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}")
                        end
                        ## 
                        ...
                        def get(request_configuration=nil)
                            ...
                            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraph::Models::LearningContentCollectionResponse.create_from_discriminator_value(pn) }, error_mapping)
                        end
                        ## 
                        ## Create new navigation property to learningContents for employeeExperience
                        ## @param body The request body
                        ## @param request_configuration Configuration for the request such as headers, query parameters, and middleware options.
                        ## @return a Fiber of learning_content
                        ## 
                        ...
                        def to_post_request_information(body, request_configuration=nil)
                            ...
                            request_info.url_template = '{+baseurl}/employeeExperience/learningProviders/{learningProvider%2Did}/learningContents'
                            request_info.path_parameters = @path_parameters
                        ...
                        ## @return a learning_contents_request_builder
                        ## 
                        def with_url(raw_url)
                            raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                            return LearningContentsRequestBuilder.new(raw_url, @request_adapter)
                        end
