    ...
    module EmployeeExperience
        module LearningCourseActivities
            ...
            class LearningCourseActivitiesRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def count()
                    return MicrosoftGraph::EmployeeExperience::LearningCourseActivities::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                ## Provides operations to manage the learningCourseActivities property of the microsoft.graph.employeeExperience entity.
                ...
                def by_learning_course_activity_id(learning_course_activity_id)
                    ...
                    return MicrosoftGraph::EmployeeExperience::LearningCourseActivities::Item::LearningCourseActivityItemRequestBuilder.new(url_tpl_params, @request_adapter)
                end
                ## 
                ...
                def initialize(path_parameters, request_adapter)
                    super(path_parameters, request_adapter, "{+baseurl}/employeeExperience/learningCourseActivities{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}")
                end
                ## 
                ...
                def to_post_request_information(body, request_configuration=nil)
                    ...
                    request_info.url_template = '{+baseurl}/employeeExperience/learningCourseActivities'
                    request_info.path_parameters = @path_parameters
