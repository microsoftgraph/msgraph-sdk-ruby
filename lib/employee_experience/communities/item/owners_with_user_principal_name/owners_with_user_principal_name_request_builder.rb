...
require_relative './owners_with_user_principal_name'

module MicrosoftGraph
    module EmployeeExperience
        module Communities
            module Item
                module OwnersWithUserPrincipalName
                    ## 
                    # Provides operations to manage the owners property of the microsoft.graph.community entity.
                    class OwnersWithUserPrincipalNameRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def initialize(path_parameters, request_adapter, user_principal_name=nil)
                            super(path_parameters, request_adapter, "{+baseurl}/employeeExperience/communities/{community%2Did}/owners(userPrincipalName='{userPrincipalName}'){?%24expand,%24select}")
                        end
                        ## 
                        ...
                        def with_url(raw_url)
                            ...
                            return OwnersWithUserPrincipalNameRequestBuilder.new(raw_url, @request_adapter)
                        end
