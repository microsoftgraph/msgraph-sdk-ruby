            ...
            module Item
                module Owners
                    ...
                    class OwnersRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def count()
                            return MicrosoftGraph::EmployeeExperience::Communities::Item::Owners::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ## Provides operations to manage the owners property of the microsoft.graph.community entity.
                        ...
                        def by_user_id(user_id)
                            ...
                            return MicrosoftGraph::EmployeeExperience::Communities::Item::Owners::Item::UserItemRequestBuilder.new(url_tpl_params, @request_adapter)
                        end
                        ## 
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/employeeExperience/communities/{community%2Did}/owners{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}")
                        end
                        ## 
