    ...
    module DeviceAppManagement
        module MobileAppConfigurations
            module Item
                ...
                class ManagedDeviceMobileAppConfigurationItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def initialize(path_parameters, request_adapter)
                        super(path_parameters, request_adapter, "{+baseurl}/deviceAppManagement/mobileAppConfigurations/{managedDeviceMobileAppConfiguration%2Did}{?%24expand,%24select}")
                    end
                    ## 
                    ...
                    def to_delete_request_information(request_configuration=nil)
                        ...
                        request_info.url_template = '{+baseurl}/deviceAppManagement/mobileAppConfigurations/{managedDeviceMobileAppConfiguration%2Did}'
                    ...
                    def with_url(raw_url)
                        ...
                        return ManagedDeviceMobileAppConfigurationItemRequestBuilder.new(raw_url, @request_adapter)
                    end
