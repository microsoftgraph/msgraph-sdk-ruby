...
module MicrosoftGraph::DeviceAppManagement::MobileAppConfigurations::Item
    ## 
    ...
    class ManagedDeviceMobileAppConfigurationItemRequestBuilder
        ...
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, managed_device_mobile_app_configuration_id=nil)
