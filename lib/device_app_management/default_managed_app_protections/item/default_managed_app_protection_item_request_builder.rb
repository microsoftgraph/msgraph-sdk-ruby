...
module MicrosoftGraph::DeviceAppManagement::DefaultManagedAppProtections::Item
    ## 
    ...
    class DefaultManagedAppProtectionItemRequestBuilder
        ...
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, default_managed_app_protection_id=)
