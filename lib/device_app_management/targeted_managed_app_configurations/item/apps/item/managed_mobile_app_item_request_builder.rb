...
module MicrosoftGraph::DeviceAppManagement::TargetedManagedAppConfigurations::Item::Apps::Item
    ...
    class ManagedMobileAppItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, managed_mobile_app_id=nil)
            ...
            @url_template = "{+baseurl}/deviceAppManagement/targetedManagedAppConfigurations/{targetedManagedAppConfiguration%2Did}/apps/{managedMobileApp%2Did}{?%24select,%24expand}"
