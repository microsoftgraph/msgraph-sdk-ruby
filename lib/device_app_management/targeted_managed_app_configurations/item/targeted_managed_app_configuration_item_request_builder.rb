    ...
    module DeviceAppManagement
        module TargetedManagedAppConfigurations
            module Item
                ...
                class TargetedManagedAppConfigurationItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def assign()
                        return MicrosoftGraph::DeviceAppManagement::TargetedManagedAppConfigurations::Item::Assign::AssignRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ...
                    def initialize(path_parameters, request_adapter)
                        super(path_parameters, request_adapter, "{+baseurl}/deviceAppManagement/targetedManagedAppConfigurations/{targetedManagedAppConfiguration%2Did}{?%24expand,%24select}")
                    end
                    ## 
                    ...
                    def to_delete_request_information(request_configuration=nil)
                        ...
                        request_info.url_template = '{+baseurl}/deviceAppManagement/targetedManagedAppConfigurations/{targetedManagedAppConfiguration%2Did}'
                    ...
                    def with_url(raw_url)
                        ...
                        return TargetedManagedAppConfigurationItemRequestBuilder.new(raw_url, @request_adapter)
                    end
