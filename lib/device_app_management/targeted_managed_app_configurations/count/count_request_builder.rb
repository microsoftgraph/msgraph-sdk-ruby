...
module MicrosoftGraph::DeviceAppManagement::TargetedManagedAppConfigurations::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/deviceAppManagement/targetedManagedAppConfigurations/$count{?%24search,%24filter}"
