    ...
    module DeviceAppManagement
        module VppTokens
            module Item
                ...
                class VppTokenItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def initialize(path_parameters, request_adapter)
                        super(path_parameters, request_adapter, "{+baseurl}/deviceAppManagement/vppTokens/{vppToken%2Did}{?%24expand,%24select}")
                    end
                    ## 
                    ## Deletes a vppToken.
                    ...
                    def to_delete_request_information(request_configuration=nil)
                        ...
                        request_info.url_template = '{+baseurl}/deviceAppManagement/vppTokens/{vppToken%2Did}'
                    ...
                    def with_url(raw_url)
                        ...
                        return VppTokenItemRequestBuilder.new(raw_url, @request_adapter)
                    end
