...
require_relative './microsoft_graph_sync_licenses'

module MicrosoftGraph::DeviceAppManagement::VppTokens::Item::MicrosoftGraphSyncLicenses
    ## 
    # Provides operations to call the syncLicenses method.
    class MicrosoftGraphSyncLicensesRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/deviceAppManagement/vppTokens/{vppToken%2Did}/microsoft.graph.syncLicenses"
        ...
        class MicrosoftGraphSyncLicensesRequestBuilderPostRequestConfiguration
