...
require_relative './sync_licenses'
        ...
        module VppTokens
            module Item
                module SyncLicenses
                    ...
                    class SyncLicensesRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/deviceAppManagement/vppTokens/{vppToken%2Did}/syncLicenses")
                        end
                        ## 
                        ...
                        ## @return a sync_licenses_request_builder
                        ## 
                        def with_url(raw_url)
                            raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                            return SyncLicensesRequestBuilder.new(raw_url, @request_adapter)
                        end
                    end
                end
            end
