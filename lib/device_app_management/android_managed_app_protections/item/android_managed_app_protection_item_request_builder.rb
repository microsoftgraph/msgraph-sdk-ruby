    ...
    module DeviceAppManagement
        module AndroidManagedAppProtections
            module Item
                ...
                class AndroidManagedAppProtectionItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def initialize(path_parameters, request_adapter)
                        super(path_parameters, request_adapter, "{+baseurl}/deviceAppManagement/androidManagedAppProtections/{androidManagedAppProtection%2Did}{?%24expand,%24select}")
                    end
                    ## 
                    ...
                    def to_delete_request_information(request_configuration=nil)
                        ...
                        request_info.url_template = '{+baseurl}/deviceAppManagement/androidManagedAppProtections/{androidManagedAppProtection%2Did}'
                    ...
                    def with_url(raw_url)
                        ...
                        return AndroidManagedAppProtectionItemRequestBuilder.new(raw_url, @request_adapter)
                    end
