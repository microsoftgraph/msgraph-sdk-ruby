...
module MicrosoftGraph::DeviceAppManagement::AndroidManagedAppProtections::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/deviceAppManagement/androidManagedAppProtections/$count{?%24search,%24filter}"
