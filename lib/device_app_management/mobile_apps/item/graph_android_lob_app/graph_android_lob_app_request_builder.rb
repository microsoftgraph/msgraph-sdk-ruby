            ...
            module Item
                module GraphAndroidLobApp
                    ...
                    class GraphAndroidLobAppRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def assignments()
                            return MicrosoftGraph::DeviceAppManagement::MobileApps::Item::GraphAndroidLobApp::Assignments::AssignmentsRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        # Provides operations to manage the categories property of the microsoft.graph.mobileApp entity.
                        def categories()
                            return MicrosoftGraph::DeviceAppManagement::MobileApps::Item::GraphAndroidLobApp::Categories::CategoriesRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        # Provides operations to manage the contentVersions property of the microsoft.graph.mobileLobApp entity.
                        def content_versions()
                            return MicrosoftGraph::DeviceAppManagement::MobileApps::Item::GraphAndroidLobApp::ContentVersions::ContentVersionsRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/deviceAppManagement/mobileApps/{mobileApp%2Did}/graph.androidLobApp{?%24expand,%24select}")
                        end
                        ## 
                        ...
                        def get(request_configuration=nil)
                            ...
                            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraph::Models::AndroidLobApp.create_from_discriminator_value(pn) }, error_mapping)
                        end
                        ## 
                        ## Get the item of type microsoft.graph.mobileApp as microsoft.graph.androidLobApp
                        ## @param request_configuration Configuration for the request such as headers, query parameters, and middleware options.
