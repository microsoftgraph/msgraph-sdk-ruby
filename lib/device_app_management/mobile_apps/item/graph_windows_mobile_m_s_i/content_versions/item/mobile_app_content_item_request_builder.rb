                    ...
                    module ContentVersions
                        module Item
                            ...
                            class MobileAppContentItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                ...
                                def contained_apps()
                                    return MicrosoftGraph::DeviceAppManagement::MobileApps::Item::GraphWindowsMobileMSI::ContentVersions::Item::ContainedApps::ContainedAppsRequestBuilder.new(@path_parameters, @request_adapter)
                                end
                                ## 
                                # Provides operations to manage the files property of the microsoft.graph.mobileAppContent entity.
                                def files()
                                    return MicrosoftGraph::DeviceAppManagement::MobileApps::Item::GraphWindowsMobileMSI::ContentVersions::Item::Files::FilesRequestBuilder.new(@path_parameters, @request_adapter)
                                end
                                ## 
                                ...
                                def initialize(path_parameters, request_adapter)
                                    super(path_parameters, request_adapter, "{+baseurl}/deviceAppManagement/mobileApps/{mobileApp%2Did}/graph.windowsMobileMSI/contentVersions/{mobileAppContent%2Did}{?%24expand,%24select}")
                                end
                                ## 
                                ...
                                def to_delete_request_information(request_configuration=nil)
                                    ...
                                    request_info.url_template = '{+baseurl}/deviceAppManagement/mobileApps/{mobileApp%2Did}/graph.windowsMobileMSI/contentVersions/{mobileAppContent%2Did}'
