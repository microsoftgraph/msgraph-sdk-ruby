                ...
                module GraphWindowsMobileMSI
                    module Categories
                        ...
                        class CategoriesRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            def count()
                                return MicrosoftGraph::DeviceAppManagement::MobileApps::Item::GraphWindowsMobileMSI::Categories::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            ## Provides operations to manage the categories property of the microsoft.graph.mobileApp entity.
                            ...
                            def by_mobile_app_category_id(mobile_app_category_id)
                                ...
                                return MicrosoftGraph::DeviceAppManagement::MobileApps::Item::GraphWindowsMobileMSI::Categories::Item::MobileAppCategoryItemRequestBuilder.new(url_tpl_params, @request_adapter)
                            end
                            ## 
                            ...
                            def initialize(path_parameters, request_adapter)
                                super(path_parameters, request_adapter, "{+baseurl}/deviceAppManagement/mobileApps/{mobileApp%2Did}/graph.windowsMobileMSI/categories{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}")
                            end
                            ## 
