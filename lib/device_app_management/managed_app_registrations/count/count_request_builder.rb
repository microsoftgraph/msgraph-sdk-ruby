...
module MicrosoftGraph::DeviceAppManagement::ManagedAppRegistrations::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/deviceAppManagement/managedAppRegistrations/$count{?%24search,%24filter}"
