...
require_relative './microsoft_graph_sync_microsoft_store_for_business_apps/sync_microsoft_store_for_business_apps_request_builder'
...
module MicrosoftGraph::DeviceAppManagement
    ## 
    ...
    class DeviceAppManagementRequestBuilder
        ...
        def microsoft_graph_sync_microsoft_store_for_business_apps()
            return MicrosoftGraph::DeviceAppManagement::MicrosoftGraphSyncMicrosoftStoreForBusinessApps::SyncMicrosoftStoreForBusinessAppsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
