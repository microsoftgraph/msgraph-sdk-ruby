...
require_relative '../../../../models/user_install_state_summary_collection_response'
        ...
        module ManagedEBooks
            module Item
                module UserStateSummary
                    ...
                    class UserStateSummaryRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/deviceAppManagement/managedEBooks/{managedEBook%2Did}/userStateSummary{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}")
                        end
                        ## 
                        ...
                        def to_post_request_information(body, request_configuration=nil)
                            ...
                            request_info.url_template = '{+baseurl}/deviceAppManagement/managedEBooks/{managedEBook%2Did}/userStateSummary'
                            request_info.path_parameters = @path_parameters
                        ...
                        ## @return a user_state_summary_request_builder
                        ## 
                        def with_url(raw_url)
                            raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                            return UserStateSummaryRequestBuilder.new(raw_url, @request_adapter)
                        end
