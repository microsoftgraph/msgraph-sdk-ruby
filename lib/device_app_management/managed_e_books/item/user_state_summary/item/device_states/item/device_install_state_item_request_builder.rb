...
module MicrosoftGraph::DeviceAppManagement::ManagedEBooks::Item::UserStateSummary::Item::DeviceStates::Item
    ...
    class DeviceInstallStateItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, device_install_state_id=nil)
            ...
            @url_template = "{+baseurl}/deviceAppManagement/managedEBooks/{managedEBook%2Did}/userStateSummary/{userInstallStateSummary%2Did}/deviceStates/{deviceInstallState%2Did}{?%24select,%24expand}"
