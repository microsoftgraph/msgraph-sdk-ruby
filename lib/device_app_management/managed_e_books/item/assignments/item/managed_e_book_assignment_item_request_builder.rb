...
module MicrosoftGraph::DeviceAppManagement::ManagedEBooks::Item::Assignments::Item
    ## 
    ...
    class ManagedEBookAssignmentItemRequestBuilder
        ...
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, managed_e_book_assignment_id=)
