...
require_relative './get_one_drive_usage_storage_with_period'

module MicrosoftGraph
    module Reports
        module GetOneDriveUsageStorageWithPeriod
            ## 
            # Provides operations to call the getOneDriveUsageStorage method.
            class GetOneDriveUsageStorageWithPeriodRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def initialize(path_parameters, request_adapter, period=nil)
                    super(path_parameters, request_adapter, "{+baseurl}/reports/getOneDriveUsageStorage(period='{period}')")
                end
                ## 
                ...
                def with_url(raw_url)
                    ...
                    return GetOneDriveUsageStorageWithPeriodRequestBuilder.new(raw_url, @request_adapter)
                end
            end
        end
    end
