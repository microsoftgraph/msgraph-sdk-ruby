...
require_relative './microsoft_graph_get_skype_for_business_organizer_activity_user_counts_with_period'
...
module MicrosoftGraph::Reports::MicrosoftGraphGetSkypeForBusinessOrganizerActivityUserCountsWithPeriod
    ...
    class GetSkypeForBusinessOrganizerActivityUserCountsWithPeriodRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, period=)
            ...
            @url_template = "{+baseurl}/reports/microsoft.graph.getSkypeForBusinessOrganizerActivityUserCounts(period='{period}')"
