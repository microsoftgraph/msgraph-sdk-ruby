...
module MicrosoftGraph
    module Reports
        module GetOneDriveActivityFileCountsWithPeriod
            ## 
            # Provides operations to call the getOneDriveActivityFileCounts method.
            class GetOneDriveActivityFileCountsWithPeriodRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def initialize(path_parameters, request_adapter, period=nil)
                    super(path_parameters, request_adapter, "{+baseurl}/reports/getOneDriveActivityFileCounts(period='{period}')")
                end
                ## 
                ...
                def with_url(raw_url)
                    ...
                    return GetOneDriveActivityFileCountsWithPeriodRequestBuilder.new(raw_url, @request_adapter)
                end
            end
        end
    end
