...
require_relative './device_configuration_device_activity'

module MicrosoftGraph
    module Reports
        module DeviceConfigurationDeviceActivity
            ## 
            # Provides operations to call the deviceConfigurationDeviceActivity method.
            class DeviceConfigurationDeviceActivityRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def initialize(path_parameters, request_adapter)
                    super(path_parameters, request_adapter, "{+baseurl}/reports/deviceConfigurationDeviceActivity()")
                end
                ## 
                ...
                def with_url(raw_url)
                    ...
                    return DeviceConfigurationDeviceActivityRequestBuilder.new(raw_url, @request_adapter)
                end
            end
        end
    end
