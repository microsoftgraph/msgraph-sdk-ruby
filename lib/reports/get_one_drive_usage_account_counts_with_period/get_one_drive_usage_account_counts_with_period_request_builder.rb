...
require_relative './get_one_drive_usage_account_counts_with_period'

module MicrosoftGraph
    module Reports
        module GetOneDriveUsageAccountCountsWithPeriod
            ## 
            # Provides operations to call the getOneDriveUsageAccountCounts method.
            class GetOneDriveUsageAccountCountsWithPeriodRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def initialize(path_parameters, request_adapter, period=nil)
                    super(path_parameters, request_adapter, "{+baseurl}/reports/getOneDriveUsageAccountCounts(period='{period}')")
                end
                ## 
                ...
                def with_url(raw_url)
                    ...
                    return GetOneDriveUsageAccountCountsWithPeriodRequestBuilder.new(raw_url, @request_adapter)
                end
            end
        end
    end
