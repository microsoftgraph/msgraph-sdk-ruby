...
require_relative './get_skype_for_business_participant_activity_counts_with_period'

module MicrosoftGraph
    module Reports
        module GetSkypeForBusinessParticipantActivityCountsWithPeriod
            ## 
            # Provides operations to call the getSkypeForBusinessParticipantActivityCounts method.
            class GetSkypeForBusinessParticipantActivityCountsWithPeriodRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def initialize(path_parameters, request_adapter, period=nil)
                    super(path_parameters, request_adapter, "{+baseurl}/reports/getSkypeForBusinessParticipantActivityCounts(period='{period}')")
                end
                ## 
                ...
                def with_url(raw_url)
                    ...
                    return GetSkypeForBusinessParticipantActivityCountsWithPeriodRequestBuilder.new(raw_url, @request_adapter)
                end
            end
        end
    end
