...
require_relative './device_configuration_user_activity'

module MicrosoftGraph
    module Reports
        module DeviceConfigurationUserActivity
            ## 
            # Provides operations to call the deviceConfigurationUserActivity method.
            class DeviceConfigurationUserActivityRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def initialize(path_parameters, request_adapter)
                    super(path_parameters, request_adapter, "{+baseurl}/reports/deviceConfigurationUserActivity()")
                end
                ## 
                ...
                def with_url(raw_url)
                    ...
                    return DeviceConfigurationUserActivityRequestBuilder.new(raw_url, @request_adapter)
                end
            end
        end
    end
