...
module MicrosoftGraph
    module Reports
        module GetOffice365ActiveUserCountsWithPeriod
            ...
            class GetOffice365ActiveUserCountsWithPeriodRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def initialize(path_parameters, request_adapter, period=nil)
                    super(path_parameters, request_adapter, "{+baseurl}/reports/getOffice365ActiveUserCounts(period='{period}')")
                end
                ## 
                ...
                def with_url(raw_url)
                    ...
                    return GetOffice365ActiveUserCountsWithPeriodRequestBuilder.new(raw_url, @request_adapter)
                end
            end
        end
    end
