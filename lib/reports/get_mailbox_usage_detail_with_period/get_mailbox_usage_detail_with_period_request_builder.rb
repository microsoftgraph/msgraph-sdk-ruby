...
require_relative './get_mailbox_usage_detail_with_period'

module MicrosoftGraph
    module Reports
        module GetMailboxUsageDetailWithPeriod
            ## 
            # Provides operations to call the getMailboxUsageDetail method.
            class GetMailboxUsageDetailWithPeriodRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def initialize(path_parameters, request_adapter, period=nil)
                    super(path_parameters, request_adapter, "{+baseurl}/reports/getMailboxUsageDetail(period='{period}')")
                end
                ## 
                ...
                def with_url(raw_url)
                    ...
                    return GetMailboxUsageDetailWithPeriodRequestBuilder.new(raw_url, @request_adapter)
                end
            end
        end
    end
