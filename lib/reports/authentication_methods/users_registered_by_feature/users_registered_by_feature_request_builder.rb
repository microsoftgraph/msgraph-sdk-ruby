...
require_relative './users_registered_by_feature'

module MicrosoftGraph
    module Reports
        module AuthenticationMethods
            module UsersRegisteredByFeature
                ## 
                # Provides operations to call the usersRegisteredByFeature method.
                class UsersRegisteredByFeatureRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def initialize(path_parameters, request_adapter)
                        super(path_parameters, request_adapter, "{+baseurl}/reports/authenticationMethods/usersRegisteredByFeature()")
                    end
                    ## 
