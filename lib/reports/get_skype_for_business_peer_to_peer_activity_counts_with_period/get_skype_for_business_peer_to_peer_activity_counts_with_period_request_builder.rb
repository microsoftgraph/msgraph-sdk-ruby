...
module MicrosoftGraph
    module Reports
        module GetSkypeForBusinessPeerToPeerActivityCountsWithPeriod
            ...
            class GetSkypeForBusinessPeerToPeerActivityCountsWithPeriodRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def initialize(path_parameters, request_adapter, period=nil)
                    super(path_parameters, request_adapter, "{+baseurl}/reports/getSkypeForBusinessPeerToPeerActivityCounts(period='{period}')")
                end
                ## 
                ...
                def with_url(raw_url)
                    ...
                    return GetSkypeForBusinessPeerToPeerActivityCountsWithPeriodRequestBuilder.new(raw_url, @request_adapter)
                end
            end
        end
    end
