...
require_relative './get_one_drive_usage_file_counts_with_period'

module MicrosoftGraph
    module Reports
        module GetOneDriveUsageFileCountsWithPeriod
            ## 
            # Provides operations to call the getOneDriveUsageFileCounts method.
            class GetOneDriveUsageFileCountsWithPeriodRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def initialize(path_parameters, request_adapter, period=nil)
                    super(path_parameters, request_adapter, "{+baseurl}/reports/getOneDriveUsageFileCounts(period='{period}')")
                end
                ## 
                ...
                def with_url(raw_url)
                    ...
                    return GetOneDriveUsageFileCountsWithPeriodRequestBuilder.new(raw_url, @request_adapter)
                end
            end
        end
    end
