...
require_relative './get_teams_team_activity_detail_with_date'

module MicrosoftGraph
    module Reports
        module GetTeamsTeamActivityDetailWithDate
            ## 
            # Provides operations to call the getTeamsTeamActivityDetail method.
            class GetTeamsTeamActivityDetailWithDateRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def initialize(path_parameters, request_adapter, date=nil)
                    super(path_parameters, request_adapter, "{+baseurl}/reports/getTeamsTeamActivityDetail(date={date})")
                end
                ## 
