...
require_relative './get_one_drive_usage_account_detail_with_date'

module MicrosoftGraph
    module Reports
        module GetOneDriveUsageAccountDetailWithDate
            ## 
            # Provides operations to call the getOneDriveUsageAccountDetail method.
            class GetOneDriveUsageAccountDetailWithDateRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def initialize(path_parameters, request_adapter, date=nil)
                    super(path_parameters, request_adapter, "{+baseurl}/reports/getOneDriveUsageAccountDetail(date={date})")
                end
                ## 
                ...
                def with_url(raw_url)
                    ...
                    return GetOneDriveUsageAccountDetailWithDateRequestBuilder.new(raw_url, @request_adapter)
                end
            end
        end
    end
