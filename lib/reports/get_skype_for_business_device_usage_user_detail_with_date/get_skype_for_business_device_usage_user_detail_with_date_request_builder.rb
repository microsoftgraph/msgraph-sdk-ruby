...
require_relative './get_skype_for_business_device_usage_user_detail_with_date'

module MicrosoftGraph
    module Reports
        module GetSkypeForBusinessDeviceUsageUserDetailWithDate
            ## 
            # Provides operations to call the getSkypeForBusinessDeviceUsageUserDetail method.
            class GetSkypeForBusinessDeviceUsageUserDetailWithDateRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def initialize(path_parameters, request_adapter, date=nil)
                    super(path_parameters, request_adapter, "{+baseurl}/reports/getSkypeForBusinessDeviceUsageUserDetail(date={date})")
                end
                ## 
                ...
                def with_url(raw_url)
                    ...
                    return GetSkypeForBusinessDeviceUsageUserDetailWithDateRequestBuilder.new(raw_url, @request_adapter)
                end
            end
        end
    end
