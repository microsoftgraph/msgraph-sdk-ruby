            ...
            module GetAttackSimulationTrainingUserCoverage
                ...
                class GetAttackSimulationTrainingUserCoverageRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def initialize(path_parameters, request_adapter)
                        super(path_parameters, request_adapter, "{+baseurl}/reports/security/getAttackSimulationTrainingUserCoverage(){?%24count,%24filter,%24search,%24skip,%24top}")
                    end
                    ## 
                    ...
                    ## @return a Fiber of get_attack_simulation_training_user_coverage_get_response
                    ## 
                    def get(request_configuration=nil)
                        ...
                        return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraph::Reports::Security::GetAttackSimulationTrainingUserCoverage::GetAttackSimulationTrainingUserCoverageGetResponse.create_from_discriminator_value(pn) }, error_mapping)
                    end
                    ## 
                    ## List training coverage for tenant users in attack simulation and training campaigns. This function supports @odata.nextLink for pagination.
                    ## @param request_configuration Configuration for the request such as headers, query parameters, and middleware options.
                    ...
                    def with_url(raw_url)
                        ...
                        return GetAttackSimulationTrainingUserCoverageRequestBuilder.new(raw_url, @request_adapter)
                    end
