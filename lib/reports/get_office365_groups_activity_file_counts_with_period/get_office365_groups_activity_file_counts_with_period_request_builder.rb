...
require_relative './get_office365_groups_activity_file_counts_with_period'

module MicrosoftGraph
    module Reports
        module GetOffice365GroupsActivityFileCountsWithPeriod
            ## 
            # Provides operations to call the getOffice365GroupsActivityFileCounts method.
            class GetOffice365GroupsActivityFileCountsWithPeriodRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def initialize(path_parameters, request_adapter, period=nil)
                    super(path_parameters, request_adapter, "{+baseurl}/reports/getOffice365GroupsActivityFileCounts(period='{period}')")
                end
                ## 
                ...
                def with_url(raw_url)
                    ...
                    return GetOffice365GroupsActivityFileCountsWithPeriodRequestBuilder.new(raw_url, @request_adapter)
                end
            end
        end
    end
