...
require_relative './get_yammer_activity_user_detail_with_date'

module MicrosoftGraph
    module Reports
        module GetYammerActivityUserDetailWithDate
            ## 
            # Provides operations to call the getYammerActivityUserDetail method.
            class GetYammerActivityUserDetailWithDateRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def initialize(path_parameters, request_adapter, date=nil)
                    super(path_parameters, request_adapter, "{+baseurl}/reports/getYammerActivityUserDetail(date={date})")
                end
                ## 
                ...
                def with_url(raw_url)
                    ...
                    return GetYammerActivityUserDetailWithDateRequestBuilder.new(raw_url, @request_adapter)
                end
            end
        end
    end
