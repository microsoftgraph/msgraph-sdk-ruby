...
module MicrosoftGraph::Reports::MicrosoftGraphGetOneDriveUsageStorageWithPeriod
    ...
    class MicrosoftGraphGetOneDriveUsageStorageWithPeriodRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, period=nil)
            ...
            @url_template = "{+baseurl}/reports/microsoft.graph.getOneDriveUsageStorage(period='{period}')"
        ...
        class MicrosoftGraphGetOneDriveUsageStorageWithPeriodRequestBuilderGetRequestConfiguration
