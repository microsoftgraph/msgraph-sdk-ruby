...
require_relative './get_share_point_site_usage_detail_with_date'

module MicrosoftGraph
    module Reports
        module GetSharePointSiteUsageDetailWithDate
            ## 
            # Provides operations to call the getSharePointSiteUsageDetail method.
            class GetSharePointSiteUsageDetailWithDateRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def initialize(path_parameters, request_adapter, date=nil)
                    super(path_parameters, request_adapter, "{+baseurl}/reports/getSharePointSiteUsageDetail(date={date})")
                end
                ## 
                ...
                def with_url(raw_url)
                    ...
                    return GetSharePointSiteUsageDetailWithDateRequestBuilder.new(raw_url, @request_adapter)
                end
            end
        end
    end
