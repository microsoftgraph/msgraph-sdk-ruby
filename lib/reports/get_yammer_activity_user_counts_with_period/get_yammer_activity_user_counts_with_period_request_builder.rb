...
require_relative './get_yammer_activity_user_counts_with_period'

module MicrosoftGraph
    module Reports
        module GetYammerActivityUserCountsWithPeriod
            ## 
            # Provides operations to call the getYammerActivityUserCounts method.
            class GetYammerActivityUserCountsWithPeriodRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def initialize(path_parameters, request_adapter, period=nil)
                    super(path_parameters, request_adapter, "{+baseurl}/reports/getYammerActivityUserCounts(period='{period}')")
                end
                ## 
                ...
                def with_url(raw_url)
                    ...
                    return GetYammerActivityUserCountsWithPeriodRequestBuilder.new(raw_url, @request_adapter)
                end
            end
        end
    end
