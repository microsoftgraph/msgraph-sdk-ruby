...
require_relative './get_mailbox_usage_mailbox_counts_with_period'

module MicrosoftGraph
    module Reports
        module GetMailboxUsageMailboxCountsWithPeriod
            ## 
            # Provides operations to call the getMailboxUsageMailboxCounts method.
            class GetMailboxUsageMailboxCountsWithPeriodRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def initialize(path_parameters, request_adapter, period=nil)
                    super(path_parameters, request_adapter, "{+baseurl}/reports/getMailboxUsageMailboxCounts(period='{period}')")
                end
                ## 
                ...
                def with_url(raw_url)
                    ...
                    return GetMailboxUsageMailboxCountsWithPeriodRequestBuilder.new(raw_url, @request_adapter)
                end
            end
        end
    end
