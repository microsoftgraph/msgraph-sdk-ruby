...
require_relative './get_teams_device_usage_user_counts_with_period'

module MicrosoftGraph
    module Reports
        module GetTeamsDeviceUsageUserCountsWithPeriod
            ## 
            # Provides operations to call the getTeamsDeviceUsageUserCounts method.
            class GetTeamsDeviceUsageUserCountsWithPeriodRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def initialize(path_parameters, request_adapter, period=nil)
                    super(path_parameters, request_adapter, "{+baseurl}/reports/getTeamsDeviceUsageUserCounts(period='{period}')")
                end
                ## 
                ...
                def with_url(raw_url)
                    ...
                    return GetTeamsDeviceUsageUserCountsWithPeriodRequestBuilder.new(raw_url, @request_adapter)
                end
            end
        end
    end
