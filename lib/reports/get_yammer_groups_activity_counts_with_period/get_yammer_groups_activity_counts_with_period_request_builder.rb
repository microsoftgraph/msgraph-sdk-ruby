...
require_relative './get_yammer_groups_activity_counts_with_period'

module MicrosoftGraph
    module Reports
        module GetYammerGroupsActivityCountsWithPeriod
            ## 
            # Provides operations to call the getYammerGroupsActivityCounts method.
            class GetYammerGroupsActivityCountsWithPeriodRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def initialize(path_parameters, request_adapter, period=nil)
                    super(path_parameters, request_adapter, "{+baseurl}/reports/getYammerGroupsActivityCounts(period='{period}')")
                end
                ## 
                ...
                def with_url(raw_url)
                    ...
                    return GetYammerGroupsActivityCountsWithPeriodRequestBuilder.new(raw_url, @request_adapter)
                end
            end
        end
    end
