...
require_relative './get_office365_activation_counts'

module MicrosoftGraph
    module Reports
        module GetOffice365ActivationCounts
            ## 
            # Provides operations to call the getOffice365ActivationCounts method.
            class GetOffice365ActivationCountsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def initialize(path_parameters, request_adapter)
                    super(path_parameters, request_adapter, "{+baseurl}/reports/getOffice365ActivationCounts()")
                end
                ## 
                ...
                def with_url(raw_url)
                    ...
                    return GetOffice365ActivationCountsRequestBuilder.new(raw_url, @request_adapter)
                end
            end
        end
    end
