...
require_relative './get_skype_for_business_peer_to_peer_activity_user_counts_with_period'

module MicrosoftGraph
    module Reports
        module GetSkypeForBusinessPeerToPeerActivityUserCountsWithPeriod
            ## 
            # Provides operations to call the getSkypeForBusinessPeerToPeerActivityUserCounts method.
            class GetSkypeForBusinessPeerToPeerActivityUserCountsWithPeriodRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def initialize(path_parameters, request_adapter, period=nil)
                    super(path_parameters, request_adapter, "{+baseurl}/reports/getSkypeForBusinessPeerToPeerActivityUserCounts(period='{period}')")
                end
                ## 
                ...
                def with_url(raw_url)
                    ...
                    return GetSkypeForBusinessPeerToPeerActivityUserCountsWithPeriodRequestBuilder.new(raw_url, @request_adapter)
                end
            end
        end
    end
