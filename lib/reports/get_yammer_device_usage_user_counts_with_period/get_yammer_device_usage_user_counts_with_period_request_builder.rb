...
require_relative './get_yammer_device_usage_user_counts_with_period'

module MicrosoftGraph
    module Reports
        module GetYammerDeviceUsageUserCountsWithPeriod
            ## 
            # Provides operations to call the getYammerDeviceUsageUserCounts method.
            class GetYammerDeviceUsageUserCountsWithPeriodRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def initialize(path_parameters, request_adapter, period=nil)
                    super(path_parameters, request_adapter, "{+baseurl}/reports/getYammerDeviceUsageUserCounts(period='{period}')")
                end
                ## 
                ...
                def with_url(raw_url)
                    ...
                    return GetYammerDeviceUsageUserCountsWithPeriodRequestBuilder.new(raw_url, @request_adapter)
                end
            end
        end
    end
