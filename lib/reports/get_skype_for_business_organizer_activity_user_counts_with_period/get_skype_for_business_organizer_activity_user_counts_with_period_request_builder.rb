...
require_relative './get_skype_for_business_organizer_activity_user_counts_with_period'

module MicrosoftGraph
    module Reports
        module GetSkypeForBusinessOrganizerActivityUserCountsWithPeriod
            ## 
            # Provides operations to call the getSkypeForBusinessOrganizerActivityUserCounts method.
            class GetSkypeForBusinessOrganizerActivityUserCountsWithPeriodRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def initialize(path_parameters, request_adapter, period=nil)
                    super(path_parameters, request_adapter, "{+baseurl}/reports/getSkypeForBusinessOrganizerActivityUserCounts(period='{period}')")
                end
                ## 
                ...
                def with_url(raw_url)
                    ...
                    return GetSkypeForBusinessOrganizerActivityUserCountsWithPeriodRequestBuilder.new(raw_url, @request_adapter)
                end
            end
        end
    end
