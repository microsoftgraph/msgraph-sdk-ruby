...
require_relative './microsoft_graph_get_office365_groups_activity_storage_with_period'

module MicrosoftGraph
    module Reports
        module MicrosoftGraphGetOffice365GroupsActivityStorageWithPeriod
            ## 
            ...
            class MicrosoftGraphGetOffice365GroupsActivityStorageWithPeriodRequestBuilder
                ...
                def initialize(path_parameters, request_adapter, period=nil)
                    ...
                    @url_template = "{+baseurl}/reports/microsoft.graph.getOffice365GroupsActivityStorage(period='{period}')"
