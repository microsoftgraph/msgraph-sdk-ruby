...
require_relative './get_share_point_site_usage_storage_with_period'

module MicrosoftGraph
    module Reports
        module GetSharePointSiteUsageStorageWithPeriod
            ## 
            # Provides operations to call the getSharePointSiteUsageStorage method.
            class GetSharePointSiteUsageStorageWithPeriodRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def initialize(path_parameters, request_adapter, period=nil)
                    super(path_parameters, request_adapter, "{+baseurl}/reports/getSharePointSiteUsageStorage(period='{period}')")
                end
                ## 
                ...
                def with_url(raw_url)
                    ...
                    return GetSharePointSiteUsageStorageWithPeriodRequestBuilder.new(raw_url, @request_adapter)
                end
            end
        end
    end
