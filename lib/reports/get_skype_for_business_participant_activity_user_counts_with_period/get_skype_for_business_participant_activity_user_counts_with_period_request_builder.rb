...
require_relative './get_skype_for_business_participant_activity_user_counts_with_period'

module MicrosoftGraph
    module Reports
        module GetSkypeForBusinessParticipantActivityUserCountsWithPeriod
            ## 
            # Provides operations to call the getSkypeForBusinessParticipantActivityUserCounts method.
            class GetSkypeForBusinessParticipantActivityUserCountsWithPeriodRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def initialize(path_parameters, request_adapter, period=nil)
                    super(path_parameters, request_adapter, "{+baseurl}/reports/getSkypeForBusinessParticipantActivityUserCounts(period='{period}')")
                end
                ## 
                ...
                def with_url(raw_url)
                    ...
                    return GetSkypeForBusinessParticipantActivityUserCountsWithPeriodRequestBuilder.new(raw_url, @request_adapter)
                end
            end
        end
    end
