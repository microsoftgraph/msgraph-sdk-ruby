...
require_relative './microsoft_graph_get_skype_for_business_peer_to_peer_activity_counts_with_period'
...
module MicrosoftGraph::Reports::MicrosoftGraphGetSkypeForBusinessPeerToPeerActivityCountsWithPeriod
    ...
    class GetSkypeForBusinessPeerToPeerActivityCountsWithPeriodRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, period=)
            ...
            @url_template = "{+baseurl}/reports/microsoft.graph.getSkypeForBusinessPeerToPeerActivityCounts(period='{period}')"
