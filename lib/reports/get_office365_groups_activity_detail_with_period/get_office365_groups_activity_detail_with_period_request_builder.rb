...
module MicrosoftGraph
    module Reports
        module GetOffice365GroupsActivityDetailWithPeriod
            ## 
            # Provides operations to call the getOffice365GroupsActivityDetail method.
            class GetOffice365GroupsActivityDetailWithPeriodRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def initialize(path_parameters, request_adapter, period=nil)
                    super(path_parameters, request_adapter, "{+baseurl}/reports/getOffice365GroupsActivityDetail(period='{period}')")
                end
                ## 
                ...
                def with_url(raw_url)
                    ...
                    return GetOffice365GroupsActivityDetailWithPeriodRequestBuilder.new(raw_url, @request_adapter)
                end
            end
        end
    end
