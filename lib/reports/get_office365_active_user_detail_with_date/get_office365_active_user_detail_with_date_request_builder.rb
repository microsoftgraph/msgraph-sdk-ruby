...
module MicrosoftGraph
    module Reports
        module GetOffice365ActiveUserDetailWithDate
            ## 
            # Provides operations to call the getOffice365ActiveUserDetail method.
            class GetOffice365ActiveUserDetailWithDateRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def initialize(path_parameters, request_adapter, date=nil)
                    super(path_parameters, request_adapter, "{+baseurl}/reports/getOffice365ActiveUserDetail(date={date})")
                end
                ## 
                ...
                def with_url(raw_url)
                    ...
                    return GetOffice365ActiveUserDetailWithDateRequestBuilder.new(raw_url, @request_adapter)
                end
            end
        end
    end
