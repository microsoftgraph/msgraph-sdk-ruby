...
require_relative './get_office365_services_user_counts_with_period'

module MicrosoftGraph
    module Reports
        module GetOffice365ServicesUserCountsWithPeriod
            ## 
            # Provides operations to call the getOffice365ServicesUserCounts method.
            class GetOffice365ServicesUserCountsWithPeriodRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def initialize(path_parameters, request_adapter, period=nil)
                    super(path_parameters, request_adapter, "{+baseurl}/reports/getOffice365ServicesUserCounts(period='{period}')")
                end
                ## 
                ...
                def with_url(raw_url)
                    ...
                    return GetOffice365ServicesUserCountsWithPeriodRequestBuilder.new(raw_url, @request_adapter)
                end
            end
        end
    end
