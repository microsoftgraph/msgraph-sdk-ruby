...
module MicrosoftGraph::Reports::MicrosoftGraphGetGroupArchivedPrintJobsWithGroupIdWithStartDateTimeWithEndDateTime
    ...
    class GetGroupArchivedPrintJobsWithGroupIdWithStartDateTimeWithEndDateTimeRequestBuilder
        ...
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, end_date_time=, group_id=, start_date_time=)
            raise StandardError, 'path_parameters cannot be null' if path_parameters.nil?
            raise StandardError, 'request_adapter cannot be null' if request_adapter.nil?
            @url_template = "{+baseurl}/reports/microsoft.graph.getGroupArchivedPrintJobs(groupId='{groupId}',startDateTime={startDateTime},endDateTime={endDateTime}){?%24top,%24skip,%24search,%24filter,%24count}"
        ...
        ## @return a Fiber of get_group_archived_print_jobs_with_group_id_with_start_date_time_with_end_date_time_response
        ## 
        def get(request_configuration=)
            ...
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraph::Reports::MicrosoftGraphGetGroupArchivedPrintJobsWithGroupIdWithStartDateTimeWithEndDateTime::GetGroupArchivedPrintJobsWithGroupIdWithStartDateTimeWithEndDateTimeResponse.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
        ## Invoke function getGroupArchivedPrintJobs
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
