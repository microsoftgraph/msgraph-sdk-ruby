...
require_relative './get_mailbox_usage_storage_with_period'

module MicrosoftGraph
    module Reports
        module GetMailboxUsageStorageWithPeriod
            ## 
            # Provides operations to call the getMailboxUsageStorage method.
            class GetMailboxUsageStorageWithPeriodRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def initialize(path_parameters, request_adapter, period=nil)
                    super(path_parameters, request_adapter, "{+baseurl}/reports/getMailboxUsageStorage(period='{period}')")
                end
                ## 
                ...
                def with_url(raw_url)
                    ...
                    return GetMailboxUsageStorageWithPeriodRequestBuilder.new(raw_url, @request_adapter)
                end
            end
        end
    end
