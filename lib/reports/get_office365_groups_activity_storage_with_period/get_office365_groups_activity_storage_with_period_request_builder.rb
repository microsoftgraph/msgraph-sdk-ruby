...
require_relative './get_office365_groups_activity_storage_with_period'

module MicrosoftGraph
    module Reports
        module GetOffice365GroupsActivityStorageWithPeriod
            ## 
            # Provides operations to call the getOffice365GroupsActivityStorage method.
            class GetOffice365GroupsActivityStorageWithPeriodRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def initialize(path_parameters, request_adapter, period=nil)
                    super(path_parameters, request_adapter, "{+baseurl}/reports/getOffice365GroupsActivityStorage(period='{period}')")
                end
                ## 
                ...
                def with_url(raw_url)
                    ...
                    return GetOffice365GroupsActivityStorageWithPeriodRequestBuilder.new(raw_url, @request_adapter)
                end
            end
        end
    end
