...
require_relative './get_one_drive_activity_user_counts_with_period'

module MicrosoftGraph
    module Reports
        module GetOneDriveActivityUserCountsWithPeriod
            ## 
            # Provides operations to call the getOneDriveActivityUserCounts method.
            class GetOneDriveActivityUserCountsWithPeriodRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def initialize(path_parameters, request_adapter, period=nil)
                    super(path_parameters, request_adapter, "{+baseurl}/reports/getOneDriveActivityUserCounts(period='{period}')")
                end
                ## 
                ...
                def with_url(raw_url)
                    ...
                    return GetOneDriveActivityUserCountsWithPeriodRequestBuilder.new(raw_url, @request_adapter)
                end
            end
        end
    end
