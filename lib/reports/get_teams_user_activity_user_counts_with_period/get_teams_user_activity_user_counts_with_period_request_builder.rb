...
require_relative './get_teams_user_activity_user_counts_with_period'

module MicrosoftGraph
    module Reports
        module GetTeamsUserActivityUserCountsWithPeriod
            ## 
            # Provides operations to call the getTeamsUserActivityUserCounts method.
            class GetTeamsUserActivityUserCountsWithPeriodRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def initialize(path_parameters, request_adapter, period=nil)
                    super(path_parameters, request_adapter, "{+baseurl}/reports/getTeamsUserActivityUserCounts(period='{period}')")
                end
                ## 
                ...
                def with_url(raw_url)
                    ...
                    return GetTeamsUserActivityUserCountsWithPeriodRequestBuilder.new(raw_url, @request_adapter)
                end
            end
        end
    end
