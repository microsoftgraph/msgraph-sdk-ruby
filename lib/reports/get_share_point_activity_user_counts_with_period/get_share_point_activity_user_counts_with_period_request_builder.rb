...
require_relative './get_share_point_activity_user_counts_with_period'

module MicrosoftGraph
    module Reports
        module GetSharePointActivityUserCountsWithPeriod
            ## 
            # Provides operations to call the getSharePointActivityUserCounts method.
            class GetSharePointActivityUserCountsWithPeriodRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def initialize(path_parameters, request_adapter, period=nil)
                    super(path_parameters, request_adapter, "{+baseurl}/reports/getSharePointActivityUserCounts(period='{period}')")
                end
                ## 
                ...
                def with_url(raw_url)
                    ...
                    return GetSharePointActivityUserCountsWithPeriodRequestBuilder.new(raw_url, @request_adapter)
                end
            end
        end
    end
