...
require_relative './get_mailbox_usage_quota_status_mailbox_counts_with_period'

module MicrosoftGraph
    module Reports
        module GetMailboxUsageQuotaStatusMailboxCountsWithPeriod
            ## 
            # Provides operations to call the getMailboxUsageQuotaStatusMailboxCounts method.
            class GetMailboxUsageQuotaStatusMailboxCountsWithPeriodRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def initialize(path_parameters, request_adapter, period=nil)
                    super(path_parameters, request_adapter, "{+baseurl}/reports/getMailboxUsageQuotaStatusMailboxCounts(period='{period}')")
                end
                ## 
                ...
                def with_url(raw_url)
                    ...
                    return GetMailboxUsageQuotaStatusMailboxCountsWithPeriodRequestBuilder.new(raw_url, @request_adapter)
                end
            end
        end
    end
