...
require_relative './get_share_point_activity_file_counts_with_period'

module MicrosoftGraph
    module Reports
        module GetSharePointActivityFileCountsWithPeriod
            ## 
            # Provides operations to call the getSharePointActivityFileCounts method.
            class GetSharePointActivityFileCountsWithPeriodRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def initialize(path_parameters, request_adapter, period=nil)
                    super(path_parameters, request_adapter, "{+baseurl}/reports/getSharePointActivityFileCounts(period='{period}')")
                end
                ## 
                ...
                def with_url(raw_url)
                    ...
                    return GetSharePointActivityFileCountsWithPeriodRequestBuilder.new(raw_url, @request_adapter)
                end
            end
        end
    end
