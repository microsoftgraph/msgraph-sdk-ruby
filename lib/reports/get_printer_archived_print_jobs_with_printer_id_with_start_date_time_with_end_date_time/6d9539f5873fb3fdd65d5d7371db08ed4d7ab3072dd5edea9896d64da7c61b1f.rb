        ...
        module GetPrinterArchivedPrintJobsWithPrinterIdWithStartDateTimeWithEndDateTime
            ...
            class GetPrinterArchivedPrintJobsWithPrinterIdWithStartDateTimeWithEndDateTimeRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def initialize(path_parameters, request_adapter, end_date_time=nil, printer_id=nil, start_date_time=nil)
                    super(path_parameters, request_adapter, "{+baseurl}/reports/getPrinterArchivedPrintJobs(printerId='{printerId}',startDateTime={startDateTime},endDateTime={endDateTime}){?%24count,%24filter,%24search,%24skip,%24top}")
                end
                ## 
                ## Get a list of archived print jobs that were queued for particular printer.
                ## @param request_configuration Configuration for the request such as headers, query parameters, and middleware options.
                ## @return a Fiber of get_printer_archived_print_jobs_with_printer_id_with_start_date_time_with_end_date_time_get_response
                ## 
                def get(request_configuration=nil)
                    ...
                    return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraph::Reports::GetPrinterArchivedPrintJobsWithPrinterIdWithStartDateTimeWithEndDateTime::GetPrinterArchivedPrintJobsWithPrinterIdWithStartDateTimeWithEndDateTimeGetResponse.create_from_discriminator_value(pn) }, error_mapping)
                end
                ## 
                ## Get a list of archived print jobs that were queued for particular printer.
                ## @param request_configuration Configuration for the request such as headers, query parameters, and middleware options.
                ...
                def with_url(raw_url)
                    ...
                    return GetPrinterArchivedPrintJobsWithPrinterIdWithStartDateTimeWithEndDateTimeRequestBuilder.new(raw_url, @request_adapter)
                end
