...
module MicrosoftGraph
    module Reports
        module GetOneDriveActivityUserDetailWithDate
            ...
            class GetOneDriveActivityUserDetailWithDateRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def initialize(path_parameters, request_adapter, date=nil)
                    super(path_parameters, request_adapter, "{+baseurl}/reports/getOneDriveActivityUserDetail(date={date})")
                end
                ## 
                ...
                def with_url(raw_url)
                    ...
                    return GetOneDriveActivityUserDetailWithDateRequestBuilder.new(raw_url, @request_adapter)
                end
            end
        end
    end
