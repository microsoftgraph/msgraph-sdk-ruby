...
require_relative './get_email_activity_counts_with_period'

module MicrosoftGraph
    module Reports
        module GetEmailActivityCountsWithPeriod
            ## 
            # Provides operations to call the getEmailActivityCounts method.
            class GetEmailActivityCountsWithPeriodRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def initialize(path_parameters, request_adapter, period=nil)
                    super(path_parameters, request_adapter, "{+baseurl}/reports/getEmailActivityCounts(period='{period}')")
                end
                ## 
                ...
                def with_url(raw_url)
                    ...
                    return GetEmailActivityCountsWithPeriodRequestBuilder.new(raw_url, @request_adapter)
                end
            end
        end
    end
