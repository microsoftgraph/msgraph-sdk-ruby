...
require_relative './get_skype_for_business_device_usage_distribution_user_counts_with_period'

module MicrosoftGraph
    module Reports
        module GetSkypeForBusinessDeviceUsageDistributionUserCountsWithPeriod
            ## 
            # Provides operations to call the getSkypeForBusinessDeviceUsageDistributionUserCounts method.
            class GetSkypeForBusinessDeviceUsageDistributionUserCountsWithPeriodRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def initialize(path_parameters, request_adapter, period=nil)
                    super(path_parameters, request_adapter, "{+baseurl}/reports/getSkypeForBusinessDeviceUsageDistributionUserCounts(period='{period}')")
                end
                ## 
                ...
                def with_url(raw_url)
                    ...
                    return GetSkypeForBusinessDeviceUsageDistributionUserCountsWithPeriodRequestBuilder.new(raw_url, @request_adapter)
                end
            end
        end
    end
