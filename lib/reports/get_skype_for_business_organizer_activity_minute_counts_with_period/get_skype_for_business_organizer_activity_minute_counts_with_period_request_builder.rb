...
require_relative './get_skype_for_business_organizer_activity_minute_counts_with_period'

module MicrosoftGraph
    module Reports
        module GetSkypeForBusinessOrganizerActivityMinuteCountsWithPeriod
            ## 
            # Provides operations to call the getSkypeForBusinessOrganizerActivityMinuteCounts method.
            class GetSkypeForBusinessOrganizerActivityMinuteCountsWithPeriodRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def initialize(path_parameters, request_adapter, period=nil)
                    super(path_parameters, request_adapter, "{+baseurl}/reports/getSkypeForBusinessOrganizerActivityMinuteCounts(period='{period}')")
                end
                ## 
                ...
                def with_url(raw_url)
                    ...
                    return GetSkypeForBusinessOrganizerActivityMinuteCountsWithPeriodRequestBuilder.new(raw_url, @request_adapter)
                end
            end
        end
    end
