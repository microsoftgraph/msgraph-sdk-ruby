...
require_relative './get_m365_app_user_detail_with_period'

module MicrosoftGraph
    module Reports
        module GetM365AppUserDetailWithPeriod
            ## 
            # Provides operations to call the getM365AppUserDetail method.
            class GetM365AppUserDetailWithPeriodRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def initialize(path_parameters, request_adapter, period=nil)
                    super(path_parameters, request_adapter, "{+baseurl}/reports/getM365AppUserDetail(period='{period}')")
                end
                ## 
                ...
                def with_url(raw_url)
                    ...
                    return GetM365AppUserDetailWithPeriodRequestBuilder.new(raw_url, @request_adapter)
                end
            end
        end
    end
