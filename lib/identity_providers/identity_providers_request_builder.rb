...
module MicrosoftGraph::IdentityProviders
    ## 
    ...
    class IdentityProvidersRequestBuilder
        ...
        def microsoft_graph_available_provider_types()
            return MicrosoftGraph::IdentityProviders::MicrosoftGraphAvailableProviderTypes::AvailableProviderTypesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
