...
require_relative '../models/application_template_collection_response'
...
module MicrosoftGraph
    module ApplicationTemplates
        ...
        class ApplicationTemplatesRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
            ...
            def initialize(path_parameters, request_adapter)
                super(path_parameters, request_adapter, "{+baseurl}/applicationTemplates{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}")
            end
            ## 
            ## Retrieve a list of applicationTemplate objects from the Azure AD application gallery.
            ## @param request_configuration Configuration for the request such as headers, query parameters, and middleware options.
            ## @return a Fiber of application_template_collection_response
            ## 
            def get(request_configuration=nil)
                ...
                return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraph::Models::ApplicationTemplateCollectionResponse.create_from_discriminator_value(pn) }, error_mapping)
            end
            ## 
            ## Retrieve a list of applicationTemplate objects from the Azure AD application gallery.
            ## @param request_configuration Configuration for the request such as headers, query parameters, and middleware options.
            ...
            ## @return a application_templates_request_builder
            ## 
            def with_url(raw_url)
                raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                return ApplicationTemplatesRequestBuilder.new(raw_url, @request_adapter)
            end
