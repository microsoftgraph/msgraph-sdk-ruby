...
module MicrosoftGraph
    module ApplicationTemplates
        module Item
            ...
            class ApplicationTemplateItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def initialize(path_parameters, request_adapter)
                    super(path_parameters, request_adapter, "{+baseurl}/applicationTemplates/{applicationTemplate%2Did}{?%24select,%24expand}")
                end
                ## 
                ...
                def with_url(raw_url)
                    ...
                    return ApplicationTemplateItemRequestBuilder.new(raw_url, @request_adapter)
                end
