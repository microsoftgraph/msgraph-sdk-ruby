...
require_relative './acronyms/acronyms_request_builder'
require_relative './bookmarks/bookmarks_request_builder'
require_relative './qnas/qnas_request_builder'
...
module MicrosoftGraph
    module Search
        ...
        class SearchRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
            ...
            def acronyms()
                return MicrosoftGraph::Search::Acronyms::AcronymsRequestBuilder.new(@path_parameters, @request_adapter)
            end
            ## 
            # Provides operations to manage the bookmarks property of the microsoft.graph.searchEntity entity.
            def bookmarks()
                return MicrosoftGraph::Search::Bookmarks::BookmarksRequestBuilder.new(@path_parameters, @request_adapter)
            end
            ## 
            # Provides operations to manage the qnas property of the microsoft.graph.searchEntity entity.
            def qnas()
                return MicrosoftGraph::Search::Qnas::QnasRequestBuilder.new(@path_parameters, @request_adapter)
            end
            ## 
            ...
            def initialize(path_parameters, request_adapter)
                super(path_parameters, request_adapter, "{+baseurl}/search{?%24expand,%24select}")
            end
            ## 
            ## Get search
            ...
            def get(request_configuration=nil)
                ...
                return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraph::Models::SearchEntity.create_from_discriminator_value(pn) }, error_mapping)
            end
            ## 
            ## Update search
            ...
            def to_patch_request_information(body, request_configuration=nil)
                ...
                request_info.url_template = '{+baseurl}/search'
                request_info.path_parameters = @path_parameters
