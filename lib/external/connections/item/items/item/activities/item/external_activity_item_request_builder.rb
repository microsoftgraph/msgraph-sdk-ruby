                        ...
                        module Activities
                            module Item
                                ...
                                class ExternalActivityItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                    ...
                                    def performed_by()
                                        return MicrosoftGraph::External::Connections::Item::Items::Item::Activities::Item::PerformedBy::PerformedByRequestBuilder.new(@path_parameters, @request_adapter)
                                    end
                                    ## 
                                    ...
                                    def initialize(path_parameters, request_adapter)
                                        super(path_parameters, request_adapter, "{+baseurl}/external/connections/{externalConnection%2Did}/items/{externalItem%2Did}/activities/{externalActivity%2Did}{?%24select,%24expand}")
                                    end
                                    ## 
