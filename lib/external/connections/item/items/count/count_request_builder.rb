...
module MicrosoftGraph::External::Connections::Item::Items::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/external/connections/{externalConnection%2Did}/items/$count{?%24search,%24filter}"
