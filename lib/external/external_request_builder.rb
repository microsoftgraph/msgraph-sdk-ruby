...
module MicrosoftGraph
    module External
        ...
        class ExternalRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
            ...
            ## @return a Fiber of external_connectors_external
            ## 
            def get(request_configuration=nil)
                ...
                return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraph::Models::ExternalConnectorsExternal.create_from_discriminator_value(pn) }, error_mapping)
            end
            ## 
            ## Update external
