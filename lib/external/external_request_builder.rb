...
module MicrosoftGraph::External
    ## 
    ...
    class ExternalRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/external{?%24select,%24expand}"
        ...
        def get(request_configuration=)
            ...
            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraph::Models::ExternalConnectors::External.create_from_discriminator_value(pn) }, error_mapping)
        end
        ## 
        ## Update external
        ## @param body 
