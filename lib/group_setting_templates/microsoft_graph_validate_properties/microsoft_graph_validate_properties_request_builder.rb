...
module MicrosoftGraph::GroupSettingTemplates::MicrosoftGraphValidateProperties
    ## 
    ...
    class MicrosoftGraphValidatePropertiesRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/groupSettingTemplates/microsoft.graph.validateProperties"
