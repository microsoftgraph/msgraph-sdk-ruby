...
require_relative './restore_factory_defaults'

module MicrosoftGraph
    module Print
        module Printers
            module Item
                module RestoreFactoryDefaults
                    ## 
                    # Provides operations to call the restoreFactoryDefaults method.
                    class RestoreFactoryDefaultsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        ## @return a restore_factory_defaults_request_builder
                        ## 
                        def with_url(raw_url)
                            raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                            return RestoreFactoryDefaultsRequestBuilder.new(raw_url, @request_adapter)
                        end
                    end
                end
            end
