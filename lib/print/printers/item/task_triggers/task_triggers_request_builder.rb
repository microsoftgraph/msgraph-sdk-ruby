...
require_relative '../../../../models/print_task_trigger_collection_response'
        ...
        module Printers
            module Item
                module TaskTriggers
                    ...
                    class TaskTriggersRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/print/printers/{printer%2Did}/taskTriggers{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}")
                        end
                        ## 
                        ...
                        ## @return a Fiber of print_task_trigger_collection_response
                        ## 
                        def get(request_configuration=nil)
                            ...
                            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraph::Models::PrintTaskTriggerCollectionResponse.create_from_discriminator_value(pn) }, error_mapping)
                        end
                        ## 
                        ...
                        def to_post_request_information(body, request_configuration=nil)
                            ...
                            request_info.url_template = '{+baseurl}/print/printers/{printer%2Did}/taskTriggers'
                            request_info.path_parameters = @path_parameters
                        ...
                        ## @return a task_triggers_request_builder
                        ## 
                        def with_url(raw_url)
                            raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                            return TaskTriggersRequestBuilder.new(raw_url, @request_adapter)
                        end
