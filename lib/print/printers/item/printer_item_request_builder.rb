    ...
    module Print
        module Printers
            module Item
                ...
                class PrinterItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def shares()
                        return MicrosoftGraph::Print::Printers::Item::Shares::SharesRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ...
                    def initialize(path_parameters, request_adapter)
                        super(path_parameters, request_adapter, "{+baseurl}/print/printers/{printer%2Did}{?%24expand,%24select}")
                    end
                    ## 
                    ...
                    def to_delete_request_information(request_configuration=nil)
                        ...
                        request_info.url_template = '{+baseurl}/print/printers/{printer%2Did}'
                    ...
                    def with_url(raw_url)
                        ...
                        return PrinterItemRequestBuilder.new(raw_url, @request_adapter)
                    end
