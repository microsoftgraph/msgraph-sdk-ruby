...
require_relative './endpoints/item/print_service_endpoint_item_request_builder'
            ...
            module Item
                ...
                class PrintServiceItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def initialize(path_parameters, request_adapter)
                        super(path_parameters, request_adapter, "{+baseurl}/print/services/{printService%2Did}{?%24select,%24expand}")
                    end
                    ## 
