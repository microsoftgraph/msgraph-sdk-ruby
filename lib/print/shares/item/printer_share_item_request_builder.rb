...
module MicrosoftGraph::Print::Shares::Item
    ## 
    ...
    class PrinterShareItemRequestBuilder
        ...
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, printer_share_id=)
            raise StandardError, 'path_parameters cannot be null' if path_parameters.nil?
            raise StandardError, 'request_adapter cannot be null' if request_adapter.nil?
            @url_template = "{+baseurl}/print/shares/{printerShare%2Did}{?%24select,%24expand}"
