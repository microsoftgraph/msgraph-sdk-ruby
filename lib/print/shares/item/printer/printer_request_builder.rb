        ...
        module Shares
            module Item
                module Printer
                    ...
                    class PrinterRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/print/shares/{printerShare%2Did}/printer{?%24expand,%24select}")
                        end
                        ## 
                        ...
                        ## @return a printer_request_builder
                        ## 
                        def with_url(raw_url)
                            raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                            return PrinterRequestBuilder.new(raw_url, @request_adapter)
                        end
