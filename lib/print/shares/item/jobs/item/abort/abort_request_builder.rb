                ...
                module Jobs
                    module Item
                        module Abort
                            ...
                            class AbortRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                ...
                                def initialize(path_parameters, request_adapter)
                                    super(path_parameters, request_adapter, "{+baseurl}/print/shares/{printerShare%2Did}/jobs/{printJob%2Did}/abort")
                                end
                                ## 
                                ...
                                ## @return a abort_request_builder
                                ## 
                                def with_url(raw_url)
                                    raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                                    return AbortRequestBuilder.new(raw_url, @request_adapter)
                                end
                            end
                        end
                    end
