                ...
                module Tasks
                    module Item
                        ...
                        class PrintTaskItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            def definition()
                                return MicrosoftGraph::Print::TaskDefinitions::Item::Tasks::Item::Definition::DefinitionRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            # Provides operations to manage the trigger property of the microsoft.graph.printTask entity.
                            def trigger()
                                return MicrosoftGraph::Print::TaskDefinitions::Item::Tasks::Item::Trigger::TriggerRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            ...
                            def initialize(path_parameters, request_adapter)
                                super(path_parameters, request_adapter, "{+baseurl}/print/taskDefinitions/{printTaskDefinition%2Did}/tasks/{printTask%2Did}{?%24expand,%24select}")
                            end
                            ## 
                            ...
                            def to_delete_request_information(request_configuration=nil)
                                ...
                                request_info.url_template = '{+baseurl}/print/taskDefinitions/{printTaskDefinition%2Did}/tasks/{printTask%2Did}'
