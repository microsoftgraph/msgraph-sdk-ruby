...
module MicrosoftGraph::Print::TaskDefinitions::Item::Tasks::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/print/taskDefinitions/{printTaskDefinition%2Did}/tasks/$count{?%24search,%24filter}"
