    ...
    module Domains
        module Item
            module RootDomain
                ...
                class RootDomainRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def initialize(path_parameters, request_adapter)
                        super(path_parameters, request_adapter, "{+baseurl}/domains/{domain%2Did}/rootDomain{?%24expand,%24select}")
                    end
                    ## 
                    ...
                    ## @return a root_domain_request_builder
                    ## 
                    def with_url(raw_url)
                        raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                        return RootDomainRequestBuilder.new(raw_url, @request_adapter)
                    end
