...
require_relative './root_domain/root_domain_request_builder'
    ...
    module Domains
        module Item
            ...
            class DomainItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def root_domain()
                    return MicrosoftGraph::Domains::Item::RootDomain::RootDomainRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                ...
                def initialize(path_parameters, request_adapter)
                    super(path_parameters, request_adapter, "{+baseurl}/domains/{domain%2Did}{?%24expand,%24select}")
                end
                ## 
