...
module MicrosoftGraph::Domains::Item::ServiceConfigurationRecords::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/domains/{domain%2Did}/serviceConfigurationRecords/$count{?%24search,%24filter}"
