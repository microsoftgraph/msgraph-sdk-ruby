...
module MicrosoftGraph
    module Domains
        module Item
            module FederationConfiguration
                ## 
                # Provides operations to manage the federationConfiguration property of the microsoft.graph.domain entity.
                class FederationConfigurationRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def initialize(path_parameters, request_adapter)
                        super(path_parameters, request_adapter, "{+baseurl}/domains/{domain%2Did}/federationConfiguration{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}")
                    end
                    ## 
                    ...
                    def to_post_request_information(body, request_configuration=nil)
                        ...
                        request_info.url_template = '{+baseurl}/domains/{domain%2Did}/federationConfiguration'
                        request_info.path_parameters = @path_parameters
                    ...
                    ## @return a federation_configuration_request_builder
                    ## 
                    def with_url(raw_url)
                        raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                        return FederationConfigurationRequestBuilder.new(raw_url, @request_adapter)
                    end
