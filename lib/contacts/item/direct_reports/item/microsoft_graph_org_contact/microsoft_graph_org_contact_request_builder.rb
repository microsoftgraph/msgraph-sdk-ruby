...
module MicrosoftGraph::Contacts::Item::DirectReports::Item::MicrosoftGraphOrgContact
    ## 
    ...
    class MicrosoftGraphOrgContactRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/contacts/{orgContact%2Did}/directReports/{directoryObject%2Did}/microsoft.graph.orgContact{?%24select,%24expand}"
