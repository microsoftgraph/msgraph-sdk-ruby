    ...
    module Contacts
        module Item
            module TransitiveMemberOf
                ...
                class TransitiveMemberOfRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def graph_administrative_unit()
                        return MicrosoftGraph::Contacts::Item::TransitiveMemberOf::GraphAdministrativeUnit::GraphAdministrativeUnitRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Casts the previous resource to group.
                    def graph_group()
                        return MicrosoftGraph::Contacts::Item::TransitiveMemberOf::GraphGroup::GraphGroupRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ## Provides operations to manage the transitiveMemberOf property of the microsoft.graph.orgContact entity.
                    ...
                    def initialize(path_parameters, request_adapter)
                        super(path_parameters, request_adapter, "{+baseurl}/contacts/{orgContact%2Did}/transitiveMemberOf{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}")
                    end
                    ## 
                    ...
                    ## @return a transitive_member_of_request_builder
                    ## 
                    def with_url(raw_url)
                        raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                        return TransitiveMemberOfRequestBuilder.new(raw_url, @request_adapter)
                    end
