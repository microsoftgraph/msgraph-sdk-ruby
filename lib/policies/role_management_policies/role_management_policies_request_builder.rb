...
module MicrosoftGraph
    module Policies
        module RoleManagementPolicies
            ...
            class RoleManagementPoliciesRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def initialize(path_parameters, request_adapter)
                    super(path_parameters, request_adapter, "{+baseurl}/policies/roleManagementPolicies{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}")
                end
                ## 
                ...
                ## @return a Fiber of unified_role_management_policy_collection_response
                ## 
                def get(request_configuration=nil)
                    ...
                    return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraph::Models::UnifiedRoleManagementPolicyCollectionResponse.create_from_discriminator_value(pn) }, error_mapping)
                end
                ## 
                ...
                def to_post_request_information(body, request_configuration=nil)
                    ...
                    request_info.url_template = '{+baseurl}/policies/roleManagementPolicies'
                    request_info.path_parameters = @path_parameters
                ...
                ## @return a role_management_policies_request_builder
                ## 
                def with_url(raw_url)
                    raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                    return RoleManagementPoliciesRequestBuilder.new(raw_url, @request_adapter)
                end
