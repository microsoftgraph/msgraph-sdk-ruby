...
require_relative '../../../../models/unified_role_management_policy_rule_collection_response'
require_relative '../../../policies'
require_relative '../../role_management_policies'
require_relative '../item'
require_relative './count/count_request_builder'
require_relative './effective_rules'
require_relative './item/unified_role_management_policy_rule_item_request_builder'

module MicrosoftGraph
    module Policies
        module RoleManagementPolicies
            module Item
                module EffectiveRules
                    ## 
                    # Provides operations to manage the effectiveRules property of the microsoft.graph.unifiedRoleManagementPolicy entity.
                    class EffectiveRulesRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        
                        ## 
                        # Provides operations to count the resources in the collection.
                        def count()
                            return MicrosoftGraph::Policies::RoleManagementPolicies::Item::EffectiveRules::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ## Provides operations to manage the effectiveRules property of the microsoft.graph.unifiedRoleManagementPolicy entity.
                        ...
                        ## 
                        def by_unified_role_management_policy_rule_id(unified_role_management_policy_rule_id)
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/policies/roleManagementPolicies/{unifiedRoleManagementPolicy%2Did}/effectiveRules{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}")
                        end
                        ## 
                        ## The list of effective rules like approval rules and expiration rules evaluated based on inherited referenced rules. For example, if there is a tenant-wide policy to enforce enabling an approval rule, the effective rule will be to enable approval even if the policy has a rule to disable approval. Supports $expand.
                        ## @param request_configuration Configuration for the request such as headers, query parameters, and middleware options.
                        ## @return a Fiber of unified_role_management_policy_rule_collection_response
                        ## 
                        ...
                        def to_post_request_information(body, request_configuration=nil)
                            ...
                            request_info.url_template = '{+baseurl}/policies/roleManagementPolicies/{unifiedRoleManagementPolicy%2Did}/effectiveRules'
                            request_info.path_parameters = @path_parameters
                        ...
                        ## @return a effective_rules_request_builder
                        ## 
                        def with_url(raw_url)
                            raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                            return EffectiveRulesRequestBuilder.new(raw_url, @request_adapter)
                        end
