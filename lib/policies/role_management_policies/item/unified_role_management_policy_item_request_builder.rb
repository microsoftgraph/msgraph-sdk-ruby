    ...
    module Policies
        module RoleManagementPolicies
            module Item
                ...
                class UnifiedRoleManagementPolicyItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    
                    ## 
                    # Provides operations to manage the effectiveRules property of the microsoft.graph.unifiedRoleManagementPolicy entity.
                    def effective_rules()
                        return MicrosoftGraph::Policies::RoleManagementPolicies::Item::EffectiveRules::EffectiveRulesRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to manage the rules property of the microsoft.graph.unifiedRoleManagementPolicy entity.
                    def rules()
                        return MicrosoftGraph::Policies::RoleManagementPolicies::Item::Rules::RulesRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ...
                    def initialize(path_parameters, request_adapter)
                        super(path_parameters, request_adapter, "{+baseurl}/policies/roleManagementPolicies/{unifiedRoleManagementPolicy%2Did}{?%24expand,%24select}")
                    end
                    ## 
                    ...
                    def to_delete_request_information(request_configuration=nil)
                        ...
                        request_info.url_template = '{+baseurl}/policies/roleManagementPolicies/{unifiedRoleManagementPolicy%2Did}'
                    ...
                    def with_url(raw_url)
                        ...
                        return UnifiedRoleManagementPolicyItemRequestBuilder.new(raw_url, @request_adapter)
                    end
