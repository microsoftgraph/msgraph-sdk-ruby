...
module MicrosoftGraph::Policies::RoleManagementPolicies::Item::Rules::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/policies/roleManagementPolicies/{unifiedRoleManagementPolicy%2Did}/rules/$count{?%24search,%24filter}"
