        ...
        module RoleManagementPolicyAssignments
            module Item
                module Policy
                    ...
                    class PolicyRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/policies/roleManagementPolicyAssignments/{unifiedRoleManagementPolicyAssignment%2Did}/policy{?%24expand,%24select}")
                        end
                        ## 
                        ...
                        ## @return a policy_request_builder
                        ## 
                        def with_url(raw_url)
                            raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                            return PolicyRequestBuilder.new(raw_url, @request_adapter)
                        end
