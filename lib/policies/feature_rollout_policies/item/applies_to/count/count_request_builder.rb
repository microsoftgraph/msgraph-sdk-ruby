...
module MicrosoftGraph::Policies::FeatureRolloutPolicies::Item::AppliesTo::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/policies/featureRolloutPolicies/{featureRolloutPolicy%2Did}/appliesTo/$count{?%24search,%24filter}"
