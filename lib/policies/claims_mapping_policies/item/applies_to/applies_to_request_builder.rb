            ...
            module Item
                module AppliesTo
                    ...
                    class AppliesToRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def count()
                            return MicrosoftGraph::Policies::ClaimsMappingPolicies::Item::AppliesTo::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ## Provides operations to manage the appliesTo property of the microsoft.graph.stsPolicy entity.
                        ...
                        def by_directory_object_id(directory_object_id)
                            ...
                            return MicrosoftGraph::Policies::ClaimsMappingPolicies::Item::AppliesTo::Item::DirectoryObjectItemRequestBuilder.new(url_tpl_params, @request_adapter)
                        end
                        ## 
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/policies/claimsMappingPolicies/{claimsMappingPolicy%2Did}/appliesTo{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}")
                        end
                        ## 
