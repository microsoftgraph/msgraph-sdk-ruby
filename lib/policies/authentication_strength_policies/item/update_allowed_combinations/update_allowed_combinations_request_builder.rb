                ...
                module UpdateAllowedCombinations
                    ...
                    class UpdateAllowedCombinationsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/policies/authenticationStrengthPolicies/{authenticationStrengthPolicy%2Did}/updateAllowedCombinations")
                        end
                        ## 
                        ...
                        ## @return a update_allowed_combinations_request_builder
                        ## 
                        def with_url(raw_url)
                            raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                            return UpdateAllowedCombinationsRequestBuilder.new(raw_url, @request_adapter)
                        end
                    end
                end
            end
