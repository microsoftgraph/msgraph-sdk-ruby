            ...
            module Item
                module CombinationConfigurations
                    ...
                    class CombinationConfigurationsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        ## 
                        ## Provides operations to manage the combinationConfigurations property of the microsoft.graph.authenticationStrengthPolicy entity.
                        ## @param authentication_combination_configuration_id Unique identifier of the item
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/policies/authenticationStrengthPolicies/{authenticationStrengthPolicy%2Did}/combinationConfigurations{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}")
                        end
                        ## 
