            ...
            module Item
                module CombinationConfigurations
                    ...
                    class CombinationConfigurationsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def count()
                            return MicrosoftGraph::Policies::AuthenticationStrengthPolicies::Item::CombinationConfigurations::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ## Provides operations to manage the combinationConfigurations property of the microsoft.graph.authenticationStrengthPolicy entity.
                        ...
                        def by_authentication_combination_configuration_id(authentication_combination_configuration_id)
                            ...
                            return MicrosoftGraph::Policies::AuthenticationStrengthPolicies::Item::CombinationConfigurations::Item::AuthenticationCombinationConfigurationItemRequestBuilder.new(url_tpl_params, @request_adapter)
                        end
                        ## 
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/policies/authenticationStrengthPolicies/{authenticationStrengthPolicy%2Did}/combinationConfigurations{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}")
                        end
                        ## 
                        ...
                        def to_post_request_information(body, request_configuration=nil)
                            ...
                            request_info.url_template = '{+baseurl}/policies/authenticationStrengthPolicies/{authenticationStrengthPolicy%2Did}/combinationConfigurations'
                            request_info.path_parameters = @path_parameters
