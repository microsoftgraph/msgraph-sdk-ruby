...
module MicrosoftGraph
    module Policies
        module AuthenticationStrengthPolicies
            ...
            class AuthenticationStrengthPoliciesRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                
                ## 
                # Provides operations to count the resources in the collection.
                def count()
                    return MicrosoftGraph::Policies::AuthenticationStrengthPolicies::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                ## Provides operations to manage the authenticationStrengthPolicies property of the microsoft.graph.policyRoot entity.
                ...
                def by_authentication_strength_policy_id(authentication_strength_policy_id)
                    ...
                    return MicrosoftGraph::Policies::AuthenticationStrengthPolicies::Item::AuthenticationStrengthPolicyItemRequestBuilder.new(url_tpl_params, @request_adapter)
                end
                ## 
                ...
                def initialize(path_parameters, request_adapter)
                    super(path_parameters, request_adapter, "{+baseurl}/policies/authenticationStrengthPolicies{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}")
                end
                ## 
                ...
                def to_post_request_information(body, request_configuration=nil)
                    ...
                    request_info.url_template = '{+baseurl}/policies/authenticationStrengthPolicies'
                    request_info.path_parameters = @path_parameters
                ...
                ## @return a authentication_strength_policies_request_builder
                ## 
                def with_url(raw_url)
                    raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                    return AuthenticationStrengthPoliciesRequestBuilder.new(raw_url, @request_adapter)
                end
