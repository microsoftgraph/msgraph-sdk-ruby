...
require_relative '../../../../models/permission_grant_condition_set'
require_relative '../../../../models/permission_grant_condition_set_collection_response'
        ...
        module PermissionGrantPolicies
            module Item
                module Includes
                    ...
                    class IncludesRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/policies/permissionGrantPolicies/{permissionGrantPolicy%2Did}/includes{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}")
                        end
                        ## 
                        ...
                        def to_post_request_information(body, request_configuration=nil)
                            ...
                            request_info.url_template = '{+baseurl}/policies/permissionGrantPolicies/{permissionGrantPolicy%2Did}/includes'
                            request_info.path_parameters = @path_parameters
                        ...
                        ## @return a includes_request_builder
                        ## 
                        def with_url(raw_url)
                            raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                            return IncludesRequestBuilder.new(raw_url, @request_adapter)
                        end
