...
module MicrosoftGraph::Policies::PermissionGrantPolicies::Item::Includes::Item
    ## 
    ...
    class PermissionGrantConditionSetItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, permission_grant_condition_set_id=nil)
            ...
            @url_template = "{+baseurl}/policies/permissionGrantPolicies/{permissionGrantPolicy%2Did}/includes/{permissionGrantConditionSet%2Did}{?%24select,%24expand}"
