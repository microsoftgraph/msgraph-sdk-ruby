...
require_relative '../../models/cross_tenant_access_policy'
require_relative '../../models/o_data_errors/o_data_error'
require_relative '../policies'
require_relative './cross_tenant_access_policy'
require_relative './default/default_request_builder'
require_relative './partners/item/cross_tenant_access_policy_configuration_partner_tenant_item_request_builder'
...
module MicrosoftGraph
    module Policies
        module CrossTenantAccessPolicy
            ...
            class CrossTenantAccessPolicyRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                
                ## 
                # Provides operations to manage the default property of the microsoft.graph.crossTenantAccessPolicy entity.
                def default()
                    return MicrosoftGraph::Policies::CrossTenantAccessPolicy::Default::DefaultRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                # Provides operations to manage the partners property of the microsoft.graph.crossTenantAccessPolicy entity.
                def partners()
                    return MicrosoftGraph::Policies::CrossTenantAccessPolicy::Partners::PartnersRequestBuilder.new(@path_parameters, @request_adapter)
                end
                ## 
                ...
                def initialize(path_parameters, request_adapter)
                    super(path_parameters, request_adapter, "{+baseurl}/policies/crossTenantAccessPolicy{?%24select,%24expand}")
                end
                ## 
                ...
                def get(request_configuration=nil)
                    ...
                    error_mapping["4XX"] = lambda {|pn| MicrosoftGraph::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
                    error_mapping["5XX"] = lambda {|pn| MicrosoftGraph::Models::ODataErrors::ODataError.create_from_discriminator_value(pn) }
                    return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraph::Models::CrossTenantAccessPolicy.create_from_discriminator_value(pn) }, error_mapping)
                end
                ## 
                ## Provides operations to manage the partners property of the microsoft.graph.crossTenantAccessPolicy entity.
