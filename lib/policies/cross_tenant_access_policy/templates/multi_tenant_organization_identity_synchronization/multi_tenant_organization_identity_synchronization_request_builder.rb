...
require_relative '../../../../models/multi_tenant_organization_identity_sync_policy_template'
        ...
        module CrossTenantAccessPolicy
            module Templates
                module MultiTenantOrganizationIdentitySynchronization
                    ...
                    class MultiTenantOrganizationIdentitySynchronizationRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/policies/crossTenantAccessPolicy/templates/multiTenantOrganizationIdentitySynchronization{?%24expand,%24select}")
                        end
                        ## 
                        ...
                        ## @param request_configuration Configuration for the request such as headers, query parameters, and middleware options.
                        ## @return a Fiber of multi_tenant_organization_identity_sync_policy_template
                        ## 
                        def get(request_configuration=nil)
                            ...
                            error_mapping = Hash.new
                            error_mapping["XXX"] = lambda {|pn| MicrosoftGraph::Models::ODataErrorsODataError.create_from_discriminator_value(pn) }
                            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraph::Models::MultiTenantOrganizationIdentitySyncPolicyTemplate.create_from_discriminator_value(pn) }, error_mapping)
                        end
                        ## 
                        ...
                        ## @return a multi_tenant_organization_identity_synchronization_request_builder
                        ## 
                        def with_url(raw_url)
                            raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                            return MultiTenantOrganizationIdentitySynchronizationRequestBuilder.new(raw_url, @request_adapter)
                        end
