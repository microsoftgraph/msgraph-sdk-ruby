    ...
    module Policies
        module CrossTenantAccessPolicy
            module Default
                ...
                class DefaultRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def initialize(path_parameters, request_adapter)
                        super(path_parameters, request_adapter, "{+baseurl}/policies/crossTenantAccessPolicy/default{?%24expand,%24select}")
                    end
                    ## 
                    ...
                    def to_delete_request_information(request_configuration=nil)
                        ...
                        request_info.url_template = '{+baseurl}/policies/crossTenantAccessPolicy/default'
                    ...
                    ## @return a default_request_builder
                    ## 
                    def with_url(raw_url)
                        raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                        return DefaultRequestBuilder.new(raw_url, @request_adapter)
                    end
