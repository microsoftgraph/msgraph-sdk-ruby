...
require_relative '../../models/tenant_app_management_policy'
require_relative '../policies'
require_relative './default_app_management_policy'
        ...
        module DefaultAppManagementPolicy
            ...
            class DefaultAppManagementPolicyRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def initialize(path_parameters, request_adapter)
                    super(path_parameters, request_adapter, "{+baseurl}/policies/defaultAppManagementPolicy{?%24expand,%24select}")
                end
                ## 
                ...
                def to_delete_request_information(request_configuration=nil)
                    ...
                    request_info.url_template = '{+baseurl}/policies/defaultAppManagementPolicy'
                ...
                ## @return a default_app_management_policy_request_builder
                ## 
                def with_url(raw_url)
                    raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                    return DefaultAppManagementPolicyRequestBuilder.new(raw_url, @request_adapter)
                end
