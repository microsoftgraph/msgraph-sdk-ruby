    ...
    module Policies
        ...
        class PoliciesRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
            ...
            def device_registration_policy()
                return MicrosoftGraph::Policies::DeviceRegistrationPolicy::DeviceRegistrationPolicyRequestBuilder.new(@path_parameters, @request_adapter)
            end
            ## 
            ...
            def to_patch_request_information(body, request_configuration=nil)
                ...
                request_info.url_template = '{+baseurl}/policies'
                request_info.path_parameters = @path_parameters
