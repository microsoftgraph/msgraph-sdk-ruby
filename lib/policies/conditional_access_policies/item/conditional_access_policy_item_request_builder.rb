    ...
    module Policies
        module ConditionalAccessPolicies
            module Item
                ...
                class ConditionalAccessPolicyItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def initialize(path_parameters, request_adapter)
                        super(path_parameters, request_adapter, "{+baseurl}/policies/conditionalAccessPolicies/{conditionalAccessPolicy%2Did}{?%24expand,%24select}")
                    end
                    ## 
                    ...
                    def to_delete_request_information(request_configuration=nil)
                        ...
                        request_info.url_template = '{+baseurl}/policies/conditionalAccessPolicies/{conditionalAccessPolicy%2Did}'
                    ...
                    def with_url(raw_url)
                        ...
                        return ConditionalAccessPolicyItemRequestBuilder.new(raw_url, @request_adapter)
                    end
