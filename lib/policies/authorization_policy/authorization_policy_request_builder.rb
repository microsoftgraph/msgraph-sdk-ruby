...
require_relative '../../models/authorization_policy'
...
module MicrosoftGraph
    module Policies
        module AuthorizationPolicy
            ...
            class AuthorizationPolicyRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def initialize(path_parameters, request_adapter)
                    super(path_parameters, request_adapter, "{+baseurl}/policies/authorizationPolicy{?%24expand,%24select}")
                end
                ## 
                ...
                def to_delete_request_information(request_configuration=nil)
                    ...
                    request_info.url_template = '{+baseurl}/policies/authorizationPolicy'
                ...
                ## @return a authorization_policy_request_builder
                ## 
                def with_url(raw_url)
                    raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                    return AuthorizationPolicyRequestBuilder.new(raw_url, @request_adapter)
                end
