...
require_relative '../../models/home_realm_discovery_policy'
        ...
        module HomeRealmDiscoveryPolicies
            ...
            class HomeRealmDiscoveryPoliciesRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def initialize(path_parameters, request_adapter)
                    super(path_parameters, request_adapter, "{+baseurl}/policies/homeRealmDiscoveryPolicies{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}")
                end
                ## 
                ...
                def to_post_request_information(body, request_configuration=nil)
                    ...
                    request_info.url_template = '{+baseurl}/policies/homeRealmDiscoveryPolicies'
                    request_info.path_parameters = @path_parameters
