            ...
            module Item
                module AppliesTo
                    ...
                    class AppliesToRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def count()
                            return MicrosoftGraph::Policies::HomeRealmDiscoveryPolicies::Item::AppliesTo::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ## Provides operations to manage the appliesTo property of the microsoft.graph.stsPolicy entity.
                        ...
                        def by_directory_object_id(directory_object_id)
                            ...
                            return MicrosoftGraph::Policies::HomeRealmDiscoveryPolicies::Item::AppliesTo::Item::DirectoryObjectItemRequestBuilder.new(url_tpl_params, @request_adapter)
                        end
                        ## 
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/policies/homeRealmDiscoveryPolicies/{homeRealmDiscoveryPolicy%2Did}/appliesTo{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}")
                        end
                        ## 
