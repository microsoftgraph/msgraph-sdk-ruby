...
module MicrosoftGraph
    module Policies
        module AuthenticationMethodsPolicy
            ...
            class AuthenticationMethodsPolicyRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def initialize(path_parameters, request_adapter)
                    super(path_parameters, request_adapter, "{+baseurl}/policies/authenticationMethodsPolicy{?%24select,%24expand}")
                end
                ## 
                ...
                ## 
                ## Read the properties and relationships of an authenticationMethodsPolicy object. This API is supported in the following national cloud deployments.
                ## @param request_configuration Configuration for the request such as headers, query parameters, and middleware options.
                ...
                ## 
                ## Update the properties of an authenticationMethodsPolicy object. This API is supported in the following national cloud deployments.
                ...
                ## @return a authentication_methods_policy_request_builder
                ## 
                def with_url(raw_url)
                    raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                    return AuthenticationMethodsPolicyRequestBuilder.new(raw_url, @request_adapter)
                end
