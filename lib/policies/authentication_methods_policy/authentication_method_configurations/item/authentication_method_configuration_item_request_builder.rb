...
module MicrosoftGraph::Policies::AuthenticationMethodsPolicy::AuthenticationMethodConfigurations::Item
    ## 
    ...
    class AuthenticationMethodConfigurationItemRequestBuilder
        ...
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, authentication_method_configuration_id=)
            raise StandardError, 'path_parameters cannot be null' if path_parameters.nil?
            raise StandardError, 'request_adapter cannot be null' if request_adapter.nil?
            @url_template = "{+baseurl}/policies/authenticationMethodsPolicy/authenticationMethodConfigurations/{authenticationMethodConfiguration%2Did}{?%24select,%24expand}"
