...
module MicrosoftGraph::Policies::TokenIssuancePolicies::Item
    ## 
    ...
    class TokenIssuancePolicyItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, token_issuance_policy_id=nil)
            ...
            @url_template = "{+baseurl}/policies/tokenIssuancePolicies/{tokenIssuancePolicy%2Did}{?%24select,%24expand}"
