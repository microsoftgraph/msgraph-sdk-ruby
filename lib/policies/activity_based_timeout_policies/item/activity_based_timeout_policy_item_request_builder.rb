    ...
    module Policies
        module ActivityBasedTimeoutPolicies
            module Item
                ...
                class ActivityBasedTimeoutPolicyItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    
                    ## 
                    # Provides operations to manage the appliesTo property of the microsoft.graph.stsPolicy entity.
                    def applies_to()
                        return MicrosoftGraph::Policies::ActivityBasedTimeoutPolicies::Item::AppliesTo::AppliesToRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ...
                    def initialize(path_parameters, request_adapter)
                        super(path_parameters, request_adapter, "{+baseurl}/policies/activityBasedTimeoutPolicies/{activityBasedTimeoutPolicy%2Did}{?%24expand,%24select}")
                    end
                    ## 
                    ...
                    def to_delete_request_information(request_configuration=nil)
                        ...
                        request_info.url_template = '{+baseurl}/policies/activityBasedTimeoutPolicies/{activityBasedTimeoutPolicy%2Did}'
                    ...
                    def with_url(raw_url)
                        ...
                        return ActivityBasedTimeoutPolicyItemRequestBuilder.new(raw_url, @request_adapter)
                    end
