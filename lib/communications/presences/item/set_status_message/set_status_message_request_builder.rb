        ...
        module Presences
            module Item
                module SetStatusMessage
                    ...
                    class SetStatusMessageRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/communications/presences/{presence%2Did}/setStatusMessage")
                        end
                        ## 
                        ...
                        ## @return a set_status_message_request_builder
                        ## 
                        def with_url(raw_url)
                            raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                            return SetStatusMessageRequestBuilder.new(raw_url, @request_adapter)
                        end
                    end
                end
            end
