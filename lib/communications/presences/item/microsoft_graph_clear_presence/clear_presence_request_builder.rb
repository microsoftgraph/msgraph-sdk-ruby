...
require_relative './microsoft_graph_clear_presence'

module MicrosoftGraph::Communications::Presences::Item::MicrosoftGraphClearPresence
    ## 
    ...
    class ClearPresenceRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/communications/presences/{presence%2Did}/microsoft.graph.clearPresence"
