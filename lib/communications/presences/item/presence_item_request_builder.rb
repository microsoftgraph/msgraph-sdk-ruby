    ...
    module Communications
        module Presences
            module Item
                ...
                class PresenceItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def set_status_message()
                        return MicrosoftGraph::Communications::Presences::Item::SetStatusMessage::SetStatusMessageRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ...
                    def initialize(path_parameters, request_adapter)
                        super(path_parameters, request_adapter, "{+baseurl}/communications/presences/{presence%2Did}{?%24expand,%24select}")
                    end
                    ## 
                    ...
                    def to_delete_request_information(request_configuration=nil)
                        ...
                        request_info.url_template = '{+baseurl}/communications/presences/{presence%2Did}'
                    ...
                    def with_url(raw_url)
                        ...
                        return PresenceItemRequestBuilder.new(raw_url, @request_adapter)
                    end
