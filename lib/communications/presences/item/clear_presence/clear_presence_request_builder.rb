        ...
        module Presences
            module Item
                module ClearPresence
                    ...
                    class ClearPresenceRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/communications/presences/{presence%2Did}/clearPresence")
                        end
                        ## 
                        ...
                        ## @return a clear_presence_request_builder
                        ## 
                        def with_url(raw_url)
                            raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                            return ClearPresenceRequestBuilder.new(raw_url, @request_adapter)
                        end
                    end
                end
            end
