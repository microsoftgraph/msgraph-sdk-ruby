...
module MicrosoftGraph::Communications::OnlineMeetings::MicrosoftGraphCreateOrGet
    ## 
    ...
    class CreateOrGetRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/communications/onlineMeetings/microsoft.graph.createOrGet"
