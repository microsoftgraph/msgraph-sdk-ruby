...
module MicrosoftGraph::Communications::OnlineMeetings::Item::AttendanceReports::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/communications/onlineMeetings/{onlineMeeting%2Did}/attendanceReports/$count{?%24search,%24filter}"
