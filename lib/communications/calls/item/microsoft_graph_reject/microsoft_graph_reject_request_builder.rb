...
require_relative './microsoft_graph_reject'

module MicrosoftGraph::Communications::Calls::Item::MicrosoftGraphReject
    ## 
    # Provides operations to call the reject method.
    class MicrosoftGraphRejectRequestBuilder
        ...
        class MicrosoftGraphRejectRequestBuilderPostRequestConfiguration
