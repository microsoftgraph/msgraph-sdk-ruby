...
require_relative './microsoft_graph_answer'

module MicrosoftGraph::Communications::Calls::Item::MicrosoftGraphAnswer
    ## 
    ...
    class AnswerRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/communications/calls/{call%2Did}/microsoft.graph.answer"
