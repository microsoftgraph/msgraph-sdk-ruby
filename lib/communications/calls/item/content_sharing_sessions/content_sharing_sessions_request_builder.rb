...
require_relative '../../../../models/content_sharing_session'
require_relative '../../../../models/content_sharing_session_collection_response'
...
module MicrosoftGraph
    module Communications
        module Calls
            module Item
                module ContentSharingSessions
                    ## 
                    # Provides operations to manage the contentSharingSessions property of the microsoft.graph.call entity.
                    class ContentSharingSessionsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/communications/calls/{call%2Did}/contentSharingSessions{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}")
                        end
                        ## 
                        ...
                        def get(request_configuration=nil)
                            ...
                            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraph::Models::ContentSharingSessionCollectionResponse.create_from_discriminator_value(pn) }, error_mapping)
                        end
                        ## 
                        ## Create new navigation property to contentSharingSessions for communications
                        ## @param body The request body
                        ## @param request_configuration Configuration for the request such as headers, query parameters, and middleware options.
                        ## @return a Fiber of content_sharing_session
                        ## 
                        ...
                        def to_post_request_information(body, request_configuration=nil)
                            ...
                            request_info.url_template = '{+baseurl}/communications/calls/{call%2Did}/contentSharingSessions'
                            request_info.path_parameters = @path_parameters
                        ...
                        ## @return a content_sharing_sessions_request_builder
                        ## 
                        def with_url(raw_url)
                            raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                            return ContentSharingSessionsRequestBuilder.new(raw_url, @request_adapter)
                        end
