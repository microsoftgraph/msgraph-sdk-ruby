        ...
        module Calls
            module Item
                module UpdateRecordingStatus
                    ...
                    class UpdateRecordingStatusRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        ## @return a update_recording_status_request_builder
                        ## 
                        def with_url(raw_url)
                            raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                            return UpdateRecordingStatusRequestBuilder.new(raw_url, @request_adapter)
                        end
                    end
                end
            end
