...
require_relative '../../../../models/play_prompt_operation'
        ...
        module Calls
            module Item
                module PlayPrompt
                    ...
                    class PlayPromptRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        ## @return a play_prompt_request_builder
                        ## 
                        def with_url(raw_url)
                            raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                            return PlayPromptRequestBuilder.new(raw_url, @request_adapter)
                        end
                    end
                end
            end
