...
module MicrosoftGraph::Communications::Calls::Item::Participants::MicrosoftGraphInvite
    ## 
    ...
    class InviteRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/communications/calls/{call%2Did}/participants/microsoft.graph.invite"
