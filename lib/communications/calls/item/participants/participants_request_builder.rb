            ...
            module Item
                module Participants
                    ...
                    class ParticipantsRequestBuilder
                        ...
                        def count()
                            return MicrosoftGraph::Communications::Calls::Item::Participants::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        # Provides operations to call the invite method.
                        def microsoft_graph_invite()
                            return MicrosoftGraph::Communications::Calls::Item::Participants::MicrosoftGraphInvite::MicrosoftGraphInviteRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ...
                        def initialize(path_parameters, request_adapter)
                            ...
                            @url_template = "{+baseurl}/communications/calls/{call%2Did}/participants{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
