    ...
    module Communications
        module Calls
            module Item
                module Participants
                    module Item
                        module StartHoldMusic
                            ## 
                            # Provides operations to call the startHoldMusic method.
                            class StartHoldMusicRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                ...
                                ## @return a start_hold_music_request_builder
                                ## 
                                def with_url(raw_url)
                                    raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                                    return StartHoldMusicRequestBuilder.new(raw_url, @request_adapter)
                                end
                            end
                        end
                    end
