            ...
            module CallRecordsGetDirectRoutingCallsWithFromDateTimeWithToDateTime
                ...
                class CallRecordsGetDirectRoutingCallsWithFromDateTimeWithToDateTimeRequestBuilder
                    ...
                    def initialize(path_parameters, request_adapter, from_date_time=nil, to_date_time=nil)
                        ...
                        @url_template = "{+baseurl}/communications/callRecords/callRecords.getDirectRoutingCalls(fromDateTime={fromDateTime},toDateTime={toDateTime}){?%24top,%24skip,%24search,%24filter,%24count}"
