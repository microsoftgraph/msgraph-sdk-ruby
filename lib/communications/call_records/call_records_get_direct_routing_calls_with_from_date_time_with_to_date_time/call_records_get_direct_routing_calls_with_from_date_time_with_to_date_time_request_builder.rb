    ...
    module Communications
        module CallRecords
            module CallRecordsGetDirectRoutingCallsWithFromDateTimeWithToDateTime
                ...
                class CallRecordsGetDirectRoutingCallsWithFromDateTimeWithToDateTimeRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def initialize(path_parameters, request_adapter, from_date_time=nil, to_date_time=nil)
                        super(path_parameters, request_adapter, "{+baseurl}/communications/callRecords/callRecords.getDirectRoutingCalls(fromDateTime={fromDateTime},toDateTime={toDateTime}){?%24top,%24skip,%24search,%24filter,%24count}")
                    end
                    ## 
                    ...
                    def get(request_configuration=nil)
                        ...
                        return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraph::Communications::CallRecords::CallRecordsGetDirectRoutingCallsWithFromDateTimeWithToDateTime::GetDirectRoutingCallsWithFromDateTimeWithToDateTimeResponse.create_from_discriminator_value(pn) }, error_mapping)
                    end
                    ## 
                    ## Invoke function getDirectRoutingCalls
                    ## @param request_configuration Configuration for the request such as headers, query parameters, and middleware options.
