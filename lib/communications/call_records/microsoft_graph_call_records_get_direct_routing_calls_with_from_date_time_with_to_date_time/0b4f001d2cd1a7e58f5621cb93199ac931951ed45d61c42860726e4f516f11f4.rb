            ...
            module MicrosoftGraphCallRecordsGetDirectRoutingCallsWithFromDateTimeWithToDateTime
                ...
                class MicrosoftGraphCallRecordsGetDirectRoutingCallsWithFromDateTimeWithToDateTimeRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def initialize(path_parameters, request_adapter, from_date_time=nil, to_date_time=nil)
                        super(path_parameters, request_adapter, "{+baseurl}/communications/callRecords/microsoft.graph.callRecords.getDirectRoutingCalls(fromDateTime={fromDateTime},toDateTime={toDateTime}){?%24count,%24filter,%24search,%24skip,%24top}")
                    end
                    ## 
                    ## Get a log of direct routing calls as a collection of directRoutingLogRow entries.
                    ## @param request_configuration Configuration for the request such as headers, query parameters, and middleware options.
                    ## @return a Fiber of get_direct_routing_calls_with_from_date_time_with_to_date_timeget_response
                    ## 
                    def get(request_configuration=nil)
                        ...
                        return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraph::Communications::CallRecords::MicrosoftGraphCallRecordsGetDirectRoutingCallsWithFromDateTimeWithToDateTime::GetDirectRoutingCallsWithFromDateTimeWithToDateTimegetResponse.create_from_discriminator_value(pn) }, error_mapping)
                    end
                    ## 
                    ## Get a log of direct routing calls as a collection of directRoutingLogRow entries.
                    ## @param request_configuration Configuration for the request such as headers, query parameters, and middleware options.
                    ...
                    def with_url(raw_url)
                        ...
                        return MicrosoftGraphCallRecordsGetDirectRoutingCallsWithFromDateTimeWithToDateTimeRequestBuilder.new(raw_url, @request_adapter)
                    end
