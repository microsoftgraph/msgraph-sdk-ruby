...
require_relative './item'
require_relative './microsoft_graph_reauthorize/microsoft_graph_reauthorize_request_builder'

module MicrosoftGraph::Sites::Item::Lists::Item::Subscriptions::Item
    ## 
    ...
    class SubscriptionItemRequestBuilder
        ...
        def microsoft_graph_reauthorize()
            return MicrosoftGraph::Sites::Item::Lists::Item::Subscriptions::Item::MicrosoftGraphReauthorize::MicrosoftGraphReauthorizeRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/sites/{site%2Did}/lists/{list%2Did}/subscriptions/{subscription%2Did}{?%24select,%24expand}"
