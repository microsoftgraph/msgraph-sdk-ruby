                            ...
                            module Versions
                                module Item
                                    ...
                                    class ListItemVersionItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                        ...
                                        def restore_version()
                                            return MicrosoftGraph::Sites::Item::Lists::Item::Items::Item::Versions::Item::RestoreVersion::RestoreVersionRequestBuilder.new(@path_parameters, @request_adapter)
                                        end
                                        ## 
                                        ...
                                        def initialize(path_parameters, request_adapter)
                                            super(path_parameters, request_adapter, "{+baseurl}/sites/{site%2Did}/lists/{list%2Did}/items/{listItem%2Did}/versions/{listItemVersion%2Did}{?%24expand,%24select}")
                                        end
                                        ## 
                                        ...
                                        def to_delete_request_information(request_configuration=nil)
                                            ...
                                            request_info.url_template = '{+baseurl}/sites/{site%2Did}/lists/{list%2Did}/items/{listItem%2Did}/versions/{listItemVersion%2Did}'
