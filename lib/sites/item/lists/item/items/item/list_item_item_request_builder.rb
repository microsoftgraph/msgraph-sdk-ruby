...
module MicrosoftGraph::Sites::Item::Lists::Item::Items::Item
    ## 
    ...
    class ListItemItemRequestBuilder
        ...
        def microsoft_graph_get_activities_by_interval()
            return MicrosoftGraph::Sites::Item::Lists::Item::Items::Item::MicrosoftGraphGetActivitiesByInterval::MicrosoftGraphGetActivitiesByIntervalRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
