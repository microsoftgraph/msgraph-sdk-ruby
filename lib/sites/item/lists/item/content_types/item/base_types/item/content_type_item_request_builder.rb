...
module MicrosoftGraph::Sites::Item::Lists::Item::ContentTypes::Item::BaseTypes::Item
    ## 
    ...
    class ContentTypeItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, content_type_id1=nil)
            ...
            @url_template = "{+baseurl}/sites/{site%2Did}/lists/{list%2Did}/contentTypes/{contentType%2Did}/baseTypes/{contentType%2Did1}{?%24select,%24expand}"
