...
module MicrosoftGraph::Sites::Item::Lists::Item::ContentTypes::Item::ColumnPositions::Item
    ## 
    ...
    class ColumnDefinitionItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, column_definition_id=)
            ...
            @url_template = "{+baseurl}/sites/{site%2Did}/lists/{list%2Did}/contentTypes/{contentType%2Did}/columnPositions/{columnDefinition%2Did}{?%24select,%24expand}"
