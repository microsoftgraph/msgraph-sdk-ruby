...
module MicrosoftGraph::Sites::Item::Lists::Item::ContentTypes::Item
    ## 
    ...
    class ContentTypeItemRequestBuilder
        ...
        def base()
            return MicrosoftGraph::Sites::Item::Lists::Item::ContentTypes::Item::Base::BaseRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def microsoft_graph_associate_with_hub_sites()
            return MicrosoftGraph::Sites::Item::Lists::Item::ContentTypes::Item::MicrosoftGraphAssociateWithHubSites::MicrosoftGraphAssociateWithHubSitesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the copyToDefaultContentLocation method.
        def microsoft_graph_copy_to_default_content_location()
            return MicrosoftGraph::Sites::Item::Lists::Item::ContentTypes::Item::MicrosoftGraphCopyToDefaultContentLocation::MicrosoftGraphCopyToDefaultContentLocationRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the isPublished method.
        def microsoft_graph_is_published()
            return MicrosoftGraph::Sites::Item::Lists::Item::ContentTypes::Item::MicrosoftGraphIsPublished::MicrosoftGraphIsPublishedRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the publish method.
        def microsoft_graph_publish()
            return MicrosoftGraph::Sites::Item::Lists::Item::ContentTypes::Item::MicrosoftGraphPublish::MicrosoftGraphPublishRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the unpublish method.
        def microsoft_graph_unpublish()
            return MicrosoftGraph::Sites::Item::Lists::Item::ContentTypes::Item::MicrosoftGraphUnpublish::MicrosoftGraphUnpublishRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def base_types_by_id(id)
            ...
            return MicrosoftGraph::Sites::Item::Lists::Item::ContentTypes::Item::BaseTypes::Item::ContentTypeItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the columnLinks property of the microsoft.graph.contentType entity.
        ## @param id Unique identifier of the item
        ...
        def column_links_by_id(id)
            ...
            return MicrosoftGraph::Sites::Item::Lists::Item::ContentTypes::Item::ColumnLinks::Item::ColumnLinkItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the columnPositions property of the microsoft.graph.contentType entity.
        ## @param id Unique identifier of the item
        ...
        def column_positions_by_id(id)
            ...
            return MicrosoftGraph::Sites::Item::Lists::Item::ContentTypes::Item::ColumnPositions::Item::ColumnDefinitionItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the columns property of the microsoft.graph.contentType entity.
        ## @param id Unique identifier of the item
        ...
        def columns_by_id(id)
            ...
            url_tpl_params = @path_parameters.clone
            url_tpl_params["columnDefinition%2Did"] = id
            return MicrosoftGraph::Sites::Item::Lists::Item::ContentTypes::Item::Columns::Item::ColumnDefinitionItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/sites/{site%2Did}/lists/{list%2Did}/contentTypes/{contentType%2Did}{?%24select,%24expand}"
