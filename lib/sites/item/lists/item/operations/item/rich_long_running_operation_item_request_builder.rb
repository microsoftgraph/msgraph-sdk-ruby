...
module MicrosoftGraph::Sites::Item::Lists::Item::Operations::Item
    ## 
    ...
    class RichLongRunningOperationItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, rich_long_running_operation_id=nil)
            ...
            @url_template = "{+baseurl}/sites/{site%2Did}/lists/{list%2Did}/operations/{richLongRunningOperation%2Did}{?%24select,%24expand}"
