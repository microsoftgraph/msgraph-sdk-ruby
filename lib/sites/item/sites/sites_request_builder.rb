        ...
        module Item
            module Sites
                ...
                class SitesRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def add()
                        return MicrosoftGraph::Sites::Item::Sites::Add::AddRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ...
                    def remove()
                        return MicrosoftGraph::Sites::Item::Sites::Remove::RemoveRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ## Provides operations to manage the sites property of the microsoft.graph.site entity.
                    ...
                    def initialize(path_parameters, request_adapter)
                        super(path_parameters, request_adapter, "{+baseurl}/sites/{site%2Did}/sites{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}")
                    end
                    ## 
