                ...
                module Remove
                    ...
                    class RemoveRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/sites/{site%2Did}/sites/remove")
                        end
                        ## 
                        ...
                        def post(body, request_configuration=nil)
                            ...
                            return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraph::Sites::Item::Sites::Remove::RemovePostResponse.create_from_discriminator_value(pn) }, error_mapping)
                        end
                        ## 
                        ## Unfollow a user's site or multiple sites.
                        ## @param body The request body
