...
module MicrosoftGraph::Sites::Item::MicrosoftGraphGetByPathWithPath
    ## 
    # Provides operations to call the getByPath method.
    class MicrosoftGraphGetByPathWithPathRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, path=nil)
            ...
            @url_template = "{+baseurl}/sites/{site%2Did}/microsoft.graph.getByPath(path='{path}')"
        ...
        class MicrosoftGraphGetByPathWithPathRequestBuilderGetRequestConfiguration
