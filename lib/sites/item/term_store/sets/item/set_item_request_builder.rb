...
module MicrosoftGraph::Sites::Item::TermStore::Sets::Item
    ## 
    ...
    class SetItemRequestBuilder
        ...
        def children()
            return MicrosoftGraph::Sites::Item::TermStore::Sets::Item::Children::ChildrenRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the parentGroup property of the microsoft.graph.termStore.set entity.
        def parent_group()
            return MicrosoftGraph::Sites::Item::TermStore::Sets::Item::ParentGroup::ParentGroupRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def relations()
            return MicrosoftGraph::Sites::Item::TermStore::Sets::Item::Relations::RelationsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def terms()
            return MicrosoftGraph::Sites::Item::TermStore::Sets::Item::Terms::TermsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def children_by_id(id)
            ...
            return MicrosoftGraph::Sites::Item::TermStore::Sets::Item::Children::Item::TermItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter, set_id=nil)
            ...
            @url_template = "{+baseurl}/sites/{site%2Did}/termStore/sets/{set%2Did}{?%24select,%24expand}"
        ...
        def relations_by_id(id)
            ...
            return MicrosoftGraph::Sites::Item::TermStore::Sets::Item::Relations::Item::RelationItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Provides operations to manage the terms property of the microsoft.graph.termStore.set entity.
        ## @param id Unique identifier of the item
        ...
        def terms_by_id(id)
            ...
            url_tpl_params = @path_parameters.clone
            url_tpl_params["term%2Did"] = id
            return MicrosoftGraph::Sites::Item::TermStore::Sets::Item::Terms::Item::TermItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Delete navigation property sets for sites
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
