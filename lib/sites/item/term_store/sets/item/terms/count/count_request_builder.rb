...
module MicrosoftGraph::Sites::Item::TermStore::Sets::Item::Terms::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/sites/{site%2Did}/termStore/sets/{set%2Did}/terms/$count{?%24search,%24filter}"
