...
module MicrosoftGraph::Sites::Item::TermStore::Sets::Item::Terms::Item::Children::Item
    ## 
    ...
    class TermItemRequestBuilder
        ...
        def relations()
            return MicrosoftGraph::Sites::Item::TermStore::Sets::Item::Terms::Item::Children::Item::Relations::RelationsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def set()
            return MicrosoftGraph::Sites::Item::TermStore::Sets::Item::Terms::Item::Children::Item::Set::SetRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter, term_id1=nil)
            ...
            @url_template = "{+baseurl}/sites/{site%2Did}/termStore/sets/{set%2Did}/terms/{term%2Did}/children/{term%2Did1}{?%24select,%24expand}"
