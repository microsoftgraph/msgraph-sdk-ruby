...
module MicrosoftGraph::Sites::Item::TermStore::Sets::Item::Terms::Item::Relations::Item
    ## 
    ...
    class RelationItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, relation_id=nil)
            ...
            @url_template = "{+baseurl}/sites/{site%2Did}/termStore/sets/{set%2Did}/terms/{term%2Did}/relations/{relation%2Did}{?%24select,%24expand}"
