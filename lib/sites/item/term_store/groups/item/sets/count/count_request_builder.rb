...
module MicrosoftGraph::Sites::Item::TermStore::Groups::Item::Sets::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/sites/{site%2Did}/termStore/groups/{group%2Did}/sets/$count{?%24search,%24filter}"
