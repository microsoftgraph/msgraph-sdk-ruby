...
module MicrosoftGraph::Sites::Item::TermStore::Groups::Item::Sets::Item::Children::Item
    ## 
    ...
    class TermItemRequestBuilder
        ...
        def children()
            return MicrosoftGraph::Sites::Item::TermStore::Groups::Item::Sets::Item::Children::Item::Children::ChildrenRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def relations()
            return MicrosoftGraph::Sites::Item::TermStore::Groups::Item::Sets::Item::Children::Item::Relations::RelationsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def set()
            return MicrosoftGraph::Sites::Item::TermStore::Groups::Item::Sets::Item::Children::Item::Set::SetRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def children_by_id(id)
            ...
            return MicrosoftGraph::Sites::Item::TermStore::Groups::Item::Sets::Item::Children::Item::Children::Item::TermItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter, term_id=nil)
            ...
            @url_template = "{+baseurl}/sites/{site%2Did}/termStore/groups/{group%2Did}/sets/{set%2Did}/children/{term%2Did}{?%24select,%24expand}"
        ...
        def relations_by_id(id)
            ...
            return MicrosoftGraph::Sites::Item::TermStore::Groups::Item::Sets::Item::Children::Item::Relations::Item::RelationItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
        ## Delete navigation property children for sites
        ## @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
