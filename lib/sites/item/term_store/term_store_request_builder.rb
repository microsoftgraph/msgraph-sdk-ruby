    ...
    module Sites
        module Item
            module TermStore
                ...
                class TermStoreRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    
                    ## 
                    # Provides operations to manage the groups property of the microsoft.graph.termStore.store entity.
                    def groups()
                        return MicrosoftGraph::Sites::Item::TermStore::Groups::GroupsRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    # Provides operations to manage the sets property of the microsoft.graph.termStore.store entity.
                    def sets()
                        return MicrosoftGraph::Sites::Item::TermStore::Sets::SetsRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ...
                    def initialize(path_parameters, request_adapter)
                        super(path_parameters, request_adapter, "{+baseurl}/sites/{site%2Did}/termStore{?%24select,%24expand}")
                    end
                    ## 
                    ...
                    def groups_by_id(id)
                        ...
                        return MicrosoftGraph::Sites::Item::TermStore::Groups::Item::GroupItemRequestBuilder.new(url_tpl_params, @request_adapter)
                    end
                    ## 
                    ...
                    def sets_by_id(id)
                        ...
                        return MicrosoftGraph::Sites::Item::TermStore::Sets::Item::SetItemRequestBuilder.new(url_tpl_params, @request_adapter)
                    end
                    ## 
                    ## Delete navigation property termStore for sites
                    ## @param request_configuration Configuration for the request such as headers, query parameters, and middleware options.
