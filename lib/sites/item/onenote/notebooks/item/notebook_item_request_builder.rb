                ...
                module Notebooks
                    module Item
                        ...
                        class NotebookItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            def copy_notebook()
                                return MicrosoftGraph::Sites::Item::Onenote::Notebooks::Item::CopyNotebook::CopyNotebookRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            # Provides operations to manage the sectionGroups property of the microsoft.graph.notebook entity.
                            def section_groups()
                                return MicrosoftGraph::Sites::Item::Onenote::Notebooks::Item::SectionGroups::SectionGroupsRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            # Provides operations to manage the sections property of the microsoft.graph.notebook entity.
                            def sections()
                                return MicrosoftGraph::Sites::Item::Onenote::Notebooks::Item::Sections::SectionsRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            ...
                            def initialize(path_parameters, request_adapter)
                                super(path_parameters, request_adapter, "{+baseurl}/sites/{site%2Did}/onenote/notebooks/{notebook%2Did}{?%24expand,%24select}")
                            end
                            ## 
                            ...
                            def to_delete_request_information(request_configuration=nil)
                                ...
                                request_info.url_template = '{+baseurl}/sites/{site%2Did}/onenote/notebooks/{notebook%2Did}'
