...
module MicrosoftGraph::Sites::Item::Onenote::Notebooks::Item
    ## 
    ...
    class NotebookItemRequestBuilder
        ...
        def microsoft_graph_copy_notebook()
            return MicrosoftGraph::Sites::Item::Onenote::Notebooks::Item::MicrosoftGraphCopyNotebook::MicrosoftGraphCopyNotebookRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/sites/{site%2Did}/onenote/notebooks/{notebook%2Did}{?%24select,%24expand}"
