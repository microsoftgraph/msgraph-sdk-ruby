...
module MicrosoftGraph::Sites::Item::Onenote::Notebooks::Item::MicrosoftGraphCopyNotebook
    ## 
    ...
    class CopyNotebookRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/sites/{site%2Did}/onenote/notebooks/{notebook%2Did}/microsoft.graph.copyNotebook"
