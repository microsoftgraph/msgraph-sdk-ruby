...
module MicrosoftGraph::Sites::Item::Onenote::Sections::Item
    ## 
    ...
    class OnenoteSectionItemRequestBuilder
        ...
        def microsoft_graph_copy_to_notebook()
            return MicrosoftGraph::Sites::Item::Onenote::Sections::Item::MicrosoftGraphCopyToNotebook::MicrosoftGraphCopyToNotebookRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the copyToSectionGroup method.
        def microsoft_graph_copy_to_section_group()
            return MicrosoftGraph::Sites::Item::Onenote::Sections::Item::MicrosoftGraphCopyToSectionGroup::MicrosoftGraphCopyToSectionGroupRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the pages property of the microsoft.graph.onenoteSection entity.
        def pages()
            return MicrosoftGraph::Sites::Item::Onenote::Sections::Item::Pages::PagesRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the parentNotebook property of the microsoft.graph.onenoteSection entity.
        def parent_notebook()
            return MicrosoftGraph::Sites::Item::Onenote::Sections::Item::ParentNotebook::ParentNotebookRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def parent_section_group()
            return MicrosoftGraph::Sites::Item::Onenote::Sections::Item::ParentSectionGroup::ParentSectionGroupRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/sites/{site%2Did}/onenote/sections/{onenoteSection%2Did}{?%24select,%24expand}"
        ...
        def pages_by_id(id)
            ...
            return MicrosoftGraph::Sites::Item::Onenote::Sections::Item::Pages::Item::OnenotePageItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
        ## 
