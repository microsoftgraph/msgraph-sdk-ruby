...
module MicrosoftGraph::Sites::Item::Onenote::Operations::Item
    ## 
    ...
    class OnenoteOperationItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, onenote_operation_id=nil)
            ...
            @url_template = "{+baseurl}/sites/{site%2Did}/onenote/operations/{onenoteOperation%2Did}{?%24select,%24expand}"
