...
module MicrosoftGraph::Sites::Item::TermStores::Item::Sets::Item::Terms::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/sites/{site%2Did}/termStores/{store%2Did}/sets/{set%2Did}/terms/$count{?%24search,%24filter}"
