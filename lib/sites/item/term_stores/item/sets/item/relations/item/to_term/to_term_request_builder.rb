...
module MicrosoftGraph::Sites::Item::TermStores::Item::Sets::Item::Relations::Item::ToTerm
    ## 
    ...
    class ToTermRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/sites/{site%2Did}/termStores/{store%2Did}/sets/{set%2Did}/relations/{relation%2Did}/toTerm{?%24select,%24expand}"
