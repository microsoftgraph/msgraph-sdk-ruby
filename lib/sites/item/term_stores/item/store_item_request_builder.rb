        ...
        module Item
            module TermStores
                module Item
                    ...
                    class StoreItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        
                        ## 
                        # Provides operations to manage the groups property of the microsoft.graph.termStore.store entity.
                        def groups()
                            return MicrosoftGraph::Sites::Item::TermStores::Item::Groups::GroupsRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        # Provides operations to manage the sets property of the microsoft.graph.termStore.store entity.
                        def sets()
                            return MicrosoftGraph::Sites::Item::TermStores::Item::Sets::SetsRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/sites/{site%2Did}/termStores/{store%2Did}{?%24expand,%24select}")
                        end
                        ## 
                        ...
                        def to_delete_request_information(request_configuration=nil)
                            ...
                            request_info.url_template = '{+baseurl}/sites/{site%2Did}/termStores/{store%2Did}'
                        ...
                        def with_url(raw_url)
                            ...
                            return StoreItemRequestBuilder.new(raw_url, @request_adapter)
                        end
