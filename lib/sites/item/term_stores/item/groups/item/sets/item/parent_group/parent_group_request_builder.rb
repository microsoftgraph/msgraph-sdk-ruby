...
module MicrosoftGraph::Sites::Item::TermStores::Item::Groups::Item::Sets::Item::ParentGroup
    ## 
    ...
    class ParentGroupRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/sites/{site%2Did}/termStores/{store%2Did}/groups/{group%2Did}/sets/{set%2Did}/parentGroup{?%24select,%24expand}"
