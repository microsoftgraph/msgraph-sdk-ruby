...
module MicrosoftGraph::Sites::Item::TermStores::Item::Groups::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/sites/{site%2Did}/termStores/{store%2Did}/groups/$count{?%24search,%24filter}"
