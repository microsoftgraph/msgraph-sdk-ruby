...
module MicrosoftGraph::Sites::Item
    ## 
    ...
    class SiteItemRequestBuilder
        ...
        def microsoft_graph_get_activities_by_interval()
            return MicrosoftGraph::Sites::Item::MicrosoftGraphGetActivitiesByInterval::GetActivitiesByIntervalRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
