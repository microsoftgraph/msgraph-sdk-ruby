...
module MicrosoftGraph::Localizations::Item
    ## 
    ...
    class OrganizationalBrandingLocalizationItemRequestBuilder
        ...
        def background_image()
            return MicrosoftGraph::Localizations::Item::BackgroundImage::BackgroundImageRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the media for the organizationalBrandingLocalization entity.
        def banner_logo()
            return MicrosoftGraph::Localizations::Item::BannerLogo::BannerLogoRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, organizational_branding_localization_id=)
