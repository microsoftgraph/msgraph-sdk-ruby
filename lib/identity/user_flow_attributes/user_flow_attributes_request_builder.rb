...
require_relative '../../models/identity_user_flow_attribute'
...
module MicrosoftGraph
    module Identity
        module UserFlowAttributes
            ## 
            # Provides operations to manage the userFlowAttributes property of the microsoft.graph.identityContainer entity.
            class UserFlowAttributesRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def initialize(path_parameters, request_adapter)
                    super(path_parameters, request_adapter, "{+baseurl}/identity/userFlowAttributes{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}")
                end
                ## 
                ...
                def to_post_request_information(body, request_configuration=nil)
                    ...
                    request_info.url_template = '{+baseurl}/identity/userFlowAttributes'
                    request_info.path_parameters = @path_parameters
                ...
                ## @return a user_flow_attributes_request_builder
                ## 
                def with_url(raw_url)
                    raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                    return UserFlowAttributesRequestBuilder.new(raw_url, @request_adapter)
                end
