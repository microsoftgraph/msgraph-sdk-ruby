...
require_relative '../../models/b2x_identity_user_flow_collection_response'
...
module MicrosoftGraph
    module Identity
        module B2xUserFlows
            ...
            class B2xUserFlowsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def initialize(path_parameters, request_adapter)
                    super(path_parameters, request_adapter, "{+baseurl}/identity/b2xUserFlows{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}")
                end
                ## 
                ...
                def to_post_request_information(body, request_configuration=nil)
                    ...
                    request_info.url_template = '{+baseurl}/identity/b2xUserFlows'
                    request_info.path_parameters = @path_parameters
                ...
                ## @return a b2x_user_flows_request_builder
                ## 
                def with_url(raw_url)
                    raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                    return B2xUserFlowsRequestBuilder.new(raw_url, @request_adapter)
                end
