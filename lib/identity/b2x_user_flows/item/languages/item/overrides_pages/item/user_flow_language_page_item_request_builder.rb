...
module MicrosoftGraph::Identity::B2xUserFlows::Item::Languages::Item::OverridesPages::Item
    ...
    class UserFlowLanguagePageItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, user_flow_language_page_id=nil)
            ...
            @url_template = "{+baseurl}/identity/b2xUserFlows/{b2xIdentityUserFlow%2Did}/languages/{userFlowLanguageConfiguration%2Did}/overridesPages/{userFlowLanguagePage%2Did}{?%24select,%24expand}"
