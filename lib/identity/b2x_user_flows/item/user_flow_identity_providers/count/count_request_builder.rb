...
module MicrosoftGraph::Identity::B2xUserFlows::Item::UserFlowIdentityProviders::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/identity/b2xUserFlows/{b2xIdentityUserFlow%2Did}/userFlowIdentityProviders/$count{?%24search,%24filter}"
