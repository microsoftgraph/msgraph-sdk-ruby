            ...
            module Item
                module UserAttributeAssignments
                    module SetOrder
                        ...
                        class SetOrderRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            def initialize(path_parameters, request_adapter)
                                super(path_parameters, request_adapter, "{+baseurl}/identity/b2xUserFlows/{b2xIdentityUserFlow%2Did}/userAttributeAssignments/setOrder")
                            end
                            ## 
                            ...
                            ## @return a set_order_request_builder
                            ## 
                            def with_url(raw_url)
                                raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                                return SetOrderRequestBuilder.new(raw_url, @request_adapter)
                            end
                        end
                    end
                end
