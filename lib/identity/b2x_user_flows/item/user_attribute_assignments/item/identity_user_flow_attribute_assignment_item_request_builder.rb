...
require_relative '../../../../../models/identity_user_flow_attribute_assignment'
...
require_relative './item'
require_relative './user_attribute/user_attribute_request_builder'
            ...
            module Item
                module UserAttributeAssignments
                    module Item
                        ...
                        class IdentityUserFlowAttributeAssignmentItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            def user_attribute()
                                return MicrosoftGraph::Identity::B2xUserFlows::Item::UserAttributeAssignments::Item::UserAttribute::UserAttributeRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            ...
                            def initialize(path_parameters, request_adapter)
                                super(path_parameters, request_adapter, "{+baseurl}/identity/b2xUserFlows/{b2xIdentityUserFlow%2Did}/userAttributeAssignments/{identityUserFlowAttributeAssignment%2Did}{?%24expand,%24select}")
                            end
                            ## 
                            ...
                            def to_delete_request_information(request_configuration=nil)
                                ...
                                request_info.url_template = '{+baseurl}/identity/b2xUserFlows/{b2xIdentityUserFlow%2Did}/userAttributeAssignments/{identityUserFlowAttributeAssignment%2Did}'
                            ...
                            def with_url(raw_url)
                                ...
                                return IdentityUserFlowAttributeAssignmentItemRequestBuilder.new(raw_url, @request_adapter)
                            end
