...
module MicrosoftGraph::Identity::ConditionalAccess::Policies::Item
    ## 
    ...
    class ConditionalAccessPolicyItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, conditional_access_policy_id=nil)
            ...
            @url_template = "{+baseurl}/identity/conditionalAccess/policies/{conditionalAccessPolicy%2Did}{?%24select,%24expand}"
