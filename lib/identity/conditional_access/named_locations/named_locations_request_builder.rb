...
require_relative '../../../models/named_location'
require_relative '../../../models/named_location_collection_response'
...
module MicrosoftGraph
    module Identity
        module ConditionalAccess
            module NamedLocations
                ## 
                # Provides operations to manage the namedLocations property of the microsoft.graph.conditionalAccessRoot entity.
                class NamedLocationsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def initialize(path_parameters, request_adapter)
                        super(path_parameters, request_adapter, "{+baseurl}/identity/conditionalAccess/namedLocations{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}")
                    end
                    ## 
                    ...
                    def to_post_request_information(body, request_configuration=nil)
                        ...
                        request_info.url_template = '{+baseurl}/identity/conditionalAccess/namedLocations'
                        request_info.path_parameters = @path_parameters
                    ...
                    ## @return a named_locations_request_builder
                    ## 
                    def with_url(raw_url)
                        raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                        return NamedLocationsRequestBuilder.new(raw_url, @request_adapter)
                    end
