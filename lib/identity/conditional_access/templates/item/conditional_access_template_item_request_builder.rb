        ...
        module ConditionalAccess
            module Templates
                module Item
                    ...
                    class ConditionalAccessTemplateItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/identity/conditionalAccess/templates/{conditionalAccessTemplate%2Did}{?%24expand,%24select}")
                        end
                        ## 
                        ...
                        def with_url(raw_url)
                            ...
                            return ConditionalAccessTemplateItemRequestBuilder.new(raw_url, @request_adapter)
                        end
