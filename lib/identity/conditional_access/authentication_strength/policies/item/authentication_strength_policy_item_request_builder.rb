                    ...
                    module Item
                        ...
                        class AuthenticationStrengthPolicyItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            def combination_configurations()
                                return MicrosoftGraph::Identity::ConditionalAccess::AuthenticationStrength::Policies::Item::CombinationConfigurations::CombinationConfigurationsRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            # Provides operations to call the updateAllowedCombinations method.
                            def update_allowed_combinations()
                                return MicrosoftGraph::Identity::ConditionalAccess::AuthenticationStrength::Policies::Item::UpdateAllowedCombinations::UpdateAllowedCombinationsRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            # Provides operations to call the usage method.
                            def usage()
                                return MicrosoftGraph::Identity::ConditionalAccess::AuthenticationStrength::Policies::Item::Usage::UsageRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            ...
                            def initialize(path_parameters, request_adapter)
                                super(path_parameters, request_adapter, "{+baseurl}/identity/conditionalAccess/authenticationStrength/policies/{authenticationStrengthPolicy%2Did}{?%24expand,%24select}")
                            end
                            ## 
                            ...
                            def to_delete_request_information(request_configuration=nil)
                                ...
                                request_info.url_template = '{+baseurl}/identity/conditionalAccess/authenticationStrength/policies/{authenticationStrengthPolicy%2Did}'
                            ...
                            def with_url(raw_url)
                                ...
                                return AuthenticationStrengthPolicyItemRequestBuilder.new(raw_url, @request_adapter)
                            end
