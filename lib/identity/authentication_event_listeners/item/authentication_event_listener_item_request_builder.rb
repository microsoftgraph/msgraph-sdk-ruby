    ...
    module Identity
        module AuthenticationEventListeners
            module Item
                ...
                class AuthenticationEventListenerItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def initialize(path_parameters, request_adapter)
                        super(path_parameters, request_adapter, "{+baseurl}/identity/authenticationEventListeners/{authenticationEventListener%2Did}{?%24expand,%24select}")
                    end
                    ## 
                    ...
                    def with_url(raw_url)
                        ...
                        return AuthenticationEventListenerItemRequestBuilder.new(raw_url, @request_adapter)
                    end
