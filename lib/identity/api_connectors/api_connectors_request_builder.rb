...
require_relative '../../models/identity_api_connector_collection_response'
...
module MicrosoftGraph
    module Identity
        module ApiConnectors
            ...
            class ApiConnectorsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def initialize(path_parameters, request_adapter)
                    super(path_parameters, request_adapter, "{+baseurl}/identity/apiConnectors{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}")
                end
                ## 
                ## Read the properties of an identityApiConnector object.
                ## @param request_configuration Configuration for the request such as headers, query parameters, and middleware options.
                ## @return a Fiber of identity_api_connector_collection_response
                ## 
                def get(request_configuration=nil)
                    ...
                    return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraph::Models::IdentityApiConnectorCollectionResponse.create_from_discriminator_value(pn) }, error_mapping)
                end
                ## 
                ...
                def to_post_request_information(body, request_configuration=nil)
                    ...
                    request_info.url_template = '{+baseurl}/identity/apiConnectors'
                    request_info.path_parameters = @path_parameters
                ...
                ## @return a api_connectors_request_builder
                ## 
                def with_url(raw_url)
                    raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                    return ApiConnectorsRequestBuilder.new(raw_url, @request_adapter)
                end
