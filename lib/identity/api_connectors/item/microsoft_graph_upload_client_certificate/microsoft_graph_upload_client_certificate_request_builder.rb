...
require_relative './microsoft_graph_upload_client_certificate'

module MicrosoftGraph::Identity::ApiConnectors::Item::MicrosoftGraphUploadClientCertificate
    ## 
    # Provides operations to call the uploadClientCertificate method.
    class MicrosoftGraphUploadClientCertificateRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/identity/apiConnectors/{identityApiConnector%2Did}/microsoft.graph.uploadClientCertificate"
        ...
        class MicrosoftGraphUploadClientCertificateRequestBuilderPostRequestConfiguration
