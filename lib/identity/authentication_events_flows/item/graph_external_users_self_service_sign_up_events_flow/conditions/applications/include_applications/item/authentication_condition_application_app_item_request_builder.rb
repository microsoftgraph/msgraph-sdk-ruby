                        ...
                        module Applications
                            module IncludeApplications
                                module Item
                                    ...
                                    class AuthenticationConditionApplicationAppItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                        ...
                                        def initialize(path_parameters, request_adapter)
                                            super(path_parameters, request_adapter, "{+baseurl}/identity/authenticationEventsFlows/{authenticationEventsFlow%2Did}/graph.externalUsersSelfServiceSignUpEventsFlow/conditions/applications/includeApplications/{authenticationConditionApplication%2DappId}{?%24expand,%24select}")
                                        end
                                        ## 
                                        ...
                                        def with_url(raw_url)
                                            ...
                                            return AuthenticationConditionApplicationAppItemRequestBuilder.new(raw_url, @request_adapter)
                                        end
