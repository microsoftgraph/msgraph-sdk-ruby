                        ...
                        module GraphOnAuthenticationMethodLoadStartExternalUsersSelfServiceSignUp
                            module IdentityProviders
                                ...
                                class IdentityProvidersRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                    ...
                                    def count()
                                        return MicrosoftGraph::Identity::AuthenticationEventsFlows::Item::GraphExternalUsersSelfServiceSignUpEventsFlow::OnAuthenticationMethodLoadStart::GraphOnAuthenticationMethodLoadStartExternalUsersSelfServiceSignUp::IdentityProviders::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                                    end
                                    ## 
                                    # Provides operations to manage the collection of identityContainer entities.
                                    def ref()
                                        return MicrosoftGraph::Identity::AuthenticationEventsFlows::Item::GraphExternalUsersSelfServiceSignUpEventsFlow::OnAuthenticationMethodLoadStart::GraphOnAuthenticationMethodLoadStartExternalUsersSelfServiceSignUp::IdentityProviders::Ref::RefRequestBuilder.new(@path_parameters, @request_adapter)
                                    end
                                    ## 
                                    ## Gets an item from the MicrosoftGraph.identity.authenticationEventsFlows.item.graphExternalUsersSelfServiceSignUpEventsFlow.onAuthenticationMethodLoadStart.graphOnAuthenticationMethodLoadStartExternalUsersSelfServiceSignUp.identityProviders.item collection
                                    ...
                                    def by_identity_provider_base_id(identity_provider_base_id)
                                        ...
                                        return MicrosoftGraph::Identity::AuthenticationEventsFlows::Item::GraphExternalUsersSelfServiceSignUpEventsFlow::OnAuthenticationMethodLoadStart::GraphOnAuthenticationMethodLoadStartExternalUsersSelfServiceSignUp::IdentityProviders::Item::IdentityProviderBaseItemRequestBuilder.new(url_tpl_params, @request_adapter)
                                    end
                                    ## 
                                    ...
                                    ## @return a identity_providers_request_builder
                                    ## 
                                    def with_url(raw_url)
                                        raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                                        return IdentityProvidersRequestBuilder.new(raw_url, @request_adapter)
                                    end
