...
require_relative '../../../../../../../models/identity_user_flow_attribute_collection_response'
...
require_relative './item/be558a88b882b2fd237e0cfbe4d857b74a11d0308b75adea0ff3750487ff475c'
                    ...
                    module OnAttributeCollection
                        module GraphOnAttributeCollectionExternalUsersSelfServiceSignUp
                            module Attributes
                                ...
                                class AttributesRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                    
                                    ## 
                                    # Provides operations to count the resources in the collection.
                                    def count()
                                        return MicrosoftGraph::Identity::AuthenticationEventsFlows::Item::GraphExternalUsersSelfServiceSignUpEventsFlow::OnAttributeCollection::GraphOnAttributeCollectionExternalUsersSelfServiceSignUp::Attributes::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
                                    end
                                    ## 
                                    # Provides operations to manage the collection of identityContainer entities.
                                    def ref()
                                        return MicrosoftGraph::Identity::AuthenticationEventsFlows::Item::GraphExternalUsersSelfServiceSignUpEventsFlow::OnAttributeCollection::GraphOnAttributeCollectionExternalUsersSelfServiceSignUp::Attributes::Ref::RefRequestBuilder.new(@path_parameters, @request_adapter)
                                    end
                                    ## 
                                    ## Gets an item from the MicrosoftGraph.identity.authenticationEventsFlows.item.graphExternalUsersSelfServiceSignUpEventsFlow.onAttributeCollection.graphOnAttributeCollectionExternalUsersSelfServiceSignUp.attributes.item collection
                                    ...
                                    def by_identity_user_flow_attribute_id(identity_user_flow_attribute_id)
                                        ...
                                        return MicrosoftGraph::Identity::AuthenticationEventsFlows::Item::GraphExternalUsersSelfServiceSignUpEventsFlow::OnAttributeCollection::GraphOnAttributeCollectionExternalUsersSelfServiceSignUp::Attributes::Item::IdentityUserFlowAttributeItemRequestBuilder.new(url_tpl_params, @request_adapter)
                                    end
                                    ## 
                                    ...
                                    ## @return a attributes_request_builder
                                    ## 
                                    def with_url(raw_url)
                                        raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                                        return AttributesRequestBuilder.new(raw_url, @request_adapter)
                                    end
