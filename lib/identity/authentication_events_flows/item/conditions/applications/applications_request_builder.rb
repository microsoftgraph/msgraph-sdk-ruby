                    ...
                    module Applications
                        ...
                        class ApplicationsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            def include_applications()
                                return MicrosoftGraph::Identity::AuthenticationEventsFlows::Item::Conditions::Applications::IncludeApplications::IncludeApplicationsRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            ...
                            def initialize(path_parameters, request_adapter)
                                super(path_parameters, request_adapter, "{+baseurl}/identity/authenticationEventsFlows/{authenticationEventsFlow%2Did}/conditions/applications")
                            end
                        end
                    end
                end
