        ...
        module AuthenticationEventsFlows
            module Item
                ...
                class AuthenticationEventsFlowItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                    ...
                    def conditions()
                        return MicrosoftGraph::Identity::AuthenticationEventsFlows::Item::Conditions::ConditionsRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ...
                    def graph_external_users_self_service_sign_up_events_flow()
                        return MicrosoftGraph::Identity::AuthenticationEventsFlows::Item::GraphExternalUsersSelfServiceSignUpEventsFlow::GraphExternalUsersSelfServiceSignUpEventsFlowRequestBuilder.new(@path_parameters, @request_adapter)
                    end
                    ## 
                    ...
                    def initialize(path_parameters, request_adapter)
                        super(path_parameters, request_adapter, "{+baseurl}/identity/authenticationEventsFlows/{authenticationEventsFlow%2Did}{?%24expand,%24select}")
                    end
                    ## 
