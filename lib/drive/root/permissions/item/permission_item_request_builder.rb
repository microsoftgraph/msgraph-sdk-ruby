...
module MicrosoftGraph::Drive::Root::Permissions::Item
    ## 
    ...
    class PermissionItemRequestBuilder
        ...
        def grant()
            return MicrosoftGraph::Drive::Root::Permissions::Item::Grant::GrantRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/drive/root/permissions/{permission%2Did}{?%24select,%24expand}"
