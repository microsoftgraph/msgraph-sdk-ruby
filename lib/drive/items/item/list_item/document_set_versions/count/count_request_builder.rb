...
module MicrosoftGraph::Drive::Items::Item::ListItem::DocumentSetVersions::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/drive/items/{driveItem%2Did}/listItem/documentSetVersions/$count{?%24search,%24filter}"
