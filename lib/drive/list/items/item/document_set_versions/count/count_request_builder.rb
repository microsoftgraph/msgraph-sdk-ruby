...
module MicrosoftGraph::Drive::List::Items::Item::DocumentSetVersions::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/drive/list/items/{listItem%2Did}/documentSetVersions/$count{?%24search,%24filter}"
