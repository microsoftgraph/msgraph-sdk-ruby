...
module MicrosoftGraph::Drive::List::Subscriptions::Item::Reauthorize
    ## 
    ...
    class ReauthorizeRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/drive/list/subscriptions/{subscription%2Did}/microsoft.graph.reauthorize"
