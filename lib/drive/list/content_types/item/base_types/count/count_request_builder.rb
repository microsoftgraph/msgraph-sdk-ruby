...
module MicrosoftGraph::Drive::List::ContentTypes::Item::BaseTypes::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/drive/list/contentTypes/{contentType%2Did}/baseTypes/$count{?%24search,%24filter}"
