...
module MicrosoftGraph::Drive::List::ContentTypes::Item::ColumnLinks::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/drive/list/contentTypes/{contentType%2Did}/columnLinks/$count{?%24search,%24filter}"
