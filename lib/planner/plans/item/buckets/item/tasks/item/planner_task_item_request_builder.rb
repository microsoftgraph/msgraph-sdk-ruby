...
module MicrosoftGraph::Planner::Plans::Item::Buckets::Item::Tasks::Item
    ## 
    ...
    class PlannerTaskItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, planner_task_id=)
            ...
            @url_template = "{+baseurl}/planner/plans/{plannerPlan%2Did}/buckets/{plannerBucket%2Did}/tasks/{plannerTask%2Did}{?%24select,%24expand}"
