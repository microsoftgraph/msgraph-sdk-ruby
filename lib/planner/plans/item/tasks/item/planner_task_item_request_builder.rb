...
module MicrosoftGraph::Planner::Plans::Item::Tasks::Item
    ## 
    ...
    class PlannerTaskItemRequestBuilder
        ...
        def assigned_to_task_board_format()
            return MicrosoftGraph::Planner::Plans::Item::Tasks::Item::AssignedToTaskBoardFormat::AssignedToTaskBoardFormatRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the bucketTaskBoardFormat property of the microsoft.graph.plannerTask entity.
        def bucket_task_board_format()
            return MicrosoftGraph::Planner::Plans::Item::Tasks::Item::BucketTaskBoardFormat::BucketTaskBoardFormatRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to manage the details property of the microsoft.graph.plannerTask entity.
        def details()
            return MicrosoftGraph::Planner::Plans::Item::Tasks::Item::Details::DetailsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def progress_task_board_format()
            return MicrosoftGraph::Planner::Plans::Item::Tasks::Item::ProgressTaskBoardFormat::ProgressTaskBoardFormatRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter, planner_task_id=)
            ...
            @url_template = "{+baseurl}/planner/plans/{plannerPlan%2Did}/tasks/{plannerTask%2Did}{?%24select,%24expand}"
