                        ...
                        module Details
                            ...
                            class DetailsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                ...
                                def initialize(path_parameters, request_adapter)
                                    super(path_parameters, request_adapter, "{+baseurl}/planner/plans/{plannerPlan%2Did}/tasks/{plannerTask%2Did}/details{?%24expand,%24select}")
                                end
                                ## 
                                ...
                                def to_delete_request_information(request_configuration=nil)
                                    ...
                                    request_info.url_template = '{+baseurl}/planner/plans/{plannerPlan%2Did}/tasks/{plannerTask%2Did}/details'
