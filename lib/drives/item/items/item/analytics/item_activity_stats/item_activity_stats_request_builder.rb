...
module MicrosoftGraph::Drives::Item::Items::Item::Analytics::ItemActivityStats
    ## 
    ...
    class ItemActivityStatsRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/analytics/itemActivityStats{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
