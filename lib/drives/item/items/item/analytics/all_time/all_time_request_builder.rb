...
module MicrosoftGraph::Drives::Item::Items::Item::Analytics::AllTime
    ## 
    ...
    class AllTimeRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/analytics/allTime{?%24select,%24expand}"
