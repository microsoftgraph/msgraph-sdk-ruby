...
require_relative '../item'
require_relative './microsoft_graph_unfollow'

module MicrosoftGraph::Drives::Item::Items::Item::MicrosoftGraphUnfollow
    ## 
    ...
    class UnfollowRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/microsoft.graph.unfollow"
