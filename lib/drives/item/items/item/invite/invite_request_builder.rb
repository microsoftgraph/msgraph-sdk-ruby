                ...
                module Item
                    module Invite
                        ...
                        class InviteRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            ## @return a Fiber of invitepost_response
                            ## 
                            def post(body, request_configuration=nil)
                                ...
                                return @request_adapter.send_async(request_info, lambda {|pn| MicrosoftGraph::Drives::Item::Items::Item::Invite::InvitepostResponse.create_from_discriminator_value(pn) }, error_mapping)
                            end
                            ## 
                            ## Sends a sharing invitation for a driveItem.A sharing invitation provides permissions to the recipients and optionally sends them an email with a sharing link.
                            ## @param body The request body
