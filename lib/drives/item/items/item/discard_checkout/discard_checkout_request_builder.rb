...
require_relative '../item'
require_relative './discard_checkout'
...
module MicrosoftGraph
    module Drives
        module Item
            module Items
                module Item
                    module DiscardCheckout
                        ## 
                        # Provides operations to call the discardCheckout method.
                        class DiscardCheckoutRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            def initialize(path_parameters, request_adapter)
                                super(path_parameters, request_adapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/discardCheckout")
                            end
                            ## 
                            ...
                            ## @return a discard_checkout_request_builder
                            ## 
                            def with_url(raw_url)
                                raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                                return DiscardCheckoutRequestBuilder.new(raw_url, @request_adapter)
                            end
                        end
                    end
                end
