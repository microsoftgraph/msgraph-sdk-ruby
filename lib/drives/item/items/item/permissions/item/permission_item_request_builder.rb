...
module MicrosoftGraph::Drives::Item::Items::Item::Permissions::Item
    ...
    class PermissionItemRequestBuilder
        ...
        def microsoft_graph_grant()
            return MicrosoftGraph::Drives::Item::Items::Item::Permissions::Item::MicrosoftGraphGrant::MicrosoftGraphGrantRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
