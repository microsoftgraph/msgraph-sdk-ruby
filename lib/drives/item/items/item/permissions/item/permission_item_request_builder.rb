...
module MicrosoftGraph::Drives::Item::Items::Item::Permissions::Item
    ## 
    ...
    class PermissionItemRequestBuilder
        ...
        def microsoft_graph_grant()
            return MicrosoftGraph::Drives::Item::Items::Item::Permissions::Item::MicrosoftGraphGrant::GrantRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, permission_id=nil)
            raise StandardError, 'path_parameters cannot be null' if path_parameters.nil?
            raise StandardError, 'request_adapter cannot be null' if request_adapter.nil?
            @url_template = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/permissions/{permission%2Did}{?%24select,%24expand}"
