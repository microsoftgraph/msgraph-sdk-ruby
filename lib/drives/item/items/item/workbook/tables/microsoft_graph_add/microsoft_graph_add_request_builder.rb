...
module MicrosoftGraph::Drives::Item::Items::Item::Workbook::Tables::MicrosoftGraphAdd
    ## 
    ...
    class MicrosoftGraphAddRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/tables/microsoft.graph.add"
