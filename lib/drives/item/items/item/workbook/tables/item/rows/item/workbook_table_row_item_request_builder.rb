...
module MicrosoftGraph::Drives::Item::Items::Item::Workbook::Tables::Item::Rows::Item
    ## 
    ...
    class WorkbookTableRowItemRequestBuilder
        ...
        def microsoft_graph_range()
            return MicrosoftGraph::Drives::Item::Items::Item::Workbook::Tables::Item::Rows::Item::MicrosoftGraphRange::RangeRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter, workbook_table_row_id=nil)
            ...
            @url_template = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/tables/{workbookTable%2Did}/rows/{workbookTableRow%2Did}{?%24select,%24expand}"
