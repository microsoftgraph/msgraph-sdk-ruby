                                ...
                                module Rows
                                    module ItemAtWithIndex
                                        ...
                                        class ItemAtWithIndexRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                            ...
                                            def range()
                                                return MicrosoftGraph::Drives::Item::Items::Item::Workbook::Tables::Item::Rows::ItemAtWithIndex::Range::RangeRequestBuilder.new(@path_parameters, @request_adapter)
                                            end
                                            ## 
                                            ...
                                            def initialize(path_parameters, request_adapter, index=nil)
                                                super(path_parameters, request_adapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/tables/{workbookTable%2Did}/rows/itemAt(index={index})")
                                            end
                                            ## 
