...
module MicrosoftGraph::Drives::Item::Items::Item::Workbook::Tables::Item::Rows::MicrosoftGraphAdd
    ## 
    ...
    class MicrosoftGraphAddRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/tables/{workbookTable%2Did}/rows/microsoft.graph.add"
