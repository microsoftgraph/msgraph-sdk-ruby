...
module MicrosoftGraph::Drives::Item::Items::Item::Workbook::Tables::Item
    ...
    class WorkbookTableItemRequestBuilder
        ...
        def microsoft_graph_clear_filters()
            return MicrosoftGraph::Drives::Item::Items::Item::Workbook::Tables::Item::MicrosoftGraphClearFilters::MicrosoftGraphClearFiltersRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the convertToRange method.
        def microsoft_graph_convert_to_range()
            return MicrosoftGraph::Drives::Item::Items::Item::Workbook::Tables::Item::MicrosoftGraphConvertToRange::MicrosoftGraphConvertToRangeRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the dataBodyRange method.
        def microsoft_graph_data_body_range()
            return MicrosoftGraph::Drives::Item::Items::Item::Workbook::Tables::Item::MicrosoftGraphDataBodyRange::MicrosoftGraphDataBodyRangeRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the headerRowRange method.
        def microsoft_graph_header_row_range()
            return MicrosoftGraph::Drives::Item::Items::Item::Workbook::Tables::Item::MicrosoftGraphHeaderRowRange::MicrosoftGraphHeaderRowRangeRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the range method.
        def microsoft_graph_range()
            return MicrosoftGraph::Drives::Item::Items::Item::Workbook::Tables::Item::MicrosoftGraphRange::MicrosoftGraphRangeRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the reapplyFilters method.
        def microsoft_graph_reapply_filters()
            return MicrosoftGraph::Drives::Item::Items::Item::Workbook::Tables::Item::MicrosoftGraphReapplyFilters::MicrosoftGraphReapplyFiltersRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the totalRowRange method.
        def microsoft_graph_total_row_range()
            return MicrosoftGraph::Drives::Item::Items::Item::Workbook::Tables::Item::MicrosoftGraphTotalRowRange::MicrosoftGraphTotalRowRangeRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
