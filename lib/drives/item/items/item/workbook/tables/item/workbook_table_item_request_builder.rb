                        ...
                        module Tables
                            module Item
                                ...
                                class WorkbookTableItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                    ...
                                    def clear_filters()
                                        return MicrosoftGraph::Drives::Item::Items::Item::Workbook::Tables::Item::ClearFilters::ClearFiltersRequestBuilder.new(@path_parameters, @request_adapter)
                                    end
                                    ## 
                                    ...
                                    def convert_to_range()
                                        return MicrosoftGraph::Drives::Item::Items::Item::Workbook::Tables::Item::ConvertToRange::ConvertToRangeRequestBuilder.new(@path_parameters, @request_adapter)
                                    end
                                    ## 
                                    # Provides operations to call the dataBodyRange method.
                                    def data_body_range()
                                        return MicrosoftGraph::Drives::Item::Items::Item::Workbook::Tables::Item::DataBodyRange::DataBodyRangeRequestBuilder.new(@path_parameters, @request_adapter)
                                    end
                                    ## 
                                    # Provides operations to call the headerRowRange method.
                                    def header_row_range()
                                        return MicrosoftGraph::Drives::Item::Items::Item::Workbook::Tables::Item::HeaderRowRange::HeaderRowRangeRequestBuilder.new(@path_parameters, @request_adapter)
                                    end
                                    ## 
                                    # Provides operations to call the range method.
                                    def range()
                                        return MicrosoftGraph::Drives::Item::Items::Item::Workbook::Tables::Item::Range::RangeRequestBuilder.new(@path_parameters, @request_adapter)
                                    end
                                    ## 
                                    # Provides operations to call the reapplyFilters method.
                                    def reapply_filters()
                                        return MicrosoftGraph::Drives::Item::Items::Item::Workbook::Tables::Item::ReapplyFilters::ReapplyFiltersRequestBuilder.new(@path_parameters, @request_adapter)
                                    end
                                    ## 
                                    ...
                                    def total_row_range()
                                        return MicrosoftGraph::Drives::Item::Items::Item::Workbook::Tables::Item::TotalRowRange::TotalRowRangeRequestBuilder.new(@path_parameters, @request_adapter)
                                    end
                                    ## 
                                    ...
                                    def initialize(path_parameters, request_adapter)
                                        super(path_parameters, request_adapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/tables/{workbookTable%2Did}{?%24expand,%24select}")
                                    end
                                    ## 
                                    ## Deletes the table.
                                    ...
                                    def to_delete_request_information(request_configuration=nil)
                                        ...
                                        request_info.url_template = '{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/tables/{workbookTable%2Did}'
