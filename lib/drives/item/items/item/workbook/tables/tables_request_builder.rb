...
module MicrosoftGraph::Drives::Item::Items::Item::Workbook::Tables
    ...
    class TablesRequestBuilder
        ...
        def count()
            return MicrosoftGraph::Drives::Item::Items::Item::Workbook::Tables::MicrosoftGraphCount::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the add method.
        def microsoft_graph_add()
            return MicrosoftGraph::Drives::Item::Items::Item::Workbook::Tables::MicrosoftGraphAdd::AddRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
