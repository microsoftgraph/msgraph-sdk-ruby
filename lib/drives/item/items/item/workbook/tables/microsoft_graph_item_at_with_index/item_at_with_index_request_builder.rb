...
module MicrosoftGraph::Drives::Item::Items::Item::Workbook::Tables::MicrosoftGraphItemAtWithIndex
    ## 
    ...
    class ItemAtWithIndexRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, index=)
            ...
            @url_template = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/tables/microsoft.graph.itemAt(index={index})"
