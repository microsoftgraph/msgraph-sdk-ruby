...
require_relative './microsoft_graph_coup_num'

module MicrosoftGraph::Drives::Item::Items::Item::Workbook::Functions::MicrosoftGraphCoupNum
    ## 
    # Provides operations to call the coupNum method.
    class CoupNumRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/microsoft.graph.coupNum"
        ...
        class CoupNumRequestBuilderPostRequestConfiguration
