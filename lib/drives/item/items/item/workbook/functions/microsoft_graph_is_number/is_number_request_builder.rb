...
require_relative './microsoft_graph_is_number'

module MicrosoftGraph::Drives::Item::Items::Item::Workbook::Functions::MicrosoftGraphIsNumber
    ## 
    # Provides operations to call the isNumber method.
    class IsNumberRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/microsoft.graph.isNumber"
        ...
        class IsNumberRequestBuilderPostRequestConfiguration
