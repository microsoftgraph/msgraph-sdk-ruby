...
require_relative './microsoft_graph_bin2_oct'

module MicrosoftGraph::Drives::Item::Items::Item::Workbook::Functions::MicrosoftGraphBin2Oct
    class Bin2OctPostRequestBody
        ...
        ## @return a bin2_oct_post_request_body
        ## 
        def self.create_from_discriminator_value(parse_node)
            raise StandardError, 'parse_node cannot be null' if parse_node.nil?
            return Bin2OctPostRequestBody.new
        end
        ## 
