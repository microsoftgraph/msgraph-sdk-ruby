...
require_relative './microsoft_graph_amor_linc'

module MicrosoftGraph::Drives::Item::Items::Item::Workbook::Functions::MicrosoftGraphAmorLinc
    ## 
    # Provides operations to call the amorLinc method.
    class AmorLincRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/microsoft.graph.amorLinc"
        ...
        class AmorLincRequestBuilderPostRequestConfiguration
