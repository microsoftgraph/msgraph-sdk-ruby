...
require_relative './microsoft_graph_im_sqrt'

module MicrosoftGraph::Drives::Item::Items::Item::Workbook::Functions::MicrosoftGraphImSqrt
    ## 
    # Provides operations to call the imSqrt method.
    class ImSqrtRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/microsoft.graph.imSqrt"
        ...
        class ImSqrtRequestBuilderPostRequestConfiguration
