...
require_relative './microsoft_graph_midb'

module MicrosoftGraph::Drives::Item::Items::Item::Workbook::Functions::MicrosoftGraphMidb
    ## 
    # Provides operations to call the midb method.
    class MicrosoftGraphMidbRequestBuilder
        ...
        @url_template
        ## 
        ## Instantiates a new MicrosoftGraphMidbRequestBuilder and sets the default values.
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/microsoft.graph.midb"
