...
require_relative './microsoft_graph_oct2_bin'

module MicrosoftGraph::Drives::Item::Items::Item::Workbook::Functions::MicrosoftGraphOct2Bin
    class Oct2BinPostRequestBody
        ...
        ## @return a oct2_bin_post_request_body
        ## 
        def self.create_from_discriminator_value(parse_node)
            raise StandardError, 'parse_node cannot be null' if parse_node.nil?
            return Oct2BinPostRequestBody.new
        end
        ## 
