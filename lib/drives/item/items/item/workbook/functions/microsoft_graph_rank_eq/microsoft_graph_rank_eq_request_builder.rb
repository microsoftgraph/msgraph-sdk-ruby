...
require_relative './microsoft_graph_rank_eq'

module MicrosoftGraph::Drives::Item::Items::Item::Workbook::Functions::MicrosoftGraphRank_Eq
    ## 
    # Provides operations to call the rank_Eq method.
    class MicrosoftGraphRank_EqRequestBuilder
        ...
        @url_template
        ## 
        ## Instantiates a new MicrosoftGraphRank_EqRequestBuilder and sets the default values.
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/microsoft.graph.rank_Eq"
