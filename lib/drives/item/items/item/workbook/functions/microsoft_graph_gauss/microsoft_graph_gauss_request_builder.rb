...
require_relative './microsoft_graph_gauss'

module MicrosoftGraph::Drives::Item::Items::Item::Workbook::Functions::MicrosoftGraphGauss
    ## 
    # Provides operations to call the gauss method.
    class MicrosoftGraphGaussRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/microsoft.graph.gauss"
