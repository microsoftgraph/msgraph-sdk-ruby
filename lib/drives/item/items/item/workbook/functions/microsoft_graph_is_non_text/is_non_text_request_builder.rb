...
require_relative './microsoft_graph_is_non_text'

module MicrosoftGraph::Drives::Item::Items::Item::Workbook::Functions::MicrosoftGraphIsNonText
    ## 
    # Provides operations to call the isNonText method.
    class IsNonTextRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/microsoft.graph.isNonText"
        ...
        class IsNonTextRequestBuilderPostRequestConfiguration
