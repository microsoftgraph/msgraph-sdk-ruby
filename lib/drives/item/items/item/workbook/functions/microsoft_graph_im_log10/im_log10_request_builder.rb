...
require_relative './microsoft_graph_im_log10'

module MicrosoftGraph::Drives::Item::Items::Item::Workbook::Functions::MicrosoftGraphImLog10
    ## 
    # Provides operations to call the imLog10 method.
    class ImLog10RequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/microsoft.graph.imLog10"
        ...
        class ImLog10RequestBuilderPostRequestConfiguration
