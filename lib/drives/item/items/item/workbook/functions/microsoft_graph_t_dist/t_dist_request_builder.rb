...
require_relative './microsoft_graph_t_dist'

module MicrosoftGraph::Drives::Item::Items::Item::Workbook::Functions::MicrosoftGraphT_Dist
    ## 
    # Provides operations to call the t_Dist method.
    class T_DistRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/microsoft.graph.t_Dist"
        ...
        class T_DistRequestBuilderPostRequestConfiguration
