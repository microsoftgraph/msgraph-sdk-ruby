...
require_relative './microsoft_graph_confidence_norm'

module MicrosoftGraph::Drives::Item::Items::Item::Workbook::Functions::MicrosoftGraphConfidence_Norm
    ## 
    ...
    class Confidence_NormRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/microsoft.graph.confidence_Norm"
