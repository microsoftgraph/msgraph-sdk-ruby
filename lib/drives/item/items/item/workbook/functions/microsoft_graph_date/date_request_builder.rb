...
require_relative './microsoft_graph_date'

module MicrosoftGraph::Drives::Item::Items::Item::Workbook::Functions::MicrosoftGraphDate
    ## 
    # Provides operations to call the date method.
    class DateRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/microsoft.graph.date"
        ...
        class DateRequestBuilderPostRequestConfiguration
