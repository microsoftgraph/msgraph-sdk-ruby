...
require_relative './microsoft_graph_dec2_hex'

module MicrosoftGraph::Drives::Item::Items::Item::Workbook::Functions::MicrosoftGraphDec2Hex
    class Dec2HexPostRequestBody
        ...
        ## @return a dec2_hex_post_request_body
        ## 
        def self.create_from_discriminator_value(parse_node)
            raise StandardError, 'parse_node cannot be null' if parse_node.nil?
            return Dec2HexPostRequestBody.new
        end
        ## 
