...
require_relative './microsoft_graph_asc'

module MicrosoftGraph::Drives::Item::Items::Item::Workbook::Functions::MicrosoftGraphAsc
    ## 
    # Provides operations to call the asc method.
    class AscRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/microsoft.graph.asc"
        ...
        class AscRequestBuilderPostRequestConfiguration
