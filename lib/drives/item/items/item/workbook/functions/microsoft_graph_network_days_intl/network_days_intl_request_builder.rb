...
require_relative './microsoft_graph_network_days_intl'

module MicrosoftGraph::Drives::Item::Items::Item::Workbook::Functions::MicrosoftGraphNetworkDays_Intl
    ## 
    ...
    class NetworkDays_IntlRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/microsoft.graph.networkDays_Intl"
