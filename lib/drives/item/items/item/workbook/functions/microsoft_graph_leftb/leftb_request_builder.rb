...
require_relative './microsoft_graph_leftb'

module MicrosoftGraph::Drives::Item::Items::Item::Workbook::Functions::MicrosoftGraphLeftb
    ## 
    # Provides operations to call the leftb method.
    class LeftbRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/microsoft.graph.leftb"
        ...
        class LeftbRequestBuilderPostRequestConfiguration
