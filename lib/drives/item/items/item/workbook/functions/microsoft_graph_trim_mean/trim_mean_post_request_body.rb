...
require_relative './microsoft_graph_trim_mean'

module MicrosoftGraph::Drives::Item::Items::Item::Workbook::Functions::MicrosoftGraphTrimMean
    class TrimMeanPostRequestBody
        ...
        ## @return a trim_mean_post_request_body
        ## 
        def self.create_from_discriminator_value(parse_node)
            raise StandardError, 'parse_node cannot be null' if parse_node.nil?
            return TrimMeanPostRequestBody.new
        end
        ## 
        ...
        def get_field_deserializers()
            return {
                ...
                "percent" => lambda {|n| @percent = n.get_object_value(lambda {|pn| MicrosoftGraph::Models::Json.create_from_discriminator_value(pn) }) },
            }
        end
        ## 
        ...
        def serialize(writer)
            ...
            writer.write_object_value("percent", @percent)
