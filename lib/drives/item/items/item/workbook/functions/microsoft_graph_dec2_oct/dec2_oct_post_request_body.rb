...
require_relative './microsoft_graph_dec2_oct'

module MicrosoftGraph::Drives::Item::Items::Item::Workbook::Functions::MicrosoftGraphDec2Oct
    class Dec2OctPostRequestBody
        ...
        def self.create_from_discriminator_value(parse_node)
            ...
            return Dec2OctPostRequestBody.new
        end
        ## 
