...
require_relative './microsoft_graph_im_sub'

module MicrosoftGraph::Drives::Item::Items::Item::Workbook::Functions::MicrosoftGraphImSub
    ## 
    # Provides operations to call the imSub method.
    class ImSubRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/microsoft.graph.imSub"
        ...
        class ImSubRequestBuilderPostRequestConfiguration
