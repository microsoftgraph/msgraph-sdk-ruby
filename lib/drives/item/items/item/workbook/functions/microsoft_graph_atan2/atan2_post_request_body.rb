...
require_relative './microsoft_graph_atan2'

module MicrosoftGraph::Drives::Item::Items::Item::Workbook::Functions::MicrosoftGraphAtan2
    class Atan2PostRequestBody
        ...
        ## @return a atan2_post_request_body
        ## 
        def self.create_from_discriminator_value(parse_node)
            raise StandardError, 'parse_node cannot be null' if parse_node.nil?
            return Atan2PostRequestBody.new
        end
        ## 
        ...
        ## @param value Value to set for the x_num property.
        ## @return a void
        ## 
        def x_num=(value)
            @x_num = value
        ...
        ## @param value Value to set for the y_num property.
        ## @return a void
        ## 
        def y_num=(value)
            @y_num = value
