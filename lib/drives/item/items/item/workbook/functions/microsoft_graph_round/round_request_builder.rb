...
require_relative './microsoft_graph_round'

module MicrosoftGraph::Drives::Item::Items::Item::Workbook::Functions::MicrosoftGraphRound
    ## 
    # Provides operations to call the round method.
    class RoundRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/microsoft.graph.round"
        ...
        class RoundRequestBuilderPostRequestConfiguration
