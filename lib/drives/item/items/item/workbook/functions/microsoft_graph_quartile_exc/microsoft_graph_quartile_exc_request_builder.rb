...
require_relative './microsoft_graph_quartile_exc'

module MicrosoftGraph::Drives::Item::Items::Item::Workbook::Functions::MicrosoftGraphQuartile_Exc
    ## 
    # Provides operations to call the quartile_Exc method.
    class MicrosoftGraphQuartile_ExcRequestBuilder
        ...
        @url_template
        ## 
        ## Instantiates a new MicrosoftGraphQuartile_ExcRequestBuilder and sets the default values.
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/microsoft.graph.quartile_Exc"
