...
require_relative './microsoft_graph_dget'

module MicrosoftGraph::Drives::Item::Items::Item::Workbook::Functions::MicrosoftGraphDget
    ## 
    # Provides operations to call the dget method.
    class DgetRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/microsoft.graph.dget"
        ...
        class DgetRequestBuilderPostRequestConfiguration
