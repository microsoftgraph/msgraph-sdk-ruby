...
require_relative './microsoft_graph_im_conjugate'

module MicrosoftGraph::Drives::Item::Items::Item::Workbook::Functions::MicrosoftGraphImConjugate
    class ImConjugatePostRequestBody
        ...
        ## @return a im_conjugate_post_request_body
        ## 
        def self.create_from_discriminator_value(parse_node)
            raise StandardError, 'parse_node cannot be null' if parse_node.nil?
            return ImConjugatePostRequestBody.new
        end
        ## 
