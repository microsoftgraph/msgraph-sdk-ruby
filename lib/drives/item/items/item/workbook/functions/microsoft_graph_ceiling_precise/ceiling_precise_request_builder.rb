...
require_relative './microsoft_graph_ceiling_precise'

module MicrosoftGraph::Drives::Item::Items::Item::Workbook::Functions::MicrosoftGraphCeiling_Precise
    ## 
    ...
    class Ceiling_PreciseRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/microsoft.graph.ceiling_Precise"
