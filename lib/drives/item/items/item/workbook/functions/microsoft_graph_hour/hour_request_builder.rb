...
require_relative './microsoft_graph_hour'

module MicrosoftGraph::Drives::Item::Items::Item::Workbook::Functions::MicrosoftGraphHour
    ## 
    # Provides operations to call the hour method.
    class HourRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/microsoft.graph.hour"
        ...
        class HourRequestBuilderPostRequestConfiguration
