...
require_relative './microsoft_graph_log'
                            ...
                            module MicrosoftGraphLog
                                class LogPostRequestBody
                                    ...
                                    def get_field_deserializers()
                                        return {
                                            "base" => lambda {|n| @base = n.get_object_value(lambda {|pn| MicrosoftGraph::Models::Json.create_from_discriminator_value(pn) }) },
