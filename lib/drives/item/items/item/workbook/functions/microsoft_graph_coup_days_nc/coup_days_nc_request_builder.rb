...
require_relative './microsoft_graph_coup_days_nc'

module MicrosoftGraph::Drives::Item::Items::Item::Workbook::Functions::MicrosoftGraphCoupDaysNc
    ## 
    # Provides operations to call the coupDaysNc method.
    class CoupDaysNcRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/microsoft.graph.coupDaysNc"
        ...
        class CoupDaysNcRequestBuilderPostRequestConfiguration
