...
require_relative './microsoft_graph_count_blank'

module MicrosoftGraph::Drives::Item::Items::Item::Workbook::Functions::MicrosoftGraphCountBlank
    class CountBlankPostRequestBody
        ...
        ## @return a count_blank_post_request_body
        ## 
        def self.create_from_discriminator_value(parse_node)
            raise StandardError, 'parse_node cannot be null' if parse_node.nil?
            return CountBlankPostRequestBody.new
        end
        ## 
