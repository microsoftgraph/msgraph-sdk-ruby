...
require_relative './microsoft_graph_erf_precise'

module MicrosoftGraph::Drives::Item::Items::Item::Workbook::Functions::MicrosoftGraphErf_Precise
    ## 
    # Provides operations to call the erf_Precise method.
    class Erf_PreciseRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/microsoft.graph.erf_Precise"
        ...
        class Erf_PreciseRequestBuilderPostRequestConfiguration
