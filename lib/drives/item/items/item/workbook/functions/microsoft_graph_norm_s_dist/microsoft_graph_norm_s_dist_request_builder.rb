...
require_relative './microsoft_graph_norm_s_dist'

module MicrosoftGraph::Drives::Item::Items::Item::Workbook::Functions::MicrosoftGraphNorm_S_Dist
    ## 
    # Provides operations to call the norm_S_Dist method.
    class MicrosoftGraphNorm_S_DistRequestBuilder
        ...
        @url_template
        ## 
        ## Instantiates a new MicrosoftGraphNorm_S_DistRequestBuilder and sets the default values.
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/microsoft.graph.norm_S_Dist"
