...
require_relative './microsoft_graph_nominal'

module MicrosoftGraph::Drives::Item::Items::Item::Workbook::Functions::MicrosoftGraphNominal
    class NominalPostRequestBody
        ...
        ## @param value Value to set for the effect_rate property.
        ## @return a void
        ## 
        ...
        def get_field_deserializers()
            return {
                "effectRate" => lambda {|n| @effect_rate = n.get_object_value(lambda {|pn| MicrosoftGraph::Models::Json.create_from_discriminator_value(pn) }) },
