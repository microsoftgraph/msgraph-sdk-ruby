...
require_relative './microsoft_graph_im_sec'

module MicrosoftGraph::Drives::Item::Items::Item::Workbook::Functions::MicrosoftGraphImSec
    class ImSecPostRequestBody
        ...
        ## 
        ## Instantiates a new imSecPostRequestBody and sets the default values.
        ## @return a void
        ## 
        def initialize()
        ...
        ## @return a im_sec_post_request_body
        ## 
        def self.create_from_discriminator_value(parse_node)
            raise StandardError, 'parse_node cannot be null' if parse_node.nil?
            return ImSecPostRequestBody.new
        end
        ## 
