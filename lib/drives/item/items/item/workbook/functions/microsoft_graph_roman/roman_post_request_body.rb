...
require_relative './microsoft_graph_roman'

module MicrosoftGraph::Drives::Item::Items::Item::Workbook::Functions::MicrosoftGraphRoman
    class RomanPostRequestBody
        ...
        ## @return a roman_post_request_body
        ## 
        def self.create_from_discriminator_value(parse_node)
            raise StandardError, 'parse_node cannot be null' if parse_node.nil?
            return RomanPostRequestBody.new
        end
        ## 
        ...
        def get_field_deserializers()
            return {
                "form" => lambda {|n| @form = n.get_object_value(lambda {|pn| MicrosoftGraph::Models::Json.create_from_discriminator_value(pn) }) },
        ...
        def serialize(writer)
            ...
            writer.write_object_value("form", @form)
