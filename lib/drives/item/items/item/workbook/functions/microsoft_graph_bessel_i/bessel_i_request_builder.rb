...
require_relative './microsoft_graph_bessel_i'

module MicrosoftGraph::Drives::Item::Items::Item::Workbook::Functions::MicrosoftGraphBesselI
    ## 
    # Provides operations to call the besselI method.
    class BesselIRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/microsoft.graph.besselI"
        ...
        class BesselIRequestBuilderPostRequestConfiguration
