...
require_relative './microsoft_graph_chi_sq_dist_r_t'

module MicrosoftGraph::Drives::Item::Items::Item::Workbook::Functions::MicrosoftGraphChiSq_Dist_RT
    ## 
    # Provides operations to call the chiSq_Dist_RT method.
    class MicrosoftGraphChiSq_Dist_RTRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/microsoft.graph.chiSq_Dist_RT"
