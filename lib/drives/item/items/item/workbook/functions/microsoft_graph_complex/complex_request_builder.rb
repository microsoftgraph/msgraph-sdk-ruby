...
require_relative './microsoft_graph_complex'

module MicrosoftGraph::Drives::Item::Items::Item::Workbook::Functions::MicrosoftGraphComplex
    ## 
    # Provides operations to call the complex method.
    class ComplexRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/microsoft.graph.complex"
        ...
        class ComplexRequestBuilderPostRequestConfiguration
