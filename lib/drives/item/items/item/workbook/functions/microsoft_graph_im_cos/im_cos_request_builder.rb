...
require_relative './microsoft_graph_im_cos'

module MicrosoftGraph::Drives::Item::Items::Item::Workbook::Functions::MicrosoftGraphImCos
    ## 
    # Provides operations to call the imCos method.
    class ImCosRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/microsoft.graph.imCos"
        ...
        class ImCosRequestBuilderPostRequestConfiguration
