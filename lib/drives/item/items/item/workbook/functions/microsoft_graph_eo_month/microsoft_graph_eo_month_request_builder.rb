...
require_relative './microsoft_graph_eo_month'

module MicrosoftGraph::Drives::Item::Items::Item::Workbook::Functions::MicrosoftGraphEoMonth
    ## 
    # Provides operations to call the eoMonth method.
    class MicrosoftGraphEoMonthRequestBuilder
        ...
        @url_template
        ## 
        ## Instantiates a new MicrosoftGraphEoMonthRequestBuilder and sets the default values.
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/microsoft.graph.eoMonth"
