...
require_relative './microsoft_graph_vlookup'

module MicrosoftGraph::Drives::Item::Items::Item::Workbook::Functions::MicrosoftGraphVlookup
    class VlookupPostRequestBody
        ...
        ## @param value Value to set for the col_index_num property.
        ## @return a void
        ## 
        def col_index_num=(value)
            @col_index_num = value
        end
        ## 
        ...
        ## @return a vlookup_post_request_body
        ## 
        def self.create_from_discriminator_value(parse_node)
            raise StandardError, 'parse_node cannot be null' if parse_node.nil?
            return VlookupPostRequestBody.new
        end
        ## 
        ...
        def get_field_deserializers()
            return {
                "colIndexNum" => lambda {|n| @col_index_num = n.get_object_value(lambda {|pn| MicrosoftGraph::Models::Json.create_from_discriminator_value(pn) }) },
        ...
        def serialize(writer)
            ...
            writer.write_object_value("colIndexNum", @col_index_num)
