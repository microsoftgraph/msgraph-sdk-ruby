...
require_relative './microsoft_graph_chi_sq_inv_r_t'

module MicrosoftGraph::Drives::Item::Items::Item::Workbook::Functions::MicrosoftGraphChiSq_Inv_RT
    ## 
    # Provides operations to call the chiSq_Inv_RT method.
    class ChiSq_Inv_RTRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/microsoft.graph.chiSq_Inv_RT"
        ...
        class ChiSq_Inv_RTRequestBuilderPostRequestConfiguration
