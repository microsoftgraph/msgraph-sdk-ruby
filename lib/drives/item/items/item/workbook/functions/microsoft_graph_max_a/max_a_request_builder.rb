...
require_relative './microsoft_graph_max_a'

module MicrosoftGraph::Drives::Item::Items::Item::Workbook::Functions::MicrosoftGraphMaxA
    ## 
    # Provides operations to call the maxA method.
    class MaxARequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/microsoft.graph.maxA"
        ...
        class MaxARequestBuilderPostRequestConfiguration
