...
require_relative './microsoft_graph_time'

module MicrosoftGraph::Drives::Item::Items::Item::Workbook::Functions::MicrosoftGraphTime
    ## 
    # Provides operations to call the time method.
    class TimeRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/microsoft.graph.time"
        ...
        class TimeRequestBuilderPostRequestConfiguration
