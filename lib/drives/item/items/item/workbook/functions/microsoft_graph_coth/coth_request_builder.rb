...
require_relative './microsoft_graph_coth'

module MicrosoftGraph::Drives::Item::Items::Item::Workbook::Functions::MicrosoftGraphCoth
    ## 
    # Provides operations to call the coth method.
    class CothRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/microsoft.graph.coth"
        ...
        class CothRequestBuilderPostRequestConfiguration
