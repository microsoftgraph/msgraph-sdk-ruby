...
require_relative './microsoft_graph_dmin'

module MicrosoftGraph::Drives::Item::Items::Item::Workbook::Functions::MicrosoftGraphDmin
    ## 
    # Provides operations to call the dmin method.
    class DminRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/microsoft.graph.dmin"
        ...
        class DminRequestBuilderPostRequestConfiguration
