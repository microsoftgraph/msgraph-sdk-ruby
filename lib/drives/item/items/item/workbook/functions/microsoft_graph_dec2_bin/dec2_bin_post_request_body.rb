...
require_relative './microsoft_graph_dec2_bin'

module MicrosoftGraph::Drives::Item::Items::Item::Workbook::Functions::MicrosoftGraphDec2Bin
    class Dec2BinPostRequestBody
        ...
        ## @return a dec2_bin_post_request_body
        ## 
        def self.create_from_discriminator_value(parse_node)
            raise StandardError, 'parse_node cannot be null' if parse_node.nil?
            return Dec2BinPostRequestBody.new
        end
        ## 
        ...
        def get_field_deserializers()
            return {
                ...
                "places" => lambda {|n| @places = n.get_object_value(lambda {|pn| MicrosoftGraph::Models::Json.create_from_discriminator_value(pn) }) },
            }
        end
        ## 
