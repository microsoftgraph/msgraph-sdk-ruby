...
require_relative './microsoft_graph_hex2_bin'

module MicrosoftGraph::Drives::Item::Items::Item::Workbook::Functions::MicrosoftGraphHex2Bin
    class Hex2BinPostRequestBody
        ...
        ## @return a hex2_bin_post_request_body
        ## 
        def self.create_from_discriminator_value(parse_node)
            raise StandardError, 'parse_node cannot be null' if parse_node.nil?
            return Hex2BinPostRequestBody.new
        end
        ## 
