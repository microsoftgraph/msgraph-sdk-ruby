...
require_relative './microsoft_graph_percentile_inc'

module MicrosoftGraph::Drives::Item::Items::Item::Workbook::Functions::MicrosoftGraphPercentile_Inc
    class Percentile_IncPostRequestBody
        ...
        ## @return a percentile_inc_post_request_body
        ## 
        def self.create_from_discriminator_value(parse_node)
            raise StandardError, 'parse_node cannot be null' if parse_node.nil?
            return Percentile_IncPostRequestBody.new
        end
        ## 
