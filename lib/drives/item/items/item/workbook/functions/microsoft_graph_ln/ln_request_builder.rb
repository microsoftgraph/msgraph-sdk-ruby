...
require_relative './microsoft_graph_ln'

module MicrosoftGraph::Drives::Item::Items::Item::Workbook::Functions::MicrosoftGraphLn
    ## 
    # Provides operations to call the ln method.
    class LnRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/microsoft.graph.ln"
        ...
        class LnRequestBuilderPostRequestConfiguration
