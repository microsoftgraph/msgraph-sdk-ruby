...
require_relative './microsoft_graph_mduration'

module MicrosoftGraph::Drives::Item::Items::Item::Workbook::Functions::MicrosoftGraphMduration
    ## 
    # Provides operations to call the mduration method.
    class MdurationRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/functions/microsoft.graph.mduration"
        ...
        class MdurationRequestBuilderPostRequestConfiguration
