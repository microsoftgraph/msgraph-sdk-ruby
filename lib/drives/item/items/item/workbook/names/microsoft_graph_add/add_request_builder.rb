...
module MicrosoftGraph::Drives::Item::Items::Item::Workbook::Names::MicrosoftGraphAdd
    ## 
    ...
    class AddRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/names/microsoft.graph.add"
