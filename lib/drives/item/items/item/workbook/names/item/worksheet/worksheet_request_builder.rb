...
module MicrosoftGraph::Drives::Item::Items::Item::Workbook::Names::Item::Worksheet
    ## 
    ...
    class WorksheetRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/names/{workbookNamedItem%2Did}/worksheet{?%24select,%24expand}"
