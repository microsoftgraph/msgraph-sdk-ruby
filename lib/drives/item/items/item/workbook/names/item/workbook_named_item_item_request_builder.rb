...
module MicrosoftGraph::Drives::Item::Items::Item::Workbook::Names::Item
    ...
    class WorkbookNamedItemItemRequestBuilder
        ...
        def microsoft_graph_range()
            return MicrosoftGraph::Drives::Item::Items::Item::Workbook::Names::Item::MicrosoftGraphRange::MicrosoftGraphRangeRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
