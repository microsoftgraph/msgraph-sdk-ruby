...
module MicrosoftGraph::Drives::Item::Items::Item::Workbook::Names::Item
    ## 
    ...
    class WorkbookNamedItemItemRequestBuilder
        ...
        def microsoft_graph_range()
            return MicrosoftGraph::Drives::Item::Items::Item::Workbook::Names::Item::MicrosoftGraphRange::RangeRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter, workbook_named_item_id=nil)
            ...
            @url_template = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/names/{workbookNamedItem%2Did}{?%24select,%24expand}"
