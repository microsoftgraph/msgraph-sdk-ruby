                        ...
                        module Names
                            module Item
                                ...
                                class WorkbookNamedItemItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                    ...
                                    def range()
                                        return MicrosoftGraph::Drives::Item::Items::Item::Workbook::Names::Item::Range::RangeRequestBuilder.new(@path_parameters, @request_adapter)
                                    end
                                    ## 
                                    # Provides operations to manage the worksheet property of the microsoft.graph.workbookNamedItem entity.
                                    def worksheet()
                                        return MicrosoftGraph::Drives::Item::Items::Item::Workbook::Names::Item::Worksheet::WorksheetRequestBuilder.new(@path_parameters, @request_adapter)
                                    end
                                    ## 
                                    ...
                                    def initialize(path_parameters, request_adapter)
                                        super(path_parameters, request_adapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/names/{workbookNamedItem%2Did}{?%24expand,%24select}")
                                    end
                                    ## 
                                    ...
                                    def to_delete_request_information(request_configuration=nil)
                                        ...
                                        request_info.url_template = '{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/names/{workbookNamedItem%2Did}'
