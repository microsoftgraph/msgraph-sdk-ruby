...
require_relative './microsoft_graph_close_session/close_session_request_builder'
require_relative './microsoft_graph_create_session/create_session_request_builder'
require_relative './microsoft_graph_refresh_session/refresh_session_request_builder'
require_relative './microsoft_graph_session_info_resource_with_key/session_info_resource_with_key_request_builder'
require_relative './microsoft_graph_table_row_operation_result_with_key/table_row_operation_result_with_key_request_builder'
...
module MicrosoftGraph::Drives::Item::Items::Item::Workbook
    ...
    class WorkbookRequestBuilder
        ...
        def microsoft_graph_close_session()
            return MicrosoftGraph::Drives::Item::Items::Item::Workbook::MicrosoftGraphCloseSession::CloseSessionRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the createSession method.
        def microsoft_graph_create_session()
            return MicrosoftGraph::Drives::Item::Items::Item::Workbook::MicrosoftGraphCreateSession::CreateSessionRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the refreshSession method.
        def microsoft_graph_refresh_session()
            return MicrosoftGraph::Drives::Item::Items::Item::Workbook::MicrosoftGraphRefreshSession::RefreshSessionRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
