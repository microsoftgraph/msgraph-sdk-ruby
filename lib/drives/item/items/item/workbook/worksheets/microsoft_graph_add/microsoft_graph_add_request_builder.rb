...
module MicrosoftGraph::Drives::Item::Items::Item::Workbook::Worksheets::MicrosoftGraphAdd
    ## 
    ...
    class MicrosoftGraphAddRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/worksheets/microsoft.graph.add"
