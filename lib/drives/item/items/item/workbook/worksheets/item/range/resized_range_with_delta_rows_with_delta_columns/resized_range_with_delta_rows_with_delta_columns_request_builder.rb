                                    ...
                                    module ResizedRangeWithDeltaRowsWithDeltaColumns
                                        ...
                                        class ResizedRangeWithDeltaRowsWithDeltaColumnsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                            ...
                                            def initialize(path_parameters, request_adapter, delta_columns=nil, delta_rows=nil)
                                                super(path_parameters, request_adapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/worksheets/{workbookWorksheet%2Did}/range()/resizedRange(deltaRows={deltaRows},deltaColumns={deltaColumns})")
                                            end
                                            ## 
