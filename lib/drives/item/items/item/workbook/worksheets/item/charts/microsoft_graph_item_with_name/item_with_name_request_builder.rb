...
require_relative './microsoft_graph_item_with_name'

module MicrosoftGraph::Drives::Item::Items::Item::Workbook::Worksheets::Item::Charts::MicrosoftGraphItemWithName
    ## 
    ...
    class ItemWithNameRequestBuilder
        ...
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, name=)
            raise StandardError, 'path_parameters cannot be null' if path_parameters.nil?
            raise StandardError, 'request_adapter cannot be null' if request_adapter.nil?
            @url_template = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/worksheets/{workbookWorksheet%2Did}/charts/microsoft.graph.item(name='{name}')"
