...
require_relative '../item'
require_relative './microsoft_graph_convert_to_range'

module MicrosoftGraph::Drives::Item::Items::Item::Workbook::Worksheets::Item::Tables::Item::MicrosoftGraphConvertToRange
    ## 
    ...
    class ConvertToRangeRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/worksheets/{workbookWorksheet%2Did}/tables/{workbookTable%2Did}/microsoft.graph.convertToRange"
