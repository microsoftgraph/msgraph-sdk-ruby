                                        ...
                                        module Columns
                                            module Item
                                                module HeaderRowRange
                                                    module ColumnsBeforeWithCount
                                                        ## 
                                                        # Provides operations to call the columnsBefore method.
                                                        class ColumnsBeforeWithCountRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                                            ...
                                                            def initialize(path_parameters, request_adapter, count=nil)
                                                                super(path_parameters, request_adapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/worksheets/{workbookWorksheet%2Did}/tables/{workbookTable%2Did}/columns/{workbookTableColumn%2Did}/headerRowRange()/columnsBefore(count={count})")
                                                            end
                                                            ## 
                                                            ...
                                                            def with_url(raw_url)
                                                                ...
                                                                return ColumnsBeforeWithCountRequestBuilder.new(raw_url, @request_adapter)
                                                            end
                                                        end
                                                    end
                                                end
