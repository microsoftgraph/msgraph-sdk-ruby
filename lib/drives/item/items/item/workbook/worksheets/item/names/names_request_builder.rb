...
require_relative './microsoft_graph_add_formula_local/add_formula_local_request_builder'
require_relative './names'

module MicrosoftGraph::Drives::Item::Items::Item::Workbook::Worksheets::Item::Names
    ## 
    ...
    class NamesRequestBuilder
        ...
        def microsoft_graph_add()
            return MicrosoftGraph::Drives::Item::Items::Item::Workbook::Worksheets::Item::Names::MicrosoftGraphAdd::AddRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the addFormulaLocal method.
        def microsoft_graph_add_formula_local()
            return MicrosoftGraph::Drives::Item::Items::Item::Workbook::Worksheets::Item::Names::MicrosoftGraphAddFormulaLocal::AddFormulaLocalRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/worksheets/{workbookWorksheet%2Did}/names{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}"
