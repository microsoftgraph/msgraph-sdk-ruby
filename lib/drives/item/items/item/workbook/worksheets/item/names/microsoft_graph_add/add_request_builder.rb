...
module MicrosoftGraph::Drives::Item::Items::Item::Workbook::Worksheets::Item::Names::MicrosoftGraphAdd
    ## 
    ...
    class AddRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/worksheets/{workbookWorksheet%2Did}/names/microsoft.graph.add"
