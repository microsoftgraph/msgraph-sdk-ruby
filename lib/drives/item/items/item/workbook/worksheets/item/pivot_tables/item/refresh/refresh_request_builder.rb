                                        ...
                                        module Refresh
                                            ...
                                            class RefreshRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                                ...
                                                def initialize(path_parameters, request_adapter)
                                                    super(path_parameters, request_adapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/worksheets/{workbookWorksheet%2Did}/pivotTables/{workbookPivotTable%2Did}/refresh")
                                                end
                                                ## 
                                                ## Refreshes the PivotTable. This API is supported in the following national cloud deployments.
