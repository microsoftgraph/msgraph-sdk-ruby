...
require_relative './microsoft_graph_image/image_request_builder'
require_relative './microsoft_graph_image_with_width/image_with_width_request_builder'
require_relative './microsoft_graph_image_with_width_with_height/image_with_width_with_height_request_builder'
require_relative './microsoft_graph_image_with_width_with_height_with_fitting_mode/image_with_width_with_height_with_fitting_mode_request_builder'
require_relative './microsoft_graph_set_data/set_data_request_builder'
require_relative './microsoft_graph_set_position/set_position_request_builder'
...
module MicrosoftGraph::Drives::Item::Items::Item::Workbook::Worksheets::Item::Charts::Item
    ## 
    ...
    class WorkbookChartItemRequestBuilder
        ...
        def microsoft_graph_image()
            return MicrosoftGraph::Drives::Item::Items::Item::Workbook::Worksheets::Item::Charts::Item::MicrosoftGraphImage::ImageRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the setData method.
        def microsoft_graph_set_data()
            return MicrosoftGraph::Drives::Item::Items::Item::Workbook::Worksheets::Item::Charts::Item::MicrosoftGraphSetData::SetDataRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the setPosition method.
        def microsoft_graph_set_position()
            return MicrosoftGraph::Drives::Item::Items::Item::Workbook::Worksheets::Item::Charts::Item::MicrosoftGraphSetPosition::SetPositionRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, workbook_chart_id=nil)
