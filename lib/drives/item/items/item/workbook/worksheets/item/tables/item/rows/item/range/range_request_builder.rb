                                            ...
                                            module Item
                                                module Range
                                                    ...
                                                    class RangeRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                                        ...
                                                        def clear()
                                                            return MicrosoftGraph::Drives::Item::Items::Item::Workbook::Worksheets::Item::Tables::Item::Rows::Item::Range::Clear::ClearRequestBuilder.new(@path_parameters, @request_adapter)
                                                        end
                                                        ## 
                                                        # Provides operations to call the columnsAfter method.
                                                        def columns_after()
                                                            return MicrosoftGraph::Drives::Item::Items::Item::Workbook::Worksheets::Item::Tables::Item::Rows::Item::Range::ColumnsAfter::ColumnsAfterRequestBuilder.new(@path_parameters, @request_adapter)
                                                        end
                                                        ## 
                                                        # Provides operations to call the columnsBefore method.
                                                        def columns_before()
                                                            return MicrosoftGraph::Drives::Item::Items::Item::Workbook::Worksheets::Item::Tables::Item::Rows::Item::Range::ColumnsBefore::ColumnsBeforeRequestBuilder.new(@path_parameters, @request_adapter)
                                                        end
                                                        ## 
                                                        # Provides operations to call the delete method.
                                                        def delete_path()
                                                            return MicrosoftGraph::Drives::Item::Items::Item::Workbook::Worksheets::Item::Tables::Item::Rows::Item::Range::Delete::DeleteRequestBuilder.new(@path_parameters, @request_adapter)
                                                        end
                                                        ## 
                                                        # Provides operations to call the entireColumn method.
                                                        def entire_column()
                                                            return MicrosoftGraph::Drives::Item::Items::Item::Workbook::Worksheets::Item::Tables::Item::Rows::Item::Range::EntireColumn::EntireColumnRequestBuilder.new(@path_parameters, @request_adapter)
                                                        end
                                                        ## 
                                                        # Provides operations to call the entireRow method.
                                                        def entire_row()
                                                            return MicrosoftGraph::Drives::Item::Items::Item::Workbook::Worksheets::Item::Tables::Item::Rows::Item::Range::EntireRow::EntireRowRequestBuilder.new(@path_parameters, @request_adapter)
                                                        end
                                                        ## 
                                                        # Provides operations to manage the format property of the microsoft.graph.workbookRange entity.
                                                        def format()
                                                            return MicrosoftGraph::Drives::Item::Items::Item::Workbook::Worksheets::Item::Tables::Item::Rows::Item::Range::Format::FormatRequestBuilder.new(@path_parameters, @request_adapter)
                                                        end
                                                        ## 
                                                        # Provides operations to call the insert method.
                                                        def insert()
                                                            return MicrosoftGraph::Drives::Item::Items::Item::Workbook::Worksheets::Item::Tables::Item::Rows::Item::Range::Insert::InsertRequestBuilder.new(@path_parameters, @request_adapter)
                                                        end
                                                        ## 
                                                        # Provides operations to call the lastCell method.
                                                        def last_cell()
                                                            return MicrosoftGraph::Drives::Item::Items::Item::Workbook::Worksheets::Item::Tables::Item::Rows::Item::Range::LastCell::LastCellRequestBuilder.new(@path_parameters, @request_adapter)
                                                        end
                                                        ## 
                                                        # Provides operations to call the lastColumn method.
                                                        def last_column()
                                                            return MicrosoftGraph::Drives::Item::Items::Item::Workbook::Worksheets::Item::Tables::Item::Rows::Item::Range::LastColumn::LastColumnRequestBuilder.new(@path_parameters, @request_adapter)
                                                        end
                                                        ## 
                                                        # Provides operations to call the lastRow method.
                                                        def last_row()
                                                            return MicrosoftGraph::Drives::Item::Items::Item::Workbook::Worksheets::Item::Tables::Item::Rows::Item::Range::LastRow::LastRowRequestBuilder.new(@path_parameters, @request_adapter)
                                                        end
                                                        ## 
                                                        # Provides operations to call the merge method.
                                                        def merge()
                                                            return MicrosoftGraph::Drives::Item::Items::Item::Workbook::Worksheets::Item::Tables::Item::Rows::Item::Range::Merge::MergeRequestBuilder.new(@path_parameters, @request_adapter)
                                                        end
                                                        ## 
                                                        # Provides operations to call the rowsAbove method.
                                                        def rows_above()
                                                            return MicrosoftGraph::Drives::Item::Items::Item::Workbook::Worksheets::Item::Tables::Item::Rows::Item::Range::RowsAbove::RowsAboveRequestBuilder.new(@path_parameters, @request_adapter)
                                                        end
                                                        ## 
                                                        # Provides operations to call the rowsBelow method.
                                                        def rows_below()
                                                            return MicrosoftGraph::Drives::Item::Items::Item::Workbook::Worksheets::Item::Tables::Item::Rows::Item::Range::RowsBelow::RowsBelowRequestBuilder.new(@path_parameters, @request_adapter)
                                                        end
                                                        ## 
                                                        # Provides operations to manage the sort property of the microsoft.graph.workbookRange entity.
                                                        def sort()
                                                            return MicrosoftGraph::Drives::Item::Items::Item::Workbook::Worksheets::Item::Tables::Item::Rows::Item::Range::Sort::SortRequestBuilder.new(@path_parameters, @request_adapter)
                                                        end
                                                        ## 
                                                        # Provides operations to call the unmerge method.
                                                        def unmerge()
                                                            return MicrosoftGraph::Drives::Item::Items::Item::Workbook::Worksheets::Item::Tables::Item::Rows::Item::Range::Unmerge::UnmergeRequestBuilder.new(@path_parameters, @request_adapter)
                                                        end
                                                        ## 
                                                        # Provides operations to call the usedRange method.
                                                        def used_range()
                                                            return MicrosoftGraph::Drives::Item::Items::Item::Workbook::Worksheets::Item::Tables::Item::Rows::Item::Range::UsedRange::UsedRangeRequestBuilder.new(@path_parameters, @request_adapter)
                                                        end
                                                        ## 
                                                        # Provides operations to call the visibleView method.
                                                        def visible_view()
                                                            return MicrosoftGraph::Drives::Item::Items::Item::Workbook::Worksheets::Item::Tables::Item::Rows::Item::Range::VisibleView::VisibleViewRequestBuilder.new(@path_parameters, @request_adapter)
                                                        end
                                                        ## 
                                                        # Provides operations to manage the worksheet property of the microsoft.graph.workbookRange entity.
                                                        def worksheet()
                                                            return MicrosoftGraph::Drives::Item::Items::Item::Workbook::Worksheets::Item::Tables::Item::Rows::Item::Range::Worksheet::WorksheetRequestBuilder.new(@path_parameters, @request_adapter)
                                                        end
                                                        ## 
                                                        ...
                                                        def initialize(path_parameters, request_adapter)
                                                            super(path_parameters, request_adapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/worksheets/{workbookWorksheet%2Did}/tables/{workbookTable%2Did}/rows/{workbookTableRow%2Did}/range()")
                                                        end
                                                        ## 
