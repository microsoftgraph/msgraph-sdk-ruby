                                    ...
                                    module IntersectionWithAnotherRange
                                        ...
                                        class IntersectionWithAnotherRangeRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                            ...
                                            def initialize(path_parameters, request_adapter, another_range=nil)
                                                super(path_parameters, request_adapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/worksheets/{workbookWorksheet%2Did}/cell(row={row},column={column})/intersection(anotherRange='{anotherRange}')")
                                            end
                                            ## 
