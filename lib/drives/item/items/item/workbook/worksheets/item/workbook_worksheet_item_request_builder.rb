...
require_relative './item'
require_relative './microsoft_graph_cell_with_row_with_column/cell_with_row_with_column_request_builder'
require_relative './microsoft_graph_range/range_request_builder'
require_relative './microsoft_graph_range_with_address/range_with_address_request_builder'
require_relative './microsoft_graph_used_range/used_range_request_builder'
require_relative './microsoft_graph_used_range_with_values_only/used_range_with_values_only_request_builder'
...
module MicrosoftGraph::Drives::Item::Items::Item::Workbook::Worksheets::Item
    ## 
    ...
    class WorkbookWorksheetItemRequestBuilder
        ...
        def microsoft_graph_range()
            return MicrosoftGraph::Drives::Item::Items::Item::Workbook::Worksheets::Item::MicrosoftGraphRange::RangeRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the usedRange method.
        def microsoft_graph_used_range()
            return MicrosoftGraph::Drives::Item::Items::Item::Workbook::Worksheets::Item::MicrosoftGraphUsedRange::UsedRangeRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, workbook_worksheet_id=nil)
