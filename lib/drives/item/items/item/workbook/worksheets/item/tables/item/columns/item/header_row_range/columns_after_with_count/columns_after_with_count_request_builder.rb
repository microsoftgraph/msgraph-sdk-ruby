                                        ...
                                        module Columns
                                            module Item
                                                module HeaderRowRange
                                                    module ColumnsAfterWithCount
                                                        ## 
                                                        # Provides operations to call the columnsAfter method.
                                                        class ColumnsAfterWithCountRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                                            ...
                                                            def initialize(path_parameters, request_adapter, count=nil)
                                                                super(path_parameters, request_adapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/worksheets/{workbookWorksheet%2Did}/tables/{workbookTable%2Did}/columns/{workbookTableColumn%2Did}/headerRowRange()/columnsAfter(count={count})")
                                                            end
                                                            ## 
                                                            ...
                                                            def with_url(raw_url)
                                                                ...
                                                                return ColumnsAfterWithCountRequestBuilder.new(raw_url, @request_adapter)
                                                            end
                                                        end
                                                    end
                                                end
