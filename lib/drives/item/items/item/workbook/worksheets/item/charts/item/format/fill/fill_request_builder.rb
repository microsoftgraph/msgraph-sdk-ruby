...
module MicrosoftGraph::Drives::Item::Items::Item::Workbook::Worksheets::Item::Charts::Item::Format::Fill
    ## 
    ...
    class FillRequestBuilder
        ...
        def microsoft_graph_clear()
            return MicrosoftGraph::Drives::Item::Items::Item::Workbook::Worksheets::Item::Charts::Item::Format::Fill::MicrosoftGraphClear::ClearRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the setSolidColor method.
        def microsoft_graph_set_solid_color()
            return MicrosoftGraph::Drives::Item::Items::Item::Workbook::Worksheets::Item::Charts::Item::Format::Fill::MicrosoftGraphSetSolidColor::SetSolidColorRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/worksheets/{workbookWorksheet%2Did}/charts/{workbookChart%2Did}/format/fill{?%24select,%24expand}"
