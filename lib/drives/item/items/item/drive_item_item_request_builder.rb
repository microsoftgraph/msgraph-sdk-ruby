...
require_relative './discard_checkout/discard_checkout_request_builder'
                ...
                module Item
                    ...
                    class DriveItemItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                        ...
                        def discard_checkout()
                            return MicrosoftGraph::Drives::Item::Items::Item::DiscardCheckout::DiscardCheckoutRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ...
                        def retention_label()
                            return MicrosoftGraph::Drives::Item::Items::Item::RetentionLabel::RetentionLabelRequestBuilder.new(@path_parameters, @request_adapter)
                        end
                        ## 
                        ...
                        def initialize(path_parameters, request_adapter)
                            super(path_parameters, request_adapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}{?%24expand,%24select}")
                        end
                        ## 
