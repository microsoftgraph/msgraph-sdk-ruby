...
require_relative '../item'
require_relative './microsoft_graph_create_link'

module MicrosoftGraph::Drives::Item::Items::Item::MicrosoftGraphCreateLink
    ## 
    ...
    class CreateLinkRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/microsoft.graph.createLink"
