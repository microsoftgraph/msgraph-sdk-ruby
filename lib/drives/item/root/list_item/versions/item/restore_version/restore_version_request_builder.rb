...
module MicrosoftGraph::Drives::Item::Root::ListItem::Versions::Item::RestoreVersion
    ## 
    ...
    class RestoreVersionRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/drives/{drive%2Did}/root/listItem/versions/{listItemVersion%2Did}/microsoft.graph.restoreVersion"
