...
module MicrosoftGraph::Drives::Item::Root::Subscriptions::Item::Reauthorize
    ## 
    ...
    class ReauthorizeRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/drives/{drive%2Did}/root/subscriptions/{subscription%2Did}/microsoft.graph.reauthorize"
