...
module MicrosoftGraph
    module Drives
        module Item
            module SharedWithMe
                class SharedWithMegetResponse < MicrosoftGraph::Models::BaseCollectionPaginationCountResponse
                    include MicrosoftKiotaAbstractions::Parsable
                    ## 
                    # The value property
                    @value
                    ## 
                    ## Instantiates a new SharedWithMegetResponse and sets the default values.
                    ## @return a void
                    ## 
                    def initialize()
                        super
                    ...
                    ## @return a shared_with_meget_response
                    ## 
                    def self.create_from_discriminator_value(parse_node)
                        raise StandardError, 'parse_node cannot be null' if parse_node.nil?
                        return SharedWithMegetResponse.new
                    end
                    ## 
