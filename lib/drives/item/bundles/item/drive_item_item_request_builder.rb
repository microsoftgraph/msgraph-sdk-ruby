...
module MicrosoftGraph::Drives::Item::Bundles::Item
    ## 
    ...
    class DriveItemItemRequestBuilder
        ...
        def content()
            return MicrosoftGraph::Drives::Item::Bundles::Item::Content::ContentRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter, drive_item_id=)
            ...
            @url_template = "{+baseurl}/drives/{drive%2Did}/bundles/{driveItem%2Did}{?%24select,%24expand}"
