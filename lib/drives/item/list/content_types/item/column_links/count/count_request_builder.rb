...
module MicrosoftGraph::Drives::Item::List::ContentTypes::Item::ColumnLinks::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/drives/{drive%2Did}/list/contentTypes/{contentType%2Did}/columnLinks/$count{?%24search,%24filter}"
