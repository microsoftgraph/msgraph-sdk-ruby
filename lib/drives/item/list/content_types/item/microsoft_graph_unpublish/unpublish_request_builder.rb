...
module MicrosoftGraph::Drives::Item::List::ContentTypes::Item::MicrosoftGraphUnpublish
    ## 
    ...
    class UnpublishRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/drives/{drive%2Did}/list/contentTypes/{contentType%2Did}/microsoft.graph.unpublish"
