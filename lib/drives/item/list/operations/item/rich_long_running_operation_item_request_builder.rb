...
module MicrosoftGraph::Drives::Item::List::Operations::Item
    ## 
    ...
    class RichLongRunningOperationItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter, rich_long_running_operation_id=nil)
            ...
            @url_template = "{+baseurl}/drives/{drive%2Did}/list/operations/{richLongRunningOperation%2Did}{?%24select,%24expand}"
