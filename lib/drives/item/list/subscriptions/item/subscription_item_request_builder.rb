                    ...
                    module Item
                        ...
                        class SubscriptionItemRequestBuilder
                            ...
                            def microsoft_graph_reauthorize()
                                return MicrosoftGraph::Drives::Item::List::Subscriptions::Item::MicrosoftGraphReauthorize::MicrosoftGraphReauthorizeRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            ...
                            def initialize(path_parameters, request_adapter)
                                ...
                                @url_template = "{+baseurl}/drives/{drive%2Did}/list/subscriptions/{subscription%2Did}{?%24select,%24expand}"
