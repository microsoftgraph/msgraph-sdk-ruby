                ...
                module Columns
                    module Item
                        ...
                        class ColumnDefinitionItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                            ...
                            def source_column()
                                return MicrosoftGraph::Drives::Item::List::Columns::Item::SourceColumn::SourceColumnRequestBuilder.new(@path_parameters, @request_adapter)
                            end
                            ## 
                            ...
                            def initialize(path_parameters, request_adapter)
                                super(path_parameters, request_adapter, "{+baseurl}/drives/{drive%2Did}/list/columns/{columnDefinition%2Did}{?%24expand,%24select}")
                            end
                            ## 
                            ...
                            def to_delete_request_information(request_configuration=nil)
                                ...
                                request_info.url_template = '{+baseurl}/drives/{drive%2Did}/list/columns/{columnDefinition%2Did}'
