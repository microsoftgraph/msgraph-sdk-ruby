...
module MicrosoftGraph::Drives::Item::List::Items::Item::DriveItem
    ## 
    ...
    class DriveItemRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/drives/{drive%2Did}/list/items/{listItem%2Did}/driveItem{?%24select,%24expand}"
