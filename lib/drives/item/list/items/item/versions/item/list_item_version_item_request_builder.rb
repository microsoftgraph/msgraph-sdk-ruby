...
module MicrosoftGraph::Drives::Item::List::Items::Item::Versions::Item
    ## 
    ...
    class ListItemVersionItemRequestBuilder
        ...
        def fields()
            return MicrosoftGraph::Drives::Item::List::Items::Item::Versions::Item::Fields::FieldsRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        # Provides operations to call the restoreVersion method.
        def microsoft_graph_restore_version()
            return MicrosoftGraph::Drives::Item::List::Items::Item::Versions::Item::MicrosoftGraphRestoreVersion::RestoreVersionRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        def initialize(path_parameters, request_adapter, list_item_version_id=nil)
            ...
            @url_template = "{+baseurl}/drives/{drive%2Did}/list/items/{listItem%2Did}/versions/{listItemVersion%2Did}{?%24select,%24expand}"
