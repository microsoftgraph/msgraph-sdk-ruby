...
module MicrosoftGraph::Drives::Item::List::Items::Item
    ## 
    ...
    class ListItemItemRequestBuilder
        ...
        def microsoft_graph_get_activities_by_interval()
            return MicrosoftGraph::Drives::Item::List::Items::Item::MicrosoftGraphGetActivitiesByInterval::GetActivitiesByIntervalRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
        ...
        ## @return a void
        ## 
        def initialize(path_parameters, request_adapter, list_item_id=nil)
            raise StandardError, 'path_parameters cannot be null' if path_parameters.nil?
            raise StandardError, 'request_adapter cannot be null' if request_adapter.nil?
            @url_template = "{+baseurl}/drives/{drive%2Did}/list/items/{listItem%2Did}{?%24select,%24expand}"
        ...
        def versions_by_id(id)
            ...
            return MicrosoftGraph::Drives::Item::List::Items::Item::Versions::Item::ListItemVersionItemRequestBuilder.new(url_tpl_params, @request_adapter)
        end
