                            ...
                            module MailboxSettings
                                ...
                                class MailboxSettingsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                                    ...
                                    def initialize(path_parameters, request_adapter)
                                        super(path_parameters, request_adapter, "{+baseurl}/drives/{drive%2Did}/list/items/{listItem%2Did}/createdByUser/mailboxSettings{?%24expand,%24select}")
                                    end
                                    ## 
                                    ...
                                    def to_patch_request_information(body, request_configuration=nil)
                                        ...
                                        request_info.url_template = '{+baseurl}/drives/{drive%2Did}/list/items/{listItem%2Did}/createdByUser/mailboxSettings'
                                        request_info.path_parameters = @path_parameters
