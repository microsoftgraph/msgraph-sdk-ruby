...
module MicrosoftGraph
    module Oauth2PermissionGrants
        module Item
            ...
            class OAuth2PermissionGrantItemRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def initialize(path_parameters, request_adapter)
                    super(path_parameters, request_adapter, "{+baseurl}/oauth2PermissionGrants/{oAuth2PermissionGrant%2Did}{?%24expand,%24select}")
                end
                ## 
                ...
                def to_delete_request_information(request_configuration=nil)
                    ...
                    request_info.url_template = '{+baseurl}/oauth2PermissionGrants/{oAuth2PermissionGrant%2Did}'
                ...
                def with_url(raw_url)
                    ...
                    return OAuth2PermissionGrantItemRequestBuilder.new(raw_url, @request_adapter)
                end
