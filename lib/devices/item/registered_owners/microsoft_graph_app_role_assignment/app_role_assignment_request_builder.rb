...
module MicrosoftGraph::Devices::Item::RegisteredOwners::MicrosoftGraphAppRoleAssignment
    ## 
    ...
    class AppRoleAssignmentRequestBuilder
        ...
        def count()
            return MicrosoftGraph::Devices::Item::RegisteredOwners::MicrosoftGraphAppRoleAssignment::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
