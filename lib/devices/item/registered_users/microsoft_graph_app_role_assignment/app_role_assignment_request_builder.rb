...
module MicrosoftGraph::Devices::Item::RegisteredUsers::MicrosoftGraphAppRoleAssignment
    ## 
    ...
    class AppRoleAssignmentRequestBuilder
        ...
        def count()
            return MicrosoftGraph::Devices::Item::RegisteredUsers::MicrosoftGraphAppRoleAssignment::Count::CountRequestBuilder.new(@path_parameters, @request_adapter)
        end
        ## 
