...
require_relative './service_principals_with_app_id'

module MicrosoftGraph
    module ServicePrincipalsWithAppId
        ## 
        # Provides operations to manage the collection of servicePrincipal entities.
        class ServicePrincipalsWithAppIdRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
            ...
            ## @return a void
            ## 
            def initialize(path_parameters, request_adapter, app_id=nil)
                super(path_parameters, request_adapter, "{+baseurl}/servicePrincipals(appId='{appId}'){?%24expand,%24select}")
            end
            ## 
            ...
            def to_delete_request_information(request_configuration=nil)
                ...
                request_info.url_template = '{+baseurl}/servicePrincipals(appId='{appId}')'
            ...
            def with_url(raw_url)
                ...
                return ServicePrincipalsWithAppIdRequestBuilder.new(raw_url, @request_adapter)
            end
