...
module MicrosoftGraph::AppCatalogs::TeamsApps::Item::AppDefinitions::Count
    ## 
    ...
    class CountRequestBuilder
        ...
        def initialize(path_parameters, request_adapter)
            ...
            @url_template = "{+baseurl}/appCatalogs/teamsApps/{teamsApp%2Did}/appDefinitions/$count{?%24search,%24filter}"
