...
require_relative '../../models/teams_app_collection_response'
require_relative '../app_catalogs'
require_relative './count/count_request_builder'
require_relative './item/teams_app_item_request_builder'
...
module MicrosoftGraph
    module AppCatalogs
        module TeamsApps
            ...
            class TeamsAppsRequestBuilder < MicrosoftKiotaAbstractions::BaseRequestBuilder
                ...
                def initialize(path_parameters, request_adapter)
                    super(path_parameters, request_adapter, "{+baseurl}/appCatalogs/teamsApps{?%24count,%24expand,%24filter,%24orderby,%24search,%24select,%24skip,%24top}")
                end
                ## 
                ...
                ## @return a Fiber of teams_app_collection_response
                ## 
                ...
                def to_post_request_information(body, request_configuration=nil)
                    ...
                    request_info.url_template = '{+baseurl}/appCatalogs/teamsApps'
                    request_info.path_parameters = @path_parameters
                ...
                ## @return a teams_apps_request_builder
                ## 
                def with_url(raw_url)
                    raise StandardError, 'raw_url cannot be null' if raw_url.nil?
                    return TeamsAppsRequestBuilder.new(raw_url, @request_adapter)
                end
